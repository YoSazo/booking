...
const LOGOS = {
    ...
    'Apple Pay': 'data:image/svg+xml;base64,',
...
function GuestInfoPage({ hotel, bookingDetails, onBack, onComplete, apiBaseUrl }) {
    ...
    return walletType ? <img src={LOGOS[walletType]} alt={walletType} className="payment-logo" /> : null;
};
