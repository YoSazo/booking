              ...
              <div className="confirmation-call-modal-overlay" onClick={(e) => e.stopPropagation()}>
                <div className="confirmation-call-modal-sheet">
                  ...
                  <p className="confirmation-call-subtitle">
                    Our front desk will call you in the next few minutes to complete your reservation. Your room is being held.
                  </p>
    ...
    <>
      {walletType ? (
        ...
        <div className="payment-method-tabs" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '7px', marginBottom: '20px' }}>
          ...
          >
            <img src="/klarna.svg" alt="Klarna" className="wallet-logo" style={{ height: '15px', width: 'auto' }} />
          </button>
        </div>
      ) : (
