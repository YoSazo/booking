const d={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let F=null;function ot(){return typeof lucide<"u"?Promise.resolve():F||(F=new Promise((e,t)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>e(),o.onerror=()=>t(new Error("lucide load failed")),document.head.appendChild(o)}),F)}async function be(e){if(!e||!e.type.startsWith("image/")||e.type==="image/webp"&&e.size<4e5)return e;try{const t=await createImageBitmap(e),o=1600,i=1200;let n=t.width,a=t.height;const r=Math.min(1,o/n,i/a);n=Math.round(n*r),a=Math.round(a*r);const s=document.createElement("canvas");s.width=n,s.height=a,s.getContext("2d").drawImage(t,0,0,n,a),t.close();const p=await new Promise((x,w)=>{s.toBlob(E=>E?x(E):w(new Error("encode failed")),"image/webp",.82)}),g=(e.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([p],g+".webp",{type:"image/webp"})}catch{return e}}function it(){const e=()=>{d.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}function we(e){Object.assign(window,e)}async function ne(){const e=document.getElementById("settingsList");if(e){e.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const t=await api("GET","/api/crm/verify"),i="https://"+(t?.domain||d.activeHotelId+".mktel.co"),n="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(i),a=await api("GET","/api/crm/rooms");let r={nightly:69,weekly:299,monthly:999};a?.rates&&(r=a.rates);const s=a?.rooms||[];let p="";t?.subscribed||(p+=goLiveInlineCardHtml()),s.length?s.forEach(g=>{const x=g.images&&g.images.length>0;p+=`
    ...
    `,e.innerHTML=p}catch{e.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function ke(){const e=document.getElementById("settings-booking-url");e&&navigator.clipboard.writeText(e.value).then(()=>{localStorage.setItem("linkCopied","1"),M(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function Ee(){localStorage.setItem("settingsTourDone","1");const e=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",e);let t=0;const o=setInterval(()=>{t++;const i=document.getElementById("edit-rate-nightly");if(i||t>20){if(clearInterval(o),!i)return;const n=i.closest(".accordion-body");if(n&&n.style.display==="none"){n.style.display="block";const a=n.previousElementSibling?.querySelector(".accordion-arrow");a&&(a.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const r=i.getBoundingClientRect(),s=document.createElement("div");s.id="checklistPointer",s.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${r.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,s.innerHTML=`
          ...
          `,document.body.appendChild(s),setTimeout(()=>{const p=document.getElementById("checklistPointer");p&&p.remove()},6e3)},1e3)},100)}},200)}function Se(){const t="https://"+(d.activeHotelDomain||d.activeHotelId+".mktel.co");navigator.clipboard.writeText(t).then(()=>{localStorage.setItem("linkCopied","1"),M(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function Te(e,t){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const n=setInterval(()=>{i++;const a=document.querySelector(e);if(a||i>20){if(clearInterval(n),!a)return;a.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const r=document.getElementById("checklistPointer");r&&r.remove();const s=a.getBoundingClientRect(),p=document.createElement("div");p.id="checklistPointer",p.style.cssText=`
        ...
        `,document.body.appendChild(p),setTimeout(()=>{const g=document.getElementById("checklistPointer");g&&g.remove()},6e3)},1e3)}},200)}function K(){const e=String(d.token||localStorage.getItem("crmToken")||"").trim();return e&&(d.token=e),e}async function X(e,t){const o=K();if(!o)throw new Error("Not logged in");const i=await be(t),n=new FormData;n.append("image",i,i.name||"room.webp");const a=new URLSearchParams;d.activeHotelId&&a.set("hotelId",d.activeHotelId),a.set("token",o);const r=await fetch(`/api/crm/rooms/${e}/images?${a}`,{method:"POST",headers:{"x-crm-token":o},body:n}),s=await r.json().catch(()=>({}));if(!r.ok||!s.success)throw new Error(s.message||s.error||`Upload failed (${r.status})`);return s}async function ze(e,t){const o=e.target.files[0];if(o)try{await X(t,o),toast("Photo uploaded!","success"),ne()}catch(i){toast(i.message||"Upload failed","error")}}async function Be(){const e=parseFloat(document.getElementById("settings-rate-nightly")?.value)||69,t=parseFloat(document.getElementById("settings-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("settings-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:e,weekly:t,monthly:o}),toast("Rates saved","success")}catch{toast("Failed to save rates","error")}}async function Ie(){const e=document.getElementById("settings-new-pin")?.value.trim();if(!e||e.length<4){toast("PIN must be at least 4 characters","error");return}try{const t=await api("POST","/api/crm/change-pin",{newPin:e});if(!t.success)throw new Error(t.message||"Failed to change PIN");d.token=e,d.isMasterPin=!1;try{localStorage.setItem("crmToken",d.token)}catch{}toast("PIN updated!","success"),document.getElementById("settings-new-pin").value=""}catch(t){toast(t.message||"Failed to change PIN","error")}}async function Ae(){const e=document.getElementById("settings-support-msg")?.value.trim();if(!e){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:e}),toast("Message sent!","success"),document.getElementById("settings-support-msg").value=""}catch{toast("Failed to send","error")}}function Pe(){const e=d.activeHotelDomain||d.activeHotelId+".mktel.co",o=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://localhost:5173/?hotelId="+encodeURIComponent(d.activeHotelId)+"&preview=1":"https://"+e+"?preview=1";window.open(o,"_blank")}function re(){if((window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&d.activeHotelId)return"http://localhost:5173/?hotelId="+encodeURIComponent(d.activeHotelId);const t=d.activeHotelDomain||"";return t?"https://"+t+"/":""}function Ce(){const e=re();if(!e){toast("Your booking domain is still setting up.","info");return}window.open(e,"_blank")}function Re(){const e=document.getElementById("previewSiteBar");e&&(e.style.display=d.currentFilter==="settings"?"block":"none")}function M(){if(localStorage.getItem("settingsTourDone"))return;const e=parseInt(localStorage.getItem("settingsTourStep")||"0"),t=d.editRooms.some(r=>r.images&&r.images.length>0),o=!!localStorage.getItem("ratesChanged"),i=!!localStorage.getItem("linkCopied");e===2&&t&&localStorage.setItem("settingsTourStep","3"),e===3&&o&&localStorage.setItem("settingsTourStep","4"),e===4&&i&&localStorage.setItem("settingsTourStep","5");const n=document.getElementById("tourTooltip");n&&n.remove();const a=document.getElementById("tourBlurOverlay");a&&a.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(r=>{r.style.position=r.dataset.tourOrigPosition||"",r.style.zIndex="",r.style.isolation="",r.style.boxShadow="",r.removeAttribute("data-tour-highlighted"),delete r.dataset.tourOrigPosition}),document.body.style.overflow=""}function Me(){let e=0;const t={},o=[{title:"Why do you want a booking page?",key:"why",type:"text",placeholder:"e.g. I want guests to book directly instead of calling me..."},{title:"How do guests currently book with you?",key:"currentBooking",type:"choice",options:[{label:"They call me or walk in",value:"phone_walkin"},{label:"Through Booking.com / Expedia",value:"ota"},{label:"I have a website but no booking system",value:"website_no_booking"},{label:"I don't take bookings online yet",value:"no_online"}]},{title:"How many rooms do you have?",key:"roomCount",type:"choice",options:[{label:"1–5 rooms",value:"1-5"},{label:"6–15 rooms",value:"6-15"},{label:"16–50 rooms",value:"16-50"},{label:"50+ rooms",value:"50+"}]},{title:"What's most important to you?",key:"priority",type:"choice",options:[{label:"Stop paying OTA commissions",value:"no_commission"},{label:"Get more direct bookings",value:"more_bookings"},{label:"Have a professional online presence",value:"professional"},{label:"Make it easier for guests to book",value:"easier_booking"}]}];function i(){let n=document.getElementById("onboardingOverlay");if(n&&n.remove(),e>=o.length){localStorage.setItem("onboardingDone","1");try{api("POST","/api/crm/onboarding-answers",t).catch(()=>{})}catch{}ae();return}const a=o[e],r=document.createElement("div");r.id="onboardingOverlay",r.style.cssText="position:fixed;inset:0;z-index:100001;background:linear-gradient(135deg, #1a2b22 0%, #2E7D5B 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;",a.type==="text"?(r.innerHTML=`
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=t}document.body.appendChild(e),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function O(){const e=document.getElementById("postActivationTourTooltip");e&&e.remove();const t=document.getElementById("postActivationTourOverlay");t&&t.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function H(){O(),localStorage.setItem("postActivationTourDone","1");const e=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",e)}catch{}}function Z(){if(localStorage.getItem("postActivationTourDone")){H();return}O();const e=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. You'll get a push alert for each new one."},{tab:"apps",navFilter:"apps",text:"<strong>Guest App</strong> — put your hotel on guests&apos; home screens and send install reminders."}];let t=0;function o(){if(O(),t>=e.length){H();return}const i=e[t],n=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);n&&setFilter(i.tab,n);const a=document.createElement("div");a.id="postActivationTourOverlay",a.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(a),document.body.style.overflow="hidden",setTimeout(()=>{const r=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);r&&(r.setAttribute("data-post-activation-highlight","1"),r.style.position="relative",r.style.zIndex="100003",r.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",r.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const s=r?r.getBoundingClientRect():{left:24,bottom:80,width:200},p=document.createElement("div");p.id="postActivationTourTooltip";const g=Math.min(300,window.innerWidth-32),x=Math.max(16,Math.min(s.left+s.width/2-g/2,window.innerWidth-g-16)),w=Math.min(s.bottom+14,window.innerHeight-180);p.style.cssText=`position:fixed;z-index:100004;left:${x}px;top:${w}px;max-width:${g}px;width:${g}px;`;const E=t>=e.length-1;p.innerHTML=`
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),Z()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}function P(e){const t=e||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText=`position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.48);pointer-events:${t.blockPointer?"auto":"none"};`,document.body.appendChild(o),t.lockScroll&&(document.body.style.overflow="hidden"),o)}function U(){const e=document.getElementById("tourTooltip");e&&e.remove();const t=document.getElementById("tourBlurOverlay");t&&t.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.tourOrigPosition||"",i.style.zIndex="",i.style.isolation="",i.style.boxShadow="",i.removeAttribute("data-tour-highlighted"),delete i.dataset.tourOrigPosition});const o=document.getElementById("goLiveBanner");o&&o.dataset.tourHidden&&(delete o.dataset.tourHidden,typeof updateGoLiveBanner=="function"&&updateGoLiveBanner()),document.body.style.overflow=""}function I(e,t){if(!t.openAccordion)return;const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const a=o.querySelector(".accordion-arrow");a&&(a.style.transform="rotate(90deg)")}}function A(e){if(!e)return null;for(const t of String(e).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(t);if(o&&o.isConnected)return o}return null}function C(e,t){if(t.highlightSelector){const o=A(t.highlightSelector);if(o)return o}if(t.highlightCard){const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(o)return o}return t.targetParent&&(e.closest(".booking-card")||e.closest(".accordion-body"))||e}function N(e,t){if(!t)return e;const o=String(t.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const n=document.querySelector(i);if(n&&n.isConnected)return n}if(t.accordionCard){const i=document.querySelector(t.accordionCard);if(i&&i.isConnected)return i}return e&&e.isConnected?e:null}function W(e,t){if(!e||!e.isConnected)return null;const o=e.getBoundingClientRect();return o.width<2||o.height<2||!t&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Y(e,t){const o=A(e.anchorSelector);if(o){const i=W(o,!0);if(i)return i}return W(t,!0)}function q(e){const t=e||"auto";try{window.scrollTo({top:0,left:0,behavior:t})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const n=document.querySelector(i);n&&(n.scrollTop=0)})}function se(e,t){const o=t.scrollTarget||t.accordionCard,i=(o?A(o):null)||e;if(!i&&!t.scrollToTop)return Promise.resolve();const n=t.scrollBlock||"center",a=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=d.settingsTourActive||a?"auto":"smooth";return new Promise(s=>{const p=()=>{const T=t.scrollPadTop??80,l=t.scrollPadBottom??220,c=A(t.anchorSelector)||(i&&i.isConnected?i:null)||(e&&e.isConnected?e:null);if(!c){s();return}const m=c.getBoundingClientRect();m.top<T&&window.scrollBy({top:m.top-T,left:0,behavior:"auto"}),m.bottom>window.innerHeight-l&&window.scrollBy({top:m.bottom-window.innerHeight+l,left:0,behavior:"auto"}),requestAnimationFrame(()=>requestAnimationFrame(s))},g=()=>{i&&i.scrollIntoView({behavior:t.scrollToTop?"auto":r,block:n,inline:"nearest"}),p()};if(t.scrollToTop){if(q(r),t.scrollToTopOnly){requestAnimationFrame(()=>requestAnimationFrame(()=>{t.forcePageTop&&q("auto"),s()}));return}if(r==="auto"){g();return}let T=!1;const l=()=>{T||(T=!0,window.removeEventListener("scrollend",c),clearTimeout(m),g())},c=()=>l();"onscrollend"in window&&window.addEventListener("scrollend",c,{once:!0});const m=setTimeout(l,520);return}if(!i){s();return}if(i.scrollIntoView({behavior:r,block:n,inline:"nearest"}),r==="auto"){p();return}let x=!1;const w=()=>{x||(x=!0,window.removeEventListener("scrollend",E),clearTimeout(G),p())},E=()=>w();"onscrollend"in window&&window.addEventListener("scrollend",E,{once:!0});const G=setTimeout(w,620)})}function de(){U(),localStorage.setItem("settingsTourStep","handoff");const e=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&setFilter("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const n=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof n=="function"&&n({chainFromSettingsTour:!0})},t=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof t=="function"?t().then(e).catch(e):e()}function R(){d.settingsTourActive=!1,updateGoLiveBanner();const e=document.createElement("div");e.id="tourBlurOverlay",e.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(e),document.body.style.overflow="hidden";const t=document.createElement("div");if(t.id="tourTooltip",t.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",t.innerHTML=`
    ...
    <div style="background:white;border-radius:20px;max-width:340px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);animation:tourModalSlideUp 0.3s ease;">
    ...
    </div>`,document.body.appendChild(t),typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("activateNowBtn").onclick=()=>{t.remove(),fe()},document.getElementById("activateLaterBtn").onclick=()=>{t.remove();const o=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');o&&setFilter("bookings",o)}}function _(){if(localStorage.getItem("settingsTourDone"))return;if(localStorage.getItem("settingsTourStep")==="handoff"){localStorage.removeItem("settingsTourStep"),R();return}d.settingsTourActive=!0,updateGoLiveBanner(),seedTourRevenueShell();const e=document.querySelector('.tab[data-nav-filter="settings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="settings"]');e&&setFilter("settings",e);function t(){if(typeof window.isEditPageDomReady=="function"&&window.isEditPageDomReady()||typeof isEditPageDomReady=="function"&&isEditPageDomReady()||!(typeof window.needsEditPageLoad=="function"&&window.needsEditPageLoad()||typeof needsEditPageLoad=="function"&&needsEditPageLoad())&&!d.editRoomsLoadPromise)return;const m=typeof window.invokeLoadEditRooms=="function"?window.invokeLoadEditRooms:typeof invokeLoadEditRooms=="function"?invokeLoadEditRooms:null;m&&m()}t();const o=[{target:"",text:"",openAccordion:!1,tab:"settings",customModal:"homescreen"},{target:"#edit-hotel-phone",title:"Edit your booking page",text:"Tap any field on this page to change it: hotel name, address, phone, room details, photos, and prices. What you edit here is what guests see.",openAccordion:!1,tab:"settings",scrollToTop:!0,forcePageTop:!0},{target:'#editRoomsCards [data-tour-room-card="1"]',highlightSelector:'#editRoomsCards [data-tour-room-card="1"]',anchorSelector:'#editRoomsCards [data-tour-room-card="1"]',scrollTarget:'#editRoomsCards [data-tour-room-card="1"]',title:"Add room photos",text:"Upload a real room photo here. Guests make faster decisions when they can see the room before they book.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:190,scrollPadBottom:220},{target:"#tour-rates-card",highlightSelector:"#tour-rates-card",anchorSelector:"#tour-rates-header",scrollTarget:"#tour-rates-card",title:"Set your rates",text:"Set nightly, weekly, and monthly prices here. Guests book from these rates on your direct booking page.",openAccordion:!0,accordionCard:"#tour-rates-card",tab:"settings",scrollBlock:"center",scrollPadBottom:260},{target:"#tour-preview-btn",title:"Preview and share it",text:"Use Preview to see exactly what guests see. Your booking link and QR code are on this page too, so you can send guests straight here.",openAccordion:!1,tab:"settings",scrollToTop:!0,scrollToTopOnly:!0,forcePageTop:!0},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",title:"Track revenue and payment status",text:"Revenue shows direct bookings and estimated OTA commission savings. Guest cards are verified to reduce no-shows, but you still collect payment at check-in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,scrollBlock:"start",scrollPadTop:92,scrollPadBottom:220},{target:"",text:"",openAccordion:!1,tab:"apps",customModal:"guestAppsStory"}];let i=parseInt(localStorage.getItem("settingsTourStep")||"0",10);(!Number.isFinite(i)||i<0||i>=o.length)&&(i=0,localStorage.removeItem("settingsTourStep"));function n(){U()}function a(){n(),localStorage.removeItem("settingsTourStep"),R()}function r(l){if(l.customModal){p(l);return}requestAnimationFrame(()=>p(l))}function s(){if(n(),i>=o.length){localStorage.removeItem("settingsTourStep"),R();return}const l=o[i];if(l.tab==="revenue"&&!d.revenueEnabled){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}if(l.tab==="apps"&&!(isStandaloneApp()||d.frontdeskInstalled)&&l.target&&!l.target.includes("tour-fd-install")){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}if(l.customModal||P(),l.tab&&l.tab!==d.currentFilter){const c=document.querySelector(`.tab[data-nav-filter="${l.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${l.tab}"]`);if(c&&setFilter(l.tab,c),l.tab==="apps"){const m=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof m=="function"&&m(!0)}r(l);return}r(l)}function p(l){if(l.customModal==="homescreen"){E();return}if(l.customModal===!0||l.customModal==="bookings"){T();return}if(l.customModal==="availability"){G();return}if(l.customModal==="finale"){R();return}if(l.customModal==="guestAppsStory"){de();return}if(l.waitForVisible){const u=l.target.split(",").map(h=>h.trim());let v=0;const f=30;P();const b=d.settingsTourActive?60:200,y=()=>{if(v++,l.tab==="apps"){const k=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof k=="function"&&k(!0)}let h=null;for(const k of u)if(h=document.querySelector(k),h)break;if(h&&(l.openAccordion&&I(h,l),l.openAccordion||h.offsetParent!==null)){g(h,l);return}v<f?setTimeout(y,b):(i++,localStorage.setItem("settingsTourStep",String(i)),s())};y();return}function c(u){const v=u.target.split(",").map(f=>f.trim());for(const f of v){const b=document.querySelector(f);if(b&&!(!u.openAccordion&&b.offsetParent===null&&getComputedStyle(b).position!=="fixed"))return b}if(u.accordionCard){const f=document.querySelector(u.accordionCard);if(f)return f}return null}function m(u,v){const f=c(u);if(f){v(f);return}const b=u.tab==="settings"&&!u.customModal&&u.target,y=u.tab==="apps"&&!u.customModal&&u.target;if(!b&&!y){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}P();let h=0;if(b&&t(),y){const z=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof z=="function"&&z(!0)}const k=d.settingsTourActive?60:250,S=()=>{if(h++,y){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}const z=c(u);if(z){v(z);return}if(t(),y){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}h<48?setTimeout(S,k):(i++,localStorage.setItem("settingsTourStep",String(i)),s())};S()}m(l,u=>g(u,l))}function g(l,c){if(I(l,c),l=C(l,c),(!l||!l.isConnected)&&(l=N(l,c),l&&(l=C(l,c))),!l){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}const m=document.getElementById("goLiveBanner");m&&c.tab==="settings"&&(m.dataset.tourHidden="1",m.style.display="none");const u=l;P(),se(u,c).then(()=>{if(c.forcePageTop&&q("auto"),!u.isConnected){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}I(u,c),c.noHighlight||(u.dataset.tourOrigPosition||(u.dataset.tourOrigPosition=u.style.position||""),u.style.position=u.style.position||"relative",u.style.zIndex="99999",u.style.isolation="isolate",u.style.boxShadow="0 0 0 4px #2E7D5B, 0 0 20px rgba(46,125,91,0.3)",u.setAttribute("data-tour-highlighted","1"));const v=()=>{const y=A(c.anchorSelector)||u;if(c.freezeTooltip){const S=y&&y.isConnected?y.getBoundingClientRect():null;x(y,c,S&&S.width>=2?S:null);return}const h=N(u,c);let k=h?C(h,c):u;I(k,c),c.tooltipAnchor||Y(c,k),x(k||u,c)};if(c.freezeTooltip){requestAnimationFrame(()=>requestAnimationFrame(v));return}const f=(b=0)=>{requestAnimationFrame(()=>{if(c.forcePageTop&&q("auto"),c.tooltipAnchor){v();return}const y=N(u,c);let h=y?C(y,c):u;if(I(h,c),!Y(c,h)&&b<4){requestAnimationFrame(()=>f(b+1));return}x(h||u,c)})};f(0)})}function x(l,c,m){const u=document.getElementById("tourTooltip");u&&u.remove();const v=document.createElement("div");v.id="tourTooltip";const f=Math.min(i+1,o.length),b=Math.max(8,Math.min(100,Math.round(f/o.length*100))),y=c.title||"Quick setup",h=c.primaryLabel||(i<o.length-1?"Next":"Got it"),k=i<=0;v.style.cssText="position:fixed;z-index:100000;left:12px;right:12px;bottom:calc(14px + env(safe-area-inset-bottom,0px));display:flex;justify-content:center;pointer-events:none;",v.innerHTML=`
      ...
      </div>`,document.body.appendChild(v),w()}function w(){const l=document.getElementById("tourNextBtn"),c=document.getElementById("tourSkipBtn");l&&(l.onclick=()=>{n(),i++,localStorage.setItem("settingsTourStep",String(i)),s()}),c&&(c.onclick=()=>{a()});const m=document.getElementById("tourBackBtn");m&&(m.onclick=()=>{i<=0||(n(),i--,localStorage.setItem("settingsTourStep",String(i)),s())})}function E(){typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms();const l=document.createElement("div");l.id="tourBlurOverlay",l.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(l),document.body.style.overflow="hidden";const c=d.activeHotelName||"Your Hotel",m=c.trim().charAt(0).toUpperCase(),u=c.length>10?c.slice(0,10):c,v="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",f="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",b="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",y=`<div style="${v}"><div style="${f}background:rgba(255,255,255,0.22);"></div><div style="${b}"></div></div>`,h=d.activeHotelAppIcon||"",k=h?`<img src="${h}" alt="" style="width:100%;height:100%;object-fit:contain;">`:m,S=h?`${f}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${f}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,z=`<div style="${v}"><div style="${S}">${k}</div><div style="${b}font-size:7.5px;color:#fff;font-weight:700;">${u}</div></div>`,B=[y,y,y,y,z,y,y,y].join(""),$=document.createElement("div");if($.id="tourTooltip",$.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",$.innerHTML=`
      ...
      </div>`],u=document.createElement("div");u.id="tourTooltip",u.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";function v(){const b=c>=m.length-1?"Next — Revenue →":"Next →";u.innerHTML=`
  ...
  `),document.getElementById("editNewRoomName").focus())}function et(){const e=document.getElementById("editNewRoomName").value.trim();e&&api("POST","/api/crm/rooms",{name:e,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),ee()}).catch(()=>toast("Failed to add","error"))}const ve={addAmenityPrompt:Ne,advanceTourIfNeeded:M,changePin:Ue,checklistGoTo:Te,checklistGoToRates:Ee,cleanupPostActivationTourUi:O,cleanupSettingsTourUi:U,closeAmenityPicker:j,confirmAmenityPicker:He,confirmEditAddRoom:et,copyBookingLink:Ge,copyBookingLinkFromChecklist:Se,deleteEditImage:Ke,deleteEditRoom:Xe,ensureTourBlurOverlay:P,finishPostActivationTour:H,getAmenityIcon:ue,getCrmAuthToken:K,getEditRoomImages:ce,goLive:fe,guestBookingEngineUrl:re,handoffToGuestAppsTour:de,hideGoLiveOverlay:Q,loadEditRooms:ee,loadSettings:ne,openAmenityPicker:me,openBillingPortal:We,openEditAddRoom:Ze,openGuestBookingEngine:Ce,openPreviewSite:Pe,openTourAccordion:I,postRoomImageUpload:X,queryTourSelector:A,removeAmenity:Oe,renderEditRooms:te,renderEditRoomsCards:L,replayWalkthrough:Le,resolveLiveTourElement:N,resolveTourHighlightEl:C,restoreAppIconPreview:J,saveEditRoom:_e,saveHotelInfo:qe,saveRates:je,scrollTourTargetIntoView:se,sendSupportMessage:Ye,setAppIconPreviewImage:ie,setAppIconPreviewLoading:he,settingsChangePin:Ie,settingsCopyLink:ke,settingsSaveRates:Be,settingsSendSupport:Ae,settingsUploadPhoto:ze,showActivatedModal:$e,showEditRoomPhoto:pe,showFinaleMockModal:R,showGoLiveOverlay:xe,showOnboardingQuestions:Me,showTestDriveModal:le,showWelcomeModal:ae,squareCropImage:ye,startPostActivationTabTour:Z,startSettingsTour:_,stepEditRoomPhoto:Fe,toggleAmenityPreset:De,toggleSection:Ve,tourAnchorRect:Y,tourElementRect:W,updatePreviewSiteBar:Re,uploadAppIcon:Je,uploadEditImages:Qe};function tt(){we(ve)}const nt=Object.freeze(Object.defineProperty({__proto__:null,default:ve,install:tt},Symbol.toStringTag,{value:"Module"}));export{ot as a,nt as b,d as c,we as e,it as s};
