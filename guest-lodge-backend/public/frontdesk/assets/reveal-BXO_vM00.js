import{c,e as we}from"./settings-BjIgv-Fo.js";const ke="/frontdesk/assets/assistant-booking-request-DM4sqyhz.webp",Se="/frontdesk/assets/assistant-text-resolution-GXaNrbcO.webp",P="marketelValueRevealPendingV1",x="marketelValueRevealStepV1",le="marketelBillingIntervalV1";let i=0,p="guest",S={rooms:[],rates:null},C=null,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},q=!1,I=0,K=!1,k={1:0,2:0},z=0,B=0,y="month",s=null,X=!1,b=!1,G=!1,Y="confirm";function de(){const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e==="0.0.0.0"||e==="::1"||e.endsWith(".local")||/^10\./.test(e)||/^192\.168\./.test(e)||/^172\.(1[6-9]|2\d|3[01])\./.test(e)}function m(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ae(e){const t=Number(e);return Number.isFinite(t)?new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:Number.isInteger(t)?0:2}).format(t):"$99"}function g(){return c.activeHotelName||"Your Property"}function Z(){return S.rooms[0]||c.editRooms[0]||{name:"Your first room",totalUnits:1,images:[]}}function re(){const e=Z();return e.images?.[0]?.url||e.imageUrl||""}function ce(){const e=Number(S.rates?.nightly);if(!Number.isFinite(e)||e<=0)return null;const t=e*.15,a=Math.max(1,Math.ceil(199/t));return{rate:e,roomNights:a,savings:t*a}}function Ie(){const e=ce();if(!e)return`<div class="mvr-value-bridge is-proof-only">
  ...
  </div>`}function Ce(){return b||n.reason==="deployment-disabled"||q&&!n.ready?!1:!!$()}function Te(){return Ce()?`<div class="mvr-page-status is-ready"><span>✓</span>${n.reason==="local"?"Local guest preview connected":"Your live guest page is online"}</div>`:b?'<div class="mvr-page-status is-attention"><span>!</span>The live preview is still publishing. Your setup is saved, so you can continue without waiting.</div>':n.reason==="deployment-disabled"?'<div class="mvr-page-status is-attention"><span>!</span>Your live page deployment needs to be re-enabled. Your saved setup is safe.</div>':`<div class="mvr-page-status"><span class="mvr-status-pulse"></span>${n.checking?"Publishing your live guest page…":"Your personalized preview is ready while the live page finishes publishing."}</div>`}function Me(){const e=$();return`<div class="mvr-booking-preview-card">
  ...
  </div>`}function xe(){return`<section class="mvr-stage mvr-stage-booking">
    <div class="mvr-copy">
  ...
  </section>`}function Fe(){return he("mvr-stage-app","2 · Your app and theirs",ge(),k[1]||0)}function De(){const e=m(g());return`<div class="mvr-guestel-proof mvr-guestel-install-proof">
  ...
  </div>`}function Oe(){return he("mvr-stage-assistant","3 · Your Front Desk Assistant",fe(),k[2]||0)}function _e(){const e=c.hotelSubscribed,t=y==="year",a=t?"$1,990":"$199",o=t?"/year":"/month",r=t?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month",l=`<div class="mvr-value-list">
  ...
  </section>`}function Ue(){return i===0?xe():i===1?Fe():i===2?Oe():_e()}function We(){if(i===0)return!X&&!b?"":`<div class="mvr-footer mvr-footer-booking">
