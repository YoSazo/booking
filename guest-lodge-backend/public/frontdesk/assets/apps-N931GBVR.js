import{c as g,e as K}from"./settings-BUSklera.js";const a={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4",frontdeskInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_19-49-38_1_tc1bzm.mp4"},J="32px";function b(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function m(t){return`border-radius:${J};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function E(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let $=[],u=0;function Z(t,e){v(!1),$=t,u=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?z(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?z(-1):i.key==="Escape"&&T()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const r=i.changedTouches[0].clientX-n;Math.abs(r)>50&&z(r<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",S()}function T(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function z(t){const e=$.length;e<=1||(u=(u+t+e)%e,S())}function S(){const t=document.getElementById("appsLightbox");if(!t)return;const e=$[u],o=$.length,n=e.type!=="video",i=o>1?`${u+1} / ${o}`:"",r=n?`<img src="${E(e.src)}" alt="${e.alt||""}"
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${s}
    </div>`}function j(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function h(t,e,o,n,i){const r=i?j("Video"):"",p=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${n})">
    ...
    ${p}
  </button>`}function ee(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function H(t){const e=document.getElementById("appsView");if(!e)return;const o=(g.activeHotelId||"")+"|"+(g.activeHotelAppIcon||"")+"|"+(g.activeHotelDomain||"");t||e.dataset.appsKey!==o||!e.querySelector(".apps-page")?(L(),e.dataset.appsKey=o):A()}function L(){const t=document.getElementById("appsView");if(!t)return;const e=g.activeHotelName||"Your Hotel",o=g.activeHotelAppIcon||"",n=e.trim().charAt(0).toUpperCase()||"🏨",i=g.activeHotelDomain||"",r=i?"https://"+i:"#",p=i?"https://"+i+"/install":"#";function l(X){return JSON.stringify(X).replace(/"/g,"&quot;")}const s=b(a.guestHome,520),c=[{type:"image",src:a.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],d=[{type:"image",src:a.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:a.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:a.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],f=[{type:"video",src:a.guestInstallVideo,poster:a.guestHome,alt:"Guest adds hotel to phone",title:"How your guests put your hotel on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your hotel shows up on their phone like an app. You don't need to do anything."}],G=[{type:"image",src:a.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your hotel app.'},{type:"image",src:a.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:a.guestMessageNotifVideo,poster:a.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],w=isStandaloneApp()||g.frontdeskInstalled,q=typeof Notification<"u"&&Notification.permission==="granted",F=[{type:"video",src:a.frontdeskInstallVideo,poster:a.frontdeskMessages,alt:"How to install Front Desk",title:"Install Front Desk on this device",caption:"Use your browser install option. No App Store. Takes about 3 seconds."},{type:"image",src:a.frontdeskMessages,alt:"Reply to guest",title:"You reply from Front Desk",caption:"Messages from guests show up in <strong>Bookings</strong>. Reply there — guests get it on their phone."}];let k;w&&q?k=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
    ...
    </div>`:w?k=`<div id="tour-fd-installed-badge"><p style="font-size:13px;color:var(--text-muted);margin:0 0 12px;line-height:1.55;">It's installed on this device. Turn on alerts so you know when a guest books.</p>
    ...
    <div class="apps-icon-card">
      ...
      ${p==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,R=p!=="#"?`
      ...
      </div>`:'<div id="guestInstallStats" style="display:none;"></div>',Y=`
    <div class="apps-loop">
    ...
    <div class="apps-step-card" id="tour-fd-install-card">
      ...
      <div class="apps-step-title">${w?"Front Desk — installed":"Install Front Desk"}</div>
      ${k}
    </div>
    ...
    ${O}
    ${guestBroadcastCardHtml()}`,Q=w?"Booking alerts live on the <strong>Bookings</strong> tab · installed from your browser":"Installs from your browser · no App Store";t.innerHTML=`
  <style>
  ...
  <div class="apps-page">
    ...
    <div style="flex-shrink:0;width:100%;max-width:400px;margin:0 auto;padding:12px 20px max(16px,env(safe-area-inset-bottom));box-sizing:border-box;text-align:center;">
      ...
      <div style="display:flex;gap:6px;justify-content:center;">${l}</div>
        ...
        </div>`}],x=0,T(),v(!1);const s=document.createElement("div");s.id="appsTourLightbox",s.style.cssText=["position:fixed;inset:0;z-index:102001;background:#000;","display:flex;flex-direction:column;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join("");let c=0;s._swipeStart=d=>{c=d.changedTouches[0].clientX},s._swipeEnd=d=>{const f=d.changedTouches[0].clientX-c;Math.abs(f)>50&&M(f<0?1:-1)},s.addEventListener("touchstart",s._swipeStart,{passive:!0}),s.addEventListener("touchend",s._swipeEnd,{passive:!0}),document.body.appendChild(s),document.body.style.overflow="hidden",I()}const oe={appsCloseLightbox:T,appsCloudinaryFull:E,appsCloudinaryImg:b,appsLbNav:z,appsLbRender:S,appsOpenLightbox:Z,appsPhoneImgStyle:m,appsQuestionRow:h,appsTourClose:v,appsTourNav:M,appsTourRender:I,appsVideoBadgeHtml:j,detectAppPlatform:ee,ensureAppsViewRendered:H,loadGuestInstallStats:A,renderAppsView:L,startAppsTour:te};function se(){K(oe)}export{oe as default,se as install};
