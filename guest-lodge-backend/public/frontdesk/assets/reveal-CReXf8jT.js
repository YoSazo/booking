import{c as d,e as de}from"./settings-B4WoF5xs.js";const C="marketelValueRevealPendingV1",H="marketelValueRevealStepV1",te="marketelBillingIntervalV1";let o=0,m="guest",g=!1,w={rooms:[],rates:null},D=null,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},S=0,R=0,A=null,c=0,Y=0,P=0,f="month",s=null,W=!1,k=!1,V=!1,q="confirm";const ce="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/46/2a/e1/462ae1c9-9347-efd0-5e99-41e7f636e3f7/phone-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg",ue="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/23/4c/cb/234ccbb4-e65a-bb94-f877-3d230743e9e3/safari-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg";function ae(){const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e==="0.0.0.0"||e==="::1"||e.endsWith(".local")||/^10\./.test(e)||/^192\.168\./.test(e)||/^172\.(1[6-9]|2\d|3[01])\./.test(e)}function u(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function J(e){const t=Number(e);return Number.isFinite(t)?new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:Number.isInteger(t)?0:2}).format(t):"$99"}function b(){return d.activeHotelName||"Your Property"}function z(){return w.rooms[0]||d.editRooms[0]||{name:"Your first room",totalUnits:1,images:[]}}function me(){const e=z();return e.images?.[0]?.url||e.imageUrl||""}function ve(){return w.rates?.nightly||99}function pe(){const e=Number(w.rates?.nightly);if(!Number.isFinite(e)||e<=0)return`<div class="mvr-value-bridge is-proof-only">
    ...
    <div class="mvr-preview-browser-bar">
      ...
      <span class="mvr-preview-address"><b></b>${u(F())}</span>
    ...
    <div class="mvr-copy">
      ...
      <p>Guests can choose <strong>${u(z().name||"a room")}</strong> and book directly in under 60 seconds.</p>
    ...
    <div class="mvr-copy">
      ...
      <p>Guests save <strong>${u(b())}</strong> to their Home Screen from your booking page—no App Store download. Then they can return in one tap and receive notifications you send from Marketel Front Desk.</p>
              ...
              <div class="mvr-install-demo-stage">
                <div class="mvr-install-entry">
                  ...
                  <div class="mvr-install-card">
                    ...
                    <div>
                      <strong>Save ${u(b())} to your Home Screen</strong>
  ...
  </section>`}function Re(){const e=z().name||"King Suite",t=q==="release";return`<section class="mvr-stage mvr-stage-assistant">
    <div class="mvr-copy">
  ...
  </section>`}function Pe(){const e=d.hotelSubscribed,t=f==="year",a=t?"$1,990":"$199",i=t?"/year":"/month",r=t?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month",v=`<div class="mvr-value-list">
  ...
  </section>`}function Be(){return o===0?$e():o===1?Ae():o===2?Re():Pe()}function Ce(){if(o===0)return!W&&!k?"":`<div class="mvr-footer mvr-footer-booking">
    ...
    <div class="mvr-live-topline">
      ...
      <div class="mvr-live-address" id="mvrLiveLocation" aria-label="Your live booking address">
        ...
        <strong data-live-location-text>${u(F())}</strong>
      </div>
  ...
  </div>`,document.getElementById("marketelValueReveal")?.appendChild(a);const i=a.querySelector(".mvr-live-stage > iframe");s={modal:a,iframe:i,layer:a.querySelector(".mvr-challenge-layer"),timer:a.querySelector(".mvr-challenge-timer"),previewOpenedAt:t,status:"waiting",hasPrompted:!1,startedAt:0,timerId:0,promptFallbackId:0,promptDelayId:0},s.promptFallbackId=window.setTimeout(()=>{s?.modal!==a||s.status!=="waiting"||I(a,!0)},4e3),i?.addEventListener("load",()=>{const r=s;r?.modal!==a||m!=="guest"||(r.promptDelayId&&window.clearTimeout(r.promptDelayId),r.promptDelayId=window.setTimeout(()=>{r.promptDelayId=0,ye(r)},1500))}),a.querySelector("#mvrClosePreview")?.addEventListener("click",()=>{l("JourneyBookingPreviewModeChanged",{action:"closed",mode:m},{durationMs:Date.now()-t}),O("preview-closed",!0),s=null,a.remove(),y()}),a.querySelector("#mvrContinueGuestApp")?.addEventListener("click",()=>{Le(a,t,"continued-without-editor")}),a.querySelector("#mvrLiveForward")?.addEventListener("click",()=>{if(m==="guest"){M(a,"edit",t,"guided-forward");return}M(a,"guest",t,"returned-to-booking-page")}),p("BookingEngineFullPreviewOpened"),l("JourneyBookingPreviewOpened",{mode:"guest",bookingPageReady:!!n.ready,bookingPageReason:n.reason||""})}function Le(e,t,a){e?.isConnected&&(l("JourneyRevealNavigation",{action:a,toStep:1,editorViewed:m==="edit"},{durationMs:Date.now()-t}),O("continued-to-guest-app",!1),s=null,e.remove(),G(1))}function M(e,t,a,i="mode-selected"){if(!e?.isConnected)return;t==="edit"&&O("edit-mode-selected",!0),m=t==="edit"?"edit":"guest";const r=e.querySelector("#mvrLiveLocation"),v=e.querySelector("[data-live-location-text]"),h=e.querySelector("#mvrLiveForward"),$=e.querySelector("#mvrContinueGuestApp"),j=e.querySelector("[data-live-forward-long]"),Q=h?.querySelector("b");r?.classList.toggle("is-editor",m==="edit"),v&&(v.textContent=m==="edit"?"Front Desk editor":F()),r&&r.setAttribute("aria-label",m==="edit"?"Front Desk editor":"Your live booking address"),j&&(j.textContent=m==="edit"?"Back to your booking page":"See how to edit your booking page"),Q&&(Q.textContent=m==="edit"?"↩":"→"),h&&h.setAttribute("aria-label",m==="edit"?"Back to your direct booking page":"See how you edit this booking page"),$&&($.hidden=!1),I(e,!0);const x=e.querySelector(".mvr-live-stage > iframe");if(x)if(x.title=m==="edit"?`${b()} Front Desk editor`:`${b()} booking-page preview`,m==="edit")x.src=ge();else{const L=new URL(B());if(e.dataset.editorSaved==="1"){L.searchParams.set("previewRefresh",String(Date.now()));const X=e.dataset.editorPreviewTarget==="checkout";L.searchParams.set("previewHighlight",X?"checkout-policy":e.dataset.editorHighlight||"header"),X?L.searchParams.set("previewCheckout","1"):e.dataset.editorHighlightRoom&&L.searchParams.set("previewHighlightRoom",e.dataset.editorHighlightRoom),delete e.dataset.editorSaved,delete e.dataset.editorHighlight,delete e.dataset.editorHighlightRoom,delete e.dataset.editorPreviewTarget}x.src=L.toString()}l("JourneyBookingPreviewModeChanged",{action:i,mode:m},{durationMs:Date.now()-a}),m==="edit"&&p("BookingEngineEditPreviewViewed")}function G(e){E();const t=o,a=Math.max(0,Math.min(3,e)),i=Date.now();P&&a!==t&&l("JourneyRevealStageCompleted",{revealStep:t,stageName:["booking-page","guest-app","front-desk-assistant","activation"][t]||"unknown",nextStep:a,direction:a>t?"forward":"back"},{durationMs:i-P}),o=a,P=i,be(),p(["BookingEngineRevealViewed","GuestAppRevealViewed","AssistantRevealViewed","ActivationOfferViewed"][o]),l("JourneyRevealStageViewed",{resumed:V,bookingPageReady:o===0?!!n.ready:void 0}),V=!1,y(),document.querySelector(".mvr-main")?.scrollTo({top:0,behavior:"auto"})}function De(){P&&l("JourneyRevealStageCompleted",{action:"reveal-finished",totalRevealMs:Y?Date.now()-Y:null},{durationMs:Date.now()-P}),S&&(window.clearTimeout(S),S=0),O("reveal-finished",!0),s=null,E(),document.getElementById("marketelValueReveal")?.remove(),document.documentElement.classList.remove("marketel-reveal-open"),document.body.style.overflow="",window.removeEventListener("message",re),d.settingsTourActive=!1;try{localStorage.removeItem(C),localStorage.removeItem(H),localStorage.setItem("settingsTourDone","1"),localStorage.setItem("onboardingDone","1")}catch{}he(),ie(!0),typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner(),typeof window.refreshGoLiveInlineCard=="function"&&window.refreshGoLiveInlineCard()}async function He(e){if(d.hotelSubscribed){De();return}if(typeof window.goLive=="function"){e.disabled=!0,e.textContent="Opening secure checkout…",p("ActivationCtaClicked");try{await window.goLive({billingInterval:f})}finally{document.body.contains(e)&&(e.disabled=!1,e.textContent=f==="year"?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month")}}}function E(){R&&(window.clearTimeout(R),R=0),A?.disconnect(),A=null}function U(e){g=!!e;const t=document.querySelector(".mvr-install-visual");t?.classList.toggle("is-installed",g);const a=document.getElementById("mvrInstallDemo");a&&(a.textContent=g?"Saved ✓":"Add",a.disabled=g);const i=t?.querySelector(".mvr-install-arrow span");i&&(i.textContent=g?"Saved to their Home Screen":"Tap Add to Home Screen")}function K(e,t=!1){E(),c=Number(e)===1?1:0;const a=document.querySelector(".mvr-install-visual");a&&(a.classList.toggle("is-slide-2",c===1),a.querySelectorAll(".mvr-app-carousel-slide").forEach((i,r)=>{i.setAttribute("aria-hidden",r===c?"false":"true")}),a.querySelectorAll(".mvr-app-carousel-dots button").forEach(i=>{const r=Number(i.dataset.mvrAppSlide)===c;i.classList.toggle("is-active",r),i.setAttribute("aria-current",r?"step":"false")}),a.querySelectorAll(".mvr-app-carousel-controls > button").forEach(i=>{i.disabled=Number(i.dataset.mvrAppSlide)===c}),c===1?U(!0):(U(!1),ne()),t&&p(c===1?"GuestAppValueSlideViewed":"GuestAppInstallSlideReplayed"),l("JourneyGuestAppDemo",{action:"slide-viewed",slide:c===1?"value":"install",manual:!!t}))}function oe(e=!1){g||c!==0||(E(),U(!0),e&&p("GuestAppInstallDemoClicked"),l("JourneyGuestAppDemo",{action:"install-demonstrated",manual:!!e}),R=window.setTimeout(()=>{o===1&&document.getElementById("marketelValueReveal")&&K(1,!1)},e?900:1200))}function ne(){if(E(),o!==1||c!==0)return;const e=document.querySelector(".mvr-install-visual");if(!e)return;const t=()=>{R||(R=window.setTimeout(()=>{o===1&&document.getElementById("marketelValueReveal")&&(g?K(1,!1):oe(!1))},g?900:1300))};"IntersectionObserver"in window?(A=new IntersectionObserver(a=>{a.some(i=>i.isIntersecting&&i.intersectionRatio>=.35)&&(A?.disconnect(),A=null,t())},{threshold:[.35]}),A.observe(e)):t()}function Te(){document.getElementById("mvrNext")?.addEventListener("click",()=>{l("JourneyRevealNavigation",{action:"next",toStep:o+1}),G(o+1)}),document.getElementById("mvrBack")?.addEventListener("click",()=>{l("JourneyRevealNavigation",{action:"back",toStep:o-1}),G(o-1)}),document.getElementById("mvrExpandPreview")?.addEventListener("click",Ee),document.getElementById("mvrFinalCta")?.addEventListener("click",e=>He(e.currentTarget)),document.querySelectorAll("[data-mvr-billing]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.mvrBilling==="year"?"year":"month";if(t!==f){f=t;try{localStorage.setItem(te,f)}catch{}p(t==="year"?"YearlyBillingSelected":"MonthlyBillingSelected"),l("JourneyBillingIntervalSelected",{billingInterval:f,price:f==="year"?1990:199,currency:"USD"}),y()}})}),document.getElementById("mvrInstallDemo")?.addEventListener("click",()=>{oe(!0)}),document.querySelectorAll("[data-mvr-app-slide]").forEach(e=>{e.addEventListener("click",()=>{const t=Number(e.dataset.mvrAppSlide)===1?1:0;t!==c&&K(t,!0)})}),document.querySelectorAll("[data-mvr-fallback]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.mvrFallback==="release"?"release":"confirm";t!==q&&(q=t,p(t==="release"?"AssistantReleaseFallbackSelected":"AssistantKeepFallbackSelected"),l("JourneyAssistantFallbackSelected",{noResponseAction:t}),typeof window.api=="function"&&window.api("POST","/api/crm/booking-approval",{noResponseAction:t}).catch(()=>{}),y())})}),ne()}async function se(){return D||typeof window.api!="function"||(D=Promise.all([window.api("GET","/api/crm/rooms"),window.api("GET","/api/crm/booking-approval").catch(()=>null)]).then(([e,t])=>(w={rooms:Array.isArray(e?.rooms)?e.rooms:[],rates:e?.rates||null},q=t?.data?.noResponseAction==="release"?"release":"confirm",w.rooms.length&&(d.editRooms=w.rooms),document.getElementById("marketelValueReveal")&&!document.getElementById("mvrLivePreview")&&y(),w)).catch(()=>w).finally(()=>{D=null})),D}async function le(){if(!(typeof window.api!="function"||!document.getElementById("marketelValueReveal"))){if(ae()){n={ready:!!B(),checking:!1,reason:"local",attempts:1,domain:""},B()&&(k=!1),l("JourneyBookingPageStatus",{ready:n.ready,reason:n.reason,attempts:n.attempts}),o===0&&!document.getElementById("mvrLivePreview")&&y();return}n.checking=!0,n.attempts+=1;try{const e=await window.api("GET","/api/crm/booking-page-status");n={ready:!!e?.ready,checking:!1,reason:String(e?.reason||""),attempts:n.attempts,domain:String(e?.domain||"")}}catch{n.checking=!1,n.reason="unreachable"}B()&&(k=!1),l("JourneyBookingPageStatus",{ready:n.ready,reason:n.reason,attempts:n.attempts}),o===0&&!document.getElementById("mvrLivePreview")&&y(),!(n.ready||n.reason==="deployment-disabled")&&n.attempts<10&&document.getElementById("marketelValueReveal")&&(S=window.setTimeout(le,6e3))}}function Me(e={}){if(document.getElementById("marketelValueReveal"))return;const t=Number(e.startAt);let a=0,i=!1;try{a=Number.parseInt(localStorage.getItem(H)||"0",10)}catch{}try{i=localStorage.getItem(C)==="1"}catch{}try{f=localStorage.getItem(te)==="year"?"year":"month"}catch{f="month"}if(o=Number.isFinite(t)?Math.max(0,Math.min(3,t)):Math.max(0,Math.min(3,Number.isFinite(a)?a:0)),d.hotelSubscribed&&o===3&&(o=0),m="guest",g=!1,c=0,W=!1,k=!1,Y=Date.now(),P=0,V=!Number.isFinite(t)&&i,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},S&&window.clearTimeout(S),S=0,E(),!d.hotelSubscribed)try{localStorage.setItem(C,"1"),localStorage.setItem(H,String(o))}catch{}try{localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep")}catch{}d.settingsTourActive=!0,window.addEventListener("message",re),document.documentElement.classList.add("marketel-reveal-open"),document.body.style.overflow="hidden",ie(!1);const r=document.createElement("div");r.id="marketelValueReveal",r.className="mvr-root",document.body.appendChild(r),y(),p("ValueRevealStarted",d.hotelSubscribed?"subscribed-replay":"pre-activation"),l("JourneyRevealStarted",{startStep:o,replay:!!d.hotelSubscribed,pendingResume:V}),G(o),se(),le()}function Fe(){try{return localStorage.getItem(C)==="1"}catch{return!1}}function xe(){try{localStorage.removeItem(C),localStorage.removeItem(H)}catch{}}const Ne={clearPendingMarketelValueReveal:xe,hasPendingMarketelValueReveal:Fe,showMarketelValueReveal:Me};function qe(){de(Ne)}export{xe as clearPendingMarketelValueReveal,Ne as default,Fe as hasPendingMarketelValueReveal,qe as install,Me as showMarketelValueReveal};
