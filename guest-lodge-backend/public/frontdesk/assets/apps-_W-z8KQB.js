import{f,e as N}from"./settings-n80yx0sy.js";const i={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",bookingNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_21-14-19_1_eckwlk.mp4",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4",frontdeskInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_19-49-38_1_tc1bzm.mp4",guestBroadcastVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/v1781196304/ScreenRecording_06-11-2026_19-41-56_1_kjgudg.mp4"},D="32px";function g(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function b(t){return`border-radius:${D};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function _(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let w=[],m=0;function q(t,e){y(!1),w=t,m=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=n=>{n.key==="ArrowRight"||n.key==="ArrowDown"?v(1):n.key==="ArrowLeft"||n.key==="ArrowUp"?v(-1):n.key==="Escape"&&$()},document.addEventListener("keydown",o._keyHandler);let a=0;o.addEventListener("touchstart",n=>{a=n.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",n=>{const p=n.changedTouches[0].clientX-a;Math.abs(p)>50&&v(p<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",I()}function $(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function v(t){const e=w.length;e<=1||(m=(m+t+e)%e,I())}function I(){const t=document.getElementById("appsLightbox");if(!t)return;const e=w[m],o=w.length,a=e.type!=="video",n=o>1?`${m+1} / ${o}`:"",p=a?`<img src="${_(e.src)}" alt="${e.alt||""}"
          ...
          ${e.poster?`poster="${g(e.poster,400)}"`:""}>
          <source src="${e.src}" type="video/mp4">
       </video>`,r=o>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",s=o>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",d=o>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:o},(c,l)=>`<div onclick="appsOpenLightbox(_appsLbItems,${l})" style="width:7px;height:7px;border-radius:50%;background:${l===m?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${d}
    </div>`}function h(t,e,o,a){return`<button type="button" class="apps-q" onclick="appsOpenLightbox(${o},${a})">
  ...
  </button>`}function P(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function F(){const t=document.getElementById("appsView");if(!t)return;const e=f.activeHotelName||"Your Hotel",o=f.activeHotelAppIcon||"",a=e.trim().charAt(0).toUpperCase()||"🏨",n=f.activeHotelDomain||"",p=n?"https://"+n:"#",r=n?"https://"+n+"/install":"#",s=r!=="#"?"https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(r):"",d=isStandaloneApp()||f.frontdeskInstalled,c=typeof Notification<"u"&&Notification.permission==="granted";let l;d&&c?l=`<div style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
  ...
  <div class="apps-page">
    ...
    <h2 class="apps-headline">Apps on your phone</h2>
    <p class="apps-intro">Save <strong>Front Desk</strong> to your home screen — your phone buzzes when someone books. Guests can save <strong>${e}</strong> the same way.</p>
    ...
    <div class="apps-step-card">
      ...
      <div class="apps-icon-card">
        <div id="appsAppIconPreview" style="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);background:${o?"#fff":"var(--green)"};color:#fff;font-size:24px;font-weight:800;">
          ${o?`<img src="${o}" alt="Hotel logo" style="width:100%;height:100%;object-fit:cover;">`:a}
        </div>
    ...
    <div class="apps-step-card">
      ...
      <button type="button" onclick="showCheckinQrOverlay()" style="width:100%;padding:13px;border-radius:12px;border:none;background:var(--green);color:#fff;font-family:inherit;font-size:14px;font-weight:700;cursor:pointer;">📲 Show check-in QR</button>
      ${r!=="#"?`
      <details class="apps-fold" style="margin-top:12px;margin-bottom:0;box-shadow:none;">
        ...
        <div class="apps-fold-body">
          <div style="display:flex;gap:14px;align-items:flex-start;flex-wrap:wrap;margin-top:12px;margin-bottom:12px;">
            ${s?`<img src="${s}" alt="Guest install QR" width="100" height="100" style="border-radius:10px;border:1px solid var(--border);flex-shrink:0;">`:""}
          ...
          <div style="background:var(--bg);border-radius:10px;padding:10px 12px;font-size:11px;color:var(--text-muted);line-height:1.45;">
    ...
    <details class="apps-fold">
      ...
      <div class="apps-fold-body">
        <div class="apps-q-list">
          ${h("When someone books you, your phone buzzes","",x(L),0)}
          ${h("What guests see on their phone","",x(E),0)}
          ${h("Guest texts you, you text back","",x(A),0)}
          ${h("How guests add your hotel","",x(H),0)}
          ${h("Your app and theirs — side by side","",x(j),0)}
          ${h("Put Front Desk on your phone","",x(B),0)}
        </div>
      </div>
    </details>
    ...
    <details class="apps-fold">
      ...
      <div class="apps-fold-body">
        ...
        <video autoplay loop muted playsinline webkit-playsinline preload="metadata" style="width:100%;max-width:240px;height:auto;display:block;margin:14px auto 0;${b()}" poster="${g(i.guestMessagesImg,360)}">
    ...
    <p class="apps-footnote">iPhone &amp; Android · no app store · no extra fees</p>
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),S()}async function S(){const t=document.getElementById("guestInstallStats");if(t)try{const e=await api("GET","/api/crm/guest-install-stats");if(!e.success)throw new Error(e.message||"Failed");const o=e.totals||{},a=e.installRatePercent!=null?e.installRatePercent:0,n=Object.entries(e.byTouchpoint||{}).filter(function(r){return r[1].views||r[1].installed}).sort(function(r,s){return(s[1].installed||0)-(r[1].installed||0)}).slice(0,5),p=n.length?n.map(function(r){const s=r[0].replace(/-/g," "),d=r[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+s+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(d.views||0)+" views · "+(d.installed||0)+" installed</span></div>"}).join(""):'<div style="font-size:12px;color:var(--text-muted);">No install activity yet — try the check-in QR at the desk.</div>';t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+a+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+(e.installedBookings||0)+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+(o.views||0)+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div><div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+p}catch{t.innerHTML='<div style="font-size:12px;color:var(--text-muted);">Install stats unavailable right now.</div>'}}let k=[],u=0;function y(t){const e=document.getElementById("appsTourLightbox");e&&(e._swipeStart&&e.removeEventListener("touchstart",e._swipeStart),e._swipeEnd&&e.removeEventListener("touchend",e._swipeEnd),e.remove()),document.body.style.overflow="",t&&localStorage.setItem("appsTourDone","1")}function T(t){const e=u+t;e<0||e>=k.length||(u=e,z())}function z(){const t=document.getElementById("appsTourLightbox");if(!t)return;const e=k[u],o=k.length,a=u>=o-1,n=`${u+1} / ${o}`,p=a?"Got it — show me":"Next →",r=Array.from({length:o},(d,c)=>`<div style="width:7px;height:7px;border-radius:50%;background:${c===u?"#fff":"rgba(255,255,255,0.35)"};"></div>`).join("");let s="";e.type==="cta"?s=`<div style="width:100%;max-width:320px;padding:0 8px;box-sizing:border-box;">${e.ctaHtml}</div>`:e.type==="video"?s=`<video autoplay loop muted playsinline webkit-playsinline preload="metadata"
      ...
      style="max-width:100%;max-height:min(50dvh,440px);width:auto;height:auto;display:block;object-fit:contain;${b()}">`,t.innerHTML=`
    ...
    <div style="flex-shrink:0;width:100%;max-width:400px;margin:0 auto;padding:12px 20px max(16px,env(safe-area-inset-bottom));box-sizing:border-box;text-align:center;">
      ...
      <div style="display:flex;gap:6px;justify-content:center;">${r}</div>
    </div>`,document.getElementById("appsTourNextBtn").onclick=()=>{if(a){y(!0);const d=document.getElementById("appsView");d&&d.scrollIntoView({behavior:"smooth",block:"start"})}else u++,z()},document.getElementById("appsTourSkipBtn").onclick=()=>y(!0)}function Y(t){if(!(t&&t.replay)&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox"))return;const o=f.activeHotelName||"Your Hotel",a=o.length>13?o.slice(0,13)+"…":o,n=o.trim().charAt(0).toUpperCase(),p=f.activeHotelAppIcon||"",r=p?`<img src="${p}" alt="${o}" style="width:52px;height:52px;border-radius:14px;object-fit:cover;">`:`<div style="width:52px;height:52px;border-radius:14px;background:#2E7D5B;color:#fff;font-size:22px;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;">${n}</div>`;k=[{type:"video",src:i.frontdeskInstallVideo,poster:g(i.frontdeskMessages,400),title:"Put Front Desk on your phone",caption:"You're on <strong>Front Desk</strong> right now. Save it to your home screen — works like an app, no app store. Same steps as <strong>Put Front Desk on my phone</strong> at the top of this page."},{type:"image",src:g(i.homeScreen,520),alt:"Two apps on home screen",title:"Your guests can save your hotel too",caption:`You get <strong>Front Desk</strong>. They get <strong>${o}</strong>. Both sit on the home screen — like real apps.`},{type:"video",src:i.guestInstallVideo,poster:g(i.guestHome,400),title:"How your guests save your hotel",caption:`They tap <strong>Add to Home Screen</strong> on your booking website. Upload your logo on this page so they see <strong>${a}</strong>.`},{type:"video",src:i.bookingNotifVideo,poster:g(i.homeScreen,400),title:"When someone books you, your phone buzzes",caption:"That's why you put Front Desk on your phone — you find out right away, before email, before Airbnb."},{type:"video",src:i.guestBroadcastVideo,poster:g(i.guestMessagesImg,400),title:"You can notify all your guests at once",caption:"Once they have your hotel on their phone, notify everyone — a sale, an event, or a check-in reminder. Scroll down on this page to try it."},{type:"cta",title:"Now do these two things",caption:"",ctaHtml:`
        ...
        </div>`}],u=0,$(),y(!1);const s=document.createElement("div");s.id="appsTourLightbox",s.style.cssText=["position:fixed;inset:0;z-index:102001;background:#000;","display:flex;flex-direction:column;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join("");let d=0;s._swipeStart=c=>{d=c.changedTouches[0].clientX},s._swipeEnd=c=>{const l=c.changedTouches[0].clientX-d;Math.abs(l)>50&&T(l<0?1:-1)},s.addEventListener("touchstart",s._swipeStart,{passive:!0}),s.addEventListener("touchend",s._swipeEnd,{passive:!0}),document.body.appendChild(s),document.body.style.overflow="hidden",z()}const G={appsCloseLightbox:$,appsCloudinaryFull:_,appsCloudinaryImg:g,appsLbNav:v,appsLbRender:I,appsOpenLightbox:q,appsPhoneImgStyle:b,appsQuestionRow:h,appsTourClose:y,appsTourNav:T,appsTourRender:z,detectAppPlatform:P,loadGuestInstallStats:S,renderAppsView:F,startAppsTour:Y};function C(){N(G)}export{G as default,C as install};
