import{c as r,a as ze,b as Ge,e as Be}from"./settings-BjIgv-Fo.js";function m(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function oe(...e){return m("ensureAppsViewRendered")?.(...e)}function ie(...e){return m("showFinaleMockModal")?.(...e)}function ae(...e){return m("finishTourHydration")?.(...e)}function ne(...e){return m("goLive")?.(...e)}function re(...e){return m("toast")?.(...e)}function _e(...e){return m("appsCloseLightbox")?.(...e)}let D=[],c=0,W=!1,A=null,F=null,N=null,S=null;function $e(){if(document.getElementById("frontdeskAppsTourStyle"))return;const e=document.createElement("style");e.id="frontdeskAppsTourStyle",e.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(e)}function w(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function se(){A&&(document.removeEventListener("keydown",A),A=null)}function Ae(e){se(),A=t=>{if(t.defaultPrevented)return;const o=t.target&&t.target.tagName?t.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||t.target?.isContentEditable||(t.key==="Escape"?(t.preventDefault(),e.onSkip?.()):t.key==="Enter"||t.key==="ArrowRight"?(t.preventDefault(),e.onNext?.()):t.key==="ArrowLeft"&&(t.preventDefault(),e.onBack?.()))},document.addEventListener("keydown",A)}function Ee(e,t){return!e||!e.isConnected||t?.noHighlight?null:(e.dataset.appsTourOrigVisibility||(e.dataset.appsTourOrigVisibility=e.style.visibility||""),S?.destroy(),S=Ge(e,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=t?.spotlightBoxShadow??"none",o.style.outline=t?.spotlightOutline??"none",o.style.outlineOffset=t?.spotlightOutlineOffset??"0",(e.classList.contains("apps-story-line")||t?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),S?.element||null)}function pe(e){const t=e||{};se(),N?.destroy(),N=null,S?.destroy(),S=null,F&&(clearTimeout(F),F=null);const o=document.getElementById("appsTourLightbox");o&&!t.keepLightbox&&o.remove();const a=document.getElementById("appsTourTooltip");a&&a.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function x(e){pe(),document.body.style.overflow="";const t=W;W=!1;try{const o=typeof oe=="function"?oe:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(e&&(localStorage.setItem("appsTourDone","1"),t||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive)){const a=typeof ie=="function"?ie:window.showFinaleMockModal;if(typeof a=="function"){a();return}}}function Le(e){const t=c+e;t<0||t>=D.length||(c=t,C())}function U(){if(localStorage.setItem("appsTourDone","1"),W||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive){r.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const t=typeof ae=="function"?ae:window.finishTourHydration;typeof t=="function"&&t()}}function Me(){U();const e=typeof ne=="function"?ne:window.goLive;if(x(!1),typeof e=="function"){e();return}const t=typeof re=="function"?re:window.toast;typeof t=="function"&&t("Open Go live to activate your booking page.","error")}function C(){$e();const e=D[c];if(!e){x(!0);return}const t=D.length,o=c>=t-1,a=`${c+1} / ${t}`,i=Math.max(8,Math.min(100,Math.round((c+1)/t*100))),n=document.querySelector(e.target);if(!n){c++,C();return}pe({keepLightbox:!0});let s=document.getElementById("appsTourLightbox");s||(s=document.createElement("div"),s.id="appsTourLightbox",s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(s)),e.noHighlight||(n.dataset.appsTourOrigPosition=n.style.position||"",n.dataset.appsTourOrigZIndex=n.style.zIndex||"",n.dataset.appsTourOrigIsolation=n.style.isolation||"",n.dataset.appsTourOrigBoxShadow=n.style.boxShadow||"",n.dataset.appsTourOrigOutline=n.style.outline||"",n.dataset.appsTourOrigOutlineOffset=n.style.outlineOffset||"",n.dataset.appsTourOrigTransition=n.style.transition||"",n.style.position=n.style.position||"relative",n.style.zIndex="100002",n.style.isolation="isolate",n.style.transition="box-shadow 0.18s ease, outline 0.18s ease",n.style.boxShadow=e.spotlightBoxShadow??"none",n.style.outline=e.spotlightOutline??"none",n.style.outlineOffset=e.spotlightOutlineOffset??"0",(n.classList.contains("apps-story-line")||e.hideSpotlightBorder)&&(n.dataset.appsTourOrigBorderTop=n.style.borderTop||"",n.dataset.appsTourOrigPaddingTop=n.style.paddingTop||"",n.style.borderTop="none",n.style.paddingTop="0"),n.setAttribute("data-apps-tour-highlighted","1"));const p=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,b=e.scrollBlock||"nearest",y=p?"auto":"smooth";n.scrollIntoView({behavior:y,block:b});const h=()=>{const d=document.getElementById("appsTourTooltip");d&&d.remove();const l=Math.min(370,window.innerWidth-28),f=e.primaryLabel||(o?"Done":"Next"),L=e.secondaryLabel||(o?"Not now":"Skip tour"),z=c<=0,V=e.kicker||"Guestel",u=document.createElement("div");u.id="appsTourTooltip",u.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${l}px;max-width:${l}px;visibility:hidden;`,u.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${w(e.title)}">
        ...
        <div class="apps-tour-actions">
          ...
          <button type="button" id="appsTourNextBtn" class="apps-tour-btn apps-tour-btn-primary">${w(f)}</button>
        </div>
      </div>`,document.body.appendChild(u),Ee(n,e);const ee=u.querySelector(".apps-tour-panel");N?.destroy(),N=ze({tooltip:u,panel:ee,target:n,anchor:n,spotlight:S,options:{preferredPlacement:e.tooltipPosition||"auto",maxWidth:l,gap:e.tooltipGap??10,autoScroll:!0,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),u.style.visibility="visible";const M=()=>{if(e.activateOnNext){Me();return}if(o){U(),x(!1),e.openGuestInstallCoachOnNext&&window.setTimeout(()=>m("appsOpenGuestInstallCoach")?.(),0);return}c++,C()},G=()=>{if(o){U(),x(!1);return}x(!0)},O=()=>{c<=0||(c--,C())};document.getElementById("appsTourNextBtn").onclick=M,document.getElementById("appsTourSkipBtn").onclick=G;const H=document.getElementById("appsTourBackBtn");H&&(H.onclick=O),Ae({onNext:M,onBack:O,onSkip:G})};F=setTimeout(()=>{requestAnimationFrame(h)},p?40:320)}function Oe(e){const t=e&&e.replay,o=e&&e.chainFromSettingsTour;if(!t&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;_e(),x(!1),W=!!o;const a=!!r.hotelSubscribed;D=!!m("isNativeFrontdeskApp")?.()||document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1"?[{target:"#tour-guest-reach",kicker:"Guestel updates",title:"Reach guests who choose to hear from you.",text:"Guests who keep your property in Guestel and allow property updates can receive a notification from you.",tooltipPosition:"above"},{target:"#tour-native-guest-share",kicker:"Invite guests",title:"Give them one Guestel link.",text:"Show the QR or copy the Guestel link. Guests can book immediately, then keep your property and stay in Guestel.",tooltipPosition:"above"},{target:"#tour-guest-icon-section",kicker:"Make it yours",title:"Choose how your property appears.",text:"Use your logo or a clear property photo for your Guestel card.",scrollBlock:"start",tooltipPosition:"below"}]:[{target:"#tour-apps-intro",kicker:"The loop",title:"One system with a clear side for you and for guests.",text:"You use Marketel Front Desk. Guests use Guestel and your direct booking experience."},{target:"#tour-apps-first",kicker:"Your side",title:"Download Marketel Front Desk.",text:"The owner app receives new-booking alerts even when the web dashboard is closed. Guests do not download this app.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-then",kicker:"Their side",title:"Guests keep your property in Guestel.",text:"They tap Add on your booking page. Guestel keeps your property, reservations, and messages together.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-after",kicker:"Direct reach",title:"Send a notification to their phone whenever you want.",text:"Anyone who keeps your property in Guestel and opts into property updates becomes reachable from Marketel Front Desk.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the Guestel card feel like your property.",text:"Use a real logo or a clear property photo.",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10},{target:"#tour-apps-loop",kicker:a?"Live loop":"Activation",title:a?"This loop is on.":"Everything is ready to turn on.",text:a?"Guests book, keep your property in Guestel, receive opted-in updates, and message you. Front Desk gets the alerts.":"For $199/month, guests can book direct, keep your property in Guestel, receive opted-in updates, and message you — while Front Desk receives the alerts.",primaryLabel:a?"Done":"Activate everything — $199/month",secondaryLabel:a?"Close":"Keep exploring",activateOnNext:!a,tooltipPosition:"below",tooltipGap:8}],c=0,C()}const g={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},He="32px";function K(e,t){return e.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(t||400)+"/")}function Y(e){return`border-radius:${He};box-shadow:0 10px 36px rgba(0,0,0,0.22);${e||""}`}function le(e){const t=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*t,1600));return e.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let j=[],T=0,q="ios26",I=null,de="",E=null;function Fe(e,t){x(!1),isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),j=e,T=t||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?P(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?P(-1):i.key==="Escape"&&Q()},document.addEventListener("keydown",o._keyHandler);let a=0;o.addEventListener("touchstart",i=>{a=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const n=i.changedTouches[0].clientX-a;Math.abs(n)>50&&P(n<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",X()}function Q(){const e=document.getElementById("appsLightbox");e&&(document.removeEventListener("keydown",e._keyHandler),e.remove(),document.body.style.overflow="",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState()))}function P(e){const t=j.length;t<=1||(T=(T+e+t)%t,X())}function X(){const e=document.getElementById("appsLightbox");if(!e)return;const t=j[T],o=j.length,a=t.type!=="video",i=o>1?`${T+1} / ${o}`:"",n=a?`<img src="${le(t.src)}" alt="${t.alt||""}"
          ...
          ${t.poster?`poster="${K(t.poster,400)}"`:""}>
          <source src="${t.src}" type="video/mp4">
       </video>`,s=o>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",p=o>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",b=o>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:o},(y,h)=>`<div onclick="appsOpenLightbox(_appsLbItems,${h})" style="width:7px;height:7px;border-radius:50%;background:${h===T?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";e.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${b}
    </div>`}function ce(){return`<svg viewBox="169 8.5 21 25.5" focusable="false" aria-hidden="true">
  ...
  </svg>`}function ge(){return`<svg viewBox="45 41.5 19 6" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Pe(){return`<svg viewBox="44 39.5 21 13" focusable="false" aria-hidden="true">
  ...
  </svg>`}function De(){return`<svg viewBox="0 0 28 28" focusable="false" aria-hidden="true">
  ...
  </svg>`}function We(e,t){const o=[...e?[{label:"More",icon:ge()}]:[],{label:"Share",icon:ce()},...t?[{label:"View More",icon:Pe()}]:[],{label:"Add to Home Screen",icon:De()}];return`<div class="agic-sequence" aria-label="${o.map(a=>a.label).join(", then ")}">
  ...
  </div>`}function ue(){const e=q==="ios26",t=I==="compact",i=e&&!I?`
    <div class="agic-content agic-choice">
      ...
      <button type="button" onclick="appsGuestInstallCoachSelectLayout('compact')">
        <span class="agic-choice-glyph">${ge()}</span>
    ...
    <section class="agic-sheet" role="dialog" aria-modal="true" aria-label="How guests save your property to their Home Screen">
      <div class="agic-header">
        ${e&&I?'<button type="button" onclick="appsGuestInstallCoachSelectLayout(null)" aria-label="Back">‹</button>':"<span></span>"}
      ...
      ${i}
    </section>`}function he(){const e=document.getElementById("appsGuestInstallCoach");e&&(e.innerHTML=ue())}function Ne(){x(!1),Q(),document.getElementById("appsGuestInstallCoach")?.remove(),q="ios26",I=null,de=document.body.style.overflow,document.body.style.overflow="hidden",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),E=t=>{t.key==="Escape"&&fe()},document.addEventListener("keydown",E);const e=document.createElement("div");e.id="appsGuestInstallCoach",e.innerHTML=ue(),document.body.appendChild(e)}function fe(){E&&(document.removeEventListener("keydown",E),E=null),document.getElementById("appsGuestInstallCoach")?.remove(),document.body.style.overflow=de,isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState())}function je(e){q=e==="classic"?"classic":"ios26",I=q==="classic"?"standard":null,he()}function qe(e){I=["standard","compact"].includes(e)?e:null,he()}function xe(e,t){const o=e||"Video";return`<span class="${"apps-media-badge"+(t==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function $(e,t,o,a,i){const n=i?xe("Video"):"",s=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${a})">
    <div class="apps-q-text">
      <div class="apps-q-title">${e}${n}</div>
      ${t?`<div class="apps-q-hint">${t}</div>`:i?'<div class="apps-q-hint">Tap to watch — about 1 min</div>':""}
    </div>
    ${s}
  </button>`}function Ve(){const e=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(e)&&!window.MSStream?"ios":/android/i.test(e)?"android":"ios"}function k(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function me(){return String(r.guestelWalletSubtitle||r.activeHotelContext?.address||"Direct booking").trim()}function be(){const e=document.getElementById("guestelWalletSubtitleInput"),t=String(e?.value||me()).trim()||"Direct booking",o=document.getElementById("guestelWalletPreviewSubtitle");o&&(o.textContent=t);const a=document.getElementById("guestelWalletSubtitleCount");a&&(a.textContent=`${String(e?.value||"").length}/64`)}async function Re(){const e=document.getElementById("guestelWalletSubtitleInput"),t=document.getElementById("guestelWalletSubtitleSave"),o=String(e?.value||"").replace(/\s+/g," ").trim().slice(0,64);t&&(t.disabled=!0);try{const a=await api("POST","/api/crm/guestel-wallet-card",{subtitle:o});if(!a?.success)throw new Error(a?.message||"Could not save the Guestel card.");r.guestelWalletSubtitle=String(a.subtitle||"").trim(),e&&(e.value=r.guestelWalletSubtitle||String(a.fallbackSubtitle||"").trim()),be(),toast("Guestel card updated.","success")}catch(a){toast(a?.message||"Could not save the Guestel card.","error")}finally{t&&(t.disabled=!1)}}function Z(e){const t=document.getElementById("guestelWalletPreviewImage");if(!t)return;const o=String(e||"").trim();t.classList.toggle("has-image",!!o),t.innerHTML=o?`<img src="${k(o)}" alt="Guestel wallet cover">`:"<span>Choose a cover photo</span>";const a=document.getElementById("guestelWalletImageRemove");a&&(a.hidden=!o)}async function Ue(e){const t=e?.files?.[0];if(!t)return;const o=document.getElementById("guestelWalletImageButton"),a=r.guestelWalletImageUrl;o&&(o.disabled=!0,o.textContent="Uploading…");const i=new FormData;i.append("image",t);try{const n=new URLSearchParams;r.activeHotelId&&n.set("hotelId",r.activeHotelId);const s=await fetch(`/api/crm/guestel-wallet-image?${n}`,{method:"POST",headers:{"x-crm-token":r.token,...isNativeFrontdeskApp()?{"x-marketel-client":"ios"}:{}},body:i}),p=await s.json();if(!s.ok||!p?.success||!p.imageUrl)throw new Error(p?.message||"Could not update the Guestel cover.");r.guestelWalletImageUrl=p.imageUrl,Z(p.imageUrl),toast("Guestel cover updated.","success")}catch(n){Z(a),toast(n?.message||"Could not update the Guestel cover.","error")}finally{e.value="",o&&(o.disabled=!1,o.textContent=r.guestelWalletImageUrl?"Change cover":"Choose cover")}}async function Ye(){const e=document.getElementById("guestelWalletImageRemove");e&&(e.disabled=!0);try{const t=await api("DELETE","/api/crm/guestel-wallet-image");if(!t?.success)throw new Error(t?.message||"Could not reset the Guestel cover.");r.guestelWalletImageUrl="",Z("");const o=document.getElementById("guestelWalletImageButton");o&&(o.textContent="Choose cover"),toast("Guestel will use your first room photo.","success")}catch(t){toast(t?.message||"Could not reset the Guestel cover.","error")}finally{e&&(e.disabled=!1)}}function Ze(e){const t=document.getElementById("appsView");if(!t)return;const o=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",a=(r.activeHotelId||"")+"|"+(r.activeHotelAppIcon||"")+"|"+(r.activeHotelDomain||"")+"|"+(r.guestelWalletImageUrl||"")+"|"+(r.guestelWalletSubtitle||"")+"|"+(o?"native-preview":"standard");e||t.dataset.appsKey!==a||!t.querySelector(".apps-page")?(ye(),t.dataset.appsKey=a):(isNativeFrontdeskApp()||o)&&J()}function ye(){const e=document.getElementById("appsView");if(!e)return;const t=r.activeHotelName||"Your Property",o=r.activeHotelAppIcon||"",a=t.trim().charAt(0).toUpperCase()||"P",i=r.activeHotelDomain||"",n=i?"https://"+i:"#",s=r.activeHotelId?`https://clip.mktel.co/clip/${encodeURIComponent(r.activeHotelId)}?intent=book&ref=frontdesk-guestel`:n;function p(Ie){return JSON.stringify(Ie).replace(/"/g,"&quot;")}const b=K(g.guestHome,520),y=[{type:"image",src:g.homeScreen,alt:"Owner and guest Home Screens",title:"Two different actions. Two different phones.",caption:`You download <strong>Marketel Front Desk</strong> from the App Store. Guests never download Front Desk; they save <strong>${t}</strong> from your booking page.`}],h=[{type:"image",src:g.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:g.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:g.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],v=[{type:"video",src:g.guestInstallVideo,poster:g.guestHome,alt:"Guest adds property to phone",title:"How guests put your property on their phone",caption:"They open your booking page and tap <strong>Add to Home Screen</strong>. Your property gets its own icon. No App Store is involved."}],d=[{type:"image",src:g.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:"Like “How do I connect to WiFi?” — they message you from the property they saved."},{type:"image",src:g.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Guest Reach</strong> in Marketel Front Desk, choose the conversation, and reply."},{type:"video",src:g.guestMessageNotifVideo,poster:g.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],l=isStandaloneApp(),f=isNativeFrontdeskApp(),L=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",z=f||L,V=String(r.nativeNotificationState||""),u=L||V==="registered",M=f?u:(f?u:l)&&typeof Notification<"u"&&Notification.permission==="granted";Number(r.bookingReviewSettings?.reminderMinutes??15),f||l&&M||l||String(r.frontdeskAppStoreUrl||"").trim();const G="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",O=o?G+"background:#fff;border:1px solid var(--border);padding:0;":G,H=o?`<img src="${o}" alt="Property logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${a}</span>`,we=`
    <div class="apps-icon-card">
      <div id="appsAppIconPreview" style="${O}">
        ${H}
      </div>
      <div style="flex:1;min-width:0;">
        ...
        <button type="button" id="tour-guest-icon-btn" onclick="${l?"document.getElementById('appsAppIconInput').click()":"toast('Download Marketel Front Desk first. Then you can change the property image guests see in Guestel.', 'error')"}" style="padding:10px 16px;border-radius:10px;border:1.5px solid var(--green);background:none;color:var(--green);font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${o?"Change picture":"Upload picture"}</button>
        ${l?"":'<div style="font-size:11px;color:var(--text-muted);margin-top:8px;line-height:1.4;">Download Marketel Front Desk first to change this icon.</div>'}
      </div>
    </div>`;s!=="#"&&`${s.replace("https://","")}`,`${b}${p(v)}${$("What guests see on their phone","",p(h),0,!1)}${$("How guests save your property","",p(v),0,!0)}${$("Guest texts you, you text back","",p(d),0,!0)}${$("Your owner app and their saved property","",p(y),0,!1)}`,n!=="#"&&`${n}`;const ke=()=>`
    <div class="apps-step-card" id="tour-guest-icon-section">
      ...
      ${we}
    </div>`,R=me(),B=String(r.guestelWalletImageUrl||"").trim(),Se=`
    <div class="apps-step-card" id="tour-native-guest-share">
      ...
      <div class="guestel-wallet-editor">
        <div class="guestel-wallet-card" aria-label="Preview of ${k(t)} in Guestel">
          <div class="guestel-wallet-cover${B?" has-image":""}" id="guestelWalletPreviewImage">${B?`<img src="${k(B)}" alt="Guestel wallet cover">`:"<span>Choose a cover photo</span>"}</div>
          <div class="guestel-wallet-copy">
            <strong>${k(t)}</strong>
            <span id="guestelWalletPreviewSubtitle">${k(R)}</span>
          </div>
        </div>
        ...
        <div class="guestel-wallet-actions">
          <button type="button" id="guestelWalletImageButton" onclick="document.getElementById('guestelWalletImageInput').click()">${B?"Change cover":"Choose cover"}</button>
          <button type="button" id="guestelWalletImageRemove" class="quiet" onclick="resetGuestelWalletImage()"${B?"":" hidden"}>Use room photo</button>
        </div>
        ...
        <div class="guestel-wallet-field">
          <input id="guestelWalletSubtitleInput" maxlength="64" value="${k(R)}" placeholder="Location or a short reason to book direct" oninput="updateGuestelWalletPreview()">
          <span id="guestelWalletSubtitleCount">${R.length}/64</span>
        </div>
    ...
    ${ke()}`,_=!!String(r.frontdeskAppStoreUrl||"").trim(),Te=z?Ce:`
    <section style="min-height:52vh;display:grid;place-items:center;padding:34px 0;">
      <div style="width:min(100%,430px);padding:28px 24px;border:1.5px solid var(--border);border-radius:22px;background:#fff;text-align:center;box-shadow:0 14px 40px rgba(26,43,34,.09);">
        ...
        <button type="button" onclick="openFrontdeskAppDownload()" ${_?"":'aria-disabled="true"'} style="width:100%;min-height:50px;border:0;border-radius:13px;background:${_?"var(--green)":"#dce8e1"};color:${_?"#fff":"#527061"};font-family:inherit;font-size:15px;font-weight:800;cursor:${_?"pointer":"default"};">${_?"Download Marketel Front Desk":"Front Desk app coming soon"}</button>
      </div>
    </section>`,te=z?"":l?"Front Desk is installed. Guests use Guestel; owners use Marketel Front Desk.":"You use Marketel Front Desk. Guests use Guestel.";e.innerHTML=`
  <style>
  ...
  <div class="apps-page">
    ...
    ${te?`<p class="apps-footnote">${te}</p>`:""}

  </div>`,typeof lucide<"u"&&lucide.createIcons(),z&&(r.guestMessages.length?renderMessages():loadMessages(),J(),ve())}async function ve(){try{const e=await api("GET","/api/crm/booking-review-settings");if(!e?.success||!e.data)return;r.bookingReviewSettings=e.data;const t=document.getElementById("bookingReviewReminderSelect");t&&(t.value=String(e.data.reminderMinutes))}catch{}}async function Ke(e){const t=String(r.bookingReviewSettings?.reminderMinutes??15),o=parseInt(e?.value,10);if([0,15,30,60].includes(o)){e&&(e.disabled=!0);try{const a=await api("POST","/api/crm/booking-review-settings",{reminderMinutes:o});if(!a?.success)throw new Error(a?.message||"Could not save reminder timing.");r.bookingReviewSettings=a.data,toast(o===0?"Booking reminders off — the first alert will still arrive.":`Booking reminders set for every ${o===60?"hour":o+" minutes"}.`,"success")}catch(a){e&&(e.value=t),toast(a?.message||"Could not save reminder timing.","error")}finally{e&&(e.disabled=!1)}}}async function J(){const e=document.getElementById("guestInstallStats");try{const t=await api("GET","/api/crm/guest-install-stats");if(!t.success)throw new Error(t.message||"Failed");if(r.guestPushSubscriberCount=t.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!e)return;const o=t.totals||{},a=t.installedBookings||0,i=o.views||0,n=o.notification_prompts||0,s=t.guestPushSubscribers||0,p=t.guestelSavedDevices||0,b=t.guestelBroadcastSubscribers||0;if(!a&&!i&&!t.guestelSavedDevices&&!t.guestelBroadcastSubscribers){e.style.display="none",e.innerHTML="";return}e.style.display="block";const y=t.installRatePercent!=null?t.installRatePercent:0,h=Object.entries(t.byTouchpoint||{}).filter(function(d){return d[1].views||d[1].installed}).sort(function(d,l){return(l[1].installed||0)-(d[1].installed||0)}).slice(0,5),v=h.length?h.map(function(d){const l=d[0].replace(/-/g," "),f=d[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+l+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(f.views||0)+" views · "+(f.installed||0)+" installed</span></div>"}).join(""):"";e.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guestel activity</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+p+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">devices keeping your property</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+b+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">Guestel devices opted into updates</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">total reachable devices</div></div></div>'+(a||i||y?'<div style="font-size:10px;color:var(--text-muted);line-height:1.45;margin:-2px 0 10px;">Legacy Home Screen activity remains supported for existing installs: '+a+" confirmed installs · "+i+" install views · "+y+"% of recent bookings.</div>":"")+(n?'<div style="font-size:11px;color:var(--text-muted);margin:-2px 0 10px;">Notification permission: '+(o.notification_granted||0)+" granted · "+(o.notification_denied||0)+" denied · "+(o.notification_dismissed||0)+" dismissed · "+(o.notification_failed||0)+" failed</div>":"")+(v?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+v:"")}catch{r.guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),e&&(e.style.display="none",e.innerHTML="")}}const Qe={appsCloseLightbox:Q,appsCloseGuestInstallCoach:fe,appsCloudinaryFull:le,appsCloudinaryImg:K,appsLbNav:P,appsLbRender:X,appsOpenLightbox:Fe,appsOpenGuestInstallCoach:Ne,appsPhoneImgStyle:Y,appsQuestionRow:$,appsGuestInstallCoachSelectLayout:qe,appsGuestInstallCoachSetVersion:je,appsTourClose:x,appsTourNav:Le,appsTourRender:C,appsVideoBadgeHtml:xe,detectAppPlatform:Ve,ensureAppsViewRendered:Ze,loadBookingReviewSettings:ve,loadGuestInstallStats:J,renderAppsView:ye,resetGuestelWalletImage:Ye,saveBookingReviewReminderSetting:Ke,saveGuestelWalletCard:Re,startAppsTour:Oe,updateGuestelWalletPreview:be,uploadGuestelWalletImage:Ue};function ot(){Be(Qe)}export{Qe as default,ot as install};
