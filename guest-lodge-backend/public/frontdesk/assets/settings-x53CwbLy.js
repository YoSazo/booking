const u={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,frontdeskInstallReported:!1,guestPushSubscriberCount:0,bookingReviewSettings:{reminderMinutes:15,maxReminders:3},bookingConflicts:[],_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let Q=null;function Je(){return typeof lucide<"u"?Promise.resolve():Q||(Q=new Promise((t,e)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>t(),o.onerror=()=>e(new Error("lucide load failed")),document.head.appendChild(o)}),Q)}async function Ut(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let r=e.width,n=e.height;const a=Math.min(1,o/r,i/n);r=Math.round(r*a),n=Math.round(n*a);const s=document.createElement("canvas");s.width=r,s.height=n,s.getContext("2d").drawImage(e,0,0,r,n),e.close();const c=await new Promise((b,k)=>{s.toBlob(S=>S?b(S):k(new Error("encode failed")),"image/webp",.82)}),f=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([c],f+".webp",{type:"image/webp"})}catch{return t}}function Ze(){const t=()=>{u.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}const Vt=["cancelled","canceled","released"];function Xe(t){return t?Vt.includes(String(t.status||"").trim().toLowerCase()):!0}function Gt(t){Object.assign(window,t)}const Yt=14,_t=10;function pt(t,e,o){return Math.max(e,Math.min(t,o))}function C(t,e,o,i){return{left:t,top:e,width:o,height:i,right:t+o,bottom:e+i}}function Wt(){const t=window.visualViewport,e=t?t.offsetLeft:0,o=t?t.offsetTop:0,i=t?t.width:window.innerWidth,r=t?t.height:window.innerHeight;return C(e,o,i,r)}function M(t){if(!t||!t.isConnected)return null;const e=t.getBoundingClientRect();return e.width<2||e.height<2?null:C(e.left,e.top,e.width,e.height)}function Kt(t,e){if(!t||!e)return 0;const o=Math.max(0,Math.min(t.right,e.right)-Math.max(t.left,e.left)),i=Math.max(0,Math.min(t.bottom,e.bottom)-Math.max(t.top,e.top));return o*i}function Qt(t,e){return Math.max(0,e.left-t.left)+Math.max(0,t.right-e.right)+Math.max(0,e.top-t.top)+Math.max(0,t.bottom-e.bottom)}function Jt(t,e){let o=0;for(const i of e||[]){const r=document.querySelector(i);if(!r||getComputedStyle(r).display==="none")continue;const n=M(r);!n||n.bottom<t.bottom-2||n.top>=t.bottom||(o=Math.max(o,t.bottom-n.top))}return o}function Zt(t){const e=Wt(),o=t.margin??Yt,i=Math.max(Number(t.bottomInset||0),Jt(e,t.avoidBottomSelectors)),r=e.left+o+Number(t.leftInset||0),n=e.top+o+Number(t.topInset||0),a=e.right-o-Number(t.rightInset||0),s=e.bottom-o-i;return C(r,n,Math.max(1,a-r),Math.max(1,s-n))}function Xt(t){return t==="above"||t==="top"?["top","bottom","right","left"]:t==="right"?["right","left","bottom","top"]:t==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function te(t,e,o,i,r){return t==="top"?C(e.left+(e.width-o)/2,e.top-i-r,o,i):t==="right"?C(e.right+r,e.top+(e.height-i)/2,o,i):t==="left"?C(e.left-o-r,e.top+(e.height-i)/2,o,i):C(e.left+(e.width-o)/2,e.bottom+r,o,i)}function ee(t,e){const o=pt(t.left,e.left,Math.max(e.left,e.right-t.width)),i=pt(t.top,e.top,Math.max(e.top,e.bottom-t.height));return C(o,i,t.width,t.height)}function oe(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function ie(t,e){if(!t||Math.abs(e)<1)return!1;const o=oe(t);return o?o.scrollTop+=e:window.scrollBy({top:e,left:0,behavior:"auto"}),!0}function lt(t,e){const o=M(t);if(!o||e.height<60)return!1;let i;return o.height<=e.height?i=pt(o.top,e.top,e.bottom-o.height):i=e.bottom-o.height,ie(t,o.top-i)}function Tt(t,e){const o=getComputedStyle(t);for(const n of o)e.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=t.children,r=e.children;for(let n=0;n<i.length;n+=1)r[n]&&Tt(i[n],r[n])}function ne(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function re(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((r,n)=>{const a=i[n];a&&(r.type==="checkbox"||r.type==="radio"?a.checked=r.checked:a.value=r.value)})}function ae(t,e={}){if(!t||!t.isConnected||e.disabled||!M(t))return null;const i=t.cloneNode(!0);ne(i),Tt(t,i),re(t,i),i.setAttribute(e.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(e.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",e.prepareClone?.(i,t);const r=t.style.visibility;e.hideSource&&(t.style.visibility="hidden"),document.body.appendChild(i);const n=()=>{const s=M(t);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),e.hideSource&&(t.style.visibility=r)};return n(),{element:i,source:t,update:n,destroy:a}}function se({tooltip:t,panel:e,target:o,anchor:i,spotlight:r,options:n={}}){if(!t||!e||!o)return null;let a=0,s=!1,c=!1,f=!1,b="";const k=(d=!0)=>{if(s||!t.isConnected||!o.isConnected)return null;const p=Zt(n),v=`${p.left}:${p.top}:${p.width}:${p.height}`;b&&b!==v&&(c=!1,d=!0),b=v;const l=M(i)||M(o),m=M(o);if(!l||!m)return null;const x=Math.min(Number(n.maxWidth||380),p.width);t.style.position="fixed",t.style.right="auto",t.style.bottom="auto",t.style.width=`${x}px`,t.style.maxWidth=`${x}px`,t.style.margin="0",t.style.justifyContent="flex-start",e.style.maxHeight=`${Math.max(120,p.height)}px`;const y=Math.min(e.offsetHeight||t.offsetHeight||190,p.height),h=Number(n.gap??_t);d&&!c&&n.autoScroll!==!1&&m.height+y+h<=p.height&&(c=lt(o,p),c&&requestAnimationFrame(()=>k(!1)));const w=Xt(n.preferredPlacement).map((z,O)=>{const U=te(z,l,x,y,h),Et=Qt(U,p),St=Kt(U,m);return{placement:z,index:O,raw:U,overflow:Et,overlap:St,score:Et*1e5+St*100+O}}),T=w.find(z=>z.overflow<.5&&z.overlap<1),B=T||w.slice().sort((z,O)=>z.score-O.score)[0],I=n.forceDock===!0||!T;let A="floating",F;if(I){A="docked";const z=Math.min(y,Number(n.dockMaxHeight||Math.max(180,p.height*.42)),p.height);e.style.maxHeight=`${z}px`;const O=Math.min(e.offsetHeight||z,z);if(F=C(p.left+(p.width-x)/2,p.bottom-O,x,O),d&&!c&&n.autoScroll!==!1){const U=C(p.left,p.top,p.width,Math.max(60,F.top-h-p.top));c=lt(o,U),c&&requestAnimationFrame(()=>k(!1))}}else if(F=ee(B.raw,p),d&&!c&&n.autoScroll!==!1){let z=p;if(B.placement==="bottom")z=C(p.left,p.top,p.width,Math.max(60,F.top-h-p.top));else if(B.placement==="top"){const O=F.bottom+h;z=C(p.left,O,p.width,Math.max(60,p.bottom-O))}c=lt(o,z),c&&requestAnimationFrame(()=>k(!1))}return t.dataset.tourLayoutMode=A,t.dataset.tourPlacement=I?"bottom-dock":B.placement,t.style.left=`${F.left}px`,t.style.top=`${F.top}px`,r?.update?.(),n.onLayout?.({mode:A,placement:t.dataset.tourPlacement,viewport:p,targetRect:M(o),anchorRect:M(i)||M(o),tooltipRect:F}),{mode:A,placement:t.dataset.tourPlacement,rect:F}},S=(d=!1)=>{f=f||d===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const p=f;f=!1,k(p)}))},P=()=>{c=!1,S(!0)},H=typeof ResizeObserver=="function"?new ResizeObserver(S):null;H?.observe(o),i&&i!==o&&H?.observe(i),H?.observe(e),window.addEventListener("resize",P),window.addEventListener("orientationchange",P),window.addEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",P),window.visualViewport.addEventListener("scroll",S));const dt=()=>{s=!0,a&&cancelAnimationFrame(a),H?.disconnect(),window.removeEventListener("resize",P),window.removeEventListener("orientationchange",P),window.removeEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",P),window.visualViewport.removeEventListener("scroll",S))},g=k(!0);return{destroy:dt,reposition:()=>k(!1),result:g}}function j(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function et(...t){return j("setFilter")?.(...t)}function de(...t){return j("toast")?.(...t)}function ot(...t){return j("updateGoLiveBanner")?.(...t)}function le(...t){return j("seedTourRevenueShell")?.(...t)}function ce(...t){return j("finishTourHydration")?.(...t)}function pe(...t){return j("goLive")?.(...t)}let _=null,it=null,q=null;function $(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
    #tourBlurOverlay {
  ...
  `,document.head.appendChild(t)}function ft(){_&&(document.removeEventListener("keydown",_),_=null)}function ue(t){ft(),_=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",_)}function ct(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function R(t){$();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=e.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=e.blockPointer?"auto":"none",e.lockScroll&&(document.body.style.overflow="hidden"),o}const Z="rgba(17,24,39,0.42)";function V(){const t=document.getElementById("tourTooltip"),e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!t||e)return Promise.resolve();t.style.pointerEvents="none";const o=t.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function ge(t,e){return q?.destroy(),q=ae(t,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=e?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=e?.spotlightOutlineOffset??"2px",e?.spotlightBackground&&(o.style.background=e.spotlightBackground,o.style.backgroundColor=e.spotlightBackground),e?.spotlightBorderRadius&&(o.style.borderRadius=e.spotlightBorderRadius)}}),q?.element||null}function D(t){const e=t||{};ft(),it?.destroy(),it=null,q?.destroy(),q=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!e.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.style.opacity=n.dataset.tourOrigOpacity||"";const a=n.dataset.tourOrigBackground||"",s=n.dataset.tourOrigBackgroundColor||"";s?n.style.backgroundColor=s:n.style.removeProperty("background-color"),a?n.style.background=a:n.style.removeProperty("background"),n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius,delete n.dataset.tourOrigOpacity});const r=document.getElementById("goLiveBanner");r&&r.dataset.tourHidden&&(delete r.dataset.tourHidden,typeof ot=="function"&&ot()),e.keepOverlay||(document.body.style.overflow="")}function me(){const t=document.getElementById("tourTooltip"),e=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[t,...e,...o].filter(Boolean);return!i.length&&!o.length?(D({keepOverlay:!0}),Promise.resolve()):(ft(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(D({keepOverlay:!0}),Promise.resolve()):(t&&(t.style.pointerEvents="none"),i.forEach(n=>{n.style.transition="opacity 0.07s ease, transform 0.07s ease",n.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(n=>{n.style.opacity="0",n.id==="tourTooltip"&&(n.style.transform="translateY(4px)")})}),new Promise(n=>{setTimeout(()=>{D({keepOverlay:!0}),n()},85)})))}function fe(t){const e=[t,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);e.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{e.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function N(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function L(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function G(t,e){if(e.highlightSelector){const o=L(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function X(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const r=document.querySelector(i);if(r&&r.isConnected)return r}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function nt(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function zt(t,e){const o=L(t.anchorSelector);if(o){const i=nt(o,!0);if(i)return i}return nt(e,!0)}function Bt(t,e){const o=t.tooltipAnchorSelector||t.anchorSelector,i=L(o);if(i){const r=nt(i,!0);if(r)return r}return zt(t,e)}function rt(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const r=document.querySelector(i);r&&(r.scrollTop=0)})}function It(t,e,o){const i=o||{},r=e.scrollTarget||e.accordionCard,n=(r?L(r):null)||t;if(!n&&!e.scrollToTop)return Promise.resolve();const a=e.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=i.smooth&&!s?"smooth":u.settingsTourActive||s?"auto":"smooth";return new Promise(f=>{if(e.scrollToTop&&(rt(c),e.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&rt("auto"),f()}));return}if(!n){f();return}if(n.scrollIntoView({behavior:c,block:a,inline:"nearest"}),c==="auto"){requestAnimationFrame(()=>requestAnimationFrame(f));return}let b=!1;const k=()=>{b||(b=!0,window.removeEventListener("scrollend",S),clearTimeout(P),requestAnimationFrame(()=>requestAnimationFrame(f)))},S=()=>k();"onscrollend"in window&&window.addEventListener("scrollend",S,{once:!0});const P=setTimeout(k,520)})}function At(){D(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&et("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const r=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof r=="function"&&r({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function Y(){D({keepOverlay:!0}),$(),u.settingsTourActive=!1,ot(),R({blockPointer:!0,lockScroll:!0,dim:Z});const t=document.createElement("div");if(t.id="tourTooltip",t.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",t.innerHTML=`
    ...
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(x);const I=x.querySelector(".tour-panel"),A=L(d.tooltipAnchorSelector||d.anchorSelector)||g;d.noHighlight||ge(g,d),it?.destroy(),it=se({tooltip:x,panel:I,target:g,anchor:A,spotlight:q,options:{preferredPlacement:d.tooltipPosition||"auto",maxWidth:380,gap:d.tooltipGap??10,autoScroll:d.autoScroll!==!1,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),x.style.visibility="visible",l.fadeIn&&fe(x),S()}function S(){const g=document.getElementById("tourNextBtn"),d=document.getElementById("tourSkipBtn"),p=y=>{if(y<0)return;const h=a(o[i],o[y]),E=()=>{i=y,localStorage.setItem("settingsTourStep",String(i)),c({keepCurrentUi:h})};me().then(E)},v=()=>{p(i+1)},l=()=>{n()},m=()=>{i<=0||p(i-1)};g&&(g.onclick=v),d&&(d.onclick=l);const x=document.getElementById("tourBackBtn");x&&(x.onclick=m),ue({onNext:v,onBack:m,onSkip:l})}function P(){$(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms(),R({blockPointer:!0,lockScroll:!0,dim:Z});const g=u.activeHotelName||"Your Property",d=g.trim().charAt(0).toUpperCase(),p=g.length>10?g.slice(0,10):g,v="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",l="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",m="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",x=`<div style="${v}"><div style="${l}background:rgba(255,255,255,0.22);"></div><div style="${m}"></div></div>`,y=u.activeHotelAppIcon||"",h=y?`<img src="${y}" alt="" style="width:100%;height:100%;object-fit:contain;">`:d,E=y?`${l}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${l}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,w=`<div style="${v}"><div style="${E}">${h}</div><div style="${m}font-size:7.5px;color:#fff;font-weight:700;">${p}</div></div>`,T=[x,x,x,x,w,x,x,x].join(""),B=document.createElement("div");if(B.id="tourTooltip",B.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",B.innerHTML=`
      ...
      <div style="padding:0 14px 14px;">
        ...
        </div>`],v=document.createElement("div");v.id="tourTooltip",v.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";const l=()=>{const m=g>=p.length-1,x=g===0?"Next — Phone alerts →":g===1?"Next — Avoid conflicts →":"Next — Availability →",y=d?"none":"tourPanelIn 0.22s ease-out",h=d?"tourPageIn 0.18s ease-out":"none";v.innerHTML=`
    ...
    `,t.innerHTML=c}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function xe(){const t=document.getElementById("settings-booking-url");t&&navigator.clipboard.writeText(t.value).then(()=>{localStorage.setItem("linkCopied","1"),W(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function ye(){localStorage.setItem("settingsTourDone","1");const t=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",t);let e=0;const o=setInterval(()=>{e++;const i=document.getElementById("edit-rate-nightly");if(i||e>20){if(clearInterval(o),!i)return;const r=i.closest(".accordion-body");if(r&&r.style.display==="none"){r.style.display="block";const n=r.previousElementSibling?.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const n=document.getElementById("checklistPointer");n&&n.remove();const a=i.getBoundingClientRect(),s=document.createElement("div");s.id="checklistPointer",s.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${a.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,s.innerHTML=`
          ...
          `,document.body.appendChild(s),setTimeout(()=>{const c=document.getElementById("checklistPointer");c&&c.remove()},6e3)},1e3)},100)}},200)}function he(){const e="https://"+(u.activeHotelDomain||u.activeHotelId+".mktel.co");navigator.clipboard.writeText(e).then(()=>{localStorage.setItem("linkCopied","1"),W(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function ve(t,e){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const r=setInterval(()=>{i++;const n=document.querySelector(t);if(n||i>20){if(clearInterval(r),!n)return;n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const s=n.getBoundingClientRect(),c=document.createElement("div");c.id="checklistPointer",c.style.cssText=`
  ...
  `),document.getElementById("editNewRoomName").focus())}function Ke(){const t=document.getElementById("editNewRoomName").value.trim();t&&api("POST","/api/crm/rooms",{name:t,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),vt()}).catch(()=>toast("Failed to add","error"))}const jt={addAmenityPrompt:Re,advanceTourIfNeeded:W,changePin:$e,checklistGoTo:ve,checklistGoToRates:ye,cleanupPostActivationTourUi:at,cleanupSettingsTourUi:D,closeAmenityPicker:st,confirmAmenityPicker:Oe,confirmEditAddRoom:Ke,copyBookingLink:Le,copyBookingLinkFromChecklist:he,deleteEditImage:Ye,deleteEditRoom:_e,ensureTourBlurOverlay:R,finishPostActivationTour:tt,getAmenityIcon:Dt,getCrmAuthToken:xt,getEditRoomImages:Mt,goLive:Ne,guestBookingEngineUrl:Ot,handoffToGuestAppsTour:At,hideGoLiveOverlay:gt,loadEditRooms:vt,loadSettings:Pt,openAmenityPicker:Lt,openBillingPortal:qe,openEditAddRoom:We,openGuestBookingEngine:Be,openPreviewSite:Se,openTourAccordion:N,postRoomImageUpload:yt,queryTourSelector:L,removeAmenity:Me,renderEditRooms:bt,renderEditRoomsCards:K,replayWalkthrough:Ie,resolveLiveTourElement:X,resolveTourHighlightEl:G,restoreAppIconPreview:mt,saveEditRoom:Ue,saveHotelInfo:Fe,saveRates:De,scrollTourTargetIntoView:It,sendSupportMessage:je,setAppIconPreviewImage:kt,setAppIconPreviewLoading:qt,settingsChangePin:ke,settingsCopyLink:xe,settingsSaveRates:we,settingsSendSupport:Ee,settingsUploadPhoto:be,showActivatedModal:Ae,showEditRoomPhoto:Ft,showFinaleMockModal:Y,showGoLiveOverlay:Ht,showOnboardingQuestions:ze,showTestDriveModal:Ct,showWelcomeModal:Rt,squareCropImage:Nt,startPostActivationTabTour:ht,startSettingsTour:ut,stepEditRoomPhoto:Ce,toggleAmenityPreset:Pe,toggleSection:He,tourAnchorRect:zt,tourElementRect:nt,updatePreviewSiteBar:Te,uploadAppIcon:Ge,uploadEditImages:Ve};function Qe(){Gt(jt)}const to=Object.freeze(Object.defineProperty({__proto__:null,default:jt,install:Qe},Symbol.toStringTag,{value:"Module"}));export{se as a,ae as b,u as c,Je as d,Gt as e,to as f,Xe as i,Ze as s};
