const d={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let O=null;function ot(){return typeof lucide<"u"?Promise.resolve():O||(O=new Promise((e,t)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>e(),o.onerror=()=>t(new Error("lucide load failed")),document.head.appendChild(o)}),O)}async function be(e){if(!e||!e.type.startsWith("image/")||e.type==="image/webp"&&e.size<4e5)return e;try{const t=await createImageBitmap(e),o=1600,i=1200;let n=t.width,a=t.height;const r=Math.min(1,o/n,i/a);n=Math.round(n*r),a=Math.round(a*r);const s=document.createElement("canvas");s.width=n,s.height=a,s.getContext("2d").drawImage(t,0,0,n,a),t.close();const u=await new Promise((f,w)=>{s.toBlob(E=>E?f(E):w(new Error("encode failed")),"image/webp",.82)}),g=(e.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([u],g+".webp",{type:"image/webp"})}catch{return e}}function it(){const e=()=>{d.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}function we(e){Object.assign(window,e)}async function ne(){const e=document.getElementById("settingsList");if(e){e.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const t=await api("GET","/api/crm/verify"),i="https://"+(t?.domain||d.activeHotelId+".mktel.co"),n="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(i),a=await api("GET","/api/crm/rooms");let r={nightly:69,weekly:299,monthly:999};a?.rates&&(r=a.rates);const s=a?.rooms||[];let u="";t?.subscribed||(u+=goLiveInlineCardHtml()),s.length?s.forEach(g=>{const f=g.images&&g.images.length>0;u+=`
    ...
    `,e.innerHTML=u}catch{e.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function ke(){const e=document.getElementById("settings-booking-url");e&&navigator.clipboard.writeText(e.value).then(()=>{localStorage.setItem("linkCopied","1"),R(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function Ee(){localStorage.setItem("settingsTourDone","1");const e=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",e);let t=0;const o=setInterval(()=>{t++;const i=document.getElementById("edit-rate-nightly");if(i||t>20){if(clearInterval(o),!i)return;const n=i.closest(".accordion-body");if(n&&n.style.display==="none"){n.style.display="block";const a=n.previousElementSibling?.querySelector(".accordion-arrow");a&&(a.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const r=i.getBoundingClientRect(),s=document.createElement("div");s.id="checklistPointer",s.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${r.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,s.innerHTML=`
          ...
          `,document.body.appendChild(s),setTimeout(()=>{const u=document.getElementById("checklistPointer");u&&u.remove()},6e3)},1e3)},100)}},200)}function Se(){const t="https://"+(d.activeHotelDomain||d.activeHotelId+".mktel.co");navigator.clipboard.writeText(t).then(()=>{localStorage.setItem("linkCopied","1"),R(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function Te(e,t){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const n=setInterval(()=>{i++;const a=document.querySelector(e);if(a||i>20){if(clearInterval(n),!a)return;a.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const r=document.getElementById("checklistPointer");r&&r.remove();const s=a.getBoundingClientRect(),u=document.createElement("div");u.id="checklistPointer",u.style.cssText=`
        ...
        `,document.body.appendChild(u),setTimeout(()=>{const g=document.getElementById("checklistPointer");g&&g.remove()},6e3)},1e3)}},200)}function K(){const e=String(d.token||localStorage.getItem("crmToken")||"").trim();return e&&(d.token=e),e}async function X(e,t){const o=K();if(!o)throw new Error("Not logged in");const i=await be(t),n=new FormData;n.append("image",i,i.name||"room.webp");const a=new URLSearchParams;d.activeHotelId&&a.set("hotelId",d.activeHotelId),a.set("token",o);const r=await fetch(`/api/crm/rooms/${e}/images?${a}`,{method:"POST",headers:{"x-crm-token":o},body:n}),s=await r.json().catch(()=>({}));if(!r.ok||!s.success)throw new Error(s.message||s.error||`Upload failed (${r.status})`);return s}async function Be(e,t){const o=e.target.files[0];if(o)try{await X(t,o),toast("Photo uploaded!","success"),ne()}catch(i){toast(i.message||"Upload failed","error")}}async function ze(){const e=parseFloat(document.getElementById("settings-rate-nightly")?.value)||69,t=parseFloat(document.getElementById("settings-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("settings-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:e,weekly:t,monthly:o}),toast("Rates saved","success")}catch{toast("Failed to save rates","error")}}async function Ie(){const e=document.getElementById("settings-new-pin")?.value.trim();if(!e||e.length<4){toast("PIN must be at least 4 characters","error");return}try{const t=await api("POST","/api/crm/change-pin",{newPin:e});if(!t.success)throw new Error(t.message||"Failed to change PIN");d.token=e,d.isMasterPin=!1;try{localStorage.setItem("crmToken",d.token)}catch{}toast("PIN updated!","success"),document.getElementById("settings-new-pin").value=""}catch(t){toast(t.message||"Failed to change PIN","error")}}async function Pe(){const e=document.getElementById("settings-support-msg")?.value.trim();if(!e){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:e}),toast("Message sent!","success"),document.getElementById("settings-support-msg").value=""}catch{toast("Failed to send","error")}}function Ae(){const e=d.activeHotelDomain||d.activeHotelId+".mktel.co",o=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://localhost:5173/?hotelId="+encodeURIComponent(d.activeHotelId)+"&preview=1":"https://"+e+"?preview=1";window.open(o,"_blank")}function re(){if((window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&d.activeHotelId)return"http://localhost:5173/?hotelId="+encodeURIComponent(d.activeHotelId);const t=d.activeHotelDomain||"";return t?"https://"+t+"/":""}function Ce(){const e=re();if(!e){toast("Your booking domain is still setting up.","info");return}window.open(e,"_blank")}function Re(){const e=document.getElementById("previewSiteBar");e&&(e.style.display=d.currentFilter==="settings"?"block":"none")}function R(){if(localStorage.getItem("settingsTourDone"))return;const e=parseInt(localStorage.getItem("settingsTourStep")||"0"),t=d.editRooms.some(r=>r.images&&r.images.length>0),o=!!localStorage.getItem("ratesChanged"),i=!!localStorage.getItem("linkCopied");e===2&&t&&localStorage.setItem("settingsTourStep","3"),e===3&&i&&localStorage.setItem("settingsTourStep","4"),e===4&&o&&localStorage.setItem("settingsTourStep","5");const n=document.getElementById("tourTooltip");n&&n.remove();const a=document.getElementById("tourBlurOverlay");a&&a.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(r=>{r.style.position=r.dataset.tourOrigPosition||"",r.style.zIndex="",r.style.isolation="",r.style.boxShadow="",r.style.outline=r.dataset.tourOrigOutline||"",r.style.outlineOffset=r.dataset.tourOrigOutlineOffset||"",r.removeAttribute("data-tour-highlighted"),delete r.dataset.tourOrigPosition,delete r.dataset.tourOrigOutline,delete r.dataset.tourOrigOutlineOffset}),document.body.style.overflow=""}function Me(){let e=0;const t={},o=[{title:"Why do you want a booking page?",key:"why",type:"text",placeholder:"e.g. I want guests to book directly instead of calling me..."},{title:"How do guests currently book with you?",key:"currentBooking",type:"choice",options:[{label:"They call me or walk in",value:"phone_walkin"},{label:"Through Booking.com / Expedia",value:"ota"},{label:"I have a website but no booking system",value:"website_no_booking"},{label:"I don't take bookings online yet",value:"no_online"}]},{title:"How many rooms do you have?",key:"roomCount",type:"choice",options:[{label:"1–5 rooms",value:"1-5"},{label:"6–15 rooms",value:"6-15"},{label:"16–50 rooms",value:"16-50"},{label:"50+ rooms",value:"50+"}]},{title:"What's most important to you?",key:"priority",type:"choice",options:[{label:"Stop paying OTA commissions",value:"no_commission"},{label:"Get more direct bookings",value:"more_bookings"},{label:"Have a professional online presence",value:"professional"},{label:"Make it easier for guests to book",value:"easier_booking"}]}];function i(){let n=document.getElementById("onboardingOverlay");if(n&&n.remove(),e>=o.length){localStorage.setItem("onboardingDone","1");try{api("POST","/api/crm/onboarding-answers",t).catch(()=>{})}catch{}ae();return}const a=o[e],r=document.createElement("div");r.id="onboardingOverlay",r.style.cssText="position:fixed;inset:0;z-index:100001;background:linear-gradient(135deg, #1a2b22 0%, #2E7D5B 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;",a.type==="text"?(r.innerHTML=`
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=t}document.body.appendChild(e),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function N(){const e=document.getElementById("postActivationTourTooltip");e&&e.remove();const t=document.getElementById("postActivationTourOverlay");t&&t.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function F(){N(),localStorage.setItem("postActivationTourDone","1");const e=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",e)}catch{}}function Z(){if(localStorage.getItem("postActivationTourDone")){F();return}N();const e=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. You'll get a push alert for each new one."},{tab:"apps",navFilter:"apps",text:"<strong>Guest App</strong> — put your hotel on guests&apos; home screens and send install reminders."}];let t=0;function o(){if(N(),t>=e.length){F();return}const i=e[t],n=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);n&&setFilter(i.tab,n);const a=document.createElement("div");a.id="postActivationTourOverlay",a.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(a),document.body.style.overflow="hidden",setTimeout(()=>{const r=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);r&&(r.setAttribute("data-post-activation-highlight","1"),r.style.position="relative",r.style.zIndex="100003",r.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",r.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const s=r?r.getBoundingClientRect():{left:24,bottom:80,width:200},u=document.createElement("div");u.id="postActivationTourTooltip";const g=Math.min(300,window.innerWidth-32),f=Math.max(16,Math.min(s.left+s.width/2-g/2,window.innerWidth-g-16)),w=Math.min(s.bottom+14,window.innerHeight-180);u.style.cssText=`position:fixed;z-index:100004;left:${f}px;top:${w}px;max-width:${g}px;width:${g}px;`;const E=t>=e.length-1;u.innerHTML=`
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),Z()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}function P(e){const t=e||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText=`position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.48);pointer-events:${t.blockPointer?"auto":"none"};`,document.body.appendChild(o),t.lockScroll&&(document.body.style.overflow="hidden"),o)}function U(){const e=document.getElementById("tourTooltip");e&&e.remove();const t=document.getElementById("tourBlurOverlay");t&&t.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.tourOrigPosition||"",i.style.zIndex="",i.style.isolation="",i.style.boxShadow="",i.style.outline=i.dataset.tourOrigOutline||"",i.style.outlineOffset=i.dataset.tourOrigOutlineOffset||"",i.removeAttribute("data-tour-highlighted"),delete i.dataset.tourOrigPosition,delete i.dataset.tourOrigOutline,delete i.dataset.tourOrigOutlineOffset});const o=document.getElementById("goLiveBanner");o&&o.dataset.tourHidden&&(delete o.dataset.tourHidden,typeof updateGoLiveBanner=="function"&&updateGoLiveBanner()),document.body.style.overflow=""}function z(e,t){if(!t.openAccordion)return;const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const a=o.querySelector(".accordion-arrow");a&&(a.style.transform="rotate(90deg)")}}function I(e){if(!e)return null;for(const t of String(e).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(t);if(o&&o.isConnected)return o}return null}function A(e,t){if(t.highlightSelector){const o=I(t.highlightSelector);if(o)return o}if(t.highlightCard){const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(o)return o}return t.targetParent&&(e.closest(".booking-card")||e.closest(".accordion-body"))||e}function H(e,t){if(!t)return e;const o=String(t.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const n=document.querySelector(i);if(n&&n.isConnected)return n}if(t.accordionCard){const i=document.querySelector(t.accordionCard);if(i&&i.isConnected)return i}return e&&e.isConnected?e:null}function W(e,t){if(!e||!e.isConnected)return null;const o=e.getBoundingClientRect();return o.width<2||o.height<2||!t&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Y(e,t){const o=I(e.anchorSelector);if(o){const i=W(o,!0);if(i)return i}return W(t,!0)}function q(e){const t=e||"auto";try{window.scrollTo({top:0,left:0,behavior:t})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const n=document.querySelector(i);n&&(n.scrollTop=0)})}function se(e,t){const o=t.scrollTarget||t.accordionCard,i=(o?I(o):null)||e;if(!i&&!t.scrollToTop)return Promise.resolve();const n=t.scrollBlock||"center",a=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=d.settingsTourActive||a?"auto":"smooth";return new Promise(s=>{const u=()=>{const S=t.scrollPadTop??80,l=t.scrollPadBottom??220,c=I(t.anchorSelector)||(i&&i.isConnected?i:null)||(e&&e.isConnected?e:null);if(!c){s();return}const p=c.getBoundingClientRect();p.top<S&&window.scrollBy({top:p.top-S,left:0,behavior:"auto"}),p.bottom>window.innerHeight-l&&window.scrollBy({top:p.bottom-window.innerHeight+l,left:0,behavior:"auto"}),requestAnimationFrame(()=>requestAnimationFrame(s))},g=()=>{i&&i.scrollIntoView({behavior:t.scrollToTop?"auto":r,block:n,inline:"nearest"}),u()};if(t.scrollToTop){if(q(r),t.scrollToTopOnly){requestAnimationFrame(()=>requestAnimationFrame(()=>{t.forcePageTop&&q("auto"),s()}));return}if(r==="auto"){g();return}let S=!1;const l=()=>{S||(S=!0,window.removeEventListener("scrollend",c),clearTimeout(p),g())},c=()=>l();"onscrollend"in window&&window.addEventListener("scrollend",c,{once:!0});const p=setTimeout(l,520);return}if(!i){s();return}if(i.scrollIntoView({behavior:r,block:n,inline:"nearest"}),r==="auto"){u();return}let f=!1;const w=()=>{f||(f=!0,window.removeEventListener("scrollend",E),clearTimeout(G),u())},E=()=>w();"onscrollend"in window&&window.addEventListener("scrollend",E,{once:!0});const G=setTimeout(w,620)})}function de(){U(),localStorage.setItem("settingsTourStep","handoff");const e=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&setFilter("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const n=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof n=="function"&&n({chainFromSettingsTour:!0})},t=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof t=="function"?t().then(e).catch(e):e()}function C(){d.settingsTourActive=!1,updateGoLiveBanner();const e=document.createElement("div");e.id="tourBlurOverlay",e.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(e),document.body.style.overflow="hidden";const t=document.createElement("div");if(t.id="tourTooltip",t.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",t.innerHTML=`
    ...
    <div style="background:white;border-radius:20px;max-width:340px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);animation:tourModalSlideUp 0.3s ease;">
    ...
    </div>`,document.body.appendChild(t),typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("activateNowBtn").onclick=()=>{t.remove(),fe()},document.getElementById("activateLaterBtn").onclick=()=>{t.remove();const o=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');o&&setFilter("bookings",o)}}function _(){if(localStorage.getItem("settingsTourDone"))return;if(localStorage.getItem("settingsTourStep")==="handoff"){localStorage.removeItem("settingsTourStep"),C();return}localStorage.getItem("settingsTourDone")||localStorage.removeItem("settingsTourStep"),d.settingsTourActive=!0,updateGoLiveBanner(),seedTourRevenueShell();const e=document.querySelector('.tab[data-nav-filter="settings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="settings"]');e&&setFilter("settings",e);function t(){if(typeof window.isEditPageDomReady=="function"&&window.isEditPageDomReady()||typeof isEditPageDomReady=="function"&&isEditPageDomReady()||!(typeof window.needsEditPageLoad=="function"&&window.needsEditPageLoad()||typeof needsEditPageLoad=="function"&&needsEditPageLoad())&&!d.editRoomsLoadPromise)return;const p=typeof window.invokeLoadEditRooms=="function"?window.invokeLoadEditRooms:typeof invokeLoadEditRooms=="function"?invokeLoadEditRooms:null;p&&p()}t();const o=[{target:"#tour-preview-btn",highlightSelector:"#tour-preview-btn",anchorSelector:"#tour-preview-btn",scrollTarget:"#tour-preview-btn",title:"Preview your booking page",text:"Use this button to open your real booking page and see exactly what guests see before you go live.",openAccordion:!1,tab:"settings",scrollToTop:!0,scrollToTopOnly:!0,forcePageTop:!0,scrollBlock:"start"},{target:"#tour-header-preview-card",highlightSelector:"#tour-header-preview-card",anchorSelector:"#tour-header-preview-card",scrollTarget:"#tour-header-preview-card",title:"Edit your booking page",text:"Tap any field on this page to change it: hotel name, address, phone, room details, photos, and prices. What you edit here is what guests see.",openAccordion:!1,tab:"settings",scrollBlock:"nearest",scrollPadTop:80,scrollPadBottom:220},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo-placeholder, #editRoomsCards [data-tour-room-card="1"] .room-edit-photo',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',scrollTarget:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',title:"Add room photos",text:"Tap + Add Photos to upload a real room photo. Guests make faster decisions when they can see the room before they book.",openAccordion:!1,tab:"settings",scrollBlock:"start",scrollPadTop:80,scrollPadBottom:220},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',scrollTarget:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',title:"Edit room details",text:"Then edit the room name, description, maximum guests, amenities, and units. These details show on your booking page.",openAccordion:!1,tab:"settings",scrollBlock:"start",scrollPadTop:80,scrollPadBottom:220},{target:"#tour-booking-link-card",highlightSelector:"#tour-booking-link-card",anchorSelector:"#tour-booking-link-card",scrollTarget:"#tour-booking-link-card",title:"Share your direct link",text:"Your booking link and QR tools live here. Send guests straight to this page so they book direct.",openAccordion:!1,tab:"settings",scrollBlock:"start",scrollPadTop:80,scrollPadBottom:220},{target:"#tour-rates-card",highlightSelector:"#tour-rates-card",anchorSelector:"#tour-rates-header",scrollTarget:"#tour-rates-card",title:"Set your rates",text:"Set nightly, weekly, and monthly prices here. Guests book from these rates on your direct booking page.",openAccordion:!0,accordionCard:"#tour-rates-card",tab:"settings",scrollBlock:"center",scrollPadBottom:260},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",title:"Track revenue and payment status",text:"Revenue shows direct bookings and estimated OTA commission savings. Guest cards are verified to reduce no-shows, but you still collect payment at check-in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,scrollBlock:"start",scrollPadTop:92,scrollPadBottom:220},{target:"",text:"",openAccordion:!1,tab:"apps",customModal:"guestAppsStory"}];let i=parseInt(localStorage.getItem("settingsTourStep")||"0",10);(!Number.isFinite(i)||i<0||i>=o.length)&&(i=0,localStorage.removeItem("settingsTourStep"));function n(){U()}function a(){n(),localStorage.removeItem("settingsTourStep"),C()}function r(l){if(l.customModal){u(l);return}requestAnimationFrame(()=>u(l))}function s(){if(n(),i>=o.length){localStorage.removeItem("settingsTourStep"),C();return}const l=o[i];if(l.tab==="revenue"&&!d.revenueEnabled){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}if(l.tab==="apps"&&!(isStandaloneApp()||d.frontdeskInstalled)&&l.target&&!l.target.includes("tour-fd-install")){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}if(l.customModal||P(),l.tab&&l.tab!==d.currentFilter){const c=document.querySelector(`.tab[data-nav-filter="${l.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${l.tab}"]`);if(c&&setFilter(l.tab,c),l.tab==="apps"){const p=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof p=="function"&&p(!0)}r(l);return}r(l)}function u(l){if(l.customModal==="homescreen"){E();return}if(l.customModal===!0||l.customModal==="bookings"){S();return}if(l.customModal==="availability"){G();return}if(l.customModal==="finale"){C();return}if(l.customModal==="guestAppsStory"){de();return}if(l.waitForVisible){const m=l.target.split(",").map(v=>v.trim());let b=0;const x=30;P();const h=d.settingsTourActive?60:200,y=()=>{if(b++,l.tab==="apps"){const k=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof k=="function"&&k(!0)}let v=null;for(const k of m)if(v=document.querySelector(k),v)break;if(v&&(l.openAccordion&&z(v,l),l.openAccordion||v.offsetParent!==null)){g(v,l);return}b<x?setTimeout(y,h):(i++,localStorage.setItem("settingsTourStep",String(i)),s())};y();return}function c(m){const b=m.target.split(",").map(x=>x.trim());for(const x of b){const h=document.querySelector(x);if(h&&!(!m.openAccordion&&h.offsetParent===null&&getComputedStyle(h).position!=="fixed"))return h}if(m.accordionCard){const x=document.querySelector(m.accordionCard);if(x)return x}return null}function p(m,b){const x=c(m);if(x){b(x);return}const h=m.tab==="settings"&&!m.customModal&&m.target,y=m.tab==="apps"&&!m.customModal&&m.target;if(!h&&!y){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}P();let v=0;if(h&&t(),y){const T=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof T=="function"&&T(!0)}const k=d.settingsTourActive?60:250,$=()=>{if(v++,y){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}const T=c(m);if(T){b(T);return}if(t(),y){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}v<48?setTimeout($,k):(i++,localStorage.setItem("settingsTourStep",String(i)),s())};$()}p(l,m=>g(m,l))}function g(l,c){if(z(l,c),l=A(l,c),(!l||!l.isConnected)&&(l=H(l,c),l&&(l=A(l,c))),!l){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}const p=l;P(),se(p,c).then(()=>{if(c.forcePageTop&&q("auto"),!p.isConnected){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}z(p,c),c.noHighlight||(p.dataset.tourOrigPosition||(p.dataset.tourOrigPosition=p.style.position||""),p.dataset.tourOrigOutline||(p.dataset.tourOrigOutline=p.style.outline||""),p.dataset.tourOrigOutlineOffset||(p.dataset.tourOrigOutlineOffset=p.style.outlineOffset||""),p.style.position=p.style.position||"relative",p.style.zIndex="99999",p.style.isolation="isolate",p.id==="tour-preview-btn"?(p.style.boxShadow="0 0 0 4px #fff, 0 0 0 8px #2E7D5B, 0 14px 34px rgba(0,0,0,0.25)",p.style.outline="3px solid #fff",p.style.outlineOffset="4px"):(p.style.boxShadow="inset 0 0 0 3px #2E7D5B, 0 0 0 3px #2E7D5B, 0 14px 34px rgba(46,125,91,0.24)",p.style.outline="3px solid #2E7D5B",p.style.outlineOffset="3px"),p.setAttribute("data-tour-highlighted","1")),document.body.style.overflow="hidden";const m=()=>{const h=I(c.anchorSelector)||p;if(c.freezeTooltip){const k=h&&h.isConnected?h.getBoundingClientRect():null;f(h,c,k&&k.width>=2?k:null);return}const y=H(p,c);let v=y?A(y,c):p;z(v,c),c.tooltipAnchor||Y(c,v),f(v||p,c)};if(c.freezeTooltip){requestAnimationFrame(()=>requestAnimationFrame(m));return}const b=(x=0)=>{requestAnimationFrame(()=>{if(c.forcePageTop&&q("auto"),c.tooltipAnchor){m();return}const h=H(p,c);let y=h?A(h,c):p;if(z(y,c),!Y(c,y)&&x<4){requestAnimationFrame(()=>b(x+1));return}f(y||p,c)})};b(0)})}function f(l,c,p){const m=document.getElementById("tourTooltip");m&&m.remove();const b=document.createElement("div");b.id="tourTooltip";const x=Math.min(i+1,o.length),h=Math.max(8,Math.min(100,Math.round(x/o.length*100))),y=c.title||"Quick setup",v=c.primaryLabel||(i<o.length-1?"Next":"Got it"),k=i<=0;b.style.cssText="position:fixed;z-index:100000;left:12px;right:12px;bottom:calc(14px + env(safe-area-inset-bottom,0px));display:flex;justify-content:center;pointer-events:none;",b.innerHTML=`
      <div style="pointer-events:auto;width:100%;max-width:560px;background:#fff;color:#1A2B22;border:1.5px solid #D8E4DC;border-radius:16px;box-shadow:0 18px 50px rgba(26,43,34,0.24);padding:14px 14px 13px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;">
          <div style="font-size:11px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:#6B7D72;white-space:nowrap;">${x} of ${o.length}</div>
          <div style="height:6px;flex:1;border-radius:999px;background:#E6EEE9;overflow:hidden;">
            <div style="height:100%;width:${h}%;border-radius:999px;background:#2E7D5B;"></div>
          </div>
        </div>
        ...
        <div style="display:flex;align-items:center;gap:8px;">
          ...
          <button id="tourNextBtn" type="button" style="min-height:40px;margin-left:auto;padding:10px 18px;border-radius:10px;border:none;background:#2E7D5B;color:#fff;font-family:inherit;font-size:14px;font-weight:800;cursor:pointer;">${v}</button>
        </div>
      </div>`,document.body.appendChild(b),w()}function w(){const l=document.getElementById("tourNextBtn"),c=document.getElementById("tourSkipBtn");l&&(l.onclick=()=>{n(),i++,localStorage.setItem("settingsTourStep",String(i)),s()}),c&&(c.onclick=()=>{a()});const p=document.getElementById("tourBackBtn");p&&(p.onclick=()=>{i<=0||(n(),i--,localStorage.setItem("settingsTourStep",String(i)),s())})}function E(){typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms();const l=document.createElement("div");l.id="tourBlurOverlay",l.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(l),document.body.style.overflow="hidden";const c=d.activeHotelName||"Your Hotel",p=c.trim().charAt(0).toUpperCase(),m=c.length>10?c.slice(0,10):c,b="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",x="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",h="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",y=`<div style="${b}"><div style="${x}background:rgba(255,255,255,0.22);"></div><div style="${h}"></div></div>`,v=d.activeHotelAppIcon||"",k=v?`<img src="${v}" alt="" style="width:100%;height:100%;object-fit:contain;">`:p,$=v?`${x}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${x}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,T=`<div style="${b}"><div style="${$}">${k}</div><div style="${h}font-size:7.5px;color:#fff;font-weight:700;">${m}</div></div>`,B=[y,y,y,y,T,y,y,y].join(""),L=document.createElement("div");if(L.id="tourTooltip",L.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",L.innerHTML=`
      ...
      <div style="padding:0 14px 14px;">
      ...
      </div>`],m=document.createElement("div");m.id="tourTooltip",m.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";function b(){const h=c>=p.length-1?"Next — Revenue →":"Next →";m.innerHTML=`
        <div style="background:white;border-radius:20px;max-width:340px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0,0,0,0.3);animation:tourModalSlideUp 0.3s ease;">
          ...
          <div style="padding:4px 18px 6px;text-align:center;">
            <div style="display:flex;justify-content:center;gap:6px;margin-bottom:10px;">
              ${p.map((y,v)=>`<div style="width:8px;height:8px;border-radius:50%;background:${v===c?"#2E7D5B":"#D8E4DC"};"></div>`).join("")}
            </div>
          </div>
        ...
        </div>`,document.getElementById("tourNextBtn").onclick=()=>{c<p.length-1?(c++,b()):(n(),i++,localStorage.setItem("settingsTourStep",String(i)),s())},document.getElementById("tourSkipBtn").onclick=()=>{a()}}if(document.body.appendChild(m),b(),!document.getElementById("tourModalAnimStyle")){const x=document.createElement("style");x.id="tourModalAnimStyle",x.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(x)}}function S(){const l=document.createElement("div");l.id="tourBlurOverlay",l.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(l),document.body.style.overflow="hidden";const c=document.createElement("div");if(c.id="tourTooltip",c.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",c.innerHTML=`
      <div style="background:white;border-radius:20px;max-width:340px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0,0,0,0.3);animation:tourModalSlideUp 0.3s ease;">
      ...
      </div>`,document.body.appendChild(c),!document.getElementById("tourModalAnimStyle")){const p=document.createElement("style");p.id="tourModalAnimStyle",p.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(p)}document.getElementById("tourNextBtn").onclick=()=>{n(),i++,localStorage.setItem("settingsTourStep",String(i)),s()},document.getElementById("tourSkipBtn").onclick=()=>{a()}}s()}async function ee(){if(isEditPageDomReady())return;if(d.editRoomsLoadPromise)return d.editRoomsLoadPromise;const e=document.getElementById("editRoomsList");if(e){d.editRoomsLoadPromise=(async()=>{e.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[t,o]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify")]);if(!t.rooms)throw new Error("No data");d.editRooms=t.rooms;const i=o?.hotelName||"";i&&(d.activeHotelName=i),o&&(d.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const n=o?.hotelSubtitle||"",a=o?.hotelAddress||"",r=o?.hotelPhone||"",s=o?.appIconUrl||"";d.activeHotelAppIcon=s,updateFrontdeskManifestLink();let u={nightly:69,weekly:299,monthly:999,taxRate:.1};t.rates&&(u=t.rates);const f="https://"+(o?.domain||d.activeHotelId+".mktel.co"),w="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(f);let E=`
    ...
    `;e.innerHTML=E,M(),typeof lucide<"u"&&lucide.createIcons()}catch{e.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load your page</div><div class="empty-sub">Check your connection and refresh.</div></div>'}})();try{await d.editRoomsLoadPromise}finally{d.editRoomsLoadPromise=null}}}function te(){M()}function M(){const e=document.getElementById("editRoomsCards");if(e){if(!d.editRooms.length){e.innerHTML='<div class="empty-state"><div class="empty-icon">🛏️</div><div class="empty-text">No rooms yet</div><div class="empty-sub">Add your first room type below.</div></div>';return}e.innerHTML=d.editRooms.map((t,o)=>{const i=(t.amenities||"").split("•").map(r=>r.trim()).filter(Boolean),n=(t.images||[]).filter(r=>r&&r.url),a=jsStr(t.id);return`
  ...
  `),document.getElementById("editNewRoomName").focus())}function et(){const e=document.getElementById("editNewRoomName").value.trim();e&&api("POST","/api/crm/rooms",{name:e,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),ee()}).catch(()=>toast("Failed to add","error"))}const ve={addAmenityPrompt:He,advanceTourIfNeeded:R,changePin:Ue,checklistGoTo:Te,checklistGoToRates:Ee,cleanupPostActivationTourUi:N,cleanupSettingsTourUi:U,closeAmenityPicker:j,confirmAmenityPicker:Fe,confirmEditAddRoom:et,copyBookingLink:Ge,copyBookingLinkFromChecklist:Se,deleteEditImage:Ke,deleteEditRoom:Xe,ensureTourBlurOverlay:P,finishPostActivationTour:F,getAmenityIcon:ue,getCrmAuthToken:K,getEditRoomImages:ce,goLive:fe,guestBookingEngineUrl:re,handoffToGuestAppsTour:de,hideGoLiveOverlay:Q,loadEditRooms:ee,loadSettings:ne,openAmenityPicker:me,openBillingPortal:We,openEditAddRoom:Ze,openGuestBookingEngine:Ce,openPreviewSite:Ae,openTourAccordion:z,postRoomImageUpload:X,queryTourSelector:I,removeAmenity:Ne,renderEditRooms:te,renderEditRoomsCards:M,replayWalkthrough:$e,resolveLiveTourElement:H,resolveTourHighlightEl:A,restoreAppIconPreview:J,saveEditRoom:_e,saveHotelInfo:qe,saveRates:je,scrollTourTargetIntoView:se,sendSupportMessage:Ye,setAppIconPreviewImage:ie,setAppIconPreviewLoading:he,settingsChangePin:Ie,settingsCopyLink:ke,settingsSaveRates:ze,settingsSendSupport:Pe,settingsUploadPhoto:Be,showActivatedModal:Le,showEditRoomPhoto:pe,showFinaleMockModal:C,showGoLiveOverlay:xe,showOnboardingQuestions:Me,showTestDriveModal:le,showWelcomeModal:ae,squareCropImage:ye,startPostActivationTabTour:Z,startSettingsTour:_,stepEditRoomPhoto:Oe,toggleAmenityPreset:De,toggleSection:Ve,tourAnchorRect:Y,tourElementRect:W,updatePreviewSiteBar:Re,uploadAppIcon:Je,uploadEditImages:Qe};function tt(){we(ve)}const nt=Object.freeze(Object.defineProperty({__proto__:null,default:ve,install:tt},Symbol.toStringTag,{value:"Module"}));export{ot as a,nt as b,d as c,we as e,it as s};
