import{c as l,a as vt,b as wt,e as kt}from"./settings-zFaEoDaw.js";function T(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function K(...t){return T("ensureAppsViewRendered")?.(...t)}function Q(...t){return T("showFinaleMockModal")?.(...t)}function X(...t){return T("finishTourHydration")?.(...t)}function Z(...t){return T("goLive")?.(...t)}function J(...t){return T("toast")?.(...t)}function Tt(...t){return T("appsCloseLightbox")?.(...t)}let L=[],u=0,H=!1,z=null,_=null,E=null,v=null;function $t(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function m(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function tt(){z&&(document.removeEventListener("keydown",z),z=null)}function zt(t){tt(),z=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",z)}function It(t,e){return!t||!t.isConnected||e?.noHighlight?null:(t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),v?.destroy(),v=wt(t,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"none",o.style.outline=e?.spotlightOutline??"none",o.style.outlineOffset=e?.spotlightOutlineOffset??"0",(t.classList.contains("apps-story-line")||e?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),v?.element||null)}function et(t){const e=t||{};tt(),E?.destroy(),E=null,v?.destroy(),v=null,_&&(clearTimeout(_),_=null);const o=document.getElementById("appsTourLightbox");o&&!e.keepLightbox&&o.remove();const n=document.getElementById("appsTourTooltip");n&&n.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function b(t){et(),document.body.style.overflow="";const e=H;H=!1;try{const o=typeof K=="function"?K:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),e||localStorage.getItem("settingsTourStep")==="handoff"||l.settingsTourActive)){const n=typeof Q=="function"?Q:window.showFinaleMockModal;if(typeof n=="function"){n();return}}}function St(t){const e=u+t;e<0||e>=L.length||(u=e,w())}function j(){if(localStorage.setItem("appsTourDone","1"),H||localStorage.getItem("settingsTourStep")==="handoff"||l.settingsTourActive){l.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const e=typeof X=="function"?X:window.finishTourHydration;typeof e=="function"&&e()}}function Bt(){j();const t=typeof Z=="function"?Z:window.goLive;if(b(!1),typeof t=="function"){t();return}const e=typeof J=="function"?J:window.toast;typeof e=="function"&&e("Open Go live to activate your booking page.","error")}function w(){$t();const t=L[u];if(!t){b(!0);return}const e=L.length,o=u>=e-1,n=`${u+1} / ${e}`,i=Math.max(8,Math.min(100,Math.round((u+1)/e*100))),s=document.querySelector(t.target);if(!s){u++,w();return}et({keepLightbox:!0});let r=document.getElementById("appsTourLightbox");r||(r=document.createElement("div"),r.id="appsTourLightbox",r.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(r)),t.noHighlight||(s.dataset.appsTourOrigPosition=s.style.position||"",s.dataset.appsTourOrigZIndex=s.style.zIndex||"",s.dataset.appsTourOrigIsolation=s.style.isolation||"",s.dataset.appsTourOrigBoxShadow=s.style.boxShadow||"",s.dataset.appsTourOrigOutline=s.style.outline||"",s.dataset.appsTourOrigOutlineOffset=s.style.outlineOffset||"",s.dataset.appsTourOrigTransition=s.style.transition||"",s.style.position=s.style.position||"relative",s.style.zIndex="100002",s.style.isolation="isolate",s.style.transition="box-shadow 0.18s ease, outline 0.18s ease",s.style.boxShadow=t.spotlightBoxShadow??"none",s.style.outline=t.spotlightOutline??"none",s.style.outlineOffset=t.spotlightOutlineOffset??"0",(s.classList.contains("apps-story-line")||t.hideSpotlightBorder)&&(s.dataset.appsTourOrigBorderTop=s.style.borderTop||"",s.dataset.appsTourOrigPaddingTop=s.style.paddingTop||"",s.style.borderTop="none",s.style.paddingTop="0"),s.setAttribute("data-apps-tour-highlighted","1"));const p=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,d=t.scrollBlock||"nearest",h=p?"auto":"smooth";s.scrollIntoView({behavior:h,block:d});const f=()=>{const I=document.getElementById("appsTourTooltip");I&&I.remove();const c=Math.min(370,window.innerWidth-28),P=t.primaryLabel||(o?"Done":"Next"),V=t.secondaryLabel||(o?"Not now":"Skip tour"),M=u<=0,a=t.kicker||"Guest App",x=document.createElement("div");x.id="appsTourTooltip",x.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${c}px;max-width:${c}px;visibility:hidden;`,x.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${m(t.title)}">
        ...
        <div class="apps-tour-kicker">${m(a)}</div>
        <div class="apps-tour-title">${m(t.title)}</div>
        <p class="apps-tour-copy">${m(t.text)}</p>
        <div class="apps-tour-actions">
          <button type="button" id="appsTourBackBtn" class="apps-tour-btn" ${M?"disabled":""}>Back</button>
          <button type="button" id="appsTourSkipBtn" class="apps-tour-btn apps-tour-btn-ghost">${m(V)}</button>
          <button type="button" id="appsTourNextBtn" class="apps-tour-btn apps-tour-btn-primary">${m(P)}</button>
        </div>
      </div>`,document.body.appendChild(x),It(s,t);const C=x.querySelector(".apps-tour-panel");E?.destroy(),E=vt({tooltip:x,panel:C,target:s,anchor:s,spotlight:v,options:{preferredPlacement:t.tooltipPosition||"auto",maxWidth:c,gap:t.tooltipGap??10,autoScroll:!0,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),x.style.visibility="visible";const S=()=>{if(t.activateOnNext){Bt();return}if(o){j(),b(!1);return}u++,w()},y=()=>{if(o){j(),b(!1);return}b(!0)},B=()=>{u<=0||(u--,w())};document.getElementById("appsTourNextBtn").onclick=S,document.getElementById("appsTourSkipBtn").onclick=y;const A=document.getElementById("appsTourBackBtn");A&&(A.onclick=B),zt({onNext:S,onBack:B,onSkip:y})};_=setTimeout(()=>{requestAnimationFrame(f)},p?40:320)}function At(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;Tt(),b(!1),H=!!o;const n=!!l.hotelSubscribed;L=[{target:"#tour-apps-intro",kicker:"The loop",title:"Your property becomes the app.",text:"Guests book direct, save your property to their phone, and come back with one tap."},{target:"#tour-apps-first",kicker:"Your side",title:"Put Front Desk on your phone in 3 steps.",text:"There is no App Store. Save this page to your home screen so new bookings can reach you before they confirm — even when Front Desk is closed.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-then",kicker:"Their side",title:"Guests install from your booking page.",text:"One tap on Install and your icon is on their home screen.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your property.",text:"A real logo or a clear photo. Guests see this square every time.",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10},{target:"#tour-apps-loop",kicker:n?"Live loop":"Activation",title:n?"This loop is on.":"Everything is ready to turn on.",text:n?"Guests book, save your property, and message you. Front Desk gets the alerts.":"For $199/month, guests can book direct, save your property, and message you — while Front Desk receives the alerts.",primaryLabel:n?"Done":"Activate everything — $199/month",secondaryLabel:n?"Close":"Keep exploring",activateOnNext:!n,tooltipPosition:"below",tooltipGap:8}],u=0,w()}const g={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},_t="32px";function N(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function q(t){return`border-radius:${_t};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function ot(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let D=[],k=0;function Ot(t,e){b(!1),D=t,k=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?O(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?O(-1):i.key==="Escape"&&it()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const s=i.changedTouches[0].clientX-n;Math.abs(s)>50&&O(s<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",Y()}function it(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function O(t){const e=D.length;e<=1||(k=(k+t+e)%e,Y())}function Y(){const t=document.getElementById("appsLightbox");if(!t)return;const e=D[k],o=D.length,n=e.type!=="video",i=o>1?`${k+1} / ${o}`:"",s=n?`<img src="${ot(e.src)}" alt="${e.alt||""}"
          ...
          ${e.poster?`poster="${N(e.poster,400)}"`:""}>
          <source src="${e.src}" type="video/mp4">
       </video>`,r=o>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",p=o>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",d=o>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${d}
    </div>`}function st(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function $(t,e,o,n,i){const s=i?st("Video"):"",r=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${n})">
    ...
    ${r}
  </button>`}function Lt(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function Ht(t){const e=document.getElementById("appsView");if(!e)return;l.bookingApproval===null&&typeof window.loadBookingApprovalSettings=="function"&&window.loadBookingApprovalSettings({refreshApps:!0});const o=(l.activeHotelId||"")+"|"+(l.activeHotelAppIcon||"")+"|"+(l.activeHotelDomain||"");t||e.dataset.appsKey!==o||!e.querySelector(".apps-page")?(nt(),e.dataset.appsKey=o):R()}function nt(){const t=document.getElementById("appsView");if(!t)return;const e=l.activeHotelName||"Your Property",o=l.activeHotelAppIcon||"",n=e.trim().charAt(0).toUpperCase()||"🏡",i=l.activeHotelDomain||"",s=i?"https://"+i:"#",r=i?"https://"+i+"/install":"#";function p(G){return JSON.stringify(G).replace(/"/g,"&quot;")}const d=N(g.guestHome,520),h=[{type:"image",src:g.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],f=[{type:"image",src:g.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:g.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:g.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],F=[{type:"video",src:g.guestInstallVideo,poster:g.guestHome,alt:"Guest adds property to phone",title:"How guests put your property on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your property shows up on their phone like an app. You don't need to do anything."}],I=[{type:"image",src:g.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your guest app.'},{type:"image",src:g.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:g.guestMessageNotifVideo,poster:g.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],c=isStandaloneApp()||l.frontdeskInstalled,P=typeof Notification<"u"&&Notification.permission==="granted",M=!!(window.matchMedia&&window.matchMedia("(max-width: 767px)").matches)?"Put Front Desk on this phone":"Put Front Desk on my phone",a=l.bookingApproval,x=!!(a&&a.supported&&a.pushConfigured),C=a&&a.windowMinutes||20,S=a&&a.enabled?`${C} minutes to confirm or release`:"Bookings confirm immediately";let y;c&&P?y=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
      ...
      <div style="flex:1;min-width:0;"><div style="font-size:13px;font-weight:700;color:#166534;">Installed on this device</div><div style="font-size:12px;color:#166534;margin-top:2px;line-height:1.45;">Booking alerts can reach this phone — even if Front Desk is closed.</div>${x?`<div style="margin-top:12px;padding-top:12px;border-top:1px solid #bbf7d0;display:flex;align-items:center;justify-content:space-between;gap:12px;">
          <div>
            <div style="font-size:12px;font-weight:800;color:#166534;">Booking review: ${a.enabled?"On":"Off"}</div>
            <div style="font-size:11px;color:#4B5D52;margin-top:2px;">${S}</div>
          </div>
          <button type="button" onclick="toggleBookingApproval()" style="flex-shrink:0;padding:8px 11px;border-radius:9px;border:1px solid ${a.enabled?"#86EFAC":"#2E7D5B"};background:${a.enabled?"#fff":"#2E7D5B"};color:${a.enabled?"#166534":"#fff"};font-family:inherit;font-size:11px;font-weight:800;cursor:pointer;">${a.enabled?"Turn off":"Turn on"}</button>
        </div>`:""}</div>
    </div>`:c?y=`<div id="tour-fd-installed-badge"><p style="font-size:13px;color:var(--text-muted);margin:0 0 12px;line-height:1.55;">Front Desk is on this device. Turn on booking protection so new reservations reach your phone before they confirm.</p>
      <button onclick="enableBookingProtection()" style="width:100%;padding:14px;border-radius:12px;border:none;background:var(--green);color:#fff;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;">Turn on booking protection</button></div>`:y=`<p style="font-size:13px;color:var(--text-muted);margin:0 0 14px;line-height:1.55;">Put Front Desk on this phone first. There is no App Store — follow 3 quick steps and it appears on your home screen like an app.</p>
      ...
      <div style="font-size:12px;color:var(--text-muted);line-height:1.45;text-align:center;">Locked until Front Desk is installed on your phone</div>`;const B=c?`<div class="apps-story-status">
      ...
      </div>`:`<button type="button" class="apps-story-primary" onclick="handleInstallFrontdesk()">${M}</button>`,A=r!=="#"?'<button type="button" class="apps-story-secondary" onclick="openGuestBookingEngine({focusInstall:true})">Go to direct booking page</button>':'<div class="apps-story-domain-note">Your direct booking domain is still setting up. Once it is ready, guests install from that page.</div>',W="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",rt=o?W+"background:#fff;border:1px solid var(--border);padding:0;":W,at=o?`<img src="${o}" alt="Property logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,pt=`
    <div class="apps-icon-card">
      <div id="appsAppIconPreview" style="${rt}">
        ${at}
      </div>
      ...
      ${r==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,lt=r!=="#"?`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <div style="border-radius:12px;background:#f4f7f9;border:1px solid var(--border);margin:0 0 12px;padding:16px;text-align:center;">
          <img src="${d}" alt="Guest saves property to phone" loading="eager" decoding="sync" style="max-width:140px;width:55%;height:auto;min-height:120px;display:block;margin:0 auto;border-radius:12px;box-shadow:0 4px 14px rgba(0,0,0,0.1);">
        </div>
        <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${p(F)},0)" style="margin-bottom:12px;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how guests install (1 min)</span></button>
        ...
        <div class="apps-q-list">
          ${$("What guests see on their phone","",p(f),0,!1)}
          ${$("How guests add your property","",p(F),0,!0)}
          ${$("Guest texts you, you text back","",p(I),0,!0)}
          ${$("Your app and theirs — side by side","",p(h),0,!1)}
        </div>
        ${s!=="#"?`<button onclick="window.open('${s}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,ft=G=>`
    ...
    ${ut}
    ${ct}
    ${c?bt:U()}`,mt=c?"Front Desk is installed. Guests can install your property from the direct booking page.":"Install Front Desk first. Then guests can install your property from the direct booking page.";t.innerHTML=`
  <style>
  ...
  <div class="apps-page">
    ...
    <p class="apps-footnote">${mt}</p>

  </div>`,typeof lucide<"u"&&lucide.createIcons(),R()}async function R(){const t=document.getElementById("guestInstallStats");try{const e=await api("GET","/api/crm/guest-install-stats");if(!e.success)throw new Error(e.message||"Failed");if(guestPushSubscriberCount=e.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const o=e.totals||{},n=e.installedBookings||0,i=o.views||0;if(!n&&!i){t.style.display="none",t.innerHTML="";return}t.style.display="block";const s=e.installRatePercent!=null?e.installRatePercent:0,r=Object.entries(e.byTouchpoint||{}).filter(function(d){return d[1].views||d[1].installed}).sort(function(d,h){return(h[1].installed||0)-(d[1].installed||0)}).slice(0,5),p=r.length?r.map(function(d){const h=d[0].replace(/-/g," "),f=d[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+h+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(f.views||0)+" views · "+(f.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+n+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div>'+(p?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+p:"")}catch{guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}const Et={appsCloseLightbox:it,appsCloudinaryFull:ot,appsCloudinaryImg:N,appsLbNav:O,appsLbRender:Y,appsOpenLightbox:Ot,appsPhoneImgStyle:q,appsQuestionRow:$,appsTourClose:b,appsTourNav:St,appsTourRender:w,appsVideoBadgeHtml:st,detectAppPlatform:Lt,ensureAppsViewRendered:Ht,loadGuestInstallStats:R,renderAppsView:nt,startAppsTour:At};function Mt(){kt(Et)}export{Et as default,Mt as install};
