import{c as h,e as yt}from"./settings-WWOGWrhy.js";function I(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function nt(...t){return I("ensureAppsViewRendered")?.(...t)}function st(...t){return I("showFinaleMockModal")?.(...t)}function at(...t){return I("finishTourHydration")?.(...t)}function C(...t){return I("goLive")?.(...t)}function M(...t){return I("toast")?.(...t)}function vt(...t){return I("appsCloseLightbox")?.(...t)}let P=[],f=0,G=!1,$=null,O=null;function pt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
