...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${t}]`);if(Array.from(i).forEach(r=>De(r,{nameAttr:t,icons:e,attrs:o})),t==="data-lucide"){const r=document.querySelectorAll("[icon-name]");r.length>0&&Array.from(r).forEach(n=>De(n,{nameAttr:"icon-name",icons:e,attrs:o}))}},so={ArrowUpRight:ht,Ban:yt,Bed:vt,Bell:bt,Calendar:wt,Camera:kt,CircleAlert:Tt,CircleCheck:It,ClipboardList:Ct,Hash:$t,House:Lt,Image:Dt,Info:Ht,Lock:qt,MessageCircle:jt,Moon:Ut,Phone:Gt,Play:_t,Undo2:oo,Bath:xt,Car:Et,Check:St,ChevronLeft:Bt,ChevronRight:At,CookingPot:zt,CopyCheck:Mt,DoorOpen:Pt,Ellipsis:Rt,Globe:Ot,Inbox:Ft,Laptop:Nt,PawPrint:Vt,QrCode:Wt,Rocket:Yt,Share:Jt,Shirt:Kt,Smartphone:Qt,Sparkles:Zt,SquarePlus:Xt,ThermometerSnowflake:eo,Tv:to,Waves:io,Wifi:no,Wind:ro};window.lucide={createIcons(e={}){ao({...e,icons:so})}};function Bi(){return Promise.resolve()}async function lo(e){if(!e||!e.type.startsWith("image/")||e.type==="image/webp"&&e.size<4e5)return e;try{const t=await createImageBitmap(e),o=1600,i=1200;let r=t.width,n=t.height;const a=Math.min(1,o/r,i/n);r=Math.round(r*a),n=Math.round(n*a);const s=document.createElement("canvas");s.width=r,s.height=n,s.getContext("2d").drawImage(t,0,0,r,n),t.close();const l=await new Promise((y,v)=>{s.toBlob(S=>S?y(S):v(new Error("encode failed")),"image/webp",.82)}),g=(e.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([l],g+".webp",{type:"image/webp"})}catch{return e}}function Ai(){const e=()=>{d.currentFilter==="apps"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}const co=["cancelled","canceled","released"];function Ti(e){return e?co.includes(String(e.status||"").trim().toLowerCase()):!0}function po(e){Object.assign(window,e)}const uo=14,go=10;function be(e,t,o){return Math.max(t,Math.min(e,o))}function R(e,t,o,i){return{left:e,top:t,width:o,height:i,right:e+o,bottom:t+i}}function mo(){const e=window.visualViewport,t=e?e.offsetLeft:0,o=e?e.offsetTop:0,i=e?e.width:window.innerWidth,r=e?e.height:window.innerHeight;return R(t,o,i,r)}function D(e){if(!e||!e.isConnected)return null;const t=e.getBoundingClientRect();return t.width<2||t.height<2?null:R(t.left,t.top,t.width,t.height)}function fo(e,t){if(!e||!t)return 0;const o=Math.max(0,Math.min(e.right,t.right)-Math.max(e.left,t.left)),i=Math.max(0,Math.min(e.bottom,t.bottom)-Math.max(e.top,t.top));return o*i}function ho(e,t){return Math.max(0,t.left-e.left)+Math.max(0,e.right-t.right)+Math.max(0,t.top-e.top)+Math.max(0,e.bottom-t.bottom)}function yo(e,t){let o=0;for(const i of t||[]){const r=document.querySelector(i);if(!r||getComputedStyle(r).display==="none")continue;const n=D(r);!n||n.bottom<e.bottom-2||n.top>=e.bottom||(o=Math.max(o,e.bottom-n.top))}return o}function xo(e){const t=mo(),o=e.margin??uo,i=Math.max(Number(e.bottomInset||0),yo(t,e.avoidBottomSelectors)),r=t.left+o+Number(e.leftInset||0),n=t.top+o+Number(e.topInset||0),a=t.right-o-Number(e.rightInset||0),s=t.bottom-o-i;return R(r,n,Math.max(1,a-r),Math.max(1,s-n))}function vo(e){return e==="above"||e==="top"?["top","bottom","right","left"]:e==="right"?["right","left","bottom","top"]:e==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function bo(e,t,o,i,r){return e==="top"?R(t.left+(t.width-o)/2,t.top-i-r,o,i):e==="right"?R(t.right+r,t.top+(t.height-i)/2,o,i):e==="left"?R(t.left-o-r,t.top+(t.height-i)/2,o,i):R(t.left+(t.width-o)/2,t.bottom+r,o,i)}function wo(e,t){const o=be(e.left,t.left,Math.max(t.left,t.right-e.width)),i=be(e.top,t.top,Math.max(t.top,t.bottom-e.height));return R(o,i,e.width,e.height)}function ko(e){let t=e&&e.parentElement;for(;t&&t!==document.body&&t!==document.documentElement;){const o=getComputedStyle(t),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&t.scrollHeight>t.clientHeight+1)return t;t=t.parentElement}return null}function Eo(e,t){if(!e||Math.abs(t)<1)return!1;const o=ko(e);return o?o.scrollTop+=t:window.scrollBy({top:t,left:0,behavior:"auto"}),!0}function xe(e,t){const o=D(e);if(!o||t.height<60)return!1;let i;return o.height<=t.height?i=be(o.top,t.top,t.bottom-o.height):i=t.bottom-o.height,Eo(e,o.top-i)}function Ue(e,t){const o=getComputedStyle(e);for(const n of o)t.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=e.children,r=t.children;for(let n=0;n<i.length;n+=1)r[n]&&Ue(i[n],r[n])}function So(e){e.removeAttribute("id"),e.querySelectorAll("[id]").forEach(t=>t.removeAttribute("id"))}function Bo(e,t){const o=e.querySelectorAll("input, textarea, select"),i=t.querySelectorAll("input, textarea, select");o.forEach((r,n)=>{const a=i[n];a&&(r.type==="checkbox"||r.type==="radio"?a.checked=r.checked:a.value=r.value)})}function Ao(e,t={}){if(!e||!e.isConnected||t.disabled||!D(e))return null;const i=e.cloneNode(!0);So(i),Ue(e,i),Bo(e,i),i.setAttribute(t.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(t.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",t.prepareClone?.(i,e);const r=e.style.visibility;t.hideSource&&(e.style.visibility="hidden"),document.body.appendChild(i);const n=()=>{const s=D(e);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),t.hideSource&&(e.style.visibility=r)};return n(),{element:i,source:e,update:n,destroy:a}}function To({tooltip:e,panel:t,target:o,anchor:i,spotlight:r,options:n={}}){if(!e||!t||!o)return null;let a=0,s=!1,l=!1,g=!1,y="";const v=(c=!0)=>{if(s||!e.isConnected||!o.isConnected)return null;const u=xo(n),k=`${u.left}:${u.top}:${u.width}:${u.height}`;y&&y!==k&&(l=!1,c=!0),y=k;const p=D(i)||D(o),f=D(o);if(!p||!f)return null;const x=Math.min(Number(n.maxWidth||380),u.width);e.style.position="fixed",e.style.right="auto",e.style.bottom="auto",e.style.width=`${x}px`,e.style.maxWidth=`${x}px`,e.style.margin="0",e.style.justifyContent="flex-start",t.style.maxHeight=`${Math.max(120,u.height)}px`;const b=Math.min(t.offsetHeight||e.offsetHeight||190,u.height),w=Number(n.gap??go);c&&!l&&n.autoScroll!==!1&&f.height+b+w<=u.height&&(l=xe(o,u),l&&requestAnimationFrame(()=>v(!1)));const E=vo(n.preferredPlacement).map((I,$)=>{const J=bo(I,p,x,b,w),$e=ho(J,u),Le=fo(J,f);return{placement:I,index:$,raw:J,overflow:$e,overlap:Le,score:$e*1e5+Le*100+$}}),T=E.find(I=>I.overflow<.5&&I.overlap<1),A=T||E.slice().sort((I,$)=>I.score-$.score)[0],z=n.forceDock===!0||!T;let P="floating",F;if(z){P="docked";const I=Math.min(b,Number(n.dockMaxHeight||Math.max(180,u.height*.42)),u.height);t.style.maxHeight=`${I}px`;const $=Math.min(t.offsetHeight||I,I);if(F=R(u.left+(u.width-x)/2,u.bottom-$,x,$),c&&!l&&n.autoScroll!==!1){const J=R(u.left,u.top,u.width,Math.max(60,F.top-w-u.top));l=xe(o,J),l&&requestAnimationFrame(()=>v(!1))}}else if(F=wo(A.raw,u),c&&!l&&n.autoScroll!==!1){let I=u;if(A.placement==="bottom")I=R(u.left,u.top,u.width,Math.max(60,F.top-w-u.top));else if(A.placement==="top"){const $=F.bottom+w;I=R(u.left,$,u.width,Math.max(60,u.bottom-$))}l=xe(o,I),l&&requestAnimationFrame(()=>v(!1))}return e.dataset.tourLayoutMode=P,e.dataset.tourPlacement=z?"bottom-dock":A.placement,e.style.left=`${F.left}px`,e.style.top=`${F.top}px`,r?.update?.(),n.onLayout?.({mode:P,placement:e.dataset.tourPlacement,viewport:u,targetRect:D(o),anchorRect:D(i)||D(o),tooltipRect:F}),{mode:P,placement:e.dataset.tourPlacement,rect:F}},S=(c=!1)=>{g=g||c===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const u=g;g=!1,v(u)}))},C=()=>{l=!1,S(!0)},G=typeof ResizeObserver=="function"?new ResizeObserver(S):null;G?.observe(o),i&&i!==o&&G?.observe(i),G?.observe(t),window.addEventListener("resize",C),window.addEventListener("orientationchange",C),window.addEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",C),window.visualViewport.addEventListener("scroll",S));const ye=()=>{s=!0,a&&cancelAnimationFrame(a),G?.disconnect(),window.removeEventListener("resize",C),window.removeEventListener("orientationchange",C),window.removeEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",C),window.visualViewport.removeEventListener("scroll",S))},m=v(!0);return{destroy:ye,reposition:()=>v(!1),result:m}}function V(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function se(...e){return V("setFilter")?.(...e)}function Fe(...e){return V("setBookingsSubview")?.(...e)}function Io(...e){return V("toast")?.(...e)}function de(...e){return V("updateGoLiveBanner")?.(...e)}function Co(...e){return V("seedTourRevenueShell")?.(...e)}function zo(...e){return V("finishTourHydration")?.(...e)}function Mo(...e){return V("goLive")?.(...e)}let X=null,le=null,W=null;function j(){if(document.getElementById("frontdeskTourPolishStyle"))return;const e=document.createElement("style");e.id="frontdeskTourPolishStyle",e.textContent=`
  ...
  `,document.head.appendChild(e)}function Ae(){X&&(document.removeEventListener("keydown",X),X=null)}function Po(e){Ae(),X=t=>{if(t.defaultPrevented)return;const o=t.target&&t.target.tagName?t.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||t.target?.isContentEditable||(t.key==="Escape"?(t.preventDefault(),e.onSkip?.()):t.key==="Enter"||t.key==="ArrowRight"?(t.preventDefault(),e.onNext?.()):t.key==="ArrowLeft"&&(t.preventDefault(),e.onBack?.()))},document.addEventListener("keydown",X)}function ve(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function L(e){j();const t=e||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=t.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=t.blockPointer?"auto":"none",t.lockScroll&&(document.body.style.overflow="hidden"),o}const ie="rgba(17,24,39,0.42)";function K(){const e=document.getElementById("tourTooltip"),t=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!e||t)return Promise.resolve();e.style.pointerEvents="none";const o=e.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function Ro(e,t){return W?.destroy(),W=Ao(e,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=t?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=t?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=t?.spotlightOutlineOffset??"2px",t?.spotlightBackground&&(o.style.background=t.spotlightBackground,o.style.backgroundColor=t.spotlightBackground),t?.spotlightBorderRadius&&(o.style.borderRadius=t.spotlightBorderRadius)}}),W?.element||null}function H(e){const t=e||{};Ae(),le?.destroy(),le=null,W?.destroy(),W=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!t.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.style.opacity=n.dataset.tourOrigOpacity||"";const a=n.dataset.tourOrigBackground||"",s=n.dataset.tourOrigBackgroundColor||"";s?n.style.backgroundColor=s:n.style.removeProperty("background-color"),a?n.style.background=a:n.style.removeProperty("background"),n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius,delete n.dataset.tourOrigOpacity});const r=document.getElementById("goLiveBanner");r&&r.dataset.tourHidden&&(delete r.dataset.tourHidden,typeof de=="function"&&de()),t.keepOverlay||(document.body.style.overflow="")}function Oo(){const e=document.getElementById("tourTooltip"),t=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[e,...t,...o].filter(Boolean);return!i.length&&!o.length?(H({keepOverlay:!0}),Promise.resolve()):(Ae(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(H({keepOverlay:!0}),Promise.resolve()):(e&&(e.style.pointerEvents="none"),i.forEach(n=>{n.style.transition="opacity 0.07s ease, transform 0.07s ease",n.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(n=>{n.style.opacity="0",n.id==="tourTooltip"&&(n.style.transform="translateY(4px)")})}),new Promise(n=>{setTimeout(()=>{H({keepOverlay:!0}),n()},85)})))}function $o(e){const t=[e,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);t.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{t.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function _(e,t){if(!t.openAccordion)return;const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function U(e){if(!e)return null;for(const t of String(e).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(t);if(o&&o.isConnected)return o}return null}function Q(e,t){if(t.highlightSelector){const o=U(t.highlightSelector);if(o)return o}if(t.highlightCard){const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(o)return o}return t.targetParent&&(e.closest(".booking-card")||e.closest(".accordion-body"))||e}function ne(e,t){if(!t)return e;const o=String(t.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const r=document.querySelector(i);if(r&&r.isConnected)return r}if(t.accordionCard){const i=document.querySelector(t.accordionCard);if(i&&i.isConnected)return i}return e&&e.isConnected?e:null}function ce(e,t){if(!e||!e.isConnected)return null;const o=e.getBoundingClientRect();return o.width<2||o.height<2||!t&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Ve(e,t){const o=U(e.anchorSelector);if(o){const i=ce(o,!0);if(i)return i}return ce(t,!0)}function He(e,t){const o=e.tooltipAnchorSelector||e.anchorSelector,i=U(o);if(i){const r=ce(i,!0);if(r)return r}return Ve(e,t)}function pe(e){const t=e||"auto";try{window.scrollTo({top:0,left:0,behavior:t})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const r=document.querySelector(i);r&&(r.scrollTop=0)})}function Ge(e,t,o){const i=o||{},r=t.scrollTarget||t.accordionCard,n=(r?U(r):null)||e;if(!n&&!t.scrollToTop)return Promise.resolve();const a=t.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,l=i.smooth&&!s?"smooth":d.settingsTourActive||s?"auto":"smooth";return new Promise(g=>{if(t.scrollToTop&&(pe(l),t.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{t.forcePageTop&&pe("auto"),g()}));return}if(!n){g();return}if(n.scrollIntoView({behavior:l,block:a,inline:"nearest"}),l==="auto"){requestAnimationFrame(()=>requestAnimationFrame(g));return}let y=!1;const v=()=>{y||(y=!0,window.removeEventListener("scrollend",S),clearTimeout(C),requestAnimationFrame(()=>requestAnimationFrame(g)))},S=()=>v();"onscrollend"in window&&window.addEventListener("scrollend",S,{once:!0});const C=setTimeout(v,520)})}function _e(){H(),localStorage.setItem("settingsTourStep","handoff");const e=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&se("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const r=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof r=="function"&&r({chainFromSettingsTour:!0})},t=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof t=="function"?t().then(e).catch(e):e()}function Z(){H({keepOverlay:!0}),j(),d.settingsTourActive=!1,de(),L({blockPointer:!0,lockScroll:!0,dim:ie});const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(A),!document.getElementById("tourModalAnimStyle")){const z=document.createElement("style");z.id="tourModalAnimStyle",z.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(z)}document.getElementById("tourNextBtn").onclick=()=>{K().then(()=>{r({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),l()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}}function G(){j(),L({blockPointer:!0,lockScroll:!0,dim:ie});let m=0;const c=[`<div style="padding:20px 18px 0;">
  ...
  </div>`}function Ke(e=null){const t=O(),o=t?"https://guest-lodge-backend.onrender.com":"",i=e?.request||null,r=i?.scheduledFor?new Date(i.scheduledFor).toLocaleDateString([],{year:"numeric",month:"short",day:"numeric"}):"",n=t?i?`<div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border);">
