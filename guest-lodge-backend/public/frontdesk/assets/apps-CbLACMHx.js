import{c as g,e as D}from"./settings-BlPlmvTI.js";const s={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4",frontdeskInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_19-49-38_1_tc1bzm.mp4"},O="32px";function b(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function m(t){return`border-radius:${O};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function B(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let z=[],x=0;function V(t,e){v(!1),z=t,x=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?_(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?_(-1):i.key==="Escape"&&S()},document.addEventListener("keydown",o._keyHandler);let a=0;o.addEventListener("touchstart",i=>{a=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const l=i.changedTouches[0].clientX-a;Math.abs(l)>50&&_(l<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",A()}function S(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function _(t){const e=z.length;e<=1||(x=(x+t+e)%e,A())}function A(){const t=document.getElementById("appsLightbox");if(!t)return;const e=z[x],o=z.length,a=e.type!=="video",i=o>1?`${x+1} / ${o}`:"",l=a?`<img src="${B(e.src)}" alt="${e.alt||""}"
       ...
       </video>`,r=o>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",p=o>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",n=o>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:o},(c,d)=>`<div onclick="appsOpenLightbox(_appsLbItems,${d})" style="width:7px;height:7px;border-radius:50%;background:${d===x?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${n}
    </div>`}function H(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function f(t,e,o,a,i){const l=i?H("Video"):"",r=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${a})">
    <div class="apps-q-text">
      <div class="apps-q-title">${t}${l}</div>
      ${e?`<div class="apps-q-hint">${e}</div>`:i?'<div class="apps-q-hint">Tap to watch — about 1 min</div>':""}
    </div>
    ${r}
  </button>`}function W(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function T(t){const e=document.getElementById("appsView");if(!e)return;const o=(g.activeHotelId||"")+"|"+(g.activeHotelAppIcon||"")+"|"+(g.activeHotelDomain||"");t||e.dataset.appsKey!==o||!e.querySelector(".apps-page")?(M(),e.dataset.appsKey=o):j()}function M(){const t=document.getElementById("appsView");if(!t)return;const e=g.activeHotelName||"Your Hotel",o=g.activeHotelAppIcon||"",a=e.trim().charAt(0).toUpperCase()||"🏨",i=g.activeHotelDomain||"",l=i?"https://"+i:"#",r=i?"https://"+i+"/install":"#";function p(Y){return JSON.stringify(Y).replace(/"/g,"&quot;")}const n=b(s.guestHome,520),c=[{type:"image",src:s.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],d=[{type:"image",src:s.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:s.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:s.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],h=[{type:"video",src:s.guestInstallVideo,poster:s.guestHome,alt:"Guest adds hotel to phone",title:"How your guests put your hotel on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your hotel shows up on their phone like an app. You don't need to do anything."}],N=[{type:"image",src:s.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your hotel app.'},{type:"image",src:s.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:s.guestMessageNotifVideo,poster:s.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],w=isStandaloneApp()||g.frontdeskInstalled,P=typeof Notification<"u"&&Notification.permission==="granted",C=[{type:"video",src:s.frontdeskInstallVideo,poster:s.frontdeskMessages,alt:"How to add Front Desk",title:"Add Front Desk to your home screen",caption:"Tap <strong>Add to Home Screen</strong> in your browser — same site you're on now. No App Store. Takes about 3 seconds."},{type:"image",src:s.frontdeskMessages,alt:"Reply to guest",title:"You reply from your phone",caption:"Messages from guests show up in <strong>Bookings</strong>. Tap reply — they get it on their phone."}];let k;w&&P?k=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
    ...
    </div>`:w?k=`<div id="tour-fd-installed-badge"><p style="font-size:13px;color:var(--text-muted);margin:0 0 12px;line-height:1.55;">You're on the home-screen version. Turn on alerts so your phone buzzes when a guest books.</p>
      <button onclick="toggleAppNotifications()" style="width:100%;padding:14px;border-radius:12px;border:none;background:var(--green);color:#fff;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;">Turn on booking alerts</button></div>`:k=`<p style="font-size:13px;color:var(--text-muted);margin:0 0 14px;line-height:1.55;">This website — the one you're on right now — can sit on your home screen like an app. <strong>No App Store.</strong> About 3 seconds. It's a shortcut, not a download, but it can <strong>buzz you when guests book</strong>.</p>
      ...
      <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${p(C)},0)" style="margin-top:0;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how (1 min)</span></button>`;const E=`
    <div class="apps-icon-card">
      <div id="appsAppIconPreview" style="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);background:#fff;border:1px solid var(--border);padding:8px;box-sizing:border-box;color:#fff;font-size:24px;font-weight:800;">
        ${o?`<img src="${o}" alt="Hotel logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);border-radius:8px;">${a}</span>`}
      </div>
      ...
      <button type="button" onclick="showCheckinQrOverlay()" style="width:100%;padding:15px;border-radius:12px;border:none;background:var(--green);color:#fff;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;">📲 Show QR at check-in</button>
      ${r!=="#"?`
      ...
      <p style="font-size:12px;color:var(--text-muted);margin:8px 0 0;text-align:center;line-height:1.5;">Scroll down and install <strong style="color:var(--text);">${e}</strong> on your home screen to see what guests see.</p>`:""}
      ${r==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,G=`
        <div id="guestInstallStats" style="display:none;margin-bottom:14px;"></div>
        ${r!=="#"?`
        <div style="margin-bottom:16px;">
          <div style="font-size:12px;font-weight:700;color:var(--text);margin-bottom:8px;">Share install link</div>
        ...
        <div class="apps-q-list">
          ${f("What guests see on their phone","",p(d),0,!1)}
          ${f("How guests add your hotel","",p(h),0,!0)}
          ${f("Guest texts you, you text back","",p(N),0,!0)}
          ${f("Your app and theirs — side by side","",p(c),0,!1)}
        </div>
        ${l!=="#"?`<button onclick="window.open('${l}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,F=w?`
    <div class="apps-step-card" id="tour-fd-install-card">
      <div class="apps-step-title" style="margin-bottom:14px;">Change your icon</div>
      ${E}
    </div>
    ${guestBroadcastCardHtml()}
    <div class="apps-step-card">
      <div class="apps-step-title" style="margin-bottom:14px;">At check-in</div>
      ${L}
    </div>`:`
    <p class="apps-intro">Two shortcuts on the home screen — yours and theirs. No App Store, no extra apps to download.</p>
    <div class="apps-step-card" id="tour-fd-install-card">
      <div class="apps-section-divider" style="margin-top:0;padding-top:0;border-top:none;">Your phone</div>
      <div class="apps-step-title">Add Front Desk to your home screen</div>
      ${k}
    </div>
    <div class="apps-step-card">
      <div class="apps-section-divider" style="margin-top:0;padding-top:0;border-top:none;">Guest phones</div>
      <div class="apps-step-title">Guests save <strong>${e}</strong> to their phone</div>
      <div style="border-radius:12px;background:#f4f7f9;border:1px solid var(--border);margin:0 0 12px;padding:16px;text-align:center;">
        <img src="${n}" alt="Guest saves hotel to phone" loading="eager" decoding="sync" style="max-width:140px;width:55%;height:auto;min-height:120px;display:block;margin:0 auto;border-radius:12px;box-shadow:0 4px 14px rgba(0,0,0,0.1);">
      </div>
      <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${p(h)},0)" style="margin-bottom:14px;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how (1 min)</span></button>
      <p style="font-size:13px;color:var(--text-muted);margin:0 0 14px;line-height:1.55;">Same idea — they tap <strong>Add to Home Screen</strong> on your booking page (or scan your QR at check-in). Then they can book and message you direct.</p>
      <div id="tour-guest-icon-section">
      <div class="apps-step-title" style="margin-bottom:10px;">Change your icon</div>
      ${E}
      </div>
      <div style="margin-top:22px;padding-top:20px;border-top:1px solid var(--border);">
        <div class="apps-step-title" style="margin-bottom:12px;">At check-in</div>
        ${L}
      </div>
    </div>`,R=w?"Booking alerts live on the <strong>Bookings</strong> tab · iPhone &amp; Android home-screen shortcuts":"iPhone &amp; Android · home-screen shortcuts · no App Store";t.innerHTML=`
  <style>
  ...
  <div class="apps-page">
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),j()}async function j(){const t=document.getElementById("guestInstallStats");try{const e=await api("GET","/api/crm/guest-install-stats");if(!e.success)throw new Error(e.message||"Failed");if(guestPushSubscriberCount=e.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const o=e.totals||{},a=e.installedBookings||0,i=o.views||0;if(!a&&!i){t.style.display="none",t.innerHTML="";return}t.style.display="block";const l=e.installRatePercent!=null?e.installRatePercent:0,r=Object.entries(e.byTouchpoint||{}).filter(function(n){return n[1].views||n[1].installed}).sort(function(n,c){return(c[1].installed||0)-(n[1].installed||0)}).slice(0,5),p=r.length?r.map(function(n){const c=n[0].replace(/-/g," "),d=n[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+c+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(d.views||0)+" views · "+(d.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+l+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+a+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div>'+(p?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+p:"")}catch{guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}let $=[],u=0,y=!1;function v(t){const e=document.getElementById("appsTourLightbox");e&&(e._swipeStart&&e.removeEventListener("touchstart",e._swipeStart),e._swipeEnd&&e.removeEventListener("touchend",e._swipeEnd),e.remove()),document.body.style.overflow="";const o=y;y=!1;try{const a=typeof T=="function"?T:window.ensureAppsViewRendered;typeof a=="function"&&a(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),o||localStorage.getItem("settingsTourStep")==="handoff"||g.settingsTourActive)){const i=typeof showFinaleMockModal=="function"?showFinaleMockModal:window.showFinaleMockModal;if(typeof i=="function"){i();return}}}function q(t){const e=u+t;e<0||e>=$.length||(u=e,I())}function I(){const t=document.getElementById("appsTourLightbox");if(!t)return;const e=$[u],o=$.length,a=u>=o-1,i=`${u+1} / ${o}`,l=a?y?"Next — you're almost done":"Got it — show me":"Next →",r=e.type==="video"?H("1 min","light"):"",p=Array.from({length:o},(c,d)=>`<div style="width:7px;height:7px;border-radius:50%;background:${d===u?"#fff":"rgba(255,255,255,0.35)"};"></div>`).join("");let n="";e.type==="cta"?n=`<div style="width:100%;max-width:320px;padding:0 8px;box-sizing:border-box;">${e.ctaHtml}</div>`:e.type==="video"?n=`<video autoplay loop muted playsinline webkit-playsinline preload="metadata"
      style="max-width:100%;max-height:min(50dvh,440px);width:auto;height:auto;display:block;${m()}"
      poster="${e.poster||""}">
      <source src="${e.src}" type="video/mp4">
    </video>`:n=`<img src="${e.src}" alt="${e.alt||""}" loading="eager" decoding="async"
    ...
    <div style="flex-shrink:0;width:100%;max-width:400px;margin:0 auto;padding:12px 20px max(16px,env(safe-area-inset-bottom));box-sizing:border-box;text-align:center;">
      ...
      <button type="button" id="appsTourNextBtn" style="width:100%;padding:14px;border-radius:12px;border:none;background:#2E7D5B;color:#fff;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;margin-bottom:12px;">${l}</button>
      <div style="display:flex;gap:6px;justify-content:center;">${p}</div>
    </div>`,document.getElementById("appsTourNextBtn").onclick=()=>{if(a){const c=y;if(v(!0),!c){const d=document.getElementById("appsView");d&&d.scrollIntoView({behavior:"smooth",block:"start"})}}else u++,I()},document.getElementById("appsTourSkipBtn").onclick=()=>v(!0)}function U(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(y=!!o,!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox"))return;const a=g.activeHotelName||"Your Hotel",i=a.length>13?a.slice(0,13)+"…":a,l=a.trim().charAt(0).toUpperCase(),r=g.activeHotelAppIcon||"",p=r?`<div style="width:52px;height:52px;border-radius:14px;background:#fff;padding:8px;box-sizing:border-box;flex-shrink:0;display:flex;align-items:center;justify-content:center;"><img src="${r}" alt="${a}" style="width:100%;height:100%;object-fit:contain;"></div>`:`<div style="width:52px;height:52px;border-radius:14px;background:#2E7D5B;color:#fff;font-size:22px;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;">${l}</div>`;$=[{type:"video",src:s.guestInstallVideo,poster:b(s.guestHome,400),title:"Guests save your hotel to their phone",caption:`They tap <strong>Add to Home Screen</strong> on your booking page or scan your QR. Tap <strong>Change your icon</strong> on the Phones tab so they see <strong>${i}</strong>.`},{type:"image",src:b(s.guestHome,520),alt:"Guest home screen",title:"What guests see after they install",caption:"Their stay info, direct booking, and a way to message you — all from one icon on their phone."},{type:"cta",title:"On the Phones tab",caption:"",ctaHtml:`
        ...
        </div>`}],u=0,S(),v(!1);const n=document.createElement("div");n.id="appsTourLightbox",n.style.cssText=["position:fixed;inset:0;z-index:102001;background:#000;","display:flex;flex-direction:column;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join("");let c=0;n._swipeStart=d=>{c=d.changedTouches[0].clientX},n._swipeEnd=d=>{const h=d.changedTouches[0].clientX-c;Math.abs(h)>50&&q(h<0?1:-1)},n.addEventListener("touchstart",n._swipeStart,{passive:!0}),n.addEventListener("touchend",n._swipeEnd,{passive:!0}),document.body.appendChild(n),document.body.style.overflow="hidden",I()}const Q={appsCloseLightbox:S,appsCloudinaryFull:B,appsCloudinaryImg:b,appsLbNav:_,appsLbRender:A,appsOpenLightbox:V,appsPhoneImgStyle:m,appsQuestionRow:f,appsTourClose:v,appsTourNav:q,appsTourRender:I,appsVideoBadgeHtml:H,detectAppPlatform:W,ensureAppsViewRendered:T,loadGuestInstallStats:j,renderAppsView:M,startAppsTour:U};function K(){D(Q)}export{Q as default,K as install};
