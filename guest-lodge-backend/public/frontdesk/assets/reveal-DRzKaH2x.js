import{c as n,e as oe}from"./settings-CBZ0R7Zu.js";const R="marketelValueRevealPendingV1",E="marketelValueRevealStepV1",X="marketelBillingIntervalV1";let r=0,u="guest",p=!1,f={rooms:[],rates:null},L=null,o={ready:!1,checking:!0,reason:"",attempts:0,domain:""},k=0,$=0,I=null,l=0,V=0,A=0,b="month",v=null,O=!1,h=!1,T=!1;const ne="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/46/2a/e1/462ae1c9-9347-efd0-5e99-41e7f636e3f7/phone-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg",se="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/23/4c/cb/234ccbb4-e65a-bb94-f877-3d230743e9e3/safari-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg";function Z(){const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e==="0.0.0.0"||e==="::1"||e.endsWith(".local")||/^10\./.test(e)||/^192\.168\./.test(e)||/^172\.(1[6-9]|2\d|3[01])\./.test(e)}function d(e){return String(e??"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function G(e){const a=Number(e);return Number.isFinite(a)?new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:Number.isInteger(a)?0:2}).format(a):"$99"}function g(){return n.activeHotelName||"Your Property"}function Y(){return f.rooms[0]||n.editRooms[0]||{name:"Your first room",totalUnits:1,images:[]}}function le(){const e=Y();return e.images?.[0]?.url||e.imageUrl||""}function de(){return f.rates?.nightly||99}function ce(){const e=Number(f.rates?.nightly);if(!Number.isFinite(e)||e<=0)return`<div class="mvr-value-bridge is-proof-only">
    ...
    <p>At ${G(e)} per night, shifting ${i} room-night${i===1?"":"s"} from an estimated 15% OTA fee to direct represents about ${G(c)} in commission savings.</p>
  ...
  </section>`,e.layer.classList.add("is-visible"),e.layer.setAttribute("aria-hidden","false"),e.layer.querySelector(".mvr-challenge-edit")?.addEventListener("click",()=>{P(e),J(e.modal,"edit",e.previewOpenedAt,"challenge-completed")}),e.layer.querySelector(".mvr-challenge-skip")?.addEventListener("click",()=>{P(e),S(e.modal,!0)}),m("BookingChallengeCheckoutReached",H(a)),s("JourneyBookingChallengeCompleted",{elapsedMs:a,completedWithin60Seconds:a<=6e4},{durationMs:a})}function te(e){const a=e?.data?.type;if(a!=="marketel:show-guest-app"&&a!=="marketel:continue-owner-tour"&&a!=="marketel:checkout-reached")return;const t=document.getElementById("marketelValueReveal");if(!(!t||!Array.from(t.querySelectorAll("iframe")).some(c=>c.contentWindow===e.source))){if(a==="marketel:checkout-reached"){if(v?.iframe?.contentWindow!==e.source||u!=="guest")return;be(v);return}v?.iframe?.contentWindow===e.source&&(m("GuestAppPreviewRequestedFromBookingEngine"),J(v.modal,"edit",v.previewOpenedAt,"booking-install-explainer-continued"))}}function fe(){return`<div class="mvr-progress" aria-label="Marketel overview progress">
    ...
    <div class="mvr-visual mvr-assistant-visual">
      <div class="mvr-booking-alert">
        ...
        <div><span>Front Desk</span><strong>New ${d(e)} booking</strong><small>Tomorrow · ${G(de())}</small></div>
        <b>now</b>
      </div>
      <div class="mvr-chat">
  ...
  </section>`}function Ie(){const e=n.hotelSubscribed,a=b==="year",t=a?"$1,990":"$199",i=a?"/year":"/month",c=a?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month";return`<section class="mvr-stage mvr-stage-finale">
