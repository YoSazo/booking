import{c as u,e as mt}from"./settings-C0uRYYTN.js";function B(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function rt(...t){return B("ensureAppsViewRendered")?.(...t)}function pt(...t){return B("showFinaleMockModal")?.(...t)}function lt(...t){return B("finishTourHydration")?.(...t)}function G(...t){return B("goLive")?.(...t)}function P(...t){return B("toast")?.(...t)}function bt(...t){return B("appsCloseLightbox")?.(...t)}let q=[],c=0,N=!1,E=null,j=null;function dt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
