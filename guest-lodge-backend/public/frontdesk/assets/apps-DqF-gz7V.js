import{c as r,a as Mt,b as Nt,e as Rt}from"./settings-CidShSGB.js";function y(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function at(...t){return y("ensureAppsViewRendered")?.(...t)}function st(...t){return y("showFinaleMockModal")?.(...t)}function rt(...t){return y("finishTourHydration")?.(...t)}function pt(...t){return y("goLive")?.(...t)}function lt(...t){return y("toast")?.(...t)}function jt(...t){return y("appsCloseLightbox")?.(...t)}let M=[],g=0,N=!1,F=null,P=null,R=null,S=null;function qt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function T(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function dt(){F&&(document.removeEventListener("keydown",F),F=null)}function Vt(t){dt(),F=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",F)}function Yt(t,e){return!t||!t.isConnected||e?.noHighlight?null:(t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),S?.destroy(),S=Nt(t,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"none",o.style.outline=e?.spotlightOutline??"none",o.style.outlineOffset=e?.spotlightOutlineOffset??"0",(t.classList.contains("apps-story-line")||e?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),S?.element||null)}function ct(t){const e=t||{};dt(),R?.destroy(),R=null,S?.destroy(),S=null,P&&(clearTimeout(P),P=null);const o=document.getElementById("appsTourLightbox");o&&!e.keepLightbox&&o.remove();const a=document.getElementById("appsTourTooltip");a&&a.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function f(t){ct(),document.body.style.overflow="";const e=N;N=!1;try{const o=typeof at=="function"?at:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),e||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive)){const a=typeof st=="function"?st:window.showFinaleMockModal;if(typeof a=="function"){a();return}}}function Wt(t){const e=g+t;e<0||e>=M.length||(g=e,C())}function W(){if(localStorage.setItem("appsTourDone","1"),N||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive){r.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const e=typeof rt=="function"?rt:window.finishTourHydration;typeof e=="function"&&e()}}function Ut(){W();const t=typeof pt=="function"?pt:window.goLive;if(f(!1),typeof t=="function"){t();return}const e=typeof lt=="function"?lt:window.toast;typeof e=="function"&&e("Open Go live to activate your booking page.","error")}function C(){qt();const t=M[g];if(!t){f(!0);return}const e=M.length,o=g>=e-1,a=`${g+1} / ${e}`,i=Math.max(8,Math.min(100,Math.round((g+1)/e*100))),n=document.querySelector(t.target);if(!n){g++,C();return}ct({keepLightbox:!0});let s=document.getElementById("appsTourLightbox");s||(s=document.createElement("div"),s.id="appsTourLightbox",s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(s)),t.noHighlight||(n.dataset.appsTourOrigPosition=n.style.position||"",n.dataset.appsTourOrigZIndex=n.style.zIndex||"",n.dataset.appsTourOrigIsolation=n.style.isolation||"",n.dataset.appsTourOrigBoxShadow=n.style.boxShadow||"",n.dataset.appsTourOrigOutline=n.style.outline||"",n.dataset.appsTourOrigOutlineOffset=n.style.outlineOffset||"",n.dataset.appsTourOrigTransition=n.style.transition||"",n.style.position=n.style.position||"relative",n.style.zIndex="100002",n.style.isolation="isolate",n.style.transition="box-shadow 0.18s ease, outline 0.18s ease",n.style.boxShadow=t.spotlightBoxShadow??"none",n.style.outline=t.spotlightOutline??"none",n.style.outlineOffset=t.spotlightOutlineOffset??"0",(n.classList.contains("apps-story-line")||t.hideSpotlightBorder)&&(n.dataset.appsTourOrigBorderTop=n.style.borderTop||"",n.dataset.appsTourOrigPaddingTop=n.style.paddingTop||"",n.style.borderTop="none",n.style.paddingTop="0"),n.setAttribute("data-apps-tour-highlighted","1"));const c=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,x=t.scrollBlock||"nearest",v=c?"auto":"smooth";n.scrollIntoView({behavior:v,block:x});const l=()=>{const k=document.getElementById("appsTourTooltip");k&&k.remove();const d=Math.min(370,window.innerWidth-28),b=t.primaryLabel||(o?"Done":"Next"),I=t.secondaryLabel||(o?"Not now":"Skip tour"),_=g<=0,E=t.kicker||"Guest App",p=document.createElement("div");p.id="appsTourTooltip",p.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${d}px;max-width:${d}px;visibility:hidden;`,p.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${T(t.title)}">
        ...
        <div class="apps-tour-kicker">${T(E)}</div>
        <div class="apps-tour-title">${T(t.title)}</div>
        <p class="apps-tour-copy">${T(t.text)}</p>
        <div class="apps-tour-actions">
          <button type="button" id="appsTourBackBtn" class="apps-tour-btn" ${_?"disabled":""}>Back</button>
          <button type="button" id="appsTourSkipBtn" class="apps-tour-btn apps-tour-btn-ghost">${T(I)}</button>
          <button type="button" id="appsTourNextBtn" class="apps-tour-btn apps-tour-btn-primary">${T(b)}</button>
        </div>
      </div>`,document.body.appendChild(p),Yt(n,t);const m=p.querySelector(".apps-tour-panel");R?.destroy(),R=Mt({tooltip:p,panel:m,target:n,anchor:n,spotlight:S,options:{preferredPlacement:t.tooltipPosition||"auto",maxWidth:d,gap:t.tooltipGap??10,autoScroll:!0,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),p.style.visibility="visible";const h=()=>{if(t.activateOnNext){Ut();return}if(o){W(),f(!1),t.openGuestInstallCoachOnNext&&window.setTimeout(()=>y("appsOpenGuestInstallCoach")?.(),0);return}g++,C()},O=()=>{if(o){W(),f(!1);return}f(!0)},V=()=>{g<=0||(g--,C())};document.getElementById("appsTourNextBtn").onclick=h,document.getElementById("appsTourSkipBtn").onclick=O;const H=document.getElementById("appsTourBackBtn");H&&(H.onclick=V),Vt({onNext:h,onBack:V,onSkip:O})};P=setTimeout(()=>{requestAnimationFrame(l)},c?40:320)}function Zt(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;jt(),f(!1),N=!!o;const a=!!r.hotelSubscribed;M=!!y("isNativeFrontdeskApp")?.()||document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1"?[{target:"#tour-guest-reach",kicker:"Direct guest reach",title:"Send a push notification directly to their phone.",text:"Every guest who downloads your app and turns on notifications can receive a message from you whenever you choose.",tooltipPosition:"above"},{target:"#tour-native-guest-share",kicker:"Build your audience",title:"Get your app onto their phone.",text:"Show the QR, copy the link, or open the guest page. They install it from there.",tooltipPosition:"above"},{target:"#tour-guest-icon-section",kicker:"Make it yours",title:"Choose the icon guests will save.",text:"Use your logo or a clear property photo.",scrollBlock:"start",tooltipPosition:"below"},{target:"#tour-native-install-guide",kicker:"Your cheat sheet",title:"Know exactly what to tell them.",text:"Open this anytime to practice the exact Safari taps for older iPhones and every iOS 26 layout.",primaryLabel:"Show me",secondaryLabel:"Close",openGuestInstallCoachOnNext:!0,tooltipPosition:"above"}]:[{target:"#tour-apps-intro",kicker:"The loop",title:"Your property becomes the app—and the direct connection.",text:"Guests book direct, save your property to their phone, and can receive notifications from you."},{target:"#tour-apps-first",kicker:"Your side",title:"Put Front Desk on your phone in 3 steps.",text:"There is no App Store. Save this page to your home screen so new bookings can reach you before they confirm — even when Front Desk is closed.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-then",kicker:"Their side",title:"Guests install from your booking page.",text:"One tap on Install and your icon is on their home screen.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-after",kicker:"Direct reach",title:"Send a notification to their phone whenever you want.",text:"Anyone who installs your app and turns on notifications becomes reachable directly from Front Desk.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your property.",text:"A real logo or a clear photo. Guests see this square every time.",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10},{target:"#tour-apps-loop",kicker:a?"Live loop":"Activation",title:a?"This loop is on.":"Everything is ready to turn on.",text:a?"Guests book, save your property, receive your updates, and message you. Front Desk gets the alerts.":"For $199/month, guests can book direct, save your property, receive your updates, and message you — while Front Desk receives the alerts.",primaryLabel:a?"Done":"Activate everything — $199/month",secondaryLabel:a?"Close":"Keep exploring",activateOnNext:!a,tooltipPosition:"below",tooltipGap:8}],g=0,C()}const u={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},Kt="32px";function Z(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function U(t){return`border-radius:${Kt};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function gt(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let j=[],z=0,q="ios26",$=null,ut="",L=null;function Qt(t,e){f(!1),isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),j=t,z=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?D(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?D(-1):i.key==="Escape"&&K()},document.addEventListener("keydown",o._keyHandler);let a=0;o.addEventListener("touchstart",i=>{a=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const n=i.changedTouches[0].clientX-a;Math.abs(n)>50&&D(n<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",Q()}function K(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState()))}function D(t){const e=j.length;e<=1||(z=(z+t+e)%e,Q())}function Q(){const t=document.getElementById("appsLightbox");if(!t)return;const e=j[z],o=j.length,a=e.type!=="video",i=o>1?`${z+1} / ${o}`:"",n=a?`<img src="${gt(e.src)}" alt="${e.alt||""}"
    ...
    ${Array.from({length:o},(v,l)=>`<div onclick="appsOpenLightbox(_appsLbItems,${l})" style="width:7px;height:7px;border-radius:50%;background:${l===z?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
  ...
  </div>`}function ft(){const t=q==="ios26",e=$==="compact",i=t&&!$?`
    ...
    <section class="agic-sheet" role="dialog" aria-modal="true" aria-label="How guests install your app">
      <div class="agic-header">
        ${t&&$?'<button type="button" onclick="appsGuestInstallCoachSelectLayout(null)" aria-label="Back">‹</button>':"<span></span>"}
      ...
      ${i}
    </section>`}function xt(){const t=document.getElementById("appsGuestInstallCoach");t&&(t.innerHTML=ft())}function ee(){f(!1),K(),document.getElementById("appsGuestInstallCoach")?.remove(),q="ios26",$=null,ut=document.body.style.overflow,document.body.style.overflow="hidden",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),L=e=>{e.key==="Escape"&&bt()},document.addEventListener("keydown",L);const t=document.createElement("div");t.id="appsGuestInstallCoach",t.innerHTML=ft(),document.body.appendChild(t)}function bt(){L&&(document.removeEventListener("keydown",L),L=null),document.getElementById("appsGuestInstallCoach")?.remove(),document.body.style.overflow=ut,isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState())}function oe(t){q=t==="classic"?"classic":"ios26",$=q==="classic"?"standard":null,xt()}function ie(t){$=["standard","compact"].includes(t)?t:null,xt()}function mt(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function A(t,e,o,a,i){const n=i?mt("Video"):"",s=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${a})">
    ...
    <div id="bookingReviewReminderSetting" style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border);">
    ...
    </div>`:d&&O?B=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
      <div style="width:32px;height:32px;border-radius:50%;background:#2E7D5B;color:#fff;display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0;">✓</div>
      ...
      <div style="font-size:12px;color:var(--text-muted);line-height:1.45;text-align:center;">Locked until Front Desk is installed on your phone</div>`;const wt=b?`<div class="apps-story-status">
        ...
        <span>Front Desk is installed here. ${p?"This iPhone can receive booking alerts.":m?"Booking-alert connection is in progress.":"Turn on notifications in iPhone Settings to receive booking alerts."}</span>
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${c(w)},0)" style="margin-bottom:12px;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how guests install (1 min)</span></button>
        ...
        <div class="apps-q-list">
          ${A("What guests see on their phone","",c(l),0,!1)}
          ${A("How guests add your property","",c(w),0,!0)}
          ${A("Guest texts you, you text back","",c(k),0,!0)}
          ${A("Your app and theirs — side by side","",c(v),0,!1)}
        </div>
    ...
    <div class="apps-step-card">
      ...
      <div class="apps-step-title">${p?"Booking alerts are on":m?"Connecting booking alerts":"Turn on booking alerts"}</div>
      <p style="font-size:12px;color:var(--text-muted);line-height:1.5;margin:0 0 ${p?"0":"12px"};">${p?"Front Desk can alert you about new bookings and room checks even when the app is closed.":m?"Front Desk has notification permission and is registering this iPhone. Refresh once if this message remains.":"Notifications are what let Front Desk warn you before an online booking conflicts with a walk-in or outside booking."}</p>
    ...
    ${Et}`,Dt=_?Gt:`${Bt}
      ${It}
      ${ot}
      ${d?Pt:`${Lt}${Y()}`}`,it=_?"":d?"Front Desk is installed. Guests can install your property from the direct booking page.":"Install Front Desk first. Then guests can install your property from the direct booking page.";t.innerHTML=`
  <style>
