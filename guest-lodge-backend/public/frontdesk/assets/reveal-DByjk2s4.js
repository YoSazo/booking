import{c as s,e as oe}from"./settings-DzmlfyYA.js";const C="marketelValueRevealPendingV1",D="marketelValueRevealStepV1",X="marketelBillingIntervalV1";let r=0,u="guest",p=!1,f={rooms:[],rates:null},L=null,o={ready:!1,checking:!0,reason:"",attempts:0,domain:""},k=0,$=0,I=null,d=0,V=0,A=0,b="month",m=null,O=!1,y=!1,T=!1;const ne="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/46/2a/e1/462ae1c9-9347-efd0-5e99-41e7f636e3f7/phone-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg",se="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/23/4c/cb/234ccbb4-e65a-bb94-f877-3d230743e9e3/safari-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg";function Z(){const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e==="0.0.0.0"||e==="::1"||e.endsWith(".local")||/^10\./.test(e)||/^192\.168\./.test(e)||/^172\.(1[6-9]|2\d|3[01])\./.test(e)}function c(e){return String(e??"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function G(e){const a=Number(e);return Number.isFinite(a)?new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:Number.isInteger(a)?0:2}).format(a):"$99"}function g(){return s.activeHotelName||"Your Property"}function Y(){return f.rooms[0]||s.editRooms[0]||{name:"Your first room",totalUnits:1,images:[]}}function le(){const e=Y();return e.images?.[0]?.url||e.imageUrl||""}function de(){return f.rates?.nightly||99}function ce(){const e=Number(f.rates?.nightly);if(!Number.isFinite(e)||e<=0)return`<div class="mvr-value-bridge is-proof-only">
  ...
  </div>`}function ye(){return y?'<div class="mvr-page-status is-attention"><span>!</span>The live preview is still publishing. Your setup is saved, so you can continue without waiting.</div>':o.ready?`<div class="mvr-page-status is-ready"><span>✓</span>${o.reason==="local"?"Local guest preview connected":"Your live guest page is online"}</div>`:o.reason==="deployment-disabled"?'<div class="mvr-page-status is-attention"><span>!</span>Your live page deployment needs to be re-enabled. Your saved setup is safe.</div>':`<div class="mvr-page-status"><span class="mvr-status-pulse"></span>${o.checking?"Publishing your live guest page…":"Your personalized preview is ready while the live page finishes publishing."}</div>`}function he(){const e=R();return`<div class="mvr-booking-preview-card">
    ...
    <div class="mvr-preview-teaser">
      ...
      <button type="button" id="mvrExpandPreview" aria-label="${e?"View your booking page":"Check booking page preview"}" ${y?"disabled":""}>
        <span class="mvr-expand-cue" aria-hidden="true">
          ...
          <strong>${y?"Still publishing":"View your booking page"}</strong>
        </span>
      </button>
    </div>
  ...
  </section>`}function Ie(){const e=s.hotelSubscribed,a=b==="year",t=a?"$1,990":"$199",i=a?"/year":"/month",n=a?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month";return`<section class="mvr-stage mvr-stage-finale">
  ...
  </section>`}function $e(){return r===0?we():r===1?ke():r===2?Se():Ie()}function Ae(){if(r===0)return!O&&!y?"":`<div class="mvr-footer mvr-footer-booking">
    ...
    ${Ae()}
  </div>`,Le())}function Re(){const e=R();if(document.getElementById("mvrLivePreview"))return;if(!e){y=!0,l("JourneyBookingPreviewOpened",{mode:"unavailable",bookingPageReady:!1,bookingPageReason:o.reason||"missing-url"}),h();return}O=!0,u="guest";const a=Date.now(),t=document.createElement("div");t.id="mvrLivePreview",t.className="mvr-live-preview",t.innerHTML=`<div class="mvr-live-toolbar">
  ...
  </div>`,document.getElementById("marketelValueReveal")?.appendChild(t);const i=t.querySelector(".mvr-live-stage > iframe");m={modal:t,iframe:i,layer:t.querySelector(".mvr-challenge-layer"),timer:t.querySelector(".mvr-challenge-timer"),previewOpenedAt:a,status:"waiting",hasPrompted:!1,startedAt:0,timerId:0,promptFallbackId:0,promptDelayId:0},m.promptFallbackId=window.setTimeout(()=>{m?.modal!==t||m.status!=="waiting"||S(t,!0)},4e3),i?.addEventListener("load",()=>{const n=m;n?.modal!==t||u!=="guest"||(n.promptDelayId&&window.clearTimeout(n.promptDelayId),n.promptDelayId=window.setTimeout(()=>{n.promptDelayId=0,ge(n)},1500))}),t.querySelector("#mvrClosePreview")?.addEventListener("click",()=>{l("JourneyBookingPreviewModeChanged",{action:"closed",mode:u},{durationMs:Date.now()-a}),x("preview-closed",!0),m=null,t.remove(),h()}),t.querySelector("#mvrContinueGuestApp")?.addEventListener("click",()=>{Q(t,a,"continued-without-editor")}),t.querySelector("#mvrLiveForward")?.addEventListener("click",()=>{if(u==="guest"){J(t,"edit",a,"guided-forward");return}Q(t,a,"continued-from-editor-preview")}),v("BookingEngineFullPreviewOpened"),l("JourneyBookingPreviewOpened",{mode:"guest",bookingPageReady:!!o.ready,bookingPageReason:o.reason||""})}function Q(e,a,t){e?.isConnected&&(l("JourneyRevealNavigation",{action:t,toStep:1,editorViewed:u==="edit"},{durationMs:Date.now()-a}),x("continued-to-guest-app",!1),m=null,e.remove(),F(1))}function J(e,a,t,i="mode-selected"){if(!e?.isConnected)return;x("edit-mode-selected",!0),u="edit";const n=e.querySelector("#mvrLiveLocation"),w=e.querySelector("[data-live-location-text]"),U=e.querySelector("#mvrLiveForward"),W=e.querySelector("#mvrContinueGuestApp"),z=e.querySelector("[data-live-forward-long]");n?.classList.toggle("is-editor",u==="edit"),w&&(w.textContent=u==="edit"?"Front Desk editor":P()),n&&n.setAttribute("aria-label",u==="edit"?"Front Desk editor":"Your live booking address"),z&&(z.textContent=u==="edit"?"Continue to Guest App":"See how to edit your booking page"),U&&U.setAttribute("aria-label",u==="edit"?"Continue to the Guest App":"See how you edit this booking page"),W&&(W.hidden=u==="edit"),S(e,!0);const N=e.querySelector(".mvr-live-stage > iframe");N&&(N.title=u==="edit"?`${g()} Front Desk editor`:`${g()} booking-page preview`,N.src=u==="edit"?ue():R()),l("JourneyBookingPreviewModeChanged",{action:i,mode:u},{durationMs:Date.now()-t}),u==="edit"&&v("BookingEngineEditPreviewViewed")}function F(e){B();const a=r,t=Math.max(0,Math.min(3,e)),i=Date.now();A&&t!==a&&l("JourneyRevealStageCompleted",{revealStep:a,stageName:["booking-page","guest-app","front-desk-assistant","activation"][a]||"unknown",nextStep:t,direction:t>a?"forward":"back"},{durationMs:i-A}),r=t,A=i,me(),v(["BookingEngineRevealViewed","GuestAppRevealViewed","AssistantRevealViewed","ActivationOfferViewed"][r]),l("JourneyRevealStageViewed",{resumed:T,bookingPageReady:r===0?!!o.ready:void 0}),T=!1,h(),document.querySelector(".mvr-main")?.scrollTo({top:0,behavior:"auto"})}function Ce(){A&&l("JourneyRevealStageCompleted",{action:"reveal-finished",totalRevealMs:V?Date.now()-V:null},{durationMs:Date.now()-A}),k&&(window.clearTimeout(k),k=0),x("reveal-finished",!0),m=null,B(),document.getElementById("marketelValueReveal")?.remove(),document.documentElement.classList.remove("marketel-reveal-open"),document.body.style.overflow="",window.removeEventListener("message",te),s.settingsTourActive=!1;try{localStorage.removeItem(C),localStorage.removeItem(D),localStorage.setItem("settingsTourDone","1"),localStorage.setItem("onboardingDone","1")}catch{}ve(),ee(!0),typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner(),typeof window.refreshGoLiveInlineCard=="function"&&window.refreshGoLiveInlineCard()}async function Be(e){if(s.hotelSubscribed){Ce();return}if(typeof window.goLive=="function"){e.disabled=!0,e.textContent="Opening secure checkout…",v("ActivationCtaClicked");try{await window.goLive({billingInterval:b})}finally{document.body.contains(e)&&(e.disabled=!1,e.textContent=b==="year"?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month")}}}function B(){$&&(window.clearTimeout($),$=0),I?.disconnect(),I=null}function q(e){p=!!e;const a=document.querySelector(".mvr-install-visual");a?.classList.toggle("is-installed",p);const t=document.getElementById("mvrInstallDemo");t&&(t.textContent=p?"Installed ✓":"Install",t.disabled=p);const i=a?.querySelector(".mvr-install-arrow span");i&&(i.textContent=p?"Now on their Home Screen":"Tap Install")}function _(e,a=!1){B(),d=Number(e)===1?1:0;const t=document.querySelector(".mvr-install-visual");t&&(t.classList.toggle("is-slide-2",d===1),t.querySelectorAll(".mvr-app-carousel-slide").forEach((i,n)=>{i.setAttribute("aria-hidden",n===d?"false":"true")}),t.querySelectorAll(".mvr-app-carousel-dots button").forEach(i=>{const n=Number(i.dataset.mvrAppSlide)===d;i.classList.toggle("is-active",n),i.setAttribute("aria-current",n?"step":"false")}),t.querySelectorAll(".mvr-app-carousel-controls > button").forEach(i=>{i.disabled=Number(i.dataset.mvrAppSlide)===d}),d===1?q(!0):(q(!1),ie()),a&&v(d===1?"GuestAppValueSlideViewed":"GuestAppInstallSlideReplayed"),l("JourneyGuestAppDemo",{action:"slide-viewed",slide:d===1?"value":"install",manual:!!a}))}function ae(e=!1){p||d!==0||(B(),q(!0),e&&v("GuestAppInstallDemoClicked"),l("JourneyGuestAppDemo",{action:"install-demonstrated",manual:!!e}),$=window.setTimeout(()=>{r===1&&document.getElementById("marketelValueReveal")&&_(1,!1)},e?900:1200))}function ie(){if(B(),r!==1||d!==0)return;const e=document.querySelector(".mvr-install-visual");if(!e)return;const a=()=>{$||($=window.setTimeout(()=>{r===1&&document.getElementById("marketelValueReveal")&&(p?_(1,!1):ae(!1))},p?900:1300))};"IntersectionObserver"in window?(I=new IntersectionObserver(t=>{t.some(i=>i.isIntersecting&&i.intersectionRatio>=.35)&&(I?.disconnect(),I=null,a())},{threshold:[.35]}),I.observe(e)):a()}function Le(){document.getElementById("mvrNext")?.addEventListener("click",()=>{l("JourneyRevealNavigation",{action:"next",toStep:r+1}),F(r+1)}),document.getElementById("mvrBack")?.addEventListener("click",()=>{l("JourneyRevealNavigation",{action:"back",toStep:r-1}),F(r-1)}),document.getElementById("mvrExpandPreview")?.addEventListener("click",Re),document.getElementById("mvrFinalCta")?.addEventListener("click",e=>Be(e.currentTarget)),document.querySelectorAll("[data-mvr-billing]").forEach(e=>{e.addEventListener("click",()=>{const a=e.dataset.mvrBilling==="year"?"year":"month";if(a!==b){b=a;try{localStorage.setItem(X,b)}catch{}v(a==="year"?"YearlyBillingSelected":"MonthlyBillingSelected"),l("JourneyBillingIntervalSelected",{billingInterval:b,price:b==="year"?1990:199,currency:"USD"}),h()}})}),document.getElementById("mvrInstallDemo")?.addEventListener("click",()=>{ae(!0)}),document.querySelectorAll("[data-mvr-app-slide]").forEach(e=>{e.addEventListener("click",()=>{const a=Number(e.dataset.mvrAppSlide)===1?1:0;a!==d&&_(a,!0)})}),ie()}async function De(){return L||typeof window.api!="function"||(L=window.api("GET","/api/crm/rooms").then(e=>(f={rooms:Array.isArray(e?.rooms)?e.rooms:[],rates:e?.rates||null},f.rooms.length&&(s.editRooms=f.rooms),document.getElementById("marketelValueReveal")&&!document.getElementById("mvrLivePreview")&&h(),f)).catch(()=>f).finally(()=>{L=null})),L}async function re(){if(!(typeof window.api!="function"||!document.getElementById("marketelValueReveal"))){if(Z()){o={ready:!!R(),checking:!1,reason:"local",attempts:1,domain:""},R()&&(y=!1),l("JourneyBookingPageStatus",{ready:o.ready,reason:o.reason,attempts:o.attempts}),r===0&&!document.getElementById("mvrLivePreview")&&h();return}o.checking=!0,o.attempts+=1;try{const e=await window.api("GET","/api/crm/booking-page-status");o={ready:!!e?.ready,checking:!1,reason:String(e?.reason||""),attempts:o.attempts,domain:String(e?.domain||"")}}catch{o.checking=!1,o.reason="unreachable"}R()&&(y=!1),l("JourneyBookingPageStatus",{ready:o.ready,reason:o.reason,attempts:o.attempts}),r===0&&!document.getElementById("mvrLivePreview")&&h(),!(o.ready||o.reason==="deployment-disabled")&&o.attempts<10&&document.getElementById("marketelValueReveal")&&(k=window.setTimeout(re,6e3))}}function Ee(e={}){if(document.getElementById("marketelValueReveal"))return;const a=Number(e.startAt);let t=0,i=!1;try{t=Number.parseInt(localStorage.getItem(D)||"0",10)}catch{}try{i=localStorage.getItem(C)==="1"}catch{}try{b=localStorage.getItem(X)==="year"?"year":"month"}catch{b="month"}if(r=Number.isFinite(a)?Math.max(0,Math.min(3,a)):Math.max(0,Math.min(3,Number.isFinite(t)?t:0)),s.hotelSubscribed&&r===3&&(r=0),u="guest",p=!1,d=0,O=!1,y=!1,V=Date.now(),A=0,T=!Number.isFinite(a)&&i,o={ready:!1,checking:!0,reason:"",attempts:0,domain:""},k&&window.clearTimeout(k),k=0,B(),!s.hotelSubscribed)try{localStorage.setItem(C,"1"),localStorage.setItem(D,String(r))}catch{}try{localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep")}catch{}s.settingsTourActive=!0,window.addEventListener("message",te),document.documentElement.classList.add("marketel-reveal-open"),document.body.style.overflow="hidden",ee(!1);const n=document.createElement("div");n.id="marketelValueReveal",n.className="mvr-root",document.body.appendChild(n),h(),v("ValueRevealStarted",s.hotelSubscribed?"subscribed-replay":"pre-activation"),l("JourneyRevealStarted",{startStep:r,replay:!!s.hotelSubscribed,pendingResume:T}),F(r),De(),re()}function Pe(){try{return localStorage.getItem(C)==="1"}catch{return!1}}function Me(){try{localStorage.removeItem(C),localStorage.removeItem(D)}catch{}}const Te={clearPendingMarketelValueReveal:Me,hasPendingMarketelValueReveal:Pe,showMarketelValueReveal:Ee};function xe(){oe(Te)}export{Me as clearPendingMarketelValueReveal,Te as default,Pe as hasPendingMarketelValueReveal,xe as install,Ee as showMarketelValueReveal};
