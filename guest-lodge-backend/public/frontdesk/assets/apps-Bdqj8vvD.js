import{c as u,e as mt}from"./settings-C1PBv--n.js";function B(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function rt(...t){return B("ensureAppsViewRendered")?.(...t)}function pt(...t){return B("showFinaleMockModal")?.(...t)}function lt(...t){return B("finishTourHydration")?.(...t)}function G(...t){return B("goLive")?.(...t)}function P(...t){return B("toast")?.(...t)}function bt(...t){return B("appsCloseLightbox")?.(...t)}let q=[],c=0,N=!1,E=null,j=null;function dt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function T(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function ct(){E&&(document.removeEventListener("keydown",E),E=null)}function yt(t){ct(),E=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",E)}function ut(){ct(),j&&(clearTimeout(j),j=null);const t=document.getElementById("appsTourLightbox");t&&t.remove();const e=document.getElementById("appsTourTooltip");e&&e.remove(),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(o=>{o.style.position=o.dataset.appsTourOrigPosition||"",o.style.zIndex=o.dataset.appsTourOrigZIndex||"",o.style.isolation=o.dataset.appsTourOrigIsolation||"",o.style.boxShadow=o.dataset.appsTourOrigBoxShadow||"",o.style.outline=o.dataset.appsTourOrigOutline||"",o.style.outlineOffset=o.dataset.appsTourOrigOutlineOffset||"",o.style.transition=o.dataset.appsTourOrigTransition||"",o.removeAttribute("data-apps-tour-highlighted"),delete o.dataset.appsTourOrigPosition,delete o.dataset.appsTourOrigZIndex,delete o.dataset.appsTourOrigIsolation,delete o.dataset.appsTourOrigBoxShadow,delete o.dataset.appsTourOrigOutline,delete o.dataset.appsTourOrigOutlineOffset,delete o.dataset.appsTourOrigTransition})}function b(t){ut(),document.body.style.overflow="";const e=N;N=!1;try{const o=typeof rt=="function"?rt:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),e||localStorage.getItem("settingsTourStep")==="handoff"||u.settingsTourActive)){const n=typeof pt=="function"?pt:window.showFinaleMockModal;if(typeof n=="function"){n();return}}}function vt(t){const e=c+t;e<0||e>=q.length||(c=e,z())}function tt(){if(localStorage.setItem("appsTourDone","1"),N||localStorage.getItem("settingsTourStep")==="handoff"||u.settingsTourActive){u.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const e=typeof lt=="function"?lt:window.finishTourHydration;typeof e=="function"&&e()}}function wt(){tt();const t=typeof G=="function"?G:window.goLive;if(b(!1),typeof t=="function"){t();return}const e=typeof P=="function"?P:window.toast;typeof e=="function"&&e("Open Go live to activate your booking page.","error")}function kt(){if(u.hotelSubscribed||document.getElementById("guestAppActivationOverlay"))return;dt();const t=document.createElement("div");if(t.id="guestAppActivationOverlay",t.style.cssText="position:fixed;inset:0;z-index:100004;background:rgba(17,24,39,0.62);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;padding:24px 16px;box-sizing:border-box;",t.innerHTML=`
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:390px;width:100%;max-height:calc(100vh - 48px);overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:appsTourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(t),document.body.style.overflow="hidden",!document.getElementById("tourModalAnimStyle")){const o=document.createElement("style");o.id="tourModalAnimStyle",o.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(o)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const e=()=>{t.remove(),document.body.style.overflow=""};document.getElementById("guestAppActivateNowBtn").onclick=()=>{e();const o=typeof G=="function"?G:window.goLive;if(typeof o=="function"){o();return}const n=typeof P=="function"?P:window.toast;typeof n=="function"&&n("Open Go live to activate your booking page.","error")},document.getElementById("guestAppActivateLaterBtn").onclick=e}function z(){dt();const t=q[c];if(!t){b(!0);return}const e=q.length,o=c>=e-1,n=`${c+1} / ${e}`,s=Math.max(8,Math.min(100,Math.round((c+1)/e*100))),i=document.querySelector(t.target);if(!i){c++,z();return}ut();let r=document.createElement("div");r.id="appsTourLightbox",r.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.52);pointer-events:auto;",document.body.appendChild(r),i.dataset.appsTourOrigPosition=i.style.position||"",i.dataset.appsTourOrigZIndex=i.style.zIndex||"",i.dataset.appsTourOrigIsolation=i.style.isolation||"",i.dataset.appsTourOrigBoxShadow=i.style.boxShadow||"",i.dataset.appsTourOrigOutline=i.style.outline||"",i.dataset.appsTourOrigOutlineOffset=i.style.outlineOffset||"",i.dataset.appsTourOrigTransition=i.style.transition||"",i.style.position=i.style.position||"relative",i.style.zIndex="100002",i.style.isolation="isolate",i.style.transition="box-shadow 0.18s ease, outline 0.18s ease",i.style.boxShadow="0 0 0 4px #fff, 0 0 0 8px rgba(46,125,91,0.92), 0 18px 42px rgba(26,43,34,0.24)",i.style.outline="2px solid #fff",i.style.outlineOffset="4px",i.setAttribute("data-apps-tour-highlighted","1");const l=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,x=a&&t.mobileScrollBlock||t.scrollBlock||"center",g=l?"auto":"smooth";if(a&&t.mobileScrollToBottom){const d=Math.max(document.documentElement?document.documentElement.scrollHeight:0,document.body?document.body.scrollHeight:0);window.scrollTo({top:d,behavior:g}),setTimeout(()=>{window.scrollTo({top:d,behavior:"auto"})},g==="smooth"?520:0)}else i.scrollIntoView({behavior:g,block:x});const D=()=>{const d=document.getElementById("appsTourTooltip");d&&d.remove();const y=i.getBoundingClientRect(),$=Math.min(a?window.innerWidth-24:370,window.innerWidth-28),W=y.left+y.width/2,v=Math.max(14,Math.min(W-$/2,window.innerWidth-$-14)),V=a&&t.mobileTooltipAnchor||t.tooltipAnchor||"bottom",w=a&&t.mobileTooltipPosition||t.tooltipPosition||"",A=y.top,H=V==="top"?y.top:y.bottom,U=t.primaryLabel||(o?"Done":"Next"),st=t.secondaryLabel||(o?"Not now":"Skip tour"),Q=c<=0,K=t.kicker||"Guest App",p=document.createElement("div");if(p.id="appsTourTooltip",p.style.cssText=`position:fixed;z-index:100003;left:${v}px;top:14px;width:${$}px;max-width:${$}px;visibility:hidden;`,p.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${T(t.title)}">
        ...
        <div class="apps-tour-actions">
      ...
      </div>`,document.body.appendChild(p),a&&!w)p.style.left="12px",p.style.right="12px",p.style.width="auto",p.style.maxWidth="none",p.style.top="auto",p.style.bottom="calc(14px + env(safe-area-inset-bottom,0px))";else{const h=Math.min(p.offsetHeight||190,Math.max(130,window.innerHeight-28)),k=window.innerHeight-H,S=A;let m=w==="below"||!w&&k>=h+14+14;w==="above"&&(m=!1),m&&k<h+14+14&&S>k&&(m=!1),!m&&S<h+14+14&&k>S&&(m=!0);const Z=m?H+14:A-h-14,J=Math.max(14,window.innerHeight-h-14),F=Math.max(14,Math.min(Z,J));p.style.top=`${F}px`}p.style.visibility="visible";const X=()=>{if(t.activateOnNext){wt();return}if(o){tt(),b(!1),t.showActivationOnComplete&&kt();return}c++,z()},L=()=>{if(o){tt(),b(!1);return}b(!0)},M=()=>{c<=0||(c--,z())};document.getElementById("appsTourNextBtn").onclick=X,document.getElementById("appsTourSkipBtn").onclick=L;const O=document.getElementById("appsTourBackBtn");O&&(O.onclick=M),yt({onNext:X,onBack:M,onSkip:L})},R=a&&t.mobileScrollToBottom?l?80:680:l?40:320;j=setTimeout(D,R)}function Tt(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;bt(),b(!1),N=!!o;const n=!!u.hotelSubscribed;q=[{target:"#tour-apps-headline",kicker:"The loop",title:"Your hotel becomes the app.",text:"Guests book from your direct page, save your hotel to their phone, then come back with one tap to book or message you."},{target:"#tour-apps-first",kicker:"Front Desk",title:"Install this on the property phone.",text:"Front Desk is this dashboard saved like an app. It is where booking alerts, guest messages, QR tools, and setup controls live."},{target:"#tour-apps-then",kicker:"Guest path",title:"Send guests to your direct page.",text:"The Install button sits on the booking page. Guests tap it once, and your hotel icon lands on their home screen."},{target:"#tour-apps-after",kicker:"Return visits",title:"Now the loop is easy to remember.",text:"Guests tap your icon to book direct or message you. New bookings and messages come back to Front Desk."},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your hotel.",text:"Use a real logo or clear property image. Guests see this square every time they save your hotel to their phone.",mobileScrollToBottom:!0,mobileScrollBlock:"end",mobileTooltipAnchor:"top",mobileTooltipPosition:"above"},{target:"#tour-apps-loop",kicker:n?"Live loop":"Activation",title:n?"This loop is on.":"Turn this on for your property.",text:n?"Guests can book direct, save your hotel, and message you. Front Desk gets the alerts.":"Activation turns on direct booking, guest installs, messages, and Front Desk alerts as one simple loop.",primaryLabel:n?"Done":"Continue to activation",secondaryLabel:n?"Close":"Not now",showActivationOnComplete:!n}],c=0,z()}const f={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},zt="32px";function ot(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function et(t){return`border-radius:${zt};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function gt(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let Y=[],I=0;function It(t,e){b(!1),Y=t,I=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=s=>{s.key==="ArrowRight"||s.key==="ArrowDown"?C(1):s.key==="ArrowLeft"||s.key==="ArrowUp"?C(-1):s.key==="Escape"&&ft()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",s=>{n=s.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",s=>{const i=s.changedTouches[0].clientX-n;Math.abs(i)>50&&C(i<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",it()}function ft(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function C(t){const e=Y.length;e<=1||(I=(I+t+e)%e,it())}function it(){const t=document.getElementById("appsLightbox");if(!t)return;const e=Y[I],o=Y.length,n=e.type!=="video",s=o>1?`${I+1} / ${o}`:"",i=n?`<img src="${gt(e.src)}" alt="${e.alt||""}"
          ...
          ${e.poster?`poster="${ot(e.poster,400)}"`:""}>
    ...
    ${Array.from({length:o},(x,g)=>`<div onclick="appsOpenLightbox(_appsLbItems,${g})" style="width:7px;height:7px;border-radius:50%;background:${g===I?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${a}
    </div>`}function xt(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function _(t,e,o,n,s){const i=s?xt("Video"):"",r=s?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${s?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${n})">
    <div class="apps-q-text">
      <div class="apps-q-title">${t}${i}</div>
      ${e?`<div class="apps-q-hint">${e}</div>`:s?'<div class="apps-q-hint">Tap to watch — about 1 min</div>':""}
    </div>
    ${r}
  </button>`}function Bt(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function $t(t){const e=document.getElementById("appsView");if(!e)return;const o=(u.activeHotelId||"")+"|"+(u.activeHotelAppIcon||"")+"|"+(u.activeHotelDomain||"");t||e.dataset.appsKey!==o||!e.querySelector(".apps-page")?(ht(),e.dataset.appsKey=o):nt()}function ht(){const t=document.getElementById("appsView");if(!t)return;const e=u.activeHotelName||"Your Hotel",o=u.activeHotelAppIcon||"",n=e.trim().charAt(0).toUpperCase()||"🏨",s=u.activeHotelDomain||"",i=s?"https://"+s:"#",r=s?"https://"+s+"/install":"#";function l(F){return JSON.stringify(F).replace(/"/g,"&quot;")}const a=ot(f.guestHome,520),x=[{type:"image",src:f.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],g=[{type:"image",src:f.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:f.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:f.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],D=[{type:"video",src:f.guestInstallVideo,poster:f.guestHome,alt:"Guest adds hotel to phone",title:"How your guests put your hotel on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your hotel shows up on their phone like an app. You don't need to do anything."}],R=[{type:"image",src:f.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your hotel app.'},{type:"image",src:f.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:f.guestMessageNotifVideo,poster:f.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],d=isStandaloneApp()||u.frontdeskInstalled,y=typeof Notification<"u"&&Notification.permission==="granted",W=!!(window.matchMedia&&window.matchMedia("(max-width: 767px)").matches)?"Install on this phone":"Install Front Desk";let v;d&&y?v=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
      ...
      <div style="font-size:12px;color:var(--text-muted);line-height:1.45;text-align:center;">Locked until Front Desk is installed on a property phone</div>`;const V=d?`<div class="apps-story-status">
      ...
      </div>`:`<button type="button" class="apps-story-primary" onclick="handleInstallFrontdesk()">${W}</button>`,w=r!=="#"?'<button type="button" class="apps-story-secondary" onclick="openGuestBookingEngine({focusInstall:true})">Go to direct booking page</button>':'<div class="apps-story-domain-note">Your direct booking domain is still setting up. Once it is ready, guests install from that page.</div>',A="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",H=o?A+"background:#fff;border:1px solid var(--border);padding:0;":A,U=o?`<img src="${o}" alt="Hotel logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,Q=`
    <div class="apps-icon-card">
      ...
      ${r==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,p=r!=="#"?`
      ...
      </div>`:'<div id="guestInstallStats" style="display:none;"></div>',L=`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <div class="apps-q-list">
          ...
          ${_("Guest texts you, you text back","",l(R),0,!0)}
          ${_("Your app and theirs — side by side","",l(x),0,!1)}
        </div>
        ${i!=="#"?`<button onclick="window.open('${i}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,at=F=>`
