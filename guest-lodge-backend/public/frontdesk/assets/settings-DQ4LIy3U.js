const c={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,frontdeskInstallReported:!1,bookingApproval:null,bookingConflicts:[],_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let _=null;function He(){return typeof lucide<"u"?Promise.resolve():_||(_=new Promise((t,e)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>t(),o.onerror=()=>e(new Error("lucide load failed")),document.head.appendChild(o)}),_)}async function Ut(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let a=e.width,n=e.height;const r=Math.min(1,o/a,i/n);a=Math.round(a*r),n=Math.round(n*r);const d=document.createElement("canvas");d.width=a,d.height=n,d.getContext("2d").drawImage(e,0,0,a,n),e.close();const p=await new Promise((y,v)=>{d.toBlob(B=>B?y(B):v(new Error("encode failed")),"image/webp",.82)}),f=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([p],f+".webp",{type:"image/webp"})}catch{return t}}function Ne(){const t=()=>{c.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}const jt=["cancelled","canceled","released"];function qe(t){return t?jt.includes(String(t.status||"").trim().toLowerCase()):!0}function Ue(t){return String(t?.status||"").trim().toLowerCase()==="pending"}function Gt(t){Object.assign(window,t)}function D(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function Z(...t){return D("setFilter")?.(...t)}function Yt(...t){return D("toast")?.(...t)}function X(...t){return D("updateGoLiveBanner")?.(...t)}function Vt(...t){return D("seedTourRevenueShell")?.(...t)}function _t(...t){return D("finishTourHydration")?.(...t)}function Wt(...t){return D("goLive")?.(...t)}let U=null;function O(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
  ...
  `,document.head.appendChild(t)}function lt(){U&&(document.removeEventListener("keydown",U),U=null)}function Qt(t){lt(),U=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",U)}function nt(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function A(t){O();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=e.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=e.blockPointer?"auto":"none",e.lockScroll&&(document.body.style.overflow="hidden"),o}const Q="rgba(17,24,39,0.42)";function H(){const t=document.getElementById("tourTooltip"),e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!t||e)return Promise.resolve();t.style.pointerEvents="none";const o=t.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function Kt(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function Jt(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((a,n)=>{const r=i[n];r&&(a.type==="checkbox"||a.type==="radio"?r.checked=a.checked:r.value=a.value)})}function Et(t,e){const o=getComputedStyle(t);for(const n of o)e.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=t.children,a=e.children;for(let n=0;n<i.length;n+=1)a[n]&&Et(i[n],a[n])}function kt(t,e){if(!t||!t.isConnected)return null;document.querySelectorAll("[data-tour-spotlight-clone]").forEach(a=>a.remove());const o=t.getBoundingClientRect();if(o.width<2||o.height<2)return null;const i=t.cloneNode(!0);return Kt(i),Et(t,i),Jt(t,i),i.setAttribute("data-tour-spotlight-clone","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.left=`${o.left}px`,i.style.top=`${o.top}px`,i.style.width=`${o.width}px`,i.style.height=`${o.height}px`,i.style.margin="0",i.style.maxWidth="none",i.style.zIndex="99999",i.style.pointerEvents="none",i.style.transform="none",i.style.boxShadow=e?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",i.style.outline=e?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",i.style.outlineOffset=e?.spotlightOutlineOffset??"2px",e?.spotlightBackground&&(i.style.background=e.spotlightBackground,i.style.backgroundColor=e.spotlightBackground),e?.spotlightBorderRadius&&(i.style.borderRadius=e.spotlightBorderRadius),document.body.appendChild(i),i}function R(t){const e=t||{};lt();const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!e.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.style.opacity=n.dataset.tourOrigOpacity||"";const r=n.dataset.tourOrigBackground||"",d=n.dataset.tourOrigBackgroundColor||"";d?n.style.backgroundColor=d:n.style.removeProperty("background-color"),r?n.style.background=r:n.style.removeProperty("background"),n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius,delete n.dataset.tourOrigOpacity});const a=document.getElementById("goLiveBanner");a&&a.dataset.tourHidden&&(delete a.dataset.tourHidden,typeof X=="function"&&X()),e.keepOverlay||(document.body.style.overflow="")}function Zt(){const t=document.getElementById("tourTooltip"),e=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[t,...e,...o].filter(Boolean);return!i.length&&!o.length?(R({keepOverlay:!0}),Promise.resolve()):(lt(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(R({keepOverlay:!0}),Promise.resolve()):(t&&(t.style.pointerEvents="none"),i.forEach(n=>{n.style.transition="opacity 0.07s ease, transform 0.07s ease",n.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(n=>{n.style.opacity="0",n.id==="tourTooltip"&&(n.style.transform="translateY(4px)")})}),new Promise(n=>{setTimeout(()=>{R({keepOverlay:!0}),n()},85)})))}function Xt(t){const e=[t,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);e.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{e.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function L(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function $(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function N(t,e){if(e.highlightSelector){const o=$(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function K(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const a=document.querySelector(i);if(a&&a.isConnected)return a}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function tt(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function j(t,e){const o=$(t.anchorSelector);if(o){const i=tt(o,!0);if(i)return i}return tt(e,!0)}function te(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function rt(t,e){if(!e)return;const o=te(t);if(o){o.scrollTop+=e;return}window.scrollBy({top:e,left:0,behavior:"auto"})}function ee(t,e){return e&&t.mobileTooltipPosition||t.tooltipPosition||"below"}function oe(t,e,o,i){if(!t||!t.isConnected||!o)return j(e,t);const a=o.querySelector(".tour-panel"),n=Math.min(a&&a.offsetHeight||o.offsetHeight||190,Math.max(140,window.innerHeight-28)),r=e.tooltipGap??8,d=e.fitPadTop??e.scrollPadTop??72,p=window.innerHeight-(e.fitPadBottom??14),f=()=>j(e,t)||tt(t,!0);let y=f();if(!y)return null;for(let v=0;v<3;v+=1){const B=Math.max(120,p-d),M=y.height+r+n<=B;let I=0;if(i==="above"){const P=y.top-r-n-d;P<0&&(I=P),M&&y.bottom>p&&(I=y.bottom-p)}else{const P=y.bottom+r+n-p;P>0&&(I=P),M&&y.top<d&&(I=y.top-d)}if(Math.abs(I)<1)break;if(rt(t,I),y=f(),!y)return null}return y}function et(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const a=document.querySelector(i);a&&(a.scrollTop=0)})}function Bt(t,e,o){const i=o||{},a=e.scrollTarget||e.accordionCard,n=(a?$(a):null)||t;if(!n&&!e.scrollToTop)return Promise.resolve();const r=e.scrollBlock||"center",d=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let p=i.smooth&&!d?"smooth":c.settingsTourActive||d?"auto":"smooth";return new Promise(f=>{(()=>{if(!i.smooth||!n||e.forceSmoothScroll)return!1;const l=$(e.anchorSelector)||(n&&n.isConnected?n:null)||(t&&t.isConnected?t:null);if(!l)return!0;const g=l.getBoundingClientRect(),h=e.scrollPadTop??80,s=e.scrollPadBottom??220,x=Math.max(0,h-g.top),m=Math.max(0,g.bottom-(window.innerHeight-s));return Math.max(x,m)<=(e.quickScrollThreshold??180)})()&&(p="auto");const v=()=>{const l=e.scrollPadTop??80,g=e.scrollPadBottom??220,h=$(e.anchorSelector)||(n&&n.isConnected?n:null)||(t&&t.isConnected?t:null);if(!h){f();return}let s=h.getBoundingClientRect();s.top<l&&(rt(h,s.top-l),s=h.getBoundingClientRect()),s.bottom>window.innerHeight-g&&rt(h,s.bottom-window.innerHeight+g),requestAnimationFrame(()=>requestAnimationFrame(f))},B=()=>{n&&n.scrollIntoView({behavior:e.scrollToTop?"auto":p,block:r,inline:"nearest"}),v()};if(e.scrollToTop){if(et(p),e.scrollToTopOnly){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&et("auto"),f()}));return}if(p==="auto"){B();return}let l=!1;const g=()=>{l||(l=!0,window.removeEventListener("scrollend",h),clearTimeout(s),B())},h=()=>g();"onscrollend"in window&&window.addEventListener("scrollend",h,{once:!0});const s=setTimeout(g,520);return}if(!n){f();return}if(n.scrollIntoView({behavior:p,block:r,inline:"nearest"}),p==="auto"){v();return}let M=!1;const I=()=>{M||(M=!0,window.removeEventListener("scrollend",P),clearTimeout(u),v())},P=()=>I();"onscrollend"in window&&window.addEventListener("scrollend",P,{once:!0});const u=setTimeout(I,620)})}function St(){R(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&Z("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const a=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof a=="function"&&a({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function q(){R({keepOverlay:!0}),O(),c.settingsTourActive=!1,X(),A({blockPointer:!0,lockScroll:!0,dim:Q});const t=document.createElement("div");if(t.id="tourTooltip",t.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),!document.getElementById("tourModalAnimStyle")){const e=document.createElement("style");e.id="tourModalAnimStyle",e.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(e)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("tourNextBtn").onclick=()=>{const o="https://"+(c.activeHotelDomain||c.activeHotelId+".mktel.co");navigator.clipboard.writeText(o).catch(()=>{}),H().then(()=>{R(),c.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.setItem("linkCopied","1"),localStorage.removeItem("settingsTourStep"),Yt("Booking link copied!","success"),_t(),Tt()})}}function Tt(t){O();const e=document.createElement("div");e.id="bookingProtectionOverlay",e.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;padding:24px 16px;";const o=i=>`<div style="display:flex;align-items:flex-start;gap:10px;">
      <span style="color:#2E7D5B;font-weight:850;flex-shrink:0;line-height:1.45;">✓</span>
      <span style="font-size:13px;color:#1A2B22;line-height:1.45;">${i}</span>
    </div>`;e.innerHTML=`
      ...
      <div style="padding:24px 22px 22px;">
        ...
        <div style="background:#F4F8F5;border-radius:14px;padding:14px;border:1.5px solid #D8E4DC;text-align:left;margin-bottom:14px;">
          <div style="display:flex;flex-direction:column;gap:10px;">
            ${o("<strong>Release it</strong> and the room goes straight back on sale — the guest is emailed and their card hold is voided for you.")}
            ${o("<strong>Ignore it</strong> and the booking confirms itself. You only step in when something has changed.")}
            ${o("<strong>Already confirmed?</strong> You can still cancel, and any room that ends up double-booked is flagged in Bookings.")}
          </div>
        </div>
    ...
    </div>`,document.body.appendChild(e),document.body.style.overflow="hidden",typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("bookingProtectionNext").onclick=()=>{e.remove(),document.body.style.overflow="",It()}}function It(t){O();const e=document.createElement("div");e.id="testDriveOverlay",e.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(e),document.body.style.overflow="hidden",typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{e.remove(),document.body.style.overflow=""};document.getElementById("activateNowBtn").onclick=()=>{o(),Wt()},document.getElementById("activateLaterBtn").onclick=()=>{o();const i=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');i&&Z("bookings",i)}}function at(){if(localStorage.getItem("settingsTourDone"))return;if(localStorage.getItem("settingsTourStep")==="handoff"){localStorage.removeItem("settingsTourStep"),q();return}localStorage.getItem("settingsTourDone")||localStorage.removeItem("settingsTourStep"),c.settingsTourActive=!0,X(),Vt();const t=document.querySelector('.tab[data-nav-filter="settings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="settings"]');t&&Z("settings",t);function e(){if(typeof window.isEditPageDomReady=="function"&&window.isEditPageDomReady()||typeof isEditPageDomReady=="function"&&isEditPageDomReady()||!(typeof window.needsEditPageLoad=="function"&&window.needsEditPageLoad()||typeof needsEditPageLoad=="function"&&needsEditPageLoad())&&!c.editRoomsLoadPromise)return;const g=typeof window.invokeLoadEditRooms=="function"?window.invokeLoadEditRooms:typeof invokeLoadEditRooms=="function"?invokeLoadEditRooms:null;g&&g()}e();const o=[{target:"#tour-preview-btn",highlightSelector:"#tour-preview-btn",anchorSelector:"#tour-preview-btn",scrollTarget:"#tour-preview-btn",title:"Preview your booking page",text:"Open the exact page guests will use. It is safe to review before activation, so check the basics here first.",openAccordion:!1,tab:"settings",scrollToTop:!0,scrollToTopOnly:!0,forcePageTop:!0,scrollBlock:"start"},{target:"#tour-header-preview-card",highlightSelector:"#tour-header-preview-card",anchorSelector:"#tour-header-preview-card",scrollTarget:"#tour-header-preview-card",title:"Edit your booking page",text:"This page is the source of truth for your guest site. Update the property name, address, phone, policy, rooms, photos, and prices here.",openAccordion:!1,tab:"settings",scrollBlock:"nearest",scrollPadTop:80,scrollPadBottom:360,tooltipPosition:"below",tooltipGap:22},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo-placeholder, #editRoomsCards [data-tour-room-card="1"] .room-edit-photo',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',scrollTarget:'#editRoomsCards [data-tour-room-card="1"]',title:"Add room photos",text:"Use real room photos. A clear first photo makes the page feel legitimate and helps guests decide faster.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:80,scrollPadBottom:220},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',scrollTarget:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',title:"Edit room details",text:"Room name, description, guest count, amenities, and units all show on the booking page. Keep this short and accurate.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:80,scrollPadBottom:220,tooltipPosition:"below",tooltipGap:8,spotlightBackground:"#fff",spotlightBorderRadius:"0 0 20px 20px",spotlightBoxShadow:"none",spotlightOutline:"none",spotlightOutlineOffset:"0",fitPadTop:108},{target:"#tour-booking-link-card",highlightSelector:"#tour-booking-link-card",anchorSelector:"#tour-booking-link-card",scrollTarget:"#tour-booking-link-card",title:"Share your direct link",text:"This is the link to send guests, add to your website, and place on Google Business Profile. QR tools live here too.",openAccordion:!1,tab:"settings",scrollBlock:"start",scrollPadTop:80,scrollPadBottom:220},{target:"#tour-rates-card",highlightSelector:"#tour-rates-card",anchorSelector:"#tour-rates-card",scrollTarget:"#tour-rates-card",title:"Set your rates",text:"Set nightly, weekly, and monthly prices before you share the link. Guests book from these rates on your direct page.",openAccordion:!0,accordionCard:"#tour-rates-card",tab:"settings",scrollBlock:"center",scrollPadBottom:220,tooltipPosition:"below",tooltipGap:8},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",title:"Track revenue and payment status",text:"Revenue shows direct bookings, card status, and estimated OTA commission savings. Cards are verified, and you collect payment at check-in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,scrollBlock:"start",scrollPadTop:92,scrollPadBottom:220},{target:"",text:"",openAccordion:!1,tab:"apps",customModal:"guestAppsStory"}];let i=parseInt(localStorage.getItem("settingsTourStep")||"0",10);(!Number.isFinite(i)||i<0||i>=o.length)&&(i=0,localStorage.removeItem("settingsTourStep"));function a(u){R(u)}function n(){H().then(()=>{a({keepOverlay:!0}),localStorage.removeItem("settingsTourStep"),q()})}function r(u,l){return!(!u||!l||u.customModal||l.customModal||u.tab!==l.tab||!u.target||!l.target)}function d(u,l){if(u.customModal){f(u,l);return}requestAnimationFrame(()=>f(u,l))}function p(u){const l=u||{};if(l.keepCurrentUi||a({keepOverlay:!0}),document.body.style.overflow="",i>=o.length){a({keepOverlay:!0}),localStorage.removeItem("settingsTourStep"),q();return}const g=o[i];if(g.tab==="revenue"&&!c.revenueEnabled){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}if(g.tab==="apps"&&!(isStandaloneApp()||c.frontdeskInstalled)&&g.target&&!g.target.includes("tour-fd-install")){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}if(g.customModal||A(),g.tab&&g.tab!==c.currentFilter){const h=document.querySelector(`.tab[data-nav-filter="${g.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${g.tab}"]`);if(h&&Z(g.tab,h),g.tab==="apps"){const s=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof s=="function"&&s(!0)}d(g,l);return}d(g,l)}function f(u,l){const g=l||{};if(u.customModal==="homescreen"){g.keepCurrentUi&&a({keepOverlay:!0}),M();return}if(u.customModal===!0||u.customModal==="bookings"){g.keepCurrentUi&&a({keepOverlay:!0}),P();return}if(u.customModal==="availability"){g.keepCurrentUi&&a({keepOverlay:!0}),I();return}if(u.customModal==="finale"){g.keepCurrentUi&&a({keepOverlay:!0}),q();return}if(u.customModal==="guestAppsStory"){g.keepCurrentUi&&a({keepOverlay:!0}),St();return}if(u.waitForVisible){const x=u.target.split(",").map(k=>k.trim());let m=0;const b=30;A();const w=c.settingsTourActive?60:200,E=()=>{if(m++,u.tab==="apps"){const T=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof T=="function"&&T(!0)}let k=null;for(const T of x)if(k=document.querySelector(T),k)break;if(k&&(u.openAccordion&&L(k,u),u.openAccordion||k.offsetParent!==null)){y(k,u,g);return}m<b?setTimeout(E,w):(i++,localStorage.setItem("settingsTourStep",String(i)),p())};E();return}function h(x){const m=x.target.split(",").map(b=>b.trim());for(const b of m){const w=document.querySelector(b);if(w&&!(!x.openAccordion&&w.offsetParent===null&&getComputedStyle(w).position!=="fixed"))return w}if(x.accordionCard){const b=document.querySelector(x.accordionCard);if(b)return b}return null}function s(x,m){const b=h(x);if(b){m(b);return}const w=x.tab==="settings"&&!x.customModal&&x.target,E=x.tab==="apps"&&!x.customModal&&x.target;if(!w&&!E){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}A();let k=0;if(w&&e(),E){const z=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof z=="function"&&z(!0)}const T=c.settingsTourActive?60:250,S=()=>{if(k++,E){const C=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof C=="function"&&C(!0)}const z=h(x);if(z){m(z);return}if(e(),E){const C=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof C=="function"&&C(!0)}k<48?setTimeout(S,T):(i++,localStorage.setItem("settingsTourStep",String(i)),p())};S()}s(u,x=>y(x,u,g))}function y(u,l,g){const h=g||{};if(L(u,l),u=N(u,l),(!u||!u.isConnected)&&(u=K(u,l),u&&(u=N(u,l))),!u){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}const s=u;A(),Bt(s,l,{smooth:!!h.keepCurrentUi}).then(()=>{if(l.forcePageTop&&et("auto"),!s.isConnected){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}L(s,l),h.keepCurrentUi&&(a({keepOverlay:!0}),A()),l.noHighlight||(s.dataset.tourOrigPosition||(s.dataset.tourOrigPosition=s.style.position||""),s.dataset.tourOrigZIndex||(s.dataset.tourOrigZIndex=s.style.zIndex||""),s.dataset.tourOrigIsolation||(s.dataset.tourOrigIsolation=s.style.isolation||""),s.dataset.tourOrigBoxShadow||(s.dataset.tourOrigBoxShadow=s.style.boxShadow||""),s.dataset.tourOrigOutline||(s.dataset.tourOrigOutline=s.style.outline||""),s.dataset.tourOrigOutlineOffset||(s.dataset.tourOrigOutlineOffset=s.style.outlineOffset||""),s.dataset.tourOrigTransition||(s.dataset.tourOrigTransition=s.style.transition||""),s.dataset.tourOrigBackground||(s.dataset.tourOrigBackground=s.style.background||""),s.dataset.tourOrigBackgroundColor||(s.dataset.tourOrigBackgroundColor=s.style.backgroundColor||""),s.dataset.tourOrigBorderRadius||(s.dataset.tourOrigBorderRadius=s.style.borderRadius||""),s.dataset.tourOrigOpacity||(s.dataset.tourOrigOpacity=s.style.opacity||""),s.style.position=s.style.position||"relative",s.style.zIndex="99999",s.style.isolation="isolate",s.style.transition="box-shadow 0.18s ease, outline 0.18s ease",s.style.boxShadow="0 0 0 1px rgba(255,255,255,0.92), 0 18px 46px rgba(26,43,34,0.22)",s.style.outline="1px solid rgba(255,255,255,0.82)",s.style.outlineOffset="2px",l.spotlightBoxShadow!=null&&(s.style.boxShadow=l.spotlightBoxShadow),l.spotlightOutline!=null&&(s.style.outline=l.spotlightOutline),l.spotlightOutlineOffset!=null&&(s.style.outlineOffset=l.spotlightOutlineOffset),l.spotlightBackground&&(s.style.background=l.spotlightBackground,s.style.backgroundColor=l.spotlightBackground),l.spotlightBorderRadius&&(s.style.borderRadius=l.spotlightBorderRadius),h.keepCurrentUi&&(s.style.opacity="0"),s.setAttribute("data-tour-highlighted","1"),kt(s,l)),document.body.style.overflow="hidden";const x=()=>{const w=$(l.anchorSelector)||s;if(l.freezeTooltip){const S=w&&w.isConnected?w.getBoundingClientRect():null;v(w,l,S&&S.width>=2?S:null,{fadeIn:!!h.keepCurrentUi});return}const E=K(s,l);let k=E?N(E,l):s;L(k,l);const T=l.tooltipAnchor?null:j(l,k);v(k||s,l,T,{fadeIn:!!h.keepCurrentUi})};if(l.freezeTooltip){requestAnimationFrame(()=>requestAnimationFrame(x));return}const m=(b=0)=>{requestAnimationFrame(()=>{if(l.forcePageTop&&et("auto"),l.tooltipAnchor){x();return}const w=K(s,l);let E=w?N(w,l):s;L(E,l);const k=j(l,E);if(!k&&b<4){requestAnimationFrame(()=>m(b+1));return}v(E||s,l,k,{fadeIn:!!h.keepCurrentUi})})};m(0)})}function v(u,l,g,h){const s=h||{},x=document.getElementById("tourTooltip");x&&x.remove(),O();const m=document.createElement("div");m.id="tourTooltip";const b=Math.min(i+1,o.length),w=Math.max(8,Math.min(100,Math.round(b/o.length*100))),E=nt(l.title||"Quick setup"),k=nt(l.text||""),T=l.primaryLabel||(i<o.length-1?"Next":"Got it"),S=i<=0;m.style.cssText="position:fixed;z-index:100000;left:12px;right:12px;bottom:calc(14px + env(safe-area-inset-bottom,0px));display:flex;justify-content:center;pointer-events:none;visibility:hidden;",m.innerHTML=`
      ...
      </div>`,document.body.appendChild(m);const z=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,C=ee(l,z);let F=g;if(g&&g.width>=2&&g.height>=2){F=oe(u,l,m,C)||g,l.noHighlight||kt(u,l);const V=Math.min(380,window.innerWidth-28);m.style.setProperty("--tour-width",`${V}px`),m.style.left="0",m.style.right="auto",m.style.bottom="auto",m.style.width=`${V}px`,m.style.justifyContent="flex-start",m.classList.add("tour-tooltip-floating");const yt=m.querySelector(".tour-panel"),ht=Math.min(yt&&yt.offsetHeight||m.offsetHeight||190,Math.max(140,window.innerHeight-28)),bt=l.tooltipGap??8,Nt=F.left+F.width/2,vt=Math.max(14,Math.min(Nt-V/2,window.innerWidth-V-14)),qt=C!=="above"?F.bottom+bt:F.top-ht-bt,wt=Math.max(14,Math.min(qt,window.innerHeight-ht-14));m.style.setProperty("--tour-left",`${vt}px`),m.style.setProperty("--tour-top",`${wt}px`),m.style.left=`${vt}px`,m.style.top=`${wt}px`}m.style.visibility="visible",s.fadeIn&&Xt(m),B()}function B(){const u=document.getElementById("tourNextBtn"),l=document.getElementById("tourSkipBtn"),g=b=>{if(b<0)return;const w=r(o[i],o[b]),E=()=>{i=b,localStorage.setItem("settingsTourStep",String(i)),p({keepCurrentUi:w})};Zt().then(E)},h=()=>{g(i+1)},s=()=>{n()},x=()=>{i<=0||g(i-1)};u&&(u.onclick=h),l&&(l.onclick=s);const m=document.getElementById("tourBackBtn");m&&(m.onclick=x),Qt({onNext:h,onBack:x,onSkip:s})}function M(){O(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms(),A({blockPointer:!0,lockScroll:!0,dim:Q});const u=c.activeHotelName||"Your Property",l=u.trim().charAt(0).toUpperCase(),g=u.length>10?u.slice(0,10):u,h="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",s="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",x="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",m=`<div style="${h}"><div style="${s}background:rgba(255,255,255,0.22);"></div><div style="${x}"></div></div>`,b=c.activeHotelAppIcon||"",w=b?`<img src="${b}" alt="" style="width:100%;height:100%;object-fit:contain;">`:l,E=b?`${s}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${s}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,k=`<div style="${h}"><div style="${E}">${w}</div><div style="${x}font-size:7.5px;color:#fff;font-weight:700;">${g}</div></div>`,T=[m,m,m,m,k,m,m,m].join(""),S=document.createElement("div");if(S.id="tourTooltip",S.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",S.innerHTML=`
      ...
      </div>`,document.body.appendChild(S),!document.getElementById("tourModalAnimStyle")){const z=document.createElement("style");z.id="tourModalAnimStyle",z.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(z)}document.getElementById("tourNextBtn").onclick=()=>{H().then(()=>{a({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),p()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}}function I(){O(),A({blockPointer:!0,lockScroll:!0,dim:Q});let u=0;const l=[`<div style="padding:20px 18px 0;">
      ...
      <div style="padding:0 14px 14px;">
      ...
      </div>`],g=document.createElement("div");g.id="tourTooltip",g.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";let h=!1;function s(){const m=u>=l.length-1?"Next — Revenue →":"Next →",b=h?"none":"tourPanelIn 0.22s ease-out",w=h?"tourPageIn 0.18s ease-out":"none";g.innerHTML=`
        <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:${b};">
          ...
          <div style="padding:4px 18px 6px;text-align:center;">
            <div style="display:flex;justify-content:center;gap:6px;margin-bottom:10px;">
              ${l.map((E,k)=>`<div style="width:8px;height:8px;border-radius:50%;background:${k===u?"#2E7D5B":"#D8E4DC"};transition:background 0.2s ease;"></div>`).join("")}
            </div>
          </div>
        ...
        </div>`,h=!0,document.getElementById("tourNextBtn").onclick=()=>{u<l.length-1?(u++,s()):H().then(()=>{a({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),p()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}}if(document.body.appendChild(g),s(),!document.getElementById("tourModalAnimStyle")){const x=document.createElement("style");x.id="tourModalAnimStyle",x.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(x)}}function P(){O(),A({blockPointer:!0,lockScroll:!0,dim:Q});const u=document.createElement("div");if(u.id="tourTooltip",u.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",u.innerHTML=`
      ...
      </div>`,document.body.appendChild(u),!document.getElementById("tourModalAnimStyle")){const l=document.createElement("style");l.id="tourModalAnimStyle",l.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(l)}document.getElementById("tourNextBtn").onclick=()=>{H().then(()=>{a({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),p()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}}p()}async function zt(){const t=document.getElementById("settingsList");if(t){t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const e=await api("GET","/api/crm/verify"),i="https://"+(e?.domain||c.activeHotelId+".mktel.co"),a="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(i),n=await api("GET","/api/crm/rooms");let r={nightly:69,weekly:299,monthly:999};n?.rates&&(r=n.rates);const d=n?.rooms||[];let p="";e?.subscribed||(p+=goLiveInlineCardHtml()),d.length?d.forEach(f=>{const y=f.images&&f.images.length>0;p+=`
    ...
    `,t.innerHTML=p}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function ie(){const t=document.getElementById("settings-booking-url");t&&navigator.clipboard.writeText(t.value).then(()=>{localStorage.setItem("linkCopied","1"),G(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function ne(){localStorage.setItem("settingsTourDone","1");const t=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",t);let e=0;const o=setInterval(()=>{e++;const i=document.getElementById("edit-rate-nightly");if(i||e>20){if(clearInterval(o),!i)return;const a=i.closest(".accordion-body");if(a&&a.style.display==="none"){a.style.display="block";const n=a.previousElementSibling?.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const n=document.getElementById("checklistPointer");n&&n.remove();const r=i.getBoundingClientRect(),d=document.createElement("div");d.id="checklistPointer",d.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${r.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,d.innerHTML=`
          ...
          `,document.body.appendChild(d),setTimeout(()=>{const p=document.getElementById("checklistPointer");p&&p.remove()},6e3)},1e3)},100)}},200)}function re(){const e="https://"+(c.activeHotelDomain||c.activeHotelId+".mktel.co");navigator.clipboard.writeText(e).then(()=>{localStorage.setItem("linkCopied","1"),G(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function ae(t,e){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const a=setInterval(()=>{i++;const n=document.querySelector(t);if(n||i>20){if(clearInterval(a),!n)return;n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const r=document.getElementById("checklistPointer");r&&r.remove();const d=n.getBoundingClientRect(),p=document.createElement("div");p.id="checklistPointer",p.style.cssText=`
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=e}document.body.appendChild(t),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function ot(){const t=document.getElementById("postActivationTourTooltip");t&&t.remove();const e=document.getElementById("postActivationTourOverlay");e&&e.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function J(){ot(),localStorage.setItem("postActivationTourDone","1");const t=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",t)}catch{}}function ut(){if(localStorage.getItem("postActivationTourDone")){J();return}ot();const t=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. You'll get a push alert for each new one."},{tab:"bookings",navFilter:"bookings",text:"<strong>Booking review</strong> — turn it on here and new bookings wait for your OK before locking in, so a room you've already given away never gets sold twice."},{tab:"apps",navFilter:"apps",text:"<strong>Guest App</strong> — put your property on guests&apos; home screens and send install reminders."}];let e=0;function o(){if(ot(),e>=t.length){J();return}const i=t[e],a=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);a&&setFilter(i.tab,a);const n=document.createElement("div");n.id="postActivationTourOverlay",n.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(n),document.body.style.overflow="hidden",setTimeout(()=>{const r=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);r&&(r.setAttribute("data-post-activation-highlight","1"),r.style.position="relative",r.style.zIndex="100003",r.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",r.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const d=r?r.getBoundingClientRect():{left:24,bottom:80,width:200},p=document.createElement("div");p.id="postActivationTourTooltip";const f=Math.min(300,window.innerWidth-32),y=Math.max(16,Math.min(d.left+d.width/2-f/2,window.innerWidth-f-16)),v=Math.min(d.bottom+14,window.innerHeight-180);p.style.cssText=`position:fixed;z-index:100004;left:${y}px;top:${v}px;max-width:${f}px;width:${f}px;`;const B=e>=t.length-1;p.innerHTML=`
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),ut()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}async function gt(){if(isEditPageDomReady())return;if(c.editRoomsLoadPromise)return c.editRoomsLoadPromise;const t=document.getElementById("editRoomsList");if(t){c.editRoomsLoadPromise=(async()=>{t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[e,o]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify")]);if(!e.rooms)throw new Error("No data");c.editRooms=e.rooms;const i=o?.hotelName||"";i&&(c.activeHotelName=i),o&&(c.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const a=o?.hotelSubtitle||"",n=o?.hotelAddress||"",r=o?.hotelPhone||"",d=o?.appIconUrl||"";c.activeHotelAppIcon=d,updateFrontdeskManifestLink();let p={nightly:69,weekly:299,monthly:999,taxRate:.1};e.rates&&(p=e.rates);const y="https://"+(o?.domain||c.activeHotelId+".mktel.co"),v="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(y);let B=`
      ...
      <div class="room-edit-fields" style="padding:18px;">
        ...
        <div style="margin-bottom:12px;">
          ...
          <div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:8px;" id="edit-amenity-pills-${e.id}">
            ${i.map(r=>`<span style="display:inline-flex;align-items:center;gap:4px;background:var(--green-pale);color:var(--green);padding:5px 10px;border-radius:8px;font-size:12px;font-weight:600;">${Rt(r)} ${r} <button onclick="removeAmenity('${e.id}','${r.replace(/'/g,"\\'")}')" style="background:none;border:none;color:var(--green);cursor:pointer;font-size:14px;margin-left:2px;">×</button></span>`).join("")}
          </div>
    ...
    </div>`}).join(""),typeof lucide<"u"&&lucide.createIcons()}}function Ct(t){const e=c.editRooms.find(o=>String(o.id)===String(t));return(e&&e.images||[]).filter(o=>o&&o.url)}function Ot(t,e){const o=Ct(t);if(!o.length)return;const i=document.getElementById("edit-card-"+t);if(!i)return;const a=o.length,n=((Number(e)||0)%a+a)%a,r=i.querySelector(".room-edit-main-img");r&&(r.src=o[n].url),i.querySelector(".room-edit-photo")?.setAttribute("data-photo-index",String(n));const d=i.querySelector(".room-edit-photo-count");d&&(d.textContent=n+1+" / "+a),i.querySelectorAll(".room-edit-image-dot").forEach((p,f)=>{p.classList.toggle("active",f===n),f===n?p.setAttribute("aria-current","true"):p.removeAttribute("aria-current")}),i.querySelectorAll(".room-edit-thumb").forEach((p,f)=>{p.classList.toggle("active",f===n),f===n?p.setAttribute("aria-current","true"):p.removeAttribute("aria-current")})}function ye(t,e){const i=document.getElementById("edit-card-"+t)?.querySelector(".room-edit-photo"),a=parseInt(i?.getAttribute("data-photo-index")||"0",10)||0;Ot(t,a+e)}function Rt(t){const e=t.toLowerCase();return e.includes("wifi")?'<i data-lucide="wifi" style="width:14px;height:14px;"></i>':e.includes("tv")||e.includes("television")?'<i data-lucide="tv" style="width:14px;height:14px;"></i>':e.includes("fridge")||e.includes("refrigerator")?'<i data-lucide="thermometer-snowflake" style="width:14px;height:14px;"></i>':e.includes("parking")?'<i data-lucide="car" style="width:14px;height:14px;"></i>':e.includes("housekeeping")||e.includes("cleaning")?'<i data-lucide="sparkles" style="width:14px;height:14px;"></i>':e.includes("bath")||e.includes("shower")?'<i data-lucide="bath" style="width:14px;height:14px;"></i>':e.includes("work")||e.includes("desk")?'<i data-lucide="laptop" style="width:14px;height:14px;"></i>':e.includes("pet")||e.includes("dog")?'<i data-lucide="paw-print" style="width:14px;height:14px;"></i>':e.includes("pool")?'<i data-lucide="waves" style="width:14px;height:14px;"></i>':e.includes("kitchen")||e.includes("microwave")?'<i data-lucide="cooking-pot" style="width:14px;height:14px;"></i>':'<i data-lucide="check" style="width:14px;height:14px;"></i>'}const Mt=[{key:"wifi",label:"Free WiFi",icon:"wifi"},{key:"tv",label:"Smart TV",icon:"tv"},{key:"fridge",label:"Fridge",icon:"thermometer-snowflake"},{key:"parking",label:"Free Parking",icon:"car"},{key:"housekeeping",label:"Weekly Housekeeping",icon:"sparkles"},{key:"bath",label:"Bath",icon:"bath"},{key:"workstation",label:"Workstation",icon:"laptop"},{key:"pet",label:"Pet Friendly",icon:"paw-print"},{key:"pool",label:"Pool",icon:"waves"},{key:"kitchen",label:"Kitchenette",icon:"cooking-pot"},{key:"ac",label:"Air Conditioning",icon:"wind"},{key:"laundry",label:"Laundry",icon:"shirt"}];let ft=null;function $t(t){ft=t;const o=(c.editRooms.find(n=>n.id===t)?.amenities||"").split("•").map(n=>n.trim().toLowerCase()).filter(Boolean);let i=document.getElementById("amenityPickerModal");i||(document.body.insertAdjacentHTML("beforeend",`
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",it),i=document.getElementById("amenityPickerModal"));const a=document.getElementById("amenityPickerGrid");a.innerHTML=Mt.map(n=>{const r=o.some(d=>d.includes(n.key));return`<button onclick="toggleAmenityPreset(this,'${n.key}')" data-key="${n.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${r?"#2E7D5B":"#e5e7eb"};background:${r?"#E8F5EE":"white"};color:${r?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${n.icon}" style="width:14px;height:14px;"></i> ${n.label}</button>`}).join(""),document.getElementById("amenityCustomInput").value="",i.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function he(t,e){const o=t.style.borderColor==="rgb(46, 125, 91)";t.style.borderColor=o?"#e5e7eb":"#2E7D5B",t.style.background=o?"white":"#E8F5EE",t.style.color=o?"#1a1a2e":"#2E7D5B"}function it(){document.getElementById("amenityPickerModal").style.display="none",ft=null}function be(){const t=c.editRooms.find(a=>a.id===ft);if(!t){it();return}const e=document.getElementById("amenityPickerGrid"),o=[];e.querySelectorAll("button").forEach(a=>{if(a.style.background==="rgb(232, 245, 238)"){const n=Mt.find(r=>r.key===a.dataset.key);n&&o.push(n.label)}});const i=document.getElementById("amenityCustomInput").value.trim();i&&o.push(i),t.amenities=o.join(" • "),it(),mt(),typeof lucide<"u"&&lucide.createIcons()}function ve(t){$t(t)}function we(t,e){const o=c.editRooms.find(a=>a.id===t);if(!o)return;const i=(o.amenities||"").split("•").map(a=>a.trim()).filter(Boolean);o.amenities=i.filter(a=>a!==e).join(" • "),mt(),typeof lucide<"u"&&lucide.createIcons()}async function ke(){const t=document.getElementById("edit-hotel-name")?.value.trim(),e=document.getElementById("edit-hotel-subtitle")?.value.trim(),o=document.getElementById("edit-hotel-address")?.value.trim(),i=document.getElementById("edit-hotel-phone")?.value.trim(),a=document.getElementById("edit-hotel-policy")?.value.trim();try{await api("POST","/api/crm/hotel-info",{name:t,subtitle:e,address:o,phone:i,cancellationPolicy:a}),toast("Property info saved!","success")}catch{toast("Failed to save","error")}}async function Ee(){const t=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),localStorage.setItem("ratesChanged","1"),c.launchStatus=null,G(),toast("Rates saved!","success")}catch{toast("Failed to save rates","error")}}async function Be(){const t=document.getElementById("edit-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");c.token=t,c.isMasterPin=!1;try{localStorage.setItem("crmToken",c.token)}catch{}toast("PIN updated!","success")}catch(e){toast(e.message||"Failed to change PIN","error")}}function Se(t){navigator.clipboard.writeText(t).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function Te(t){const e=t.nextElementSibling,o=t.querySelector(".accordion-arrow");e.style.display==="none"?(e.style.display="block",o&&(o.style.transform="rotate(90deg)")):(e.style.display="none",o&&(o.style.transform="rotate(0deg)"))}let W=!1;function Lt(){if(document.getElementById("goLiveOverlay"))return;const t=document.createElement("div");t.id="goLiveOverlay",t.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(255,255,255,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;",t.innerHTML='<div class="logo-sprite-bounce"></div><div style="font-size:14px;font-weight:700;color:#1a5c3f;">Opening secure checkout…</div><div style="font-size:12px;color:#6b7280;">Taking you to Stripe — one moment</div>',document.body.appendChild(t)}function st(){const t=document.getElementById("goLiveOverlay");t&&t.remove()}async function Ie(){if(!W){W=!0,Lt();try{const t=await api("POST","/api/crm/go-live");if(t.success&&t.url){window.location.href=t.url;return}st(),W=!1,toast(t.message||"Failed to start checkout","error")}catch{st(),W=!1,toast("Failed to start checkout. Try again.","error")}}}async function ze(){try{const t=await api("GET","/api/crm/billing-portal");t.success&&t.url?window.location.href=t.url:toast(t.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function Pe(){const t=document.getElementById("supportMessage")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),document.getElementById("supportMessage").value="",toast("Message sent! We'll reply to your email.","success")}catch{toast("Failed to send. Email support@bookmarketel.com directly.","error")}}async function Ae(t){const e=c.editRooms.find(d=>d.id===t);if(!e){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+t)?.value.trim(),i=document.getElementById("edit-desc-"+t)?.value.trim(),a=parseInt(document.getElementById("edit-occ-"+t)?.value)||4,n=parseInt(document.getElementById("edit-units-"+t)?.value)||1,r={id:t,name:o||e.name,description:i||"",amenities:e.amenities||"",maxOccupancy:a,totalUnits:n};try{const d=await api("POST","/api/crm/rooms",r);if(d&&d.success===!1){toast(d.message||"Failed to save","error");return}e.name=r.name,e.description=r.description,e.maxOccupancy=a,e.totalUnits=n,toast("Room saved!","success")}catch(d){toast("Failed to save: "+(d.message||""),"error")}}async function Ce(t,e){const o=Array.from(t.target.files);if(!o.length)return;const a=document.getElementById("edit-card-"+e)?.querySelector("div:first-child");a&&(a.style.position="relative",a.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+e+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+e+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let n=0,r="";for(const p of o){try{const y=await pt(e,p);if(y.image){const v=c.editRooms.find(B=>B.id===e);v&&(v.images||(v.images=[]),v.images.push(y.image),v.imageUrl||(v.imageUrl=y.image.url)),n++}}catch(y){r=y.message||"Upload failed"}const f=document.getElementById("upload-progress-"+e);f&&(f.textContent=n+" / "+o.length)}const d=document.getElementById("upload-spinner-"+e);d&&d.remove(),Y(),n>0&&(c.launchStatus=null),G(),n>0?toast(n+" photo"+(n!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success"):toast(r||"Upload failed","error")}function Dt(t,e=512){return new Promise((o,i)=>{const a=new Image,n=URL.createObjectURL(t);a.onload=()=>{try{const r=Math.min(a.naturalWidth,a.naturalHeight),d=(a.naturalWidth-r)/2,p=(a.naturalHeight-r)/2,f=document.createElement("canvas");f.width=e,f.height=e;const y=f.getContext("2d");y.imageSmoothingQuality="high",y.drawImage(a,d,p,r,r,0,0,e,e),URL.revokeObjectURL(n),f.toBlob(v=>v?o(v):i(new Error("crop failed")),"image/png",.92)}catch(r){URL.revokeObjectURL(n),i(r)}},a.onerror=()=>{URL.revokeObjectURL(n),i(new Error("load failed"))},a.src=n})}function Ft(){const t=document.getElementById("appsAppIconPreview");t&&(t.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function xt(t){const e=document.getElementById("appsAppIconPreview");e&&(e.style.background="#fff",e.style.border="1px solid var(--border)",e.style.padding="0",e.innerHTML='<img src="'+t+'" alt="App icon" style="width:100%;height:100%;object-fit:contain;">')}function dt(){const t=document.getElementById("appsAppIconPreview");if(!t)return;if(c.activeHotelAppIcon){xt(c.activeHotelAppIcon);return}const e=(c.activeHotelName||"P").trim().charAt(0).toUpperCase()||"🏡";t.style.background="transparent",t.style.border="none",t.style.padding="0",t.innerHTML='<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">'+e+"</span>"}async function Oe(t){const e=t.files&&t.files[0];if(!e)return;Ft();const o=new FormData;try{const i=await Dt(e,512);o.append("icon",i,"app-icon.png")}catch{o.append("icon",e)}try{const i=ct(),a=new URLSearchParams;c.activeHotelId&&a.set("hotelId",c.activeHotelId),i&&a.set("token",i);const r=await(await fetch(`/api/crm/hotel-app-icon?${a}`,{method:"POST",headers:{"x-crm-token":i},body:o})).json();if(r.success&&r.appIconUrl){c.activeHotelAppIcon=r.appIconUrl,xt(r.appIconUrl);const d=document.getElementById("appsView");d&&(d.dataset.appsKey=(c.activeHotelId||"")+"|"+r.appIconUrl+"|"+(c.activeHotelDomain||"")),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Logo updated! Guests will see it on their phone.","success")}else toast(r.message||"Failed to upload icon","error"),dt()}catch{toast("Failed to upload icon","error"),dt()}t.value=""}async function Re(t,e){if(confirm("Delete this photo?"))try{await api("DELETE",`/api/crm/rooms/${t}/images/${e}`);const o=c.editRooms.find(i=>i.id===t);o&&o.images&&(o.images=o.images.filter(i=>i.id!==e),o.imageUrl=o.images[0]?.url||null),Y(),toast("Photo deleted","success")}catch{toast("Failed to delete","error")}}async function Me(t){if(confirm("Delete this room type?"))try{await api("DELETE",`/api/crm/rooms/${t}`),toast("Room deleted","success"),gt()}catch{toast("Failed to delete","error")}}function $e(){const t=document.getElementById("editRoomsList");document.getElementById("editAddForm")||(t.insertAdjacentHTML("beforeend",`
  ...
  `),document.getElementById("editNewRoomName").focus())}function Le(){const t=document.getElementById("editNewRoomName").value.trim();t&&api("POST","/api/crm/rooms",{name:t,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),gt()}).catch(()=>toast("Failed to add","error"))}const Ht={addAmenityPrompt:ve,advanceTourIfNeeded:G,changePin:Be,checklistGoTo:ae,checklistGoToRates:ne,cleanupPostActivationTourUi:ot,cleanupSettingsTourUi:R,closeAmenityPicker:it,confirmAmenityPicker:be,confirmEditAddRoom:Le,copyBookingLink:Se,copyBookingLinkFromChecklist:re,deleteEditImage:Re,deleteEditRoom:Me,ensureTourBlurOverlay:A,finishPostActivationTour:J,getAmenityIcon:Rt,getCrmAuthToken:ct,getEditRoomImages:Ct,goLive:Ie,guestBookingEngineUrl:Pt,handoffToGuestAppsTour:St,hideGoLiveOverlay:st,loadEditRooms:gt,loadSettings:zt,openAmenityPicker:$t,openBillingPortal:ze,openEditAddRoom:$e,openGuestBookingEngine:ue,openPreviewSite:pe,openTourAccordion:L,postRoomImageUpload:pt,queryTourSelector:$,removeAmenity:we,renderEditRooms:mt,renderEditRoomsCards:Y,replayWalkthrough:fe,resolveLiveTourElement:K,resolveTourHighlightEl:N,restoreAppIconPreview:dt,saveEditRoom:Ae,saveHotelInfo:ke,saveRates:Ee,scrollTourTargetIntoView:Bt,sendSupportMessage:Pe,setAppIconPreviewImage:xt,setAppIconPreviewLoading:Ft,settingsChangePin:le,settingsCopyLink:ie,settingsSaveRates:de,settingsSendSupport:ce,settingsUploadPhoto:se,showActivatedModal:xe,showBookingProtectionModal:Tt,showEditRoomPhoto:Ot,showFinaleMockModal:q,showGoLiveOverlay:Lt,showOnboardingQuestions:me,showTestDriveModal:It,showWelcomeModal:At,squareCropImage:Dt,startPostActivationTabTour:ut,startSettingsTour:at,stepEditRoomPhoto:ye,toggleAmenityPreset:he,toggleSection:Te,tourAnchorRect:j,tourElementRect:tt,updatePreviewSiteBar:ge,uploadAppIcon:Oe,uploadEditImages:Ce};function De(){Gt(Ht)}const je=Object.freeze(Object.defineProperty({__proto__:null,default:Ht,install:De},Symbol.toStringTag,{value:"Module"}));export{He as a,Ue as b,c,je as d,Gt as e,qe as i,Ne as s};
