import{c as u,e as yt}from"./settings-DLCjGil9.js";function I(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function rt(...t){return I("ensureAppsViewRendered")?.(...t)}function pt(...t){return I("showFinaleMockModal")?.(...t)}function lt(...t){return I("finishTourHydration")?.(...t)}function j(...t){return I("goLive")?.(...t)}function G(...t){return I("toast")?.(...t)}function vt(...t){return I("appsCloseLightbox")?.(...t)}let q=[],c=0,N=!1,_=null,M=null;function ct(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function T(t){return String(t??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function ut(){_&&(document.removeEventListener("keydown",_),_=null)}function wt(t){ut(),_=o=>{if(o.defaultPrevented)return;const e=o.target&&o.target.tagName?o.target.tagName.toLowerCase():"";e==="input"||e==="textarea"||e==="select"||o.target?.isContentEditable||(o.key==="Escape"?(o.preventDefault(),t.onSkip?.()):o.key==="Enter"||o.key==="ArrowRight"?(o.preventDefault(),t.onNext?.()):o.key==="ArrowLeft"&&(o.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",_)}function kt(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(o=>o.removeAttribute("id"))}function Tt(t,o){const e=t.querySelectorAll("input, textarea, select"),n=o.querySelectorAll("input, textarea, select");e.forEach((s,i)=>{const a=n[i];a&&(s.type==="checkbox"||s.type==="radio"?a.checked=s.checked:a.value=s.value)})}function gt(t,o){const e=getComputedStyle(t);for(const i of e)o.style.setProperty(i,e.getPropertyValue(i),e.getPropertyPriority(i));const n=t.children,s=o.children;for(let i=0;i<n.length;i+=1)s[i]&&gt(n[i],s[i])}function zt(t){if(!t||!t.isConnected)return null;document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(n=>n.remove());const o=t.getBoundingClientRect();if(o.width<2||o.height<2)return null;const e=t.cloneNode(!0);return kt(e),gt(t,e),Tt(t,e),t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),t.style.visibility="hidden",e.setAttribute("data-apps-tour-spotlight-clone","1"),e.setAttribute("aria-hidden","true"),e.style.position="fixed",e.style.left=`${o.left}px`,e.style.top=`${o.top}px`,e.style.width=`${o.width}px`,e.style.height=`${o.height}px`,e.style.margin="0",e.style.maxWidth="none",e.style.zIndex="100002",e.style.pointerEvents="none",e.style.transform="none",e.style.boxShadow="0 18px 46px rgba(26,43,34,0.24)",e.style.outline="1px solid rgba(255,255,255,0.82)",e.style.outlineOffset="2px",document.body.appendChild(e),e}function ft(){ut(),M&&(clearTimeout(M),M=null);const t=document.getElementById("appsTourLightbox");t&&t.remove();const o=document.getElementById("appsTourTooltip");o&&o.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(e=>e.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(e=>{e.style.position=e.dataset.appsTourOrigPosition||"",e.style.zIndex=e.dataset.appsTourOrigZIndex||"",e.style.isolation=e.dataset.appsTourOrigIsolation||"",e.style.boxShadow=e.dataset.appsTourOrigBoxShadow||"",e.style.outline=e.dataset.appsTourOrigOutline||"",e.style.outlineOffset=e.dataset.appsTourOrigOutlineOffset||"",e.style.transition=e.dataset.appsTourOrigTransition||"",e.style.visibility=e.dataset.appsTourOrigVisibility||"",e.removeAttribute("data-apps-tour-highlighted"),delete e.dataset.appsTourOrigPosition,delete e.dataset.appsTourOrigZIndex,delete e.dataset.appsTourOrigIsolation,delete e.dataset.appsTourOrigBoxShadow,delete e.dataset.appsTourOrigOutline,delete e.dataset.appsTourOrigOutlineOffset,delete e.dataset.appsTourOrigTransition,delete e.dataset.appsTourOrigVisibility})}function At(t){let o=t&&t.parentElement;for(;o&&o!==document.body&&o!==document.documentElement;){const e=getComputedStyle(o),n=e.overflowY||e.overflow;if(/(auto|scroll)/.test(n)&&o.scrollHeight>o.clientHeight+1)return o;o=o.parentElement}return null}function dt(t,o){if(!o)return;const e=At(t);if(e){e.scrollTop+=o;return}window.scrollBy({top:o,left:0,behavior:"auto"})}function It(t,o,e){if(!t||!t.isConnected)return;const n=e?o.mobileScrollPadTop:o.scrollPadTop,s=e?o.mobileScrollPadBottom:o.scrollPadBottom;if(n==null&&s==null)return;let i=t.getBoundingClientRect();const a=n??80,p=s??220;i.top<a&&(dt(t,i.top-a),i=t.getBoundingClientRect()),i.bottom>window.innerHeight-p&&dt(t,i.bottom-window.innerHeight+p)}function b(t){ft(),document.body.style.overflow="";const o=N;N=!1;try{const e=typeof rt=="function"?rt:window.ensureAppsViewRendered;typeof e=="function"&&e(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),o||localStorage.getItem("settingsTourStep")==="handoff"||u.settingsTourActive)){const n=typeof pt=="function"?pt:window.showFinaleMockModal;if(typeof n=="function"){n();return}}}function Bt(t){const o=c+t;o<0||o>=q.length||(c=o,z())}function tt(){if(localStorage.setItem("appsTourDone","1"),N||localStorage.getItem("settingsTourStep")==="handoff"||u.settingsTourActive){u.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const o=typeof lt=="function"?lt:window.finishTourHydration;typeof o=="function"&&o()}}function St(){tt();const t=typeof j=="function"?j:window.goLive;if(b(!1),typeof t=="function"){t();return}const o=typeof G=="function"?G:window.toast;typeof o=="function"&&o("Open Go live to activate your booking page.","error")}function $t(){if(u.hotelSubscribed||document.getElementById("guestAppActivationOverlay"))return;ct();const t=document.createElement("div");if(t.id="guestAppActivationOverlay",t.style.cssText="position:fixed;inset:0;z-index:100004;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;padding:24px 16px;box-sizing:border-box;",t.innerHTML=`
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:390px;width:100%;max-height:calc(100vh - 48px);overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:appsTourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(t),document.body.style.overflow="hidden",!document.getElementById("tourModalAnimStyle")){const e=document.createElement("style");e.id="tourModalAnimStyle",e.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(e)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{t.remove(),document.body.style.overflow=""};document.getElementById("guestAppActivateNowBtn").onclick=()=>{o();const e=typeof j=="function"?j:window.goLive;if(typeof e=="function"){e();return}const n=typeof G=="function"?G:window.toast;typeof n=="function"&&n("Open Go live to activate your booking page.","error")},document.getElementById("guestAppActivateLaterBtn").onclick=o}function z(){ct();const t=q[c];if(!t){b(!0);return}const o=q.length,e=c>=o-1,n=`${c+1} / ${o}`,s=Math.max(8,Math.min(100,Math.round((c+1)/o*100))),i=document.querySelector(t.target);if(!i){c++,z();return}ft();let a=document.createElement("div");a.id="appsTourLightbox",a.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.22);pointer-events:auto;",document.body.appendChild(a),i.dataset.appsTourOrigPosition=i.style.position||"",i.dataset.appsTourOrigZIndex=i.style.zIndex||"",i.dataset.appsTourOrigIsolation=i.style.isolation||"",i.dataset.appsTourOrigBoxShadow=i.style.boxShadow||"",i.dataset.appsTourOrigOutline=i.style.outline||"",i.dataset.appsTourOrigOutlineOffset=i.style.outlineOffset||"",i.dataset.appsTourOrigTransition=i.style.transition||"",i.style.position=i.style.position||"relative",i.style.zIndex="100002",i.style.isolation="isolate",i.style.transition="box-shadow 0.18s ease, outline 0.18s ease",i.style.boxShadow="0 0 0 1px rgba(255,255,255,0.92), 0 18px 46px rgba(26,43,34,0.22)",i.style.outline="1px solid rgba(255,255,255,0.82)",i.style.outlineOffset="2px",i.setAttribute("data-apps-tour-highlighted","1");const p=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,h=r&&t.mobileScrollBlock||t.scrollBlock||"center",g=p?"auto":"smooth";if(r&&t.mobileScrollToBottom){const d=Math.max(document.documentElement?document.documentElement.scrollHeight:0,document.body?document.body.scrollHeight:0);window.scrollTo({top:d,behavior:g}),setTimeout(()=>{window.scrollTo({top:d,behavior:"auto"})},g==="smooth"?520:0)}else i.scrollIntoView({behavior:g,block:h});const H=()=>{const d=document.getElementById("appsTourTooltip");d&&d.remove(),zt(i);const y=i.getBoundingClientRect(),B=Math.min(r?window.innerWidth-24:370,window.innerWidth-28),V=y.left+y.width/2,v=Math.max(14,Math.min(V-B/2,window.innerWidth-B-14)),W=r&&t.mobileTooltipAnchor||t.tooltipAnchor||"bottom",w=r&&t.mobileTooltipPosition||t.tooltipPosition||"",S=y.top,D=W==="top"?y.top:y.bottom,U=t.primaryLabel||(e?"Done":"Next"),st=t.secondaryLabel||(e?"Not now":"Skip tour"),Q=c<=0,K=t.kicker||"Guest App",l=document.createElement("div");if(l.id="appsTourTooltip",l.style.cssText=`position:fixed;z-index:100003;left:${v}px;top:14px;width:${B}px;max-width:${B}px;visibility:hidden;`,l.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${T(t.title)}">
      ...
      </div>`,document.body.appendChild(l),r&&!w)l.style.left="12px",l.style.right="12px",l.style.width="auto",l.style.maxWidth="none",l.style.top="auto",l.style.bottom="calc(14px + env(safe-area-inset-bottom,0px))";else{const x=Math.min(l.offsetHeight||190,Math.max(130,window.innerHeight-28)),k=window.innerHeight-D,$=S;let m=w==="below"||!w&&k>=x+14+14;w==="above"&&(m=!1),m&&k<x+14+14&&$>k&&(m=!1),!m&&$<x+14+14&&k>$&&(m=!0);const Z=m?D+14:S-x-14,J=Math.max(14,window.innerHeight-x-14),L=Math.max(14,Math.min(Z,J));l.style.top=`${L}px`}l.style.visibility="visible";const X=()=>{if(t.activateOnNext){St();return}if(e){tt(),b(!1),t.showActivationOnComplete&&$t();return}c++,z()},O=()=>{if(e){tt(),b(!1);return}b(!0)},C=()=>{c<=0||(c--,z())};document.getElementById("appsTourNextBtn").onclick=X,document.getElementById("appsTourSkipBtn").onclick=O;const F=document.getElementById("appsTourBackBtn");F&&(F.onclick=C),wt({onNext:X,onBack:C,onSkip:O})},Y=r&&t.mobileScrollToBottom?p?80:680:p?40:320;M=setTimeout(()=>{It(i,t,r),requestAnimationFrame(H)},Y)}function Et(t){const o=t&&t.replay,e=t&&t.chainFromSettingsTour;if(!o&&!e&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;vt(),b(!1),N=!!e;const n=!!u.hotelSubscribed;q=[{target:"#tour-apps-intro",kicker:"The loop",title:"Your hotel becomes the app.",text:"Guests book from your direct page, save your hotel to their phone, then come back with one tap to book or message you."},{target:"#tour-apps-first",kicker:"Front Desk",title:"Install this on the property phone.",text:"Front Desk is this dashboard saved like an app. It is where booking alerts, guest messages, QR tools, and setup controls live.",scrollBlock:"center",tooltipAnchor:"top",tooltipPosition:"above",mobileScrollBlock:"center",mobileScrollPadTop:260,mobileScrollPadBottom:180,mobileTooltipAnchor:"top",mobileTooltipPosition:"above"},{target:"#tour-apps-then",kicker:"Guest path",title:"Send guests to your direct page.",text:"The Install button sits on the booking page. Guests tap it once, and your hotel icon lands on their home screen.",scrollBlock:"center",tooltipAnchor:"top",tooltipPosition:"above",mobileScrollBlock:"center",mobileScrollPadTop:260,mobileScrollPadBottom:180,mobileTooltipAnchor:"top",mobileTooltipPosition:"above"},{target:"#tour-apps-after",kicker:"Return visits",title:"Now the loop is easy to remember.",text:"Guests tap your icon to book direct or message you. New bookings and messages come back to Front Desk."},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your hotel.",text:"Use a real logo or clear property image. Guests see this square every time they save your hotel to their phone.",mobileScrollToBottom:!0,mobileScrollBlock:"end",mobileTooltipAnchor:"top",mobileTooltipPosition:"above"},{target:"#tour-apps-loop",kicker:n?"Live loop":"Activation",title:n?"This loop is on.":"Turn this on for your property.",text:n?"Guests can book direct, save your hotel, and message you. Front Desk gets the alerts.":"Activation turns on direct booking, guest installs, messages, and Front Desk alerts as one simple loop.",primaryLabel:n?"Done":"Continue to activation",secondaryLabel:n?"Close":"Not now",showActivationOnComplete:!n,mobileScrollBlock:"center",mobileScrollPadBottom:300}],c=0,z()}const f={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},_t="32px";function ot(t,o){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(o||400)+"/")}function et(t){return`border-radius:${_t};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function ht(t){const o=Math.min(window.devicePixelRatio||1,2),e=Math.round(Math.min(window.screen.width*o,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${e}/`)}let R=[],A=0;function Ht(t,o){b(!1),R=t,A=o||0;let e=document.getElementById("appsLightbox");if(!e){e=document.createElement("div"),e.id="appsLightbox",e.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(e),document.body.style.overflow="hidden",e._keyHandler=s=>{s.key==="ArrowRight"||s.key==="ArrowDown"?P(1):s.key==="ArrowLeft"||s.key==="ArrowUp"?P(-1):s.key==="Escape"&&xt()},document.addEventListener("keydown",e._keyHandler);let n=0;e.addEventListener("touchstart",s=>{n=s.changedTouches[0].clientX},{passive:!0}),e.addEventListener("touchend",s=>{const i=s.changedTouches[0].clientX-n;Math.abs(i)>50&&P(i<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",it()}function xt(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function P(t){const o=R.length;o<=1||(A=(A+t+o)%o,it())}function it(){const t=document.getElementById("appsLightbox");if(!t)return;const o=R[A],e=R.length,n=o.type!=="video",s=e>1?`${A+1} / ${e}`:"",i=n?`<img src="${ht(o.src)}" alt="${o.alt||""}"
       ...
       </video>`,a=e>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",p=e>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",r=e>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:e},(h,g)=>`<div onclick="appsOpenLightbox(_appsLbItems,${g})" style="width:7px;height:7px;border-radius:50%;background:${g===A?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${r}
    </div>`}function mt(t,o){const e=t||"Video";return`<span class="${"apps-media-badge"+(o==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${e}</span></span>`}function E(t,o,e,n,s){const i=s?mt("Video"):"",a=s?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${s?" apps-q--video":""}" onclick="appsOpenLightbox(${e},${n})">
    ...
    ${a}
  </button>`}function Dt(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function Ot(t){const o=document.getElementById("appsView");if(!o)return;const e=(u.activeHotelId||"")+"|"+(u.activeHotelAppIcon||"")+"|"+(u.activeHotelDomain||"");t||o.dataset.appsKey!==e||!o.querySelector(".apps-page")?(bt(),o.dataset.appsKey=e):nt()}function bt(){const t=document.getElementById("appsView");if(!t)return;const o=u.activeHotelName||"Your Hotel",e=u.activeHotelAppIcon||"",n=o.trim().charAt(0).toUpperCase()||"🏨",s=u.activeHotelDomain||"",i=s?"https://"+s:"#",a=s?"https://"+s+"/install":"#";function p(L){return JSON.stringify(L).replace(/"/g,"&quot;")}const r=ot(f.guestHome,520),h=[{type:"image",src:f.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${o}</strong> — they tap it to book you or text you. No app store.`}],g=[{type:"image",src:f.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:f.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:f.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],H=[{type:"video",src:f.guestInstallVideo,poster:f.guestHome,alt:"Guest adds hotel to phone",title:"How your guests put your hotel on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your hotel shows up on their phone like an app. You don't need to do anything."}],Y=[{type:"image",src:f.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your hotel app.'},{type:"image",src:f.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:f.guestMessageNotifVideo,poster:f.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],d=isStandaloneApp()||u.frontdeskInstalled,y=typeof Notification<"u"&&Notification.permission==="granted",V=!!(window.matchMedia&&window.matchMedia("(max-width: 767px)").matches)?"Install on this phone":"Install Front Desk";let v;d&&y?v=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
      ...
      </div>`:`<button type="button" class="apps-story-primary" onclick="handleInstallFrontdesk()">${V}</button>`,w=a!=="#"?'<button type="button" class="apps-story-secondary" onclick="openGuestBookingEngine({focusInstall:true})">Go to direct booking page</button>':'<div class="apps-story-domain-note">Your direct booking domain is still setting up. Once it is ready, guests install from that page.</div>',S="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",D=e?S+"background:#fff;border:1px solid var(--border);padding:0;":S,U=e?`<img src="${e}" alt="Hotel logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,Q=`
    <div class="apps-icon-card">
      ...
      ${a==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,l=a!=="#"?`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${p(H)},0)" style="margin-bottom:12px;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how guests install (1 min)</span></button>
        ...
        <div class="apps-q-list">
          ${E("What guests see on their phone","",p(g),0,!1)}
          ${E("How guests add your hotel","",p(H),0,!0)}
          ${E("Guest texts you, you text back","",p(Y),0,!0)}
          ${E("Your app and theirs — side by side","",p(h),0,!1)}
        </div>
        ${i!=="#"?`<button onclick="window.open('${i}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,at=L=>`
    ...
    ${C}
    ${O}
    ${d?m:x()}`,J=d?"Front Desk is installed. Guests can install your hotel from the direct booking page.":"Install Front Desk first. Then guests can install your hotel from the direct booking page.";t.innerHTML=`
  <style>
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),nt()}async function nt(){const t=document.getElementById("guestInstallStats");try{const o=await api("GET","/api/crm/guest-install-stats");if(!o.success)throw new Error(o.message||"Failed");if(guestPushSubscriberCount=o.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const e=o.totals||{},n=o.installedBookings||0,s=e.views||0;if(!n&&!s){t.style.display="none",t.innerHTML="";return}t.style.display="block";const i=o.installRatePercent!=null?o.installRatePercent:0,a=Object.entries(o.byTouchpoint||{}).filter(function(r){return r[1].views||r[1].installed}).sort(function(r,h){return(h[1].installed||0)-(r[1].installed||0)}).slice(0,5),p=a.length?a.map(function(r){const h=r[0].replace(/-/g," "),g=r[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+h+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(g.views||0)+" views · "+(g.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+n+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div>'+(p?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+p:"")}catch{guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}const Ct={appsCloseLightbox:xt,appsCloudinaryFull:ht,appsCloudinaryImg:ot,appsLbNav:P,appsLbRender:it,appsOpenLightbox:Ht,appsPhoneImgStyle:et,appsQuestionRow:E,appsTourClose:b,appsTourNav:Bt,appsTourRender:z,appsVideoBadgeHtml:mt,detectAppPlatform:Dt,ensureAppsViewRendered:Ot,loadGuestInstallStats:nt,renderAppsView:bt,startAppsTour:Et};function Lt(){yt(Ct)}export{Ct as default,Lt as install};
