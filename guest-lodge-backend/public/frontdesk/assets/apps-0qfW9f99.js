import{c as r,a as Dt,b as Mt,e as Nt}from"./settings-C-XMJ1IW.js";function m(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function at(...t){return m("ensureAppsViewRendered")?.(...t)}function st(...t){return m("showFinaleMockModal")?.(...t)}function rt(...t){return m("finishTourHydration")?.(...t)}function pt(...t){return m("goLive")?.(...t)}function lt(...t){return m("toast")?.(...t)}function Rt(...t){return m("appsCloseLightbox")?.(...t)}let M=[],g=0,N=!1,L=null,P=null,R=null,T=null;function jt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
