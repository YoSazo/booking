const c={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let Y=null;function $e(){return typeof lucide<"u"?Promise.resolve():Y||(Y=new Promise((t,e)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>t(),o.onerror=()=>e(new Error("lucide load failed")),document.head.appendChild(o)}),Y)}async function Ht(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let r=e.width,n=e.height;const a=Math.min(1,o/r,i/n);r=Math.round(r*a),n=Math.round(n*a);const l=document.createElement("canvas");l.width=r,l.height=n,l.getContext("2d").drawImage(e,0,0,r,n),e.close();const p=await new Promise((y,w)=>{l.toBlob(S=>S?y(S):w(new Error("encode failed")),"image/webp",.82)}),m=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([p],m+".webp",{type:"image/webp"})}catch{return t}}function Le(){const t=()=>{c.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}function Nt(t){Object.assign(window,t)}function F(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function K(...t){return F("setFilter")?.(...t)}function qt(...t){return F("toast")?.(...t)}function J(...t){return F("updateGoLiveBanner")?.(...t)}function Ut(...t){return F("seedTourRevenueShell")?.(...t)}function jt(...t){return F("finishTourHydration")?.(...t)}function Gt(...t){return F("goLive")?.(...t)}let q=null;function M(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
  ...
  `,document.head.appendChild(t)}function st(){q&&(document.removeEventListener("keydown",q),q=null)}function Vt(t){st(),q=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",q)}function ot(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function O(t){M();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText=`position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.22);pointer-events:${e.blockPointer?"auto":"none"};`,document.body.appendChild(o),e.lockScroll&&(document.body.style.overflow="hidden"),o)}function Yt(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function Wt(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((r,n)=>{const a=i[n];a&&(r.type==="checkbox"||r.type==="radio"?a.checked=r.checked:a.value=r.value)})}function wt(t,e){const o=getComputedStyle(t);for(const n of o)e.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=t.children,r=e.children;for(let n=0;n<i.length;n+=1)r[n]&&wt(i[n],r[n])}function vt(t,e){if(!t||!t.isConnected)return null;document.querySelectorAll("[data-tour-spotlight-clone]").forEach(r=>r.remove());const o=t.getBoundingClientRect();if(o.width<2||o.height<2)return null;const i=t.cloneNode(!0);return Yt(i),wt(t,i),Wt(t,i),i.setAttribute("data-tour-spotlight-clone","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.left=`${o.left}px`,i.style.top=`${o.top}px`,i.style.width=`${o.width}px`,i.style.height=`${o.height}px`,i.style.margin="0",i.style.maxWidth="none",i.style.zIndex="99999",i.style.pointerEvents="none",i.style.transform="none",i.style.boxShadow=e?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",i.style.outline=e?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",i.style.outlineOffset=e?.spotlightOutlineOffset??"2px",e?.spotlightBackground&&(i.style.background=e.spotlightBackground,i.style.backgroundColor=e.spotlightBackground),e?.spotlightBorderRadius&&(i.style.borderRadius=e.spotlightBorderRadius),document.body.appendChild(i),i}function C(t){const e=t||{};st();const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!e.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.background=n.dataset.tourOrigBackground||"",n.style.backgroundColor=n.dataset.tourOrigBackgroundColor||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.style.opacity=n.dataset.tourOrigOpacity||"",n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius,delete n.dataset.tourOrigOpacity});const r=document.getElementById("goLiveBanner");r&&r.dataset.tourHidden&&(delete r.dataset.tourHidden,typeof J=="function"&&J()),e.keepOverlay||(document.body.style.overflow="")}function _t(){const t=document.getElementById("tourTooltip"),e=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[t,...e,...o].filter(Boolean);return!i.length&&!o.length?(C({keepOverlay:!0}),Promise.resolve()):(st(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(C({keepOverlay:!0}),Promise.resolve()):(t&&(t.style.pointerEvents="none"),i.forEach(n=>{n.style.transition="opacity 0.07s ease, transform 0.07s ease",n.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(n=>{n.style.opacity="0",n.id==="tourTooltip"&&(n.style.transform="translateY(4px)")})}),new Promise(n=>{setTimeout(()=>{C({keepOverlay:!0}),n()},85)})))}function Qt(t){const e=[t,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);e.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{e.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function L(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function $(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function H(t,e){if(e.highlightSelector){const o=$(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function _(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const r=document.querySelector(i);if(r&&r.isConnected)return r}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function Z(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function U(t,e){const o=$(t.anchorSelector);if(o){const i=Z(o,!0);if(i)return i}return Z(e,!0)}function Kt(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function it(t,e){if(!e)return;const o=Kt(t);if(o){o.scrollTop+=e;return}window.scrollBy({top:e,left:0,behavior:"auto"})}function Jt(t,e){return e&&t.mobileTooltipPosition||t.tooltipPosition||"below"}function Zt(t,e,o,i){if(!t||!t.isConnected||!o)return U(e,t);const r=o.querySelector(".tour-panel"),n=Math.min(r&&r.offsetHeight||o.offsetHeight||190,Math.max(140,window.innerHeight-28)),a=e.tooltipGap??8,l=e.fitPadTop??e.scrollPadTop??72,p=window.innerHeight-(e.fitPadBottom??14),m=()=>U(e,t)||Z(t,!0);let y=m();if(!y)return null;for(let w=0;w<3;w+=1){const S=Math.max(120,p-l),R=y.height+a+n<=S;let z=0;if(i==="above"){const P=y.top-a-n-l;P<0&&(z=P),R&&y.bottom>p&&(z=y.bottom-p)}else{const P=y.bottom+a+n-p;P>0&&(z=P),R&&y.top<l&&(z=y.top-l)}if(Math.abs(z)<1)break;if(it(t,z),y=m(),!y)return null}return y}function X(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const r=document.querySelector(i);r&&(r.scrollTop=0)})}function kt(t,e,o){const i=o||{},r=e.scrollTarget||e.accordionCard,n=(r?$(r):null)||t;if(!n&&!e.scrollToTop)return Promise.resolve();const a=e.scrollBlock||"center",l=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let p=i.smooth&&!l?"smooth":c.settingsTourActive||l?"auto":"smooth";return new Promise(m=>{(()=>{if(!i.smooth||!n||e.forceSmoothScroll)return!1;const s=$(e.anchorSelector)||(n&&n.isConnected?n:null)||(t&&t.isConnected?t:null);if(!s)return!0;const g=s.getBoundingClientRect(),h=e.scrollPadTop??80,d=e.scrollPadBottom??220,x=Math.max(0,h-g.top),f=Math.max(0,g.bottom-(window.innerHeight-d));return Math.max(x,f)<=(e.quickScrollThreshold??180)})()&&(p="auto");const w=()=>{const s=e.scrollPadTop??80,g=e.scrollPadBottom??220,h=$(e.anchorSelector)||(n&&n.isConnected?n:null)||(t&&t.isConnected?t:null);if(!h){m();return}let d=h.getBoundingClientRect();d.top<s&&(it(h,d.top-s),d=h.getBoundingClientRect()),d.bottom>window.innerHeight-g&&it(h,d.bottom-window.innerHeight+g),requestAnimationFrame(()=>requestAnimationFrame(m))},S=()=>{n&&n.scrollIntoView({behavior:e.scrollToTop?"auto":p,block:a,inline:"nearest"}),w()};if(e.scrollToTop){if(X(p),e.scrollToTopOnly){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&X("auto"),m()}));return}if(p==="auto"){S();return}let s=!1;const g=()=>{s||(s=!0,window.removeEventListener("scrollend",h),clearTimeout(d),S())},h=()=>g();"onscrollend"in window&&window.addEventListener("scrollend",h,{once:!0});const d=setTimeout(g,520);return}if(!n){m();return}if(n.scrollIntoView({behavior:p,block:a,inline:"nearest"}),p==="auto"){w();return}let R=!1;const z=()=>{R||(R=!0,window.removeEventListener("scrollend",P),clearTimeout(u),w())},P=()=>z();"onscrollend"in window&&window.addEventListener("scrollend",P,{once:!0});const u=setTimeout(z,620)})}function Et(){C(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&K("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const r=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof r=="function"&&r({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function N(){C(),M(),c.settingsTourActive=!1,J();const t=O({blockPointer:!0,lockScroll:!0});t.style.background="rgba(17,24,39,0.42)";const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(e),document.body.style.overflow="hidden",typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{e.remove(),document.body.style.overflow=""};document.getElementById("activateNowBtn").onclick=()=>{o(),Gt()},document.getElementById("activateLaterBtn").onclick=()=>{o();const i=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');i&&K("bookings",i)}}function nt(){if(localStorage.getItem("settingsTourDone"))return;if(localStorage.getItem("settingsTourStep")==="handoff"){localStorage.removeItem("settingsTourStep"),N();return}localStorage.getItem("settingsTourDone")||localStorage.removeItem("settingsTourStep"),c.settingsTourActive=!0,J(),Ut();const t=document.querySelector('.tab[data-nav-filter="settings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="settings"]');t&&K("settings",t);function e(){if(typeof window.isEditPageDomReady=="function"&&window.isEditPageDomReady()||typeof isEditPageDomReady=="function"&&isEditPageDomReady()||!(typeof window.needsEditPageLoad=="function"&&window.needsEditPageLoad()||typeof needsEditPageLoad=="function"&&needsEditPageLoad())&&!c.editRoomsLoadPromise)return;const g=typeof window.invokeLoadEditRooms=="function"?window.invokeLoadEditRooms:typeof invokeLoadEditRooms=="function"?invokeLoadEditRooms:null;g&&g()}e();const o=[{target:"#tour-preview-btn",highlightSelector:"#tour-preview-btn",anchorSelector:"#tour-preview-btn",scrollTarget:"#tour-preview-btn",title:"Preview your booking page",text:"Open the exact page guests will use. It is safe to review before activation, so check the basics here first.",openAccordion:!1,tab:"settings",scrollToTop:!0,scrollToTopOnly:!0,forcePageTop:!0,scrollBlock:"start"},{target:"#tour-header-preview-card",highlightSelector:"#tour-header-preview-card",anchorSelector:"#tour-header-preview-card",scrollTarget:"#tour-header-preview-card",title:"Edit your booking page",text:"This page is the source of truth for your guest site. Update the hotel name, address, phone, policy, rooms, photos, and prices here.",openAccordion:!1,tab:"settings",scrollBlock:"nearest",scrollPadTop:80,scrollPadBottom:360,tooltipPosition:"below",tooltipGap:22},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo-placeholder, #editRoomsCards [data-tour-room-card="1"] .room-edit-photo',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',scrollTarget:'#editRoomsCards [data-tour-room-card="1"]',title:"Add room photos",text:"Use real room photos. A clear first photo makes the page feel legitimate and helps guests decide faster.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:80,scrollPadBottom:220},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',scrollTarget:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',title:"Edit room details",text:"Room name, description, guest count, amenities, and units all show on the booking page. Keep this short and accurate.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:80,scrollPadBottom:220,tooltipPosition:"below",tooltipGap:8,spotlightBackground:"#fff",spotlightBorderRadius:"0 0 20px 20px",spotlightBoxShadow:"none",spotlightOutline:"none",spotlightOutlineOffset:"0",fitPadTop:108},{target:"#tour-booking-link-card",highlightSelector:"#tour-booking-link-card",anchorSelector:"#tour-booking-link-card",scrollTarget:"#tour-booking-link-card",title:"Share your direct link",text:"This is the link to send guests, add to your website, and place on Google Business Profile. QR tools live here too.",openAccordion:!1,tab:"settings",scrollBlock:"start",scrollPadTop:80,scrollPadBottom:220},{target:"#tour-rates-card",highlightSelector:"#tour-rates-card",anchorSelector:"#tour-rates-card",scrollTarget:"#tour-rates-card",title:"Set your rates",text:"Set nightly, weekly, and monthly prices before you share the link. Guests book from these rates on your direct page.",openAccordion:!0,accordionCard:"#tour-rates-card",tab:"settings",scrollBlock:"center",scrollPadBottom:220,tooltipPosition:"below",tooltipGap:8},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",title:"Track revenue and payment status",text:"Revenue shows direct bookings, card status, and estimated OTA commission savings. Cards are verified, and you collect payment at check-in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,scrollBlock:"start",scrollPadTop:92,scrollPadBottom:220},{target:"",text:"",openAccordion:!1,tab:"apps",customModal:"guestAppsStory"}];let i=parseInt(localStorage.getItem("settingsTourStep")||"0",10);(!Number.isFinite(i)||i<0||i>=o.length)&&(i=0,localStorage.removeItem("settingsTourStep"));function r(u){C(u)}function n(){r(),localStorage.removeItem("settingsTourStep"),N()}function a(u,s){return!(!u||!s||u.customModal||s.customModal||u.tab!==s.tab||!u.target||!s.target)}function l(u,s){if(u.customModal){m(u,s);return}requestAnimationFrame(()=>m(u,s))}function p(u){const s=u||{};if(s.keepCurrentUi?document.body.style.overflow="":r(),i>=o.length){r(),localStorage.removeItem("settingsTourStep"),N();return}const g=o[i];if(g.tab==="revenue"&&!c.revenueEnabled){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}if(g.tab==="apps"&&!(isStandaloneApp()||c.frontdeskInstalled)&&g.target&&!g.target.includes("tour-fd-install")){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}if(g.customModal||O(),g.tab&&g.tab!==c.currentFilter){const h=document.querySelector(`.tab[data-nav-filter="${g.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${g.tab}"]`);if(h&&K(g.tab,h),g.tab==="apps"){const d=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof d=="function"&&d(!0)}l(g,s);return}l(g,s)}function m(u,s){const g=s||{};if(u.customModal==="homescreen"){g.keepCurrentUi&&r(),R();return}if(u.customModal===!0||u.customModal==="bookings"){g.keepCurrentUi&&r(),P();return}if(u.customModal==="availability"){g.keepCurrentUi&&r(),z();return}if(u.customModal==="finale"){g.keepCurrentUi&&r(),N();return}if(u.customModal==="guestAppsStory"){g.keepCurrentUi&&r(),Et();return}if(u.waitForVisible){const x=u.target.split(",").map(E=>E.trim());let f=0;const b=30;O();const v=c.settingsTourActive?60:200,k=()=>{if(f++,u.tab==="apps"){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}let E=null;for(const B of x)if(E=document.querySelector(B),E)break;if(E&&(u.openAccordion&&L(E,u),u.openAccordion||E.offsetParent!==null)){y(E,u,g);return}f<b?setTimeout(k,v):(i++,localStorage.setItem("settingsTourStep",String(i)),p())};k();return}function h(x){const f=x.target.split(",").map(b=>b.trim());for(const b of f){const v=document.querySelector(b);if(v&&!(!x.openAccordion&&v.offsetParent===null&&getComputedStyle(v).position!=="fixed"))return v}if(x.accordionCard){const b=document.querySelector(x.accordionCard);if(b)return b}return null}function d(x,f){const b=h(x);if(b){f(b);return}const v=x.tab==="settings"&&!x.customModal&&x.target,k=x.tab==="apps"&&!x.customModal&&x.target;if(!v&&!k){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}O();let E=0;if(v&&e(),k){const T=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof T=="function"&&T(!0)}const B=c.settingsTourActive?60:250,A=()=>{if(E++,k){const I=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof I=="function"&&I(!0)}const T=h(x);if(T){f(T);return}if(e(),k){const I=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof I=="function"&&I(!0)}E<48?setTimeout(A,B):(i++,localStorage.setItem("settingsTourStep",String(i)),p())};A()}d(u,x=>y(x,u,g))}function y(u,s,g){const h=g||{};if(L(u,s),u=H(u,s),(!u||!u.isConnected)&&(u=_(u,s),u&&(u=H(u,s))),!u){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}const d=u;O(),kt(d,s,{smooth:!!h.keepCurrentUi}).then(()=>{if(s.forcePageTop&&X("auto"),!d.isConnected){i++,localStorage.setItem("settingsTourStep",String(i)),p();return}L(d,s),h.keepCurrentUi&&(r({keepOverlay:!0}),O()),s.noHighlight||(d.dataset.tourOrigPosition||(d.dataset.tourOrigPosition=d.style.position||""),d.dataset.tourOrigZIndex||(d.dataset.tourOrigZIndex=d.style.zIndex||""),d.dataset.tourOrigIsolation||(d.dataset.tourOrigIsolation=d.style.isolation||""),d.dataset.tourOrigBoxShadow||(d.dataset.tourOrigBoxShadow=d.style.boxShadow||""),d.dataset.tourOrigOutline||(d.dataset.tourOrigOutline=d.style.outline||""),d.dataset.tourOrigOutlineOffset||(d.dataset.tourOrigOutlineOffset=d.style.outlineOffset||""),d.dataset.tourOrigTransition||(d.dataset.tourOrigTransition=d.style.transition||""),d.dataset.tourOrigBackground||(d.dataset.tourOrigBackground=d.style.background||""),d.dataset.tourOrigBackgroundColor||(d.dataset.tourOrigBackgroundColor=d.style.backgroundColor||""),d.dataset.tourOrigBorderRadius||(d.dataset.tourOrigBorderRadius=d.style.borderRadius||""),d.dataset.tourOrigOpacity||(d.dataset.tourOrigOpacity=d.style.opacity||""),d.style.position=d.style.position||"relative",d.style.zIndex="99999",d.style.isolation="isolate",d.style.transition="box-shadow 0.18s ease, outline 0.18s ease",d.style.boxShadow="0 0 0 1px rgba(255,255,255,0.92), 0 18px 46px rgba(26,43,34,0.22)",d.style.outline="1px solid rgba(255,255,255,0.82)",d.style.outlineOffset="2px",s.spotlightBoxShadow!=null&&(d.style.boxShadow=s.spotlightBoxShadow),s.spotlightOutline!=null&&(d.style.outline=s.spotlightOutline),s.spotlightOutlineOffset!=null&&(d.style.outlineOffset=s.spotlightOutlineOffset),s.spotlightBackground&&(d.style.background=s.spotlightBackground,d.style.backgroundColor=s.spotlightBackground),s.spotlightBorderRadius&&(d.style.borderRadius=s.spotlightBorderRadius),h.keepCurrentUi&&(d.style.opacity="0"),d.setAttribute("data-tour-highlighted","1"),vt(d,s)),document.body.style.overflow="hidden";const x=()=>{const v=$(s.anchorSelector)||d;if(s.freezeTooltip){const A=v&&v.isConnected?v.getBoundingClientRect():null;w(v,s,A&&A.width>=2?A:null,{fadeIn:!!h.keepCurrentUi});return}const k=_(d,s);let E=k?H(k,s):d;L(E,s);const B=s.tooltipAnchor?null:U(s,E);w(E||d,s,B,{fadeIn:!!h.keepCurrentUi})};if(s.freezeTooltip){requestAnimationFrame(()=>requestAnimationFrame(x));return}const f=(b=0)=>{requestAnimationFrame(()=>{if(s.forcePageTop&&X("auto"),s.tooltipAnchor){x();return}const v=_(d,s);let k=v?H(v,s):d;L(k,s);const E=U(s,k);if(!E&&b<4){requestAnimationFrame(()=>f(b+1));return}w(k||d,s,E,{fadeIn:!!h.keepCurrentUi})})};f(0)})}function w(u,s,g,h){const d=h||{},x=document.getElementById("tourTooltip");x&&x.remove(),M();const f=document.createElement("div");f.id="tourTooltip";const b=Math.min(i+1,o.length),v=Math.max(8,Math.min(100,Math.round(b/o.length*100))),k=ot(s.title||"Quick setup"),E=ot(s.text||""),B=s.primaryLabel||(i<o.length-1?"Next":"Got it"),A=i<=0;f.style.cssText="position:fixed;z-index:100000;left:12px;right:12px;bottom:calc(14px + env(safe-area-inset-bottom,0px));display:flex;justify-content:center;pointer-events:none;visibility:hidden;",f.innerHTML=`
      ...
      </div>`,document.body.appendChild(f);const T=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,I=Jt(s,T);let D=g;if(g&&g.width>=2&&g.height>=2){D=Zt(u,s,f,I)||g,s.noHighlight||vt(u,s);const V=Math.min(380,window.innerWidth-28);f.style.setProperty("--tour-width",`${V}px`),f.style.left="0",f.style.right="auto",f.style.bottom="auto",f.style.width=`${V}px`,f.style.justifyContent="flex-start",f.classList.add("tour-tooltip-floating");const ft=f.querySelector(".tour-panel"),xt=Math.min(ft&&ft.offsetHeight||f.offsetHeight||190,Math.max(140,window.innerHeight-28)),yt=s.tooltipGap??8,Ft=D.left+D.width/2,ht=Math.max(14,Math.min(Ft-V/2,window.innerWidth-V-14)),Dt=I!=="above"?D.bottom+yt:D.top-xt-yt,bt=Math.max(14,Math.min(Dt,window.innerHeight-xt-14));f.style.setProperty("--tour-left",`${ht}px`),f.style.setProperty("--tour-top",`${bt}px`),f.style.left=`${ht}px`,f.style.top=`${bt}px`}f.style.visibility="visible",d.fadeIn&&Qt(f),S()}function S(){const u=document.getElementById("tourNextBtn"),s=document.getElementById("tourSkipBtn"),g=b=>{if(b<0)return;const v=a(o[i],o[b]),k=()=>{i=b,localStorage.setItem("settingsTourStep",String(i)),p({keepCurrentUi:v})};if(!v){r(),k();return}_t().then(k)},h=()=>{g(i+1)},d=()=>{n()},x=()=>{i<=0||g(i-1)};u&&(u.onclick=h),s&&(s.onclick=d);const f=document.getElementById("tourBackBtn");f&&(f.onclick=x),Vt({onNext:h,onBack:x,onSkip:d})}function R(){M(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms();const u=document.createElement("div");u.id="tourBlurOverlay",u.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(u),document.body.style.overflow="hidden";const s=c.activeHotelName||"Your Hotel",g=s.trim().charAt(0).toUpperCase(),h=s.length>10?s.slice(0,10):s,d="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",x="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",f="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",b=`<div style="${d}"><div style="${x}background:rgba(255,255,255,0.22);"></div><div style="${f}"></div></div>`,v=c.activeHotelAppIcon||"",k=v?`<img src="${v}" alt="" style="width:100%;height:100%;object-fit:contain;">`:g,E=v?`${x}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${x}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,B=`<div style="${d}"><div style="${E}">${k}</div><div style="${f}font-size:7.5px;color:#fff;font-weight:700;">${h}</div></div>`,A=[b,b,b,b,B,b,b,b].join(""),T=document.createElement("div");if(T.id="tourTooltip",T.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",T.innerHTML=`
      ...
      </div>`,document.body.appendChild(T),!document.getElementById("tourModalAnimStyle")){const I=document.createElement("style");I.id="tourModalAnimStyle",I.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(I)}document.getElementById("tourNextBtn").onclick=()=>{r(),i++,localStorage.setItem("settingsTourStep",String(i)),p()},document.getElementById("tourSkipBtn").onclick=()=>{n()}}function z(){M();const u=document.createElement("div");u.id="tourBlurOverlay",u.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(u),document.body.style.overflow="hidden";let s=0;const g=[`<div style="padding:20px 18px 0;">
      ...
      <div style="padding:0 14px 14px;">
      ...
      </div>`],h=document.createElement("div");h.id="tourTooltip",h.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";function d(){const f=s>=g.length-1?"Next — Revenue →":"Next →";h.innerHTML=`
        ...
        </div>`,document.getElementById("tourNextBtn").onclick=()=>{s<g.length-1?(s++,d()):(r(),i++,localStorage.setItem("settingsTourStep",String(i)),p())},document.getElementById("tourSkipBtn").onclick=()=>{n()}}if(document.body.appendChild(h),d(),!document.getElementById("tourModalAnimStyle")){const x=document.createElement("style");x.id="tourModalAnimStyle",x.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(x)}}function P(){M();const u=document.createElement("div");u.id="tourBlurOverlay",u.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(u),document.body.style.overflow="hidden";const s=document.createElement("div");if(s.id="tourTooltip",s.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",s.innerHTML=`
      <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(s),!document.getElementById("tourModalAnimStyle")){const g=document.createElement("style");g.id="tourModalAnimStyle",g.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(g)}document.getElementById("tourNextBtn").onclick=()=>{r(),i++,localStorage.setItem("settingsTourStep",String(i)),p()},document.getElementById("tourSkipBtn").onclick=()=>{n()}}p()}async function Bt(){const t=document.getElementById("settingsList");if(t){t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const e=await api("GET","/api/crm/verify"),i="https://"+(e?.domain||c.activeHotelId+".mktel.co"),r="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(i),n=await api("GET","/api/crm/rooms");let a={nightly:69,weekly:299,monthly:999};n?.rates&&(a=n.rates);const l=n?.rooms||[];let p="";e?.subscribed||(p+=goLiveInlineCardHtml()),l.length?l.forEach(m=>{const y=m.images&&m.images.length>0;p+=`
    ...
    `,t.innerHTML=p}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function Xt(){const t=document.getElementById("settings-booking-url");t&&navigator.clipboard.writeText(t.value).then(()=>{localStorage.setItem("linkCopied","1"),j(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function te(){localStorage.setItem("settingsTourDone","1");const t=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",t);let e=0;const o=setInterval(()=>{e++;const i=document.getElementById("edit-rate-nightly");if(i||e>20){if(clearInterval(o),!i)return;const r=i.closest(".accordion-body");if(r&&r.style.display==="none"){r.style.display="block";const n=r.previousElementSibling?.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const n=document.getElementById("checklistPointer");n&&n.remove();const a=i.getBoundingClientRect(),l=document.createElement("div");l.id="checklistPointer",l.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${a.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,l.innerHTML=`
          ...
          `,document.body.appendChild(l),setTimeout(()=>{const p=document.getElementById("checklistPointer");p&&p.remove()},6e3)},1e3)},100)}},200)}function ee(){const e="https://"+(c.activeHotelDomain||c.activeHotelId+".mktel.co");navigator.clipboard.writeText(e).then(()=>{localStorage.setItem("linkCopied","1"),j(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function oe(t,e){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const r=setInterval(()=>{i++;const n=document.querySelector(t);if(n||i>20){if(clearInterval(r),!n)return;n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const l=n.getBoundingClientRect(),p=document.createElement("div");p.id="checklistPointer",p.style.cssText=`
