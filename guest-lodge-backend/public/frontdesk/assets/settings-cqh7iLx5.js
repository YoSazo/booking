const c={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let G=null;function Ce(){return typeof lucide<"u"?Promise.resolve():G||(G=new Promise((t,e)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>t(),o.onerror=()=>e(new Error("lucide load failed")),document.head.appendChild(o)}),G)}async function Ft(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let r=e.width,n=e.height;const a=Math.min(1,o/r,i/n);r=Math.round(r*a),n=Math.round(n*a);const l=document.createElement("canvas");l.width=r,l.height=n,l.getContext("2d").drawImage(e,0,0,r,n),e.close();const u=await new Promise((f,v)=>{l.toBlob(B=>B?f(B):v(new Error("encode failed")),"image/webp",.82)}),m=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([u],m+".webp",{type:"image/webp"})}catch{return t}}function Re(){const t=()=>{c.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}function Dt(t){Object.assign(window,t)}function L(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function _(...t){return L("setFilter")?.(...t)}function Ht(...t){return L("toast")?.(...t)}function Q(...t){return L("updateGoLiveBanner")?.(...t)}function Nt(...t){return L("seedTourRevenueShell")?.(...t)}function qt(...t){return L("finishTourHydration")?.(...t)}function jt(...t){return L("goLive")?.(...t)}let H=null;function O(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
  ...
  `,document.head.appendChild(t)}function ht(){H&&(document.removeEventListener("keydown",H),H=null)}function Ut(t){ht(),H=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",H)}function tt(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function R(t){O();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText=`position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.22);pointer-events:${e.blockPointer?"auto":"none"};`,document.body.appendChild(o),e.lockScroll&&(document.body.style.overflow="hidden"),o)}function Gt(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function Vt(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((r,n)=>{const a=i[n];a&&(r.type==="checkbox"||r.type==="radio"?a.checked=r.checked:a.value=r.value)})}function bt(t,e){const o=getComputedStyle(t);for(const n of o)e.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=t.children,r=e.children;for(let n=0;n<i.length;n+=1)r[n]&&bt(i[n],r[n])}function yt(t,e){if(!t||!t.isConnected)return null;document.querySelectorAll("[data-tour-spotlight-clone]").forEach(r=>r.remove());const o=t.getBoundingClientRect();if(o.width<2||o.height<2)return null;const i=t.cloneNode(!0);return Gt(i),bt(t,i),Vt(t,i),i.setAttribute("data-tour-spotlight-clone","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.left=`${o.left}px`,i.style.top=`${o.top}px`,i.style.width=`${o.width}px`,i.style.height=`${o.height}px`,i.style.margin="0",i.style.maxWidth="none",i.style.zIndex="99999",i.style.pointerEvents="none",i.style.transform="none",i.style.boxShadow=e?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",i.style.outline=e?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",i.style.outlineOffset=e?.spotlightOutlineOffset??"2px",e?.spotlightBackground&&(i.style.background=e.spotlightBackground,i.style.backgroundColor=e.spotlightBackground),e?.spotlightBorderRadius&&(i.style.borderRadius=e.spotlightBorderRadius),document.body.appendChild(i),i}function N(t){const e=t||{};ht();const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!e.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.background=n.dataset.tourOrigBackground||"",n.style.backgroundColor=n.dataset.tourOrigBackgroundColor||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius});const r=document.getElementById("goLiveBanner");r&&r.dataset.tourHidden&&(delete r.dataset.tourHidden,typeof Q=="function"&&Q()),e.keepOverlay||(document.body.style.overflow="")}function M(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function $(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function F(t,e){if(e.highlightSelector){const o=$(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function W(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const r=document.querySelector(i);if(r&&r.isConnected)return r}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function K(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function q(t,e){const o=$(t.anchorSelector);if(o){const i=K(o,!0);if(i)return i}return K(e,!0)}function Wt(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function et(t,e){if(!e)return;const o=Wt(t);if(o){o.scrollTop+=e;return}window.scrollBy({top:e,left:0,behavior:"auto"})}function Yt(t,e){return e&&t.mobileTooltipPosition||t.tooltipPosition||"below"}function _t(t,e,o,i){if(!t||!t.isConnected||!o)return q(e,t);const r=o.querySelector(".tour-panel"),n=Math.min(r&&r.offsetHeight||o.offsetHeight||190,Math.max(140,window.innerHeight-28)),a=e.tooltipGap??8,l=e.fitPadTop??e.scrollPadTop??72,u=window.innerHeight-(e.fitPadBottom??14),m=()=>q(e,t)||K(t,!0);let f=m();if(!f)return null;for(let v=0;v<3;v+=1){const B=Math.max(120,u-l),C=f.height+a+n<=B;let z=0;if(i==="above"){const A=f.top-a-n-l;A<0&&(z=A),C&&f.bottom>u&&(z=f.bottom-u)}else{const A=f.bottom+a+n-u;A>0&&(z=A),C&&f.top<l&&(z=f.top-l)}if(Math.abs(z)<1)break;if(et(t,z),f=m(),!f)return null}return f}function J(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const r=document.querySelector(i);r&&(r.scrollTop=0)})}function vt(t,e,o){const i=o||{},r=e.scrollTarget||e.accordionCard,n=(r?$(r):null)||t;if(!n&&!e.scrollToTop)return Promise.resolve();const a=e.scrollBlock||"center",l=window.matchMedia("(prefers-reduced-motion: reduce)").matches,u=i.smooth&&!l?"smooth":c.settingsTourActive||l?"auto":"smooth";return new Promise(m=>{const f=()=>{const p=e.scrollPadTop??80,d=e.scrollPadBottom??220,g=$(e.anchorSelector)||(n&&n.isConnected?n:null)||(t&&t.isConnected?t:null);if(!g){m();return}let h=g.getBoundingClientRect();h.top<p&&(et(g,h.top-p),h=g.getBoundingClientRect()),h.bottom>window.innerHeight-d&&et(g,h.bottom-window.innerHeight+d),requestAnimationFrame(()=>requestAnimationFrame(m))},v=()=>{n&&n.scrollIntoView({behavior:e.scrollToTop?"auto":u,block:a,inline:"nearest"}),f()};if(e.scrollToTop){if(J(u),e.scrollToTopOnly){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&J("auto"),m()}));return}if(u==="auto"){v();return}let p=!1;const d=()=>{p||(p=!0,window.removeEventListener("scrollend",g),clearTimeout(h),v())},g=()=>d();"onscrollend"in window&&window.addEventListener("scrollend",g,{once:!0});const h=setTimeout(d,520);return}if(!n){m();return}if(n.scrollIntoView({behavior:u,block:a,inline:"nearest"}),u==="auto"){f();return}let B=!1;const C=()=>{B||(B=!0,window.removeEventListener("scrollend",z),clearTimeout(A),f())},z=()=>C();"onscrollend"in window&&window.addEventListener("scrollend",z,{once:!0});const A=setTimeout(C,620)})}function wt(){N(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&_("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const r=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof r=="function"&&r({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function D(){N(),O(),c.settingsTourActive=!1,Q();const t=R({blockPointer:!0,lockScroll:!0});t.style.background="rgba(17,24,39,0.42)";const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),!document.getElementById("tourModalAnimStyle")){const o=document.createElement("style");o.id="tourModalAnimStyle",o.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(o)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("tourNextBtn").onclick=()=>{const i="https://"+(c.activeHotelDomain||c.activeHotelId+".mktel.co");navigator.clipboard.writeText(i).catch(()=>{}),N(),c.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.setItem("linkCopied","1"),localStorage.removeItem("settingsTourStep"),Ht("Booking link copied!","success"),qt(),kt()}}function kt(t){O();const e=document.createElement("div");e.id="testDriveOverlay",e.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(e),document.body.style.overflow="hidden",typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{e.remove(),document.body.style.overflow=""};document.getElementById("activateNowBtn").onclick=()=>{o(),jt()},document.getElementById("activateLaterBtn").onclick=()=>{o();const i=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');i&&_("bookings",i)}}function ot(){if(localStorage.getItem("settingsTourDone"))return;if(localStorage.getItem("settingsTourStep")==="handoff"){localStorage.removeItem("settingsTourStep"),D();return}localStorage.getItem("settingsTourDone")||localStorage.removeItem("settingsTourStep"),c.settingsTourActive=!0,Q(),Nt();const t=document.querySelector('.tab[data-nav-filter="settings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="settings"]');t&&_("settings",t);function e(){if(typeof window.isEditPageDomReady=="function"&&window.isEditPageDomReady()||typeof isEditPageDomReady=="function"&&isEditPageDomReady()||!(typeof window.needsEditPageLoad=="function"&&window.needsEditPageLoad()||typeof needsEditPageLoad=="function"&&needsEditPageLoad())&&!c.editRoomsLoadPromise)return;const g=typeof window.invokeLoadEditRooms=="function"?window.invokeLoadEditRooms:typeof invokeLoadEditRooms=="function"?invokeLoadEditRooms:null;g&&g()}e();const o=[{target:"#tour-preview-btn",highlightSelector:"#tour-preview-btn",anchorSelector:"#tour-preview-btn",scrollTarget:"#tour-preview-btn",title:"Preview your booking page",text:"Open the exact page guests will use. It is safe to review before activation, so check the basics here first.",openAccordion:!1,tab:"settings",scrollToTop:!0,scrollToTopOnly:!0,forcePageTop:!0,scrollBlock:"start"},{target:"#tour-header-preview-card",highlightSelector:"#tour-header-preview-card",anchorSelector:"#tour-header-preview-card",scrollTarget:"#tour-header-preview-card",title:"Edit your booking page",text:"This page is the source of truth for your guest site. Update the hotel name, address, phone, policy, rooms, photos, and prices here.",openAccordion:!1,tab:"settings",scrollBlock:"nearest",scrollPadTop:80,scrollPadBottom:360,tooltipPosition:"below",tooltipGap:22},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo-placeholder, #editRoomsCards [data-tour-room-card="1"] .room-edit-photo',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',scrollTarget:'#editRoomsCards [data-tour-room-card="1"]',title:"Add room photos",text:"Use real room photos. A clear first photo makes the page feel legitimate and helps guests decide faster.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:80,scrollPadBottom:220},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',scrollTarget:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',title:"Edit room details",text:"Room name, description, guest count, amenities, and units all show on the booking page. Keep this short and accurate.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:80,scrollPadBottom:220,tooltipPosition:"below",tooltipGap:8,spotlightBackground:"#fff",spotlightBorderRadius:"0 0 20px 20px",spotlightBoxShadow:"none",spotlightOutline:"none",spotlightOutlineOffset:"0",fitPadTop:108},{target:"#tour-booking-link-card",highlightSelector:"#tour-booking-link-card",anchorSelector:"#tour-booking-link-card",scrollTarget:"#tour-booking-link-card",title:"Share your direct link",text:"This is the link to send guests, add to your website, and place on Google Business Profile. QR tools live here too.",openAccordion:!1,tab:"settings",scrollBlock:"start",scrollPadTop:80,scrollPadBottom:220},{target:"#tour-rates-card",highlightSelector:"#tour-rates-card",anchorSelector:"#tour-rates-card",scrollTarget:"#tour-rates-card",title:"Set your rates",text:"Set nightly, weekly, and monthly prices before you share the link. Guests book from these rates on your direct page.",openAccordion:!0,accordionCard:"#tour-rates-card",tab:"settings",scrollBlock:"center",scrollPadBottom:220,tooltipPosition:"below",tooltipGap:8},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",title:"Track revenue and payment status",text:"Revenue shows direct bookings, card status, and estimated OTA commission savings. Cards are verified, and you collect payment at check-in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,scrollBlock:"start",scrollPadTop:92,scrollPadBottom:220},{target:"",text:"",openAccordion:!1,tab:"apps",customModal:"guestAppsStory"}];let i=parseInt(localStorage.getItem("settingsTourStep")||"0",10);(!Number.isFinite(i)||i<0||i>=o.length)&&(i=0,localStorage.removeItem("settingsTourStep"));function r(p){N(p)}function n(){r(),localStorage.removeItem("settingsTourStep"),D()}function a(p,d){return!(!p||!d||p.customModal||d.customModal||p.tab!==d.tab||!p.target||!d.target)}function l(p,d){if(p.customModal){m(p,d);return}requestAnimationFrame(()=>m(p,d))}function u(p){const d=p||{};if(d.keepCurrentUi?document.body.style.overflow="":r(),i>=o.length){r(),localStorage.removeItem("settingsTourStep"),D();return}const g=o[i];if(g.tab==="revenue"&&!c.revenueEnabled){i++,localStorage.setItem("settingsTourStep",String(i)),u();return}if(g.tab==="apps"&&!(isStandaloneApp()||c.frontdeskInstalled)&&g.target&&!g.target.includes("tour-fd-install")){i++,localStorage.setItem("settingsTourStep",String(i)),u();return}if(g.customModal||R(),g.tab&&g.tab!==c.currentFilter){const h=document.querySelector(`.tab[data-nav-filter="${g.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${g.tab}"]`);if(h&&_(g.tab,h),g.tab==="apps"){const s=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof s=="function"&&s(!0)}l(g,d);return}l(g,d)}function m(p,d){const g=d||{};if(p.customModal==="homescreen"){g.keepCurrentUi&&r(),C();return}if(p.customModal===!0||p.customModal==="bookings"){g.keepCurrentUi&&r(),A();return}if(p.customModal==="availability"){g.keepCurrentUi&&r(),z();return}if(p.customModal==="finale"){g.keepCurrentUi&&r(),D();return}if(p.customModal==="guestAppsStory"){g.keepCurrentUi&&r(),wt();return}if(p.waitForVisible){const x=p.target.split(",").map(w=>w.trim());let E=0;const y=30;R();const b=c.settingsTourActive?60:200,k=()=>{if(E++,p.tab==="apps"){const I=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof I=="function"&&I(!0)}let w=null;for(const I of x)if(w=document.querySelector(I),w)break;if(w&&(p.openAccordion&&M(w,p),p.openAccordion||w.offsetParent!==null)){f(w,p,g);return}E<y?setTimeout(k,b):(i++,localStorage.setItem("settingsTourStep",String(i)),u())};k();return}function h(x){const E=x.target.split(",").map(y=>y.trim());for(const y of E){const b=document.querySelector(y);if(b&&!(!x.openAccordion&&b.offsetParent===null&&getComputedStyle(b).position!=="fixed"))return b}if(x.accordionCard){const y=document.querySelector(x.accordionCard);if(y)return y}return null}function s(x,E){const y=h(x);if(y){E(y);return}const b=x.tab==="settings"&&!x.customModal&&x.target,k=x.tab==="apps"&&!x.customModal&&x.target;if(!b&&!k){i++,localStorage.setItem("settingsTourStep",String(i)),u();return}R();let w=0;if(b&&e(),k){const S=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof S=="function"&&S(!0)}const I=c.settingsTourActive?60:250,P=()=>{if(w++,k){const T=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof T=="function"&&T(!0)}const S=h(x);if(S){E(S);return}if(e(),k){const T=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof T=="function"&&T(!0)}w<48?setTimeout(P,I):(i++,localStorage.setItem("settingsTourStep",String(i)),u())};P()}s(p,x=>f(x,p,g))}function f(p,d,g){const h=g||{};if(M(p,d),p=F(p,d),(!p||!p.isConnected)&&(p=W(p,d),p&&(p=F(p,d))),!p){i++,localStorage.setItem("settingsTourStep",String(i)),u();return}const s=p;R(),vt(s,d,{smooth:!!h.keepCurrentUi}).then(()=>{if(d.forcePageTop&&J("auto"),!s.isConnected){i++,localStorage.setItem("settingsTourStep",String(i)),u();return}M(s,d),h.keepCurrentUi&&(r({keepOverlay:!0}),R()),d.noHighlight||(s.dataset.tourOrigPosition||(s.dataset.tourOrigPosition=s.style.position||""),s.dataset.tourOrigZIndex||(s.dataset.tourOrigZIndex=s.style.zIndex||""),s.dataset.tourOrigIsolation||(s.dataset.tourOrigIsolation=s.style.isolation||""),s.dataset.tourOrigBoxShadow||(s.dataset.tourOrigBoxShadow=s.style.boxShadow||""),s.dataset.tourOrigOutline||(s.dataset.tourOrigOutline=s.style.outline||""),s.dataset.tourOrigOutlineOffset||(s.dataset.tourOrigOutlineOffset=s.style.outlineOffset||""),s.dataset.tourOrigTransition||(s.dataset.tourOrigTransition=s.style.transition||""),s.dataset.tourOrigBackground||(s.dataset.tourOrigBackground=s.style.background||""),s.dataset.tourOrigBackgroundColor||(s.dataset.tourOrigBackgroundColor=s.style.backgroundColor||""),s.dataset.tourOrigBorderRadius||(s.dataset.tourOrigBorderRadius=s.style.borderRadius||""),s.style.position=s.style.position||"relative",s.style.zIndex="99999",s.style.isolation="isolate",s.style.transition="box-shadow 0.18s ease, outline 0.18s ease",s.style.boxShadow="0 0 0 1px rgba(255,255,255,0.92), 0 18px 46px rgba(26,43,34,0.22)",s.style.outline="1px solid rgba(255,255,255,0.82)",s.style.outlineOffset="2px",d.spotlightBoxShadow!=null&&(s.style.boxShadow=d.spotlightBoxShadow),d.spotlightOutline!=null&&(s.style.outline=d.spotlightOutline),d.spotlightOutlineOffset!=null&&(s.style.outlineOffset=d.spotlightOutlineOffset),d.spotlightBackground&&(s.style.background=d.spotlightBackground,s.style.backgroundColor=d.spotlightBackground),d.spotlightBorderRadius&&(s.style.borderRadius=d.spotlightBorderRadius),s.setAttribute("data-tour-highlighted","1"),yt(s,d)),document.body.style.overflow="hidden";const x=()=>{const b=$(d.anchorSelector)||s;if(d.freezeTooltip){const P=b&&b.isConnected?b.getBoundingClientRect():null;v(b,d,P&&P.width>=2?P:null);return}const k=W(s,d);let w=k?F(k,d):s;M(w,d);const I=d.tooltipAnchor?null:q(d,w);v(w||s,d,I)};if(d.freezeTooltip){requestAnimationFrame(()=>requestAnimationFrame(x));return}const E=(y=0)=>{requestAnimationFrame(()=>{if(d.forcePageTop&&J("auto"),d.tooltipAnchor){x();return}const b=W(s,d);let k=b?F(b,d):s;M(k,d);const w=q(d,k);if(!w&&y<4){requestAnimationFrame(()=>E(y+1));return}v(k||s,d,w)})};E(0)})}function v(p,d,g){const h=document.getElementById("tourTooltip");h&&h.remove(),O();const s=document.createElement("div");s.id="tourTooltip";const x=Math.min(i+1,o.length),E=Math.max(8,Math.min(100,Math.round(x/o.length*100))),y=tt(d.title||"Quick setup"),b=tt(d.text||""),k=d.primaryLabel||(i<o.length-1?"Next":"Got it"),w=i<=0;s.style.cssText="position:fixed;z-index:100000;left:12px;right:12px;bottom:calc(14px + env(safe-area-inset-bottom,0px));display:flex;justify-content:center;pointer-events:none;visibility:hidden;",s.innerHTML=`
      <div class="tour-panel" role="dialog" aria-live="polite" aria-label="${y}">
        <div class="tour-progress-row">
          <div class="tour-progress-label">${x} of ${o.length}</div>
          <div class="tour-progress-track">
            <div class="tour-progress-fill" style="width:${E}%;"></div>
          </div>
        </div>
        <div class="tour-title">${y}</div>
        <p class="tour-copy">${b}</p>
        <div class="tour-actions">
          <button id="tourBackBtn" class="tour-btn" type="button" ${w?"disabled":""}>Back</button>
          <button id="tourSkipBtn" class="tour-btn tour-btn-ghost" type="button">Skip</button>
          <button id="tourNextBtn" class="tour-btn tour-btn-primary" type="button">${tt(k)}</button>
        </div>
      </div>`,document.body.appendChild(s);const I=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,P=Yt(d,I);let S=g;if(g&&g.width>=2&&g.height>=2){S=_t(p,d,s,P)||g,d.noHighlight||yt(p,d);const T=Math.min(380,window.innerWidth-28);s.style.setProperty("--tour-width",`${T}px`),s.style.left="0",s.style.right="auto",s.style.bottom="auto",s.style.width=`${T}px`,s.style.justifyContent="flex-start",s.classList.add("tour-tooltip-floating");const ut=s.querySelector(".tour-panel"),gt=Math.min(ut&&ut.offsetHeight||s.offsetHeight||190,Math.max(140,window.innerHeight-28)),mt=d.tooltipGap??8,$t=S.left+S.width/2,ft=Math.max(14,Math.min($t-T/2,window.innerWidth-T-14)),Lt=P!=="above"?S.bottom+mt:S.top-gt-mt,xt=Math.max(14,Math.min(Lt,window.innerHeight-gt-14));s.style.setProperty("--tour-left",`${ft}px`),s.style.setProperty("--tour-top",`${xt}px`),s.style.left=`${ft}px`,s.style.top=`${xt}px`}s.style.visibility="visible",B()}function B(){const p=document.getElementById("tourNextBtn"),d=document.getElementById("tourSkipBtn"),g=y=>{if(y<0)return;const b=a(o[i],o[y]);if(!b)r();else{const k=document.querySelector("#tourTooltip .tour-panel");k&&(k.style.pointerEvents="none")}i=y,localStorage.setItem("settingsTourStep",String(i)),u({keepCurrentUi:b})},h=()=>{g(i+1)},s=()=>{n()},x=()=>{i<=0||g(i-1)};p&&(p.onclick=h),d&&(d.onclick=s);const E=document.getElementById("tourBackBtn");E&&(E.onclick=x),Ut({onNext:h,onBack:x,onSkip:s})}function C(){O(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms();const p=document.createElement("div");p.id="tourBlurOverlay",p.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(p),document.body.style.overflow="hidden";const d=c.activeHotelName||"Your Hotel",g=d.trim().charAt(0).toUpperCase(),h=d.length>10?d.slice(0,10):d,s="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",x="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",E="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",y=`<div style="${s}"><div style="${x}background:rgba(255,255,255,0.22);"></div><div style="${E}"></div></div>`,b=c.activeHotelAppIcon||"",k=b?`<img src="${b}" alt="" style="width:100%;height:100%;object-fit:contain;">`:g,w=b?`${x}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${x}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,I=`<div style="${s}"><div style="${w}">${k}</div><div style="${E}font-size:7.5px;color:#fff;font-weight:700;">${h}</div></div>`,P=[y,y,y,y,I,y,y,y].join(""),S=document.createElement("div");if(S.id="tourTooltip",S.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",S.innerHTML=`
      ...
      </div>`,document.body.appendChild(S),!document.getElementById("tourModalAnimStyle")){const T=document.createElement("style");T.id="tourModalAnimStyle",T.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(T)}document.getElementById("tourNextBtn").onclick=()=>{r(),i++,localStorage.setItem("settingsTourStep",String(i)),u()},document.getElementById("tourSkipBtn").onclick=()=>{n()}}function z(){O();const p=document.createElement("div");p.id="tourBlurOverlay",p.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(p),document.body.style.overflow="hidden";let d=0;const g=[`<div style="padding:20px 18px 0;">
      ...
      <div style="padding:0 14px 14px;">
      ...
      </div>`],h=document.createElement("div");h.id="tourTooltip",h.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";function s(){const E=d>=g.length-1?"Next — Revenue →":"Next →";h.innerHTML=`
        <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
          ...
          <div style="padding:4px 18px 6px;text-align:center;">
            <div style="display:flex;justify-content:center;gap:6px;margin-bottom:10px;">
              ${g.map((y,b)=>`<div style="width:8px;height:8px;border-radius:50%;background:${b===d?"#2E7D5B":"#D8E4DC"};"></div>`).join("")}
            </div>
          </div>
          <div style="padding:0 18px 20px;text-align:center;">
            <button id="tourNextBtn" style="width:100%;padding:14px 20px;border-radius:12px;border:none;background:#2E7D5B;color:white;font-family:inherit;font-size:14px;font-weight:700;cursor:pointer;">${E}</button>
        ...
        </div>`,document.getElementById("tourNextBtn").onclick=()=>{d<g.length-1?(d++,s()):(r(),i++,localStorage.setItem("settingsTourStep",String(i)),u())},document.getElementById("tourSkipBtn").onclick=()=>{n()}}if(document.body.appendChild(h),s(),!document.getElementById("tourModalAnimStyle")){const x=document.createElement("style");x.id="tourModalAnimStyle",x.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(x)}}function A(){O();const p=document.createElement("div");p.id="tourBlurOverlay",p.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(p),document.body.style.overflow="hidden";const d=document.createElement("div");if(d.id="tourTooltip",d.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",d.innerHTML=`
      <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(d),!document.getElementById("tourModalAnimStyle")){const g=document.createElement("style");g.id="tourModalAnimStyle",g.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(g)}document.getElementById("tourNextBtn").onclick=()=>{r(),i++,localStorage.setItem("settingsTourStep",String(i)),u()},document.getElementById("tourSkipBtn").onclick=()=>{n()}}u()}async function Et(){const t=document.getElementById("settingsList");if(t){t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const e=await api("GET","/api/crm/verify"),i="https://"+(e?.domain||c.activeHotelId+".mktel.co"),r="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(i),n=await api("GET","/api/crm/rooms");let a={nightly:69,weekly:299,monthly:999};n?.rates&&(a=n.rates);const l=n?.rooms||[];let u="";e?.subscribed||(u+=goLiveInlineCardHtml()),l.length?l.forEach(m=>{const f=m.images&&m.images.length>0;u+=`
    ...
    `,t.innerHTML=u}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function Qt(){const t=document.getElementById("settings-booking-url");t&&navigator.clipboard.writeText(t.value).then(()=>{localStorage.setItem("linkCopied","1"),j(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function Kt(){localStorage.setItem("settingsTourDone","1");const t=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",t);let e=0;const o=setInterval(()=>{e++;const i=document.getElementById("edit-rate-nightly");if(i||e>20){if(clearInterval(o),!i)return;const r=i.closest(".accordion-body");if(r&&r.style.display==="none"){r.style.display="block";const n=r.previousElementSibling?.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const n=document.getElementById("checklistPointer");n&&n.remove();const a=i.getBoundingClientRect(),l=document.createElement("div");l.id="checklistPointer",l.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${a.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,l.innerHTML=`
          ...
          `,document.body.appendChild(l),setTimeout(()=>{const u=document.getElementById("checklistPointer");u&&u.remove()},6e3)},1e3)},100)}},200)}function Jt(){const e="https://"+(c.activeHotelDomain||c.activeHotelId+".mktel.co");navigator.clipboard.writeText(e).then(()=>{localStorage.setItem("linkCopied","1"),j(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function Zt(t,e){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const r=setInterval(()=>{i++;const n=document.querySelector(t);if(n||i>20){if(clearInterval(r),!n)return;n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const l=n.getBoundingClientRect(),u=document.createElement("div");u.id="checklistPointer",u.style.cssText=`
        ...
        `,document.body.appendChild(u),setTimeout(()=>{const m=document.getElementById("checklistPointer");m&&m.remove()},6e3)},1e3)}},200)}function rt(){const t=String(c.token||localStorage.getItem("crmToken")||"").trim();return t&&(c.token=t),t}async function at(t,e){const o=rt();if(!o)throw new Error("Not logged in");const i=await Ft(e),r=new FormData;r.append("image",i,i.name||"room.webp");const n=new URLSearchParams;c.activeHotelId&&n.set("hotelId",c.activeHotelId),n.set("token",o);const a=await fetch(`/api/crm/rooms/${t}/images?${n}`,{method:"POST",headers:{"x-crm-token":o},body:r}),l=await a.json().catch(()=>({}));if(!a.ok||!l.success)throw new Error(l.message||l.error||`Upload failed (${a.status})`);return l}async function Xt(t,e){const o=t.target.files[0];if(o)try{await at(e,o),toast("Photo uploaded!","success"),Et()}catch(i){toast(i.message||"Upload failed","error")}}async function te(){const t=parseFloat(document.getElementById("settings-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("settings-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("settings-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),toast("Rates saved","success")}catch{toast("Failed to save rates","error")}}async function ee(){const t=document.getElementById("settings-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");c.token=t,c.isMasterPin=!1;try{localStorage.setItem("crmToken",c.token)}catch{}toast("PIN updated!","success"),document.getElementById("settings-new-pin").value=""}catch(e){toast(e.message||"Failed to change PIN","error")}}async function oe(){const t=document.getElementById("settings-support-msg")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),toast("Message sent!","success"),document.getElementById("settings-support-msg").value=""}catch{toast("Failed to send","error")}}function ie(){const t=c.activeHotelDomain||c.activeHotelId+".mktel.co",o=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://localhost:5173/?hotelId="+encodeURIComponent(c.activeHotelId)+"&preview=1":"https://"+t+"?preview=1";window.open(o,"_blank")}function St(){if((window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&c.activeHotelId)return"http://localhost:5173/?hotelId="+encodeURIComponent(c.activeHotelId);const e=c.activeHotelDomain||"";return e?"https://"+e+"/":""}function ne(){const t=St();if(!t){toast("Your booking domain is still setting up.","info");return}window.open(t,"_blank")}function re(){const t=document.getElementById("previewSiteBar");t&&(t.style.display=c.currentFilter==="settings"?"block":"none")}function j(){if(localStorage.getItem("settingsTourDone"))return;const t=parseInt(localStorage.getItem("settingsTourStep")||"0"),e=c.editRooms.some(a=>a.images&&a.images.length>0),o=!!localStorage.getItem("ratesChanged"),i=!!localStorage.getItem("linkCopied");t===2&&e&&localStorage.setItem("settingsTourStep","3"),t===3&&i&&localStorage.setItem("settingsTourStep","4"),t===4&&o&&localStorage.setItem("settingsTourStep","5");const r=document.getElementById("tourTooltip");r&&r.remove();const n=document.getElementById("tourBlurOverlay");n&&n.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(a=>{a.style.position=a.dataset.tourOrigPosition||"",a.style.zIndex="",a.style.isolation="",a.style.boxShadow="",a.style.outline=a.dataset.tourOrigOutline||"",a.style.outlineOffset=a.dataset.tourOrigOutlineOffset||"",a.removeAttribute("data-tour-highlighted"),delete a.dataset.tourOrigPosition,delete a.dataset.tourOrigOutline,delete a.dataset.tourOrigOutlineOffset}),document.body.style.overflow=""}function ae(){let t=0;const e={},o=[{title:"Why do you want a booking page?",key:"why",type:"text",placeholder:"e.g. I want guests to book directly instead of calling me..."},{title:"How do guests currently book with you?",key:"currentBooking",type:"choice",options:[{label:"They call me or walk in",value:"phone_walkin"},{label:"Through Booking.com / Expedia",value:"ota"},{label:"I have a website but no booking system",value:"website_no_booking"},{label:"I don't take bookings online yet",value:"no_online"}]},{title:"How many rooms do you have?",key:"roomCount",type:"choice",options:[{label:"1–5 rooms",value:"1-5"},{label:"6–15 rooms",value:"6-15"},{label:"16–50 rooms",value:"16-50"},{label:"50+ rooms",value:"50+"}]},{title:"What's most important to you?",key:"priority",type:"choice",options:[{label:"Stop paying OTA commissions",value:"no_commission"},{label:"Get more direct bookings",value:"more_bookings"},{label:"Have a professional online presence",value:"professional"},{label:"Make it easier for guests to book",value:"easier_booking"}]}];function i(){let r=document.getElementById("onboardingOverlay");if(r&&r.remove(),t>=o.length){localStorage.setItem("onboardingDone","1");try{api("POST","/api/crm/onboarding-answers",e).catch(()=>{})}catch{}Bt();return}const n=o[t],a=document.createElement("div");a.id="onboardingOverlay",a.style.cssText="position:fixed;inset:0;z-index:100001;background:linear-gradient(135deg, #1a2b22 0%, #2E7D5B 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;",n.type==="text"?(a.innerHTML=`
      ...
      `,document.body.appendChild(a),document.getElementById("onboardingTextSubmit").onclick=()=>{const l=document.getElementById("onboardingTextInput").value.trim();l&&(e[n.key]=l,t++,i())}):(a.innerHTML=`
        <div style="max-width:360px;width:100%;text-align:center;">
          <div style="font-size:12px;color:rgba(255,255,255,0.6);margin-bottom:8px;">Question ${t+1} of ${o.length}</div>
          <h2 style="font-size:20px;font-weight:700;color:white;margin:0 0 24px;line-height:1.3;">${n.title}</h2>
          <div style="display:flex;flex-direction:column;gap:10px;">
      ...
      `,document.body.appendChild(a),a.querySelectorAll(".onboarding-opt").forEach(l=>{l.addEventListener("click",()=>{e[n.key]=l.dataset.value,l.style.background="#1a1a2e",l.style.color="white",l.style.fontWeight="600",setTimeout(()=>{t++,i()},250)})}))}i()}function se(){["onboardingDone","settingsTourDone","settingsTourStep","linkCopied","ratesChanged","appsTourDone","postActivationTourDone"].forEach(o=>{localStorage.removeItem(o)});const t=new URL(window.location.href);t.searchParams.set("welcome","1"),t.searchParams.delete("tab");const e=t.pathname+t.search+t.hash;if(e===window.location.pathname+window.location.search+window.location.hash){window.location.reload();return}window.location.assign(e)}function Bt(){const t=document.createElement("div");t.id="welcomeModalOverlay",t.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.72);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;padding:24px;";function e(){localStorage.setItem("onboardingDone","1"),localStorage.removeItem("settingsTourDone"),localStorage.removeItem("settingsTourStep");try{const r=new URL(window.location);r.searchParams.delete("welcome"),window.history.replaceState({},"",r)}catch{}const i=typeof ot=="function"?ot:typeof window.startSettingsTour=="function"?window.startSettingsTour:null;i&&i(),t.remove()}function o(){t.innerHTML=`
      <div style="background:white;border-radius:20px;padding:28px 24px;max-width:340px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.2);">
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=e}document.body.appendChild(t),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function Z(){const t=document.getElementById("postActivationTourTooltip");t&&t.remove();const e=document.getElementById("postActivationTourOverlay");e&&e.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function Y(){Z(),localStorage.setItem("postActivationTourDone","1");const t=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",t)}catch{}}function st(){if(localStorage.getItem("postActivationTourDone")){Y();return}Z();const t=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. You'll get a push alert for each new one."},{tab:"apps",navFilter:"apps",text:"<strong>Guest App</strong> — put your hotel on guests&apos; home screens and send install reminders."}];let e=0;function o(){if(Z(),e>=t.length){Y();return}const i=t[e],r=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);r&&setFilter(i.tab,r);const n=document.createElement("div");n.id="postActivationTourOverlay",n.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(n),document.body.style.overflow="hidden",setTimeout(()=>{const a=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);a&&(a.setAttribute("data-post-activation-highlight","1"),a.style.position="relative",a.style.zIndex="100003",a.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",a.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const l=a?a.getBoundingClientRect():{left:24,bottom:80,width:200},u=document.createElement("div");u.id="postActivationTourTooltip";const m=Math.min(300,window.innerWidth-32),f=Math.max(16,Math.min(l.left+l.width/2-m/2,window.innerWidth-m-16)),v=Math.min(l.bottom+14,window.innerHeight-180);u.style.cssText=`position:fixed;z-index:100004;left:${f}px;top:${v}px;max-width:${m}px;width:${m}px;`;const B=e>=t.length-1;u.innerHTML=`
        <div style="background:#1a1a2e;border-radius:12px;padding:16px 18px;color:#fff;font-size:13px;line-height:1.55;box-shadow:0 8px 32px rgba(0,0,0,0.35);">
          ...
          <button type="button" id="postActivationTourNext" style="width:100%;padding:12px;border-radius:10px;border:none;background:#2E7D5B;color:#fff;font-family:inherit;font-size:14px;font-weight:700;cursor:pointer;">${B?"Got it — open Guest App":"Next tab →"}</button>
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),st()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}async function dt(){if(isEditPageDomReady())return;if(c.editRoomsLoadPromise)return c.editRoomsLoadPromise;const t=document.getElementById("editRoomsList");if(t){c.editRoomsLoadPromise=(async()=>{t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[e,o]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify")]);if(!e.rooms)throw new Error("No data");c.editRooms=e.rooms;const i=o?.hotelName||"";i&&(c.activeHotelName=i),o&&(c.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const r=o?.hotelSubtitle||"",n=o?.hotelAddress||"",a=o?.hotelPhone||"",l=o?.appIconUrl||"";c.activeHotelAppIcon=l,updateFrontdeskManifestLink();let u={nightly:69,weekly:299,monthly:999,taxRate:.1};e.rates&&(u=e.rates);const f="https://"+(o?.domain||c.activeHotelId+".mktel.co"),v="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(f);let B=`
    ...
    `;t.innerHTML=B,U(),typeof lucide<"u"&&lucide.createIcons()}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load your page</div><div class="empty-sub">Check your connection and refresh.</div></div>'}})();try{await c.editRoomsLoadPromise}finally{c.editRoomsLoadPromise=null}}}function lt(){U()}function U(){const t=document.getElementById("editRoomsCards");if(t){if(!c.editRooms.length){t.innerHTML='<div class="empty-state"><div class="empty-icon">🛏️</div><div class="empty-text">No rooms yet</div><div class="empty-sub">Add your first room type below.</div></div>';return}t.innerHTML=c.editRooms.map((e,o)=>{const i=(e.amenities||"").split("•").map(a=>a.trim()).filter(Boolean),r=(e.images||[]).filter(a=>a&&a.url),n=jsStr(e.id);return`
        ...
        ${r.length?`
          ...
          ${r.length>1?`
            ...
            <div class="room-edit-image-dots">
              ${r.map((a,l)=>`<button type="button" class="room-edit-image-dot ${l===0?"active":""}" aria-label="Show photo ${l+1}" ${l===0?'aria-current="true"':""} onclick="event.stopPropagation();showEditRoomPhoto('${n}', ${l})"></button>`).join("")}
            </div>`:""}
      ...
      <div class="room-edit-fields" style="padding:18px;">
        ...
        <div style="margin-bottom:12px;">
          ...
          <div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:8px;" id="edit-amenity-pills-${e.id}">
            ${i.map(a=>`<span style="display:inline-flex;align-items:center;gap:4px;background:var(--green-pale);color:var(--green);padding:5px 10px;border-radius:8px;font-size:12px;font-weight:600;">${zt(a)} ${a} <button onclick="removeAmenity('${e.id}','${a.replace(/'/g,"\\'")}')" style="background:none;border:none;color:var(--green);cursor:pointer;font-size:14px;margin-left:2px;">×</button></span>`).join("")}
          </div>
    ...
    </div>`}).join(""),typeof lucide<"u"&&lucide.createIcons()}}function Tt(t){const e=c.editRooms.find(o=>String(o.id)===String(t));return(e&&e.images||[]).filter(o=>o&&o.url)}function It(t,e){const o=Tt(t);if(!o.length)return;const i=document.getElementById("edit-card-"+t);if(!i)return;const r=o.length,n=((Number(e)||0)%r+r)%r,a=i.querySelector(".room-edit-main-img");a&&(a.src=o[n].url),i.querySelector(".room-edit-photo")?.setAttribute("data-photo-index",String(n));const l=i.querySelector(".room-edit-photo-count");l&&(l.textContent=n+1+" / "+r),i.querySelectorAll(".room-edit-image-dot").forEach((u,m)=>{u.classList.toggle("active",m===n),m===n?u.setAttribute("aria-current","true"):u.removeAttribute("aria-current")}),i.querySelectorAll(".room-edit-thumb").forEach((u,m)=>{u.classList.toggle("active",m===n),m===n?u.setAttribute("aria-current","true"):u.removeAttribute("aria-current")})}function le(t,e){const i=document.getElementById("edit-card-"+t)?.querySelector(".room-edit-photo"),r=parseInt(i?.getAttribute("data-photo-index")||"0",10)||0;It(t,r+e)}function zt(t){const e=t.toLowerCase();return e.includes("wifi")?'<i data-lucide="wifi" style="width:14px;height:14px;"></i>':e.includes("tv")||e.includes("television")?'<i data-lucide="tv" style="width:14px;height:14px;"></i>':e.includes("fridge")||e.includes("refrigerator")?'<i data-lucide="thermometer-snowflake" style="width:14px;height:14px;"></i>':e.includes("parking")?'<i data-lucide="car" style="width:14px;height:14px;"></i>':e.includes("housekeeping")||e.includes("cleaning")?'<i data-lucide="sparkles" style="width:14px;height:14px;"></i>':e.includes("bath")||e.includes("shower")?'<i data-lucide="bath" style="width:14px;height:14px;"></i>':e.includes("work")||e.includes("desk")?'<i data-lucide="laptop" style="width:14px;height:14px;"></i>':e.includes("pet")||e.includes("dog")?'<i data-lucide="paw-print" style="width:14px;height:14px;"></i>':e.includes("pool")?'<i data-lucide="waves" style="width:14px;height:14px;"></i>':e.includes("kitchen")||e.includes("microwave")?'<i data-lucide="cooking-pot" style="width:14px;height:14px;"></i>':'<i data-lucide="check" style="width:14px;height:14px;"></i>'}const Pt=[{key:"wifi",label:"Free WiFi",icon:"wifi"},{key:"tv",label:"Smart TV",icon:"tv"},{key:"fridge",label:"Fridge",icon:"thermometer-snowflake"},{key:"parking",label:"Free Parking",icon:"car"},{key:"housekeeping",label:"Weekly Housekeeping",icon:"sparkles"},{key:"bath",label:"Bath",icon:"bath"},{key:"workstation",label:"Workstation",icon:"laptop"},{key:"pet",label:"Pet Friendly",icon:"paw-print"},{key:"pool",label:"Pool",icon:"waves"},{key:"kitchen",label:"Kitchenette",icon:"cooking-pot"},{key:"ac",label:"Air Conditioning",icon:"wind"},{key:"laundry",label:"Laundry",icon:"shirt"}];let ct=null;function At(t){ct=t;const o=(c.editRooms.find(n=>n.id===t)?.amenities||"").split("•").map(n=>n.trim().toLowerCase()).filter(Boolean);let i=document.getElementById("amenityPickerModal");i||(document.body.insertAdjacentHTML("beforeend",`
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",X),i=document.getElementById("amenityPickerModal"));const r=document.getElementById("amenityPickerGrid");r.innerHTML=Pt.map(n=>{const a=o.some(l=>l.includes(n.key));return`<button onclick="toggleAmenityPreset(this,'${n.key}')" data-key="${n.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${a?"#2E7D5B":"#e5e7eb"};background:${a?"#E8F5EE":"white"};color:${a?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${n.icon}" style="width:14px;height:14px;"></i> ${n.label}</button>`}).join(""),document.getElementById("amenityCustomInput").value="",i.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function ce(t,e){const o=t.style.borderColor==="rgb(46, 125, 91)";t.style.borderColor=o?"#e5e7eb":"#2E7D5B",t.style.background=o?"white":"#E8F5EE",t.style.color=o?"#1a1a2e":"#2E7D5B"}function X(){document.getElementById("amenityPickerModal").style.display="none",ct=null}function pe(){const t=c.editRooms.find(r=>r.id===ct);if(!t){X();return}const e=document.getElementById("amenityPickerGrid"),o=[];e.querySelectorAll("button").forEach(r=>{if(r.style.background==="rgb(232, 245, 238)"){const n=Pt.find(a=>a.key===r.dataset.key);n&&o.push(n.label)}});const i=document.getElementById("amenityCustomInput").value.trim();i&&o.push(i),t.amenities=o.join(" • "),X(),lt(),typeof lucide<"u"&&lucide.createIcons()}function ue(t){At(t)}function ge(t,e){const o=c.editRooms.find(r=>r.id===t);if(!o)return;const i=(o.amenities||"").split("•").map(r=>r.trim()).filter(Boolean);o.amenities=i.filter(r=>r!==e).join(" • "),lt(),typeof lucide<"u"&&lucide.createIcons()}async function me(){const t=document.getElementById("edit-hotel-name")?.value.trim(),e=document.getElementById("edit-hotel-subtitle")?.value.trim(),o=document.getElementById("edit-hotel-address")?.value.trim(),i=document.getElementById("edit-hotel-phone")?.value.trim(),r=document.getElementById("edit-hotel-policy")?.value.trim();try{await api("POST","/api/crm/hotel-info",{name:t,subtitle:e,address:o,phone:i,cancellationPolicy:r}),toast("Hotel info saved!","success")}catch{toast("Failed to save","error")}}async function fe(){const t=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),localStorage.setItem("ratesChanged","1"),c.launchStatus=null,j(),toast("Rates saved!","success")}catch{toast("Failed to save rates","error")}}async function xe(){const t=document.getElementById("edit-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");c.token=t,c.isMasterPin=!1;try{localStorage.setItem("crmToken",c.token)}catch{}toast("PIN updated!","success")}catch(e){toast(e.message||"Failed to change PIN","error")}}function ye(t){navigator.clipboard.writeText(t).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function he(t){const e=t.nextElementSibling,o=t.querySelector(".accordion-arrow");e.style.display==="none"?(e.style.display="block",o&&(o.style.transform="rotate(90deg)")):(e.style.display="none",o&&(o.style.transform="rotate(0deg)"))}let V=!1;function Ct(){if(document.getElementById("goLiveOverlay"))return;const t=document.createElement("div");t.id="goLiveOverlay",t.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(255,255,255,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;",t.innerHTML='<div class="logo-sprite-bounce"></div><div style="font-size:14px;font-weight:700;color:#1a5c3f;">Opening secure checkout…</div><div style="font-size:12px;color:#6b7280;">Taking you to Stripe — one moment</div>',document.body.appendChild(t)}function it(){const t=document.getElementById("goLiveOverlay");t&&t.remove()}async function be(){if(!V){V=!0,Ct();try{const t=await api("POST","/api/crm/go-live");if(t.success&&t.url){window.location.href=t.url;return}it(),V=!1,toast(t.message||"Failed to start checkout","error")}catch{it(),V=!1,toast("Failed to start checkout. Try again.","error")}}}async function ve(){try{const t=await api("GET","/api/crm/billing-portal");t.success&&t.url?window.location.href=t.url:toast(t.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function we(){const t=document.getElementById("supportMessage")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),document.getElementById("supportMessage").value="",toast("Message sent! We'll reply to your email.","success")}catch{toast("Failed to send. Email support@bookmarketel.com directly.","error")}}async function ke(t){const e=c.editRooms.find(l=>l.id===t);if(!e){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+t)?.value.trim(),i=document.getElementById("edit-desc-"+t)?.value.trim(),r=parseInt(document.getElementById("edit-occ-"+t)?.value)||4,n=parseInt(document.getElementById("edit-units-"+t)?.value)||1,a={id:t,name:o||e.name,description:i||"",amenities:e.amenities||"",maxOccupancy:r,totalUnits:n};try{const l=await api("POST","/api/crm/rooms",a);if(l&&l.success===!1){toast(l.message||"Failed to save","error");return}e.name=a.name,e.description=a.description,e.maxOccupancy=r,e.totalUnits=n,toast("Room saved!","success")}catch(l){toast("Failed to save: "+(l.message||""),"error")}}async function Ee(t,e){const o=Array.from(t.target.files);if(!o.length)return;const r=document.getElementById("edit-card-"+e)?.querySelector("div:first-child");r&&(r.style.position="relative",r.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+e+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+e+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let n=0,a="";for(const u of o){try{const f=await at(e,u);if(f.image){const v=c.editRooms.find(B=>B.id===e);v&&(v.images||(v.images=[]),v.images.push(f.image),v.imageUrl||(v.imageUrl=f.image.url)),n++}}catch(f){a=f.message||"Upload failed"}const m=document.getElementById("upload-progress-"+e);m&&(m.textContent=n+" / "+o.length)}const l=document.getElementById("upload-spinner-"+e);l&&l.remove(),U(),n>0&&(c.launchStatus=null),j(),n>0?toast(n+" photo"+(n!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success"):toast(a||"Upload failed","error")}function Rt(t,e=512){return new Promise((o,i)=>{const r=new Image,n=URL.createObjectURL(t);r.onload=()=>{try{const a=Math.min(r.naturalWidth,r.naturalHeight),l=(r.naturalWidth-a)/2,u=(r.naturalHeight-a)/2,m=document.createElement("canvas");m.width=e,m.height=e;const f=m.getContext("2d");f.imageSmoothingQuality="high",f.drawImage(r,l,u,a,a,0,0,e,e),URL.revokeObjectURL(n),m.toBlob(v=>v?o(v):i(new Error("crop failed")),"image/png",.92)}catch(a){URL.revokeObjectURL(n),i(a)}},r.onerror=()=>{URL.revokeObjectURL(n),i(new Error("load failed"))},r.src=n})}function Ot(){const t=document.getElementById("appsAppIconPreview");t&&(t.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function pt(t){const e=document.getElementById("appsAppIconPreview");e&&(e.style.background="#fff",e.style.border="1px solid var(--border)",e.style.padding="0",e.innerHTML='<img src="'+t+'" alt="App icon" style="width:100%;height:100%;object-fit:contain;">')}function nt(){const t=document.getElementById("appsAppIconPreview");if(!t)return;if(c.activeHotelAppIcon){pt(c.activeHotelAppIcon);return}const e=(c.activeHotelName||"H").trim().charAt(0).toUpperCase()||"🏨";t.style.background="transparent",t.style.border="none",t.style.padding="0",t.innerHTML='<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">'+e+"</span>"}async function Se(t){const e=t.files&&t.files[0];if(!e)return;Ot();const o=new FormData;try{const i=await Rt(e,512);o.append("icon",i,"app-icon.png")}catch{o.append("icon",e)}try{const i=rt(),r=new URLSearchParams;c.activeHotelId&&r.set("hotelId",c.activeHotelId),i&&r.set("token",i);const a=await(await fetch(`/api/crm/hotel-app-icon?${r}`,{method:"POST",headers:{"x-crm-token":i},body:o})).json();if(a.success&&a.appIconUrl){c.activeHotelAppIcon=a.appIconUrl,pt(a.appIconUrl);const l=document.getElementById("appsView");l&&(l.dataset.appsKey=(c.activeHotelId||"")+"|"+a.appIconUrl+"|"+(c.activeHotelDomain||"")),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Logo updated! Guests will see it on their phone.","success")}else toast(a.message||"Failed to upload icon","error"),nt()}catch{toast("Failed to upload icon","error"),nt()}t.value=""}async function Be(t,e){if(confirm("Delete this photo?"))try{await api("DELETE",`/api/crm/rooms/${t}/images/${e}`);const o=c.editRooms.find(i=>i.id===t);o&&o.images&&(o.images=o.images.filter(i=>i.id!==e),o.imageUrl=o.images[0]?.url||null),U(),toast("Photo deleted","success")}catch{toast("Failed to delete","error")}}async function Te(t){if(confirm("Delete this room type?"))try{await api("DELETE",`/api/crm/rooms/${t}`),toast("Room deleted","success"),dt()}catch{toast("Failed to delete","error")}}function Ie(){const t=document.getElementById("editRoomsList");document.getElementById("editAddForm")||(t.insertAdjacentHTML("beforeend",`
  ...
  `),document.getElementById("editNewRoomName").focus())}function ze(){const t=document.getElementById("editNewRoomName").value.trim();t&&api("POST","/api/crm/rooms",{name:t,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),dt()}).catch(()=>toast("Failed to add","error"))}const Mt={addAmenityPrompt:ue,advanceTourIfNeeded:j,changePin:xe,checklistGoTo:Zt,checklistGoToRates:Kt,cleanupPostActivationTourUi:Z,cleanupSettingsTourUi:N,closeAmenityPicker:X,confirmAmenityPicker:pe,confirmEditAddRoom:ze,copyBookingLink:ye,copyBookingLinkFromChecklist:Jt,deleteEditImage:Be,deleteEditRoom:Te,ensureTourBlurOverlay:R,finishPostActivationTour:Y,getAmenityIcon:zt,getCrmAuthToken:rt,getEditRoomImages:Tt,goLive:be,guestBookingEngineUrl:St,handoffToGuestAppsTour:wt,hideGoLiveOverlay:it,loadEditRooms:dt,loadSettings:Et,openAmenityPicker:At,openBillingPortal:ve,openEditAddRoom:Ie,openGuestBookingEngine:ne,openPreviewSite:ie,openTourAccordion:M,postRoomImageUpload:at,queryTourSelector:$,removeAmenity:ge,renderEditRooms:lt,renderEditRoomsCards:U,replayWalkthrough:se,resolveLiveTourElement:W,resolveTourHighlightEl:F,restoreAppIconPreview:nt,saveEditRoom:ke,saveHotelInfo:me,saveRates:fe,scrollTourTargetIntoView:vt,sendSupportMessage:we,setAppIconPreviewImage:pt,setAppIconPreviewLoading:Ot,settingsChangePin:ee,settingsCopyLink:Qt,settingsSaveRates:te,settingsSendSupport:oe,settingsUploadPhoto:Xt,showActivatedModal:de,showEditRoomPhoto:It,showFinaleMockModal:D,showGoLiveOverlay:Ct,showOnboardingQuestions:ae,showTestDriveModal:kt,showWelcomeModal:Bt,squareCropImage:Rt,startPostActivationTabTour:st,startSettingsTour:ot,stepEditRoomPhoto:le,toggleAmenityPreset:ce,toggleSection:he,tourAnchorRect:q,tourElementRect:K,updatePreviewSiteBar:re,uploadAppIcon:Se,uploadEditImages:Ee};function Pe(){Dt(Mt)}const Oe=Object.freeze(Object.defineProperty({__proto__:null,default:Mt,install:Pe},Symbol.toStringTag,{value:"Module"}));export{Ce as a,Oe as b,c,Dt as e,Re as s};
