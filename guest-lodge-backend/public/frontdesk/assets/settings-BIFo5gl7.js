 ...
 */const je=(e,t,o=[])=>{const i=document.createElementNS("http://www.w3.org/2000/svg",e);return Object.keys(t).forEach(n=>{i.setAttribute(n,String(t[n]))}),o.length&&o.forEach(n=>{const r=je(...n);i.appendChild(r)}),i};var pt=([e,t,o])=>je(e,t,o);/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ut=e=>Array.from(e.attributes).reduce((t,o)=>(t[o.name]=o.value,t),{}),gt=e=>typeof e=="string"?e:!e||!e.class?"":e.class&&typeof e.class=="string"?e.class.split(" "):e.class&&Array.isArray(e.class)?e.class:"",mt=e=>e.flatMap(gt).map(o=>o.trim()).filter(Boolean).filter((o,i,n)=>n.indexOf(o)===i).join(" "),ft=e=>e.replace(/(\w)(\w*)(_|-|\s*)/g,(t,o,i)=>o.toUpperCase()+i.toLowerCase()),De=(e,{nameAttr:t,icons:o,attrs:i})=>{const n=e.getAttribute(t);if(n==null)return;const r=ft(n),a=o[r];if(!a)return;const s=ut(e),[l,g,y]=a,v={...g,"data-lucide":n,...i,...s},S=mt(["lucide",`lucide-${n}`,s,i]);S&&Object.assign(v,{class:S});const C=pt([l,v,y]);return e.parentNode?.replaceChild(C,e)};/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kt=["svg",h,[["path",{d:"M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"}],["polyline",{points:"16 6 12 2 8 6"}],["line",{x1:"12",x2:"12",y1:"2",y2:"15"}]]];/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Jt=["svg",h,[["path",{d:"M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z"}]]];/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${t}]`);if(Array.from(i).forEach(n=>De(n,{nameAttr:t,icons:e,attrs:o})),t==="data-lucide"){const n=document.querySelectorAll("[icon-name]");n.length>0&&Array.from(n).forEach(r=>De(r,{nameAttr:"icon-name",icons:e,attrs:o}))}},so={ArrowUpRight:ht,Ban:yt,Bed:vt,Bell:bt,Calendar:wt,Camera:kt,CircleAlert:Tt,CircleCheck:It,ClipboardList:Ct,Hash:$t,House:Lt,Image:Dt,Info:Ht,Lock:qt,MessageCircle:jt,Moon:Ut,Phone:Gt,Play:_t,Undo2:oo,Bath:xt,Car:Et,Check:St,ChevronLeft:Bt,ChevronRight:At,CookingPot:zt,CopyCheck:Mt,DoorOpen:Pt,Ellipsis:Rt,Globe:Ot,Inbox:Ft,Laptop:Nt,PawPrint:Vt,QrCode:Wt,Rocket:Yt,Share:Kt,Shirt:Jt,Smartphone:Qt,Sparkles:Zt,SquarePlus:Xt,ThermometerSnowflake:eo,Tv:to,Waves:io,Wifi:no,Wind:ro};window.lucide={createIcons(e={}){ao({...e,icons:so})}};function Ti(){return Promise.resolve()}async function lo(e){if(!e||!e.type.startsWith("image/")||e.type==="image/webp"&&e.size<4e5)return e;try{const t=await createImageBitmap(e),o=1600,i=1200;let n=t.width,r=t.height;const a=Math.min(1,o/n,i/r);n=Math.round(n*a),r=Math.round(r*a);const s=document.createElement("canvas");s.width=n,s.height=r,s.getContext("2d").drawImage(t,0,0,n,r),t.close();const l=await new Promise((y,v)=>{s.toBlob(S=>S?y(S):v(new Error("encode failed")),"image/webp",.82)}),g=(e.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([l],g+".webp",{type:"image/webp"})}catch{return e}}function Ii(){const e=()=>{d.currentFilter==="apps"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}const co=["cancelled","canceled","released"];function Ci(e){return e?co.includes(String(e.status||"").trim().toLowerCase()):!0}function po(e){Object.assign(window,e)}const uo=14,go=10;function be(e,t,o){return Math.max(t,Math.min(e,o))}function R(e,t,o,i){return{left:e,top:t,width:o,height:i,right:e+o,bottom:t+i}}function mo(){const e=window.visualViewport,t=e?e.offsetLeft:0,o=e?e.offsetTop:0,i=e?e.width:window.innerWidth,n=e?e.height:window.innerHeight;return R(t,o,i,n)}function D(e){if(!e||!e.isConnected)return null;const t=e.getBoundingClientRect();return t.width<2||t.height<2?null:R(t.left,t.top,t.width,t.height)}function fo(e,t){if(!e||!t)return 0;const o=Math.max(0,Math.min(e.right,t.right)-Math.max(e.left,t.left)),i=Math.max(0,Math.min(e.bottom,t.bottom)-Math.max(e.top,t.top));return o*i}function ho(e,t){return Math.max(0,t.left-e.left)+Math.max(0,e.right-t.right)+Math.max(0,t.top-e.top)+Math.max(0,e.bottom-t.bottom)}function yo(e,t){let o=0;for(const i of t||[]){const n=document.querySelector(i);if(!n||getComputedStyle(n).display==="none")continue;const r=D(n);!r||r.bottom<e.bottom-2||r.top>=e.bottom||(o=Math.max(o,e.bottom-r.top))}return o}function xo(e){const t=mo(),o=e.margin??uo,i=Math.max(Number(e.bottomInset||0),yo(t,e.avoidBottomSelectors)),n=t.left+o+Number(e.leftInset||0),r=t.top+o+Number(e.topInset||0),a=t.right-o-Number(e.rightInset||0),s=t.bottom-o-i;return R(n,r,Math.max(1,a-n),Math.max(1,s-r))}function vo(e){return e==="above"||e==="top"?["top","bottom","right","left"]:e==="right"?["right","left","bottom","top"]:e==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function bo(e,t,o,i,n){return e==="top"?R(t.left+(t.width-o)/2,t.top-i-n,o,i):e==="right"?R(t.right+n,t.top+(t.height-i)/2,o,i):e==="left"?R(t.left-o-n,t.top+(t.height-i)/2,o,i):R(t.left+(t.width-o)/2,t.bottom+n,o,i)}function wo(e,t){const o=be(e.left,t.left,Math.max(t.left,t.right-e.width)),i=be(e.top,t.top,Math.max(t.top,t.bottom-e.height));return R(o,i,e.width,e.height)}function ko(e){let t=e&&e.parentElement;for(;t&&t!==document.body&&t!==document.documentElement;){const o=getComputedStyle(t),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&t.scrollHeight>t.clientHeight+1)return t;t=t.parentElement}return null}function Eo(e,t){if(!e||Math.abs(t)<1)return!1;const o=ko(e);return o?o.scrollTop+=t:window.scrollBy({top:t,left:0,behavior:"auto"}),!0}function xe(e,t){const o=D(e);if(!o||t.height<60)return!1;let i;return o.height<=t.height?i=be(o.top,t.top,t.bottom-o.height):i=t.bottom-o.height,Eo(e,o.top-i)}function Ue(e,t){const o=getComputedStyle(e);for(const r of o)t.style.setProperty(r,o.getPropertyValue(r),o.getPropertyPriority(r));const i=e.children,n=t.children;for(let r=0;r<i.length;r+=1)n[r]&&Ue(i[r],n[r])}function So(e){e.removeAttribute("id"),e.querySelectorAll("[id]").forEach(t=>t.removeAttribute("id"))}function Bo(e,t){const o=e.querySelectorAll("input, textarea, select"),i=t.querySelectorAll("input, textarea, select");o.forEach((n,r)=>{const a=i[r];a&&(n.type==="checkbox"||n.type==="radio"?a.checked=n.checked:a.value=n.value)})}function Ao(e,t={}){if(!e||!e.isConnected||t.disabled||!D(e))return null;const i=e.cloneNode(!0);So(i),Ue(e,i),Bo(e,i),i.setAttribute(t.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(t.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",t.prepareClone?.(i,e);const n=e.style.visibility;t.hideSource&&(e.style.visibility="hidden"),document.body.appendChild(i);const r=()=>{const s=D(e);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),t.hideSource&&(e.style.visibility=n)};return r(),{element:i,source:e,update:r,destroy:a}}function To({tooltip:e,panel:t,target:o,anchor:i,spotlight:n,options:r={}}){if(!e||!t||!o)return null;let a=0,s=!1,l=!1,g=!1,y="";const v=(c=!0)=>{if(s||!e.isConnected||!o.isConnected)return null;const u=xo(r),k=`${u.left}:${u.top}:${u.width}:${u.height}`;y&&y!==k&&(l=!1,c=!0),y=k;const p=D(i)||D(o),f=D(o);if(!p||!f)return null;const x=Math.min(Number(r.maxWidth||380),u.width);e.style.position="fixed",e.style.right="auto",e.style.bottom="auto",e.style.width=`${x}px`,e.style.maxWidth=`${x}px`,e.style.margin="0",e.style.justifyContent="flex-start",t.style.maxHeight=`${Math.max(120,u.height)}px`;const b=Math.min(t.offsetHeight||e.offsetHeight||190,u.height),w=Number(r.gap??go);c&&!l&&r.autoScroll!==!1&&f.height+b+w<=u.height&&(l=xe(o,u),l&&requestAnimationFrame(()=>v(!1)));const E=vo(r.preferredPlacement).map((I,$)=>{const K=bo(I,p,x,b,w),$e=ho(K,u),Le=fo(K,f);return{placement:I,index:$,raw:K,overflow:$e,overlap:Le,score:$e*1e5+Le*100+$}}),T=E.find(I=>I.overflow<.5&&I.overlap<1),A=T||E.slice().sort((I,$)=>I.score-$.score)[0],z=r.forceDock===!0||!T;let P="floating",F;if(z){P="docked";const I=Math.min(b,Number(r.dockMaxHeight||Math.max(180,u.height*.42)),u.height);t.style.maxHeight=`${I}px`;const $=Math.min(t.offsetHeight||I,I);if(F=R(u.left+(u.width-x)/2,u.bottom-$,x,$),c&&!l&&r.autoScroll!==!1){const K=R(u.left,u.top,u.width,Math.max(60,F.top-w-u.top));l=xe(o,K),l&&requestAnimationFrame(()=>v(!1))}}else if(F=wo(A.raw,u),c&&!l&&r.autoScroll!==!1){let I=u;if(A.placement==="bottom")I=R(u.left,u.top,u.width,Math.max(60,F.top-w-u.top));else if(A.placement==="top"){const $=F.bottom+w;I=R(u.left,$,u.width,Math.max(60,u.bottom-$))}l=xe(o,I),l&&requestAnimationFrame(()=>v(!1))}return e.dataset.tourLayoutMode=P,e.dataset.tourPlacement=z?"bottom-dock":A.placement,e.style.left=`${F.left}px`,e.style.top=`${F.top}px`,n?.update?.(),r.onLayout?.({mode:P,placement:e.dataset.tourPlacement,viewport:u,targetRect:D(o),anchorRect:D(i)||D(o),tooltipRect:F}),{mode:P,placement:e.dataset.tourPlacement,rect:F}},S=(c=!1)=>{g=g||c===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const u=g;g=!1,v(u)}))},C=()=>{l=!1,S(!0)},G=typeof ResizeObserver=="function"?new ResizeObserver(S):null;G?.observe(o),i&&i!==o&&G?.observe(i),G?.observe(t),window.addEventListener("resize",C),window.addEventListener("orientationchange",C),window.addEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",C),window.visualViewport.addEventListener("scroll",S));const ye=()=>{s=!0,a&&cancelAnimationFrame(a),G?.disconnect(),window.removeEventListener("resize",C),window.removeEventListener("orientationchange",C),window.removeEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",C),window.visualViewport.removeEventListener("scroll",S))},m=v(!0);return{destroy:ye,reposition:()=>v(!1),result:m}}function V(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function se(...e){return V("setFilter")?.(...e)}function Fe(...e){return V("setBookingsSubview")?.(...e)}function Io(...e){return V("toast")?.(...e)}function de(...e){return V("updateGoLiveBanner")?.(...e)}function Co(...e){return V("seedTourRevenueShell")?.(...e)}function zo(...e){return V("finishTourHydration")?.(...e)}function Mo(...e){return V("goLive")?.(...e)}let ee=null,le=null,W=null;function j(){if(document.getElementById("frontdeskTourPolishStyle"))return;const e=document.createElement("style");e.id="frontdeskTourPolishStyle",e.textContent=`
    #tourBlurOverlay {
  ...
  `,document.head.appendChild(e)}function Ae(){ee&&(document.removeEventListener("keydown",ee),ee=null)}function Po(e){Ae(),ee=t=>{if(t.defaultPrevented)return;const o=t.target&&t.target.tagName?t.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||t.target?.isContentEditable||(t.key==="Escape"?(t.preventDefault(),e.onSkip?.()):t.key==="Enter"||t.key==="ArrowRight"?(t.preventDefault(),e.onNext?.()):t.key==="ArrowLeft"&&(t.preventDefault(),e.onBack?.()))},document.addEventListener("keydown",ee)}function ve(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function L(e){j();const t=e||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=t.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=t.blockPointer?"auto":"none",t.lockScroll&&(document.body.style.overflow="hidden"),o}const ie="rgba(17,24,39,0.42)";function Q(){const e=document.getElementById("tourTooltip"),t=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!e||t)return Promise.resolve();e.style.pointerEvents="none";const o=e.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function Ro(e,t){return W?.destroy(),W=Ao(e,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=t?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=t?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=t?.spotlightOutlineOffset??"2px",t?.spotlightBackground&&(o.style.background=t.spotlightBackground,o.style.backgroundColor=t.spotlightBackground),t?.spotlightBorderRadius&&(o.style.borderRadius=t.spotlightBorderRadius)}}),W?.element||null}function H(e){const t=e||{};Ae(),le?.destroy(),le=null,W?.destroy(),W=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!t.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(r=>r.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(r=>{r.style.position=r.dataset.tourOrigPosition||"",r.style.zIndex=r.dataset.tourOrigZIndex||"",r.style.isolation=r.dataset.tourOrigIsolation||"",r.style.boxShadow=r.dataset.tourOrigBoxShadow||"",r.style.outline=r.dataset.tourOrigOutline||"",r.style.outlineOffset=r.dataset.tourOrigOutlineOffset||"",r.style.transition=r.dataset.tourOrigTransition||"",r.style.borderRadius=r.dataset.tourOrigBorderRadius||"",r.style.opacity=r.dataset.tourOrigOpacity||"";const a=r.dataset.tourOrigBackground||"",s=r.dataset.tourOrigBackgroundColor||"";s?r.style.backgroundColor=s:r.style.removeProperty("background-color"),a?r.style.background=a:r.style.removeProperty("background"),r.removeAttribute("data-tour-highlighted"),delete r.dataset.tourOrigPosition,delete r.dataset.tourOrigZIndex,delete r.dataset.tourOrigIsolation,delete r.dataset.tourOrigBoxShadow,delete r.dataset.tourOrigOutline,delete r.dataset.tourOrigOutlineOffset,delete r.dataset.tourOrigTransition,delete r.dataset.tourOrigBackground,delete r.dataset.tourOrigBackgroundColor,delete r.dataset.tourOrigBorderRadius,delete r.dataset.tourOrigOpacity});const n=document.getElementById("goLiveBanner");n&&n.dataset.tourHidden&&(delete n.dataset.tourHidden,typeof de=="function"&&de()),t.keepOverlay||(document.body.style.overflow="")}function Oo(){const e=document.getElementById("tourTooltip"),t=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[e,...t,...o].filter(Boolean);return!i.length&&!o.length?(H({keepOverlay:!0}),Promise.resolve()):(Ae(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(H({keepOverlay:!0}),Promise.resolve()):(e&&(e.style.pointerEvents="none"),i.forEach(r=>{r.style.transition="opacity 0.07s ease, transform 0.07s ease",r.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(r=>{r.style.opacity="0",r.id==="tourTooltip"&&(r.style.transform="translateY(4px)")})}),new Promise(r=>{setTimeout(()=>{H({keepOverlay:!0}),r()},85)})))}function $o(e){const t=[e,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);t.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{t.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function _(e,t){if(!t.openAccordion)return;const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const r=o.querySelector(".accordion-arrow");r&&(r.style.transform="rotate(90deg)")}}function U(e){if(!e)return null;for(const t of String(e).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(t);if(o&&o.isConnected)return o}return null}function Z(e,t){if(t.highlightSelector){const o=U(t.highlightSelector);if(o)return o}if(t.highlightCard){const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(o)return o}return t.targetParent&&(e.closest(".booking-card")||e.closest(".accordion-body"))||e}function ne(e,t){if(!t)return e;const o=String(t.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const n=document.querySelector(i);if(n&&n.isConnected)return n}if(t.accordionCard){const i=document.querySelector(t.accordionCard);if(i&&i.isConnected)return i}return e&&e.isConnected?e:null}function ce(e,t){if(!e||!e.isConnected)return null;const o=e.getBoundingClientRect();return o.width<2||o.height<2||!t&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Ve(e,t){const o=U(e.anchorSelector);if(o){const i=ce(o,!0);if(i)return i}return ce(t,!0)}function He(e,t){const o=e.tooltipAnchorSelector||e.anchorSelector,i=U(o);if(i){const n=ce(i,!0);if(n)return n}return Ve(e,t)}function pe(e){const t=e||"auto";try{window.scrollTo({top:0,left:0,behavior:t})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const n=document.querySelector(i);n&&(n.scrollTop=0)})}function Ge(e,t,o){const i=o||{},n=t.scrollTarget||t.accordionCard,r=(n?U(n):null)||e;if(!r&&!t.scrollToTop)return Promise.resolve();const a=t.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,l=i.smooth&&!s?"smooth":d.settingsTourActive||s?"auto":"smooth";return new Promise(g=>{if(t.scrollToTop&&(pe(l),t.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{t.forcePageTop&&pe("auto"),g()}));return}if(!r){g();return}if(r.scrollIntoView({behavior:l,block:a,inline:"nearest"}),l==="auto"){requestAnimationFrame(()=>requestAnimationFrame(g));return}let y=!1;const v=()=>{y||(y=!0,window.removeEventListener("scrollend",S),clearTimeout(C),requestAnimationFrame(()=>requestAnimationFrame(g)))},S=()=>v();"onscrollend"in window&&window.addEventListener("scrollend",S,{once:!0});const C=setTimeout(v,520)})}function _e(){H(),localStorage.setItem("settingsTourStep","handoff");const e=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&se("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const n=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof n=="function"&&n({chainFromSettingsTour:!0})},t=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof t=="function"?t().then(e).catch(e):e()}function X(){H({keepOverlay:!0}),j(),d.settingsTourActive=!1,de(),L({blockPointer:!0,lockScroll:!0,dim:ie});const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(A),!document.getElementById("tourModalAnimStyle")){const z=document.createElement("style");z.id="tourModalAnimStyle",z.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(z)}document.getElementById("tourNextBtn").onclick=()=>{Q().then(()=>{n({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),l()})},document.getElementById("tourSkipBtn").onclick=()=>{r()}}function G(){j(),L({blockPointer:!0,lockScroll:!0,dim:ie});let m=0;const c=[`<div style="padding:20px 18px 0;">
      ...
      <div style="padding:0 14px 14px;">
        ...
        </div>`,k=!0,document.getElementById("tourNextBtn").onclick=()=>{m<c.length-1?(m++,p()):Q().then(()=>{n({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),l()})},document.getElementById("tourSkipBtn").onclick=()=>{r()}}if(document.body.appendChild(u),p(),!document.getElementById("tourModalAnimStyle")){const f=document.createElement("style");f.id="tourModalAnimStyle",f.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(f)}}function ye(){j(),L({blockPointer:!0,lockScroll:!0,dim:ie});let m=0,c=!1;const u=[`
        ...
        </div>`,c=!0,document.getElementById("tourNextBtn").onclick=()=>{if(!f){m++,p();return}Q().then(()=>{n({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),l()})},document.getElementById("tourSkipBtn").onclick=()=>{r()}};if(document.body.appendChild(k),p(),!document.getElementById("tourModalAnimStyle")){const f=document.createElement("style");f.id="tourModalAnimStyle",f.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(f)}}l()}function Ye(e){if(!e||typeof window.applyRiseStagger!="function")return;const t=e.querySelector(".settings-dashboard-grid");if(!t){window.applyRiseStagger(e,":scope > *");return}t.querySelectorAll(":scope > *").forEach(o=>{window.applyRiseStagger(o,":scope > *")})}function O(){return typeof window.isNativeFrontdeskApp=="function"&&window.isNativeFrontdeskApp()}function me(){return document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1"}function Lo(e){return/^(?:fd_|fds_|fdn_)/.test(String(e||""))}let re=null;function M(e){return String(e??"").trim()}function fe(e,t={}){if(!(!me()||window.parent===window))try{window.parent.postMessage({type:"marketel:editor-saved",kind:String(e||"booking-page"),hotelId:d.activeHotelId||"",...t},window.location.origin)}catch{}}function Ke(){return`<div class="booking-card" style="margin-bottom:14px;">
  ...
  </div>`}function Je(e=null){const t=O(),o=t?"https://guest-lodge-backend.onrender.com":"",i=e?.request||null,n=i?.scheduledFor?new Date(i.scheduledFor).toLocaleDateString([],{year:"numeric",month:"short",day:"numeric"}):"",r=t?i?`<div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border);">
    ...
    `,t?.subscribed&&!O()&&(g+=`
      ...
      `),g+=Ke(),g+=Je(o),e.innerHTML=g,Ye(e),window.refreshSupportSummary?.()}catch{e.innerHTML='<div class="empty-state"><div class="empty-icon"><i data-lucide="circle-alert" style="width:26px;height:26px;"></i></div><div class="empty-text">Failed to load settings</div></div>'}}}function Do(){const e=document.getElementById("settings-booking-url");e&&navigator.clipboard.writeText(e.value).then(()=>{localStorage.setItem("linkCopied","1"),te(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function Fo(){localStorage.setItem("settingsTourDone","1");const e=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",e);let t=0;const o=setInterval(()=>{t++;const i=document.getElementById("edit-rate-nightly");if(i||t>20){if(clearInterval(o),!i)return;const n=i.closest(".accordion-body");if(n&&n.style.display==="none"){n.style.display="block";const r=n.previousElementSibling?.querySelector(".accordion-arrow");r&&(r.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const r=document.getElementById("checklistPointer");r&&r.remove();const a=i.getBoundingClientRect(),s=document.createElement("div");s.id="checklistPointer",s.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${a.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,s.innerHTML=`
          ...
          `,document.body.appendChild(s),setTimeout(()=>{const l=document.getElementById("checklistPointer");l&&l.remove()},6e3)},1e3)},100)}},200)}function Ho(){const t="https://"+(d.activeHotelDomain||d.activeHotelId+".mktel.co");navigator.clipboard.writeText(t).then(()=>{localStorage.setItem("linkCopied","1"),te(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function No(e,t){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const n=setInterval(()=>{i++;const r=document.querySelector(e);if(r||i>20){if(clearInterval(n),!r)return;r.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const s=r.getBoundingClientRect(),l=document.createElement("div");l.id="checklistPointer",l.style.cssText=`
      ...
      `,document.body.appendChild(a),a.querySelectorAll(".onboarding-opt").forEach(s=>{s.addEventListener("click",()=>{t[r.key]=s.dataset.value,s.style.background="#1a1a2e",s.style.color="white",s.style.fontWeight="600",setTimeout(()=>{e++,i()},250)})}))}i()}function Ko(){["onboardingDone","settingsTourDone","settingsTourStep","linkCopied","ratesChanged","appsTourDone","postActivationTourDone"].forEach(o=>{localStorage.removeItem(o)});const e=new URL(window.location.href);e.searchParams.set("welcome","1"),e.searchParams.set("reveal","1"),e.searchParams.delete("tab");const t=e.pathname+e.search+e.hash;if(t===window.location.pathname+window.location.search+window.location.hash){window.location.reload();return}window.location.assign(t)}function et(){const e=document.createElement("div");e.id="welcomeModalOverlay",e.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.72);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;padding:24px;";function t(){localStorage.setItem("onboardingDone","1"),localStorage.removeItem("settingsTourDone"),localStorage.removeItem("settingsTourStep");try{const n=new URL(window.location);n.searchParams.delete("welcome"),window.history.replaceState({},"",n)}catch{}const i=typeof we=="function"?we:typeof window.startSettingsTour=="function"?window.startSettingsTour:null;i&&i(),e.remove()}function o(){e.innerHTML=`
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=t}document.body.appendChild(e),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function ue(){const e=document.getElementById("postActivationTourTooltip");e&&e.remove();const t=document.getElementById("postActivationTourOverlay");t&&t.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function ae(){ue(),localStorage.setItem("postActivationTourDone","1");const e=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",e)}catch{}}function tt(){if(localStorage.getItem("postActivationTourDone")){ae();return}ue();const e=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. Once the Front Desk app is connected, new bookings can alert you even when it is closed."},{tab:"apps",navFilter:"apps",text:"<strong>Last step: open Guestel.</strong> Share the Guestel QR, see your property card, reply to verified guests, and send updates to guests who opt in."}];let t=0;function o(){if(ue(),t>=e.length){ae();return}const i=e[t],n=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);n&&setFilter(i.tab,n);const r=document.createElement("div");r.id="postActivationTourOverlay",r.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(r),document.body.style.overflow="hidden",setTimeout(()=>{const a=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);a&&(a.setAttribute("data-post-activation-highlight","1"),a.style.position="relative",a.style.zIndex="100003",a.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",a.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const s=a?a.getBoundingClientRect():{left:24,bottom:80,width:200},l=document.createElement("div");l.id="postActivationTourTooltip";const g=Math.min(300,window.innerWidth-32),y=Math.max(16,Math.min(s.left+s.width/2-g/2,window.innerWidth-g-16)),v=Math.min(s.bottom+14,window.innerHeight-180);l.style.cssText=`position:fixed;z-index:100004;left:${y}px;top:${v}px;max-width:${g}px;width:${g}px;`;const S=t>=e.length-1;l.innerHTML=`
  ...
  `,document.body.appendChild(n);const r=()=>{n.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}};document.getElementById("activatedModalContinueWeb")?.addEventListener("click",r),document.getElementById("activatedModalContinueWebPrimary")?.addEventListener("click",r)}async function Qo(){if(isEditPageDomReady())return;if(d.editRoomsLoadPromise)return d.editRoomsLoadPromise;const e=document.getElementById("editRoomsList");if(e){d.editRoomsLoadPromise=(async()=>{e.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[t,o,i]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify"),O()?api("GET","/api/crm/account-deletion/status").catch(()=>null):Promise.resolve(null)]);if(!t.rooms)throw new Error("No data");d.editRooms=t.rooms;const n=o?.hotelName||"";n&&(d.activeHotelName=n),o&&(d.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const r=o?.hotelSubtitle||"",a=o?.hotelAddress||"",s=o?.hotelPhone||"";re={name:M(n),subtitle:M(r),address:M(a),phone:M(s),cancellationPolicy:M(o?.cancellationPolicy)};const l=o?.appIconUrl||"";d.activeHotelAppIcon=l,updateFrontdeskManifestLink();let g={nightly:69,weekly:299,monthly:999,taxRate:.1};t.rates&&(g=t.rates),d.editRates=g;const v="https://"+(o?.domain||d.activeHotelId+".mktel.co"),S=me();let C=`
      ...
      ${J("Returning guests",`
        ...
        <label style="display:flex;align-items:center;gap:8px;font-size:13px;color:var(--text);margin-bottom:10px;font-weight:600;cursor:pointer;">
          <input type="checkbox" id="edit-offer-enabled" ${o?.returnOfferEnabled?"checked":""} onchange="updateReturnOfferPreview()"> Offer a returning-guest discount
        </label>
        <div style="display:flex;gap:8px;margin-bottom:8px;">
          <input type="number" min="0" id="edit-offer-value" value="${Number(o?.returnOfferValue)||10}" oninput="updateReturnOfferPreview()" style="flex:1;padding:11px 13px;font-size:13px;border:1.5px solid var(--border);border-radius:10px;background:var(--white);outline:none;font-family:inherit;">
          <select id="edit-offer-kind" onchange="updateReturnOfferPreview()" style="padding:11px 13px;font-size:13px;border:1.5px solid var(--border);border-radius:10px;background:var(--white);font-family:inherit;">
            <option value="percent" ${o?.returnOfferKind!=="amount"?"selected":""}>% off</option>
            <option value="amount" ${o?.returnOfferKind==="amount"?"selected":""}>$ off / night</option>
          </select>
        </div>
      ...
      `,{open:!1,hint:o?.returnOfferEnabled?`${o?.returnOfferKind==="amount"?"$":""}${Number(o?.returnOfferValue)||0}${o?.returnOfferKind==="amount"?"/night":"%"} off`:"Off"})}
      ${J("Your booking link",`
    ...
    </span>`).join(""),e.hidden=N.length===0)}function rt(e){Pe=e;const o=(d.editRooms.find(l=>l.id===e)?.amenities||"").split("•").map(l=>l.trim()).filter(Boolean),i=o.map(l=>l.toLowerCase());N=o.filter(l=>!Xo(l));let n=document.getElementById("amenityPickerModal");n||(document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`),e=document.getElementById("amenityCustomModal"),e.addEventListener("click",he),window.visualViewport&&e.dataset.viewportBound!=="1"&&(e.dataset.viewportBound="1",window.visualViewport.addEventListener("resize",ke),window.visualViewport.addEventListener("scroll",ke)),e)}function oi(){const e=ti(),t=document.getElementById("amenityCustomInput");t&&(t.value=""),e.style.display="flex",ke(),requestAnimationFrame(()=>t?.focus({preventScroll:!0}))}function he(){const e=document.getElementById("amenityCustomModal");e&&(document.getElementById("amenityCustomInput")?.blur(),e.style.display="none")}function ii(){const e=document.getElementById("amenityCustomInput"),t=String(e?.value||"").replace(/\s+/g," ").trim();t&&(N.some(o=>o.toLowerCase()===t.toLowerCase())||N.push(t),he(),Re())}function ni(e){N.splice(Number(e),1),Re()}function ri(){const e=d.editRooms.find(i=>i.id===Pe);if(!e){ge();return}const t=document.getElementById("amenityPickerGrid"),o=[];t.querySelectorAll("button").forEach(i=>{if(i.style.background==="rgb(232, 245, 238)"){const n=Me.find(r=>r.key===i.dataset.key);n&&o.push(n.label)}}),o.push(...N),e.amenities=o.join(" • "),ge(),Ce(),typeof lucide<"u"&&lucide.createIcons()}function ai(e){rt(e)}function si(e,t){const o=d.editRooms.find(n=>n.id===e);if(!o)return;const i=(o.amenities||"").split("•").map(n=>n.trim()).filter(Boolean);o.amenities=i.filter(n=>n!==t).join(" • "),Ce(),typeof lucide<"u"&&lucide.createIcons()}async function di(e="header"){const t=document.getElementById("edit-hotel-name")?.value.trim(),o=document.getElementById("edit-hotel-subtitle")?.value.trim(),i=document.getElementById("edit-hotel-address")?.value.trim(),n=document.getElementById("edit-hotel-phone")?.value.trim(),r=document.getElementById("edit-hotel-policy")?.value.trim(),a={name:t,subtitle:o,address:i,phone:n},s=Object.keys(a).filter(g=>M(a[g])!==M(re?.[g])),l=M(r)!==M(re?.cancellationPolicy);try{if(await api("POST","/api/crm/hotel-info",{name:t,subtitle:o,address:i,phone:n,cancellationPolicy:r}),t&&(d.activeHotelName=t),toast(e==="policy"?"Checkout banner saved!":"Property info saved!","success"),re={...Object.fromEntries(Object.entries(a).map(([g,y])=>[g,M(y)])),cancellationPolicy:M(r)},fe(e==="policy"?"checkout-policy":"header",{hotelName:t||"",changedFields:e==="policy"?l?["cancellationPolicy"]:["checkout-policy"]:s.length?s:["header"]}),e==="header"){const g=new Set(["name","subtitle","address","phone"]),y=s.length===1&&g.has(s[0])?`header-${s[0]}`:"header";Y(y)}else e==="policy"&&Y("checkout-policy")}catch{toast("Failed to save","error")}}function li(){const e=document.getElementById("edit-offer-enabled")?.checked,t=document.getElementById("edit-offer-kind")?.value==="amount"?"amount":"percent",o=Number(document.getElementById("edit-offer-value")?.value)||0,i=document.getElementById("offerPreview");if(i){if(!e||o<=0){i.textContent="Guests see their normal rate.",i.style.opacity="0.6";return}i.style.opacity="1",i.textContent=t==="amount"?`Returning guests see $${o} off per night.`:`Returning guests see ${o}% off the direct rate.`}}async function ci(){const e=!!document.getElementById("edit-offer-enabled")?.checked,t=document.getElementById("edit-offer-kind")?.value==="amount"?"amount":"percent",o=Number(document.getElementById("edit-offer-value")?.value)||0;try{await api("POST","/api/crm/hotel-info",{returnOfferEnabled:e,returnOfferKind:t,returnOfferValue:o}),toast(e?"Returning-guest offer saved!":"Offer turned off","success")}catch{toast("Could not save offer","error")}}async function pi(){const e=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,t=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:e,weekly:t,monthly:o}),localStorage.setItem("ratesChanged","1"),d.launchStatus=null,te(),toast("Rates saved!","success"),Y("room",d.editRooms[0]?.id||"")}catch{toast("Failed to save rates","error")}}async function ui(){const e=document.getElementById("edit-new-pin")?.value.trim();if(!e||e.length<6){toast("PIN must be at least 6 characters","error");return}try{const t=await api("POST","/api/crm/change-pin",{newPin:e});if(!t.success)throw new Error(t.message||"Failed to change PIN");d.token=e,d.isMasterPin=!1,d.isDogfoodPreview=!1;try{localStorage.setItem("crmToken",d.token)}catch{}toast("PIN updated!","success")}catch(t){toast(t.message||"Failed to change PIN","error")}}function gi(e){navigator.clipboard.writeText(e).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function J(e,t,{open:o=!1,hint:i="",id:n=""}={}){return`<div class="booking-card page-section" style="margin-bottom:14px;"${n?` id="${n}"`:""}>
  ...
  </div>`,t.querySelector("#goLiveDismiss")?.addEventListener("click",Ee),t.querySelector("#goLiveRetry")?.addEventListener("click",()=>{Ee(),e?.()})}async function Se(e={}){if(O()){toast("Front Desk app access is managed with your Marketel account.","info");return}if(oe)return;const t=e?.billingInterval==="year"?"year":"month",o=t==="year"?1990:199;oe=!0,at();const i=window.MarketelJourney;i?.track("JourneyCheckoutRequested",{source:document.getElementById("marketelValueReveal")?"value-reveal":"frontdesk",price:o,currency:"USD",billingInterval:t},{immediate:!0});const n=i?.getContext?.()||{},r=i?.linkage?.()||{};try{const a=await api("POST","/api/crm/go-live",{...r,journeyVisitorId:r.journeyVisitorId||n.visitorId||"",journeySessionId:r.journeySessionId||n.sessionId||"",journeySequence:r.journeySequence||n.sequence||null,billingInterval:t});if(a.success&&a.url){i?.track("JourneyCheckoutRedirected",{provider:"stripe",price:o,currency:"USD",billingInterval:t},{immediate:!0,keepalive:!0}),window.location.href=a.url;return}i?.track("JourneyCheckoutFailed",{stage:"create-checkout-session",reason:"server-rejected",serverMessage:String(a?.message||"").slice(0,160)},{immediate:!0}),oe=!1,qe(()=>Se(e))}catch(a){i?.track("JourneyCheckoutFailed",{stage:"create-checkout-session",reason:"network-or-server-error",errorName:String(a?.name||"").slice(0,80)},{immediate:!0}),oe=!1,qe(()=>Se(e))}}async function fi(){if(O()){toast("Email support@bookmarketel.com for billing help.","info");return}try{const e=await api("GET","/api/crm/billing-portal");e.success&&e.url?window.location.href=e.url:toast(e.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function hi(){if(!confirm("Delete this Marketel account and all property data? The subscription will be canceled when deletion completes."))return;const e=prompt("Type DELETE to schedule permanent deletion after a seven-day recovery window.");if(String(e||"").trim().toUpperCase()==="DELETE")try{const t=await api("POST","/api/crm/account-deletion/request",{confirmation:"DELETE"});if(!t?.success)throw new Error(t?.message||"Could not schedule deletion.");toast("Account deletion scheduled. You can cancel during the next seven days.","success"),setTimeout(()=>window.location.reload(),900)}catch(t){toast(t.message||"Could not schedule account deletion.","error")}}async function yi(){try{const e=await api("POST","/api/crm/account-deletion/cancel");if(!e?.success)throw new Error(e?.message||"Could not cancel deletion.");toast("Account deletion cancelled.","success"),setTimeout(()=>window.location.reload(),700)}catch(e){toast(e.message||"Could not cancel account deletion.","error")}}async function xi(){window.openMarketelSupport?.()}async function vi(e){const t=d.editRooms.find(l=>l.id===e);if(!t){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+e)?.value.trim(),i=document.getElementById("edit-desc-"+e)?.value.trim(),n=parseInt(document.getElementById("edit-occ-"+e)?.value)||4,r=parseInt(document.getElementById("edit-units-"+e)?.value)||1,a={id:e,name:o||t.name,description:i||"",amenities:t.amenities||"",maxOccupancy:n,totalUnits:r},s=["name","description","amenities","maxOccupancy","totalUnits"].filter(l=>M(a[l])!==M(t[l]));try{const l=await api("POST","/api/crm/rooms",a);if(l&&l.success===!1){toast(l.message||"Failed to save","error");return}t.name=a.name,t.description=a.description,t.maxOccupancy=n,t.totalUnits=r,toast("Room saved!","success"),fe("room",{roomId:e,roomName:a.name,changedFields:s.length?s:["room"]}),Y("room",e)}catch(l){toast("Failed to save: "+(l.message||""),"error")}}async function bi(e,t){const o=Array.from(e.target.files);if(!o.length)return;const n=document.getElementById("edit-card-"+t)?.querySelector("div:first-child");n&&(n.style.position="relative",n.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+t+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+t+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let r=0,a="";for(const l of o){try{const y=await Ie(t,l);if(y.image){const v=d.editRooms.find(S=>S.id===t);v&&(v.images||(v.images=[]),v.images.push(y.image),v.imageUrl||(v.imageUrl=y.image.url)),r++}}catch(y){a=y.message||"Upload failed"}const g=document.getElementById("upload-progress-"+t);g&&(g.textContent=r+" / "+o.length)}const s=document.getElementById("upload-spinner-"+t);s&&s.remove(),q(),r>0&&(d.launchStatus=null),te(),r>0?(fe("room-photos",{roomId:t,changedFields:["photos"]}),toast(r+" photo"+(r!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success"),Y("room-photo",t)):toast(a||"Upload failed","error")}function st(e,t=512){return new Promise((o,i)=>{const n=new Image,r=URL.createObjectURL(e);n.onload=()=>{try{const a=Math.min(n.naturalWidth,n.naturalHeight),s=(n.naturalWidth-a)/2,l=(n.naturalHeight-a)/2,g=document.createElement("canvas");g.width=t,g.height=t;const y=g.getContext("2d");y.imageSmoothingQuality="high",y.drawImage(n,s,l,a,a,0,0,t,t),URL.revokeObjectURL(r),g.toBlob(v=>v?o(v):i(new Error("crop failed")),"image/png",.92)}catch(a){URL.revokeObjectURL(r),i(a)}},n.onerror=()=>{URL.revokeObjectURL(r),i(new Error("load failed"))},n.src=r})}function dt(){const e=document.getElementById("appsAppIconPreview");e&&(e.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function Oe(e){const t=document.getElementById("appsAppIconPreview");t&&(t.style.background="#fff",t.style.border="1px solid var(--border)",t.style.padding="0",t.innerHTML='<img src="'+e+'" alt="App icon" style="width:100%;height:100%;object-fit:contain;">')}function Be(){const e=document.getElementById("appsAppIconPreview");if(!e)return;if(d.activeHotelAppIcon){Oe(d.activeHotelAppIcon);return}const t=(d.activeHotelName||"P").trim().charAt(0).toUpperCase()||"P";e.style.background="transparent",e.style.border="none",e.style.padding="0",e.innerHTML='<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">'+t+"</span>"}async function wi(e){const t=e.files&&e.files[0];if(!t)return;dt();const o=new FormData;try{const i=await st(t,512);o.append("icon",i,"app-icon.png")}catch{o.append("icon",t)}try{const i=Te(),n=new URLSearchParams;d.activeHotelId&&n.set("hotelId",d.activeHotelId);const a=await(await fetch(`/api/crm/hotel-app-icon?${n}`,{method:"POST",headers:{"x-crm-token":i,...O()?{"x-marketel-client":"ios"}:{}},body:o})).json();if(a.success&&a.appIconUrl){d.activeHotelAppIcon=a.appIconUrl,Oe(a.appIconUrl);const s=document.getElementById("appsView");s&&(s.dataset.appsKey=(d.activeHotelId||"")+"|"+a.appIconUrl+"|"+(d.activeHotelDomain||"")),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Guestel icon updated.","success")}else toast(a.message||"Failed to upload icon","error"),Be()}catch{toast("Failed to upload icon","error"),Be()}e.value=""}async function ki(e,t){if(!confirm("Delete this photo?"))return;const o=document.querySelector(`[data-thumb-id="${CSS.escape(String(t))}"]`),i=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;o&&!i&&(o.classList.add("marketel-removing"),setTimeout(()=>{o.style.transition="width 140ms var(--ease-in-out), margin 140ms var(--ease-in-out)",o.style.width="0px",o.style.margin="0"},120));try{await api("DELETE",`/api/crm/rooms/${e}/images/${t}`);const n=d.editRooms.find(r=>r.id===e);n&&n.images&&(n.images=n.images.filter(r=>r.id!==t),n.imageUrl=n.images[0]?.url||null),q(),toast("Photo deleted","success"),fe("room-photo-deleted",{roomId:e,changedFields:["photos"]}),Y("room-photo",e)}catch{o&&(o.classList.remove("marketel-removing"),o.style.transition="",o.style.width="",o.style.margin=""),toast("Failed to delete","error")}}async function Ei(e){if(!confirm("Delete this room from your booking page and Availability? Saved date changes will also be removed."))return;const t=d.editRooms.find(o=>o.id===e);try{if(await api("DELETE",`/api/crm/rooms/${e}`),d.editRooms=d.editRooms.filter(i=>i.id!==e),t){const i=d.manualAvailability||{rooms:[],overrides:{}};i.rooms=(i.rooms||[]).filter(n=>n.name!==t.name),i.overrides=Object.fromEntries(Object.entries(i.overrides||{}).filter(([n])=>!n.startsWith(`${t.name}|`))),d.manualAvailability=i,d.manualSelectedRoom===t.name&&(d.manualSelectedRoom=i.rooms[0]?.name||"")}q(),window.refreshRoomBadge?.(),window.renderAvailabilityView?.(),toast("Room deleted","success"),ze({render:!0}).catch(()=>{}),window.loadManualAvailability?.({silent:!0})?.catch(()=>{})}catch(o){toast(o.message||"Failed to delete","error")}}function Si(){document.getElementById("editAddRoomModal")||(document.body.insertAdjacentHTML("beforeend",`
  ...
  `),window.setNativeModalOpen?.("edit-add-room",!0),requestAnimationFrame(()=>document.getElementById("editNewRoomName")?.focus()))}function lt(){document.getElementById("editAddRoomModal")?.remove(),window.setNativeModalOpen?.("edit-add-room",!1)}async function Bi(){const e=document.getElementById("editNewRoomName"),t=document.querySelector("#editAddRoomModal .edit-add-room-actions .primary"),o=e?.value.trim()||"";if(!o)return;e&&(e.disabled=!0),t&&(t.disabled=!0,t.textContent="Adding…");const i=5;try{const n=await api("POST","/api/crm/rooms",{name:o,maxOccupancy:4,totalUnits:i});if(!n?.success||!n.room?.id)throw new Error(n?.message||"Failed to add room");const r={id:n.room.id,name:n.room.name||o,description:"",amenities:"",maxOccupancy:4,totalUnits:i,imageUrl:null,images:[]},a=d.editRooms.findIndex(g=>g.id===r.id);a>=0?d.editRooms=d.editRooms.map((g,y)=>y===a?r:g):d.editRooms=[...d.editRooms,r];const s=d.manualAvailability||{rooms:[],overrides:{}};Array.isArray(s.rooms)||(s.rooms=[]),(!s.overrides||typeof s.overrides!="object")&&(s.overrides={}),s.rooms.some(g=>g.name===r.name)||(s.rooms=[...s.rooms,{name:r.name,totalUnits:i}].sort((g,y)=>String(g.name).localeCompare(String(y.name)))),d.manualAvailability=s,d.manualSelectedRoom||(d.manualSelectedRoom=r.name),lt(),q(),window.refreshRoomBadge?.(),toast("Room added","success"),ze({render:!0}).catch(()=>{}),window.loadManualAvailability?.({silent:!0})?.catch(()=>{})}catch(n){e&&(e.disabled=!1),t&&(t.disabled=!1,t.textContent="Add room"),toast(n.message||"Failed to add room","error")}}const ct={addAmenityPrompt:ai,advanceTourIfNeeded:te,changePin:ui,checklistGoTo:No,checklistGoToRates:Fo,cleanupPostActivationTourUi:ue,cleanupSettingsTourUi:H,cancelAccountDeletion:yi,closeAmenityPicker:ge,closeCustomAmenityModal:he,closeEditAddRoom:lt,confirmAmenityPicker:ri,confirmCustomAmenity:ii,confirmEditAddRoom:Bi,copyBookingLink:gi,copyBookingLinkFromChecklist:Ho,deleteEditImage:ki,deleteEditRoom:Ei,ensureTourBlurOverlay:L,finishPostActivationTour:ae,getAmenityIcon:nt,getCrmAuthToken:Te,getEditRoomImages:ot,goLive:Se,guestBookingEngineUrl:Xe,handoffToGuestAppsTour:_e,hideGoLiveOverlay:Ee,loadEditRooms:Qo,loadSettings:Qe,openAmenityPicker:rt,openCustomAmenityModal:oi,openBillingPortal:fi,openEditAddRoom:Si,openGuestBookingEngine:_o,openPreviewSite:Ze,openTourAccordion:_,postRoomImageUpload:Ie,queryTourSelector:U,requestAccountDeletion:hi,removeAmenity:si,removeCustomAmenity:ni,renderEditRooms:Ce,renderEditRoomsCards:q,refreshEditRoomsData:ze,replayWalkthrough:Ko,resolveLiveTourElement:ne,resolveTourHighlightEl:Z,restoreAppIconPreview:Be,saveEditRoom:vi,saveHotelInfo:di,saveRates:pi,saveReturnOffer:ci,updateReturnOfferPreview:li,scrollTourTargetIntoView:Ge,sendSupportMessage:xi,setAppIconPreviewImage:Oe,setAppIconPreviewLoading:dt,settingsChangePin:Uo,settingsCopyLink:Do,settingsSaveRates:jo,settingsSendSupport:Vo,settingsUploadPhoto:qo,showActivatedModal:Jo,showEditRoomPhoto:it,showFinaleMockModal:X,showGoLiveOverlay:at,showOnboardingQuestions:Yo,showTestDriveModal:We,showWelcomeModal:et,squareCropImage:st,startPostActivationTabTour:tt,startSettingsTour:we,stepEditRoomPhoto:Zo,toggleAmenityPreset:ei,toggleSection:mi,tourAnchorRect:Ve,tourElementRect:ce,updatePreviewSiteBar:Wo,uploadAppIcon:wi,uploadEditImages:bi};function Ai(){po(ct)}const zi=Object.freeze(Object.defineProperty({__proto__:null,default:ct,install:Ai},Symbol.toStringTag,{value:"Module"}));export{To as a,Ao as b,d as c,Ti as d,po as e,zi as f,Ci as i,Ii as s};
