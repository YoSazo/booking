 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mt=["svg",S,[["path",{d:"M12 20h.01"}],["path",{d:"M2 8.82a15 15 0 0 1 20 0"}],["path",{d:"M5 12.859a10 10 0 0 1 14 0"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0"}]]];/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Rt=["svg",S,[["path",{d:"M12.8 19.6A2 2 0 1 0 14 16H2"}],["path",{d:"M17.5 8a2.5 2.5 0 1 1 2 4H2"}],["path",{d:"M9.8 4.4A2 2 0 1 1 11 8H2"}]]];/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${t}]`);if(Array.from(i).forEach(r=>Pe(r,{nameAttr:t,icons:e,attrs:o})),t==="data-lucide"){const r=document.querySelectorAll("[icon-name]");r.length>0&&Array.from(r).forEach(n=>Pe(n,{nameAttr:"icon-name",icons:e,attrs:o}))}},Lt={Bath:lt,Car:ct,Check:pt,ChevronLeft:ut,ChevronRight:gt,CookingPot:mt,CopyCheck:ft,DoorOpen:ht,Ellipsis:xt,Globe:yt,Inbox:vt,Laptop:bt,PawPrint:wt,QrCode:kt,Rocket:Et,Share:St,Shirt:Bt,Smartphone:At,Sparkles:Tt,SquarePlus:zt,ThermometerSnowflake:It,Tv:Ct,Waves:Pt,Wifi:Mt,Wind:Rt};window.lucide={createIcons(e={}){Ot({...e,icons:Lt})}};function Wo(){return Promise.resolve()}async function Dt(e){if(!e||!e.type.startsWith("image/")||e.type==="image/webp"&&e.size<4e5)return e;try{const t=await createImageBitmap(e),o=1600,i=1200;let r=t.width,n=t.height;const a=Math.min(1,o/r,i/n);r=Math.round(r*a),n=Math.round(n*a);const s=document.createElement("canvas");s.width=r,s.height=n,s.getContext("2d").drawImage(t,0,0,r,n),t.close();const c=await new Promise((x,y)=>{s.toBlob(E=>E?x(E):y(new Error("encode failed")),"image/webp",.82)}),g=(e.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([c],g+".webp",{type:"image/webp"})}catch{return e}}function Jo(){const e=()=>{d.currentFilter==="apps"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}const $t=["cancelled","canceled","released"];function Ko(e){return e?$t.includes(String(e.status||"").trim().toLowerCase()):!0}function Ft(e){Object.assign(window,e)}const Ht=14,Nt=10;function xe(e,t,o){return Math.max(t,Math.min(e,o))}function R(e,t,o,i){return{left:e,top:t,width:o,height:i,right:e+o,bottom:t+i}}function qt(){const e=window.visualViewport,t=e?e.offsetLeft:0,o=e?e.offsetTop:0,i=e?e.width:window.innerWidth,r=e?e.height:window.innerHeight;return R(t,o,i,r)}function $(e){if(!e||!e.isConnected)return null;const t=e.getBoundingClientRect();return t.width<2||t.height<2?null:R(t.left,t.top,t.width,t.height)}function jt(e,t){if(!e||!t)return 0;const o=Math.max(0,Math.min(e.right,t.right)-Math.max(e.left,t.left)),i=Math.max(0,Math.min(e.bottom,t.bottom)-Math.max(e.top,t.top));return o*i}function Ut(e,t){return Math.max(0,t.left-e.left)+Math.max(0,e.right-t.right)+Math.max(0,t.top-e.top)+Math.max(0,e.bottom-t.bottom)}function Vt(e,t){let o=0;for(const i of t||[]){const r=document.querySelector(i);if(!r||getComputedStyle(r).display==="none")continue;const n=$(r);!n||n.bottom<e.bottom-2||n.top>=e.bottom||(o=Math.max(o,e.bottom-n.top))}return o}function Gt(e){const t=qt(),o=e.margin??Ht,i=Math.max(Number(e.bottomInset||0),Vt(t,e.avoidBottomSelectors)),r=t.left+o+Number(e.leftInset||0),n=t.top+o+Number(e.topInset||0),a=t.right-o-Number(e.rightInset||0),s=t.bottom-o-i;return R(r,n,Math.max(1,a-r),Math.max(1,s-n))}function _t(e){return e==="above"||e==="top"?["top","bottom","right","left"]:e==="right"?["right","left","bottom","top"]:e==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function Yt(e,t,o,i,r){return e==="top"?R(t.left+(t.width-o)/2,t.top-i-r,o,i):e==="right"?R(t.right+r,t.top+(t.height-i)/2,o,i):e==="left"?R(t.left-o-r,t.top+(t.height-i)/2,o,i):R(t.left+(t.width-o)/2,t.bottom+r,o,i)}function Wt(e,t){const o=xe(e.left,t.left,Math.max(t.left,t.right-e.width)),i=xe(e.top,t.top,Math.max(t.top,t.bottom-e.height));return R(o,i,e.width,e.height)}function Jt(e){let t=e&&e.parentElement;for(;t&&t!==document.body&&t!==document.documentElement;){const o=getComputedStyle(t),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&t.scrollHeight>t.clientHeight+1)return t;t=t.parentElement}return null}function Kt(e,t){if(!e||Math.abs(t)<1)return!1;const o=Jt(e);return o?o.scrollTop+=t:window.scrollBy({top:t,left:0,behavior:"auto"}),!0}function fe(e,t){const o=$(e);if(!o||t.height<60)return!1;let i;return o.height<=t.height?i=xe(o.top,t.top,t.bottom-o.height):i=t.bottom-o.height,Kt(e,o.top-i)}function De(e,t){const o=getComputedStyle(e);for(const n of o)t.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=e.children,r=t.children;for(let n=0;n<i.length;n+=1)r[n]&&De(i[n],r[n])}function Qt(e){e.removeAttribute("id"),e.querySelectorAll("[id]").forEach(t=>t.removeAttribute("id"))}function Zt(e,t){const o=e.querySelectorAll("input, textarea, select"),i=t.querySelectorAll("input, textarea, select");o.forEach((r,n)=>{const a=i[n];a&&(r.type==="checkbox"||r.type==="radio"?a.checked=r.checked:a.value=r.value)})}function Xt(e,t={}){if(!e||!e.isConnected||t.disabled||!$(e))return null;const i=e.cloneNode(!0);Qt(i),De(e,i),Zt(e,i),i.setAttribute(t.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(t.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",t.prepareClone?.(i,e);const r=e.style.visibility;t.hideSource&&(e.style.visibility="hidden"),document.body.appendChild(i);const n=()=>{const s=$(e);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),t.hideSource&&(e.style.visibility=r)};return n(),{element:i,source:e,update:n,destroy:a}}function eo({tooltip:e,panel:t,target:o,anchor:i,spotlight:r,options:n={}}){if(!e||!t||!o)return null;let a=0,s=!1,c=!1,g=!1,x="";const y=(l=!0)=>{if(s||!e.isConnected||!o.isConnected)return null;const u=Gt(n),w=`${u.left}:${u.top}:${u.width}:${u.height}`;x&&x!==w&&(c=!1,l=!0),x=w;const p=$(i)||$(o),f=$(o);if(!p||!f)return null;const h=Math.min(Number(n.maxWidth||380),u.width);e.style.position="fixed",e.style.right="auto",e.style.bottom="auto",e.style.width=`${h}px`,e.style.maxWidth=`${h}px`,e.style.margin="0",e.style.justifyContent="flex-start",t.style.maxHeight=`${Math.max(120,u.height)}px`;const v=Math.min(t.offsetHeight||e.offsetHeight||190,u.height),b=Number(n.gap??Nt);l&&!c&&n.autoScroll!==!1&&f.height+v+b<=u.height&&(c=fe(o,u),c&&requestAnimationFrame(()=>y(!1)));const k=_t(n.preferredPlacement).map((z,L)=>{const W=Yt(z,p,h,v,b),Ie=Ut(W,u),Ce=jt(W,f);return{placement:z,index:L,raw:W,overflow:Ie,overlap:Ce,score:Ie*1e5+Ce*100+L}}),T=k.find(z=>z.overflow<.5&&z.overlap<1),A=T||k.slice().sort((z,L)=>z.score-L.score)[0],C=n.forceDock===!0||!T;let M="floating",F;if(C){M="docked";const z=Math.min(v,Number(n.dockMaxHeight||Math.max(180,u.height*.42)),u.height);t.style.maxHeight=`${z}px`;const L=Math.min(t.offsetHeight||z,z);if(F=R(u.left+(u.width-h)/2,u.bottom-L,h,L),l&&!c&&n.autoScroll!==!1){const W=R(u.left,u.top,u.width,Math.max(60,F.top-b-u.top));c=fe(o,W),c&&requestAnimationFrame(()=>y(!1))}}else if(F=Wt(A.raw,u),l&&!c&&n.autoScroll!==!1){let z=u;if(A.placement==="bottom")z=R(u.left,u.top,u.width,Math.max(60,F.top-b-u.top));else if(A.placement==="top"){const L=F.bottom+b;z=R(u.left,L,u.width,Math.max(60,u.bottom-L))}c=fe(o,z),c&&requestAnimationFrame(()=>y(!1))}return e.dataset.tourLayoutMode=M,e.dataset.tourPlacement=C?"bottom-dock":A.placement,e.style.left=`${F.left}px`,e.style.top=`${F.top}px`,r?.update?.(),n.onLayout?.({mode:M,placement:e.dataset.tourPlacement,viewport:u,targetRect:$(o),anchorRect:$(i)||$(o),tooltipRect:F}),{mode:M,placement:e.dataset.tourPlacement,rect:F}},E=(l=!1)=>{g=g||l===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const u=g;g=!1,y(u)}))},I=()=>{c=!1,E(!0)},V=typeof ResizeObserver=="function"?new ResizeObserver(E):null;V?.observe(o),i&&i!==o&&V?.observe(i),V?.observe(t),window.addEventListener("resize",I),window.addEventListener("orientationchange",I),window.addEventListener("scroll",E,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",I),window.visualViewport.addEventListener("scroll",E));const me=()=>{s=!0,a&&cancelAnimationFrame(a),V?.disconnect(),window.removeEventListener("resize",I),window.removeEventListener("orientationchange",I),window.removeEventListener("scroll",E,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",I),window.visualViewport.removeEventListener("scroll",E))},m=y(!0);return{destroy:me,reposition:()=>y(!1),result:m}}function U(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function re(...e){return U("setFilter")?.(...e)}function Me(...e){return U("setBookingsSubview")?.(...e)}function to(...e){return U("toast")?.(...e)}function ae(...e){return U("updateGoLiveBanner")?.(...e)}function oo(...e){return U("seedTourRevenueShell")?.(...e)}function io(...e){return U("finishTourHydration")?.(...e)}function no(...e){return U("goLive")?.(...e)}let Z=null,se=null,_=null;function q(){if(document.getElementById("frontdeskTourPolishStyle"))return;const e=document.createElement("style");e.id="frontdeskTourPolishStyle",e.textContent=`
  ...
  `,document.head.appendChild(e)}function ke(){Z&&(document.removeEventListener("keydown",Z),Z=null)}function ro(e){ke(),Z=t=>{if(t.defaultPrevented)return;const o=t.target&&t.target.tagName?t.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||t.target?.isContentEditable||(t.key==="Escape"?(t.preventDefault(),e.onSkip?.()):t.key==="Enter"||t.key==="ArrowRight"?(t.preventDefault(),e.onNext?.()):t.key==="ArrowLeft"&&(t.preventDefault(),e.onBack?.()))},document.addEventListener("keydown",Z)}function he(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function D(e){q();const t=e||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=t.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=t.blockPointer?"auto":"none",t.lockScroll&&(document.body.style.overflow="hidden"),o}const te="rgba(17,24,39,0.42)";function J(){const e=document.getElementById("tourTooltip"),t=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!e||t)return Promise.resolve();e.style.pointerEvents="none";const o=e.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function ao(e,t){return _?.destroy(),_=Xt(e,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=t?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=t?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=t?.spotlightOutlineOffset??"2px",t?.spotlightBackground&&(o.style.background=t.spotlightBackground,o.style.backgroundColor=t.spotlightBackground),t?.spotlightBorderRadius&&(o.style.borderRadius=t.spotlightBorderRadius)}}),_?.element||null}function H(e){const t=e||{};ke(),se?.destroy(),se=null,_?.destroy(),_=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!t.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.style.opacity=n.dataset.tourOrigOpacity||"";const a=n.dataset.tourOrigBackground||"",s=n.dataset.tourOrigBackgroundColor||"";s?n.style.backgroundColor=s:n.style.removeProperty("background-color"),a?n.style.background=a:n.style.removeProperty("background"),n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius,delete n.dataset.tourOrigOpacity});const r=document.getElementById("goLiveBanner");r&&r.dataset.tourHidden&&(delete r.dataset.tourHidden,typeof ae=="function"&&ae()),t.keepOverlay||(document.body.style.overflow="")}function so(){const e=document.getElementById("tourTooltip"),t=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[e,...t,...o].filter(Boolean);return!i.length&&!o.length?(H({keepOverlay:!0}),Promise.resolve()):(ke(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(H({keepOverlay:!0}),Promise.resolve()):(e&&(e.style.pointerEvents="none"),i.forEach(n=>{n.style.transition="opacity 0.07s ease, transform 0.07s ease",n.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(n=>{n.style.opacity="0",n.id==="tourTooltip"&&(n.style.transform="translateY(4px)")})}),new Promise(n=>{setTimeout(()=>{H({keepOverlay:!0}),n()},85)})))}function lo(e){const t=[e,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);t.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{t.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function G(e,t){if(!t.openAccordion)return;const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function j(e){if(!e)return null;for(const t of String(e).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(t);if(o&&o.isConnected)return o}return null}function K(e,t){if(t.highlightSelector){const o=j(t.highlightSelector);if(o)return o}if(t.highlightCard){const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(o)return o}return t.targetParent&&(e.closest(".booking-card")||e.closest(".accordion-body"))||e}function oe(e,t){if(!t)return e;const o=String(t.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const r=document.querySelector(i);if(r&&r.isConnected)return r}if(t.accordionCard){const i=document.querySelector(t.accordionCard);if(i&&i.isConnected)return i}return e&&e.isConnected?e:null}function de(e,t){if(!e||!e.isConnected)return null;const o=e.getBoundingClientRect();return o.width<2||o.height<2||!t&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function $e(e,t){const o=j(e.anchorSelector);if(o){const i=de(o,!0);if(i)return i}return de(t,!0)}function Re(e,t){const o=e.tooltipAnchorSelector||e.anchorSelector,i=j(o);if(i){const r=de(i,!0);if(r)return r}return $e(e,t)}function le(e){const t=e||"auto";try{window.scrollTo({top:0,left:0,behavior:t})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const r=document.querySelector(i);r&&(r.scrollTop=0)})}function Fe(e,t,o){const i=o||{},r=t.scrollTarget||t.accordionCard,n=(r?j(r):null)||e;if(!n&&!t.scrollToTop)return Promise.resolve();const a=t.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=i.smooth&&!s?"smooth":d.settingsTourActive||s?"auto":"smooth";return new Promise(g=>{if(t.scrollToTop&&(le(c),t.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{t.forcePageTop&&le("auto"),g()}));return}if(!n){g();return}if(n.scrollIntoView({behavior:c,block:a,inline:"nearest"}),c==="auto"){requestAnimationFrame(()=>requestAnimationFrame(g));return}let x=!1;const y=()=>{x||(x=!0,window.removeEventListener("scrollend",E),clearTimeout(I),requestAnimationFrame(()=>requestAnimationFrame(g)))},E=()=>y();"onscrollend"in window&&window.addEventListener("scrollend",E,{once:!0});const I=setTimeout(y,520)})}function He(){H(),localStorage.setItem("settingsTourStep","handoff");const e=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&re("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const r=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof r=="function"&&r({chainFromSettingsTour:!0})},t=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof t=="function"?t().then(e).catch(e):e()}function Q(){H({keepOverlay:!0}),q(),d.settingsTourActive=!1,ae(),D({blockPointer:!0,lockScroll:!0,dim:te});const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    `,t?.subscribed&&!O()&&(g+=`
      ...
      `),g+=qe(),g+=je(o),e.innerHTML=g,window.refreshSupportSummary?.()}catch{e.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function co(){const e=document.getElementById("settings-booking-url");e&&navigator.clipboard.writeText(e.value).then(()=>{localStorage.setItem("linkCopied","1"),X(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function po(){localStorage.setItem("settingsTourDone","1");const e=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",e);let t=0;const o=setInterval(()=>{t++;const i=document.getElementById("edit-rate-nightly");if(i||t>20){if(clearInterval(o),!i)return;const r=i.closest(".accordion-body");if(r&&r.style.display==="none"){r.style.display="block";const n=r.previousElementSibling?.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const n=document.getElementById("checklistPointer");n&&n.remove();const a=i.getBoundingClientRect(),s=document.createElement("div");s.id="checklistPointer",s.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${a.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,s.innerHTML=`
          ...
          `,document.body.appendChild(s),setTimeout(()=>{const c=document.getElementById("checklistPointer");c&&c.remove()},6e3)},1e3)},100)}},200)}function uo(){const t="https://"+(d.activeHotelDomain||d.activeHotelId+".mktel.co");navigator.clipboard.writeText(t).then(()=>{localStorage.setItem("linkCopied","1"),X(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function go(e,t){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const r=setInterval(()=>{i++;const n=document.querySelector(e);if(n||i>20){if(clearInterval(r),!n)return;n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const s=n.getBoundingClientRect(),c=document.createElement("div");c.id="checklistPointer",c.style.cssText=`
      ...
      <div style="background:white;border-radius:20px;padding:28px 24px;max-width:340px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.2);">
        ...
        <div style="background:#1a1a2e;border-radius:12px;padding:16px 18px;color:#fff;font-size:13px;line-height:1.55;box-shadow:0 8px 32px rgba(0,0,0,0.35);">
          ...
          <button type="button" id="postActivationTourNext" style="width:100%;padding:12px;border-radius:10px;border:none;background:#2E7D5B;color:#fff;font-family:inherit;font-size:14px;font-weight:700;cursor:pointer;">${E?"Open Guest App":"Next tab →"}</button>
    ...
    <div style="background:white;border-radius:22px;padding:32px 24px 22px;max-width:380px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.25);">
      ...
      ${i}
      <p style="font-size:12px;color:#7a857e;line-height:1.45;margin:10px 4px 4px;">${o?"Manage bookings, availability and alerts from your phone.":"Your booking page is live. The web Front Desk is ready now."}</p>
  ...
  `),window.setNativeModalOpen?.("edit-add-room",!0),requestAnimationFrame(()=>document.getElementById("editNewRoomName")?.focus()))}function ot(){document.getElementById("editAddRoomModal")?.remove(),window.setNativeModalOpen?.("edit-add-room",!1)}async function _o(){const e=document.getElementById("editNewRoomName"),t=document.querySelector("#editAddRoomModal .edit-add-room-actions .primary"),o=e?.value.trim()||"";if(!o)return;e&&(e.disabled=!0),t&&(t.disabled=!0,t.textContent="Adding…");const i=5;try{const r=await api("POST","/api/crm/rooms",{name:o,maxOccupancy:4,totalUnits:i});if(!r?.success||!r.room?.id)throw new Error(r?.message||"Failed to add room");const n={id:r.room.id,name:r.room.name||o,description:"",amenities:"",maxOccupancy:4,totalUnits:i,imageUrl:null,images:[]},a=d.editRooms.findIndex(g=>g.id===n.id);a>=0?d.editRooms=d.editRooms.map((g,x)=>x===a?n:g):d.editRooms=[...d.editRooms,n];const s=d.manualAvailability||{rooms:[],overrides:{}};Array.isArray(s.rooms)||(s.rooms=[]),(!s.overrides||typeof s.overrides!="object")&&(s.overrides={}),s.rooms.some(g=>g.name===n.name)||(s.rooms=[...s.rooms,{name:n.name,totalUnits:i}].sort((g,x)=>String(g.name).localeCompare(String(x.name)))),d.manualAvailability=s,d.manualSelectedRoom||(d.manualSelectedRoom=n.name),ot(),N(),window.refreshRoomBadge?.(),toast("Room added","success"),Ae({render:!0}).catch(()=>{}),window.loadManualAvailability?.({silent:!0})?.catch(()=>{})}catch(r){e&&(e.disabled=!1),t&&(t.disabled=!1,t.textContent="Add room"),toast(r.message||"Failed to add room","error")}}const it={addAmenityPrompt:zo,advanceTourIfNeeded:X,changePin:Mo,checklistGoTo:go,checklistGoToRates:po,cleanupPostActivationTourUi:ce,cleanupSettingsTourUi:H,cancelAccountDeletion:Fo,closeAmenityPicker:pe,closeEditAddRoom:ot,confirmAmenityPicker:To,confirmEditAddRoom:_o,copyBookingLink:Ro,copyBookingLinkFromChecklist:uo,deleteEditImage:Uo,deleteEditRoom:Vo,ensureTourBlurOverlay:D,finishPostActivationTour:ne,getAmenityIcon:Ke,getCrmAuthToken:Ee,getEditRoomImages:We,goLive:be,guestBookingEngineUrl:Ge,handoffToGuestAppsTour:He,hideGoLiveOverlay:ve,loadEditRooms:So,loadSettings:Ue,openAmenityPicker:Ze,openBillingPortal:Do,openEditAddRoom:Go,openGuestBookingEngine:vo,openPreviewSite:Ve,openTourAccordion:G,postRoomImageUpload:Se,queryTourSelector:j,requestAccountDeletion:$o,removeAmenity:Io,renderEditRooms:Be,renderEditRoomsCards:N,refreshEditRoomsData:Ae,replayWalkthrough:ko,resolveLiveTourElement:oe,resolveTourHighlightEl:K,restoreAppIconPreview:we,saveEditRoom:No,saveHotelInfo:Co,saveRates:Po,selectPageUtility:Oo,scrollTourTargetIntoView:Fe,sendSupportMessage:Ho,setAppIconPreviewImage:ze,setAppIconPreviewLoading:tt,settingsChangePin:ho,settingsCopyLink:co,settingsSaveRates:fo,settingsSendSupport:xo,settingsUploadPhoto:mo,showActivatedModal:Eo,showEditRoomPhoto:Je,showFinaleMockModal:Q,showGoLiveOverlay:Xe,showOnboardingQuestions:wo,showTestDriveModal:Ne,showWelcomeModal:_e,squareCropImage:et,startPostActivationTabTour:Ye,startSettingsTour:ye,stepEditRoomPhoto:Bo,toggleAmenityPreset:Ao,toggleSection:Lo,tourAnchorRect:$e,tourElementRect:de,updatePreviewSiteBar:bo,uploadAppIcon:jo,uploadEditImages:qo};function Yo(){Ft(it)}const Qo=Object.freeze(Object.defineProperty({__proto__:null,default:it,install:Yo},Symbol.toStringTag,{value:"Module"}));export{eo as a,Xt as b,d as c,Wo as d,Ft as e,Qo as f,Ko as i,Jo as s};
