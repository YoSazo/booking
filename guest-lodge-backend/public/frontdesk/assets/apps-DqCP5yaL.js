import{c as n,a as we,b as ke,e as Se}from"./settings-upW4UXde.js";function v(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function ee(...e){return v("ensureAppsViewRendered")?.(...e)}function te(...e){return v("showFinaleMockModal")?.(...e)}function oe(...e){return v("finishTourHydration")?.(...e)}function ie(...e){return v("goLive")?.(...e)}function ae(...e){return v("toast")?.(...e)}function Ce(...e){return v("appsCloseLightbox")?.(...e)}let F=[],d=0,P=!1,$=null,O=null,W=null,C=null;function Te(){if(document.getElementById("frontdeskAppsTourStyle"))return;const e=document.createElement("style");e.id="frontdeskAppsTourStyle",e.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(e)}function k(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function re(){$&&(document.removeEventListener("keydown",$),$=null)}function Ie(e){re(),$=t=>{if(t.defaultPrevented)return;const o=t.target&&t.target.tagName?t.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||t.target?.isContentEditable||(t.key==="Escape"?(t.preventDefault(),e.onSkip?.()):t.key==="Enter"||t.key==="ArrowRight"?(t.preventDefault(),e.onNext?.()):t.key==="ArrowLeft"&&(t.preventDefault(),e.onBack?.()))},document.addEventListener("keydown",$)}function ze(e,t){return!e||!e.isConnected||t?.noHighlight?null:(e.dataset.appsTourOrigVisibility||(e.dataset.appsTourOrigVisibility=e.style.visibility||""),C?.destroy(),C=ke(e,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=t?.spotlightBoxShadow??"none",o.style.outline=t?.spotlightOutline??"none",o.style.outlineOffset=t?.spotlightOutlineOffset??"0",(e.classList.contains("apps-story-line")||t?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),C?.element||null)}function ne(e){const t=e||{};re(),W?.destroy(),W=null,C?.destroy(),C=null,O&&(clearTimeout(O),O=null);const o=document.getElementById("appsTourLightbox");o&&!t.keepLightbox&&o.remove();const a=document.getElementById("appsTourTooltip");a&&a.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function f(e){ne(),document.body.style.overflow="";const t=P;P=!1;try{const o=typeof ee=="function"?ee:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(e&&(localStorage.setItem("appsTourDone","1"),t||localStorage.getItem("settingsTourStep")==="handoff"||n.settingsTourActive)){const a=typeof te=="function"?te:window.showFinaleMockModal;if(typeof a=="function"){a();return}}}function Ge(e){const t=d+e;t<0||t>=F.length||(d=t,T())}function q(){if(localStorage.setItem("appsTourDone","1"),P||localStorage.getItem("settingsTourStep")==="handoff"||n.settingsTourActive){n.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const t=typeof oe=="function"?oe:window.finishTourHydration;typeof t=="function"&&t()}}function _e(){q();const e=typeof ie=="function"?ie:window.goLive;if(f(!1),typeof e=="function"){e();return}const t=typeof ae=="function"?ae:window.toast;typeof t=="function"&&t("Open Go live to activate your booking page.","error")}function T(){Te();const e=F[d];if(!e){f(!0);return}const t=F.length,o=d>=t-1,a=`${d+1} / ${t}`,i=Math.max(8,Math.min(100,Math.round((d+1)/t*100))),r=document.querySelector(e.target);if(!r){d++,T();return}ne({keepLightbox:!0});let s=document.getElementById("appsTourLightbox");s||(s=document.createElement("div"),s.id="appsTourLightbox",s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(s)),e.noHighlight||(r.dataset.appsTourOrigPosition=r.style.position||"",r.dataset.appsTourOrigZIndex=r.style.zIndex||"",r.dataset.appsTourOrigIsolation=r.style.isolation||"",r.dataset.appsTourOrigBoxShadow=r.style.boxShadow||"",r.dataset.appsTourOrigOutline=r.style.outline||"",r.dataset.appsTourOrigOutlineOffset=r.style.outlineOffset||"",r.dataset.appsTourOrigTransition=r.style.transition||"",r.style.position=r.style.position||"relative",r.style.zIndex="100002",r.style.isolation="isolate",r.style.transition="box-shadow 0.18s ease, outline 0.18s ease",r.style.boxShadow=e.spotlightBoxShadow??"none",r.style.outline=e.spotlightOutline??"none",r.style.outlineOffset=e.spotlightOutlineOffset??"0",(r.classList.contains("apps-story-line")||e.hideSpotlightBorder)&&(r.dataset.appsTourOrigBorderTop=r.style.borderTop||"",r.dataset.appsTourOrigPaddingTop=r.style.paddingTop||"",r.style.borderTop="none",r.style.paddingTop="0"),r.setAttribute("data-apps-tour-highlighted","1"));const l=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,w=e.scrollBlock||"nearest",x=l?"auto":"smooth";r.scrollIntoView({behavior:x,block:w});const u=()=>{const p=document.getElementById("appsTourTooltip");p&&p.remove();const g=Math.min(370,window.innerWidth-28),b=e.primaryLabel||(o?"Done":"Next"),V=e.secondaryLabel||(o?"Not now":"Skip tour"),A=d<=0,X=e.kicker||"Guestel",h=document.createElement("div");h.id="appsTourTooltip",h.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${g}px;max-width:${g}px;visibility:hidden;`,h.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${k(e.title)}">
        ...
        <div class="apps-tour-kicker">${k(X)}</div>
        <div class="apps-tour-title">${k(e.title)}</div>
        <p class="apps-tour-copy">${k(e.text)}</p>
        <div class="apps-tour-actions">
          <button type="button" id="appsTourBackBtn" class="apps-tour-btn" ${A?"disabled":""}>Back</button>
       ...
       </video>`,s=o>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",l=o>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",w=o>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${w}
    </div>`}function le(){return`<svg viewBox="169 8.5 21 25.5" focusable="false" aria-hidden="true">
  ...
  </svg>`}function de(){return`<svg viewBox="45 41.5 19 6" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Ae(){return`<svg viewBox="44 39.5 21 13" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Le(){return`<svg viewBox="0 0 28 28" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Me(e,t){const o=[...e?[{label:"More",icon:de()}]:[],{label:"Share",icon:le()},...t?[{label:"View More",icon:Ae()}]:[],{label:"Add to Home Screen",icon:Le()}];return`<div class="agic-sequence" aria-label="${o.map(a=>a.label).join(", then ")}">
  ...
  </div>`}function ce(){const e=N==="ios26",t=z==="compact",i=e&&!z?`
    <div class="agic-content agic-choice">
      ...
      <button type="button" onclick="appsGuestInstallCoachSelectLayout('standard')">
        <span class="agic-choice-glyph">${le()}</span>
    ...
    <section class="agic-sheet" role="dialog" aria-modal="true" aria-label="How guests save your property to their Home Screen">
      ...
      ${i}
    </section>`}function ge(){const e=document.getElementById("appsGuestInstallCoach");e&&(e.innerHTML=ce())}function Oe(){f(!1),Z(),document.getElementById("appsGuestInstallCoach")?.remove(),N="ios26",z=null,pe=document.body.style.overflow,document.body.style.overflow="hidden",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),E=t=>{t.key==="Escape"&&ue()},document.addEventListener("keydown",E);const e=document.createElement("div");e.id="appsGuestInstallCoach",e.innerHTML=ce(),document.body.appendChild(e)}function ue(){E&&(document.removeEventListener("keydown",E),E=null),document.getElementById("appsGuestInstallCoach")?.remove(),document.body.style.overflow=pe,isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState())}function He(e){N=e==="classic"?"classic":"ios26",z=N==="classic"?"standard":null,ge()}function Fe(e){z=["standard","compact"].includes(e)?e:null,ge()}function he(e,t){const o=e||"Video";return`<span class="${"apps-media-badge"+(t==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function B(e,t,o,a,i){const r=i?he("Video"):"",s=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${a})">
    ...
    <div class="apps-step-card" id="tour-native-guest-share">
      ...
      <div class="guestel-wallet-editor">
        <div class="guestel-wallet-card" aria-label="Preview of ${S(t)} in Guestel">
          <div class="guestel-wallet-cover${y?" has-image":""}" id="guestelWalletPreviewImage">${y?`<img src="${S(y)}" alt="Guestel wallet cover">`:"<span>Choose a cover photo</span>"}</div>
        ...
        <div class="guestel-wallet-actions">
          <button type="button" id="guestelWalletImageButton" onclick="document.getElementById('guestelWalletImageInput').click()">${y?"Change cover":"Choose cover"}</button>
          <button type="button" id="guestelWalletImageRemove" class="quiet" onclick="resetGuestelWalletImage()"${y?"":" hidden"}>Use room photo</button>
        </div>
    ...
    ${guestBroadcastCardHtml({compact:!0})}`,_=!!String(n.frontdeskAppStoreUrl||"").trim(),ye=b?M:`
    ...
    </section>`,J=b?"":m?"Front Desk is installed. Guests use Guestel; owners use Marketel Front Desk.":"You use Marketel Front Desk. Guests use Guestel.";e.innerHTML=`
  <style>
  ...
  <div class="apps-page">
    ...
    ${J?`<p class="apps-footnote">${J}</p>`:""}

  </div>`,typeof lucide<"u"&&lucide.createIcons(),b&&(n.guestMessages.length?renderMessages():loadMessages(),Q(),be())}async function be(){try{const e=await api("GET","/api/crm/booking-review-settings");if(!e?.success||!e.data)return;n.bookingReviewSettings=e.data;const t=document.getElementById("bookingReviewReminderSelect");t&&(t.value=String(e.data.reminderMinutes))}catch{}}async function je(e){const t=String(n.bookingReviewSettings?.reminderMinutes??15),o=parseInt(e?.value,10);if([0,15,30,60].includes(o)){e&&(e.disabled=!0);try{const a=await api("POST","/api/crm/booking-review-settings",{reminderMinutes:o});if(!a?.success)throw new Error(a?.message||"Could not save reminder timing.");n.bookingReviewSettings=a.data,toast(o===0?"Booking reminders off — the first alert will still arrive.":`Booking reminders set for every ${o===60?"hour":o+" minutes"}.`,"success")}catch(a){e&&(e.value=t),toast(a?.message||"Could not save reminder timing.","error")}finally{e&&(e.disabled=!1)}}}async function Q(){const e=document.getElementById("guestInstallStats");try{const t=await api("GET","/api/crm/guest-install-stats");if(!t.success)throw new Error(t.message||"Failed");if(n.guestPushSubscriberCount=t.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!e)return;const o=t.totals||{},a=t.installedBookings||0,i=o.views||0,r=o.notification_prompts||0,s=t.guestPushSubscribers||0,l=t.guestelSavedDevices||0,w=t.guestelBroadcastSubscribers||0;if(!a&&!i&&!t.guestelSavedDevices&&!t.guestelBroadcastSubscribers){e.style.display="none",e.innerHTML="";return}e.style.display="block";const x=t.installRatePercent!=null?t.installRatePercent:0,u=Object.entries(t.byTouchpoint||{}).filter(function(p){return p[1].views||p[1].installed}).sort(function(p,g){return(g[1].installed||0)-(p[1].installed||0)}).slice(0,5),m=u.length?u.map(function(p){const g=p[0].replace(/-/g," "),b=p[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+g+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(b.views||0)+" views · "+(b.installed||0)+" installed</span></div>"}).join(""):"";e.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guestel activity</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+l+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">devices keeping your property</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+w+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">Guestel devices opted into updates</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">total reachable devices</div></div></div>'+(a||i||x?'<div style="font-size:10px;color:var(--text-muted);line-height:1.45;margin:-2px 0 10px;">Legacy Home Screen activity remains supported for existing installs: '+a+" confirmed installs · "+i+" install views · "+x+"% of recent bookings.</div>":"")+(r?'<div style="font-size:11px;color:var(--text-muted);margin:-2px 0 10px;">Notification permission: '+(o.notification_granted||0)+" granted · "+(o.notification_denied||0)+" denied · "+(o.notification_dismissed||0)+" dismissed · "+(o.notification_failed||0)+" failed</div>":"")+(m?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+m:"")}catch{n.guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),e&&(e.style.display="none",e.innerHTML="")}}const qe={appsCloseLightbox:Z,appsCloseGuestInstallCoach:ue,appsCloudinaryFull:se,appsCloudinaryImg:Y,appsLbNav:H,appsLbRender:K,appsOpenLightbox:Ee,appsOpenGuestInstallCoach:Oe,appsPhoneImgStyle:R,appsQuestionRow:B,appsGuestInstallCoachSelectLayout:Fe,appsGuestInstallCoachSetVersion:He,appsTourClose:f,appsTourNav:Ge,appsTourRender:T,appsVideoBadgeHtml:he,detectAppPlatform:Pe,ensureAppsViewRendered:Ve,loadBookingReviewSettings:be,loadGuestInstallStats:Q,renderAppsView:me,resetGuestelWalletImage:Ne,saveBookingReviewReminderSetting:je,saveGuestelWalletCard:We,startAppsTour:Be,updateGuestelWalletPreview:xe,uploadGuestelWalletImage:De};function Ye(){Se(qe)}export{qe as default,Ye as install};
