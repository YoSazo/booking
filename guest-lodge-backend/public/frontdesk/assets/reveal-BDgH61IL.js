import{c as r,e as L}from"./settings-BVJy4Woh.js";const b="marketelValueRevealPendingV1",f="marketelValueRevealStepV1";let i=0,c="guest",p=!1,d={rooms:[],rates:null},h=null,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},v=0;const A="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/46/2a/e1/462ae1c9-9347-efd0-5e99-41e7f636e3f7/phone-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg",M="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/23/4c/cb/234ccbb4-e65a-bb94-f877-3d230743e9e3/safari-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg";function $(){const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e==="0.0.0.0"||e==="::1"||e.endsWith(".local")||/^10\./.test(e)||/^192\.168\./.test(e)||/^172\.(1[6-9]|2\d|3[01])\./.test(e)}function o(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function H(e){const t=Number(e);return Number.isFinite(t)?new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:Number.isInteger(t)?0:2}).format(t):"$99"}function s(){return r.activeHotelName||"Your Property"}function k(){return d.rooms[0]||r.editRooms[0]||{name:"Your first room",totalUnits:1,images:[]}}function T(){const e=k();return e.images?.[0]?.url||e.imageUrl||""}function D(){return d.rates?.nightly||99}function w(){if($()&&r.activeHotelId){const a=new URL(window.location.href);return a.port="5173",a.pathname="/",a.search="",a.hash="",a.searchParams.set("hotelId",r.activeHotelId),a.searchParams.set("preview","1"),a.toString()}const e=n.domain||r.activeHotelDomain||"";if(!e)return"";const t=new URL(`https://${e}/`);return r.activeHotelId&&t.searchParams.set("hotelId",r.activeHotelId),t.searchParams.set("preview","1"),t.toString()}function F(){const e=new URL(window.location.href);return e.search="",e.hash="",r.activeHotelId&&e.searchParams.set("hotelId",r.activeHotelId),e.searchParams.set("previewEditor","1"),e.toString()}function I(e=""){const t=r.activeHotelAppIcon||T(),a=s().trim().charAt(0).toUpperCase()||"M";return t?`<img class="${e}" src="${o(t)}" alt="">`:`<span class="${e}">${o(a)}</span>`}function N(){if(!r.hotelSubscribed)try{localStorage.setItem(b,"1"),localStorage.setItem(f,String(i))}catch{}}function m(e,t=""){typeof window.api=="function"&&window.api("POST","/api/crm/value-reveal-event",{eventName:e,contentName:t}).catch(()=>{})}function V(){try{const e=new URL(window.location.href);e.searchParams.delete("welcome"),e.searchParams.delete("reveal"),window.history.replaceState({},"",e.pathname+e.search+e.hash)}catch{}}function P(e){typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(e)}function R(e){if(e?.data?.type!=="marketel:show-guest-app")return;const t=document.getElementById("marketelValueReveal");!t||!Array.from(t.querySelectorAll("iframe")).some(l=>l.contentWindow===e.source)||(document.getElementById("mvrLivePreview")?.remove(),m("GuestAppPreviewRequestedFromBookingEngine"),y(1))}function x(){return`<div class="mvr-progress" aria-label="Marketel overview progress">
    ${["Booking page","Guest app","Front Desk",r.hotelSubscribed?"Complete":"Activate"].map((t,a)=>`<div class="mvr-progress-item ${a===i?"is-active":""} ${a<i?"is-done":""}">
  ...
  </section>`}function E(e,t){return`<img class="mvr-ios-system-icon" src="${o(e)}" alt="${o(t)}">`}function G(){return`<section class="mvr-stage mvr-stage-app">
    <div class="mvr-copy">
    ...
    <div class="mvr-visual mvr-assistant-visual">
      <div class="mvr-booking-alert">
        ...
        <div><span>Front Desk</span><strong>New ${o(e)} booking</strong><small>Tomorrow · ${H(D())}</small></div>
        <b>now</b>
      </div>
      <div class="mvr-chat">
  ...
  </section>`}function q(){return i===0?C():i===1?G():i===2?U():O()}function z(){if(i===3)return`<div class="mvr-footer mvr-footer-final">
    ...
    ${z()}
  </div>`,J())}function K(){const e=w();if(!e||document.getElementById("mvrLivePreview"))return;c="guest";const t=document.createElement("div");t.id="mvrLivePreview",t.className="mvr-live-preview",t.innerHTML=`<div class="mvr-live-toolbar">
  ...
  <iframe title="${o(s())} live preview" src="${o(e)}" sandbox="allow-scripts allow-same-origin allow-forms allow-modals"></iframe>`,document.getElementById("marketelValueReveal")?.appendChild(t),document.getElementById("mvrClosePreview")?.addEventListener("click",()=>t.remove()),t.querySelectorAll("[data-live-preview-mode]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.livePreviewMode==="edit"?"edit":"guest";if(l===c)return;c=l,t.querySelectorAll("[data-live-preview-mode]").forEach(S=>{S.classList.toggle("is-active",S.dataset.livePreviewMode===c)});const u=t.querySelector("iframe");u&&(u.title=c==="edit"?`${s()} Front Desk editor`:`${s()} booking-page preview`,u.src=c==="edit"?F():w()),c==="edit"&&m("BookingEngineEditPreviewViewed")})}),m("BookingEngineFullPreviewOpened")}function y(e){i=Math.max(0,Math.min(3,e)),N(),m(["BookingEngineRevealViewed","GuestAppRevealViewed","AssistantRevealViewed","ActivationOfferViewed"][i]),g(),document.querySelector(".mvr-main")?.scrollTo({top:0,behavior:"auto"})}function W(){v&&(window.clearTimeout(v),v=0),document.getElementById("marketelValueReveal")?.remove(),document.documentElement.classList.remove("marketel-reveal-open"),document.body.style.overflow="",window.removeEventListener("message",R),r.settingsTourActive=!1;try{localStorage.removeItem(b),localStorage.removeItem(f),localStorage.setItem("settingsTourDone","1"),localStorage.setItem("onboardingDone","1")}catch{}V(),P(!0),typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner(),typeof window.refreshGoLiveInlineCard=="function"&&window.refreshGoLiveInlineCard()}async function j(e){if(r.hotelSubscribed){W();return}if(typeof window.goLive=="function"){e.disabled=!0,e.textContent="Opening secure checkout…",m("ActivationCtaClicked");try{await window.goLive()}finally{document.body.contains(e)&&(e.disabled=!1,e.textContent="Activate Marketel — $199/month")}}}function J(){document.getElementById("mvrNext")?.addEventListener("click",()=>y(i+1)),document.getElementById("mvrBack")?.addEventListener("click",()=>y(i-1)),document.getElementById("mvrExpandPreview")?.addEventListener("click",K),document.getElementById("mvrFinalCta")?.addEventListener("click",e=>j(e.currentTarget)),document.getElementById("mvrInstallDemo")?.addEventListener("click",()=>{p||(p=!0,m("GuestAppInstallDemoClicked"),g())})}async function Q(){return h||typeof window.api!="function"||(h=window.api("GET","/api/crm/rooms").then(e=>(d={rooms:Array.isArray(e?.rooms)?e.rooms:[],rates:e?.rates||null},d.rooms.length&&(r.editRooms=d.rooms),document.getElementById("marketelValueReveal")&&!document.getElementById("mvrLivePreview")&&g(),d)).catch(()=>d).finally(()=>{h=null})),h}async function B(){if(!(typeof window.api!="function"||!document.getElementById("marketelValueReveal"))){if($()){n={ready:!!w(),checking:!1,reason:"local",attempts:1,domain:""},i===0&&!document.getElementById("mvrLivePreview")&&g();return}n.checking=!0,n.attempts+=1;try{const e=await window.api("GET","/api/crm/booking-page-status");n={ready:!!e?.ready,checking:!1,reason:String(e?.reason||""),attempts:n.attempts,domain:String(e?.domain||"")}}catch{n.checking=!1,n.reason="unreachable"}i===0&&!document.getElementById("mvrLivePreview")&&g(),!(n.ready||n.reason==="deployment-disabled")&&n.attempts<10&&document.getElementById("marketelValueReveal")&&(v=window.setTimeout(B,6e3))}}function X(e={}){if(document.getElementById("marketelValueReveal"))return;const t=Number(e.startAt);let a=0;try{a=Number.parseInt(localStorage.getItem(f)||"0",10)}catch{}if(i=Number.isFinite(t)?Math.max(0,Math.min(3,t)):Math.max(0,Math.min(3,Number.isFinite(a)?a:0)),r.hotelSubscribed&&i===3&&(i=0),c="guest",p=!1,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},v&&window.clearTimeout(v),v=0,!r.hotelSubscribed)try{localStorage.setItem(b,"1"),localStorage.setItem(f,String(i))}catch{}try{localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep")}catch{}r.settingsTourActive=!0,window.addEventListener("message",R),document.documentElement.classList.add("marketel-reveal-open"),document.body.style.overflow="hidden",P(!1);const l=document.createElement("div");l.id="marketelValueReveal",l.className="mvr-root",document.body.appendChild(l),g(),m("ValueRevealStarted",r.hotelSubscribed?"subscribed-replay":"pre-activation"),y(i),Q(),B()}function Z(){try{return localStorage.getItem(b)==="1"}catch{return!1}}function ee(){try{localStorage.removeItem(b),localStorage.removeItem(f)}catch{}}const te={clearPendingMarketelValueReveal:ee,hasPendingMarketelValueReveal:Z,showMarketelValueReveal:X};function re(){L(te)}export{ee as clearPendingMarketelValueReveal,te as default,Z as hasPendingMarketelValueReveal,re as install,X as showMarketelValueReveal};
