import{c as a,a as St,b as $t,e as zt}from"./settings-U4fdIiTo.js";function v(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function K(...t){return v("ensureAppsViewRendered")?.(...t)}function X(...t){return v("showFinaleMockModal")?.(...t)}function Z(...t){return v("finishTourHydration")?.(...t)}function J(...t){return v("goLive")?.(...t)}function tt(...t){return v("toast")?.(...t)}function It(...t){return v("appsCloseLightbox")?.(...t)}let F=[],c=0,H=!1,B=null,D=null,L=null,T=null;function Bt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
