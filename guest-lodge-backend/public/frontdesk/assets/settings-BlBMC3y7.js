const u={token:"",bookings:[],guestMessages:[],currentFilter:"settings",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,_magicLoginPending:!1,editRooms:[],messageUnreadCount:0,bookingsVirtualList:[],bookingsVirtualRaf:0};let T=null;function Me(){return typeof lucide<"u"?Promise.resolve():T||(T=new Promise((e,t)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>e(),o.onerror=()=>t(new Error("lucide load failed")),document.head.appendChild(o)}),T)}async function L(e){if(!e||!e.type.startsWith("image/")||e.type==="image/webp"&&e.size<4e5)return e;try{const t=await createImageBitmap(e),o=1600,r=1200;let i=t.width,n=t.height;const d=Math.min(1,o/i,r/n);i=Math.round(i*d),n=Math.round(n*d);const l=document.createElement("canvas");l.width=i,l.height=n,l.getContext("2d").drawImage(t,0,0,i,n),t.close();const g=await new Promise((m,w)=>{l.toBlob(h=>h?m(h):w(new Error("encode failed")),"image/webp",.82)}),x=(e.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([g],x+".webp",{type:"image/webp"})}catch{return e}}function Ce(){const e=()=>{u.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}function V(e){Object.assign(window,e)}async function N(){const e=document.getElementById("settingsList");if(e){e.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const t=await api("GET","/api/crm/verify"),r="https://"+(t?.domain||u.activeHotelId+".bookmarketel.com"),i="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(r),n=await api("GET","/api/crm/rooms");let d={nightly:69,weekly:299,monthly:999};n?.rates&&(d=n.rates);const l=n?.rooms||[];let g="";l.length?l.forEach(x=>{const m=x.images&&x.images.length>0;g+=`
    ...
    `,e.innerHTML=g}catch{e.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function Q(){const e=document.getElementById("settings-booking-url");e&&navigator.clipboard.writeText(e.value).then(()=>{localStorage.setItem("linkCopied","1"),S(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function J(){localStorage.setItem("settingsTourDone","1");const e=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",e);let t=0;const o=setInterval(()=>{t++;const r=document.getElementById("edit-rate-nightly");if(r||t>20){if(clearInterval(o),!r)return;const i=r.closest(".accordion-body");if(i&&i.style.display==="none"){i.style.display="block";const n=i.previousElementSibling?.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}setTimeout(()=>{r.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const n=document.getElementById("checklistPointer");n&&n.remove();const d=r.getBoundingClientRect(),l=document.createElement("div");l.id="checklistPointer",l.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${d.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,l.innerHTML=`
          ...
          `,document.body.appendChild(l),setTimeout(()=>{const g=document.getElementById("checklistPointer");g&&g.remove()},6e3)},1e3)},100)}},200)}function K(){const t="https://"+(u.activeHotelDomain||u.activeHotelId+".bookmarketel.com");navigator.clipboard.writeText(t).then(()=>{localStorage.setItem("linkCopied","1"),S(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function X(e,t){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let r=0;const i=setInterval(()=>{r++;const n=document.querySelector(e);if(n||r>20){if(clearInterval(i),!n)return;n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const d=document.getElementById("checklistPointer");d&&d.remove();const l=n.getBoundingClientRect(),g=document.createElement("div");g.id="checklistPointer",g.style.cssText=`
    ...
    <div style="background:white;border-radius:20px;padding:28px 24px;max-width:340px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.2);">
      ...
      <p style="font-size:14px;color:#6b7280;line-height:1.65;margin:0 0 20px;text-align:left;">This is where you:<br><br>
        ...
        <strong>See fd.bookings</strong> when they come in<br>
  ...
  `,document.body.appendChild(e),document.getElementById("welcomeModalGotIt").onclick=()=>{e.remove(),setTimeout(()=>{C()},200)}}function ae(){if(document.getElementById("activatedModalOverlay"))return;const e=activeHotelDomain||(activeHotelId?activeHotelId+".bookmarketel.com":""),t=document.createElement("div");t.id="activatedModalOverlay",t.style.cssText="position:fixed;inset:0;z-index:100002;background:rgba(0,0,0,0.55);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;padding:24px;",t.innerHTML=`
    <div style="background:white;border-radius:20px;padding:28px 24px;max-width:380px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.25);">
      ...
      <div style="text-align:left;background:#f0f7f3;border:1px solid #d6e9df;border-radius:14px;padding:16px 18px;margin-bottom:18px;">
        ...
        <div style="display:flex;gap:10px;align-items:flex-start;margin-bottom:12px;">
          <span style="color:#2E7D5B;font-weight:700;flex-shrink:0;">✓</span>
          <span style="font-size:13px;color:#1a1a2e;line-height:1.5;"><strong>New fd.bookings appear right here</strong> in your Bookings tab, and you'll get a notification for each one.</span>
        </div>
        <div style="display:flex;gap:10px;align-items:flex-start;margin-bottom:12px;">
          <span style="color:#2E7D5B;font-weight:700;flex-shrink:0;">✓</span>
      ...
      <button id="activatedModalDone" style="width:100%;padding:14px;border-radius:12px;border:none;background:#2E7D5B;color:white;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;">Got it — take me to my fd.bookings</button>
    </div>
  `,document.body.appendChild(t),document.getElementById("activatedModalDone").onclick=()=>{t.remove();try{setFilter("bookings")}catch{}}}function R(){const e=isStandaloneApp()||u.frontdeskInstalled,t=typeof Notification<"u"&&Notification.permission==="granted";let o;return e&&pushSupported()?o=t?`<p style="font-size:12px;color:var(--text-muted);margin:0 0 14px;line-height:1.5;">You're all set — you'll get an alert on this phone every time a guest books.</p>
    ...
    <div id="iosInstallSheetCard" style="background:#fff;width:100%;max-width:440px;border-radius:20px 20px 0 0;padding:24px 22px 32px;box-shadow:0 -8px 40px rgba(0,0,0,0.2);">
      ...
      <button id="iosInstallSheetDone" style="width:100%;margin-top:22px;padding:14px;border-radius:12px;border:none;background:#2E7D5B;color:#fff;font-size:15px;font-weight:700;cursor:pointer;font-family:inherit;">Got it</button>
    </div>`,document.body.appendChild(n),typeof lucide<"u"&&lucide.createIcons();const l=()=>n.remove();n.addEventListener("click",m=>{m.target===n&&l()});const g=document.getElementById("iosInstallSheetCard");g&&g.addEventListener("click",m=>m.stopPropagation());const x=document.getElementById("iosInstallSheetDone");x&&(x.onclick=l)}function C(){if(localStorage.getItem("settingsTourDone"))return;let e=parseInt(localStorage.getItem("settingsTourStep")||"0");const t=[{target:"",text:"",openAccordion:!1,tab:"settings",customModal:"homescreen"},{target:"#edit-hotel-phone",text:"Tap any field here to edit your hotel info — name, address, phone.",openAccordion:!1,tab:"settings"},{target:"#editRoomsCards .booking-card > div:first-child",text:"Add a photo of your room — guests book more when they see one.",openAccordion:!1,tab:"settings"},{target:"#edit-rate-nightly",text:"You can change your rates here — nightly, weekly, and monthly.",openAccordion:!0,targetParent:!0,tab:"settings"},{target:'button[onclick*="copyBookingLink"]',text:"This is your booking URL — the link guests use to book with you directly.",openAccordion:!1,tab:"settings"},{target:'button[onclick*="openPreviewSite"]',text:"Preview your booking engine to see exactly what your guests see.",openAccordion:!1,tab:"settings"},{target:"#edit-new-pin",text:"This is your login PIN — you'll need it to access this dashboard next time. You can change it here anytime.",openAccordion:!0,tab:"settings"},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",text:"See how much revenue your booking page generates and how much you're saving vs OTA commissions.",openAccordion:!1,tab:"revenue",waitForVisible:!0},{target:"#paymentsExplainer",text:"When guests book through your engine, their card is verified but never charged. This prevents no-shows — and you collect payment however you want when they physically check in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,tooltipPosition:"above"},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:"finale"}];function o(){const a=document.getElementById("tourTooltip");a&&a.remove();const s=document.getElementById("tourBlurOverlay");s&&s.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(p=>{p.style.position=p.dataset.tourOrigPosition||"",p.style.zIndex="",p.style.boxShadow="",p.removeAttribute("data-tour-highlighted"),delete p.dataset.tourOrigPosition}),document.body.style.overflow=""}function r(){o(),x()}function i(){if(o(),e>=t.length){localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");return}const a=t[e];if(a.tab==="revenue"&&!revenueEnabled){e++,localStorage.setItem("settingsTourStep",String(e)),i();return}if(a.tab&&a.tab!==currentFilter){const s=document.querySelector(`.tab[data-nav-filter="${a.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${a.tab}"]`);s&&setFilter(a.tab,s),a.customModal?setTimeout(()=>{n(a)},150):setTimeout(()=>{n(a)},800);return}setTimeout(()=>{n(a)},100)}function n(a){if(a.customModal==="homescreen"){g();return}if(a.customModal===!0||a.customModal==="fd.bookings"){h();return}if(a.customModal==="availability"){w();return}if(a.customModal==="finale"){x();return}if(a.waitForVisible){const c=a.target.split(",").map(f=>f.trim());let b=0;const v=20,y=()=>{b++;let f=null;for(const k of c){if(f=document.querySelector(k),f&&f.offsetParent!==null)break;f=null}f?d(f,a):b<v?setTimeout(y,200):(e++,localStorage.setItem("settingsTourStep",String(e)),i())};y();return}let s=null;const p=a.target.split(",").map(c=>c.trim());for(const c of p){if(s=document.querySelector(c),s&&!a.openAccordion&&s.offsetParent===null&&getComputedStyle(s).position!=="fixed"){s=null;continue}if(s)break}if(!s){e++,localStorage.setItem("settingsTourStep",String(e)),i();return}d(s,a)}function d(a,s){if(s.openAccordion){const c=a.closest(".accordion-body");if(c&&c.style.display==="none"){c.style.display="block";const b=c.previousElementSibling?.querySelector(".accordion-arrow");b&&(b.style.transform="rotate(90deg)")}}s.targetParent&&(a=a.closest(".booking-card")||a.closest(".accordion-body")||a);const p=document.createElement("div");p.id="tourBlurOverlay",p.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.6);",document.body.appendChild(p),document.body.style.overflow="hidden",a.dataset.tourOrigPosition||(a.dataset.tourOrigPosition=a.style.position||""),a.style.position=a.style.position||"relative",a.style.zIndex="99999",a.style.isolation="isolate",a.style.boxShadow="0 0 0 4px #2E7D5B, 0 0 20px rgba(46,125,91,0.3)",a.setAttribute("data-tour-highlighted","1"),a.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{l(a,s)},500)}function l(a,s){const p=a.getBoundingClientRect(),c=document.createElement("div");c.id="tourTooltip";const b=window.innerHeight-p.bottom,v=p.top,y=Math.min(280,window.innerWidth-32),f=p.left+p.width/2,k=Math.max(16,Math.min(f-y/2,window.innerWidth-y-16)),B=Math.max(20,Math.min(f-k,y-20)),z='<div style="margin-top:8px;"><button id="tourSkipBtn" style="background:none;border:none;color:rgba(255,255,255,0.5);font-size:11px;font-family:inherit;cursor:pointer;padding:4px 8px;">Skip tour</button></div>',E=s.tooltipPosition||(b>130?"below":v>130?"above":"center");E==="below"?(c.style.cssText=`position:fixed;z-index:100000;left:${k}px;top:${p.bottom+12}px;max-width:${y}px;width:${y}px;`,c.innerHTML=`
        ...
        <div style="background:#1a1a2e;border-radius:10px;padding:14px 18px;color:white;font-size:13px;line-height:1.5;font-weight:500;text-align:center;box-shadow:0 4px 20px rgba(0,0,0,0.25);">
          ...
          ${z}
        </div>`):E==="above"?(c.style.cssText=`position:fixed;z-index:100000;left:${k}px;bottom:${window.innerHeight-p.top+12}px;max-width:${y}px;width:${y}px;`,c.innerHTML=`
        <div style="background:#1a1a2e;border-radius:10px;padding:14px 18px;color:white;font-size:13px;line-height:1.5;font-weight:500;text-align:center;box-shadow:0 4px 20px rgba(0,0,0,0.25);">
          <p style="margin:0 0 12px;">${s.text}</p>
          <button id="tourNextBtn" style="padding:8px 20px;border-radius:6px;border:none;background:#2E7D5B;color:white;font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${e<t.length-1?"Next →":"Got it!"}</button>
          ${z}
        </div>
        <div style="width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-top:8px solid #1a1a2e;margin-left:${B-8}px;"></div>`):(c.style.cssText=`position:fixed;z-index:100000;left:50%;top:50%;transform:translate(-50%,-50%);max-width:${y}px;width:${y}px;`,c.innerHTML=`
        <div style="background:#1a1a2e;border-radius:10px;padding:14px 18px;color:white;font-size:13px;line-height:1.5;font-weight:500;text-align:center;box-shadow:0 4px 20px rgba(0,0,0,0.25);">
          <p style="margin:0 0 12px;">${s.text}</p>
          <button id="tourNextBtn" style="padding:8px 20px;border-radius:6px;border:none;background:#2E7D5B;color:white;font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${e<t.length-1?"Next →":"Got it!"}</button>
          ${z}
        </div>`),document.body.appendChild(c),document.getElementById("tourNextBtn").onclick=()=>{o(),e++,localStorage.setItem("settingsTourStep",String(e)),i()},document.getElementById("tourSkipBtn").onclick=()=>{r()}}function g(){const a=document.createElement("div");a.id="tourBlurOverlay",a.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(a),document.body.style.overflow="hidden";const s=typeof activeHotelName<"u"&&activeHotelName?activeHotelName:"Your Hotel",p=s.trim().charAt(0).toUpperCase(),c=s.length>10?s.slice(0,10):s,b="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",v="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",y="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",f=`<div style="${b}"><div style="${v}background:rgba(255,255,255,0.22);"></div><div style="${y}"></div></div>`,k=`<div style="${b}"><div style="${v}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);">${p}</div><div style="${y}font-size:7.5px;color:#fff;font-weight:700;">${c}</div></div>`,B=[f,f,f,f,k,f,f,f].join(""),z=document.createElement("div");if(z.id="tourTooltip",z.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",z.innerHTML=`
      ...
      </div>`,document.body.appendChild(s),!document.getElementById("tourModalAnimStyle")){const p=document.createElement("style");p.id="tourModalAnimStyle",p.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(p)}document.getElementById("tourNextBtn").onclick=()=>{const c="https://"+(u.activeHotelDomain||u.activeHotelId+".bookmarketel.com");navigator.clipboard.writeText(c).catch(()=>{}),o(),localStorage.setItem("settingsTourDone","1"),localStorage.setItem("linkCopied","1"),localStorage.removeItem("settingsTourStep"),toast("Booking link copied!","success"),m()}}function m(a){const s=document.createElement("div");s.id="testDriveOverlay",s.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;padding:24px 16px;",s.innerHTML=`
      <div style="background:white;border-radius:20px;max-width:340px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);animation:tourModalSlideUp 0.3s ease;">
        <div style="padding:28px 22px;text-align:center;">
          <div style="font-size:36px;margin-bottom:12px;">🚀</div>
          <div style="font-size:18px;font-weight:700;color:#1a1a2e;margin-bottom:8px;">Go live and start accepting fd.bookings</div>
          ...
          <div style="background:#f0fdf4;border-radius:12px;padding:14px;border:1px solid #bbf7d0;text-align:left;margin-bottom:20px;">
            <div style="display:flex;flex-direction:column;gap:8px;">
              ...
              <div style="display:flex;align-items:center;gap:8px;"><span style="color:#2E7D5B;font-weight:700;">✓</span><span style="font-size:13px;color:#166534;">Get notified when fd.bookings come in</span></div>
      ...
      </div>`,document.body.appendChild(s),document.getElementById("activateNowBtn").onclick=()=>{s.remove();const p=u.token;fetch("/api/crm/go-live",{method:"POST",headers:{"Content-Type":"application/json","x-crm-token":p},body:JSON.stringify({hotelId:u.activeHotelId})}).then(c=>c.json()).then(c=>{c.success&&c.url?window.location.href=c.url:toast("Something went wrong. Try again.","error")}).catch(()=>toast("Something went wrong. Try again.","error"))},document.getElementById("activateLaterBtn").onclick=()=>{s.remove();const p=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');p&&setFilter("bookings",p)}}function w(){const a=document.createElement("div");a.id="tourBlurOverlay",a.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(a),document.body.style.overflow="hidden";let s=0;const p=[`<div style="padding:20px 18px 0;">
      ...
      <div style="padding:0 14px 14px;">
      ...
      </div>`],c=document.createElement("div");c.id="tourTooltip",c.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";function b(){const y=s>=p.length-1?"Next — Revenue →":"Next →";c.innerHTML=`
        <div style="background:white;border-radius:20px;max-width:340px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0,0,0,0.3);animation:tourModalSlideUp 0.3s ease;">
          ...
          <div style="padding:4px 18px 6px;text-align:center;">
            <div style="display:flex;justify-content:center;gap:6px;margin-bottom:10px;">
              ${p.map((f,k)=>`<div style="width:8px;height:8px;border-radius:50%;background:${k===s?"#2E7D5B":"#D8E4DC"};"></div>`).join("")}
            </div>
          </div>
        ...
        </div>`,document.getElementById("tourNextBtn").onclick=()=>{s<p.length-1?(s++,b()):(o(),e++,localStorage.setItem("settingsTourStep",String(e)),i())},document.getElementById("tourSkipBtn").onclick=()=>{r()}}if(document.body.appendChild(c),b(),!document.getElementById("tourModalAnimStyle")){const v=document.createElement("style");v.id="tourModalAnimStyle",v.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(v)}}function h(){const a=document.createElement("div");a.id="tourBlurOverlay",a.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(a),document.body.style.overflow="hidden";const s=document.createElement("div");if(s.id="tourTooltip",s.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",s.innerHTML=`
      <div style="background:white;border-radius:20px;max-width:340px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0,0,0,0.3);animation:tourModalSlideUp 0.3s ease;">
      ...
      </div>`,document.body.appendChild(s),!document.getElementById("tourModalAnimStyle")){const p=document.createElement("style");p.id="tourModalAnimStyle",p.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(p)}document.getElementById("tourNextBtn").onclick=()=>{o(),e++,localStorage.setItem("settingsTourStep",String(e)),i()},document.getElementById("tourSkipBtn").onclick=()=>{r()}}i()}async function D(){const e=document.getElementById("editRoomsList");if(e){e.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const t=await api("GET","/api/crm/rooms");if(!t.rooms)throw new Error("No data");u.editRooms=t.rooms;const o=await api("GET","/api/crm/verify"),r=o?.hotelName||"";r&&(activeHotelName=r);const i=o?.hotelSubtitle||"",n=o?.hotelAddress||"",d=o?.hotelPhone||"",l=o?.appIconUrl||"";activeHotelAppIcon=l,updateFrontdeskManifestLink();let g={nightly:69,weekly:299,monthly:999,taxRate:.1};t.rates&&(g=t.rates);const m="https://"+(o?.domain||activeHotelId+".bookmarketel.com"),w="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(m);let h=`
      ...
      <div class="booking-card" style="margin-bottom:14px;">
        ...
        <div class="accordion-body" style="display:none;padding:0 18px 18px;">
          <div style="margin-bottom:12px;">
            <input type="text" id="edit-new-pin" value="${token}" placeholder="Enter new PIN (min 4 chars)" style="width:100%;font-size:16px;padding:8px 10px;border-radius:8px;border:1.5px solid var(--border);font-family:inherit;outline:none;text-align:center;letter-spacing:2px;">
          </div>
    ...
    `;e.innerHTML=h,I(),typeof lucide<"u"&&lucide.createIcons(),setTimeout(()=>{u.currentFilter==="settings"&&localStorage.getItem("onboardingDone")&&!localStorage.getItem("settingsTourDone")&&!document.getElementById("welcomeModalOverlay")&&C()},300)}catch{e.innerHTML='<div class="empty-state"><div class="empty-icon">🛏️</div><div class="empty-text">No rooms yet</div><div class="empty-sub">Add your first room type below.</div></div>'}}}function $(){I()}function I(){const e=document.getElementById("editRoomsCards")||document.getElementById("editRoomsList");if(!u.editRooms.length){e.innerHTML='<div class="empty-state"><div class="empty-icon">🛏️</div><div class="empty-text">No rooms yet</div><div class="empty-sub">Add your first room type below.</div></div>';return}e.innerHTML=u.editRooms.map(t=>{const o=(t.amenities||"").split("•").map(i=>i.trim()).filter(Boolean),r=t.images||[];return`
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",P),r=document.getElementById("amenityPickerModal"));const i=document.getElementById("amenityPickerGrid");i.innerHTML=U.map(n=>{const d=o.some(l=>l.includes(n.key));return`<button onclick="toggleAmenityPreset(this,'${n.key}')" data-key="${n.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${d?"#2E7D5B":"#e5e7eb"};background:${d?"#E8F5EE":"white"};color:${d?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${n.icon}" style="width:14px;height:14px;"></i> ${n.label}</button>`}).join(""),document.getElementById("amenityCustomInput").value="",r.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function pe(e,t){const o=e.style.borderColor==="rgb(46, 125, 91)";e.style.borderColor=o?"#e5e7eb":"#2E7D5B",e.style.background=o?"white":"#E8F5EE",e.style.color=o?"#1a1a2e":"#2E7D5B"}function P(){document.getElementById("amenityPickerModal").style.display="none",A=null}function ce(){const e=editRooms.find(i=>i.id===A);if(!e){P();return}const t=document.getElementById("amenityPickerGrid"),o=[];t.querySelectorAll("button").forEach(i=>{if(i.style.background==="rgb(232, 245, 238)"){const n=U.find(d=>d.key===i.dataset.key);n&&o.push(n.label)}});const r=document.getElementById("amenityCustomInput").value.trim();r&&o.push(r),e.amenities=o.join(" • "),P(),$(),typeof lucide<"u"&&lucide.createIcons()}function ge(e){Y(e)}function xe(e,t){const o=editRooms.find(i=>i.id===e);if(!o)return;const r=(o.amenities||"").split("•").map(i=>i.trim()).filter(Boolean);o.amenities=r.filter(i=>i!==t).join(" • "),$(),typeof lucide<"u"&&lucide.createIcons()}async function ue(){const e=document.getElementById("edit-hotel-name")?.value.trim(),t=document.getElementById("edit-hotel-subtitle")?.value.trim(),o=document.getElementById("edit-hotel-address")?.value.trim(),r=document.getElementById("edit-hotel-phone")?.value.trim(),i=document.getElementById("edit-hotel-policy")?.value.trim();try{await api("POST","/api/crm/hotel-info",{name:e,subtitle:t,address:o,phone:r,cancellationPolicy:i}),toast("Hotel info saved!","success")}catch{toast("Failed to save","error")}}async function me(){const e=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,t=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:e,weekly:t,monthly:o}),localStorage.setItem("ratesChanged","1"),S(),toast("Rates saved!","success")}catch{toast("Failed to save rates","error")}}async function fe(){const e=document.getElementById("edit-new-pin")?.value.trim();if(!e||e.length<4){toast("PIN must be at least 4 characters","error");return}try{await api("POST","/api/crm/change-pin",{newPin:e}),token=e;try{localStorage.setItem("crmToken",token)}catch{}toast("PIN updated!","success")}catch{toast("Failed to change PIN","error")}}function ye(e){navigator.clipboard.writeText(e).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function be(e){const t=e.nextElementSibling,o=e.querySelector(".accordion-arrow");t.style.display==="none"?(t.style.display="block",o&&(o.style.transform="rotate(90deg)")):(t.style.display="none",o&&(o.style.transform="rotate(0deg)"))}async function he(){try{const e=await api("POST","/api/crm/go-live");e.success&&e.url?window.location.href=e.url:toast(e.message||"Failed to start checkout","error")}catch{toast("Failed to start checkout. Try again.","error")}}async function ve(){try{const e=await api("GET","/api/crm/billing-portal");e.success&&e.url?window.location.href=e.url:toast(e.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function we(){const e=document.getElementById("supportMessage")?.value.trim();if(!e){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:e}),document.getElementById("supportMessage").value="",toast("Message sent! We'll reply to your email.","success")}catch{toast("Failed to send. Email support@bookmarketel.com directly.","error")}}async function ke(e){const t=u.editRooms.find(l=>l.id===e);if(!t){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+e)?.value.trim(),r=document.getElementById("edit-desc-"+e)?.value.trim(),i=parseInt(document.getElementById("edit-occ-"+e)?.value)||4,n=parseInt(document.getElementById("edit-units-"+e)?.value)||1,d={id:e,name:o||t.name,description:r||"",amenities:t.amenities||"",maxOccupancy:i,totalUnits:n};try{const l=await api("POST","/api/crm/rooms",d);if(l&&l.success===!1){toast(l.message||"Failed to save","error");return}t.name=d.name,t.description=d.description,t.maxOccupancy=i,t.totalUnits=n,toast("Room saved!","success")}catch(l){toast("Failed to save: "+(l.message||""),"error")}}async function ze(e,t){const o=Array.from(e.target.files);if(!o.length)return;const i=document.getElementById("edit-card-"+t)?.querySelector("div:first-child");i&&(i.style.position="relative",i.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+t+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+t+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let n=0;for(const l of o){const g=await L(l),x=new FormData;x.append("image",g,g.name||"room.webp");try{const h=await(await fetch(`/api/crm/rooms/${t}/images`,{method:"POST",headers:{"x-crm-token":x.token},body:x})).json();if(h.success&&h.image){const a=x.editRooms.find(s=>s.id===t);a&&(a.images||(a.images=[]),a.images.push(h.image),a.imageUrl||(a.imageUrl=h.image.url)),n++}}catch{}const m=document.getElementById("upload-progress-"+t);m&&(m.textContent=n+" / "+o.length)}const d=document.getElementById("upload-spinner-"+t);d&&d.remove(),I(),S(),toast(n+" photo"+(n!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success")}function q(e,t=512){return new Promise((o,r)=>{const i=new Image,n=URL.createObjectURL(e);i.onload=()=>{try{const d=Math.min(i.naturalWidth,i.naturalHeight),l=(i.naturalWidth-d)/2,g=(i.naturalHeight-d)/2,x=document.createElement("canvas");x.width=t,x.height=t;const m=x.getContext("2d");m.imageSmoothingQuality="high",m.drawImage(i,l,g,d,d,0,0,t,t),URL.revokeObjectURL(n),x.toBlob(w=>w?o(w):r(new Error("crop failed")),"image/png",.92)}catch(d){URL.revokeObjectURL(n),r(d)}},i.onerror=()=>{URL.revokeObjectURL(n),r(new Error("load failed"))},i.src=n})}function G(){const e=document.getElementById("appsAppIconPreview");e&&(e.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function W(e){const t=document.getElementById("appsAppIconPreview");t&&(t.style.background="#fff",t.innerHTML='<img src="'+e+'" alt="App icon" style="width:100%;height:100%;object-fit:cover;">')}async function Ee(e){const t=e.files&&e.files[0];if(!t)return;G();const o=new FormData;try{const r=await q(t,512);o.append("icon",r,"app-icon.png")}catch{o.append("icon",t)}try{const i=await(await fetch("/api/crm/hotel-app-icon",{method:"POST",headers:{"x-crm-token":o.token},body:o})).json();if(i.success&&i.appIconUrl)o.activeHotelAppIcon=i.appIconUrl,W(i.appIconUrl),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Logo updated! Guests will see it on their phone.","success");else{toast(i.message||"Failed to upload icon","error");const n=(typeof o.activeHotelName<"u"&&o.activeHotelName?activeHotelName:"H").trim().charAt(0).toUpperCase()||"🏨",d=document.getElementById("appsAppIconPreview");d&&(d.style.background="var(--green)",d.innerHTML=n)}}catch{toast("Failed to upload icon","error")}e.value=""}async function Se(e,t){if(confirm("Delete this photo?"))try{await api("DELETE",`/api/crm/rooms/${e}/images/${t}`);const o=u.editRooms.find(r=>r.id===e);o&&o.images&&(o.images=o.images.filter(r=>r.id!==t),o.imageUrl=o.images[0]?.url||null),I(),toast("Photo deleted","success")}catch{toast("Failed to delete","error")}}async function Ie(e){if(confirm("Delete this room type?"))try{await api("DELETE",`/api/crm/rooms/${e}`),toast("Room deleted","success"),D()}catch{toast("Failed to delete","error")}}function Be(){const e=document.getElementById("editRoomsList");document.getElementById("editAddForm")||(e.insertAdjacentHTML("beforeend",`
  ...
  `),document.getElementById("editNewRoomName").focus())}function Te(){const e=document.getElementById("editNewRoomName").value.trim();e&&api("POST","/api/crm/rooms",{name:e,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),D()}).catch(()=>toast("Failed to add","error"))}const _={addAmenityPrompt:ge,advanceTourIfNeeded:S,changePin:fe,checklistGoTo:X,checklistGoToRates:J,closeAmenityPicker:P,confirmAmenityPicker:ce,confirmEditAddRoom:Te,copyBookingLink:ye,copyBookingLinkFromChecklist:K,deleteEditImage:Se,deleteEditRoom:Ie,frontdeskInstallCardHtml:R,getAmenityIcon:j,goLive:he,handleInstallFrontdesk:de,loadEditRooms:D,loadSettings:N,maybePromptInstalledNotifications:le,openAmenityPicker:Y,openBillingPortal:ve,openEditAddRoom:Be,openPreviewSite:ie,refreshFrontdeskInstallCard:M,removeAmenity:xe,renderEditRooms:$,renderEditRoomsCards:I,saveEditRoom:ke,saveHotelInfo:ue,saveRates:me,sendSupportMessage:we,setAppIconPreviewImage:W,setAppIconPreviewLoading:G,settingsChangePin:te,settingsCopyLink:Q,settingsSaveRates:ee,settingsSendSupport:oe,settingsUploadPhoto:Z,showActivatedModal:ae,showIosInstallSheet:O,showNotifPromptModal:F,showOnboardingQuestions:re,showWelcomeModal:H,squareCropImage:q,startSettingsTour:C,toggleAmenityPreset:pe,toggleAppNotifications:se,toggleSection:be,updatePreviewSiteBar:ne,uploadAppIcon:Ee,uploadEditImages:ze};function Pe(){V(_)}const De=Object.freeze(Object.defineProperty({__proto__:null,default:_,install:Pe},Symbol.toStringTag,{value:"Module"}));export{Me as a,De as b,V as e,u as f,Ce as s};
