...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${t}]`);if(Array.from(i).forEach(n=>Pe(n,{nameAttr:t,icons:e,attrs:o})),t==="data-lucide"){const n=document.querySelectorAll("[icon-name]");n.length>0&&Array.from(n).forEach(r=>Pe(r,{nameAttr:"icon-name",icons:e,attrs:o}))}},oo={ArrowUpRight:pt,Ban:ut,Bed:mt,Bell:ht,Calendar:ft,Camera:yt,CircleAlert:kt,CircleCheck:Et,ClipboardList:St,Hash:Ct,House:Mt,Image:Pt,Info:Ot,Lock:$t,MessageCircle:Dt,Moon:Ft,Phone:Nt,Play:qt,Undo2:Qt,Bath:gt,Car:xt,Check:vt,ChevronLeft:bt,ChevronRight:wt,CookingPot:Bt,CopyCheck:At,DoorOpen:Tt,Ellipsis:It,Globe:zt,Inbox:Rt,Laptop:Lt,PawPrint:Ht,QrCode:jt,Rocket:Ut,Share:Vt,Shirt:Gt,Smartphone:_t,Sparkles:Yt,SquarePlus:Wt,ThermometerSnowflake:Jt,Tv:Kt,Waves:Zt,Wifi:Xt,Wind:eo};window.lucide={createIcons(e={}){to({...e,icons:oo})}};function mi(){return Promise.resolve()}async function io(e){if(!e||!e.type.startsWith("image/")||e.type==="image/webp"&&e.size<4e5)return e;try{const t=await createImageBitmap(e),o=1600,i=1200;let n=t.width,r=t.height;const a=Math.min(1,o/n,i/r);n=Math.round(n*a),r=Math.round(r*a);const s=document.createElement("canvas");s.width=n,s.height=r,s.getContext("2d").drawImage(t,0,0,n,r),t.close();const c=await new Promise((x,v)=>{s.toBlob(S=>S?x(S):v(new Error("encode failed")),"image/webp",.82)}),g=(e.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([c],g+".webp",{type:"image/webp"})}catch{return e}}function hi(){const e=()=>{d.currentFilter==="apps"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}const no=["cancelled","canceled","released"];function fi(e){return e?no.includes(String(e.status||"").trim().toLowerCase()):!0}function ro(e){Object.assign(window,e)}const ao=14,so=10;function xe(e,t,o){return Math.max(t,Math.min(e,o))}function R(e,t,o,i){return{left:e,top:t,width:o,height:i,right:e+o,bottom:t+i}}function lo(){const e=window.visualViewport,t=e?e.offsetLeft:0,o=e?e.offsetTop:0,i=e?e.width:window.innerWidth,n=e?e.height:window.innerHeight;return R(t,o,i,n)}function D(e){if(!e||!e.isConnected)return null;const t=e.getBoundingClientRect();return t.width<2||t.height<2?null:R(t.left,t.top,t.width,t.height)}function co(e,t){if(!e||!t)return 0;const o=Math.max(0,Math.min(e.right,t.right)-Math.max(e.left,t.left)),i=Math.max(0,Math.min(e.bottom,t.bottom)-Math.max(e.top,t.top));return o*i}function po(e,t){return Math.max(0,t.left-e.left)+Math.max(0,e.right-t.right)+Math.max(0,t.top-e.top)+Math.max(0,e.bottom-t.bottom)}function uo(e,t){let o=0;for(const i of t||[]){const n=document.querySelector(i);if(!n||getComputedStyle(n).display==="none")continue;const r=D(n);!r||r.bottom<e.bottom-2||r.top>=e.bottom||(o=Math.max(o,e.bottom-r.top))}return o}function go(e){const t=lo(),o=e.margin??ao,i=Math.max(Number(e.bottomInset||0),uo(t,e.avoidBottomSelectors)),n=t.left+o+Number(e.leftInset||0),r=t.top+o+Number(e.topInset||0),a=t.right-o-Number(e.rightInset||0),s=t.bottom-o-i;return R(n,r,Math.max(1,a-n),Math.max(1,s-r))}function mo(e){return e==="above"||e==="top"?["top","bottom","right","left"]:e==="right"?["right","left","bottom","top"]:e==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function ho(e,t,o,i,n){return e==="top"?R(t.left+(t.width-o)/2,t.top-i-n,o,i):e==="right"?R(t.right+n,t.top+(t.height-i)/2,o,i):e==="left"?R(t.left-o-n,t.top+(t.height-i)/2,o,i):R(t.left+(t.width-o)/2,t.bottom+n,o,i)}function fo(e,t){const o=xe(e.left,t.left,Math.max(t.left,t.right-e.width)),i=xe(e.top,t.top,Math.max(t.top,t.bottom-e.height));return R(o,i,e.width,e.height)}function yo(e){let t=e&&e.parentElement;for(;t&&t!==document.body&&t!==document.documentElement;){const o=getComputedStyle(t),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&t.scrollHeight>t.clientHeight+1)return t;t=t.parentElement}return null}function xo(e,t){if(!e||Math.abs(t)<1)return!1;const o=yo(e);return o?o.scrollTop+=t:window.scrollBy({top:t,left:0,behavior:"auto"}),!0}function he(e,t){const o=D(e);if(!o||t.height<60)return!1;let i;return o.height<=t.height?i=xe(o.top,t.top,t.bottom-o.height):i=t.bottom-o.height,xo(e,o.top-i)}function De(e,t){const o=getComputedStyle(e);for(const r of o)t.style.setProperty(r,o.getPropertyValue(r),o.getPropertyPriority(r));const i=e.children,n=t.children;for(let r=0;r<i.length;r+=1)n[r]&&De(i[r],n[r])}function vo(e){e.removeAttribute("id"),e.querySelectorAll("[id]").forEach(t=>t.removeAttribute("id"))}function bo(e,t){const o=e.querySelectorAll("input, textarea, select"),i=t.querySelectorAll("input, textarea, select");o.forEach((n,r)=>{const a=i[r];a&&(n.type==="checkbox"||n.type==="radio"?a.checked=n.checked:a.value=n.value)})}function wo(e,t={}){if(!e||!e.isConnected||t.disabled||!D(e))return null;const i=e.cloneNode(!0);vo(i),De(e,i),bo(e,i),i.setAttribute(t.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(t.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",t.prepareClone?.(i,e);const n=e.style.visibility;t.hideSource&&(e.style.visibility="hidden"),document.body.appendChild(i);const r=()=>{const s=D(e);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),t.hideSource&&(e.style.visibility=n)};return r(),{element:i,source:e,update:r,destroy:a}}function ko({tooltip:e,panel:t,target:o,anchor:i,spotlight:n,options:r={}}){if(!e||!t||!o)return null;let a=0,s=!1,c=!1,g=!1,x="";const v=(l=!0)=>{if(s||!e.isConnected||!o.isConnected)return null;const u=go(r),k=`${u.left}:${u.top}:${u.width}:${u.height}`;x&&x!==k&&(c=!1,l=!0),x=k;const p=D(i)||D(o),h=D(o);if(!p||!h)return null;const y=Math.min(Number(r.maxWidth||380),u.width);e.style.position="fixed",e.style.right="auto",e.style.bottom="auto",e.style.width=`${y}px`,e.style.maxWidth=`${y}px`,e.style.margin="0",e.style.justifyContent="flex-start",t.style.maxHeight=`${Math.max(120,u.height)}px`;const b=Math.min(t.offsetHeight||e.offsetHeight||190,u.height),w=Number(r.gap??so);l&&!c&&r.autoScroll!==!1&&h.height+b+w<=u.height&&(c=he(o,u),c&&requestAnimationFrame(()=>v(!1)));const E=mo(r.preferredPlacement).map((I,L)=>{const W=ho(I,p,y,b,w),Ce=po(W,u),Me=co(W,h);return{placement:I,index:L,raw:W,overflow:Ce,overlap:Me,score:Ce*1e5+Me*100+L}}),T=E.find(I=>I.overflow<.5&&I.overlap<1),A=T||E.slice().sort((I,L)=>I.score-L.score)[0],C=r.forceDock===!0||!T;let P="floating",F;if(C){P="docked";const I=Math.min(b,Number(r.dockMaxHeight||Math.max(180,u.height*.42)),u.height);t.style.maxHeight=`${I}px`;const L=Math.min(t.offsetHeight||I,I);if(F=R(u.left+(u.width-y)/2,u.bottom-L,y,L),l&&!c&&r.autoScroll!==!1){const W=R(u.left,u.top,u.width,Math.max(60,F.top-w-u.top));c=he(o,W),c&&requestAnimationFrame(()=>v(!1))}}else if(F=fo(A.raw,u),l&&!c&&r.autoScroll!==!1){let I=u;if(A.placement==="bottom")I=R(u.left,u.top,u.width,Math.max(60,F.top-w-u.top));else if(A.placement==="top"){const L=F.bottom+w;I=R(u.left,L,u.width,Math.max(60,u.bottom-L))}c=he(o,I),c&&requestAnimationFrame(()=>v(!1))}return e.dataset.tourLayoutMode=P,e.dataset.tourPlacement=C?"bottom-dock":A.placement,e.style.left=`${F.left}px`,e.style.top=`${F.top}px`,n?.update?.(),r.onLayout?.({mode:P,placement:e.dataset.tourPlacement,viewport:u,targetRect:D(o),anchorRect:D(i)||D(o),tooltipRect:F}),{mode:P,placement:e.dataset.tourPlacement,rect:F}},S=(l=!1)=>{g=g||l===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const u=g;g=!1,v(u)}))},z=()=>{c=!1,S(!0)},V=typeof ResizeObserver=="function"?new ResizeObserver(S):null;V?.observe(o),i&&i!==o&&V?.observe(i),V?.observe(t),window.addEventListener("resize",z),window.addEventListener("orientationchange",z),window.addEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",z),window.visualViewport.addEventListener("scroll",S));const me=()=>{s=!0,a&&cancelAnimationFrame(a),V?.disconnect(),window.removeEventListener("resize",z),window.removeEventListener("orientationchange",z),window.removeEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",z),window.visualViewport.removeEventListener("scroll",S))},m=v(!0);return{destroy:me,reposition:()=>v(!1),result:m}}function U(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function re(...e){return U("setFilter")?.(...e)}function Re(...e){return U("setBookingsSubview")?.(...e)}function Eo(...e){return U("toast")?.(...e)}function ae(...e){return U("updateGoLiveBanner")?.(...e)}function So(...e){return U("seedTourRevenueShell")?.(...e)}function Bo(...e){return U("finishTourHydration")?.(...e)}function Ao(...e){return U("goLive")?.(...e)}let Z=null,se=null,_=null;function q(){if(document.getElementById("frontdeskTourPolishStyle"))return;const e=document.createElement("style");e.id="frontdeskTourPolishStyle",e.textContent=`
  ...
  `,document.head.appendChild(e)}function Ee(){Z&&(document.removeEventListener("keydown",Z),Z=null)}function To(e){Ee(),Z=t=>{if(t.defaultPrevented)return;const o=t.target&&t.target.tagName?t.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||t.target?.isContentEditable||(t.key==="Escape"?(t.preventDefault(),e.onSkip?.()):t.key==="Enter"||t.key==="ArrowRight"?(t.preventDefault(),e.onNext?.()):t.key==="ArrowLeft"&&(t.preventDefault(),e.onBack?.()))},document.addEventListener("keydown",Z)}function fe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function $(e){q();const t=e||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=t.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=t.blockPointer?"auto":"none",t.lockScroll&&(document.body.style.overflow="hidden"),o}const te="rgba(17,24,39,0.42)";function J(){const e=document.getElementById("tourTooltip"),t=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!e||t)return Promise.resolve();e.style.pointerEvents="none";const o=e.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function Io(e,t){return _?.destroy(),_=wo(e,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=t?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=t?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=t?.spotlightOutlineOffset??"2px",t?.spotlightBackground&&(o.style.background=t.spotlightBackground,o.style.backgroundColor=t.spotlightBackground),t?.spotlightBorderRadius&&(o.style.borderRadius=t.spotlightBorderRadius)}}),_?.element||null}function H(e){const t=e||{};Ee(),se?.destroy(),se=null,_?.destroy(),_=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!t.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(r=>r.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(r=>{r.style.position=r.dataset.tourOrigPosition||"",r.style.zIndex=r.dataset.tourOrigZIndex||"",r.style.isolation=r.dataset.tourOrigIsolation||"",r.style.boxShadow=r.dataset.tourOrigBoxShadow||"",r.style.outline=r.dataset.tourOrigOutline||"",r.style.outlineOffset=r.dataset.tourOrigOutlineOffset||"",r.style.transition=r.dataset.tourOrigTransition||"",r.style.borderRadius=r.dataset.tourOrigBorderRadius||"",r.style.opacity=r.dataset.tourOrigOpacity||"";const a=r.dataset.tourOrigBackground||"",s=r.dataset.tourOrigBackgroundColor||"";s?r.style.backgroundColor=s:r.style.removeProperty("background-color"),a?r.style.background=a:r.style.removeProperty("background"),r.removeAttribute("data-tour-highlighted"),delete r.dataset.tourOrigPosition,delete r.dataset.tourOrigZIndex,delete r.dataset.tourOrigIsolation,delete r.dataset.tourOrigBoxShadow,delete r.dataset.tourOrigOutline,delete r.dataset.tourOrigOutlineOffset,delete r.dataset.tourOrigTransition,delete r.dataset.tourOrigBackground,delete r.dataset.tourOrigBackgroundColor,delete r.dataset.tourOrigBorderRadius,delete r.dataset.tourOrigOpacity});const n=document.getElementById("goLiveBanner");n&&n.dataset.tourHidden&&(delete n.dataset.tourHidden,typeof ae=="function"&&ae()),t.keepOverlay||(document.body.style.overflow="")}function zo(){const e=document.getElementById("tourTooltip"),t=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[e,...t,...o].filter(Boolean);return!i.length&&!o.length?(H({keepOverlay:!0}),Promise.resolve()):(Ee(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(H({keepOverlay:!0}),Promise.resolve()):(e&&(e.style.pointerEvents="none"),i.forEach(r=>{r.style.transition="opacity 0.07s ease, transform 0.07s ease",r.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(r=>{r.style.opacity="0",r.id==="tourTooltip"&&(r.style.transform="translateY(4px)")})}),new Promise(r=>{setTimeout(()=>{H({keepOverlay:!0}),r()},85)})))}function Co(e){const t=[e,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);t.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{t.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function G(e,t){if(!t.openAccordion)return;const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const r=o.querySelector(".accordion-arrow");r&&(r.style.transform="rotate(90deg)")}}function j(e){if(!e)return null;for(const t of String(e).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(t);if(o&&o.isConnected)return o}return null}function K(e,t){if(t.highlightSelector){const o=j(t.highlightSelector);if(o)return o}if(t.highlightCard){const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(o)return o}return t.targetParent&&(e.closest(".booking-card")||e.closest(".accordion-body"))||e}function oe(e,t){if(!t)return e;const o=String(t.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const n=document.querySelector(i);if(n&&n.isConnected)return n}if(t.accordionCard){const i=document.querySelector(t.accordionCard);if(i&&i.isConnected)return i}return e&&e.isConnected?e:null}function de(e,t){if(!e||!e.isConnected)return null;const o=e.getBoundingClientRect();return o.width<2||o.height<2||!t&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Fe(e,t){const o=j(e.anchorSelector);if(o){const i=de(o,!0);if(i)return i}return de(t,!0)}function Oe(e,t){const o=e.tooltipAnchorSelector||e.anchorSelector,i=j(o);if(i){const n=de(i,!0);if(n)return n}return Fe(e,t)}function le(e){const t=e||"auto";try{window.scrollTo({top:0,left:0,behavior:t})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const n=document.querySelector(i);n&&(n.scrollTop=0)})}function He(e,t,o){const i=o||{},n=t.scrollTarget||t.accordionCard,r=(n?j(n):null)||e;if(!r&&!t.scrollToTop)return Promise.resolve();const a=t.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=i.smooth&&!s?"smooth":d.settingsTourActive||s?"auto":"smooth";return new Promise(g=>{if(t.scrollToTop&&(le(c),t.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{t.forcePageTop&&le("auto"),g()}));return}if(!r){g();return}if(r.scrollIntoView({behavior:c,block:a,inline:"nearest"}),c==="auto"){requestAnimationFrame(()=>requestAnimationFrame(g));return}let x=!1;const v=()=>{x||(x=!0,window.removeEventListener("scrollend",S),clearTimeout(z),requestAnimationFrame(()=>requestAnimationFrame(g)))},S=()=>v();"onscrollend"in window&&window.addEventListener("scrollend",S,{once:!0});const z=setTimeout(v,520)})}function Ne(){H(),localStorage.setItem("settingsTourStep","handoff");const e=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&re("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const n=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof n=="function"&&n({chainFromSettingsTour:!0})},t=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof t=="function"?t().then(e).catch(e):e()}function Q(){H({keepOverlay:!0}),q(),d.settingsTourActive=!1,ae(),$({blockPointer:!0,lockScroll:!0,dim:te});const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    `,t?.subscribed&&!O()&&(g+=`
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=t}document.body.appendChild(e),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function ce(){const e=document.getElementById("postActivationTourTooltip");e&&e.remove();const t=document.getElementById("postActivationTourOverlay");t&&t.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function ne(){ce(),localStorage.setItem("postActivationTourDone","1");const e=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",e)}catch{}}function Je(){if(localStorage.getItem("postActivationTourDone")){ne();return}ce();const e=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. Once the Front Desk app is connected, new bookings can alert you even when it is closed."},{tab:"apps",navFilter:"apps",text:"<strong>Last step: open Guest Reach.</strong> Guests save your property from its booking page; you use this tab in Marketel Front Desk to share the QR, choose their Home Screen icon and send notifications."}];let t=0;function o(){if(ce(),t>=e.length){ne();return}const i=e[t],n=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);n&&setFilter(i.tab,n);const r=document.createElement("div");r.id="postActivationTourOverlay",r.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(r),document.body.style.overflow="hidden",setTimeout(()=>{const a=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);a&&(a.setAttribute("data-post-activation-highlight","1"),a.style.position="relative",a.style.zIndex="100003",a.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",a.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const s=a?a.getBoundingClientRect():{left:24,bottom:80,width:200},c=document.createElement("div");c.id="postActivationTourTooltip";const g=Math.min(300,window.innerWidth-32),x=Math.max(16,Math.min(s.left+s.width/2-g/2,window.innerWidth-g-16)),v=Math.min(s.bottom+14,window.innerHeight-180);c.style.cssText=`position:fixed;z-index:100004;left:${x}px;top:${v}px;max-width:${g}px;width:${g}px;`;const S=t>=e.length-1;c.innerHTML=`
