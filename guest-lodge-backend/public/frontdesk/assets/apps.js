import{c as g,e as J}from"./settings.js";const s={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4",frontdeskInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_19-49-38_1_tc1bzm.mp4"},K="32px";function m(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function v(t){return`border-radius:${K};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function G(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let $=[],u=0;function Z(t,e){w(!1),$=t,u=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?z(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?z(-1):i.key==="Escape"&&H()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const r=i.changedTouches[0].clientX-n;Math.abs(r)>50&&z(r<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",S()}function H(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function z(t){const e=$.length;e<=1||(u=(u+t+e)%e,S())}function S(){const t=document.getElementById("appsLightbox");if(!t)return;const e=$[u],o=$.length,n=e.type!=="video",i=o>1?`${u+1} / ${o}`:"",r=n?`<img src="${G(e.src)}" alt="${e.alt||""}"
  ...
  <div class="apps-page">
    ...
    <div style="flex-shrink:0;width:100%;max-width:400px;margin:0 auto;padding:12px 20px max(16px,env(safe-area-inset-bottom));box-sizing:border-box;text-align:center;">
      ...
      <div style="display:flex;gap:6px;justify-content:center;">${l}</div>
        ...
        </div>`}],x=0,H(),w(!1);const a=document.createElement("div");a.id="appsTourLightbox",a.style.cssText=["position:fixed;inset:0;z-index:102001;background:#000;","display:flex;flex-direction:column;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join("");let c=0;a._swipeStart=d=>{c=d.changedTouches[0].clientX},a._swipeEnd=d=>{const f=d.changedTouches[0].clientX-c;Math.abs(f)>50&&N(f<0?1:-1)},a.addEventListener("touchstart",a._swipeStart,{passive:!0}),a.addEventListener("touchend",a._swipeEnd,{passive:!0}),document.body.appendChild(a),document.body.style.overflow="hidden",I()}const oe={appsCloseLightbox:H,appsCloudinaryFull:G,appsCloudinaryImg:m,appsLbNav:z,appsLbRender:S,appsOpenLightbox:Z,appsPhoneImgStyle:v,appsQuestionRow:b,appsTourClose:w,appsTourNav:N,appsTourRender:I,appsVideoBadgeHtml:j,detectAppPlatform:ee,ensureAppsViewRendered:T,loadGuestInstallStats:A,renderAppsView:q,startAppsTour:te};function se(){J(oe)}export{oe as default,se as install};
