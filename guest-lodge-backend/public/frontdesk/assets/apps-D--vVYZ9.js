import{c as n,a as Se,b as Ce,e as Te}from"./settings-BIFo5gl7.js";function y(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function te(...e){return y("ensureAppsViewRendered")?.(...e)}function oe(...e){return y("showFinaleMockModal")?.(...e)}function ie(...e){return y("finishTourHydration")?.(...e)}function ae(...e){return y("goLive")?.(...e)}function re(...e){return y("toast")?.(...e)}function Ie(...e){return y("appsCloseLightbox")?.(...e)}let H=[],d=0,P=!1,A=null,O=null,W=null,C=null;function ze(){if(document.getElementById("frontdeskAppsTourStyle"))return;const e=document.createElement("style");e.id="frontdeskAppsTourStyle",e.textContent=`
    #appsTourLightbox {
