import{c as r,a as wt,b as kt,e as Tt}from"./settings-Cm4LQhi7.js";function f(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function J(...t){return f("ensureAppsViewRendered")?.(...t)}function tt(...t){return f("showFinaleMockModal")?.(...t)}function et(...t){return f("finishTourHydration")?.(...t)}function ot(...t){return f("goLive")?.(...t)}function it(...t){return f("toast")?.(...t)}function St(...t){return f("appsCloseLightbox")?.(...t)}let F=[],d=0,P=!1,B=null,M=null,N=null,k=null;function Ct(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function w(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function at(){B&&(document.removeEventListener("keydown",B),B=null)}function zt(t){at(),B=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",B)}function It(t,e){return!t||!t.isConnected||e?.noHighlight?null:(t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),k?.destroy(),k=kt(t,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"none",o.style.outline=e?.spotlightOutline??"none",o.style.outlineOffset=e?.spotlightOutlineOffset??"0",(t.classList.contains("apps-story-line")||e?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),k?.element||null)}function nt(t){const e=t||{};at(),N?.destroy(),N=null,k?.destroy(),k=null,M&&(clearTimeout(M),M=null);const o=document.getElementById("appsTourLightbox");o&&!e.keepLightbox&&o.remove();const n=document.getElementById("appsTourTooltip");n&&n.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function h(t){nt(),document.body.style.overflow="";const e=P;P=!1;try{const o=typeof J=="function"?J:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),e||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive)){const n=typeof tt=="function"?tt:window.showFinaleMockModal;if(typeof n=="function"){n();return}}}function At(t){const e=d+t;e<0||e>=F.length||(d=e,T())}function q(){if(localStorage.setItem("appsTourDone","1"),P||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive){r.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const e=typeof et=="function"?et:window.finishTourHydration;typeof e=="function"&&e()}}function $t(){q();const t=typeof ot=="function"?ot:window.goLive;if(h(!1),typeof t=="function"){t();return}const e=typeof it=="function"?it:window.toast;typeof e=="function"&&e("Open Go live to activate your booking page.","error")}function T(){Ct();const t=F[d];if(!t){h(!0);return}const e=F.length,o=d>=e-1,n=`${d+1} / ${e}`,i=Math.max(8,Math.min(100,Math.round((d+1)/e*100))),a=document.querySelector(t.target);if(!a){d++,T();return}nt({keepLightbox:!0});let s=document.getElementById("appsTourLightbox");s||(s=document.createElement("div"),s.id="appsTourLightbox",s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(s)),t.noHighlight||(a.dataset.appsTourOrigPosition=a.style.position||"",a.dataset.appsTourOrigZIndex=a.style.zIndex||"",a.dataset.appsTourOrigIsolation=a.style.isolation||"",a.dataset.appsTourOrigBoxShadow=a.style.boxShadow||"",a.dataset.appsTourOrigOutline=a.style.outline||"",a.dataset.appsTourOrigOutlineOffset=a.style.outlineOffset||"",a.dataset.appsTourOrigTransition=a.style.transition||"",a.style.position=a.style.position||"relative",a.style.zIndex="100002",a.style.isolation="isolate",a.style.transition="box-shadow 0.18s ease, outline 0.18s ease",a.style.boxShadow=t.spotlightBoxShadow??"none",a.style.outline=t.spotlightOutline??"none",a.style.outlineOffset=t.spotlightOutlineOffset??"0",(a.classList.contains("apps-story-line")||t.hideSpotlightBorder)&&(a.dataset.appsTourOrigBorderTop=a.style.borderTop||"",a.dataset.appsTourOrigPaddingTop=a.style.paddingTop||"",a.style.borderTop="none",a.style.paddingTop="0"),a.setAttribute("data-apps-tour-highlighted","1"));const l=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,x=t.scrollBlock||"nearest",b=l?"auto":"smooth";a.scrollIntoView({behavior:b,block:x});const p=()=>{const y=document.getElementById("appsTourTooltip");y&&y.remove();const g=Math.min(370,window.innerWidth-28),v=t.primaryLabel||(o?"Done":"Next"),L=t.secondaryLabel||(o?"Not now":"Skip tour"),z=d<=0,j=t.kicker||"Guest App",u=document.createElement("div");u.id="appsTourTooltip",u.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${g}px;max-width:${g}px;visibility:hidden;`,u.innerHTML=`
      ...
      </div>`,document.body.appendChild(u),It(a,t);const Q=u.querySelector(".apps-tour-panel");N?.destroy(),N=wt({tooltip:u,panel:Q,target:a,anchor:a,spotlight:k,options:{preferredPlacement:t.tooltipPosition||"auto",maxWidth:g,gap:t.tooltipGap??10,autoScroll:!0,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),u.style.visibility="visible";const O=()=>{if(t.activateOnNext){$t();return}if(o){q(),h(!1),t.openGuestInstallCoachOnNext&&window.setTimeout(()=>f("appsOpenGuestInstallCoach")?.(),0);return}d++,T()},I=()=>{if(o){q(),h(!1);return}h(!0)},E=()=>{d<=0||(d--,T())};document.getElementById("appsTourNextBtn").onclick=O,document.getElementById("appsTourSkipBtn").onclick=I;const G=document.getElementById("appsTourBackBtn");G&&(G.onclick=E),zt({onNext:O,onBack:E,onSkip:I})};M=setTimeout(()=>{requestAnimationFrame(p)},l?40:320)}function Bt(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;St(),h(!1),P=!!o;const n=!!r.hotelSubscribed;F=!!f("isNativeFrontdeskApp")?.()||document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1"?[{target:"#tour-guest-reach",kicker:"Direct guest reach",title:"Send a push notification directly to their phone.",text:"Every guest who downloads your app and turns on notifications can receive a message from you whenever you choose.",tooltipPosition:"above"},{target:"#tour-native-guest-share",kicker:"Build your audience",title:"Get your app onto their phone.",text:"Show the QR, copy the link, or open the guest page. They install it from there.",tooltipPosition:"above"},{target:"#tour-guest-icon-section",kicker:"Make it yours",title:"Choose the icon guests will save.",text:"Use your logo or a clear property photo.",scrollBlock:"start",tooltipPosition:"below"},{target:"#tour-native-install-guide",kicker:"Your cheat sheet",title:"Know exactly what to tell them.",text:"Open this anytime to practice the exact Safari taps for older iPhones and every iOS 26 layout.",primaryLabel:"Show me",secondaryLabel:"Close",openGuestInstallCoachOnNext:!0,tooltipPosition:"above"}]:[{target:"#tour-apps-intro",kicker:"The loop",title:"Your property becomes the app—and the direct connection.",text:"Guests book direct, save your property to their phone, and can receive notifications from you."},{target:"#tour-apps-first",kicker:"Your side",title:"Download Marketel Front Desk.",text:"The owner app receives new-booking alerts even when the web dashboard is closed. Guests do not download this app.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-then",kicker:"Their side",title:"Guests install from your booking page.",text:"One tap on Install and your icon is on their home screen.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-after",kicker:"Direct reach",title:"Send a notification to their phone whenever you want.",text:"Anyone who installs your app and turns on notifications becomes reachable directly from Front Desk.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your property.",text:"A real logo or a clear photo. Guests see this square every time.",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10},{target:"#tour-apps-loop",kicker:n?"Live loop":"Activation",title:n?"This loop is on.":"Everything is ready to turn on.",text:n?"Guests book, save your property, receive your updates, and message you. Front Desk gets the alerts.":"For $199/month, guests can book direct, save your property, receive your updates, and message you — while Front Desk receives the alerts.",primaryLabel:n?"Done":"Activate everything — $199/month",secondaryLabel:n?"Close":"Keep exploring",activateOnNext:!n,tooltipPosition:"below",tooltipGap:8}],d=0,T()}const c={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},_t="32px";function Y(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function R(t){return`border-radius:${_t};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function rt(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let D=[],S=0,V="ios26",C=null,st="",_=null;function Lt(t,e){h(!1),isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),D=t,S=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?H(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?H(-1):i.key==="Escape"&&W()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const a=i.changedTouches[0].clientX-n;Math.abs(a)>50&&H(a<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",U()}function W(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState()))}function H(t){const e=D.length;e<=1||(S=(S+t+e)%e,U())}function U(){const t=document.getElementById("appsLightbox");if(!t)return;const e=D[S],o=D.length,n=e.type!=="video",i=o>1?`${S+1} / ${o}`:"",a=n?`<img src="${rt(e.src)}" alt="${e.alt||""}"
    ...
    ${Array.from({length:o},(b,p)=>`<div onclick="appsOpenLightbox(_appsLbItems,${p})" style="width:7px;height:7px;border-radius:50%;background:${p===S?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
  ...
  </svg>`}function Ot(){return`<svg viewBox="44 39.5 21 13" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Et(){return`<svg viewBox="0 0 28 28" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Gt(t,e){const o=[...t?[{label:"More",icon:pt()}]:[],{label:"Share",icon:Z()},...e?[{label:"View More",icon:Ot()}]:[],{label:"Add to Home Screen",icon:Et()}];return`<div class="agic-sequence" aria-label="${o.map(n=>n.label).join(", then ")}">
    ...
    ${s}
  </button>`}function Pt(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function Nt(t){const e=document.getElementById("appsView");if(!e)return;const o=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",n=(r.activeHotelId||"")+"|"+(r.activeHotelAppIcon||"")+"|"+(r.activeHotelDomain||"")+"|"+(o?"native-preview":"standard");t||e.dataset.appsKey!==n||!e.querySelector(".apps-page")?(ut(),e.dataset.appsKey=n):(isNativeFrontdeskApp()||o)&&K()}function ut(){const t=document.getElementById("appsView");if(!t)return;const e=r.activeHotelName||"Your Property",o=r.activeHotelAppIcon||"",n=e.trim().charAt(0).toUpperCase()||"🏡",i=r.activeHotelDomain||"",a=i?"https://"+i:"#",s=i?"https://"+i+"/install":"#";function l(vt){return JSON.stringify(vt).replace(/"/g,"&quot;")}const x=Y(c.guestHome,520),b=[{type:"image",src:c.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You download <strong>Marketel Front Desk</strong> from the App Store. Guests save <strong>${e}</strong> from your booking page — no Guest App Store download.`}],p=[{type:"image",src:c.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:c.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:c.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],m=[{type:"video",src:c.guestInstallVideo,poster:c.guestHome,alt:"Guest adds property to phone",title:"How guests put your property on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your property shows up on their phone like an app. You don't need to do anything."}],y=[{type:"image",src:c.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your guest app.'},{type:"image",src:c.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Guest App</strong>, choose the conversation, and reply."},{type:"video",src:c.guestMessageNotifVideo,poster:c.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],g=isStandaloneApp(),v=isNativeFrontdeskApp(),L=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",z=v||L,j=String(r.nativeNotificationState||""),u=L||j==="registered",O=v?u:(v?u:g)&&typeof Notification<"u"&&Notification.permission==="granted";window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,Number(r.bookingReviewSettings?.reminderMinutes??15),v||g&&O||g||String(r.frontdeskAppStoreUrl||"").trim();const I="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",E=o?I+"background:#fff;border:1px solid var(--border);padding:0;":I,G=o?`<img src="${o}" alt="Property logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,xt=`
    ...
    </div>`;s!=="#"&&`${s.replace("https://","")}`,`${x}${l(m)}${$("What guests see on their phone","",l(p),0,!1)}${$("How guests add your property","",l(m),0,!0)}${$("Guest texts you, you text back","",l(y),0,!0)}${$("Your app and theirs — side by side","",l(b),0,!1)}`,a!=="#"&&`${a}`;const ft=()=>`
    ...
    </section>`,X=z?"":g?"Front Desk is installed. Guests can install your property from the direct booking page.":"Download Marketel Front Desk for the owner. Guests save your property from its direct booking page.";t.innerHTML=`
  <style>
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),z&&(r.guestMessages.length?renderMessages():loadMessages(),K(),ht())}async function ht(){try{const t=await api("GET","/api/crm/booking-review-settings");if(!t?.success||!t.data)return;r.bookingReviewSettings=t.data;const e=document.getElementById("bookingReviewReminderSelect");e&&(e.value=String(t.data.reminderMinutes))}catch{}}async function Dt(t){const e=String(r.bookingReviewSettings?.reminderMinutes??15),o=parseInt(t?.value,10);if([0,15,30,60].includes(o)){t&&(t.disabled=!0);try{const n=await api("POST","/api/crm/booking-review-settings",{reminderMinutes:o});if(!n?.success)throw new Error(n?.message||"Could not save reminder timing.");r.bookingReviewSettings=n.data,toast(o===0?"Booking reminders off — the first alert will still arrive.":`Booking reminders set for every ${o===60?"hour":o+" minutes"}.`,"success")}catch(n){t&&(t.value=e),toast(n?.message||"Could not save reminder timing.","error")}finally{t&&(t.disabled=!1)}}}async function K(){const t=document.getElementById("guestInstallStats");try{const e=await api("GET","/api/crm/guest-install-stats");if(!e.success)throw new Error(e.message||"Failed");if(r.guestPushSubscriberCount=e.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const o=e.totals||{},n=e.installedBookings||0,i=o.views||0,a=o.notification_prompts||0,s=e.guestPushSubscribers||0;if(!n&&!i){t.style.display="none",t.innerHTML="";return}t.style.display="block";const l=e.installRatePercent!=null?e.installRatePercent:0,x=Object.entries(e.byTouchpoint||{}).filter(function(p){return p[1].views||p[1].installed}).sort(function(p,m){return(m[1].installed||0)-(p[1].installed||0)}).slice(0,5),b=x.length?x.map(function(p){const m=p[0].replace(/-/g," "),y=p[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+m+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(y.views||0)+" views · "+(y.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+l+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+n+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">guests reachable now</div></div></div>'+(a?'<div style="font-size:11px;color:var(--text-muted);margin:-2px 0 10px;">Notification permission: '+(o.notification_granted||0)+" granted · "+(o.notification_denied||0)+" denied · "+(o.notification_dismissed||0)+" dismissed · "+(o.notification_failed||0)+" failed</div>":"")+(b?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+b:"")}catch{r.guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}const Vt={appsCloseLightbox:W,appsCloseGuestInstallCoach:ct,appsCloudinaryFull:rt,appsCloudinaryImg:Y,appsLbNav:H,appsLbRender:U,appsOpenLightbox:Lt,appsOpenGuestInstallCoach:Mt,appsPhoneImgStyle:R,appsQuestionRow:$,appsGuestInstallCoachSelectLayout:Ft,appsGuestInstallCoachSetVersion:Ht,appsTourClose:h,appsTourNav:At,appsTourRender:T,appsVideoBadgeHtml:gt,detectAppPlatform:Pt,ensureAppsViewRendered:Nt,loadBookingReviewSettings:ht,loadGuestInstallStats:K,renderAppsView:ut,saveBookingReviewReminderSetting:Dt,startAppsTour:Bt};function Wt(){Tt(Vt)}export{Vt as default,Wt as install};
