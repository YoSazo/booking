import{c as r,a as Mt,b as Nt,e as Rt}from"./settings-DzmlfyYA.js";function v(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function at(...t){return v("ensureAppsViewRendered")?.(...t)}function st(...t){return v("showFinaleMockModal")?.(...t)}function rt(...t){return v("finishTourHydration")?.(...t)}function pt(...t){return v("goLive")?.(...t)}function lt(...t){return v("toast")?.(...t)}function jt(...t){return v("appsCloseLightbox")?.(...t)}let D=[],g=0,M=!1,B=null,G=null,N=null,k=null;function qt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
