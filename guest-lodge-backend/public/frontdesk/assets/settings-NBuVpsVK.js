const c={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let W=null;function Fe(){return typeof lucide<"u"?Promise.resolve():W||(W=new Promise((t,e)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>t(),o.onerror=()=>e(new Error("lucide load failed")),document.head.appendChild(o)}),W)}async function qt(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let a=e.width,n=e.height;const r=Math.min(1,o/a,i/n);a=Math.round(a*r),n=Math.round(n*r);const d=document.createElement("canvas");d.width=a,d.height=n,d.getContext("2d").drawImage(e,0,0,a,n),e.close();const p=await new Promise((y,v)=>{d.toBlob(S=>S?y(S):v(new Error("encode failed")),"image/webp",.82)}),f=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([p],f+".webp",{type:"image/webp"})}catch{return t}}function De(){const t=()=>{c.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}function Ut(t){Object.assign(window,t)}function F(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function J(...t){return F("setFilter")?.(...t)}function jt(...t){return F("toast")?.(...t)}function X(...t){return F("updateGoLiveBanner")?.(...t)}function Gt(...t){return F("seedTourRevenueShell")?.(...t)}function Yt(...t){return F("finishTourHydration")?.(...t)}function Vt(...t){return F("goLive")?.(...t)}let U=null;function M(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
  ...
  `,document.head.appendChild(t)}function lt(){U&&(document.removeEventListener("keydown",U),U=null)}function Wt(t){lt(),U=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",U)}function nt(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function A(t){M();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=e.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=e.blockPointer?"auto":"none",e.lockScroll&&(document.body.style.overflow="hidden"),o}const Q="rgba(17,24,39,0.42)";function H(){const t=document.getElementById("tourTooltip"),e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!t||e)return Promise.resolve();t.style.pointerEvents="none";const o=t.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function _t(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function Qt(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((a,n)=>{const r=i[n];r&&(a.type==="checkbox"||a.type==="radio"?r.checked=a.checked:r.value=a.value)})}function Et(t,e){const o=getComputedStyle(t);for(const n of o)e.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=t.children,a=e.children;for(let n=0;n<i.length;n+=1)a[n]&&Et(i[n],a[n])}function kt(t,e){if(!t||!t.isConnected)return null;document.querySelectorAll("[data-tour-spotlight-clone]").forEach(a=>a.remove());const o=t.getBoundingClientRect();if(o.width<2||o.height<2)return null;const i=t.cloneNode(!0);return _t(i),Et(t,i),Qt(t,i),i.setAttribute("data-tour-spotlight-clone","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.left=`${o.left}px`,i.style.top=`${o.top}px`,i.style.width=`${o.width}px`,i.style.height=`${o.height}px`,i.style.margin="0",i.style.maxWidth="none",i.style.zIndex="99999",i.style.pointerEvents="none",i.style.transform="none",i.style.boxShadow=e?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",i.style.outline=e?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",i.style.outlineOffset=e?.spotlightOutlineOffset??"2px",e?.spotlightBackground&&(i.style.background=e.spotlightBackground,i.style.backgroundColor=e.spotlightBackground),e?.spotlightBorderRadius&&(i.style.borderRadius=e.spotlightBorderRadius),document.body.appendChild(i),i}function O(t){const e=t||{};lt();const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!e.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.style.opacity=n.dataset.tourOrigOpacity||"";const r=n.dataset.tourOrigBackground||"",d=n.dataset.tourOrigBackgroundColor||"";d?n.style.backgroundColor=d:n.style.removeProperty("background-color"),r?n.style.background=r:n.style.removeProperty("background"),n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius,delete n.dataset.tourOrigOpacity});const a=document.getElementById("goLiveBanner");a&&a.dataset.tourHidden&&(delete a.dataset.tourHidden,typeof X=="function"&&X()),e.keepOverlay||(document.body.style.overflow="")}function Kt(){const t=document.getElementById("tourTooltip"),e=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[t,...e,...o].filter(Boolean);return!i.length&&!o.length?(O({keepOverlay:!0}),Promise.resolve()):(lt(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(O({keepOverlay:!0}),Promise.resolve()):(t&&(t.style.pointerEvents="none"),i.forEach(n=>{n.style.transition="opacity 0.07s ease, transform 0.07s ease",n.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(n=>{n.style.opacity="0",n.id==="tourTooltip"&&(n.style.transform="translateY(4px)")})}),new Promise(n=>{setTimeout(()=>{O({keepOverlay:!0}),n()},85)})))}function Zt(t){const e=[t,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);e.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{e.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function L(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function $(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function N(t,e){if(e.highlightSelector){const o=$(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function K(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const a=document.querySelector(i);if(a&&a.isConnected)return a}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function tt(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function j(t,e){const o=$(t.anchorSelector);if(o){const i=tt(o,!0);if(i)return i}return tt(e,!0)}function Jt(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function rt(t,e){if(!e)return;const o=Jt(t);if(o){o.scrollTop+=e;return}window.scrollBy({top:e,left:0,behavior:"auto"})}function Xt(t,e){return e&&t.mobileTooltipPosition||t.tooltipPosition||"below"}function te(t,e,o,i){if(!t||!t.isConnected||!o)return j(e,t);const a=o.querySelector(".tour-panel"),n=Math.min(a&&a.offsetHeight||o.offsetHeight||190,Math.max(140,window.innerHeight-28)),r=e.tooltipGap??8,d=e.fitPadTop??e.scrollPadTop??72,p=window.innerHeight-(e.fitPadBottom??14),f=()=>j(e,t)||tt(t,!0);let y=f();if(!y)return null;for(let v=0;v<3;v+=1){const S=Math.max(120,p-d),R=y.height+r+n<=S;let I=0;if(i==="above"){const P=y.top-r-n-d;P<0&&(I=P),R&&y.bottom>p&&(I=y.bottom-p)}else{const P=y.bottom+r+n-p;P>0&&(I=P),R&&y.top<d&&(I=y.top-d)}if(Math.abs(I)<1)break;if(rt(t,I),y=f(),!y)return null}return y}function et(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const a=document.querySelector(i);a&&(a.scrollTop=0)})}function St(t,e,o){const i=o||{},a=e.scrollTarget||e.accordionCard,n=(a?$(a):null)||t;if(!n&&!e.scrollToTop)return Promise.resolve();const r=e.scrollBlock||"center",d=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let p=i.smooth&&!d?"smooth":c.settingsTourActive||d?"auto":"smooth";return new Promise(f=>{(()=>{if(!i.smooth||!n||e.forceSmoothScroll)return!1;const l=$(e.anchorSelector)||(n&&n.isConnected?n:null)||(t&&t.isConnected?t:null);if(!l)return!0;const g=l.getBoundingClientRect(),h=e.scrollPadTop??80,s=e.scrollPadBottom??220,x=Math.max(0,h-g.top),m=Math.max(0,g.bottom-(window.innerHeight-s));return Math.max(x,m)<=(e.quickScrollThreshold??180)})()&&(p="auto");const v=()=>{const l=e.scrollPadTop??80,g=e.scrollPadBottom??220,h=$(e.anchorSelector)||(n&&n.isConnected?n:null)||(t&&t.isConnected?t:null);if(!h){f();return}let s=h.getBoundingClientRect();s.top<l&&(rt(h,s.top-l),s=h.getBoundingClientRect()),s.bottom>window.innerHeight-g&&rt(h,s.bottom-window.innerHeight+g),requestAnimationFrame(()=>requestAnimationFrame(f))},S=()=>{n&&n.scrollIntoView({behavior:e.scrollToTop?"auto":p,block:r,inline:"nearest"}),v()};if(e.scrollToTop){if(et(p),e.scrollToTopOnly){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&et("auto"),f()}));return}if(p==="auto"){S();return}let l=!1;const g=()=>{l||(l=!0,window.removeEventListener("scrollend",h),clearTimeout(s),S())},h=()=>g();"onscrollend"in window&&window.addEventListener("scrollend",h,{once:!0});const s=setTimeout(g,520);return}if(!n){f();return}if(n.scrollIntoView({behavior:p,block:r,inline:"nearest"}),p==="auto"){v();return}let R=!1;const I=()=>{R||(R=!0,window.removeEventListener("scrollend",P),clearTimeout(u),v())},P=()=>I();"onscrollend"in window&&window.addEventListener("scrollend",P,{once:!0});const u=setTimeout(I,620)})}function Bt(){O(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&J("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const a=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof a=="function"&&a({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function q(){O({keepOverlay:!0}),M(),c.settingsTourActive=!1,X(),A({blockPointer:!0,lockScroll:!0,dim:Q});const t=document.createElement("div");if(t.id="tourTooltip",t.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",t.innerHTML=`
    ...
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(m);const z=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,C=Xt(l,z);let D=g;if(g&&g.width>=2&&g.height>=2){D=te(u,l,m,C)||g,l.noHighlight||kt(u,l);const V=Math.min(380,window.innerWidth-28);m.style.setProperty("--tour-width",`${V}px`),m.style.left="0",m.style.right="auto",m.style.bottom="auto",m.style.width=`${V}px`,m.style.justifyContent="flex-start",m.classList.add("tour-tooltip-floating");const yt=m.querySelector(".tour-panel"),ht=Math.min(yt&&yt.offsetHeight||m.offsetHeight||190,Math.max(140,window.innerHeight-28)),bt=l.tooltipGap??8,Ht=D.left+D.width/2,vt=Math.max(14,Math.min(Ht-V/2,window.innerWidth-V-14)),Nt=C!=="above"?D.bottom+bt:D.top-ht-bt,wt=Math.max(14,Math.min(Nt,window.innerHeight-ht-14));m.style.setProperty("--tour-left",`${vt}px`),m.style.setProperty("--tour-top",`${wt}px`),m.style.left=`${vt}px`,m.style.top=`${wt}px`}m.style.visibility="visible",s.fadeIn&&Zt(m),S()}function S(){const u=document.getElementById("tourNextBtn"),l=document.getElementById("tourSkipBtn"),g=b=>{if(b<0)return;const w=r(o[i],o[b]),E=()=>{i=b,localStorage.setItem("settingsTourStep",String(i)),p({keepCurrentUi:w})};Kt().then(E)},h=()=>{g(i+1)},s=()=>{n()},x=()=>{i<=0||g(i-1)};u&&(u.onclick=h),l&&(l.onclick=s);const m=document.getElementById("tourBackBtn");m&&(m.onclick=x),Wt({onNext:h,onBack:x,onSkip:s})}function R(){M(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms(),A({blockPointer:!0,lockScroll:!0,dim:Q});const u=c.activeHotelName||"Your Property",l=u.trim().charAt(0).toUpperCase(),g=u.length>10?u.slice(0,10):u,h="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",s="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",x="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",m=`<div style="${h}"><div style="${s}background:rgba(255,255,255,0.22);"></div><div style="${x}"></div></div>`,b=c.activeHotelAppIcon||"",w=b?`<img src="${b}" alt="" style="width:100%;height:100%;object-fit:contain;">`:l,E=b?`${s}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${s}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,k=`<div style="${h}"><div style="${E}">${w}</div><div style="${x}font-size:7.5px;color:#fff;font-weight:700;">${g}</div></div>`,T=[m,m,m,m,k,m,m,m].join(""),B=document.createElement("div");if(B.id="tourTooltip",B.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",B.innerHTML=`
      ...
      </div>`,document.body.appendChild(B),!document.getElementById("tourModalAnimStyle")){const z=document.createElement("style");z.id="tourModalAnimStyle",z.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(z)}document.getElementById("tourNextBtn").onclick=()=>{H().then(()=>{a({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),p()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}}function I(){M(),A({blockPointer:!0,lockScroll:!0,dim:Q});let u=0;const l=[`<div style="padding:20px 18px 0;">
    ...
    `,t.innerHTML=p}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function ee(){const t=document.getElementById("settings-booking-url");t&&navigator.clipboard.writeText(t.value).then(()=>{localStorage.setItem("linkCopied","1"),G(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function oe(){localStorage.setItem("settingsTourDone","1");const t=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",t);let e=0;const o=setInterval(()=>{e++;const i=document.getElementById("edit-rate-nightly");if(i||e>20){if(clearInterval(o),!i)return;const a=i.closest(".accordion-body");if(a&&a.style.display==="none"){a.style.display="block";const n=a.previousElementSibling?.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const n=document.getElementById("checklistPointer");n&&n.remove();const r=i.getBoundingClientRect(),d=document.createElement("div");d.id="checklistPointer",d.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${r.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,d.innerHTML=`
          ...
          `,document.body.appendChild(d),setTimeout(()=>{const p=document.getElementById("checklistPointer");p&&p.remove()},6e3)},1e3)},100)}},200)}function ie(){const e="https://"+(c.activeHotelDomain||c.activeHotelId+".mktel.co");navigator.clipboard.writeText(e).then(()=>{localStorage.setItem("linkCopied","1"),G(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function ne(t,e){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const a=setInterval(()=>{i++;const n=document.querySelector(t);if(n||i>20){if(clearInterval(a),!n)return;n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const r=document.getElementById("checklistPointer");r&&r.remove();const d=n.getBoundingClientRect(),p=document.createElement("div");p.id="checklistPointer",p.style.cssText=`
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),ut()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}async function gt(){if(isEditPageDomReady())return;if(c.editRoomsLoadPromise)return c.editRoomsLoadPromise;const t=document.getElementById("editRoomsList");if(t){c.editRoomsLoadPromise=(async()=>{t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[e,o]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify")]);if(!e.rooms)throw new Error("No data");c.editRooms=e.rooms;const i=o?.hotelName||"";i&&(c.activeHotelName=i),o&&(c.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const a=o?.hotelSubtitle||"",n=o?.hotelAddress||"",r=o?.hotelPhone||"",d=o?.appIconUrl||"";c.activeHotelAppIcon=d,updateFrontdeskManifestLink();let p={nightly:69,weekly:299,monthly:999,taxRate:.1};e.rates&&(p=e.rates);const y="https://"+(o?.domain||c.activeHotelId+".mktel.co"),v="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(y);let S=`
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",it),i=document.getElementById("amenityPickerModal"));const a=document.getElementById("amenityPickerGrid");a.innerHTML=Rt.map(n=>{const r=o.some(d=>d.includes(n.key));return`<button onclick="toggleAmenityPreset(this,'${n.key}')" data-key="${n.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${r?"#2E7D5B":"#e5e7eb"};background:${r?"#E8F5EE":"white"};color:${r?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${n.icon}" style="width:14px;height:14px;"></i> ${n.label}</button>`}).join(""),document.getElementById("amenityCustomInput").value="",i.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function xe(t,e){const o=t.style.borderColor==="rgb(46, 125, 91)";t.style.borderColor=o?"#e5e7eb":"#2E7D5B",t.style.background=o?"white":"#E8F5EE",t.style.color=o?"#1a1a2e":"#2E7D5B"}function it(){document.getElementById("amenityPickerModal").style.display="none",ft=null}function ye(){const t=c.editRooms.find(a=>a.id===ft);if(!t){it();return}const e=document.getElementById("amenityPickerGrid"),o=[];e.querySelectorAll("button").forEach(a=>{if(a.style.background==="rgb(232, 245, 238)"){const n=Rt.find(r=>r.key===a.dataset.key);n&&o.push(n.label)}});const i=document.getElementById("amenityCustomInput").value.trim();i&&o.push(i),t.amenities=o.join(" • "),it(),mt(),typeof lucide<"u"&&lucide.createIcons()}function he(t){Mt(t)}function be(t,e){const o=c.editRooms.find(a=>a.id===t);if(!o)return;const i=(o.amenities||"").split("•").map(a=>a.trim()).filter(Boolean);o.amenities=i.filter(a=>a!==e).join(" • "),mt(),typeof lucide<"u"&&lucide.createIcons()}async function ve(){const t=document.getElementById("edit-hotel-name")?.value.trim(),e=document.getElementById("edit-hotel-subtitle")?.value.trim(),o=document.getElementById("edit-hotel-address")?.value.trim(),i=document.getElementById("edit-hotel-phone")?.value.trim(),a=document.getElementById("edit-hotel-policy")?.value.trim();try{await api("POST","/api/crm/hotel-info",{name:t,subtitle:e,address:o,phone:i,cancellationPolicy:a}),toast("Property info saved!","success")}catch{toast("Failed to save","error")}}async function we(){const t=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),localStorage.setItem("ratesChanged","1"),c.launchStatus=null,G(),toast("Rates saved!","success")}catch{toast("Failed to save rates","error")}}async function ke(){const t=document.getElementById("edit-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");c.token=t,c.isMasterPin=!1;try{localStorage.setItem("crmToken",c.token)}catch{}toast("PIN updated!","success")}catch(e){toast(e.message||"Failed to change PIN","error")}}function Ee(t){navigator.clipboard.writeText(t).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function Se(t){const e=t.nextElementSibling,o=t.querySelector(".accordion-arrow");e.style.display==="none"?(e.style.display="block",o&&(o.style.transform="rotate(90deg)")):(e.style.display="none",o&&(o.style.transform="rotate(0deg)"))}let _=!1;function $t(){if(document.getElementById("goLiveOverlay"))return;const t=document.createElement("div");t.id="goLiveOverlay",t.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(255,255,255,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;",t.innerHTML='<div class="logo-sprite-bounce"></div><div style="font-size:14px;font-weight:700;color:#1a5c3f;">Opening secure checkout…</div><div style="font-size:12px;color:#6b7280;">Taking you to Stripe — one moment</div>',document.body.appendChild(t)}function st(){const t=document.getElementById("goLiveOverlay");t&&t.remove()}async function Be(){if(!_){_=!0,$t();try{const t=await api("POST","/api/crm/go-live");if(t.success&&t.url){window.location.href=t.url;return}st(),_=!1,toast(t.message||"Failed to start checkout","error")}catch{st(),_=!1,toast("Failed to start checkout. Try again.","error")}}}async function Te(){try{const t=await api("GET","/api/crm/billing-portal");t.success&&t.url?window.location.href=t.url:toast(t.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function Ie(){const t=document.getElementById("supportMessage")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),document.getElementById("supportMessage").value="",toast("Message sent! We'll reply to your email.","success")}catch{toast("Failed to send. Email support@bookmarketel.com directly.","error")}}async function ze(t){const e=c.editRooms.find(d=>d.id===t);if(!e){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+t)?.value.trim(),i=document.getElementById("edit-desc-"+t)?.value.trim(),a=parseInt(document.getElementById("edit-occ-"+t)?.value)||4,n=parseInt(document.getElementById("edit-units-"+t)?.value)||1,r={id:t,name:o||e.name,description:i||"",amenities:e.amenities||"",maxOccupancy:a,totalUnits:n};try{const d=await api("POST","/api/crm/rooms",r);if(d&&d.success===!1){toast(d.message||"Failed to save","error");return}e.name=r.name,e.description=r.description,e.maxOccupancy=a,e.totalUnits=n,toast("Room saved!","success")}catch(d){toast("Failed to save: "+(d.message||""),"error")}}async function Pe(t,e){const o=Array.from(t.target.files);if(!o.length)return;const a=document.getElementById("edit-card-"+e)?.querySelector("div:first-child");a&&(a.style.position="relative",a.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+e+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+e+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let n=0,r="";for(const p of o){try{const y=await pt(e,p);if(y.image){const v=c.editRooms.find(S=>S.id===e);v&&(v.images||(v.images=[]),v.images.push(y.image),v.imageUrl||(v.imageUrl=y.image.url)),n++}}catch(y){r=y.message||"Upload failed"}const f=document.getElementById("upload-progress-"+e);f&&(f.textContent=n+" / "+o.length)}const d=document.getElementById("upload-spinner-"+e);d&&d.remove(),Y(),n>0&&(c.launchStatus=null),G(),n>0?toast(n+" photo"+(n!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success"):toast(r||"Upload failed","error")}function Lt(t,e=512){return new Promise((o,i)=>{const a=new Image,n=URL.createObjectURL(t);a.onload=()=>{try{const r=Math.min(a.naturalWidth,a.naturalHeight),d=(a.naturalWidth-r)/2,p=(a.naturalHeight-r)/2,f=document.createElement("canvas");f.width=e,f.height=e;const y=f.getContext("2d");y.imageSmoothingQuality="high",y.drawImage(a,d,p,r,r,0,0,e,e),URL.revokeObjectURL(n),f.toBlob(v=>v?o(v):i(new Error("crop failed")),"image/png",.92)}catch(r){URL.revokeObjectURL(n),i(r)}},a.onerror=()=>{URL.revokeObjectURL(n),i(new Error("load failed"))},a.src=n})}function Ft(){const t=document.getElementById("appsAppIconPreview");t&&(t.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function xt(t){const e=document.getElementById("appsAppIconPreview");e&&(e.style.background="#fff",e.style.border="1px solid var(--border)",e.style.padding="0",e.innerHTML='<img src="'+t+'" alt="App icon" style="width:100%;height:100%;object-fit:contain;">')}function dt(){const t=document.getElementById("appsAppIconPreview");if(!t)return;if(c.activeHotelAppIcon){xt(c.activeHotelAppIcon);return}const e=(c.activeHotelName||"P").trim().charAt(0).toUpperCase()||"🏡";t.style.background="transparent",t.style.border="none",t.style.padding="0",t.innerHTML='<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">'+e+"</span>"}async function Ae(t){const e=t.files&&t.files[0];if(!e)return;Ft();const o=new FormData;try{const i=await Lt(e,512);o.append("icon",i,"app-icon.png")}catch{o.append("icon",e)}try{const i=ct(),a=new URLSearchParams;c.activeHotelId&&a.set("hotelId",c.activeHotelId),i&&a.set("token",i);const r=await(await fetch(`/api/crm/hotel-app-icon?${a}`,{method:"POST",headers:{"x-crm-token":i},body:o})).json();if(r.success&&r.appIconUrl){c.activeHotelAppIcon=r.appIconUrl,xt(r.appIconUrl);const d=document.getElementById("appsView");d&&(d.dataset.appsKey=(c.activeHotelId||"")+"|"+r.appIconUrl+"|"+(c.activeHotelDomain||"")),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Logo updated! Guests will see it on their phone.","success")}else toast(r.message||"Failed to upload icon","error"),dt()}catch{toast("Failed to upload icon","error"),dt()}t.value=""}async function Ce(t,e){if(confirm("Delete this photo?"))try{await api("DELETE",`/api/crm/rooms/${t}/images/${e}`);const o=c.editRooms.find(i=>i.id===t);o&&o.images&&(o.images=o.images.filter(i=>i.id!==e),o.imageUrl=o.images[0]?.url||null),Y(),toast("Photo deleted","success")}catch{toast("Failed to delete","error")}}async function Oe(t){if(confirm("Delete this room type?"))try{await api("DELETE",`/api/crm/rooms/${t}`),toast("Room deleted","success"),gt()}catch{toast("Failed to delete","error")}}function Re(){const t=document.getElementById("editRoomsList");document.getElementById("editAddForm")||(t.insertAdjacentHTML("beforeend",`
  ...
  `),document.getElementById("editNewRoomName").focus())}function Me(){const t=document.getElementById("editNewRoomName").value.trim();t&&api("POST","/api/crm/rooms",{name:t,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),gt()}).catch(()=>toast("Failed to add","error"))}const Dt={addAmenityPrompt:he,advanceTourIfNeeded:G,changePin:ke,checklistGoTo:ne,checklistGoToRates:oe,cleanupPostActivationTourUi:ot,cleanupSettingsTourUi:O,closeAmenityPicker:it,confirmAmenityPicker:ye,confirmEditAddRoom:Me,copyBookingLink:Ee,copyBookingLinkFromChecklist:ie,deleteEditImage:Ce,deleteEditRoom:Oe,ensureTourBlurOverlay:A,finishPostActivationTour:Z,getAmenityIcon:Ot,getCrmAuthToken:ct,getEditRoomImages:At,goLive:Be,guestBookingEngineUrl:zt,handoffToGuestAppsTour:Bt,hideGoLiveOverlay:st,loadEditRooms:gt,loadSettings:It,openAmenityPicker:Mt,openBillingPortal:Te,openEditAddRoom:Re,openGuestBookingEngine:ce,openPreviewSite:le,openTourAccordion:L,postRoomImageUpload:pt,queryTourSelector:$,removeAmenity:be,renderEditRooms:mt,renderEditRoomsCards:Y,replayWalkthrough:ge,resolveLiveTourElement:K,resolveTourHighlightEl:N,restoreAppIconPreview:dt,saveEditRoom:ze,saveHotelInfo:ve,saveRates:we,scrollTourTargetIntoView:St,sendSupportMessage:Ie,setAppIconPreviewImage:xt,setAppIconPreviewLoading:Ft,settingsChangePin:se,settingsCopyLink:ee,settingsSaveRates:ae,settingsSendSupport:de,settingsUploadPhoto:re,showActivatedModal:me,showEditRoomPhoto:Ct,showFinaleMockModal:q,showGoLiveOverlay:$t,showOnboardingQuestions:ue,showTestDriveModal:Tt,showWelcomeModal:Pt,squareCropImage:Lt,startPostActivationTabTour:ut,startSettingsTour:at,stepEditRoomPhoto:fe,toggleAmenityPreset:xe,toggleSection:Se,tourAnchorRect:j,tourElementRect:tt,updatePreviewSiteBar:pe,uploadAppIcon:Ae,uploadEditImages:Pe};function $e(){Ut(Dt)}const He=Object.freeze(Object.defineProperty({__proto__:null,default:Dt,install:$e},Symbol.toStringTag,{value:"Module"}));export{Fe as a,He as b,c,Ut as e,De as s};
