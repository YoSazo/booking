import{c as f,e as Tt}from"./settings-kPt78bRA.js";function A(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function st(...t){return A("ensureAppsViewRendered")?.(...t)}function rt(...t){return A("showFinaleMockModal")?.(...t)}function at(...t){return A("finishTourHydration")?.(...t)}function M(...t){return A("goLive")?.(...t)}function P(...t){return A("toast")?.(...t)}function Bt(...t){return A("appsCloseLightbox")?.(...t)}let j=[],h=0,G=!1,E=null,D=null;function lt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function T(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function dt(){E&&(document.removeEventListener("keydown",E),E=null)}function zt(t){dt(),E=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",E)}function At(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function It(t,e){const o=t.querySelectorAll("input, textarea, select"),n=e.querySelectorAll("input, textarea, select");o.forEach((i,s)=>{const r=n[s];r&&(i.type==="checkbox"||i.type==="radio"?r.checked=i.checked:r.value=i.value)})}function ct(t,e){const o=getComputedStyle(t);for(const s of o)e.style.setProperty(s,o.getPropertyValue(s),o.getPropertyPriority(s));const n=t.children,i=e.children;for(let s=0;s<n.length;s+=1)i[s]&&ct(n[s],i[s])}function pt(t,e){if(!t||!t.isConnected||e?.noHighlight)return null;document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove());const o=t.getBoundingClientRect();if(o.width<2||o.height<2)return null;const n=t.cloneNode(!0);return At(n),ct(t,n),It(t,n),t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),t.style.visibility="hidden",n.setAttribute("data-apps-tour-spotlight-clone","1"),n.setAttribute("aria-hidden","true"),n.style.position="fixed",n.style.left=`${o.left}px`,n.style.top=`${o.top}px`,n.style.width=`${o.width}px`,n.style.height=`${o.height}px`,n.style.margin="0",n.style.maxWidth="none",n.style.zIndex="100002",n.style.pointerEvents="none",n.style.transform="none",n.style.boxShadow=e?.spotlightBoxShadow??"none",n.style.outline=e?.spotlightOutline??"none",n.style.outlineOffset=e?.spotlightOutlineOffset??"0",(t.classList.contains("apps-story-line")||e?.hideSpotlightBorder)&&(n.style.border="none",n.style.borderTop="none",n.style.borderTopWidth="0",n.style.paddingTop="0"),document.body.appendChild(n),n}function ut(t){const e=t||{};dt(),D&&(clearTimeout(D),D=null);const o=document.getElementById("appsTourLightbox");o&&!e.keepLightbox&&o.remove();const n=document.getElementById("appsTourTooltip");n&&n.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function $t(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),n=o.overflowY||o.overflow;if(/(auto|scroll)/.test(n)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function St(t,e){if(!e)return;const o=$t(t);if(o){o.scrollTop+=e;return}window.scrollBy({top:e,left:0,behavior:"auto"})}function Et(t,e){return e&&t.mobileTooltipPosition||t.tooltipPosition||""}function Ot(t,e,o,n,i){if(!t||!t.isConnected||!o)return t?.getBoundingClientRect()||null;const s=o.querySelector(".apps-tour-panel"),r=Math.min(s&&s.offsetHeight||o.offsetHeight||190,Math.max(130,window.innerHeight-28)),d=e.tooltipGap??8,a=(i?e.mobileFitPadTop:e.fitPadTop)??14,x=window.innerHeight-((i?e.mobileFitPadBottom:e.fitPadBottom)??14);let p=t.getBoundingClientRect();if(p.width<2||p.height<2)return p;for(let v=0;v<3;v+=1){const I=Math.max(120,x-a),c=p.height+d+r<=I;let u=0;if(n==="above"){const y=p.top-d-r-a;y<0&&(u=y),c&&p.bottom>x&&(u=p.bottom-x)}else{const y=p.bottom+d+r-x;y>0&&(u=y),c&&p.top<a&&(u=p.top-a)}if(Math.abs(u)<1)break;St(t,u),p=t.getBoundingClientRect()}return p}function b(t){ut(),document.body.style.overflow="";const e=G;G=!1;try{const o=typeof st=="function"?st:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),e||localStorage.getItem("settingsTourStep")==="handoff"||f.settingsTourActive)){const n=typeof rt=="function"?rt:window.showFinaleMockModal;if(typeof n=="function"){n();return}}}function _t(t){const e=h+t;e<0||e>=j.length||(h=e,B())}function X(){if(localStorage.setItem("appsTourDone","1"),G||localStorage.getItem("settingsTourStep")==="handoff"||f.settingsTourActive){f.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const e=typeof at=="function"?at:window.finishTourHydration;typeof e=="function"&&e()}}function Ht(){X();const t=typeof M=="function"?M:window.goLive;if(b(!1),typeof t=="function"){t();return}const e=typeof P=="function"?P:window.toast;typeof e=="function"&&e("Open Go live to activate your booking page.","error")}function Lt(){if(f.hotelSubscribed||document.getElementById("guestAppActivationOverlay"))return;lt();const t=document.createElement("div");if(t.id="guestAppActivationOverlay",t.style.cssText="position:fixed;inset:0;z-index:100004;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;padding:24px 16px;box-sizing:border-box;",t.innerHTML=`
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:390px;width:100%;max-height:calc(100vh - 48px);overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:appsTourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(t),document.body.style.overflow="hidden",!document.getElementById("tourModalAnimStyle")){const o=document.createElement("style");o.id="tourModalAnimStyle",o.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(o)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const e=()=>{t.remove(),document.body.style.overflow=""};document.getElementById("guestAppActivateNowBtn").onclick=()=>{e();const o=typeof M=="function"?M:window.goLive;if(typeof o=="function"){o();return}const n=typeof P=="function"?P:window.toast;typeof n=="function"&&n("Open Go live to activate your booking page.","error")},document.getElementById("guestAppActivateLaterBtn").onclick=e}function B(){lt();const t=j[h];if(!t){b(!0);return}const e=j.length,o=h>=e-1,n=`${h+1} / ${e}`,i=Math.max(8,Math.min(100,Math.round((h+1)/e*100))),s=document.querySelector(t.target);if(!s){h++,B();return}ut({keepLightbox:!0});let r=document.getElementById("appsTourLightbox");r||(r=document.createElement("div"),r.id="appsTourLightbox",r.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(r)),t.noHighlight||(s.dataset.appsTourOrigPosition=s.style.position||"",s.dataset.appsTourOrigZIndex=s.style.zIndex||"",s.dataset.appsTourOrigIsolation=s.style.isolation||"",s.dataset.appsTourOrigBoxShadow=s.style.boxShadow||"",s.dataset.appsTourOrigOutline=s.style.outline||"",s.dataset.appsTourOrigOutlineOffset=s.style.outlineOffset||"",s.dataset.appsTourOrigTransition=s.style.transition||"",s.style.position=s.style.position||"relative",s.style.zIndex="100002",s.style.isolation="isolate",s.style.transition="box-shadow 0.18s ease, outline 0.18s ease",s.style.boxShadow=t.spotlightBoxShadow??"none",s.style.outline=t.spotlightOutline??"none",s.style.outlineOffset=t.spotlightOutlineOffset??"0",(s.classList.contains("apps-story-line")||t.hideSpotlightBorder)&&(s.dataset.appsTourOrigBorderTop=s.style.borderTop||"",s.dataset.appsTourOrigPaddingTop=s.style.paddingTop||"",s.style.borderTop="none",s.style.paddingTop="0"),s.setAttribute("data-apps-tour-highlighted","1"));const d=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,x=a&&t.mobileScrollBlock||t.scrollBlock||"center",p=d?"auto":"smooth";if(a&&t.mobileScrollToBottom){const c=Math.max(document.documentElement?document.documentElement.scrollHeight:0,document.body?document.body.scrollHeight:0);window.scrollTo({top:c,behavior:p}),setTimeout(()=>{window.scrollTo({top:c,behavior:"auto"})},p==="smooth"?520:0)}else s.scrollIntoView({behavior:p,block:x});const v=()=>{const c=document.getElementById("appsTourTooltip");c&&c.remove();const u=Math.min(a?window.innerWidth-24:370,window.innerWidth-28),y=Et(t,a),N=t.primaryLabel||(o?"Done":"Next"),g=t.secondaryLabel||(o?"Not now":"Skip tour"),R=h<=0,Y=t.kicker||"Guest App",l=document.createElement("div");if(l.id="appsTourTooltip",l.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${u}px;max-width:${u}px;visibility:hidden;`,l.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${T(t.title)}">
        ...
        <div class="apps-tour-kicker">${T(Y)}</div>
        <div class="apps-tour-title">${T(t.title)}</div>
        <p class="apps-tour-copy">${T(t.text)}</p>
        <div class="apps-tour-actions">
          <button type="button" id="appsTourBackBtn" class="apps-tour-btn" ${R?"disabled":""}>Back</button>
          <button type="button" id="appsTourSkipBtn" class="apps-tour-btn apps-tour-btn-ghost">${T(g)}</button>
          <button type="button" id="appsTourNextBtn" class="apps-tour-btn apps-tour-btn-primary">${T(N)}</button>
        </div>
      </div>`,document.body.appendChild(l),a&&!y)pt(s,t),l.style.left="12px",l.style.right="12px",l.style.width="auto",l.style.maxWidth="none",l.style.top="auto",l.style.bottom="calc(14px + env(safe-area-inset-bottom,0px))";else{const H=y||"below",k=Ot(s,t,l,H,a)||s.getBoundingClientRect();pt(s,t);const V=l.querySelector(".apps-tour-panel"),L=Math.min(V&&V.offsetHeight||l.offsetHeight||190,Math.max(130,window.innerHeight-28)),C=t.tooltipGap??8,W=k.left+k.width/2,ot=Math.max(14,Math.min(W-u/2,window.innerWidth-u-14)),U=H!=="above"?k.bottom+C:k.top-L-C,Q=Math.max(14,Math.min(U,window.innerHeight-L-14));l.style.left=`${ot}px`,l.style.right="auto",l.style.bottom="auto",l.style.width=`${u}px`,l.style.maxWidth=`${u}px`,l.style.top=`${Q}px`}l.style.visibility="visible";const w=()=>{if(t.activateOnNext){Ht();return}if(o){X(),b(!1),t.showActivationOnComplete&&Lt();return}h++,B()},O=()=>{if(o){X(),b(!1);return}b(!0)},_=()=>{h<=0||(h--,B())};document.getElementById("appsTourNextBtn").onclick=w,document.getElementById("appsTourSkipBtn").onclick=O;const $=document.getElementById("appsTourBackBtn");$&&($.onclick=_),zt({onNext:w,onBack:_,onSkip:O})},I=a&&t.mobileScrollToBottom?d?80:680:d?40:320;D=setTimeout(()=>{requestAnimationFrame(v)},I)}function Ct(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;Bt(),b(!1),G=!!o;const n=!!f.hotelSubscribed;j=[{target:"#tour-apps-intro",kicker:"The loop",title:"Your property becomes the app.",text:"Guests book direct, save your property to their phone, and come back with one tap."},{target:"#tour-apps-first",kicker:"Your side",title:"Front Desk lives on this phone.",text:"This dashboard, saved like an app. Booking alerts, guest messages, and QR tools land here.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8,mobileScrollBlock:"center",mobileTooltipPosition:"below"},{target:"#tour-apps-then",kicker:"Their side",title:"Guests install from your booking page.",text:"One tap on Install and your icon is on their home screen.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8,mobileScrollBlock:"center",mobileTooltipPosition:"below"},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your property.",text:"A real logo or a clear photo. Guests see this square every time.",mobileScrollToBottom:!0,mobileScrollBlock:"end",mobileTooltipAnchor:"top",mobileTooltipPosition:"above"},{target:"#tour-apps-loop",kicker:n?"Live loop":"Activation",title:n?"This loop is on.":"Turn this on for your property.",text:n?"Guests book, save your property, and message you. Front Desk gets the alerts.":"One activation turns it all on: direct booking, guest installs, messages, and alerts.",primaryLabel:n?"Done":"Continue to activation",secondaryLabel:n?"Close":"Not now",showActivationOnComplete:!n,mobileScrollBlock:"center",tooltipPosition:"below",tooltipGap:8,mobileTooltipPosition:"below"}],h=0,B()}const m={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},Dt="32px";function J(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function Z(t){return`border-radius:${Dt};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function gt(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let q=[],z=0;function Ft(t,e){b(!1),q=t,z=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?F(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?F(-1):i.key==="Escape"&&ft()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const s=i.changedTouches[0].clientX-n;Math.abs(s)>50&&F(s<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",tt()}function ft(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function F(t){const e=q.length;e<=1||(z=(z+t+e)%e,tt())}function tt(){const t=document.getElementById("appsLightbox");if(!t)return;const e=q[z],o=q.length,n=e.type!=="video",i=o>1?`${z+1} / ${o}`:"",s=n?`<img src="${gt(e.src)}" alt="${e.alt||""}"
    ...
    ${Array.from({length:o},(x,p)=>`<div onclick="appsOpenLightbox(_appsLbItems,${p})" style="width:7px;height:7px;border-radius:50%;background:${p===z?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${a}
    </div>`}function xt(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function S(t,e,o,n,i){const s=i?xt("Video"):"",r=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${n})">
    ...
    ${r}
  </button>`}function Mt(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function Pt(t){const e=document.getElementById("appsView");if(!e)return;f.bookingApproval===null&&typeof window.loadBookingApprovalSettings=="function"&&window.loadBookingApprovalSettings({refreshApps:!0});const o=(f.activeHotelId||"")+"|"+(f.activeHotelAppIcon||"")+"|"+(f.activeHotelDomain||"");t||e.dataset.appsKey!==o||!e.querySelector(".apps-page")?(ht(),e.dataset.appsKey=o):et()}function ht(){const t=document.getElementById("appsView");if(!t)return;const e=f.activeHotelName||"Your Property",o=f.activeHotelAppIcon||"",n=e.trim().charAt(0).toUpperCase()||"🏡",i=f.activeHotelDomain||"",s=i?"https://"+i:"#",r=i?"https://"+i+"/install":"#";function d(K){return JSON.stringify(K).replace(/"/g,"&quot;")}const a=J(m.guestHome,520),x=[{type:"image",src:m.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],p=[{type:"image",src:m.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:m.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:m.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],v=[{type:"video",src:m.guestInstallVideo,poster:m.guestHome,alt:"Guest adds property to phone",title:"How guests put your property on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your property shows up on their phone like an app. You don't need to do anything."}],I=[{type:"image",src:m.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your guest app.'},{type:"image",src:m.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:m.guestMessageNotifVideo,poster:m.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],c=isStandaloneApp()||f.frontdeskInstalled,u=typeof Notification<"u"&&Notification.permission==="granted",N=!!(window.matchMedia&&window.matchMedia("(max-width: 767px)").matches)?"Install on this phone":"Install Front Desk",g=f.bookingApproval,R=!!(g&&g.supported&&g.pushConfigured),Y=g&&g.windowMinutes||20,l=g&&g.enabled?`${Y} minutes to confirm or release`:"Bookings confirm immediately";let w;c&&u?w=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
    ...
    </div>`:c?w=`<div id="tour-fd-installed-badge"><p style="font-size:13px;color:var(--text-muted);margin:0 0 12px;line-height:1.55;">It's installed on this device. Turn on alerts so you know when a guest books.</p>
      <button onclick="toggleAppNotifications()" style="width:100%;padding:14px;border-radius:12px;border:none;background:var(--green);color:#fff;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;">Turn on booking alerts</button></div>`:w=`<p style="font-size:13px;color:var(--text-muted);margin:0 0 14px;line-height:1.55;">Install Front Desk on your phone first. That unlocks guest app setup, install links, QR tools, guest messages, and booking alerts.</p>
      ...
      <div style="font-size:12px;color:var(--text-muted);line-height:1.45;text-align:center;">Locked until Front Desk is installed on your phone</div>`;const O=c?`<div class="apps-story-status">
      ...
      </div>`:`<button type="button" class="apps-story-primary" onclick="handleInstallFrontdesk()">${N}</button>`,_=r!=="#"?'<button type="button" class="apps-story-secondary" onclick="openGuestBookingEngine({focusInstall:true})">Go to direct booking page</button>':'<div class="apps-story-domain-note">Your direct booking domain is still setting up. Once it is ready, guests install from that page.</div>',$="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",H=o?$+"background:#fff;border:1px solid var(--border);padding:0;":$,k=o?`<img src="${o}" alt="Property logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,L=`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <div class="apps-q-list">
          ${S("What guests see on their phone","",d(p),0,!1)}
          ${S("How guests add your property","",d(v),0,!0)}
          ${S("Guest texts you, you text back","",d(I),0,!0)}
          ${S("Your app and theirs — side by side","",d(x),0,!1)}
        </div>
        ${s!=="#"?`<button onclick="window.open('${s}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,mt=K=>`
    ...
    ${U}
    ${it}
    ${c?vt:nt()}`,kt=c?"Front Desk is installed. Guests can install your property from the direct booking page.":"Install Front Desk first. Then guests can install your property from the direct booking page.";t.innerHTML=`
  <style>
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),et()}async function et(){const t=document.getElementById("guestInstallStats");try{const e=await api("GET","/api/crm/guest-install-stats");if(!e.success)throw new Error(e.message||"Failed");if(guestPushSubscriberCount=e.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const o=e.totals||{},n=e.installedBookings||0,i=o.views||0;if(!n&&!i){t.style.display="none",t.innerHTML="";return}t.style.display="block";const s=e.installRatePercent!=null?e.installRatePercent:0,r=Object.entries(e.byTouchpoint||{}).filter(function(a){return a[1].views||a[1].installed}).sort(function(a,x){return(x[1].installed||0)-(a[1].installed||0)}).slice(0,5),d=r.length?r.map(function(a){const x=a[0].replace(/-/g," "),p=a[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+x+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(p.views||0)+" views · "+(p.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+n+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div>'+(d?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+d:"")}catch{guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}const jt={appsCloseLightbox:ft,appsCloudinaryFull:gt,appsCloudinaryImg:J,appsLbNav:F,appsLbRender:tt,appsOpenLightbox:Ft,appsPhoneImgStyle:Z,appsQuestionRow:S,appsTourClose:b,appsTourNav:_t,appsTourRender:B,appsVideoBadgeHtml:xt,detectAppPlatform:Mt,ensureAppsViewRendered:Pt,loadGuestInstallStats:et,renderAppsView:ht,startAppsTour:Ct};function qt(){Tt(jt)}export{jt as default,qt as install};
