import{c as a,a as Bt,b as It,e as At}from"./settings-Bw-9fpLt.js";function w(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function X(...t){return w("ensureAppsViewRendered")?.(...t)}function Z(...t){return w("showFinaleMockModal")?.(...t)}function J(...t){return w("finishTourHydration")?.(...t)}function tt(...t){return w("goLive")?.(...t)}function et(...t){return w("toast")?.(...t)}function _t(...t){return w("appsCloseLightbox")?.(...t)}let E=[],u=0,L=!1,A=null,F=null,P=null,T=null;function Ot(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
