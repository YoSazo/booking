import{c as g,e as Q}from"./settings-Bk3TCrUc.js";const a={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4",frontdeskInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_19-49-38_1_tc1bzm.mp4"},X="32px";function b(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function m(t){return`border-radius:${X};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function E(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let _=[],x=0;function K(t,e){v(!1),_=t,x=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?z(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?z(-1):i.key==="Escape"&&H()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const d=i.changedTouches[0].clientX-n;Math.abs(d)>50&&z(d<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",S()}function H(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function z(t){const e=_.length;e<=1||(x=(x+t+e)%e,S())}function S(){const t=document.getElementById("appsLightbox");if(!t)return;const e=_[x],o=_.length,n=e.type!=="video",i=o>1?`${x+1} / ${o}`:"",d=n?`<img src="${E(e.src)}" alt="${e.alt||""}"
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${s}
    </div>`}function A(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function f(t,e,o,n,i){const d=i?A("Video"):"",r=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${n})">
    ...
    ${r}
  </button>`}function J(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function T(t){const e=document.getElementById("appsView");if(!e)return;const o=(g.activeHotelId||"")+"|"+(g.activeHotelAppIcon||"")+"|"+(g.activeHotelDomain||"");t||e.dataset.appsKey!==o||!e.querySelector(".apps-page")?(L(),e.dataset.appsKey=o):j()}function L(){const t=document.getElementById("appsView");if(!t)return;const e=g.activeHotelName||"Your Hotel",o=g.activeHotelAppIcon||"",n=e.trim().charAt(0).toUpperCase()||"🏨",i=g.activeHotelDomain||"",d=i?"https://"+i:"#",r=i?"https://"+i+"/install":"#";function l(U){return JSON.stringify(U).replace(/"/g,"&quot;")}const s=b(a.guestHome,520),c=[{type:"image",src:a.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],p=[{type:"image",src:a.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:a.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:a.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],h=[{type:"video",src:a.guestInstallVideo,poster:a.guestHome,alt:"Guest adds hotel to phone",title:"How your guests put your hotel on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your hotel shows up on their phone like an app. You don't need to do anything."}],q=[{type:"image",src:a.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your hotel app.'},{type:"image",src:a.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:a.guestMessageNotifVideo,poster:a.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],w=isStandaloneApp()||g.frontdeskInstalled,F=typeof Notification<"u"&&Notification.permission==="granted",G=[{type:"video",src:a.frontdeskInstallVideo,poster:a.frontdeskMessages,alt:"How to add Front Desk",title:"Add Front Desk to your home screen",caption:"Tap <strong>Add to Home Screen</strong> in your browser. No App Store. Takes about 3 seconds."},{type:"image",src:a.frontdeskMessages,alt:"Reply to guest",title:"You reply from your phone",caption:"Messages from guests show up in <strong>Bookings</strong>. Tap reply — they get it on their phone."}];let k;w&&F?k=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
      ...
      <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${l(G)},0)" style="margin-top:0;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how (1 min)</span></button>`;const B="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",P=o?B+"background:#fff;border:1px solid var(--border);padding:8px;":B,N=o?`<img src="${o}" alt="Hotel logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,C=`
    <div class="apps-icon-card">
      ...
      </div>`:'<div id="guestInstallStats" style="display:none;"></div>',R=`
    <div class="apps-loop">
      ...
      <div class="apps-loop-side">
        ...
        <div class="apps-q-list">
          ${f("What guests see on their phone","",l(p),0,!1)}
          ${f("How guests add your hotel","",l(h),0,!0)}
          ${f("Guest texts you, you text back","",l(q),0,!0)}
          ${f("Your app and theirs — side by side","",l(c),0,!1)}
        </div>
        ${d!=="#"?`<button onclick="window.open('${d}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,V=`
    ${R}
    ...
    ${guestBroadcastCardHtml()}`,W=w?"Booking alerts live on the <strong>Bookings</strong> tab · installs on iPhone &amp; Android":"iPhone &amp; Android · lives on your home screen · no App Store";t.innerHTML=`
  <style>
  ...
  <div class="apps-page">
    ...
    <div style="flex-shrink:0;width:100%;max-width:400px;margin:0 auto;padding:12px 20px max(16px,env(safe-area-inset-bottom));box-sizing:border-box;text-align:center;">
      ...
      <div style="display:flex;gap:6px;justify-content:center;">${l}</div>
        ...
        </div>`}],u=0,H(),v(!1);const s=document.createElement("div");s.id="appsTourLightbox",s.style.cssText=["position:fixed;inset:0;z-index:102001;background:#000;","display:flex;flex-direction:column;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join("");let c=0;s._swipeStart=p=>{c=p.changedTouches[0].clientX},s._swipeEnd=p=>{const h=p.changedTouches[0].clientX-c;Math.abs(h)>50&&M(h<0?1:-1)},s.addEventListener("touchstart",s._swipeStart,{passive:!0}),s.addEventListener("touchend",s._swipeEnd,{passive:!0}),document.body.appendChild(s),document.body.style.overflow="hidden",I()}const ee={appsCloseLightbox:H,appsCloudinaryFull:E,appsCloudinaryImg:b,appsLbNav:z,appsLbRender:S,appsOpenLightbox:K,appsPhoneImgStyle:m,appsQuestionRow:f,appsTourClose:v,appsTourNav:M,appsTourRender:I,appsVideoBadgeHtml:A,detectAppPlatform:J,ensureAppsViewRendered:T,loadGuestInstallStats:j,renderAppsView:L,startAppsTour:Z};function ie(){Q(ee)}export{ee as default,ie as install};
