import{f as l,e as M}from"./settings-n80yx0sy.js";const i={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",bookingNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_21-14-19_1_eckwlk.mp4",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4",frontdeskInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_19-49-38_1_tc1bzm.mp4",guestBroadcastVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/v1781196304/ScreenRecording_06-11-2026_19-41-56_1_kjgudg.mp4"},D="32px";function c(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function m(t){return`border-radius:${D};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function _(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let w=[],f=0;function F(t,e){y(!1),w=t,f=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=n=>{n.key==="ArrowRight"||n.key==="ArrowDown"?v(1):n.key==="ArrowLeft"||n.key==="ArrowUp"?v(-1):n.key==="Escape"&&$()},document.addEventListener("keydown",o._keyHandler);let p=0;o.addEventListener("touchstart",n=>{p=n.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",n=>{const s=n.changedTouches[0].clientX-p;Math.abs(s)>50&&v(s<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",I()}function $(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function v(t){const e=w.length;e<=1||(f=(f+t+e)%e,I())}function I(){const t=document.getElementById("appsLightbox");if(!t)return;const e=w[f],o=w.length,p=e.type!=="video",n=o>1?`${f+1} / ${o}`:"",s=p?`<img src="${_(e.src)}" alt="${e.alt||""}"
          ...
          ${e.poster?`poster="${c(e.poster,400)}"`:""}>
    ...
    ${Array.from({length:o},(b,u)=>`<div onclick="appsOpenLightbox(_appsLbItems,${u})" style="width:7px;height:7px;border-radius:50%;background:${u===f?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${d}
    </div>`}function h(t,e,o,p){return`<button type="button" class="apps-q" onclick="appsOpenLightbox(${o},${p})">
  ...
  </button>`}function q(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function Y(){const t=document.getElementById("appsView");if(!t)return;const e=typeof l.activeHotelName<"u"&&l.activeHotelName?l.activeHotelName:"Your Hotel",o=l.activeHotelAppIcon||"",p=e.trim().charAt(0).toUpperCase()||"🏨",n=l.activeHotelDomain||"",s=n?"https://"+n:"#",r=n?"https://"+n+"/install":"#",a=r!=="#"?"https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(r):"",d=isStandaloneApp()||l.frontdeskInstalled,b=typeof Notification<"u"&&Notification.permission==="granted";let u;d&&b?u=`<div style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
  ...
  <div class="apps-page">
    ...
    <div class="apps-q-list">
      ${h("When someone books you, your phone buzzes","See what that looks like",x(L),0)}
      ${h("What your guests see on their phone","Home, book a room, message you",x(j),0)}
      ${h("When a guest texts you, you text back","Like WiFi questions",x(B),0)}
      ${h("How your guests put your hotel on their phone","They tap one button on your website",x(E),0)}
      ${h("Your app and theirs — same home screen","Side by side",x(H),0)}
      ${h("Need help putting Front Desk on your phone?","Watch a short video",x(N),0)}
    </div>
    ...
    <div class="apps-broadcast-card">
      ...
      <div style="margin-top:16px;padding-top:16px;border-top:1px solid var(--border);">
        ...
        <video autoplay loop muted playsinline webkit-playsinline preload="metadata" style="width:100%;max-width:280px;height:auto;display:block;margin:0 auto;${m()}" poster="${c(i.guestMessagesImg,360)}">
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),S()}async function S(){const t=document.getElementById("guestInstallStats");if(t)try{const e=await api("GET","/api/crm/guest-install-stats");if(!e.success)throw new Error(e.message||"Failed");const o=e.totals||{},p=e.installRatePercent!=null?e.installRatePercent:0,n=Object.entries(e.byTouchpoint||{}).filter(function(r){return r[1].views||r[1].installed}).sort(function(r,a){return(a[1].installed||0)-(r[1].installed||0)}).slice(0,5),s=n.length?n.map(function(r){const a=r[0].replace(/-/g," "),d=r[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+a+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(d.views||0)+" views · "+(d.installed||0)+" installed</span></div>"}).join(""):'<div style="font-size:12px;color:var(--text-muted);">No install activity yet — try the check-in QR at the desk.</div>';t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+p+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+(e.installedBookings||0)+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+(o.views||0)+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div><div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+s}catch{t.innerHTML='<div style="font-size:12px;color:var(--text-muted);">Install stats unavailable right now.</div>'}}let k=[],g=0;function y(t){const e=document.getElementById("appsTourLightbox");e&&(e._swipeStart&&e.removeEventListener("touchstart",e._swipeStart),e._swipeEnd&&e.removeEventListener("touchend",e._swipeEnd),e.remove()),document.body.style.overflow="",t&&localStorage.setItem("appsTourDone","1")}function T(t){const e=g+t;e<0||e>=k.length||(g=e,z())}function z(){const t=document.getElementById("appsTourLightbox");if(!t)return;const e=k[g],o=k.length,p=g>=o-1,n=`${g+1} / ${o}`,s=p?"Got it — show me":"Next →",r=Array.from({length:o},(d,b)=>`<div style="width:7px;height:7px;border-radius:50%;background:${b===g?"#fff":"rgba(255,255,255,0.35)"};"></div>`).join("");let a="";e.type==="cta"?a=`<div style="width:100%;max-width:320px;padding:0 8px;box-sizing:border-box;">${e.ctaHtml}</div>`:e.type==="video"?a=`<video autoplay loop muted playsinline webkit-playsinline preload="metadata"
    ...
    <div style="flex-shrink:0;width:100%;max-width:400px;margin:0 auto;padding:12px 20px max(16px,env(safe-area-inset-bottom));box-sizing:border-box;text-align:center;">
      ...
      <div style="display:flex;gap:6px;justify-content:center;">${r}</div>
    </div>`,document.getElementById("appsTourNextBtn").onclick=()=>{if(p){y(!0);const d=document.getElementById("appsView");d&&d.scrollIntoView({behavior:"smooth",block:"start"})}else g++,z()},document.getElementById("appsTourSkipBtn").onclick=()=>y(!0)}function P(){if(localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox"))return;const t=l.activeHotelName||"Your Hotel",e=t.length>13?t.slice(0,13)+"…":t,o=t.trim().charAt(0).toUpperCase(),p=l.activeHotelAppIcon||"",n=p?`<img src="${p}" alt="${t}" style="width:52px;height:52px;border-radius:14px;object-fit:cover;">`:`<div style="width:52px;height:52px;border-radius:14px;background:#2E7D5B;color:#fff;font-size:22px;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;">${o}</div>`;k=[{type:"video",src:i.frontdeskInstallVideo,poster:c(i.frontdeskMessages,400),title:"Put Front Desk on your phone",caption:"You're on <strong>Front Desk</strong> right now. Save it to your home screen — works like an app, no app store. Same steps as <strong>Put Front Desk on my phone</strong> at the top of this page."},{type:"image",src:c(i.homeScreen,520),alt:"Two apps on home screen",title:"Your guests can save your hotel too",caption:`You get <strong>Front Desk</strong>. They get <strong>${t}</strong>. Both sit on the home screen — like real apps.`},{type:"video",src:i.guestInstallVideo,poster:c(i.guestHome,400),title:"How your guests save your hotel",caption:`They tap <strong>Add to Home Screen</strong> on your booking website. Upload your logo on this page so they see <strong>${e}</strong>.`},{type:"video",src:i.bookingNotifVideo,poster:c(i.homeScreen,400),title:"When someone books you, your phone buzzes",caption:"That's why you put Front Desk on your phone — you find out right away, before email, before Airbnb."},{type:"video",src:i.guestBroadcastVideo,poster:c(i.guestMessagesImg,400),title:"You can notify all your guests at once",caption:"Once they have your hotel on their phone, notify everyone — a sale, an event, or a check-in reminder. Scroll down on this page to try it."},{type:"cta",title:"Now do these two things",caption:"",ctaHtml:`
        ...
        </div>`}],g=0,$(),y(!1);const s=document.createElement("div");s.id="appsTourLightbox",s.style.cssText=["position:fixed;inset:0;z-index:102001;background:#000;","display:flex;flex-direction:column;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join("");let r=0;s._swipeStart=a=>{r=a.changedTouches[0].clientX},s._swipeEnd=a=>{const d=a.changedTouches[0].clientX-r;Math.abs(d)>50&&T(d<0?1:-1)},s.addEventListener("touchstart",s._swipeStart,{passive:!0}),s.addEventListener("touchend",s._swipeEnd,{passive:!0}),document.body.appendChild(s),document.body.style.overflow="hidden",z()}const R={appsCloseLightbox:$,appsCloudinaryFull:_,appsCloudinaryImg:c,appsLbNav:v,appsLbRender:I,appsOpenLightbox:F,appsPhoneImgStyle:m,appsQuestionRow:h,appsTourClose:y,appsTourNav:T,appsTourRender:z,detectAppPlatform:q,loadGuestInstallStats:S,renderAppsView:Y,startAppsTour:P};function G(){M(R)}export{R as default,G as install};
