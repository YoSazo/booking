import{c as l,e as rt}from"./settings-Cwg6CLRs.js";const g={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},pt="32px";function W(e,o){return e.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(o||400)+"/")}function N(e){return`border-radius:${pt};box-shadow:0 10px 36px rgba(0,0,0,0.22);${e||""}`}function K(e){const o=Math.min(window.devicePixelRatio||1,2),t=Math.round(Math.min(window.screen.width*o,1600));return e.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${t}/`)}let L=[],z=0;function dt(e,o){y(!1),L=e,z=o||0;let t=document.getElementById("appsLightbox");if(!t){t=document.createElement("div"),t.id="appsLightbox",t.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(t),document.body.style.overflow="hidden",t._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?F(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?F(-1):i.key==="Escape"&&V()},document.addEventListener("keydown",t._keyHandler);let s=0;t.addEventListener("touchstart",i=>{s=i.changedTouches[0].clientX},{passive:!0}),t.addEventListener("touchend",i=>{const p=i.changedTouches[0].clientX-s;Math.abs(p)>50&&F(p<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",U()}function V(){const e=document.getElementById("appsLightbox");e&&(document.removeEventListener("keydown",e._keyHandler),e.remove(),document.body.style.overflow="")}function F(e){const o=L.length;o<=1||(z=(z+e+o)%o,U())}function U(){const e=document.getElementById("appsLightbox");if(!e)return;const o=L[z],t=L.length,s=o.type!=="video",i=t>1?`${z+1} / ${t}`:"",p=s?`<img src="${K(o.src)}" alt="${o.alt||""}"
          ...
          ${o.poster?`poster="${W(o.poster,400)}"`:""}>
          <source src="${o.src}" type="video/mp4">
       </video>`,n=t>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",d=t>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",a=t>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:t},(h,c)=>`<div onclick="appsOpenLightbox(_appsLbItems,${c})" style="width:7px;height:7px;border-radius:50%;background:${c===z?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";e.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${a}
    </div>`}function J(e,o){const t=e||"Video";return`<span class="${"apps-media-badge"+(o==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${t}</span></span>`}function _(e,o,t,s,i){const p=i?J("Video"):"",n=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${t},${s})">
    ...
    ${n}
  </button>`}function lt(){const e=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(e)&&!window.MSStream?"ios":/android/i.test(e)?"android":"ios"}function R(e){const o=document.getElementById("appsView");if(!o)return;const t=(l.activeHotelId||"")+"|"+(l.activeHotelAppIcon||"")+"|"+(l.activeHotelDomain||"");e||o.dataset.appsKey!==t||!o.querySelector(".apps-page")?(tt(),o.dataset.appsKey=t):Q()}function tt(){const e=document.getElementById("appsView");if(!e)return;const o=l.activeHotelName||"Your Hotel",t=l.activeHotelAppIcon||"",s=o.trim().charAt(0).toUpperCase()||"🏨",i=l.activeHotelDomain||"",p=i?"https://"+i:"#",n=i?"https://"+i+"/install":"#";function d(Z){return JSON.stringify(Z).replace(/"/g,"&quot;")}const a=W(g.guestHome,520),h=[{type:"image",src:g.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${o}</strong> — they tap it to book you or text you. No app store.`}],c=[{type:"image",src:g.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:g.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:g.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],H=[{type:"video",src:g.guestInstallVideo,poster:g.guestHome,alt:"Guest adds hotel to phone",title:"How your guests put your hotel on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your hotel shows up on their phone like an app. You don't need to do anything."}],j=[{type:"image",src:g.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your hotel app.'},{type:"image",src:g.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:g.guestMessageNotifVideo,poster:g.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],r=isStandaloneApp()||l.frontdeskInstalled,u=typeof Notification<"u"&&Notification.permission==="granted",k=!!(window.matchMedia&&window.matchMedia("(max-width: 767px)").matches)?"Install on this phone":"Install Front Desk";let T;r&&u?T=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
    ...
    </div>`:r?T=`<div id="tour-fd-installed-badge"><p style="font-size:13px;color:var(--text-muted);margin:0 0 12px;line-height:1.55;">It's installed on this device. Turn on alerts so you know when a guest books.</p>
      <button onclick="toggleAppNotifications()" style="width:100%;padding:14px;border-radius:12px;border:none;background:var(--green);color:#fff;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;">Turn on booking alerts</button></div>`:T=`<p style="font-size:13px;color:var(--text-muted);margin:0 0 14px;line-height:1.55;">Install Front Desk on the property phone first. That unlocks guest app setup, install links, QR tools, guest messages, and booking alerts.</p>
      ...
      <div style="font-size:12px;color:var(--text-muted);line-height:1.45;text-align:center;">Locked until Front Desk is installed on a property phone</div>`;const G=r?`<div class="apps-story-status">
      ...
      </div>`:`<button type="button" class="apps-story-primary" onclick="handleInstallFrontdesk()">${k}</button>`,I=n!=="#"?'<button type="button" class="apps-story-secondary" onclick="openGuestBookingEngine({focusInstall:true})">Go to direct booking page</button>':'<div class="apps-story-domain-note">Your direct booking domain is still setting up. Once it is ready, guests install from that page.</div>',$="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",M=t?$+"background:#fff;border:1px solid var(--border);padding:0;":$,C=t?`<img src="${t}" alt="Hotel logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${s}</span>`,x=`
    <div class="apps-icon-card">
      <div id="appsAppIconPreview" style="${M}">
        ${C}
      </div>
      ...
      ${n==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,w=n!=="#"?`
      ...
      </div>`:'<div id="guestInstallStats" style="display:none;"></div>',B=`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-first">
        ...
        <div class="apps-story-actions">${G}</div>
      </div>
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${d(H)},0)" style="margin-bottom:12px;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how guests install (1 min)</span></button>
        ...
        <div class="apps-q-list">
          ${_("What guests see on their phone","",d(c),0,!1)}
          ${_("How guests add your hotel","",d(H),0,!0)}
          ${_("Guest texts you, you text back","",d(j),0,!0)}
          ${_("Your app and theirs — side by side","",d(h),0,!1)}
        </div>
        ${p!=="#"?`<button onclick="window.open('${p}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,q=Z=>`
    ...
    ${m}
    ${B}
    ${r?st:O()}`,at=r?"Front Desk is installed. Guests can install your hotel from the direct booking page.":"Install Front Desk first. Then guests can install your hotel from the direct booking page.";e.innerHTML=`
  <style>
  ...
  <div class="apps-page">
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),Q()}async function Q(){const e=document.getElementById("guestInstallStats");try{const o=await api("GET","/api/crm/guest-install-stats");if(!o.success)throw new Error(o.message||"Failed");if(guestPushSubscriberCount=o.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!e)return;const t=o.totals||{},s=o.installedBookings||0,i=t.views||0;if(!s&&!i){e.style.display="none",e.innerHTML="";return}e.style.display="block";const p=o.installRatePercent!=null?o.installRatePercent:0,n=Object.entries(o.byTouchpoint||{}).filter(function(a){return a[1].views||a[1].installed}).sort(function(a,h){return(h[1].installed||0)-(a[1].installed||0)}).slice(0,5),d=n.length?n.map(function(a){const h=a[0].replace(/-/g," "),c=a[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+h+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(c.views||0)+" views · "+(c.installed||0)+" installed</span></div>"}).join(""):"";e.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+p+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div>'+(d?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+d:"")}catch{guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),e&&(e.style.display="none",e.innerHTML="")}}let E=[],b=0,D=!1;function et(){const e=document.getElementById("appsTourLightbox");e&&e.remove();const o=document.getElementById("appsTourTooltip");o&&o.remove(),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(t=>{t.style.position=t.dataset.appsTourOrigPosition||"",t.style.zIndex=t.dataset.appsTourOrigZIndex||"",t.style.isolation=t.dataset.appsTourOrigIsolation||"",t.style.boxShadow=t.dataset.appsTourOrigBoxShadow||"",t.style.borderRadius=t.dataset.appsTourOrigBorderRadius||"",t.style.padding=t.dataset.appsTourOrigPadding||"",t.style.boxSizing=t.dataset.appsTourOrigBoxSizing||"",t.style.outline=t.dataset.appsTourOrigOutline||"",t.style.outlineOffset=t.dataset.appsTourOrigOutlineOffset||"",t.removeAttribute("data-apps-tour-highlighted"),delete t.dataset.appsTourOrigPosition,delete t.dataset.appsTourOrigZIndex,delete t.dataset.appsTourOrigIsolation,delete t.dataset.appsTourOrigBoxShadow,delete t.dataset.appsTourOrigBorderRadius,delete t.dataset.appsTourOrigPadding,delete t.dataset.appsTourOrigBoxSizing,delete t.dataset.appsTourOrigOutline,delete t.dataset.appsTourOrigOutlineOffset})}function y(e){et(),document.body.style.overflow="";const o=D;D=!1;try{const t=typeof R=="function"?R:window.ensureAppsViewRendered;typeof t=="function"&&t(!0)}catch{}if(e&&(localStorage.setItem("appsTourDone","1"),o||localStorage.getItem("settingsTourStep")==="handoff"||l.settingsTourActive)){const s=typeof showFinaleMockModal=="function"?showFinaleMockModal:window.showFinaleMockModal;if(typeof s=="function"){s();return}}}function ct(e){const o=b+e;o<0||o>=E.length||(b=o,A())}function Y(){if(localStorage.setItem("appsTourDone","1"),D||localStorage.getItem("settingsTourStep")==="handoff"||l.settingsTourActive){l.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const o=typeof finishTourHydration=="function"?finishTourHydration:window.finishTourHydration;typeof o=="function"&&o()}}function gt(){Y();const e=typeof goLive=="function"?goLive:window.goLive;if(y(!1),typeof e=="function"){e();return}const o=typeof toast=="function"?toast:window.toast;typeof o=="function"&&o("Open Go live to activate your booking page.","error")}function ut(){if(l.hotelSubscribed||document.getElementById("guestAppActivationOverlay"))return;const e=document.createElement("div");if(e.id="guestAppActivationOverlay",e.style.cssText="position:fixed;inset:0;z-index:100004;background:rgba(0,0,0,0.68);display:flex;align-items:center;justify-content:center;padding:24px 16px;box-sizing:border-box;",e.innerHTML=`
    <div style="background:white;border-radius:20px;max-width:360px;width:100%;max-height:calc(100vh - 48px);overflow-y:auto;box-shadow:0 22px 64px rgba(0,0,0,0.32);animation:tourModalSlideUp 0.3s ease;">
    ...
    </div>`,document.body.appendChild(e),document.body.style.overflow="hidden",!document.getElementById("tourModalAnimStyle")){const t=document.createElement("style");t.id="tourModalAnimStyle",t.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(t)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{e.remove(),document.body.style.overflow=""};document.getElementById("guestAppActivateNowBtn").onclick=()=>{o();const t=typeof goLive=="function"?goLive:window.goLive;if(typeof t=="function"){t();return}const s=typeof toast=="function"?toast:window.toast;typeof s=="function"&&s("Open Go live to activate your booking page.","error")},document.getElementById("guestAppActivateLaterBtn").onclick=o}function A(){const e=E[b];if(!e){y(!0);return}const o=E.length,t=b>=o-1,s=`${b+1} / ${o}`,i=document.querySelector(e.target);if(!i){b++,A();return}et();let p=document.createElement("div");p.id="appsTourLightbox",p.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(0,0,0,0.52);pointer-events:auto;",document.body.appendChild(p),i.dataset.appsTourOrigPosition=i.style.position||"",i.dataset.appsTourOrigZIndex=i.style.zIndex||"",i.dataset.appsTourOrigIsolation=i.style.isolation||"",i.dataset.appsTourOrigBoxShadow=i.style.boxShadow||"",i.dataset.appsTourOrigBorderRadius=i.style.borderRadius||"",i.dataset.appsTourOrigPadding=i.style.padding||"",i.dataset.appsTourOrigBoxSizing=i.style.boxSizing||"",i.dataset.appsTourOrigOutline=i.style.outline||"",i.dataset.appsTourOrigOutlineOffset=i.style.outlineOffset||"",i.style.position=i.style.position||"relative",i.style.zIndex="100002",i.style.isolation="isolate",i.style.boxSizing="border-box";const n=window.getComputedStyle?window.getComputedStyle(i):null;if(n){const r=parseFloat(n.paddingTop)||0,u=parseFloat(n.paddingRight)||0,f=parseFloat(n.paddingBottom)||0,k=parseFloat(n.paddingLeft)||0;(r<10||u<12||f<10||k<12)&&(i.style.padding=`${Math.max(r,10)}px ${Math.max(u,12)}px ${Math.max(f,10)}px ${Math.max(k,12)}px`)}i.style.boxShadow="0 14px 38px rgba(0,0,0,0.24)",i.style.outline="4px solid #2E7D5B",i.style.outlineOffset="5px",i.style.borderRadius=i.style.borderRadius||"16px",i.setAttribute("data-apps-tour-highlighted","1");const d=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,h=a&&e.mobileScrollBlock||e.scrollBlock||"center",c=d?"auto":"smooth";if(a&&e.mobileScrollToBottom){const r=Math.max(document.documentElement?document.documentElement.scrollHeight:0,document.body?document.body.scrollHeight:0);window.scrollTo({top:r,behavior:c}),setTimeout(()=>{window.scrollTo({top:r,behavior:"auto"})},c==="smooth"?520:0)}else i.scrollIntoView({behavior:c,block:h});const H=()=>{const r=document.getElementById("appsTourTooltip");r&&r.remove();const u=i.getBoundingClientRect(),f=Math.min(330,window.innerWidth-28),k=u.left+u.width/2,T=Math.max(14,Math.min(k-f/2,window.innerWidth-f-14)),G=a&&e.mobileTooltipAnchor||e.tooltipAnchor||"bottom",I=a&&e.mobileTooltipPosition||e.tooltipPosition||"",$=u.top,M=G==="top"?u.top:u.bottom,C=e.primaryLabel||(t?"Done":"Next"),X=e.secondaryLabel||(t?"Not now":"Skip tour"),x=document.createElement("div");x.id="appsTourTooltip",x.style.cssText=`position:fixed;z-index:100003;left:${T}px;top:14px;width:${f}px;max-width:${f}px;visibility:hidden;`,x.innerHTML=`
      <div style="background:#111827;color:#fff;border-radius:14px;padding:15px 16px;box-shadow:0 18px 46px rgba(0,0,0,0.32);max-height:calc(100vh - 28px);overflow-y:auto;">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:8px;">
          ...
          <button type="button" id="appsTourSkipBtn" style="border:none;background:transparent;color:rgba(255,255,255,0.62);font-family:inherit;font-size:12px;font-weight:700;cursor:pointer;padding:4px 0;">${X}</button>
        </div>
        ...
        <button type="button" id="appsTourNextBtn" style="width:100%;padding:12px 14px;border-radius:10px;border:none;background:#2E7D5B;color:#fff;font-family:inherit;font-size:14px;font-weight:800;cursor:pointer;">${C}</button>
      </div>`,document.body.appendChild(x);const v=12,w=Math.min(x.offsetHeight||176,Math.max(120,window.innerHeight-28)),S=window.innerHeight-M,B=$;let m=I==="below"||!I&&S>=w+v+14;I==="above"&&(m=!1),m&&S<w+v+14&&B>S&&(m=!1),!m&&B<w+v+14&&S>B&&(m=!0);const P=m?M+v:$-w-v,q=Math.max(14,window.innerHeight-w-14),O=Math.max(14,Math.min(P,q));x.style.top=`${O}px`,x.style.visibility="visible",document.getElementById("appsTourNextBtn").onclick=()=>{if(e.activateOnNext){gt();return}if(t){Y(),y(!1),e.showActivationOnComplete&&ut();return}b++,A()},document.getElementById("appsTourSkipBtn").onclick=()=>{if(t){Y(),y(!1);return}y(!0)}},j=a&&e.mobileScrollToBottom?d?80:680:d?40:320;setTimeout(H,j)}function xt(e){const o=e&&e.replay,t=e&&e.chainFromSettingsTour;if(!o&&!t&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;V(),y(!1),D=!!t;const s=!!l.hotelSubscribed;E=[{target:"#tour-apps-headline",title:"This is the whole idea.",text:"Your hotel can live on your guest's home screen. That is the value of this page."},{target:"#tour-apps-first",title:"First: install Front Desk.",text:"Front Desk is this website saved to your property phone. This is how you get booking alerts and guest messages."},{target:"#tour-apps-then",title:"Then: send guests to your booking page.",text:"When guests are booking, the Install button is at the bottom of the page. They tap it and your hotel is on their phone."},{target:"#tour-apps-after",title:"After that, the loop is clear.",text:"Guests tap your hotel icon to book or message you. New bookings and messages come back here in Front Desk."},{target:"#tour-guest-icon-section",title:"This is the one setup item.",text:"Guests see this icon on their home screen. Uploading the picture unlocks after Front Desk is installed.",mobileScrollToBottom:!0,mobileScrollBlock:"end",mobileTooltipAnchor:"top",mobileTooltipPosition:"above"},{target:"#tour-apps-loop",title:s?"This loop is on.":"Turn this on for your property.",text:s?"Guests can book direct, save your hotel, and message you. Front Desk gets the alerts.":"Activate once. Guests can book direct, save your hotel to their home screen, and Front Desk gets the alerts.",primaryLabel:s?"Done":"Continue to activation",secondaryLabel:s?"Close":"Not now",showActivationOnComplete:!s}],b=0,A()}const ht={appsCloseLightbox:V,appsCloudinaryFull:K,appsCloudinaryImg:W,appsLbNav:F,appsLbRender:U,appsOpenLightbox:dt,appsPhoneImgStyle:N,appsQuestionRow:_,appsTourClose:y,appsTourNav:ct,appsTourRender:A,appsVideoBadgeHtml:J,detectAppPlatform:lt,ensureAppsViewRendered:R,loadGuestInstallStats:Q,renderAppsView:tt,startAppsTour:xt};function mt(){rt(ht)}export{ht as default,mt as install};
