const l={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let q=null;function Pe(){return typeof lucide<"u"?Promise.resolve():q||(q=new Promise((t,e)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>t(),o.onerror=()=>e(new Error("lucide load failed")),document.head.appendChild(o)}),q)}async function Dt(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let n=e.width,r=e.height;const a=Math.min(1,o/n,i/r);n=Math.round(n*a),r=Math.round(r*a);const s=document.createElement("canvas");s.width=n,s.height=r,s.getContext("2d").drawImage(e,0,0,n,r),e.close();const u=await new Promise((y,w)=>{s.toBlob(k=>k?y(k):w(new Error("encode failed")),"image/webp",.82)}),g=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([u],g+".webp",{type:"image/webp"})}catch{return t}}function Ae(){const t=()=>{l.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}function Ot(t){Object.assign(window,t)}function M(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function V(...t){return M("setFilter")?.(...t)}function Ft(...t){return M("toast")?.(...t)}function W(...t){return M("updateGoLiveBanner")?.(...t)}function Ht(...t){return M("seedTourRevenueShell")?.(...t)}function Nt(...t){return M("finishTourHydration")?.(...t)}function qt(...t){return M("goLive")?.(...t)}let O=null;function A(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
  ...
  `,document.head.appendChild(t)}function xt(){O&&(document.removeEventListener("keydown",O),O=null)}function jt(t){xt(),O=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",O)}function Z(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function R(t){A();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText=`position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.22);pointer-events:${e.blockPointer?"auto":"none"};`,document.body.appendChild(o),e.lockScroll&&(document.body.style.overflow="hidden"),o)}function Ut(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function Gt(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((n,r)=>{const a=i[r];a&&(n.type==="checkbox"||n.type==="radio"?a.checked=n.checked:a.value=n.value)})}function yt(t,e){const o=getComputedStyle(t);for(const r of o)e.style.setProperty(r,o.getPropertyValue(r),o.getPropertyPriority(r));const i=t.children,n=e.children;for(let r=0;r<i.length;r+=1)n[r]&&yt(i[r],n[r])}function Vt(t){if(!t||!t.isConnected)return null;document.querySelectorAll("[data-tour-spotlight-clone]").forEach(i=>i.remove());const e=t.getBoundingClientRect();if(e.width<2||e.height<2)return null;const o=t.cloneNode(!0);return Ut(o),yt(t,o),Gt(t,o),o.setAttribute("data-tour-spotlight-clone","1"),o.setAttribute("aria-hidden","true"),o.style.position="fixed",o.style.left=`${e.left}px`,o.style.top=`${e.top}px`,o.style.width=`${e.width}px`,o.style.height=`${e.height}px`,o.style.margin="0",o.style.maxWidth="none",o.style.zIndex="99999",o.style.pointerEvents="none",o.style.transform="none",o.style.boxShadow="0 18px 46px rgba(26,43,34,0.24)",o.style.outline="1px solid rgba(255,255,255,0.82)",o.style.outlineOffset="2px",document.body.appendChild(o),o}function F(){xt();const t=document.getElementById("tourTooltip");t&&t.remove();const e=document.getElementById("tourBlurOverlay");e&&e.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.tourOrigPosition||"",i.style.zIndex=i.dataset.tourOrigZIndex||"",i.style.isolation=i.dataset.tourOrigIsolation||"",i.style.boxShadow=i.dataset.tourOrigBoxShadow||"",i.style.outline=i.dataset.tourOrigOutline||"",i.style.outlineOffset=i.dataset.tourOrigOutlineOffset||"",i.style.transition=i.dataset.tourOrigTransition||"",i.removeAttribute("data-tour-highlighted"),delete i.dataset.tourOrigPosition,delete i.dataset.tourOrigZIndex,delete i.dataset.tourOrigIsolation,delete i.dataset.tourOrigBoxShadow,delete i.dataset.tourOrigOutline,delete i.dataset.tourOrigOutlineOffset,delete i.dataset.tourOrigTransition});const o=document.getElementById("goLiveBanner");o&&o.dataset.tourHidden&&(delete o.dataset.tourHidden,typeof W=="function"&&W()),document.body.style.overflow=""}function C(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const r=o.querySelector(".accordion-arrow");r&&(r.style.transform="rotate(90deg)")}}function $(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function L(t,e){if(e.highlightSelector){const o=$(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function U(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const n=document.querySelector(i);if(n&&n.isConnected)return n}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function X(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function tt(t,e){const o=$(t.anchorSelector);if(o){const i=X(o,!0);if(i)return i}return X(e,!0)}function Wt(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function ft(t,e){if(!e)return;const o=Wt(t);if(o){o.scrollTop+=e;return}window.scrollBy({top:e,left:0,behavior:"auto"})}function Y(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const n=document.querySelector(i);n&&(n.scrollTop=0)})}function ht(t,e){const o=e.scrollTarget||e.accordionCard,i=(o?$(o):null)||t;if(!i&&!e.scrollToTop)return Promise.resolve();const n=e.scrollBlock||"center",r=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=l.settingsTourActive||r?"auto":"smooth";return new Promise(s=>{const u=()=>{const z=e.scrollPadTop??80,c=e.scrollPadBottom??220,p=$(e.anchorSelector)||(i&&i.isConnected?i:null)||(t&&t.isConnected?t:null);if(!p){s();return}let d=p.getBoundingClientRect();d.top<z&&(ft(p,d.top-z),d=p.getBoundingClientRect()),d.bottom>window.innerHeight-c&&ft(p,d.bottom-window.innerHeight+c),requestAnimationFrame(()=>requestAnimationFrame(s))},g=()=>{i&&i.scrollIntoView({behavior:e.scrollToTop?"auto":a,block:n,inline:"nearest"}),u()};if(e.scrollToTop){if(Y(a),e.scrollToTopOnly){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&Y("auto"),s()}));return}if(a==="auto"){g();return}let z=!1;const c=()=>{z||(z=!0,window.removeEventListener("scrollend",p),clearTimeout(d),g())},p=()=>c();"onscrollend"in window&&window.addEventListener("scrollend",p,{once:!0});const d=setTimeout(c,520);return}if(!i){s();return}if(i.scrollIntoView({behavior:a,block:n,inline:"nearest"}),a==="auto"){u();return}let y=!1;const w=()=>{y||(y=!0,window.removeEventListener("scrollend",k),clearTimeout(K),u())},k=()=>w();"onscrollend"in window&&window.addEventListener("scrollend",k,{once:!0});const K=setTimeout(w,620)})}function bt(){F(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&V("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const n=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof n=="function"&&n({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function D(){F(),A(),l.settingsTourActive=!1,W();const t=R({blockPointer:!0,lockScroll:!0});t.style.background="rgba(17,24,39,0.42)";const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(e),document.body.style.overflow="hidden",typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{e.remove(),document.body.style.overflow=""};document.getElementById("activateNowBtn").onclick=()=>{o(),qt()},document.getElementById("activateLaterBtn").onclick=()=>{o();const i=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');i&&V("bookings",i)}}function et(){if(localStorage.getItem("settingsTourDone"))return;if(localStorage.getItem("settingsTourStep")==="handoff"){localStorage.removeItem("settingsTourStep"),D();return}localStorage.getItem("settingsTourDone")||localStorage.removeItem("settingsTourStep"),l.settingsTourActive=!0,W(),Ht();const t=document.querySelector('.tab[data-nav-filter="settings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="settings"]');t&&V("settings",t);function e(){if(typeof window.isEditPageDomReady=="function"&&window.isEditPageDomReady()||typeof isEditPageDomReady=="function"&&isEditPageDomReady()||!(typeof window.needsEditPageLoad=="function"&&window.needsEditPageLoad()||typeof needsEditPageLoad=="function"&&needsEditPageLoad())&&!l.editRoomsLoadPromise)return;const d=typeof window.invokeLoadEditRooms=="function"?window.invokeLoadEditRooms:typeof invokeLoadEditRooms=="function"?invokeLoadEditRooms:null;d&&d()}e();const o=[{target:"#tour-preview-btn",highlightSelector:"#tour-preview-btn",anchorSelector:"#tour-preview-btn",scrollTarget:"#tour-preview-btn",title:"Preview your booking page",text:"Open the exact page guests will use. It is safe to review before activation, so check the basics here first.",openAccordion:!1,tab:"settings",scrollToTop:!0,scrollToTopOnly:!0,forcePageTop:!0,scrollBlock:"start"},{target:"#tour-header-preview-card",highlightSelector:"#tour-header-preview-card",anchorSelector:"#tour-header-preview-card",scrollTarget:"#tour-header-preview-card",title:"Edit your booking page",text:"This page is the source of truth for your guest site. Update the hotel name, address, phone, policy, rooms, photos, and prices here.",openAccordion:!1,tab:"settings",scrollBlock:"nearest",scrollPadTop:80,scrollPadBottom:360,tooltipPosition:"below",tooltipGap:22},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo-placeholder, #editRoomsCards [data-tour-room-card="1"] .room-edit-photo',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',scrollTarget:'#editRoomsCards [data-tour-room-card="1"]',title:"Add room photos",text:"Use real room photos. A clear first photo makes the page feel legitimate and helps guests decide faster.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:80,scrollPadBottom:220},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields button[onclick^="saveEditRoom"]',scrollTarget:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields button[onclick^="saveEditRoom"]',title:"Edit room details",text:"Room name, description, guest count, amenities, and units all show on the booking page. Keep this short and accurate.",openAccordion:!1,tab:"settings",scrollBlock:"center",scrollPadTop:80,scrollPadBottom:390,tooltipPosition:"below",tooltipGap:22},{target:"#tour-booking-link-card",highlightSelector:"#tour-booking-link-card",anchorSelector:"#tour-booking-link-card",scrollTarget:"#tour-booking-link-card",title:"Share your direct link",text:"This is the link to send guests, add to your website, and place on Google Business Profile. QR tools live here too.",openAccordion:!1,tab:"settings",scrollBlock:"start",scrollPadTop:80,scrollPadBottom:220},{target:"#tour-rates-card",highlightSelector:"#tour-rates-card",anchorSelector:"#tour-rates-header",scrollTarget:"#tour-rates-card",title:"Set your rates",text:"Set nightly, weekly, and monthly prices before you share the link. Guests book from these rates on your direct page.",openAccordion:!0,accordionCard:"#tour-rates-card",tab:"settings",scrollBlock:"center",scrollPadBottom:260},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",title:"Track revenue and payment status",text:"Revenue shows direct bookings, card status, and estimated OTA commission savings. Cards are verified, and you collect payment at check-in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,scrollBlock:"start",scrollPadTop:92,scrollPadBottom:220},{target:"",text:"",openAccordion:!1,tab:"apps",customModal:"guestAppsStory"}];let i=parseInt(localStorage.getItem("settingsTourStep")||"0",10);(!Number.isFinite(i)||i<0||i>=o.length)&&(i=0,localStorage.removeItem("settingsTourStep"));function n(){F()}function r(){n(),localStorage.removeItem("settingsTourStep"),D()}function a(c){if(c.customModal){u(c);return}requestAnimationFrame(()=>u(c))}function s(){if(n(),i>=o.length){localStorage.removeItem("settingsTourStep"),D();return}const c=o[i];if(c.tab==="revenue"&&!l.revenueEnabled){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}if(c.tab==="apps"&&!(isStandaloneApp()||l.frontdeskInstalled)&&c.target&&!c.target.includes("tour-fd-install")){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}if(c.customModal||R(),c.tab&&c.tab!==l.currentFilter){const p=document.querySelector(`.tab[data-nav-filter="${c.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${c.tab}"]`);if(p&&V(c.tab,p),c.tab==="apps"){const d=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof d=="function"&&d(!0)}a(c);return}a(c)}function u(c){if(c.customModal==="homescreen"){k();return}if(c.customModal===!0||c.customModal==="bookings"){z();return}if(c.customModal==="availability"){K();return}if(c.customModal==="finale"){D();return}if(c.customModal==="guestAppsStory"){bt();return}if(c.waitForVisible){const f=c.target.split(",").map(b=>b.trim());let m=0;const x=30;R();const v=l.settingsTourActive?60:200,h=()=>{if(m++,c.tab==="apps"){const E=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof E=="function"&&E(!0)}let b=null;for(const E of f)if(b=document.querySelector(E),b)break;if(b&&(c.openAccordion&&C(b,c),c.openAccordion||b.offsetParent!==null)){g(b,c);return}m<x?setTimeout(h,v):(i++,localStorage.setItem("settingsTourStep",String(i)),s())};h();return}function p(f){const m=f.target.split(",").map(x=>x.trim());for(const x of m){const v=document.querySelector(x);if(v&&!(!f.openAccordion&&v.offsetParent===null&&getComputedStyle(v).position!=="fixed"))return v}if(f.accordionCard){const x=document.querySelector(f.accordionCard);if(x)return x}return null}function d(f,m){const x=p(f);if(x){m(x);return}const v=f.tab==="settings"&&!f.customModal&&f.target,h=f.tab==="apps"&&!f.customModal&&f.target;if(!v&&!h){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}R();let b=0;if(v&&e(),h){const S=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof S=="function"&&S(!0)}const E=l.settingsTourActive?60:250,T=()=>{if(b++,h){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}const S=p(f);if(S){m(S);return}if(e(),h){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}b<48?setTimeout(T,E):(i++,localStorage.setItem("settingsTourStep",String(i)),s())};T()}d(c,f=>g(f,c))}function g(c,p){if(C(c,p),c=L(c,p),(!c||!c.isConnected)&&(c=U(c,p),c&&(c=L(c,p))),!c){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}const d=c;R(),ht(d,p).then(()=>{if(p.forcePageTop&&Y("auto"),!d.isConnected){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}C(d,p),p.noHighlight||(d.dataset.tourOrigPosition||(d.dataset.tourOrigPosition=d.style.position||""),d.dataset.tourOrigZIndex||(d.dataset.tourOrigZIndex=d.style.zIndex||""),d.dataset.tourOrigIsolation||(d.dataset.tourOrigIsolation=d.style.isolation||""),d.dataset.tourOrigBoxShadow||(d.dataset.tourOrigBoxShadow=d.style.boxShadow||""),d.dataset.tourOrigOutline||(d.dataset.tourOrigOutline=d.style.outline||""),d.dataset.tourOrigOutlineOffset||(d.dataset.tourOrigOutlineOffset=d.style.outlineOffset||""),d.dataset.tourOrigTransition||(d.dataset.tourOrigTransition=d.style.transition||""),d.style.position=d.style.position||"relative",d.style.zIndex="99999",d.style.isolation="isolate",d.style.transition="box-shadow 0.18s ease, outline 0.18s ease",d.style.boxShadow="0 0 0 1px rgba(255,255,255,0.92), 0 18px 46px rgba(26,43,34,0.22)",d.style.outline="1px solid rgba(255,255,255,0.82)",d.style.outlineOffset="2px",d.setAttribute("data-tour-highlighted","1"),Vt(d)),document.body.style.overflow="hidden";const f=()=>{const v=$(p.anchorSelector)||d;if(p.freezeTooltip){const T=v&&v.isConnected?v.getBoundingClientRect():null;y(v,p,T&&T.width>=2?T:null);return}const h=U(d,p);let b=h?L(h,p):d;C(b,p);const E=p.tooltipAnchor?null:tt(p,b);y(b||d,p,E)};if(p.freezeTooltip){requestAnimationFrame(()=>requestAnimationFrame(f));return}const m=(x=0)=>{requestAnimationFrame(()=>{if(p.forcePageTop&&Y("auto"),p.tooltipAnchor){f();return}const v=U(d,p);let h=v?L(v,p):d;C(h,p);const b=tt(p,h);if(!b&&x<4){requestAnimationFrame(()=>m(x+1));return}y(h||d,p,b)})};m(0)})}function y(c,p,d){const f=document.getElementById("tourTooltip");f&&f.remove(),A();const m=document.createElement("div");m.id="tourTooltip";const x=Math.min(i+1,o.length),v=Math.max(8,Math.min(100,Math.round(x/o.length*100))),h=Z(p.title||"Quick setup"),b=Z(p.text||""),E=p.primaryLabel||(i<o.length-1?"Next":"Got it"),T=i<=0;m.style.cssText="position:fixed;z-index:100000;left:12px;right:12px;bottom:calc(14px + env(safe-area-inset-bottom,0px));display:flex;justify-content:center;pointer-events:none;",m.innerHTML=`
      <div class="tour-panel" role="dialog" aria-live="polite" aria-label="${h}">
        ...
        <div class="tour-actions">
          ...
          <button id="tourNextBtn" class="tour-btn tour-btn-primary" type="button">${Z(E)}</button>
        </div>
      </div>`,document.body.appendChild(m);const S=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,B=S&&!!p.mobileTooltipPosition;if((!S||B)&&d&&d.width>=2&&d.height>=2){const I=Math.min(380,window.innerWidth-28);m.style.setProperty("--tour-width",`${I}px`),m.style.left="0",m.style.right="auto",m.style.bottom="auto",m.style.width=`${I}px`,m.classList.add("tour-tooltip-floating");const P=Math.min(m.offsetHeight||190,Math.max(140,window.innerHeight-28)),J=p.tooltipGap??14,$t=d.left+d.width/2,pt=Math.max(14,Math.min($t-I/2,window.innerWidth-I-14)),ut=window.innerHeight-d.bottom,Mt=d.top,gt=S&&p.mobileTooltipPosition||p.tooltipPosition||"",Lt=(gt==="below"?!0:gt==="above"?!1:ut>=P+J||ut>=Mt)?d.bottom+J:d.top-P-J,mt=Math.max(14,Math.min(Lt,window.innerHeight-P-14));m.style.setProperty("--tour-left",`${pt}px`),m.style.setProperty("--tour-top",`${mt}px`),m.style.left=`${pt}px`,m.style.top=`${mt}px`}w()}function w(){const c=document.getElementById("tourNextBtn"),p=document.getElementById("tourSkipBtn"),d=()=>{n(),i++,localStorage.setItem("settingsTourStep",String(i)),s()},f=()=>{r()},m=()=>{i<=0||(n(),i--,localStorage.setItem("settingsTourStep",String(i)),s())};c&&(c.onclick=d),p&&(p.onclick=f);const x=document.getElementById("tourBackBtn");x&&(x.onclick=m),jt({onNext:d,onBack:m,onSkip:f})}function k(){A(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms();const c=document.createElement("div");c.id="tourBlurOverlay",c.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(c),document.body.style.overflow="hidden";const p=l.activeHotelName||"Your Hotel",d=p.trim().charAt(0).toUpperCase(),f=p.length>10?p.slice(0,10):p,m="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",x="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",v="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",h=`<div style="${m}"><div style="${x}background:rgba(255,255,255,0.22);"></div><div style="${v}"></div></div>`,b=l.activeHotelAppIcon||"",E=b?`<img src="${b}" alt="" style="width:100%;height:100%;object-fit:contain;">`:d,T=b?`${x}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${x}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,S=`<div style="${m}"><div style="${T}">${E}</div><div style="${v}font-size:7.5px;color:#fff;font-weight:700;">${f}</div></div>`,B=[h,h,h,h,S,h,h,h].join(""),I=document.createElement("div");if(I.id="tourTooltip",I.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",I.innerHTML=`
      ...
      </div>`,document.body.appendChild(I),!document.getElementById("tourModalAnimStyle")){const P=document.createElement("style");P.id="tourModalAnimStyle",P.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(P)}document.getElementById("tourNextBtn").onclick=()=>{n(),i++,localStorage.setItem("settingsTourStep",String(i)),s()},document.getElementById("tourSkipBtn").onclick=()=>{r()}}function K(){A();const c=document.createElement("div");c.id="tourBlurOverlay",c.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(c),document.body.style.overflow="hidden";let p=0;const d=[`<div style="padding:20px 18px 0;">
      ...
      <div style="padding:0 14px 14px;">
      ...
      </div>`],f=document.createElement("div");f.id="tourTooltip",f.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";function m(){const v=p>=d.length-1?"Next — Revenue →":"Next →";f.innerHTML=`
        ...
        </div>`,document.getElementById("tourNextBtn").onclick=()=>{p<d.length-1?(p++,m()):(n(),i++,localStorage.setItem("settingsTourStep",String(i)),s())},document.getElementById("tourSkipBtn").onclick=()=>{r()}}if(document.body.appendChild(f),m(),!document.getElementById("tourModalAnimStyle")){const x=document.createElement("style");x.id="tourModalAnimStyle",x.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(x)}}function z(){A();const c=document.createElement("div");c.id="tourBlurOverlay",c.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);",document.body.appendChild(c),document.body.style.overflow="hidden";const p=document.createElement("div");if(p.id="tourTooltip",p.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",p.innerHTML=`
      <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(p),!document.getElementById("tourModalAnimStyle")){const d=document.createElement("style");d.id="tourModalAnimStyle",d.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(d)}document.getElementById("tourNextBtn").onclick=()=>{n(),i++,localStorage.setItem("settingsTourStep",String(i)),s()},document.getElementById("tourSkipBtn").onclick=()=>{r()}}s()}async function wt(){const t=document.getElementById("settingsList");if(t){t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const e=await api("GET","/api/crm/verify"),i="https://"+(e?.domain||l.activeHotelId+".mktel.co"),n="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(i),r=await api("GET","/api/crm/rooms");let a={nightly:69,weekly:299,monthly:999};r?.rates&&(a=r.rates);const s=r?.rooms||[];let u="";e?.subscribed||(u+=goLiveInlineCardHtml()),s.length?s.forEach(g=>{const y=g.images&&g.images.length>0;u+=`
    ...
    `,t.innerHTML=u}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function Yt(){const t=document.getElementById("settings-booking-url");t&&navigator.clipboard.writeText(t.value).then(()=>{localStorage.setItem("linkCopied","1"),H(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function _t(){localStorage.setItem("settingsTourDone","1");const t=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",t);let e=0;const o=setInterval(()=>{e++;const i=document.getElementById("edit-rate-nightly");if(i||e>20){if(clearInterval(o),!i)return;const n=i.closest(".accordion-body");if(n&&n.style.display==="none"){n.style.display="block";const r=n.previousElementSibling?.querySelector(".accordion-arrow");r&&(r.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const r=document.getElementById("checklistPointer");r&&r.remove();const a=i.getBoundingClientRect(),s=document.createElement("div");s.id="checklistPointer",s.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${a.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,s.innerHTML=`
          ...
          `,document.body.appendChild(s),setTimeout(()=>{const u=document.getElementById("checklistPointer");u&&u.remove()},6e3)},1e3)},100)}},200)}function Qt(){const e="https://"+(l.activeHotelDomain||l.activeHotelId+".mktel.co");navigator.clipboard.writeText(e).then(()=>{localStorage.setItem("linkCopied","1"),H(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function Kt(t,e){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const n=setInterval(()=>{i++;const r=document.querySelector(t);if(r||i>20){if(clearInterval(n),!r)return;r.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const s=r.getBoundingClientRect(),u=document.createElement("div");u.id="checklistPointer",u.style.cssText=`
        ...
        `,document.body.appendChild(u),setTimeout(()=>{const g=document.getElementById("checklistPointer");g&&g.remove()},6e3)},1e3)}},200)}function nt(){const t=String(l.token||localStorage.getItem("crmToken")||"").trim();return t&&(l.token=t),t}async function rt(t,e){const o=nt();if(!o)throw new Error("Not logged in");const i=await Dt(e),n=new FormData;n.append("image",i,i.name||"room.webp");const r=new URLSearchParams;l.activeHotelId&&r.set("hotelId",l.activeHotelId),r.set("token",o);const a=await fetch(`/api/crm/rooms/${t}/images?${r}`,{method:"POST",headers:{"x-crm-token":o},body:n}),s=await a.json().catch(()=>({}));if(!a.ok||!s.success)throw new Error(s.message||s.error||`Upload failed (${a.status})`);return s}async function Jt(t,e){const o=t.target.files[0];if(o)try{await rt(e,o),toast("Photo uploaded!","success"),wt()}catch(i){toast(i.message||"Upload failed","error")}}async function Zt(){const t=parseFloat(document.getElementById("settings-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("settings-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("settings-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),toast("Rates saved","success")}catch{toast("Failed to save rates","error")}}async function Xt(){const t=document.getElementById("settings-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");l.token=t,l.isMasterPin=!1;try{localStorage.setItem("crmToken",l.token)}catch{}toast("PIN updated!","success"),document.getElementById("settings-new-pin").value=""}catch(e){toast(e.message||"Failed to change PIN","error")}}async function te(){const t=document.getElementById("settings-support-msg")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),toast("Message sent!","success"),document.getElementById("settings-support-msg").value=""}catch{toast("Failed to send","error")}}function ee(){const t=l.activeHotelDomain||l.activeHotelId+".mktel.co",o=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://localhost:5173/?hotelId="+encodeURIComponent(l.activeHotelId)+"&preview=1":"https://"+t+"?preview=1";window.open(o,"_blank")}function kt(){if((window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&l.activeHotelId)return"http://localhost:5173/?hotelId="+encodeURIComponent(l.activeHotelId);const e=l.activeHotelDomain||"";return e?"https://"+e+"/":""}function oe(){const t=kt();if(!t){toast("Your booking domain is still setting up.","info");return}window.open(t,"_blank")}function ie(){const t=document.getElementById("previewSiteBar");t&&(t.style.display=l.currentFilter==="settings"?"block":"none")}function H(){if(localStorage.getItem("settingsTourDone"))return;const t=parseInt(localStorage.getItem("settingsTourStep")||"0"),e=l.editRooms.some(a=>a.images&&a.images.length>0),o=!!localStorage.getItem("ratesChanged"),i=!!localStorage.getItem("linkCopied");t===2&&e&&localStorage.setItem("settingsTourStep","3"),t===3&&i&&localStorage.setItem("settingsTourStep","4"),t===4&&o&&localStorage.setItem("settingsTourStep","5");const n=document.getElementById("tourTooltip");n&&n.remove();const r=document.getElementById("tourBlurOverlay");r&&r.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(a=>{a.style.position=a.dataset.tourOrigPosition||"",a.style.zIndex="",a.style.isolation="",a.style.boxShadow="",a.style.outline=a.dataset.tourOrigOutline||"",a.style.outlineOffset=a.dataset.tourOrigOutlineOffset||"",a.removeAttribute("data-tour-highlighted"),delete a.dataset.tourOrigPosition,delete a.dataset.tourOrigOutline,delete a.dataset.tourOrigOutlineOffset}),document.body.style.overflow=""}function ne(){let t=0;const e={},o=[{title:"Why do you want a booking page?",key:"why",type:"text",placeholder:"e.g. I want guests to book directly instead of calling me..."},{title:"How do guests currently book with you?",key:"currentBooking",type:"choice",options:[{label:"They call me or walk in",value:"phone_walkin"},{label:"Through Booking.com / Expedia",value:"ota"},{label:"I have a website but no booking system",value:"website_no_booking"},{label:"I don't take bookings online yet",value:"no_online"}]},{title:"How many rooms do you have?",key:"roomCount",type:"choice",options:[{label:"1–5 rooms",value:"1-5"},{label:"6–15 rooms",value:"6-15"},{label:"16–50 rooms",value:"16-50"},{label:"50+ rooms",value:"50+"}]},{title:"What's most important to you?",key:"priority",type:"choice",options:[{label:"Stop paying OTA commissions",value:"no_commission"},{label:"Get more direct bookings",value:"more_bookings"},{label:"Have a professional online presence",value:"professional"},{label:"Make it easier for guests to book",value:"easier_booking"}]}];function i(){let n=document.getElementById("onboardingOverlay");if(n&&n.remove(),t>=o.length){localStorage.setItem("onboardingDone","1");try{api("POST","/api/crm/onboarding-answers",e).catch(()=>{})}catch{}Et();return}const r=o[t],a=document.createElement("div");a.id="onboardingOverlay",a.style.cssText="position:fixed;inset:0;z-index:100001;background:linear-gradient(135deg, #1a2b22 0%, #2E7D5B 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;",r.type==="text"?(a.innerHTML=`
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=e}document.body.appendChild(t),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function _(){const t=document.getElementById("postActivationTourTooltip");t&&t.remove();const e=document.getElementById("postActivationTourOverlay");e&&e.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function G(){_(),localStorage.setItem("postActivationTourDone","1");const t=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",t)}catch{}}function at(){if(localStorage.getItem("postActivationTourDone")){G();return}_();const t=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. You'll get a push alert for each new one."},{tab:"apps",navFilter:"apps",text:"<strong>Guest App</strong> — put your hotel on guests&apos; home screens and send install reminders."}];let e=0;function o(){if(_(),e>=t.length){G();return}const i=t[e],n=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);n&&setFilter(i.tab,n);const r=document.createElement("div");r.id="postActivationTourOverlay",r.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(r),document.body.style.overflow="hidden",setTimeout(()=>{const a=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);a&&(a.setAttribute("data-post-activation-highlight","1"),a.style.position="relative",a.style.zIndex="100003",a.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",a.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const s=a?a.getBoundingClientRect():{left:24,bottom:80,width:200},u=document.createElement("div");u.id="postActivationTourTooltip";const g=Math.min(300,window.innerWidth-32),y=Math.max(16,Math.min(s.left+s.width/2-g/2,window.innerWidth-g-16)),w=Math.min(s.bottom+14,window.innerHeight-180);u.style.cssText=`position:fixed;z-index:100004;left:${y}px;top:${w}px;max-width:${g}px;width:${g}px;`;const k=e>=t.length-1;u.innerHTML=`
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),at()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}async function st(){if(isEditPageDomReady())return;if(l.editRoomsLoadPromise)return l.editRoomsLoadPromise;const t=document.getElementById("editRoomsList");if(t){l.editRoomsLoadPromise=(async()=>{t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[e,o]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify")]);if(!e.rooms)throw new Error("No data");l.editRooms=e.rooms;const i=o?.hotelName||"";i&&(l.activeHotelName=i),o&&(l.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const n=o?.hotelSubtitle||"",r=o?.hotelAddress||"",a=o?.hotelPhone||"",s=o?.appIconUrl||"";l.activeHotelAppIcon=s,updateFrontdeskManifestLink();let u={nightly:69,weekly:299,monthly:999,taxRate:.1};e.rates&&(u=e.rates);const y="https://"+(o?.domain||l.activeHotelId+".mktel.co"),w="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(y);let k=`
    ...
    `;t.innerHTML=k,N(),typeof lucide<"u"&&lucide.createIcons()}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load your page</div><div class="empty-sub">Check your connection and refresh.</div></div>'}})();try{await l.editRoomsLoadPromise}finally{l.editRoomsLoadPromise=null}}}function dt(){N()}function N(){const t=document.getElementById("editRoomsCards");if(t){if(!l.editRooms.length){t.innerHTML='<div class="empty-state"><div class="empty-icon">🛏️</div><div class="empty-text">No rooms yet</div><div class="empty-sub">Add your first room type below.</div></div>';return}t.innerHTML=l.editRooms.map((e,o)=>{const i=(e.amenities||"").split("•").map(a=>a.trim()).filter(Boolean),n=(e.images||[]).filter(a=>a&&a.url),r=jsStr(e.id);return`
      ...
      <div class="room-edit-fields" style="padding:18px;">
        ...
        <div style="margin-bottom:12px;">
          ...
          <div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:8px;" id="edit-amenity-pills-${e.id}">
            ${i.map(a=>`<span style="display:inline-flex;align-items:center;gap:4px;background:var(--green-pale);color:var(--green);padding:5px 10px;border-radius:8px;font-size:12px;font-weight:600;">${Bt(a)} ${a} <button onclick="removeAmenity('${e.id}','${a.replace(/'/g,"\\'")}')" style="background:none;border:none;color:var(--green);cursor:pointer;font-size:14px;margin-left:2px;">×</button></span>`).join("")}
          </div>
    ...
    </div>`}).join(""),typeof lucide<"u"&&lucide.createIcons()}}function St(t){const e=l.editRooms.find(o=>String(o.id)===String(t));return(e&&e.images||[]).filter(o=>o&&o.url)}function Tt(t,e){const o=St(t);if(!o.length)return;const i=document.getElementById("edit-card-"+t);if(!i)return;const n=o.length,r=((Number(e)||0)%n+n)%n,a=i.querySelector(".room-edit-main-img");a&&(a.src=o[r].url),i.querySelector(".room-edit-photo")?.setAttribute("data-photo-index",String(r));const s=i.querySelector(".room-edit-photo-count");s&&(s.textContent=r+1+" / "+n),i.querySelectorAll(".room-edit-image-dot").forEach((u,g)=>{u.classList.toggle("active",g===r),g===r?u.setAttribute("aria-current","true"):u.removeAttribute("aria-current")}),i.querySelectorAll(".room-edit-thumb").forEach((u,g)=>{u.classList.toggle("active",g===r),g===r?u.setAttribute("aria-current","true"):u.removeAttribute("aria-current")})}function se(t,e){const i=document.getElementById("edit-card-"+t)?.querySelector(".room-edit-photo"),n=parseInt(i?.getAttribute("data-photo-index")||"0",10)||0;Tt(t,n+e)}function Bt(t){const e=t.toLowerCase();return e.includes("wifi")?'<i data-lucide="wifi" style="width:14px;height:14px;"></i>':e.includes("tv")||e.includes("television")?'<i data-lucide="tv" style="width:14px;height:14px;"></i>':e.includes("fridge")||e.includes("refrigerator")?'<i data-lucide="thermometer-snowflake" style="width:14px;height:14px;"></i>':e.includes("parking")?'<i data-lucide="car" style="width:14px;height:14px;"></i>':e.includes("housekeeping")||e.includes("cleaning")?'<i data-lucide="sparkles" style="width:14px;height:14px;"></i>':e.includes("bath")||e.includes("shower")?'<i data-lucide="bath" style="width:14px;height:14px;"></i>':e.includes("work")||e.includes("desk")?'<i data-lucide="laptop" style="width:14px;height:14px;"></i>':e.includes("pet")||e.includes("dog")?'<i data-lucide="paw-print" style="width:14px;height:14px;"></i>':e.includes("pool")?'<i data-lucide="waves" style="width:14px;height:14px;"></i>':e.includes("kitchen")||e.includes("microwave")?'<i data-lucide="cooking-pot" style="width:14px;height:14px;"></i>':'<i data-lucide="check" style="width:14px;height:14px;"></i>'}const It=[{key:"wifi",label:"Free WiFi",icon:"wifi"},{key:"tv",label:"Smart TV",icon:"tv"},{key:"fridge",label:"Fridge",icon:"thermometer-snowflake"},{key:"parking",label:"Free Parking",icon:"car"},{key:"housekeeping",label:"Weekly Housekeeping",icon:"sparkles"},{key:"bath",label:"Bath",icon:"bath"},{key:"workstation",label:"Workstation",icon:"laptop"},{key:"pet",label:"Pet Friendly",icon:"paw-print"},{key:"pool",label:"Pool",icon:"waves"},{key:"kitchen",label:"Kitchenette",icon:"cooking-pot"},{key:"ac",label:"Air Conditioning",icon:"wind"},{key:"laundry",label:"Laundry",icon:"shirt"}];let lt=null;function zt(t){lt=t;const o=(l.editRooms.find(r=>r.id===t)?.amenities||"").split("•").map(r=>r.trim().toLowerCase()).filter(Boolean);let i=document.getElementById("amenityPickerModal");i||(document.body.insertAdjacentHTML("beforeend",`
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",Q),i=document.getElementById("amenityPickerModal"));const n=document.getElementById("amenityPickerGrid");n.innerHTML=It.map(r=>{const a=o.some(s=>s.includes(r.key));return`<button onclick="toggleAmenityPreset(this,'${r.key}')" data-key="${r.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${a?"#2E7D5B":"#e5e7eb"};background:${a?"#E8F5EE":"white"};color:${a?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${r.icon}" style="width:14px;height:14px;"></i> ${r.label}</button>`}).join(""),document.getElementById("amenityCustomInput").value="",i.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function de(t,e){const o=t.style.borderColor==="rgb(46, 125, 91)";t.style.borderColor=o?"#e5e7eb":"#2E7D5B",t.style.background=o?"white":"#E8F5EE",t.style.color=o?"#1a1a2e":"#2E7D5B"}function Q(){document.getElementById("amenityPickerModal").style.display="none",lt=null}function le(){const t=l.editRooms.find(n=>n.id===lt);if(!t){Q();return}const e=document.getElementById("amenityPickerGrid"),o=[];e.querySelectorAll("button").forEach(n=>{if(n.style.background==="rgb(232, 245, 238)"){const r=It.find(a=>a.key===n.dataset.key);r&&o.push(r.label)}});const i=document.getElementById("amenityCustomInput").value.trim();i&&o.push(i),t.amenities=o.join(" • "),Q(),dt(),typeof lucide<"u"&&lucide.createIcons()}function ce(t){zt(t)}function pe(t,e){const o=l.editRooms.find(n=>n.id===t);if(!o)return;const i=(o.amenities||"").split("•").map(n=>n.trim()).filter(Boolean);o.amenities=i.filter(n=>n!==e).join(" • "),dt(),typeof lucide<"u"&&lucide.createIcons()}async function ue(){const t=document.getElementById("edit-hotel-name")?.value.trim(),e=document.getElementById("edit-hotel-subtitle")?.value.trim(),o=document.getElementById("edit-hotel-address")?.value.trim(),i=document.getElementById("edit-hotel-phone")?.value.trim(),n=document.getElementById("edit-hotel-policy")?.value.trim();try{await api("POST","/api/crm/hotel-info",{name:t,subtitle:e,address:o,phone:i,cancellationPolicy:n}),toast("Hotel info saved!","success")}catch{toast("Failed to save","error")}}async function ge(){const t=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),localStorage.setItem("ratesChanged","1"),l.launchStatus=null,H(),toast("Rates saved!","success")}catch{toast("Failed to save rates","error")}}async function me(){const t=document.getElementById("edit-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");l.token=t,l.isMasterPin=!1;try{localStorage.setItem("crmToken",l.token)}catch{}toast("PIN updated!","success")}catch(e){toast(e.message||"Failed to change PIN","error")}}function fe(t){navigator.clipboard.writeText(t).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function xe(t){const e=t.nextElementSibling,o=t.querySelector(".accordion-arrow");e.style.display==="none"?(e.style.display="block",o&&(o.style.transform="rotate(90deg)")):(e.style.display="none",o&&(o.style.transform="rotate(0deg)"))}let j=!1;function Pt(){if(document.getElementById("goLiveOverlay"))return;const t=document.createElement("div");t.id="goLiveOverlay",t.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(255,255,255,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;",t.innerHTML='<div class="logo-sprite-bounce"></div><div style="font-size:14px;font-weight:700;color:#1a5c3f;">Opening secure checkout…</div><div style="font-size:12px;color:#6b7280;">Taking you to Stripe — one moment</div>',document.body.appendChild(t)}function ot(){const t=document.getElementById("goLiveOverlay");t&&t.remove()}async function ye(){if(!j){j=!0,Pt();try{const t=await api("POST","/api/crm/go-live");if(t.success&&t.url){window.location.href=t.url;return}ot(),j=!1,toast(t.message||"Failed to start checkout","error")}catch{ot(),j=!1,toast("Failed to start checkout. Try again.","error")}}}async function he(){try{const t=await api("GET","/api/crm/billing-portal");t.success&&t.url?window.location.href=t.url:toast(t.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function be(){const t=document.getElementById("supportMessage")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),document.getElementById("supportMessage").value="",toast("Message sent! We'll reply to your email.","success")}catch{toast("Failed to send. Email support@bookmarketel.com directly.","error")}}async function ve(t){const e=l.editRooms.find(s=>s.id===t);if(!e){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+t)?.value.trim(),i=document.getElementById("edit-desc-"+t)?.value.trim(),n=parseInt(document.getElementById("edit-occ-"+t)?.value)||4,r=parseInt(document.getElementById("edit-units-"+t)?.value)||1,a={id:t,name:o||e.name,description:i||"",amenities:e.amenities||"",maxOccupancy:n,totalUnits:r};try{const s=await api("POST","/api/crm/rooms",a);if(s&&s.success===!1){toast(s.message||"Failed to save","error");return}e.name=a.name,e.description=a.description,e.maxOccupancy=n,e.totalUnits=r,toast("Room saved!","success")}catch(s){toast("Failed to save: "+(s.message||""),"error")}}async function we(t,e){const o=Array.from(t.target.files);if(!o.length)return;const n=document.getElementById("edit-card-"+e)?.querySelector("div:first-child");n&&(n.style.position="relative",n.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+e+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+e+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let r=0,a="";for(const u of o){try{const y=await rt(e,u);if(y.image){const w=l.editRooms.find(k=>k.id===e);w&&(w.images||(w.images=[]),w.images.push(y.image),w.imageUrl||(w.imageUrl=y.image.url)),r++}}catch(y){a=y.message||"Upload failed"}const g=document.getElementById("upload-progress-"+e);g&&(g.textContent=r+" / "+o.length)}const s=document.getElementById("upload-spinner-"+e);s&&s.remove(),N(),r>0&&(l.launchStatus=null),H(),r>0?toast(r+" photo"+(r!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success"):toast(a||"Upload failed","error")}function At(t,e=512){return new Promise((o,i)=>{const n=new Image,r=URL.createObjectURL(t);n.onload=()=>{try{const a=Math.min(n.naturalWidth,n.naturalHeight),s=(n.naturalWidth-a)/2,u=(n.naturalHeight-a)/2,g=document.createElement("canvas");g.width=e,g.height=e;const y=g.getContext("2d");y.imageSmoothingQuality="high",y.drawImage(n,s,u,a,a,0,0,e,e),URL.revokeObjectURL(r),g.toBlob(w=>w?o(w):i(new Error("crop failed")),"image/png",.92)}catch(a){URL.revokeObjectURL(r),i(a)}},n.onerror=()=>{URL.revokeObjectURL(r),i(new Error("load failed"))},n.src=r})}function Ct(){const t=document.getElementById("appsAppIconPreview");t&&(t.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function ct(t){const e=document.getElementById("appsAppIconPreview");e&&(e.style.background="#fff",e.style.border="1px solid var(--border)",e.style.padding="0",e.innerHTML='<img src="'+t+'" alt="App icon" style="width:100%;height:100%;object-fit:contain;">')}function it(){const t=document.getElementById("appsAppIconPreview");if(!t)return;if(l.activeHotelAppIcon){ct(l.activeHotelAppIcon);return}const e=(l.activeHotelName||"H").trim().charAt(0).toUpperCase()||"🏨";t.style.background="transparent",t.style.border="none",t.style.padding="0",t.innerHTML='<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">'+e+"</span>"}async function ke(t){const e=t.files&&t.files[0];if(!e)return;Ct();const o=new FormData;try{const i=await At(e,512);o.append("icon",i,"app-icon.png")}catch{o.append("icon",e)}try{const i=nt(),n=new URLSearchParams;l.activeHotelId&&n.set("hotelId",l.activeHotelId),i&&n.set("token",i);const a=await(await fetch(`/api/crm/hotel-app-icon?${n}`,{method:"POST",headers:{"x-crm-token":i},body:o})).json();if(a.success&&a.appIconUrl){l.activeHotelAppIcon=a.appIconUrl,ct(a.appIconUrl);const s=document.getElementById("appsView");s&&(s.dataset.appsKey=(l.activeHotelId||"")+"|"+a.appIconUrl+"|"+(l.activeHotelDomain||"")),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Logo updated! Guests will see it on their phone.","success")}else toast(a.message||"Failed to upload icon","error"),it()}catch{toast("Failed to upload icon","error"),it()}t.value=""}async function Ee(t,e){if(confirm("Delete this photo?"))try{await api("DELETE",`/api/crm/rooms/${t}/images/${e}`);const o=l.editRooms.find(i=>i.id===t);o&&o.images&&(o.images=o.images.filter(i=>i.id!==e),o.imageUrl=o.images[0]?.url||null),N(),toast("Photo deleted","success")}catch{toast("Failed to delete","error")}}async function Se(t){if(confirm("Delete this room type?"))try{await api("DELETE",`/api/crm/rooms/${t}`),toast("Room deleted","success"),st()}catch{toast("Failed to delete","error")}}function Te(){const t=document.getElementById("editRoomsList");document.getElementById("editAddForm")||(t.insertAdjacentHTML("beforeend",`
  ...
  `),document.getElementById("editNewRoomName").focus())}function Be(){const t=document.getElementById("editNewRoomName").value.trim();t&&api("POST","/api/crm/rooms",{name:t,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),st()}).catch(()=>toast("Failed to add","error"))}const Rt={addAmenityPrompt:ce,advanceTourIfNeeded:H,changePin:me,checklistGoTo:Kt,checklistGoToRates:_t,cleanupPostActivationTourUi:_,cleanupSettingsTourUi:F,closeAmenityPicker:Q,confirmAmenityPicker:le,confirmEditAddRoom:Be,copyBookingLink:fe,copyBookingLinkFromChecklist:Qt,deleteEditImage:Ee,deleteEditRoom:Se,ensureTourBlurOverlay:R,finishPostActivationTour:G,getAmenityIcon:Bt,getCrmAuthToken:nt,getEditRoomImages:St,goLive:ye,guestBookingEngineUrl:kt,handoffToGuestAppsTour:bt,hideGoLiveOverlay:ot,loadEditRooms:st,loadSettings:wt,openAmenityPicker:zt,openBillingPortal:he,openEditAddRoom:Te,openGuestBookingEngine:oe,openPreviewSite:ee,openTourAccordion:C,postRoomImageUpload:rt,queryTourSelector:$,removeAmenity:pe,renderEditRooms:dt,renderEditRoomsCards:N,replayWalkthrough:re,resolveLiveTourElement:U,resolveTourHighlightEl:L,restoreAppIconPreview:it,saveEditRoom:ve,saveHotelInfo:ue,saveRates:ge,scrollTourTargetIntoView:ht,sendSupportMessage:be,setAppIconPreviewImage:ct,setAppIconPreviewLoading:Ct,settingsChangePin:Xt,settingsCopyLink:Yt,settingsSaveRates:Zt,settingsSendSupport:te,settingsUploadPhoto:Jt,showActivatedModal:ae,showEditRoomPhoto:Tt,showFinaleMockModal:D,showGoLiveOverlay:Pt,showOnboardingQuestions:ne,showTestDriveModal:vt,showWelcomeModal:Et,squareCropImage:At,startPostActivationTabTour:at,startSettingsTour:et,stepEditRoomPhoto:se,toggleAmenityPreset:de,toggleSection:xe,tourAnchorRect:tt,tourElementRect:X,updatePreviewSiteBar:ie,uploadAppIcon:ke,uploadEditImages:we};function Ie(){Ot(Rt)}const Ce=Object.freeze(Object.defineProperty({__proto__:null,default:Rt,install:Ie},Symbol.toStringTag,{value:"Module"}));export{Pe as a,Ce as b,l as c,Ot as e,Ae as s};
