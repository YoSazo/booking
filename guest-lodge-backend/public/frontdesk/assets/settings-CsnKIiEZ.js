...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${e}]`);if(Array.from(i).forEach(n=>Bt(n,{nameAttr:e,icons:t,attrs:o})),e==="data-lucide"){const n=document.querySelectorAll("[icon-name]");n.length>0&&Array.from(n).forEach(r=>Bt(r,{nameAttr:"icon-name",icons:t,attrs:o}))}},Te={Bath:ee,Car:oe,Check:ie,ChevronLeft:ne,ChevronRight:re,CookingPot:ae,CopyCheck:se,DoorOpen:de,Ellipsis:le,Globe:ce,Inbox:pe,Laptop:ue,PawPrint:ge,QrCode:me,Rocket:fe,Share:he,Shirt:xe,Smartphone:ye,Sparkles:ve,SquarePlus:be,ThermometerSnowflake:we,Tv:ke,Waves:Ee,Wifi:Se,Wind:Be};window.lucide={createIcons(t={}){Ae({...t,icons:Te})}};function qo(){return Promise.resolve()}async function Ie(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let n=e.width,r=e.height;const a=Math.min(1,o/n,i/r);n=Math.round(n*a),r=Math.round(r*a);const s=document.createElement("canvas");s.width=n,s.height=r,s.getContext("2d").drawImage(e,0,0,n,r),e.close();const u=await new Promise((x,y)=>{s.toBlob(B=>B?x(B):y(new Error("encode failed")),"image/webp",.82)}),m=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([u],m+".webp",{type:"image/webp"})}catch{return t}}function jo(){const t=()=>{d.currentFilter==="apps"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}const ze=["cancelled","canceled","released"];function Uo(t){return t?ze.includes(String(t.status||"").trim().toLowerCase()):!0}function Ce(t){Object.assign(window,t)}const Pe=14,Me=10;function ut(t,e,o){return Math.max(e,Math.min(t,o))}function M(t,e,o,i){return{left:t,top:e,width:o,height:i,right:t+o,bottom:e+i}}function Re(){const t=window.visualViewport,e=t?t.offsetLeft:0,o=t?t.offsetTop:0,i=t?t.width:window.innerWidth,n=t?t.height:window.innerHeight;return M(e,o,i,n)}function $(t){if(!t||!t.isConnected)return null;const e=t.getBoundingClientRect();return e.width<2||e.height<2?null:M(e.left,e.top,e.width,e.height)}function Oe(t,e){if(!t||!e)return 0;const o=Math.max(0,Math.min(t.right,e.right)-Math.max(t.left,e.left)),i=Math.max(0,Math.min(t.bottom,e.bottom)-Math.max(t.top,e.top));return o*i}function De(t,e){return Math.max(0,e.left-t.left)+Math.max(0,t.right-e.right)+Math.max(0,e.top-t.top)+Math.max(0,t.bottom-e.bottom)}function $e(t,e){let o=0;for(const i of e||[]){const n=document.querySelector(i);if(!n||getComputedStyle(n).display==="none")continue;const r=$(n);!r||r.bottom<t.bottom-2||r.top>=t.bottom||(o=Math.max(o,t.bottom-r.top))}return o}function Le(t){const e=Re(),o=t.margin??Pe,i=Math.max(Number(t.bottomInset||0),$e(e,t.avoidBottomSelectors)),n=e.left+o+Number(t.leftInset||0),r=e.top+o+Number(t.topInset||0),a=e.right-o-Number(t.rightInset||0),s=e.bottom-o-i;return M(n,r,Math.max(1,a-n),Math.max(1,s-r))}function Fe(t){return t==="above"||t==="top"?["top","bottom","right","left"]:t==="right"?["right","left","bottom","top"]:t==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function He(t,e,o,i,n){return t==="top"?M(e.left+(e.width-o)/2,e.top-i-n,o,i):t==="right"?M(e.right+n,e.top+(e.height-i)/2,o,i):t==="left"?M(e.left-o-n,e.top+(e.height-i)/2,o,i):M(e.left+(e.width-o)/2,e.bottom+n,o,i)}function Ne(t,e){const o=ut(t.left,e.left,Math.max(e.left,e.right-t.width)),i=ut(t.top,e.top,Math.max(e.top,e.bottom-t.height));return M(o,i,t.width,t.height)}function qe(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function je(t,e){if(!t||Math.abs(e)<1)return!1;const o=qe(t);return o?o.scrollTop+=e:window.scrollBy({top:e,left:0,behavior:"auto"}),!0}function ct(t,e){const o=$(t);if(!o||e.height<60)return!1;let i;return o.height<=e.height?i=ut(o.top,e.top,e.bottom-o.height):i=e.bottom-o.height,je(t,o.top-i)}function zt(t,e){const o=getComputedStyle(t);for(const r of o)e.style.setProperty(r,o.getPropertyValue(r),o.getPropertyPriority(r));const i=t.children,n=e.children;for(let r=0;r<i.length;r+=1)n[r]&&zt(i[r],n[r])}function Ue(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function Ve(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((n,r)=>{const a=i[r];a&&(n.type==="checkbox"||n.type==="radio"?a.checked=n.checked:a.value=n.value)})}function Ge(t,e={}){if(!t||!t.isConnected||e.disabled||!$(t))return null;const i=t.cloneNode(!0);Ue(i),zt(t,i),Ve(t,i),i.setAttribute(e.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(e.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",e.prepareClone?.(i,t);const n=t.style.visibility;e.hideSource&&(t.style.visibility="hidden"),document.body.appendChild(i);const r=()=>{const s=$(t);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),e.hideSource&&(t.style.visibility=n)};return r(),{element:i,source:t,update:r,destroy:a}}function _e({tooltip:t,panel:e,target:o,anchor:i,spotlight:n,options:r={}}){if(!t||!e||!o)return null;let a=0,s=!1,u=!1,m=!1,x="";const y=(l=!0)=>{if(s||!t.isConnected||!o.isConnected)return null;const p=Le(r),w=`${p.left}:${p.top}:${p.width}:${p.height}`;x&&x!==w&&(u=!1,l=!0),x=w;const c=$(i)||$(o),f=$(o);if(!c||!f)return null;const h=Math.min(Number(r.maxWidth||380),p.width);t.style.position="fixed",t.style.right="auto",t.style.bottom="auto",t.style.width=`${h}px`,t.style.maxWidth=`${h}px`,t.style.margin="0",t.style.justifyContent="flex-start",e.style.maxHeight=`${Math.max(120,p.height)}px`;const v=Math.min(e.offsetHeight||t.offsetHeight||190,p.height),b=Number(r.gap??Me);l&&!u&&r.autoScroll!==!1&&f.height+v+b<=p.height&&(u=ct(o,p),u&&requestAnimationFrame(()=>y(!1)));const k=Fe(r.preferredPlacement).map((I,O)=>{const _=He(I,c,h,v,b),Et=De(_,p),St=Oe(_,f);return{placement:I,index:O,raw:_,overflow:Et,overlap:St,score:Et*1e5+St*100+O}}),T=k.find(I=>I.overflow<.5&&I.overlap<1),A=T||k.slice().sort((I,O)=>I.score-O.score)[0],z=r.forceDock===!0||!T;let P="floating",L;if(z){P="docked";const I=Math.min(v,Number(r.dockMaxHeight||Math.max(180,p.height*.42)),p.height);e.style.maxHeight=`${I}px`;const O=Math.min(e.offsetHeight||I,I);if(L=M(p.left+(p.width-h)/2,p.bottom-O,h,O),l&&!u&&r.autoScroll!==!1){const _=M(p.left,p.top,p.width,Math.max(60,L.top-b-p.top));u=ct(o,_),u&&requestAnimationFrame(()=>y(!1))}}else if(L=Ne(A.raw,p),l&&!u&&r.autoScroll!==!1){let I=p;if(A.placement==="bottom")I=M(p.left,p.top,p.width,Math.max(60,L.top-b-p.top));else if(A.placement==="top"){const O=L.bottom+b;I=M(p.left,O,p.width,Math.max(60,p.bottom-O))}u=ct(o,I),u&&requestAnimationFrame(()=>y(!1))}return t.dataset.tourLayoutMode=P,t.dataset.tourPlacement=z?"bottom-dock":A.placement,t.style.left=`${L.left}px`,t.style.top=`${L.top}px`,n?.update?.(),r.onLayout?.({mode:P,placement:t.dataset.tourPlacement,viewport:p,targetRect:$(o),anchorRect:$(i)||$(o),tooltipRect:L}),{mode:P,placement:t.dataset.tourPlacement,rect:L}},B=(l=!1)=>{m=m||l===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const p=m;m=!1,y(p)}))},C=()=>{u=!1,B(!0)},U=typeof ResizeObserver=="function"?new ResizeObserver(B):null;U?.observe(o),i&&i!==o&&U?.observe(i),U?.observe(e),window.addEventListener("resize",C),window.addEventListener("orientationchange",C),window.addEventListener("scroll",B,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",C),window.visualViewport.addEventListener("scroll",B));const lt=()=>{s=!0,a&&cancelAnimationFrame(a),U?.disconnect(),window.removeEventListener("resize",C),window.removeEventListener("orientationchange",C),window.removeEventListener("scroll",B,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",C),window.visualViewport.removeEventListener("scroll",B))},g=y(!0);return{destroy:lt,reposition:()=>y(!1),result:g}}function j(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function ot(...t){return j("setFilter")?.(...t)}function At(...t){return j("setBookingsSubview")?.(...t)}function Ye(...t){return j("toast")?.(...t)}function it(...t){return j("updateGoLiveBanner")?.(...t)}function We(...t){return j("seedTourRevenueShell")?.(...t)}function Je(...t){return j("finishTourHydration")?.(...t)}function Ke(...t){return j("goLive")?.(...t)}let K=null,nt=null,G=null;function N(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
  ...
  `,document.head.appendChild(t)}function ht(){K&&(document.removeEventListener("keydown",K),K=null)}function Qe(t){ht(),K=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",K)}function pt(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function D(t){N();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=e.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=e.blockPointer?"auto":"none",e.lockScroll&&(document.body.style.overflow="hidden"),o}const X="rgba(17,24,39,0.42)";function Y(){const t=document.getElementById("tourTooltip"),e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!t||e)return Promise.resolve();t.style.pointerEvents="none";const o=t.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function Ze(t,e){return G?.destroy(),G=Ge(t,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=e?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=e?.spotlightOutlineOffset??"2px",e?.spotlightBackground&&(o.style.background=e.spotlightBackground,o.style.backgroundColor=e.spotlightBackground),e?.spotlightBorderRadius&&(o.style.borderRadius=e.spotlightBorderRadius)}}),G?.element||null}function F(t){const e=t||{};ht(),nt?.destroy(),nt=null,G?.destroy(),G=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!e.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(r=>r.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(r=>{r.style.position=r.dataset.tourOrigPosition||"",r.style.zIndex=r.dataset.tourOrigZIndex||"",r.style.isolation=r.dataset.tourOrigIsolation||"",r.style.boxShadow=r.dataset.tourOrigBoxShadow||"",r.style.outline=r.dataset.tourOrigOutline||"",r.style.outlineOffset=r.dataset.tourOrigOutlineOffset||"",r.style.transition=r.dataset.tourOrigTransition||"",r.style.borderRadius=r.dataset.tourOrigBorderRadius||"",r.style.opacity=r.dataset.tourOrigOpacity||"";const a=r.dataset.tourOrigBackground||"",s=r.dataset.tourOrigBackgroundColor||"";s?r.style.backgroundColor=s:r.style.removeProperty("background-color"),a?r.style.background=a:r.style.removeProperty("background"),r.removeAttribute("data-tour-highlighted"),delete r.dataset.tourOrigPosition,delete r.dataset.tourOrigZIndex,delete r.dataset.tourOrigIsolation,delete r.dataset.tourOrigBoxShadow,delete r.dataset.tourOrigOutline,delete r.dataset.tourOrigOutlineOffset,delete r.dataset.tourOrigTransition,delete r.dataset.tourOrigBackground,delete r.dataset.tourOrigBackgroundColor,delete r.dataset.tourOrigBorderRadius,delete r.dataset.tourOrigOpacity});const n=document.getElementById("goLiveBanner");n&&n.dataset.tourHidden&&(delete n.dataset.tourHidden,typeof it=="function"&&it()),e.keepOverlay||(document.body.style.overflow="")}function Xe(){const t=document.getElementById("tourTooltip"),e=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[t,...e,...o].filter(Boolean);return!i.length&&!o.length?(F({keepOverlay:!0}),Promise.resolve()):(ht(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(F({keepOverlay:!0}),Promise.resolve()):(t&&(t.style.pointerEvents="none"),i.forEach(r=>{r.style.transition="opacity 0.07s ease, transform 0.07s ease",r.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(r=>{r.style.opacity="0",r.id==="tourTooltip"&&(r.style.transform="translateY(4px)")})}),new Promise(r=>{setTimeout(()=>{F({keepOverlay:!0}),r()},85)})))}function to(t){const e=[t,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);e.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{e.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function V(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const r=o.querySelector(".accordion-arrow");r&&(r.style.transform="rotate(90deg)")}}function q(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function W(t,e){if(e.highlightSelector){const o=q(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function tt(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const n=document.querySelector(i);if(n&&n.isConnected)return n}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function rt(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Ct(t,e){const o=q(t.anchorSelector);if(o){const i=rt(o,!0);if(i)return i}return rt(e,!0)}function Tt(t,e){const o=t.tooltipAnchorSelector||t.anchorSelector,i=q(o);if(i){const n=rt(i,!0);if(n)return n}return Ct(t,e)}function at(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const n=document.querySelector(i);n&&(n.scrollTop=0)})}function Pt(t,e,o){const i=o||{},n=e.scrollTarget||e.accordionCard,r=(n?q(n):null)||t;if(!r&&!e.scrollToTop)return Promise.resolve();const a=e.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,u=i.smooth&&!s?"smooth":d.settingsTourActive||s?"auto":"smooth";return new Promise(m=>{if(e.scrollToTop&&(at(u),e.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&at("auto"),m()}));return}if(!r){m();return}if(r.scrollIntoView({behavior:u,block:a,inline:"nearest"}),u==="auto"){requestAnimationFrame(()=>requestAnimationFrame(m));return}let x=!1;const y=()=>{x||(x=!0,window.removeEventListener("scrollend",B),clearTimeout(C),requestAnimationFrame(()=>requestAnimationFrame(m)))},B=()=>y();"onscrollend"in window&&window.addEventListener("scrollend",B,{once:!0});const C=setTimeout(y,520)})}function Mt(){F(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&ot("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const n=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof n=="function"&&n({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function J(){F({keepOverlay:!0}),N(),d.settingsTourActive=!1,it(),D({blockPointer:!0,lockScroll:!0,dim:X});const t=document.createElement("div");if(t.id="tourTooltip",t.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",t.innerHTML=`
    ...
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(A),!document.getElementById("tourModalAnimStyle")){const z=document.createElement("style");z.id="tourModalAnimStyle",z.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(z)}document.getElementById("tourNextBtn").onclick=()=>{Y().then(()=>{n({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),u()})},document.getElementById("tourSkipBtn").onclick=()=>{r()}}function U(){N(),D({blockPointer:!0,lockScroll:!0,dim:X});let g=0;const l=[`<div style="padding:20px 18px 0;">
