import{c as g,e as J}from"./settings-B7Jf8heO.js";const r={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4",frontdeskInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_19-49-38_1_tc1bzm.mp4"},K="32px";function m(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function v(t){return`border-radius:${K};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function P(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let $=[],u=0;function Z(t,e){w(!1),$=t,u=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?z(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?z(-1):i.key==="Escape"&&H()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const s=i.changedTouches[0].clientX-n;Math.abs(s)>50&&z(s<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",A()}function H(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function z(t){const e=$.length;e<=1||(u=(u+t+e)%e,A())}function A(){const t=document.getElementById("appsLightbox");if(!t)return;const e=$[u],o=$.length,n=e.type!=="video",i=o>1?`${u+1} / ${o}`:"",s=n?`<img src="${P(e.src)}" alt="${e.alt||""}"
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${a}
    </div>`}function S(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function b(t,e,o,n,i){const s=i?S("Video"):"",p=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${n})">
    ...
    ${p}
  </button>`}function ee(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function T(t){const e=document.getElementById("appsView");if(!e)return;const o=(g.activeHotelId||"")+"|"+(g.activeHotelAppIcon||"")+"|"+(g.activeHotelDomain||"");t||e.dataset.appsKey!==o||!e.querySelector(".apps-page")?(G(),e.dataset.appsKey=o):j()}function G(){const t=document.getElementById("appsView");if(!t)return;const e=g.activeHotelName||"Your Hotel",o=g.activeHotelAppIcon||"",n=e.trim().charAt(0).toUpperCase()||"🏨",i=g.activeHotelDomain||"",s=i?"https://"+i:"#",p=i?"https://"+i+"/install":"#";function l(X){return JSON.stringify(X).replace(/"/g,"&quot;")}const a=m(r.guestHome,520),c=[{type:"image",src:r.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],d=[{type:"image",src:r.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:r.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:r.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],f=[{type:"video",src:r.guestInstallVideo,poster:r.guestHome,alt:"Guest adds hotel to phone",title:"How your guests put your hotel on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your hotel shows up on their phone like an app. You don't need to do anything."}],N=[{type:"image",src:r.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your hotel app.'},{type:"image",src:r.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Bookings</strong>, type your reply. Takes 5 seconds."},{type:"video",src:r.guestMessageNotifVideo,poster:r.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],k=isStandaloneApp()||g.frontdeskInstalled,C=typeof Notification<"u"&&Notification.permission==="granted",D=[{type:"video",src:r.frontdeskInstallVideo,poster:r.frontdeskMessages,alt:"How to add Front Desk",title:"Add Front Desk to your home screen",caption:"Tap <strong>Add to Home Screen</strong> in your browser. No App Store. Takes about 3 seconds."},{type:"image",src:r.frontdeskMessages,alt:"Reply to guest",title:"You reply from your phone",caption:"Messages from guests show up in <strong>Bookings</strong>. Tap reply — they get it on their phone."}];let h;k&&C?h=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
    ...
    </div>`:k?h=`<div id="tour-fd-installed-badge"><p style="font-size:13px;color:var(--text-muted);margin:0 0 12px;line-height:1.55;">It's on your home screen. Turn on alerts so your phone buzzes when a guest books.</p>
      ...
      <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${l(D)},0)" style="margin-top:0;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how (1 min)</span></button>`;const B="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",Y=o?B+"background:#fff;border:1px solid var(--border);padding:8px;":B,R=o?`<img src="${o}" alt="Hotel logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,E=`
    ...
    <div class="apps-step-card" style="padding:0;overflow:hidden;">
      ...
      <div style="padding:0 18px 16px;background:#f8faf9;">
        ${s!=="#"?'<button type="button" onclick="openGuestBookingEngine()" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:var(--white);color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;">Go to direct booking page ↗</button>':""}
      </div>
    ...
    <div class="apps-page">
      ...
      <div class="apps-lock-wrapper">
        <div class="apps-lock-overlay">
          <div class="apps-lock-card">
            ...
            <p style="font-size:13px;color:var(--text-muted);line-height:1.55;margin:0 0 16px;">Check-in QR, guest notifications, app icon, and more — all available once Front Desk is on your home screen.</p>
            <button type="button" onclick="handleInstallFrontdesk()" style="width:100%;padding:14px;border-radius:12px;border:none;background:var(--green);color:#fff;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;">
              <span style="display:inline-flex;align-items:center;gap:8px;"><i data-lucide="download" style="width:18px;height:18px;"></i> Add to Home Screen</span>
            </button>
        ...
        <div class="apps-lock-content">
          ...
          <div class="apps-step-card">
            ...
            <p style="font-size:13px;color:var(--text-muted);margin:0 0 14px;line-height:1.55;">Just like you can save Front Desk to your home screen, your guests can save <strong>${e}</strong> to theirs — one tap, no app store.</p>
            ${L}
            ${M}
          </div>
      ...
      <p class="apps-footnote">iPhone &amp; Android · lives on your home screen · no App Store</p>

    </div>`,typeof lucide<"u"&&lucide.createIcons();return}const U=`
    ${F}
    <div class="apps-step-card" id="tour-fd-install-card">
      <div class="apps-section-divider" style="margin-top:0;padding-top:0;border-top:none;">Your phone</div>
      <div class="apps-step-title">${k?"Front Desk — on your home screen":"Add Front Desk to your home screen"}</div>
      ${h}
    </div>
    <div class="apps-step-card" id="tour-guest-icon-section">
      <div class="apps-step-title" style="margin-bottom:14px;">Your guest app icon</div>
    ...
    <div class="apps-step-card">
      <div class="apps-section-divider" style="margin-top:0;padding-top:0;border-top:none;">Guest phones</div>
      <p style="font-size:13px;color:var(--text-muted);margin:0 0 14px;line-height:1.55;">Just like you can save Front Desk to your home screen, your guests can save <strong>${e}</strong> to theirs — one tap, no app store. Then you're on their phone, and they book and message you direct.</p>
      ${L}
      ${M}
    </div>
    ${V}
    ${guestBroadcastCardHtml()}`,Q=k?"Booking alerts live on the <strong>Bookings</strong> tab · installs on iPhone &amp; Android":"iPhone &amp; Android · lives on your home screen · no App Store";t.innerHTML=`
  <style>
    .apps-page { padding:4px 0 28px; }
    .apps-headline { font-size:20px;font-weight:800;color:var(--text);line-height:1.3;margin:0 0 8px; }
    .apps-intro { font-size:14px;color:var(--text-muted);line-height:1.55;margin:0 0 22px; }
  ...
  <div class="apps-page">
    ...
    <div style="flex-shrink:0;width:100%;max-width:400px;margin:0 auto;padding:12px 20px max(16px,env(safe-area-inset-bottom));box-sizing:border-box;text-align:center;">
      ...
      <div style="display:flex;gap:6px;justify-content:center;">${l}</div>
        ...
        </div>`}],x=0,H(),w(!1);const a=document.createElement("div");a.id="appsTourLightbox",a.style.cssText=["position:fixed;inset:0;z-index:102001;background:#000;","display:flex;flex-direction:column;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join("");let c=0;a._swipeStart=d=>{c=d.changedTouches[0].clientX},a._swipeEnd=d=>{const f=d.changedTouches[0].clientX-c;Math.abs(f)>50&&q(f<0?1:-1)},a.addEventListener("touchstart",a._swipeStart,{passive:!0}),a.addEventListener("touchend",a._swipeEnd,{passive:!0}),document.body.appendChild(a),document.body.style.overflow="hidden",I()}const oe={appsCloseLightbox:H,appsCloudinaryFull:P,appsCloudinaryImg:m,appsLbNav:z,appsLbRender:A,appsOpenLightbox:Z,appsPhoneImgStyle:v,appsQuestionRow:b,appsTourClose:w,appsTourNav:q,appsTourRender:I,appsVideoBadgeHtml:S,detectAppPlatform:ee,ensureAppsViewRendered:T,loadGuestInstallStats:j,renderAppsView:G,startAppsTour:te};function re(){J(oe)}export{oe as default,re as install};
