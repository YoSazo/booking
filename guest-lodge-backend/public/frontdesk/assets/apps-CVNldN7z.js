import{c as l,e as rt}from"./settings-BX27OTdO.js";const c={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},pt="32px";function R(t,o){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(o||400)+"/")}function P(t){return`border-radius:${pt};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function K(t){const o=Math.min(window.devicePixelRatio||1,2),e=Math.round(Math.min(window.screen.width*o,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${e}/`)}let L=[],z=0;function dt(t,o){m(!1),L=t,z=o||0;let e=document.getElementById("appsLightbox");if(!e){e=document.createElement("div"),e.id="appsLightbox",e.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(e),document.body.style.overflow="hidden",e._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?M(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?M(-1):i.key==="Escape"&&W()},document.addEventListener("keydown",e._keyHandler);let n=0;e.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),e.addEventListener("touchend",i=>{const r=i.changedTouches[0].clientX-n;Math.abs(r)>50&&M(r<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",V()}function W(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function M(t){const o=L.length;o<=1||(z=(z+t+o)%o,V())}function V(){const t=document.getElementById("appsLightbox");if(!t)return;const o=L[z],e=L.length,n=o.type!=="video",i=e>1?`${z+1} / ${e}`:"",r=n?`<img src="${K(o.src)}" alt="${o.alt||""}"
          style="max-width:100%;max-height:calc(100dvh - 160px);width:auto;height:auto;display:block;object-fit:contain;${P()}"
          loading="eager" decoding="async">`:`<video autoplay loop muted playsinline webkit-playsinline
          style="max-width:100%;max-height:calc(100dvh - 160px);width:auto;height:auto;display:block;${P()}"
          ${o.poster?`poster="${R(o.poster,400)}"`:""}>
          <source src="${o.src}" type="video/mp4">
       </video>`,s=e>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",a=e>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",d=e>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:e},(g,u)=>`<div onclick="appsOpenLightbox(_appsLbItems,${u})" style="width:7px;height:7px;border-radius:50%;background:${u===z?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${d}
    </div>`}function J(t,o){const e=t||"Video";return`<span class="${"apps-media-badge"+(o==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${e}</span></span>`}function S(t,o,e,n,i){const r=i?J("Video"):"",s=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${e},${n})">
    ...
    ${s}
      ...
      </div>`:`<button type="button" class="apps-story-primary" onclick="handleInstallFrontdesk()">${E}</button>`,B=s!=="#"?'<button type="button" class="apps-story-secondary" onclick="openGuestBookingEngine({focusInstall:true})">Go to direct booking page</button>':'<div class="apps-story-domain-note">Your direct booking domain is still setting up. Once it is ready, guests install from that page.</div>',$="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",D=e?$+"background:#fff;border:1px solid var(--border);padding:0;":$,j=e?`<img src="${e}" alt="Hotel logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,y=`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${a(A)},0)" style="margin-bottom:12px;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how guests install (1 min)</span></button>
        ...
        <div class="apps-q-list">
          ...
          ${S("How guests add your hotel","",a(A),0,!0)}
          ${S("Guest texts you, you text back","",a(b),0,!0)}
          ${S("Your app and theirs — side by side","",a(g),0,!1)}
        </div>
        ${r!=="#"?`<button onclick="window.open('${r}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,q=Z=>`
    ...
    ${G}
    ${f}
    ${p?nt:X()}`,at=p?"Front Desk is installed. Guests can install your hotel from the direct booking page.":"Install Front Desk first. Then guests can install your hotel from the direct booking page.";t.innerHTML=`
  <style>
  ...
  <div class="apps-page">
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),U()}async function U(){const t=document.getElementById("guestInstallStats");try{const o=await api("GET","/api/crm/guest-install-stats");if(!o.success)throw new Error(o.message||"Failed");if(guestPushSubscriberCount=o.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const e=o.totals||{},n=o.installedBookings||0,i=e.views||0;if(!n&&!i){t.style.display="none",t.innerHTML="";return}t.style.display="block";const r=o.installRatePercent!=null?o.installRatePercent:0,s=Object.entries(o.byTouchpoint||{}).filter(function(d){return d[1].views||d[1].installed}).sort(function(d,g){return(g[1].installed||0)-(d[1].installed||0)}).slice(0,5),a=s.length?s.map(function(d){const g=d[0].replace(/-/g," "),u=d[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+g+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(u.views||0)+" views · "+(u.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+r+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+n+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div>'+(a?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+a:"")}catch{guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}let F=[],x=0,O=!1;function et(){const t=document.getElementById("appsTourLightbox");t&&t.remove();const o=document.getElementById("appsTourTooltip");o&&o.remove(),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(e=>{e.style.position=e.dataset.appsTourOrigPosition||"",e.style.zIndex=e.dataset.appsTourOrigZIndex||"",e.style.isolation=e.dataset.appsTourOrigIsolation||"",e.style.boxShadow=e.dataset.appsTourOrigBoxShadow||"",e.style.outline=e.dataset.appsTourOrigOutline||"",e.style.outlineOffset=e.dataset.appsTourOrigOutlineOffset||"",e.removeAttribute("data-apps-tour-highlighted"),delete e.dataset.appsTourOrigPosition,delete e.dataset.appsTourOrigZIndex,delete e.dataset.appsTourOrigIsolation,delete e.dataset.appsTourOrigBoxShadow,delete e.dataset.appsTourOrigOutline,delete e.dataset.appsTourOrigOutlineOffset})}function m(t){et(),document.body.style.overflow="";const o=O;O=!1;try{const e=typeof N=="function"?N:window.ensureAppsViewRendered;typeof e=="function"&&e(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),o||localStorage.getItem("settingsTourStep")==="handoff"||l.settingsTourActive)){const n=typeof showFinaleMockModal=="function"?showFinaleMockModal:window.showFinaleMockModal;if(typeof n=="function"){n();return}}}function ct(t){const o=x+t;o<0||o>=F.length||(x=o,_())}function Y(){if(localStorage.setItem("appsTourDone","1"),O||localStorage.getItem("settingsTourStep")==="handoff"||l.settingsTourActive){l.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const o=typeof finishTourHydration=="function"?finishTourHydration:window.finishTourHydration;typeof o=="function"&&o()}}function gt(){Y();const t=typeof goLive=="function"?goLive:window.goLive;if(m(!1),typeof t=="function"){t();return}const o=typeof toast=="function"?toast:window.toast;typeof o=="function"&&o("Open Go live to activate your booking page.","error")}function ut(){if(l.hotelSubscribed||document.getElementById("guestAppActivationOverlay"))return;const t=document.createElement("div");if(t.id="guestAppActivationOverlay",t.style.cssText="position:fixed;inset:0;z-index:100004;background:rgba(0,0,0,0.68);display:flex;align-items:center;justify-content:center;padding:24px 16px;box-sizing:border-box;",t.innerHTML=`
    <div style="background:white;border-radius:20px;max-width:360px;width:100%;max-height:calc(100vh - 48px);overflow-y:auto;box-shadow:0 22px 64px rgba(0,0,0,0.32);animation:tourModalSlideUp 0.3s ease;">
    ...
    </div>`,document.body.appendChild(t),document.body.style.overflow="hidden",!document.getElementById("tourModalAnimStyle")){const e=document.createElement("style");e.id="tourModalAnimStyle",e.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(e)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{t.remove(),document.body.style.overflow=""};document.getElementById("guestAppActivateNowBtn").onclick=()=>{o();const e=typeof goLive=="function"?goLive:window.goLive;if(typeof e=="function"){e();return}const n=typeof toast=="function"?toast:window.toast;typeof n=="function"&&n("Open Go live to activate your booking page.","error")},document.getElementById("guestAppActivateLaterBtn").onclick=o}function _(){const t=F[x];if(!t){m(!0);return}const o=F.length,e=x>=o-1,n=`${x+1} / ${o}`,i=document.querySelector(t.target);if(!i){x++,_();return}et();let r=document.createElement("div");r.id="appsTourLightbox",r.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(0,0,0,0.52);pointer-events:auto;",document.body.appendChild(r),i.dataset.appsTourOrigPosition=i.style.position||"",i.dataset.appsTourOrigZIndex=i.style.zIndex||"",i.dataset.appsTourOrigIsolation=i.style.isolation||"",i.dataset.appsTourOrigBoxShadow=i.style.boxShadow||"",i.dataset.appsTourOrigOutline=i.style.outline||"",i.dataset.appsTourOrigOutlineOffset=i.style.outlineOffset||"",i.style.position=i.style.position||"relative",i.style.zIndex="100002",i.style.isolation="isolate",i.style.boxShadow="0 14px 38px rgba(0,0,0,0.24)",i.style.outline="4px solid #2E7D5B",i.style.outlineOffset="5px",i.setAttribute("data-apps-tour-highlighted","1");const s=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,d=a&&t.mobileScrollBlock||t.scrollBlock||"center",g=s?"auto":"smooth";if(a&&t.mobileScrollToBottom){const b=Math.max(document.documentElement?document.documentElement.scrollHeight:0,document.body?document.body.scrollHeight:0);window.scrollTo({top:b,behavior:g}),setTimeout(()=>{window.scrollTo({top:b,behavior:"auto"})},g==="smooth"?520:0)}else i.scrollIntoView({behavior:g,block:d});const u=()=>{const b=document.getElementById("appsTourTooltip");b&&b.remove();const p=i.getBoundingClientRect(),w=Math.min(330,window.innerWidth-28),Q=p.left+p.width/2,E=Math.max(14,Math.min(Q-w/2,window.innerWidth-w-14)),k=a&&t.mobileTooltipAnchor||t.tooltipAnchor||"bottom",I=a&&t.mobileTooltipPosition||t.tooltipPosition||"",B=p.top,$=k==="top"?p.top:p.bottom,D=t.primaryLabel||(e?"Done":"Next"),j=t.secondaryLabel||(e?"Not now":"Skip tour"),h=document.createElement("div");h.id="appsTourTooltip",h.style.cssText=`position:fixed;z-index:100003;left:${E}px;top:14px;width:${w}px;max-width:${w}px;visibility:hidden;`,h.innerHTML=`
      <div style="background:#111827;color:#fff;border-radius:14px;padding:15px 16px;box-shadow:0 18px 46px rgba(0,0,0,0.32);max-height:calc(100vh - 28px);overflow-y:auto;">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:8px;">
          <div style="font-size:11px;color:rgba(255,255,255,0.54);font-weight:800;letter-spacing:0.8px;text-transform:uppercase;">${n}</div>
      ...
      </div>`,document.body.appendChild(h);const y=12,v=Math.min(h.offsetHeight||176,Math.max(120,window.innerHeight-28)),T=window.innerHeight-$,H=B;let f=I==="below"||!I&&T>=v+y+14;I==="above"&&(f=!1),f&&T<v+y+14&&H>T&&(f=!1),!f&&H<v+y+14&&T>H&&(f=!0);const G=f?$+y:B-v-y,C=Math.max(14,window.innerHeight-v-14),q=Math.max(14,Math.min(G,C));h.style.top=`${q}px`,h.style.visibility="visible",document.getElementById("appsTourNextBtn").onclick=()=>{if(t.activateOnNext){gt();return}if(e){Y(),m(!1),t.showActivationOnComplete&&ut();return}x++,_()},document.getElementById("appsTourSkipBtn").onclick=()=>{if(e){Y(),m(!1);return}m(!0)}},A=a&&t.mobileScrollToBottom?s?80:680:s?40:320;setTimeout(u,A)}function ht(t){const o=t&&t.replay,e=t&&t.chainFromSettingsTour;if(!o&&!e&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;W(),m(!1),O=!!e;const n=!!l.hotelSubscribed;F=[{target:"#tour-apps-headline",title:"This is the whole idea.",text:"Your hotel can live on your guest's home screen. That is the value of this page."},{target:"#tour-apps-first",title:"First: install Front Desk.",text:"Front Desk is this website saved to your property phone. This is how you get booking alerts and guest messages."},{target:"#tour-apps-then",title:"Then: send guests to your booking page.",text:"When guests are booking, the Install button is at the bottom of the page. They tap it and your hotel is on their phone."},{target:"#tour-apps-after",title:"After that, the loop is clear.",text:"Guests tap your hotel icon to book or message you. New bookings and messages come back here in Front Desk."},{target:"#tour-guest-icon-section",title:"This is the one setup item.",text:"Guests see this icon on their home screen. Uploading the picture unlocks after Front Desk is installed.",mobileScrollToBottom:!0,mobileScrollBlock:"end",mobileTooltipAnchor:"top",mobileTooltipPosition:"above"},{target:"#tour-apps-loop",title:n?"This loop is on.":"Turn this on for your property.",text:n?"Guests can book direct, save your hotel, and message you. Front Desk gets the alerts.":"Activate once. Guests can book direct, save your hotel to their home screen, and Front Desk gets the alerts.",primaryLabel:n?"Done":"Continue to activation",secondaryLabel:n?"Close":"Not now",showActivationOnComplete:!n}],x=0,_()}const ft={appsCloseLightbox:W,appsCloudinaryFull:K,appsCloudinaryImg:R,appsLbNav:M,appsLbRender:V,appsOpenLightbox:dt,appsPhoneImgStyle:P,appsQuestionRow:S,appsTourClose:m,appsTourNav:ct,appsTourRender:_,appsVideoBadgeHtml:J,detectAppPlatform:lt,ensureAppsViewRendered:N,loadGuestInstallStats:U,renderAppsView:tt,startAppsTour:ht};function mt(){rt(ft)}export{ft as default,mt as install};
