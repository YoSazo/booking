 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Lt=["svg",h,[["line",{x1:"4",x2:"20",y1:"9",y2:"9"}],["line",{x1:"4",x2:"20",y1:"15",y2:"15"}],["line",{x1:"10",x2:"8",y1:"3",y2:"21"}],["line",{x1:"16",x2:"14",y1:"3",y2:"21"}]]];/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $t=["svg",h,[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"}]]];/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${t}]`);if(Array.from(i).forEach(n=>De(n,{nameAttr:t,icons:e,attrs:o})),t==="data-lucide"){const n=document.querySelectorAll("[icon-name]");n.length>0&&Array.from(n).forEach(r=>De(r,{nameAttr:"icon-name",icons:e,attrs:o}))}},so={ArrowUpRight:ht,Ban:yt,Bed:vt,Bell:bt,Calendar:wt,Camera:kt,CircleAlert:Tt,CircleCheck:It,ClipboardList:Ct,Hash:Lt,House:$t,Image:Dt,Info:Ht,Lock:qt,MessageCircle:jt,Moon:Ut,Phone:Gt,Play:_t,Undo2:oo,Bath:xt,Car:Et,Check:St,ChevronLeft:Bt,ChevronRight:At,CookingPot:zt,CopyCheck:Mt,DoorOpen:Pt,Ellipsis:Rt,Globe:Ot,Inbox:Ft,Laptop:Nt,PawPrint:Vt,QrCode:Wt,Rocket:Yt,Share:Jt,Shirt:Kt,Smartphone:Qt,Sparkles:Zt,SquarePlus:Xt,ThermometerSnowflake:eo,Tv:to,Waves:io,Wifi:no,Wind:ro};window.lucide={createIcons(e={}){ao({...e,icons:so})}};function Bi(){return Promise.resolve()}async function lo(e){if(!e||!e.type.startsWith("image/")||e.type==="image/webp"&&e.size<4e5)return e;try{const t=await createImageBitmap(e),o=1600,i=1200;let n=t.width,r=t.height;const a=Math.min(1,o/n,i/r);n=Math.round(n*a),r=Math.round(r*a);const s=document.createElement("canvas");s.width=n,s.height=r,s.getContext("2d").drawImage(t,0,0,n,r),t.close();const l=await new Promise((y,v)=>{s.toBlob(S=>S?y(S):v(new Error("encode failed")),"image/webp",.82)}),g=(e.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([l],g+".webp",{type:"image/webp"})}catch{return e}}function Ai(){const e=()=>{d.currentFilter==="apps"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}const co=["cancelled","canceled","released"];function Ti(e){return e?co.includes(String(e.status||"").trim().toLowerCase()):!0}function po(e){Object.assign(window,e)}const uo=14,go=10;function be(e,t,o){return Math.max(t,Math.min(e,o))}function R(e,t,o,i){return{left:e,top:t,width:o,height:i,right:e+o,bottom:t+i}}function mo(){const e=window.visualViewport,t=e?e.offsetLeft:0,o=e?e.offsetTop:0,i=e?e.width:window.innerWidth,n=e?e.height:window.innerHeight;return R(t,o,i,n)}function D(e){if(!e||!e.isConnected)return null;const t=e.getBoundingClientRect();return t.width<2||t.height<2?null:R(t.left,t.top,t.width,t.height)}function fo(e,t){if(!e||!t)return 0;const o=Math.max(0,Math.min(e.right,t.right)-Math.max(e.left,t.left)),i=Math.max(0,Math.min(e.bottom,t.bottom)-Math.max(e.top,t.top));return o*i}function ho(e,t){return Math.max(0,t.left-e.left)+Math.max(0,e.right-t.right)+Math.max(0,t.top-e.top)+Math.max(0,e.bottom-t.bottom)}function yo(e,t){let o=0;for(const i of t||[]){const n=document.querySelector(i);if(!n||getComputedStyle(n).display==="none")continue;const r=D(n);!r||r.bottom<e.bottom-2||r.top>=e.bottom||(o=Math.max(o,e.bottom-r.top))}return o}function xo(e){const t=mo(),o=e.margin??uo,i=Math.max(Number(e.bottomInset||0),yo(t,e.avoidBottomSelectors)),n=t.left+o+Number(e.leftInset||0),r=t.top+o+Number(e.topInset||0),a=t.right-o-Number(e.rightInset||0),s=t.bottom-o-i;return R(n,r,Math.max(1,a-n),Math.max(1,s-r))}function vo(e){return e==="above"||e==="top"?["top","bottom","right","left"]:e==="right"?["right","left","bottom","top"]:e==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function bo(e,t,o,i,n){return e==="top"?R(t.left+(t.width-o)/2,t.top-i-n,o,i):e==="right"?R(t.right+n,t.top+(t.height-i)/2,o,i):e==="left"?R(t.left-o-n,t.top+(t.height-i)/2,o,i):R(t.left+(t.width-o)/2,t.bottom+n,o,i)}function wo(e,t){const o=be(e.left,t.left,Math.max(t.left,t.right-e.width)),i=be(e.top,t.top,Math.max(t.top,t.bottom-e.height));return R(o,i,e.width,e.height)}function ko(e){let t=e&&e.parentElement;for(;t&&t!==document.body&&t!==document.documentElement;){const o=getComputedStyle(t),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&t.scrollHeight>t.clientHeight+1)return t;t=t.parentElement}return null}function Eo(e,t){if(!e||Math.abs(t)<1)return!1;const o=ko(e);return o?o.scrollTop+=t:window.scrollBy({top:t,left:0,behavior:"auto"}),!0}function ye(e,t){const o=D(e);if(!o||t.height<60)return!1;let i;return o.height<=t.height?i=be(o.top,t.top,t.bottom-o.height):i=t.bottom-o.height,Eo(e,o.top-i)}function Ue(e,t){const o=getComputedStyle(e);for(const r of o)t.style.setProperty(r,o.getPropertyValue(r),o.getPropertyPriority(r));const i=e.children,n=t.children;for(let r=0;r<i.length;r+=1)n[r]&&Ue(i[r],n[r])}function So(e){e.removeAttribute("id"),e.querySelectorAll("[id]").forEach(t=>t.removeAttribute("id"))}function Bo(e,t){const o=e.querySelectorAll("input, textarea, select"),i=t.querySelectorAll("input, textarea, select");o.forEach((n,r)=>{const a=i[r];a&&(n.type==="checkbox"||n.type==="radio"?a.checked=n.checked:a.value=n.value)})}function Ao(e,t={}){if(!e||!e.isConnected||t.disabled||!D(e))return null;const i=e.cloneNode(!0);So(i),Ue(e,i),Bo(e,i),i.setAttribute(t.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(t.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",t.prepareClone?.(i,e);const n=e.style.visibility;t.hideSource&&(e.style.visibility="hidden"),document.body.appendChild(i);const r=()=>{const s=D(e);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),t.hideSource&&(e.style.visibility=n)};return r(),{element:i,source:e,update:r,destroy:a}}function To({tooltip:e,panel:t,target:o,anchor:i,spotlight:n,options:r={}}){if(!e||!t||!o)return null;let a=0,s=!1,l=!1,g=!1,y="";const v=(c=!0)=>{if(s||!e.isConnected||!o.isConnected)return null;const u=xo(r),k=`${u.left}:${u.top}:${u.width}:${u.height}`;y&&y!==k&&(l=!1,c=!0),y=k;const p=D(i)||D(o),f=D(o);if(!p||!f)return null;const x=Math.min(Number(r.maxWidth||380),u.width);e.style.position="fixed",e.style.right="auto",e.style.bottom="auto",e.style.width=`${x}px`,e.style.maxWidth=`${x}px`,e.style.margin="0",e.style.justifyContent="flex-start",t.style.maxHeight=`${Math.max(120,u.height)}px`;const b=Math.min(t.offsetHeight||e.offsetHeight||190,u.height),w=Number(r.gap??go);c&&!l&&r.autoScroll!==!1&&f.height+b+w<=u.height&&(l=ye(o,u),l&&requestAnimationFrame(()=>v(!1)));const E=vo(r.preferredPlacement).map((I,L)=>{const J=bo(I,p,x,b,w),Le=ho(J,u),$e=fo(J,f);return{placement:I,index:L,raw:J,overflow:Le,overlap:$e,score:Le*1e5+$e*100+L}}),T=E.find(I=>I.overflow<.5&&I.overlap<1),A=T||E.slice().sort((I,L)=>I.score-L.score)[0],z=r.forceDock===!0||!T;let P="floating",F;if(z){P="docked";const I=Math.min(b,Number(r.dockMaxHeight||Math.max(180,u.height*.42)),u.height);t.style.maxHeight=`${I}px`;const L=Math.min(t.offsetHeight||I,I);if(F=R(u.left+(u.width-x)/2,u.bottom-L,x,L),c&&!l&&r.autoScroll!==!1){const J=R(u.left,u.top,u.width,Math.max(60,F.top-w-u.top));l=ye(o,J),l&&requestAnimationFrame(()=>v(!1))}}else if(F=wo(A.raw,u),c&&!l&&r.autoScroll!==!1){let I=u;if(A.placement==="bottom")I=R(u.left,u.top,u.width,Math.max(60,F.top-w-u.top));else if(A.placement==="top"){const L=F.bottom+w;I=R(u.left,L,u.width,Math.max(60,u.bottom-L))}l=ye(o,I),l&&requestAnimationFrame(()=>v(!1))}return e.dataset.tourLayoutMode=P,e.dataset.tourPlacement=z?"bottom-dock":A.placement,e.style.left=`${F.left}px`,e.style.top=`${F.top}px`,n?.update?.(),r.onLayout?.({mode:P,placement:e.dataset.tourPlacement,viewport:u,targetRect:D(o),anchorRect:D(i)||D(o),tooltipRect:F}),{mode:P,placement:e.dataset.tourPlacement,rect:F}},S=(c=!1)=>{g=g||c===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const u=g;g=!1,v(u)}))},C=()=>{l=!1,S(!0)},G=typeof ResizeObserver=="function"?new ResizeObserver(S):null;G?.observe(o),i&&i!==o&&G?.observe(i),G?.observe(t),window.addEventListener("resize",C),window.addEventListener("orientationchange",C),window.addEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",C),window.visualViewport.addEventListener("scroll",S));const he=()=>{s=!0,a&&cancelAnimationFrame(a),G?.disconnect(),window.removeEventListener("resize",C),window.removeEventListener("orientationchange",C),window.removeEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",C),window.visualViewport.removeEventListener("scroll",S))},m=v(!0);return{destroy:he,reposition:()=>v(!1),result:m}}function V(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function ae(...e){return V("setFilter")?.(...e)}function Fe(...e){return V("setBookingsSubview")?.(...e)}function Io(...e){return V("toast")?.(...e)}function se(...e){return V("updateGoLiveBanner")?.(...e)}function Co(...e){return V("seedTourRevenueShell")?.(...e)}function zo(...e){return V("finishTourHydration")?.(...e)}function Mo(...e){return V("goLive")?.(...e)}let X=null,de=null,W=null;function j(){if(document.getElementById("frontdeskTourPolishStyle"))return;const e=document.createElement("style");e.id="frontdeskTourPolishStyle",e.textContent=`
  ...
  `,document.head.appendChild(e)}function Ae(){X&&(document.removeEventListener("keydown",X),X=null)}function Po(e){Ae(),X=t=>{if(t.defaultPrevented)return;const o=t.target&&t.target.tagName?t.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||t.target?.isContentEditable||(t.key==="Escape"?(t.preventDefault(),e.onSkip?.()):t.key==="Enter"||t.key==="ArrowRight"?(t.preventDefault(),e.onNext?.()):t.key==="ArrowLeft"&&(t.preventDefault(),e.onBack?.()))},document.addEventListener("keydown",X)}function xe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function $(e){j();const t=e||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=t.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=t.blockPointer?"auto":"none",t.lockScroll&&(document.body.style.overflow="hidden"),o}const oe="rgba(17,24,39,0.42)";function K(){const e=document.getElementById("tourTooltip"),t=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!e||t)return Promise.resolve();e.style.pointerEvents="none";const o=e.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function Ro(e,t){return W?.destroy(),W=Ao(e,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=t?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=t?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=t?.spotlightOutlineOffset??"2px",t?.spotlightBackground&&(o.style.background=t.spotlightBackground,o.style.backgroundColor=t.spotlightBackground),t?.spotlightBorderRadius&&(o.style.borderRadius=t.spotlightBorderRadius)}}),W?.element||null}function H(e){const t=e||{};Ae(),de?.destroy(),de=null,W?.destroy(),W=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!t.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(r=>r.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(r=>{r.style.position=r.dataset.tourOrigPosition||"",r.style.zIndex=r.dataset.tourOrigZIndex||"",r.style.isolation=r.dataset.tourOrigIsolation||"",r.style.boxShadow=r.dataset.tourOrigBoxShadow||"",r.style.outline=r.dataset.tourOrigOutline||"",r.style.outlineOffset=r.dataset.tourOrigOutlineOffset||"",r.style.transition=r.dataset.tourOrigTransition||"",r.style.borderRadius=r.dataset.tourOrigBorderRadius||"",r.style.opacity=r.dataset.tourOrigOpacity||"";const a=r.dataset.tourOrigBackground||"",s=r.dataset.tourOrigBackgroundColor||"";s?r.style.backgroundColor=s:r.style.removeProperty("background-color"),a?r.style.background=a:r.style.removeProperty("background"),r.removeAttribute("data-tour-highlighted"),delete r.dataset.tourOrigPosition,delete r.dataset.tourOrigZIndex,delete r.dataset.tourOrigIsolation,delete r.dataset.tourOrigBoxShadow,delete r.dataset.tourOrigOutline,delete r.dataset.tourOrigOutlineOffset,delete r.dataset.tourOrigTransition,delete r.dataset.tourOrigBackground,delete r.dataset.tourOrigBackgroundColor,delete r.dataset.tourOrigBorderRadius,delete r.dataset.tourOrigOpacity});const n=document.getElementById("goLiveBanner");n&&n.dataset.tourHidden&&(delete n.dataset.tourHidden,typeof se=="function"&&se()),t.keepOverlay||(document.body.style.overflow="")}function Oo(){const e=document.getElementById("tourTooltip"),t=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[e,...t,...o].filter(Boolean);return!i.length&&!o.length?(H({keepOverlay:!0}),Promise.resolve()):(Ae(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(H({keepOverlay:!0}),Promise.resolve()):(e&&(e.style.pointerEvents="none"),i.forEach(r=>{r.style.transition="opacity 0.07s ease, transform 0.07s ease",r.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(r=>{r.style.opacity="0",r.id==="tourTooltip"&&(r.style.transform="translateY(4px)")})}),new Promise(r=>{setTimeout(()=>{H({keepOverlay:!0}),r()},85)})))}function Lo(e){const t=[e,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);t.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{t.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function _(e,t){if(!t.openAccordion)return;const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const r=o.querySelector(".accordion-arrow");r&&(r.style.transform="rotate(90deg)")}}function U(e){if(!e)return null;for(const t of String(e).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(t);if(o&&o.isConnected)return o}return null}function Q(e,t){if(t.highlightSelector){const o=U(t.highlightSelector);if(o)return o}if(t.highlightCard){const o=t.accordionCard?document.querySelector(t.accordionCard):e&&e.closest?e.closest(".booking-card"):null;if(o)return o}return t.targetParent&&(e.closest(".booking-card")||e.closest(".accordion-body"))||e}function ie(e,t){if(!t)return e;const o=String(t.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const n=document.querySelector(i);if(n&&n.isConnected)return n}if(t.accordionCard){const i=document.querySelector(t.accordionCard);if(i&&i.isConnected)return i}return e&&e.isConnected?e:null}function le(e,t){if(!e||!e.isConnected)return null;const o=e.getBoundingClientRect();return o.width<2||o.height<2||!t&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Ve(e,t){const o=U(e.anchorSelector);if(o){const i=le(o,!0);if(i)return i}return le(t,!0)}function He(e,t){const o=e.tooltipAnchorSelector||e.anchorSelector,i=U(o);if(i){const n=le(i,!0);if(n)return n}return Ve(e,t)}function ce(e){const t=e||"auto";try{window.scrollTo({top:0,left:0,behavior:t})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const n=document.querySelector(i);n&&(n.scrollTop=0)})}function Ge(e,t,o){const i=o||{},n=t.scrollTarget||t.accordionCard,r=(n?U(n):null)||e;if(!r&&!t.scrollToTop)return Promise.resolve();const a=t.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,l=i.smooth&&!s?"smooth":d.settingsTourActive||s?"auto":"smooth";return new Promise(g=>{if(t.scrollToTop&&(ce(l),t.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{t.forcePageTop&&ce("auto"),g()}));return}if(!r){g();return}if(r.scrollIntoView({behavior:l,block:a,inline:"nearest"}),l==="auto"){requestAnimationFrame(()=>requestAnimationFrame(g));return}let y=!1;const v=()=>{y||(y=!0,window.removeEventListener("scrollend",S),clearTimeout(C),requestAnimationFrame(()=>requestAnimationFrame(g)))},S=()=>v();"onscrollend"in window&&window.addEventListener("scrollend",S,{once:!0});const C=setTimeout(v,520)})}function _e(){H(),localStorage.setItem("settingsTourStep","handoff");const e=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&ae("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const n=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof n=="function"&&n({chainFromSettingsTour:!0})},t=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof t=="function"?t().then(e).catch(e):e()}function Z(){H({keepOverlay:!0}),j(),d.settingsTourActive=!1,se(),$({blockPointer:!0,lockScroll:!0,dim:oe});const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(A),!document.getElementById("tourModalAnimStyle")){const z=document.createElement("style");z.id="tourModalAnimStyle",z.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(z)}document.getElementById("tourNextBtn").onclick=()=>{K().then(()=>{n({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),l()})},document.getElementById("tourSkipBtn").onclick=()=>{r()}}function G(){j(),$({blockPointer:!0,lockScroll:!0,dim:oe});let m=0;const c=[`<div style="padding:20px 18px 0;">
    ...
    `,t?.subscribed&&!O()&&(g+=`
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=t}document.body.appendChild(e),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function pe(){const e=document.getElementById("postActivationTourTooltip");e&&e.remove();const t=document.getElementById("postActivationTourOverlay");t&&t.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function re(){pe(),localStorage.setItem("postActivationTourDone","1");const e=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",e)}catch{}}function tt(){if(localStorage.getItem("postActivationTourDone")){re();return}pe();const e=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. Once the Front Desk app is connected, new bookings can alert you even when it is closed."},{tab:"apps",navFilter:"apps",text:"<strong>Last step: open Guestel.</strong> Share the Guestel QR, see your property card, reply to verified guests, and send updates to guests who opt in."}];let t=0;function o(){if(pe(),t>=e.length){re();return}const i=e[t],n=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);n&&setFilter(i.tab,n);const r=document.createElement("div");r.id="postActivationTourOverlay",r.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(r),document.body.style.overflow="hidden",setTimeout(()=>{const a=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);a&&(a.setAttribute("data-post-activation-highlight","1"),a.style.position="relative",a.style.zIndex="100003",a.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",a.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const s=a?a.getBoundingClientRect():{left:24,bottom:80,width:200},l=document.createElement("div");l.id="postActivationTourTooltip";const g=Math.min(300,window.innerWidth-32),y=Math.max(16,Math.min(s.left+s.width/2-g/2,window.innerWidth-g-16)),v=Math.min(s.bottom+14,window.innerHeight-180);l.style.cssText=`position:fixed;z-index:100004;left:${y}px;top:${v}px;max-width:${g}px;width:${g}px;`;const S=t>=e.length-1;l.innerHTML=`
  ...
  `,document.body.appendChild(n);const r=()=>{n.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}};document.getElementById("activatedModalContinueWeb")?.addEventListener("click",r),document.getElementById("activatedModalContinueWebPrimary")?.addEventListener("click",r)}async function Qo(){if(isEditPageDomReady())return;if(d.editRoomsLoadPromise)return d.editRoomsLoadPromise;const e=document.getElementById("editRoomsList");if(e){d.editRoomsLoadPromise=(async()=>{e.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[t,o,i]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify"),O()?api("GET","/api/crm/account-deletion/status").catch(()=>null):Promise.resolve(null)]);if(!t.rooms)throw new Error("No data");d.editRooms=t.rooms;const n=o?.hotelName||"";n&&(d.activeHotelName=n),o&&(d.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const r=o?.hotelSubtitle||"",a=o?.hotelAddress||"",s=o?.hotelPhone||"";ne={name:M(n),subtitle:M(r),address:M(a),phone:M(s),cancellationPolicy:M(o?.cancellationPolicy)};const l=o?.appIconUrl||"";d.activeHotelAppIcon=l,updateFrontdeskManifestLink();let g={nightly:69,weekly:299,monthly:999,taxRate:.1};t.rates&&(g=t.rates),d.editRates=g;const v="https://"+(o?.domain||d.activeHotelId+".mktel.co"),S=ge();let C=`
      ...
      ${ve("Change PIN",`
            <div style="margin-bottom:12px;">
              <input type="text" id="edit-new-pin" value="${d.isMasterPin||$o(d.token)?"":d.token}" placeholder="${d.isMasterPin?"Enter a unique property PIN":"Enter new PIN (min 6 chars)"}" style="width:100%;box-sizing:border-box;font-size:16px;padding:8px 10px;border-radius:8px;border:1.5px solid var(--border);font-family:inherit;outline:none;text-align:center;letter-spacing:2px;">
            </div>
    ...
    <div class="booking-card" style="margin-bottom:14px;" id="edit-card-${t.id}" ${o===0?'data-tour-room-card="1"':""}>
      ...
      <div class="room-edit-fields" style="padding:18px;">
        ...
        <div style="display:flex;gap:8px;">
          <button onclick="saveEditRoom('${t.id}')" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:white;font-family:inherit;font-size:14px;font-weight:700;cursor:pointer;">${ge()||d.hotelSubscribed?"Save &amp; see changes":"Save Changes"}</button>
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",ue),n=document.getElementById("amenityPickerModal"));const r=d.editRooms[0];r&&String(r.id)===String(e)?n.dataset.previewActionScope="first-room-editor":delete n.dataset.previewActionScope;const s=document.getElementById("amenityPickerGrid");s.innerHTML=Me.map(l=>{const g=i.some(y=>y.includes(l.key));return`<button onclick="toggleAmenityPreset(this,'${l.key}')" data-key="${l.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${g?"#2E7D5B":"#e5e7eb"};background:${g?"#E8F5EE":"white"};color:${g?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${l.icon}" style="width:14px;height:14px;"></i> ${l.label}</button>`}).join(""),Re(),n.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function ei(e,t){const o=e.style.borderColor==="rgb(46, 125, 91)";e.style.borderColor=o?"#e5e7eb":"#2E7D5B",e.style.background=o?"white":"#E8F5EE",e.style.color=o?"#1a1a2e":"#2E7D5B"}function ue(){fe(),document.getElementById("amenityPickerModal").style.display="none",Pe=null,N=[]}function ke(){const e=document.getElementById("amenityCustomModal");if(!e||e.style.display==="none")return;const t=window.visualViewport;e.style.top=`${Math.round(t?.offsetTop||0)}px`,e.style.height=`${Math.round(t?.height||window.innerHeight)}px`}function ti(){let e=document.getElementById("amenityCustomModal");return e||(document.body.insertAdjacentHTML("beforeend",`
    <div id="amenityCustomModal" style="display:none;position:fixed;left:0;right:0;top:0;height:100vh;background:rgba(0,0,0,0.42);z-index:10020;align-items:center;justify-content:center;padding:20px;box-sizing:border-box;">
    ...
    </div>`),e=document.getElementById("amenityCustomModal"),e.addEventListener("click",fe),window.visualViewport&&e.dataset.viewportBound!=="1"&&(e.dataset.viewportBound="1",window.visualViewport.addEventListener("resize",ke),window.visualViewport.addEventListener("scroll",ke)),e)}function oi(){const e=ti(),t=document.getElementById("amenityCustomInput");t&&(t.value=""),e.style.display="flex",ke(),requestAnimationFrame(()=>t?.focus({preventScroll:!0}))}function fe(){const e=document.getElementById("amenityCustomModal");e&&(document.getElementById("amenityCustomInput")?.blur(),e.style.display="none")}function ii(){const e=document.getElementById("amenityCustomInput"),t=String(e?.value||"").replace(/\s+/g," ").trim();t&&(N.some(o=>o.toLowerCase()===t.toLowerCase())||N.push(t),fe(),Re())}function ni(e){N.splice(Number(e),1),Re()}function ri(){const e=d.editRooms.find(i=>i.id===Pe);if(!e){ue();return}const t=document.getElementById("amenityPickerGrid"),o=[];t.querySelectorAll("button").forEach(i=>{if(i.style.background==="rgb(232, 245, 238)"){const n=Me.find(r=>r.key===i.dataset.key);n&&o.push(n.label)}}),o.push(...N),e.amenities=o.join(" • "),ue(),Ce(),typeof lucide<"u"&&lucide.createIcons()}function ai(e){rt(e)}function si(e,t){const o=d.editRooms.find(n=>n.id===e);if(!o)return;const i=(o.amenities||"").split("•").map(n=>n.trim()).filter(Boolean);o.amenities=i.filter(n=>n!==t).join(" • "),Ce(),typeof lucide<"u"&&lucide.createIcons()}async function di(e="header"){const t=document.getElementById("edit-hotel-name")?.value.trim(),o=document.getElementById("edit-hotel-subtitle")?.value.trim(),i=document.getElementById("edit-hotel-address")?.value.trim(),n=document.getElementById("edit-hotel-phone")?.value.trim(),r=document.getElementById("edit-hotel-policy")?.value.trim(),a={name:t,subtitle:o,address:i,phone:n},s=Object.keys(a).filter(g=>M(a[g])!==M(ne?.[g])),l=M(r)!==M(ne?.cancellationPolicy);try{if(await api("POST","/api/crm/hotel-info",{name:t,subtitle:o,address:i,phone:n,cancellationPolicy:r}),t&&(d.activeHotelName=t),toast(e==="policy"?"Checkout banner saved!":"Property info saved!","success"),ne={...Object.fromEntries(Object.entries(a).map(([g,y])=>[g,M(y)])),cancellationPolicy:M(r)},me(e==="policy"?"checkout-policy":"header",{hotelName:t||"",changedFields:e==="policy"?l?["cancellationPolicy"]:["checkout-policy"]:s.length?s:["header"]}),e==="header"){const g=new Set(["name","subtitle","address","phone"]),y=s.length===1&&g.has(s[0])?`header-${s[0]}`:"header";Y(y)}else e==="policy"&&Y("checkout-policy")}catch{toast("Failed to save","error")}}async function li(){const e=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,t=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:e,weekly:t,monthly:o}),localStorage.setItem("ratesChanged","1"),d.launchStatus=null,ee(),toast("Rates saved!","success"),Y("room",d.editRooms[0]?.id||"")}catch{toast("Failed to save rates","error")}}async function ci(){const e=document.getElementById("edit-new-pin")?.value.trim();if(!e||e.length<6){toast("PIN must be at least 6 characters","error");return}try{const t=await api("POST","/api/crm/change-pin",{newPin:e});if(!t.success)throw new Error(t.message||"Failed to change PIN");d.token=e,d.isMasterPin=!1,d.isDogfoodPreview=!1;try{localStorage.setItem("crmToken",d.token)}catch{}toast("PIN updated!","success")}catch(t){toast(t.message||"Failed to change PIN","error")}}function pi(e){navigator.clipboard.writeText(e).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function ve(e,t,{open:o=!1,hint:i="",id:n=""}={}){return`<div class="booking-card page-section" style="margin-bottom:14px;"${n?` id="${n}"`:""}>
