import{c,e as we}from"./settings-BjIgv-Fo.js";const ke="/frontdesk/assets/assistant-booking-request-DM4sqyhz.webp",Se="/frontdesk/assets/assistant-text-resolution-GXaNrbcO.webp",P="marketelValueRevealPendingV1",F="marketelValueRevealStepV1",le="marketelBillingIntervalV1";let i=0,p="guest",S={rooms:[],rates:null},T=null,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},V=!1,I=0,K=!1,k={1:0,2:0},z=0,B=0,y="month",s=null,X=!1,b=!1,G=!1,Y="confirm";function de(){const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e==="0.0.0.0"||e==="::1"||e.endsWith(".local")||/^10\./.test(e)||/^192\.168\./.test(e)||/^172\.(1[6-9]|2\d|3[01])\./.test(e)}function m(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ae(e){const t=Number(e);return Number.isFinite(t)?new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:Number.isInteger(t)?0:2}).format(t):"$99"}function g(){return c.activeHotelName||"Your Property"}function Z(){return S.rooms[0]||c.editRooms[0]||{name:"Your first room",totalUnits:1,images:[]}}function re(){const e=Z();return e.images?.[0]?.url||e.imageUrl||""}function ce(){const e=Number(S.rates?.nightly);if(!Number.isFinite(e)||e<=0)return null;const t=e*.15,a=Math.max(1,Math.ceil(199/t));return{rate:e,roomNights:a,savings:t*a}}function Ie(){const e=ce();if(!e)return`<div class="mvr-value-bridge is-proof-only">
  ...
  </div>`}function $(){if(de()&&c.activeHotelId){const a=new URL(window.location.href);return a.port="5173",a.pathname="/",a.search="",a.hash="",a.searchParams.set("hotelId",c.activeHotelId),a.searchParams.set("preview","1"),a.toString()}const e=n.domain||c.activeHotelDomain||"";if(!e)return"";const t=new URL(`https://${e}/`);return c.activeHotelId&&t.searchParams.set("hotelId",c.activeHotelId),t.searchParams.set("preview","1"),t.toString()}function N(){const e=String(n.domain||c.activeHotelDomain||"").trim().replace(/^https?:\/\//i,"").replace(/\/.*$/,"").toLowerCase();return e?e.endsWith(".bookmarketel.com")?e.replace(/\.bookmarketel\.com$/,".mktel.co"):e:`${g().normalize("NFKD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,50)||"your-property"}.mktel.co`}function ue(){const e=new URL(window.location.href);return e.search="",e.hash="",c.activeHotelId&&e.searchParams.set("hotelId",c.activeHotelId),e.searchParams.set("previewEditor","1"),e.toString()}function $e(){if(!c.hotelSubscribed)try{localStorage.setItem(P,"1"),localStorage.setItem(F,String(i))}catch{}}function v(e,t=""){typeof window.api=="function"&&window.api("POST","/api/crm/value-reveal-event",{eventName:e,contentName:t,...window.MarketelJourney?.linkage?.()||{}}).catch(()=>{})}function u(e,t={},a={}){return window.MarketelJourney?.track(e,{revealStep:i,stageName:["booking-page","guest-app","front-desk-assistant","activation"][i]||"unknown",...t},a)}function Re(){try{const e=new URL(window.location.href);e.searchParams.delete("welcome"),e.searchParams.delete("reveal"),window.history.replaceState({},"",e.pathname+e.search+e.hash)}catch{}}function me(e){typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(e)}function ve(e){return Math.max(0,Math.floor(Number(e||0)/1e3))}function Ae(e){return String(ve(e)).padStart(2,"0")}function ie(e){return`${ve(e)}s`}function x(e){e?.layer&&(e.layer.classList.remove("is-visible","is-prompt"),e.layer.setAttribute("aria-hidden","true"),e.layer.innerHTML="")}function R(e,t){const a=e?.querySelector("#mvrLiveActions");a&&(a.hidden=!t)}function W(e="",t=!1){const a=s;if(a){if(a.timerId&&(window.clearInterval(a.timerId),a.timerId=0),a.promptFallbackId&&(window.clearTimeout(a.promptFallbackId),a.promptFallbackId=0),a.promptDelayId&&(window.clearTimeout(a.promptDelayId),a.promptDelayId=0),t&&a.status==="running"){const o=Date.now()-a.startedAt;v("BookingChallengeAbandoned",e),u("JourneyBookingChallengeAbandoned",{reason:e,elapsedMs:o},{durationMs:o})}a.timer?.classList.remove("is-live"),a.status==="running"&&(a.status="abandoned"),x(a)}}function oe(e){if(!e||e.status!=="running"||!e.timer)return;const t=Date.now()-e.startedAt,a=e.timer.querySelector("[data-challenge-time]");a&&(a.textContent=Ae(t)),e.timer.classList.toggle("is-over-minute",t>=6e4)}function Be(e){!e||e!==s||e.status!=="prompted"||(e.status="running",e.startedAt=Date.now(),x(e),R(e.modal,!0),e.timer.classList.add("is-live"),oe(e),e.timerId=window.setInterval(()=>oe(e),500),v("BookingChallengeStarted"),u("JourneyBookingChallengeStarted",{targetSeconds:60,bookingDomain:N()}))}function Pe(e){!e||e!==s||e.hasPrompted||p!=="guest"||(e.hasPrompted=!0,e.status="prompted",e.promptFallbackId&&(window.clearTimeout(e.promptFallbackId),e.promptFallbackId=0),R(e.modal,!1),e.layer.innerHTML=`<section class="mvr-challenge-card mvr-challenge-intro" role="dialog" aria-labelledby="mvrChallengeTitle">
  ...
  </div>`}function Te(){return b||n.reason==="deployment-disabled"||V&&!n.ready?!1:!!$()}function Ce(){return Te()?`<div class="mvr-page-status is-ready"><span>✓</span>${n.reason==="local"?"Local guest preview connected":"Your live guest page is online"}</div>`:b?'<div class="mvr-page-status is-attention"><span>!</span>The live preview is still publishing. Your setup is saved, so you can continue without waiting.</div>':n.reason==="deployment-disabled"?'<div class="mvr-page-status is-attention"><span>!</span>Your live page deployment needs to be re-enabled. Your saved setup is safe.</div>':`<div class="mvr-page-status"><span class="mvr-status-pulse"></span>${n.checking?"Publishing your live guest page…":"Your personalized preview is ready while the live page finishes publishing."}</div>`}function Me(){const e=$();return`<div class="mvr-booking-preview-card">
    ...
    <div class="mvr-beat-stage">
      ${r.proof?`<figure class="mvr-beat-proof${d?" is-paired":""}">
        ${l.map((f,A)=>`<img class="mvr-beat-frame${A===0?" is-active":""}" src="${f.url}" width="780" height="1528" decoding="async" alt="${m(f.alt)}">`).join("")}
        ${d?`<span class="mvr-beat-frame-dots" aria-hidden="true">${l.map((f,A)=>`<i${A===0?' class="is-active"':""}></i>`).join("")}</span>`:""}
      </figure>`:`<div class="mvr-beat-settings">${r.render?r.render():""}</div>`}
    </div>
  </section>`}const Ve=850,Ge=2600;let q=0,C=0;function j(){q&&(window.clearInterval(q),q=0),C&&(window.clearTimeout(C),C=0)}function Ye(){j();const e=document.querySelector(".mvr-beat-proof.is-paired");if(!e)return;const t=[...e.querySelectorAll(".mvr-beat-frame")],a=[...e.querySelectorAll(".mvr-beat-frame-dots i")];if(t.length<2)return;let o=0;const r=()=>{if(!e.isConnected)return j();o=(o+1)%t.length,t.forEach((l,d)=>l.classList.toggle("is-active",d===o)),a.forEach((l,d)=>l.classList.toggle("is-active",d===o))};C=window.setTimeout(()=>{C=0,r(),q=window.setInterval(r,Ge)},Ve)}function ne(e,t=!1){const a=J();if(!a)return;const o=Math.max(0,Math.min(a.length-1,Number(e)||0));if(o===(k[i]||0)||(k[i]=o,w(),document.querySelector(".mvr-main")?.scrollTo({top:0,behavior:"auto"}),!t))return;const r=a[o];r.event&&v(r.event),u("JourneyRevealBeatViewed",{revealStep:i,beat:o})}function Je(){const e=Y==="release";return`<div class="mvr-fallback-control">
  ...
  </div>`}function Oe(){return he("mvr-stage-assistant","3 · The rest of Front Desk",fe(),k[2]||0)}function _e(){const e=c.hotelSubscribed,t=y==="year",a=t?"$1,990":"$199",o=t?"/year":"/month",r=t?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month",l=`<div class="mvr-value-list">
  ...
  </section>`}function Ue(){return i===0?Fe():i===1?xe():i===2?Oe():_e()}function We(){if(i===0)return!X&&!b?"":`<div class="mvr-footer mvr-footer-booking">
  ...
  </div>`}let O="",M=-1,_=-1;function w(){const e=document.getElementById("marketelValueReveal");if(!e)return;const t=`<div class="mvr-shell">
    <header class="mvr-header">
      <div class="mvr-brand"><img src="/marketellogo.svg" alt="Marketel"><span>Marketel</span></div>
      ${Le()}
    </header>
    <main class="mvr-main">${Ue()}</main>
    ${We()}
  </div>`;if(t===O&&e.firstElementChild)return;const a=k[i]||0,o=i!==M||a!==_;e.classList.toggle("mvr-no-enter",!o&&M!==-1),M=i,_=a,O=t,e.innerHTML=t,Xe()}function se(){const e=$();if(document.getElementById("mvrLivePreview"))return;if(!e){b=!0,u("JourneyBookingPreviewOpened",{mode:"unavailable",bookingPageReady:!1,bookingPageReason:n.reason||"missing-url"}),w();return}X=!0,p="guest";const t=Date.now(),a=document.createElement("div");a.id="mvrLivePreview",a.className="mvr-live-preview",a.innerHTML=`<div class="mvr-live-toolbar">
  ...
  </div>`,document.getElementById("marketelValueReveal")?.appendChild(a);const o=a.querySelector('[data-preview-frame="guest"]');window.setTimeout(()=>{const r=a.querySelector('[data-preview-frame="editor"]');!r?.isConnected||r.getAttribute("src")||(r.src=ue())},1200),s={modal:a,iframe:o,layer:a.querySelector(".mvr-challenge-layer"),timer:a.querySelector(".mvr-challenge-timer"),previewOpenedAt:t,status:"waiting",hasPrompted:!1,startedAt:0,timerId:0,promptFallbackId:0,promptDelayId:0},s.promptFallbackId=window.setTimeout(()=>{s?.modal!==a||s.status!=="waiting"||R(a,!0)},4e3),o?.addEventListener("load",()=>{const r=s;r?.modal!==a||p!=="guest"||(r.promptDelayId&&window.clearTimeout(r.promptDelayId),r.promptDelayId=window.setTimeout(()=>{r.promptDelayId=0,Pe(r)},1500))}),a.querySelector("#mvrClosePreview")?.addEventListener("click",()=>{u("JourneyBookingPreviewModeChanged",{action:"closed",mode:p},{durationMs:Date.now()-t}),W("preview-closed",!0),s=null,a.remove(),w()}),a.querySelector("#mvrContinueGuestApp")?.addEventListener("click",()=>{Ke(a,t,"continued-without-editor")}),a.querySelector("#mvrLiveForward")?.addEventListener("click",()=>{D(a,"edit",t,"guided-forward")}),a.querySelector("#mvrLiveBack")?.addEventListener("click",()=>{D(a,"guest",t,"returned-to-booking-page")}),v("BookingEngineFullPreviewOpened"),u("JourneyBookingPreviewOpened",{mode:"guest",bookingPageReady:!!n.ready,bookingPageReason:n.reason||""})}function Ke(e,t,a){e?.isConnected&&(u("JourneyRevealNavigation",{action:a,toStep:1,editorViewed:p==="edit"},{durationMs:Date.now()-t}),W("continued-to-guest-app",!1),s=null,e.remove(),U(1))}function ze(e,t){if(!e||!t)return;let a="";try{a=new URL(e.getAttribute("src")||"",window.location.href).toString()}catch{a=e.getAttribute("src")||""}a!==t&&(e.src=t)}function D(e,t,a,o="mode-selected"){if(!e?.isConnected)return;t==="edit"&&W("edit-mode-selected",!0),p=t==="edit"?"edit":"guest";const r=e.querySelector("#mvrLiveLocation"),l=e.querySelector("[data-live-location-text]"),d=e.querySelector("#mvrLiveForward"),f=e.querySelector("#mvrContinueGuestApp"),A=e.querySelector("#mvrLiveBack"),h=p==="edit";r?.classList.toggle("is-editor",h),l&&(l.textContent=h?"Front Desk editor":N()),r&&r.setAttribute("aria-label",h?"Front Desk editor":"Your live booking address");const be=!h&&String(o||"").startsWith("saved-"),ee=h||be;d&&(d.hidden=ee),f&&(f.hidden=!ee),A&&(A.hidden=!h),R(e,!0);const H=e.querySelector('[data-preview-frame="guest"]'),E=e.querySelector('[data-preview-frame="editor"]');if(H&&E){if(h)E.getAttribute("src")||(E.src=ue());else{const L=new URL($());if(e.dataset.editorSaved==="1"){L.searchParams.set("previewRefresh",String(Date.now()));const te=e.dataset.editorPreviewTarget==="checkout";L.searchParams.set("previewHighlight",te?"checkout-policy":e.dataset.editorHighlight||"header"),te?L.searchParams.set("previewCheckout","1"):e.dataset.editorHighlightRoom&&L.searchParams.set("previewHighlightRoom",e.dataset.editorHighlightRoom),delete e.dataset.editorSaved,delete e.dataset.editorHighlight,delete e.dataset.editorHighlightRoom,delete e.dataset.editorPreviewTarget}ze(H,L.toString())}H.hidden=h,E.hidden=!h,s?.modal===e&&(s.iframe=h?E:H)}u("JourneyBookingPreviewModeChanged",{action:o,mode:p},{durationMs:Date.now()-a}),p==="edit"&&v("BookingEngineEditPreviewViewed")}function U(e){const t=i,a=Math.max(0,Math.min(3,e)),o=Date.now();B&&a!==t&&u("JourneyRevealStageCompleted",{revealStep:t,stageName:["booking-page","guest-app","front-desk-assistant","activation"][t]||"unknown",nextStep:a,direction:a>t?"forward":"back"},{durationMs:o-B}),i=a,B=o,$e(),v(["BookingEngineRevealViewed","GuestAppRevealViewed","AssistantRevealViewed","ActivationOfferViewed"][i]),u("JourneyRevealStageViewed",{resumed:G,bookingPageReady:i===0?!!n.ready:void 0}),G=!1,w(),document.querySelector(".mvr-main")?.scrollTo({top:0,behavior:"auto"})}function je(){B&&u("JourneyRevealStageCompleted",{action:"reveal-finished",totalRevealMs:z?Date.now()-z:null},{durationMs:Date.now()-B}),I&&(window.clearTimeout(I),I=0),W("reveal-finished",!0),s=null,j(),O="",M=-1,_=-1,document.getElementById("marketelValueReveal")?.remove(),document.documentElement.classList.remove("marketel-reveal-open"),document.body.style.overflow="",window.removeEventListener("message",pe),c.settingsTourActive=!1;try{localStorage.removeItem(P),localStorage.removeItem(F),localStorage.setItem("settingsTourDone","1"),localStorage.setItem("onboardingDone","1")}catch{}Re(),me(!0),typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner(),typeof window.refreshGoLiveInlineCard=="function"&&window.refreshGoLiveInlineCard()}async function Qe(e){if(c.hotelSubscribed){je();return}if(typeof window.goLive=="function"){e.disabled=!0,e.textContent="Opening secure checkout…",v("ActivationCtaClicked");try{await window.goLive({billingInterval:y})}finally{document.body.contains(e)&&(e.disabled=!1,e.textContent=y==="year"?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month")}}}function Xe(){document.getElementById("mvrAskBeforeActivating")?.addEventListener("click",()=>{window.openMarketelSupport?.()}),document.getElementById("mvrNext")?.addEventListener("click",()=>{const e=J(),t=k[i]||0;if(e&&t<e.length-1){ne(t+1,!0);return}u("JourneyRevealNavigation",{action:"next",toStep:i+1}),U(i+1)}),document.getElementById("mvrBack")?.addEventListener("click",()=>{const e=J(),t=k[i]||0;if(e&&t>0){ne(t-1,!0);return}u("JourneyRevealNavigation",{action:"back",toStep:i-1}),U(i-1)}),document.getElementById("mvrExpandPreview")?.addEventListener("click",se),document.querySelector(".mvr-preview-teaser-veil")?.addEventListener("click",()=>{b||se()}),document.getElementById("mvrFinalCta")?.addEventListener("click",e=>Qe(e.currentTarget)),document.querySelectorAll("[data-mvr-billing]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.mvrBilling==="year"?"year":"month";if(t!==y){y=t;try{localStorage.setItem(le,y)}catch{}v(t==="year"?"YearlyBillingSelected":"MonthlyBillingSelected"),u("JourneyBillingIntervalSelected",{billingInterval:y,price:y==="year"?1990:199,currency:"USD"}),w()}})}),document.querySelectorAll("[data-mvr-fallback]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.mvrFallback==="release"?"release":"confirm";t!==Y&&(Y=t,v(t==="release"?"AssistantReleaseFallbackSelected":"AssistantKeepFallbackSelected"),u("JourneyAssistantFallbackSelected",{noResponseAction:t}),typeof window.api=="function"&&window.api("POST","/api/crm/booking-approval",{noResponseAction:t}).catch(()=>{}),w())})}),Ye()}async function Q(){return T||typeof window.api!="function"||(T=Promise.all([window.api("GET","/api/crm/rooms"),window.api("GET","/api/crm/booking-approval").catch(()=>null)]).then(([e,t])=>(S={rooms:Array.isArray(e?.rooms)?e.rooms:[],rates:e?.rates||null},Y=t?.data?.noResponseAction==="release"?"release":"confirm",S.rooms.length&&(c.editRooms=S.rooms),document.getElementById("marketelValueReveal")&&!document.getElementById("mvrLivePreview")&&w(),S)).catch(()=>S).finally(()=>{T=null})),T}async function ye(){if(!(typeof window.api!="function"||!document.getElementById("marketelValueReveal"))){if(de()){n={ready:!!$(),checking:!1,reason:"local",attempts:1,domain:""},V=!n.ready,$()&&(b=!1),u("JourneyBookingPageStatus",{ready:n.ready,reason:n.reason,attempts:n.attempts}),i===0&&!document.getElementById("mvrLivePreview")&&w();return}n.checking=!0,n.attempts+=1;try{const e=await window.api("GET","/api/crm/booking-page-status");n={ready:!!e?.ready,checking:!1,reason:String(e?.reason||""),attempts:n.attempts,domain:String(e?.domain||"")},V=!n.ready}catch{n.checking=!1,n.reason="unreachable"}$()&&(b=!1),u("JourneyBookingPageStatus",{ready:n.ready,reason:n.reason,attempts:n.attempts}),i===0&&!document.getElementById("mvrLivePreview")&&w(),!(n.ready||n.reason==="deployment-disabled")&&n.attempts<10&&document.getElementById("marketelValueReveal")&&(I=window.setTimeout(ye,6e3))}}async function Ze(e={}){if(document.getElementById("marketelValueReveal")||K)return;K=!0;let t=!1;if(!c.editRooms?.length&&typeof window.api=="function"&&(await Promise.race([Q(),new Promise(d=>{setTimeout(d,2500)})]),t=!0),K=!1,document.getElementById("marketelValueReveal"))return;const a=Number(e.startAt);let o=0,r=!1;try{o=Number.parseInt(localStorage.getItem(F)||"0",10)}catch{}try{r=localStorage.getItem(P)==="1"}catch{}try{y=localStorage.getItem(le)==="year"?"year":"month"}catch{y="month"}if(i=Number.isFinite(a)?Math.max(0,Math.min(3,a)):Math.max(0,Math.min(3,Number.isFinite(o)?o:0)),c.hotelSubscribed&&i===3&&(i=0),p="guest",k={1:0,2:0},X=!1,b=!1,O="",M=-1,_=-1,z=Date.now(),B=0,G=!Number.isFinite(a)&&r,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},V=!1,I&&window.clearTimeout(I),I=0,!c.hotelSubscribed)try{localStorage.setItem(P,"1"),localStorage.setItem(F,String(i))}catch{}try{localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep")}catch{}c.settingsTourActive=!0,window.addEventListener("message",pe),document.documentElement.classList.add("marketel-reveal-open"),document.body.style.overflow="hidden",me(!1);const l=document.createElement("div");l.id="marketelValueReveal",l.className="mvr-root",document.body.appendChild(l),w(),v("ValueRevealStarted",c.hotelSubscribed?"subscribed-replay":"pre-activation"),u("JourneyRevealStarted",{startStep:i,replay:!!c.hotelSubscribed,pendingResume:G}),U(i),t||Q(),ye()}function et(){try{return localStorage.getItem(P)==="1"}catch{return!1}}function tt(){try{localStorage.removeItem(P),localStorage.removeItem(F)}catch{}}const at={clearPendingMarketelValueReveal:tt,hasPendingMarketelValueReveal:et,showMarketelValueReveal:Ze};function it(){we(at)}export{tt as clearPendingMarketelValueReveal,at as default,et as hasPendingMarketelValueReveal,it as install,Ze as showMarketelValueReveal};
