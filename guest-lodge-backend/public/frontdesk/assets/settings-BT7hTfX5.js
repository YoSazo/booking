const l={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let Y=null;function ye(){return typeof lucide<"u"?Promise.resolve():Y||(Y=new Promise((t,e)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>t(),o.onerror=()=>e(new Error("lucide load failed")),document.head.appendChild(o)}),Y)}async function Lt(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let n=e.width,a=e.height;const r=Math.min(1,o/n,i/a);n=Math.round(n*r),a=Math.round(a*r);const s=document.createElement("canvas");s.width=n,s.height=a,s.getContext("2d").drawImage(e,0,0,n,a),e.close();const p=await new Promise((h,v)=>{s.toBlob(S=>S?h(S):v(new Error("encode failed")),"image/webp",.82)}),g=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([p],g+".webp",{type:"image/webp"})}catch{return t}}function he(){const t=()=>{l.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}function Ht(t){Object.assign(window,t)}async function ht(){const t=document.getElementById("settingsList");if(t){t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const e=await api("GET","/api/crm/verify"),i="https://"+(e?.domain||l.activeHotelId+".mktel.co"),n="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(i),a=await api("GET","/api/crm/rooms");let r={nightly:69,weekly:299,monthly:999};a?.rates&&(r=a.rates);const s=a?.rooms||[];let p="";e?.subscribed||(p+=goLiveInlineCardHtml()),s.length?s.forEach(g=>{const h=g.images&&g.images.length>0;p+=`
    ...
    `,t.innerHTML=p}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function Ft(){const t=document.getElementById("settings-booking-url");t&&navigator.clipboard.writeText(t.value).then(()=>{localStorage.setItem("linkCopied","1"),O(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function Dt(){localStorage.setItem("settingsTourDone","1");const t=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",t);let e=0;const o=setInterval(()=>{e++;const i=document.getElementById("edit-rate-nightly");if(i||e>20){if(clearInterval(o),!i)return;const n=i.closest(".accordion-body");if(n&&n.style.display==="none"){n.style.display="block";const a=n.previousElementSibling?.querySelector(".accordion-arrow");a&&(a.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const r=i.getBoundingClientRect(),s=document.createElement("div");s.id="checklistPointer",s.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${r.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,s.innerHTML=`
          ...
          `,document.body.appendChild(s),setTimeout(()=>{const p=document.getElementById("checklistPointer");p&&p.remove()},6e3)},1e3)},100)}},200)}function Nt(){const e="https://"+(l.activeHotelDomain||l.activeHotelId+".mktel.co");navigator.clipboard.writeText(e).then(()=>{localStorage.setItem("linkCopied","1"),O(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function Ot(t,e){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const n=setInterval(()=>{i++;const a=document.querySelector(t);if(a||i>20){if(clearInterval(n),!a)return;a.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const r=document.getElementById("checklistPointer");r&&r.remove();const s=a.getBoundingClientRect(),p=document.createElement("div");p.id="checklistPointer",p.style.cssText=`
        ...
        `,document.body.appendChild(p),setTimeout(()=>{const g=document.getElementById("checklistPointer");g&&g.remove()},6e3)},1e3)}},200)}function lt(){const t=String(l.token||localStorage.getItem("crmToken")||"").trim();return t&&(l.token=t),t}async function ct(t,e){const o=lt();if(!o)throw new Error("Not logged in");const i=await Lt(e),n=new FormData;n.append("image",i,i.name||"room.webp");const a=new URLSearchParams;l.activeHotelId&&a.set("hotelId",l.activeHotelId),a.set("token",o);const r=await fetch(`/api/crm/rooms/${t}/images?${a}`,{method:"POST",headers:{"x-crm-token":o},body:n}),s=await r.json().catch(()=>({}));if(!r.ok||!s.success)throw new Error(s.message||s.error||`Upload failed (${r.status})`);return s}async function qt(t,e){const o=t.target.files[0];if(o)try{await ct(e,o),toast("Photo uploaded!","success"),ht()}catch(i){toast(i.message||"Upload failed","error")}}async function jt(){const t=parseFloat(document.getElementById("settings-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("settings-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("settings-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),toast("Rates saved","success")}catch{toast("Failed to save rates","error")}}async function Ut(){const t=document.getElementById("settings-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");l.token=t,l.isMasterPin=!1;try{localStorage.setItem("crmToken",l.token)}catch{}toast("PIN updated!","success"),document.getElementById("settings-new-pin").value=""}catch(e){toast(e.message||"Failed to change PIN","error")}}async function Gt(){const t=document.getElementById("settings-support-msg")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),toast("Message sent!","success"),document.getElementById("settings-support-msg").value=""}catch{toast("Failed to send","error")}}function Wt(){const t=l.activeHotelDomain||l.activeHotelId+".mktel.co",o=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://localhost:5173/?hotelId="+encodeURIComponent(l.activeHotelId)+"&preview=1":"https://"+t+"?preview=1";window.open(o,"_blank")}function bt(){if((window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&l.activeHotelId)return"http://localhost:5173/?hotelId="+encodeURIComponent(l.activeHotelId);const e=l.activeHotelDomain||"";return e?"https://"+e+"/":""}function Vt(){const t=bt();if(!t){toast("Your booking domain is still setting up.","info");return}window.open(t,"_blank")}function Yt(){const t=document.getElementById("previewSiteBar");t&&(t.style.display=l.currentFilter==="settings"?"block":"none")}function O(){if(localStorage.getItem("settingsTourDone"))return;const t=parseInt(localStorage.getItem("settingsTourStep")||"0"),e=l.editRooms.some(r=>r.images&&r.images.length>0),o=!!localStorage.getItem("ratesChanged"),i=!!localStorage.getItem("linkCopied");t===1&&e&&localStorage.setItem("settingsTourStep","2"),t===2&&o&&localStorage.setItem("settingsTourStep","3"),t===3&&i&&localStorage.setItem("settingsTourStep","4");const n=document.getElementById("tourTooltip");n&&n.remove();const a=document.getElementById("tourBlurOverlay");a&&a.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(r=>{r.style.position=r.dataset.tourOrigPosition||"",r.style.zIndex="",r.style.isolation="",r.style.boxShadow="",r.removeAttribute("data-tour-highlighted"),delete r.dataset.tourOrigPosition}),document.body.style.overflow=""}function _t(){let t=0;const e={},o=[{title:"Why do you want a booking page?",key:"why",type:"text",placeholder:"e.g. I want guests to book directly instead of calling me..."},{title:"How do guests currently book with you?",key:"currentBooking",type:"choice",options:[{label:"They call me or walk in",value:"phone_walkin"},{label:"Through Booking.com / Expedia",value:"ota"},{label:"I have a website but no booking system",value:"website_no_booking"},{label:"I don't take bookings online yet",value:"no_online"}]},{title:"How many rooms do you have?",key:"roomCount",type:"choice",options:[{label:"1–5 rooms",value:"1-5"},{label:"6–15 rooms",value:"6-15"},{label:"16–50 rooms",value:"16-50"},{label:"50+ rooms",value:"50+"}]},{title:"What's most important to you?",key:"priority",type:"choice",options:[{label:"Stop paying OTA commissions",value:"no_commission"},{label:"Get more direct bookings",value:"more_bookings"},{label:"Have a professional online presence",value:"professional"},{label:"Make it easier for guests to book",value:"easier_booking"}]}];function i(){let n=document.getElementById("onboardingOverlay");if(n&&n.remove(),t>=o.length){localStorage.setItem("onboardingDone","1");try{api("POST","/api/crm/onboarding-answers",e).catch(()=>{})}catch{}vt();return}const a=o[t],r=document.createElement("div");r.id="onboardingOverlay",r.style.cssText="position:fixed;inset:0;z-index:100001;background:linear-gradient(135deg, #1a2b22 0%, #2E7D5B 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;",a.type==="text"?(r.innerHTML=`
      ...
      `,document.body.appendChild(r),r.querySelectorAll(".onboarding-opt").forEach(s=>{s.addEventListener("click",()=>{e[a.key]=s.dataset.value,s.style.background="#1a1a2e",s.style.color="white",s.style.fontWeight="600",setTimeout(()=>{t++,i()},250)})}))}i()}function Qt(){["onboardingDone","settingsTourDone","settingsTourStep","linkCopied","ratesChanged","appsTourDone","postActivationTourDone"].forEach(o=>{localStorage.removeItem(o)});const t=new URL(window.location.href);t.searchParams.set("welcome","1"),t.searchParams.delete("tab");const e=t.pathname+t.search+t.hash;if(e===window.location.pathname+window.location.search+window.location.hash){window.location.reload();return}window.location.assign(e)}function vt(){const t=document.createElement("div");t.id="welcomeModalOverlay",t.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.72);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;padding:24px;";function e(){localStorage.setItem("onboardingDone","1"),localStorage.removeItem("settingsTourDone"),localStorage.removeItem("settingsTourStep");try{const n=new URL(window.location);n.searchParams.delete("welcome"),window.history.replaceState({},"",n)}catch{}const i=typeof at=="function"?at:typeof window.startSettingsTour=="function"?window.startSettingsTour:null;i&&i(),t.remove()}function o(){t.innerHTML=`
      ...
      </div>`,document.getElementById("welcomeModalNext").onclick=e}document.body.appendChild(t),o(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms()}function X(){const t=document.getElementById("postActivationTourTooltip");t&&t.remove();const e=document.getElementById("postActivationTourOverlay");e&&e.remove(),document.querySelectorAll("[data-post-activation-highlight]").forEach(o=>{o.style.boxShadow="",o.style.position="",o.style.zIndex="",o.removeAttribute("data-post-activation-highlight")}),document.body.style.overflow=""}function Q(){X(),localStorage.setItem("postActivationTourDone","1");const t=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');try{setFilter("apps",t)}catch{}}function pt(){if(localStorage.getItem("postActivationTourDone")){Q();return}X();const t=[{tab:"bookings",navFilter:"bookings",text:"<strong>Bookings</strong> — live reservations land here. You'll get a push alert for each new one."},{tab:"apps",navFilter:"apps",text:"<strong>Guest App</strong> — put your hotel on guests&apos; home screens and send install reminders."}];let e=0;function o(){if(X(),e>=t.length){Q();return}const i=t[e],n=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);n&&setFilter(i.tab,n);const a=document.createElement("div");a.id="postActivationTourOverlay",a.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.55);",document.body.appendChild(a),document.body.style.overflow="hidden",setTimeout(()=>{const r=document.querySelector(`.tab[data-nav-filter="${i.navFilter}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${i.navFilter}"]`);r&&(r.setAttribute("data-post-activation-highlight","1"),r.style.position="relative",r.style.zIndex="100003",r.style.boxShadow="0 0 0 3px #fff, 0 0 0 6px #2E7D5B",r.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}));const s=r?r.getBoundingClientRect():{left:24,bottom:80,width:200},p=document.createElement("div");p.id="postActivationTourTooltip";const g=Math.min(300,window.innerWidth-32),h=Math.max(16,Math.min(s.left+s.width/2-g/2,window.innerWidth-g-16)),v=Math.min(s.bottom+14,window.innerHeight-180);p.style.cssText=`position:fixed;z-index:100004;left:${h}px;top:${v}px;max-width:${g}px;width:${g}px;`;const S=e>=t.length-1;p.innerHTML=`
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),pt()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}function F(){let t=document.getElementById("tourBlurOverlay");return t||(t=document.createElement("div"),t.id="tourBlurOverlay",t.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.6);",document.body.appendChild(t),document.body.style.overflow="hidden",t)}function et(){const t=document.getElementById("tourTooltip");t&&t.remove();const e=document.getElementById("tourBlurOverlay");e&&e.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.tourOrigPosition||"",i.style.zIndex="",i.style.isolation="",i.style.boxShadow="",i.removeAttribute("data-tour-highlighted"),delete i.dataset.tourOrigPosition});const o=document.getElementById("goLiveBanner");o&&o.dataset.tourHidden&&(delete o.dataset.tourHidden,typeof updateGoLiveBanner=="function"&&updateGoLiveBanner()),document.body.style.overflow=""}function R(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const a=o.querySelector(".accordion-arrow");a&&(a.style.transform="rotate(90deg)")}}function $(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function D(t,e){if(e.highlightSelector){const o=$(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function J(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const n=document.querySelector(i);if(n&&n.isConnected)return n}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function rt(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function K(t,e){const o=$(t.anchorSelector);if(o){const i=rt(o,!0);if(i)return i}return rt(e,!0)}function Z(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const n=document.querySelector(i);n&&(n.scrollTop=0)})}function wt(t,e){const o=e.scrollTarget||e.accordionCard,i=(o?$(o):null)||t;if(!i&&!e.scrollToTop)return Promise.resolve();const n=e.scrollBlock||"center",r=window.matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth";return new Promise(s=>{const p=()=>{const C=e.scrollPadTop??80,d=e.scrollPadBottom??130,c=$(e.anchorSelector)||(i&&i.isConnected?i:null)||(t&&t.isConnected?t:null);if(!c){s();return}const y=c.getBoundingClientRect();y.top<C&&window.scrollBy({top:y.top-C,left:0,behavior:"auto"}),y.bottom>window.innerHeight-d&&window.scrollBy({top:y.bottom-window.innerHeight+d,left:0,behavior:"auto"}),requestAnimationFrame(()=>requestAnimationFrame(s))},g=()=>{i&&i.scrollIntoView({behavior:e.scrollToTop?"auto":r,block:n,inline:"nearest"}),p()};if(e.scrollToTop){if(Z(r),e.scrollToTopOnly){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&Z("auto"),s()}));return}if(r==="auto"){g();return}let C=!1;const d=()=>{C||(C=!0,window.removeEventListener("scrollend",c),clearTimeout(y),g())},c=()=>d();"onscrollend"in window&&window.addEventListener("scrollend",c,{once:!0});const y=setTimeout(d,520);return}if(!i){s();return}if(i.scrollIntoView({behavior:r,block:n,inline:"nearest"}),r==="auto"){p();return}let h=!1;const v=()=>{h||(h=!0,window.removeEventListener("scrollend",S),clearTimeout(ot),p())},S=()=>v();"onscrollend"in window&&window.addEventListener("scrollend",S,{once:!0});const ot=setTimeout(v,620)})}function kt(){et(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&setFilter("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const n=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof n=="function"&&n({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function N(){l.settingsTourActive=!1,updateGoLiveBanner();const t=document.createElement("div");t.id="tourBlurOverlay",t.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(t),document.body.style.overflow="hidden";const e=document.createElement("div");if(e.id="tourTooltip",e.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),!document.getElementById("tourModalAnimStyle")){const o=document.createElement("style");o.id="tourModalAnimStyle",o.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(o)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("tourNextBtn").onclick=()=>{const i="https://"+(l.activeHotelDomain||l.activeHotelId+".mktel.co");navigator.clipboard.writeText(i).catch(()=>{}),et(),l.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.setItem("linkCopied","1"),localStorage.removeItem("settingsTourStep"),toast("Booking link copied!","success"),finishTourHydration(),Et()}}function Et(t){const e=document.createElement("div");e.id="testDriveOverlay",e.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    <div style="background:white;border-radius:20px;max-width:340px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);animation:tourModalSlideUp 0.3s ease;">
    ...
    </div>`,document.body.appendChild(e),typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("activateNowBtn").onclick=()=>{e.remove(),Pt()},document.getElementById("activateLaterBtn").onclick=()=>{e.remove();const o=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');o&&setFilter("bookings",o)}}function at(){if(localStorage.getItem("settingsTourDone"))return;if(localStorage.getItem("settingsTourStep")==="handoff"){localStorage.removeItem("settingsTourStep"),N();return}l.settingsTourActive=!0,updateGoLiveBanner(),seedTourRevenueShell();const t=document.querySelector('.tab[data-nav-filter="settings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="settings"]');t&&setFilter("settings",t);function e(){if(typeof window.isEditPageDomReady=="function"&&window.isEditPageDomReady()||typeof isEditPageDomReady=="function"&&isEditPageDomReady()||!(typeof window.needsEditPageLoad=="function"&&window.needsEditPageLoad()||typeof needsEditPageLoad=="function"&&needsEditPageLoad())&&!l.editRoomsLoadPromise)return;const y=typeof window.invokeLoadEditRooms=="function"?window.invokeLoadEditRooms:typeof invokeLoadEditRooms=="function"?invokeLoadEditRooms:null;y&&y()}e();const o=[{target:"",text:"",openAccordion:!1,tab:"settings",customModal:"homescreen"},{target:"#edit-hotel-phone",text:"Tap any field here to edit your hotel info — name, address, phone.",openAccordion:!1,tab:"settings"},{target:'#editRoomsCards [data-tour-room-card="1"]',highlightSelector:'#editRoomsCards [data-tour-room-card="1"]',anchorSelector:'#editRoomsCards [data-tour-room-card="1"]',scrollTarget:'#editRoomsCards [data-tour-room-card="1"]',text:"Add a photo of your room — guests book more when they see one.",openAccordion:!1,tab:"settings",tooltipAnchor:"card-top",scrollBlock:"center",scrollPadTop:190,scrollPadBottom:80,forceTooltipAbove:!0},{target:"#tour-rates-card",highlightSelector:"#tour-rates-card",anchorSelector:"#tour-rates-header",scrollTarget:"#tour-rates-card",text:"You can change your rates here — nightly, weekly, and monthly.",openAccordion:!0,accordionCard:"#tour-rates-card",tab:"settings",scrollBlock:"center",scrollPadBottom:280,tooltipAnchor:"card-bottom"},{target:"#tour-copy-link-btn",text:"This is your booking URL — the link guests use to book with you directly.",openAccordion:!1,tab:"settings",tooltipPosition:"below"},{target:"#tour-preview-btn",text:"Preview your booking page to see exactly what your guests see.",openAccordion:!1,tab:"settings",tooltipPosition:"below",scrollToTop:!0,scrollToTopOnly:!0,forcePageTop:!0},{target:"#tour-pin-card",highlightSelector:"#tour-pin-card",anchorSelector:"#tour-pin-header",scrollTarget:"#tour-pin-card",text:"This is your login PIN — you'll need it to access this dashboard next time. You can change it here anytime.",openAccordion:!0,accordionCard:"#tour-pin-card",tab:"settings",tooltipAnchor:"card-top",scrollBlock:"center",scrollPadBottom:200},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",text:"See how much revenue your booking page generates and how much you're saving vs OTA commissions.",openAccordion:!1,tab:"revenue",waitForVisible:!0},{target:"#paymentsExplainer",text:"When guests book through your booking page, their card is verified but never charged. This prevents no-shows — and you collect payment however you want when they physically check in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,tooltipPosition:"above"},{target:"",text:"",openAccordion:!1,tab:"apps",customModal:"guestAppsStory"}];let i=parseInt(localStorage.getItem("settingsTourStep")||"0",10);(!Number.isFinite(i)||i<0||i>=o.length)&&(i=0,localStorage.removeItem("settingsTourStep"));function n(){et()}function a(){n(),localStorage.removeItem("settingsTourStep"),N()}function r(d){if(d.customModal){p(d);return}requestAnimationFrame(()=>p(d))}function s(){if(n(),i>=o.length){localStorage.removeItem("settingsTourStep"),N();return}const d=o[i];if(d.tab==="revenue"&&!l.revenueEnabled){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}if(d.tab==="apps"&&!(isStandaloneApp()||l.frontdeskInstalled)&&d.target&&!d.target.includes("tour-fd-install")){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}if(d.customModal||F(),d.tab&&d.tab!==l.currentFilter){const c=document.querySelector(`.tab[data-nav-filter="${d.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${d.tab}"]`);if(c&&setFilter(d.tab,c),d.tab==="apps"){const y=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof y=="function"&&y(!0)}r(d);return}r(d)}function p(d){if(d.customModal==="homescreen"){S();return}if(d.customModal===!0||d.customModal==="bookings"){C();return}if(d.customModal==="availability"){ot();return}if(d.customModal==="finale"){N();return}if(d.customModal==="guestAppsStory"){kt();return}if(d.waitForVisible){const u=d.target.split(",").map(f=>f.trim());let m=0;const b=30;F();const w=l.settingsTourActive?60:200,x=()=>{if(m++,d.tab==="apps"){const k=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof k=="function"&&k(!0)}let f=null;for(const k of u)if(f=document.querySelector(k),f)break;if(f&&(d.openAccordion&&R(f,d),d.openAccordion||f.offsetParent!==null)){g(f,d);return}m<b?setTimeout(x,w):(i++,localStorage.setItem("settingsTourStep",String(i)),s())};x();return}function c(u){const m=u.target.split(",").map(b=>b.trim());for(const b of m){const w=document.querySelector(b);if(w&&!(!u.openAccordion&&w.offsetParent===null&&getComputedStyle(w).position!=="fixed"))return w}if(u.accordionCard){const b=document.querySelector(u.accordionCard);if(b)return b}return null}function y(u,m){const b=c(u);if(b){m(b);return}const w=u.tab==="settings"&&!u.customModal&&u.target,x=u.tab==="apps"&&!u.customModal&&u.target;if(!w&&!x){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}F();let f=0;if(w&&e(),x){const E=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof E=="function"&&E(!0)}const k=l.settingsTourActive?60:250,T=()=>{if(f++,x){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}const E=c(u);if(E){m(E);return}if(e(),x){const B=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof B=="function"&&B(!0)}f<48?setTimeout(T,k):(i++,localStorage.setItem("settingsTourStep",String(i)),s())};T()}y(d,u=>g(u,d))}function g(d,c){if(R(d,c),d=D(d,c),(!d||!d.isConnected)&&(d=J(d,c),d&&(d=D(d,c))),!d){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}const y=document.getElementById("goLiveBanner");y&&c.tab==="settings"&&(y.dataset.tourHidden="1",y.style.display="none");const u=d;F(),wt(u,c).then(()=>{if(c.forcePageTop&&Z("auto"),!u.isConnected){i++,localStorage.setItem("settingsTourStep",String(i)),s();return}R(u,c),c.noHighlight||(u.dataset.tourOrigPosition||(u.dataset.tourOrigPosition=u.style.position||""),u.style.position=u.style.position||"relative",u.style.zIndex="99999",u.style.isolation="isolate",u.style.boxShadow="0 0 0 4px #2E7D5B, 0 0 20px rgba(46,125,91,0.3)",u.setAttribute("data-tour-highlighted","1"));const m=()=>{const x=$(c.anchorSelector)||u;if(c.freezeTooltip){const E=x&&x.isConnected?x.getBoundingClientRect():null;h(x,c,E&&E.width>=2?E:null);return}const f=J(u,c);let k=f?D(f,c):u;R(k,c);const T=c.tooltipAnchor?null:K(c,k);h(k||u,c,T)};if(c.freezeTooltip){requestAnimationFrame(()=>requestAnimationFrame(m));return}const b=(w=0)=>{requestAnimationFrame(()=>{if(c.forcePageTop&&Z("auto"),c.tooltipAnchor){m();return}const x=J(u,c);let f=x?D(x,c):u;R(f,c);const k=K(c,f);if(!k&&w<4){requestAnimationFrame(()=>b(w+1));return}h(f||u,c,k)})};b(0)})}function h(d,c,y){const u=document.getElementById("tourTooltip");u&&u.remove();const m=document.createElement("div");m.id="tourTooltip";const b='<div style="margin-top:8px;"><button id="tourSkipBtn" style="background:none;border:none;color:rgba(255,255,255,0.5);font-size:11px;font-family:inherit;cursor:pointer;padding:4px 8px;">Skip tour</button></div>',w=i<o.length-1?"Next →":"Got it!",x=`
      <div style="background:#1a1a2e;border-radius:10px;padding:14px 18px;color:white;font-size:13px;line-height:1.5;font-weight:500;text-align:center;box-shadow:0 4px 20px rgba(0,0,0,0.25);">
        ...
        ${b}
      </div>`;if(c.tooltipAnchor==="card-bottom"||c.tooltipAnchor==="card-top"){const j=$(c.highlightSelector)||d,ft=$(c.anchorSelector);if(j){const P=j.getBoundingClientRect(),U=ft?ft.getBoundingClientRect():null,z=Math.min(280,window.innerWidth-32),yt=P.left+P.width/2,L=Math.max(16,Math.min(yt-z/2,window.innerWidth-z-16)),G=Math.max(20,Math.min(yt-L,z-20)),H=132;if(c.tooltipAnchor==="card-bottom"){const W=window.innerHeight-P.bottom,it=Math.min(P.bottom+12,window.innerHeight-H-16);if(W>=H+20)m.style.cssText=`position:fixed;z-index:100000;left:${L}px;top:${it}px;max-width:${z}px;width:${z}px;`,m.innerHTML=`
              ...
              ${x}`;else{const nt=U?U.top:P.top;m.style.cssText=`position:fixed;z-index:100000;left:${L}px;bottom:${window.innerHeight-nt+10}px;max-width:${z}px;width:${z}px;`,m.innerHTML=`
              ${x}
              <div style="width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-top:8px solid #1a1a2e;margin-left:${G-8}px;"></div>`}}else{const W=P.top,it=P.top-16,nt=!!c.forceTooltipAbove||!!(c.forceTooltipAboveOnDesktop&&window.matchMedia("(min-width: 1024px)").matches);if(it>=H+24||nt){const V=W-H-10,Rt=V>=16?`bottom:${window.innerHeight-W+10}px;`:`top:${Math.max(16,V)}px;`;m.style.cssText=`position:fixed;z-index:100000;left:${L}px;${Rt}max-width:${z}px;width:${z}px;`,m.innerHTML=`
              ${x}
              <div style="width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-top:8px solid #1a1a2e;margin-left:${G-8}px;"></div>`}else{const V=Math.min(P.top+(U?U.height:48)+12,window.innerHeight-H-16);m.style.cssText=`position:fixed;z-index:100000;left:${L}px;top:${V}px;max-width:${z}px;width:${z}px;`,m.innerHTML=`
              <div style="width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-bottom:8px solid #1a1a2e;margin-left:${G-8}px;"></div>
              ${x}`}}document.body.appendChild(m),v();return}}const f=y||K(c,d);if(!f){m.style.cssText="position:fixed;z-index:100000;left:50%;top:50%;transform:translate(-50%,-50%);max-width:280px;width:calc(100% - 32px);",m.innerHTML=x,document.body.appendChild(m),v();return}const k=window.innerHeight-f.bottom,T=f.top,E=Math.min(280,window.innerWidth-32),B=f.left+f.width/2,I=Math.max(16,Math.min(B-E/2,window.innerWidth-E-16)),M=Math.max(20,Math.min(B-I,E-20));let A=c.tooltipPosition||(k>150?"below":T>150?"above":"center");if(A==="below"&&k<130&&T>k&&(A="above"),A==="above"&&T<130&&k>T&&(A="below"),A==="below"&&f.bottom+150>window.innerHeight&&(A="above"),A==="below"){const j=Math.min(f.bottom+8,window.innerHeight-24);m.style.cssText=`position:fixed;z-index:100000;left:${I}px;top:${j}px;max-width:${E}px;width:${E}px;`,m.innerHTML=`
      ...
      </div>`,document.body.appendChild(I),!document.getElementById("tourModalAnimStyle")){const M=document.createElement("style");M.id="tourModalAnimStyle",M.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(M)}document.getElementById("tourNextBtn").onclick=()=>{n(),i++,localStorage.setItem("settingsTourStep",String(i)),s()},document.getElementById("tourSkipBtn").onclick=()=>{a()}}function ot(){const d=document.createElement("div");d.id="tourBlurOverlay",d.style.cssText="position:fixed;inset:0;z-index:99998;background:rgba(0,0,0,0.7);",document.body.appendChild(d),document.body.style.overflow="hidden";let c=0;const y=[`<div style="padding:20px 18px 0;">
    ...
    `;t.innerHTML=S,q(),typeof lucide<"u"&&lucide.createIcons()}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load your page</div><div class="empty-sub">Check your connection and refresh.</div></div>'}})();try{await l.editRoomsLoadPromise}finally{l.editRoomsLoadPromise=null}}}function gt(){q()}function q(){const t=document.getElementById("editRoomsCards");if(t){if(!l.editRooms.length){t.innerHTML='<div class="empty-state"><div class="empty-icon">🛏️</div><div class="empty-text">No rooms yet</div><div class="empty-sub">Add your first room type below.</div></div>';return}t.innerHTML=l.editRooms.map((e,o)=>{const i=(e.amenities||"").split("•").map(r=>r.trim()).filter(Boolean),n=(e.images||[]).filter(r=>r&&r.url),a=jsStr(e.id);return`
      ...
      <div class="room-edit-fields" style="padding:18px;">
        ...
        <div style="margin-bottom:12px;">
          ...
          <div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:8px;" id="edit-amenity-pills-${e.id}">
            ${i.map(r=>`<span style="display:inline-flex;align-items:center;gap:4px;background:var(--green-pale);color:var(--green);padding:5px 10px;border-radius:8px;font-size:12px;font-weight:600;">${zt(r)} ${r} <button onclick="removeAmenity('${e.id}','${r.replace(/'/g,"\\'")}')" style="background:none;border:none;color:var(--green);cursor:pointer;font-size:14px;margin-left:2px;">×</button></span>`).join("")}
          </div>
    ...
    </div>`}).join(""),typeof lucide<"u"&&lucide.createIcons()}}function St(t){const e=l.editRooms.find(o=>String(o.id)===String(t));return(e&&e.images||[]).filter(o=>o&&o.url)}function Tt(t,e){const o=St(t);if(!o.length)return;const i=document.getElementById("edit-card-"+t);if(!i)return;const n=o.length,a=((Number(e)||0)%n+n)%n,r=i.querySelector(".room-edit-main-img");r&&(r.src=o[a].url),i.querySelector(".room-edit-photo")?.setAttribute("data-photo-index",String(a));const s=i.querySelector(".room-edit-photo-count");s&&(s.textContent=a+1+" / "+n),i.querySelectorAll(".room-edit-image-dot").forEach((p,g)=>{p.classList.toggle("active",g===a),g===a?p.setAttribute("aria-current","true"):p.removeAttribute("aria-current")}),i.querySelectorAll(".room-edit-thumb").forEach((p,g)=>{p.classList.toggle("active",g===a),g===a?p.setAttribute("aria-current","true"):p.removeAttribute("aria-current")})}function Kt(t,e){const i=document.getElementById("edit-card-"+t)?.querySelector(".room-edit-photo"),n=parseInt(i?.getAttribute("data-photo-index")||"0",10)||0;Tt(t,n+e)}function zt(t){const e=t.toLowerCase();return e.includes("wifi")?'<i data-lucide="wifi" style="width:14px;height:14px;"></i>':e.includes("tv")||e.includes("television")?'<i data-lucide="tv" style="width:14px;height:14px;"></i>':e.includes("fridge")||e.includes("refrigerator")?'<i data-lucide="thermometer-snowflake" style="width:14px;height:14px;"></i>':e.includes("parking")?'<i data-lucide="car" style="width:14px;height:14px;"></i>':e.includes("housekeeping")||e.includes("cleaning")?'<i data-lucide="sparkles" style="width:14px;height:14px;"></i>':e.includes("bath")||e.includes("shower")?'<i data-lucide="bath" style="width:14px;height:14px;"></i>':e.includes("work")||e.includes("desk")?'<i data-lucide="laptop" style="width:14px;height:14px;"></i>':e.includes("pet")||e.includes("dog")?'<i data-lucide="paw-print" style="width:14px;height:14px;"></i>':e.includes("pool")?'<i data-lucide="waves" style="width:14px;height:14px;"></i>':e.includes("kitchen")||e.includes("microwave")?'<i data-lucide="cooking-pot" style="width:14px;height:14px;"></i>':'<i data-lucide="check" style="width:14px;height:14px;"></i>'}const Bt=[{key:"wifi",label:"Free WiFi",icon:"wifi"},{key:"tv",label:"Smart TV",icon:"tv"},{key:"fridge",label:"Fridge",icon:"thermometer-snowflake"},{key:"parking",label:"Free Parking",icon:"car"},{key:"housekeeping",label:"Weekly Housekeeping",icon:"sparkles"},{key:"bath",label:"Bath",icon:"bath"},{key:"workstation",label:"Workstation",icon:"laptop"},{key:"pet",label:"Pet Friendly",icon:"paw-print"},{key:"pool",label:"Pool",icon:"waves"},{key:"kitchen",label:"Kitchenette",icon:"cooking-pot"},{key:"ac",label:"Air Conditioning",icon:"wind"},{key:"laundry",label:"Laundry",icon:"shirt"}];let mt=null;function It(t){mt=t;const o=(l.editRooms.find(a=>a.id===t)?.amenities||"").split("•").map(a=>a.trim().toLowerCase()).filter(Boolean);let i=document.getElementById("amenityPickerModal");i||(document.body.insertAdjacentHTML("beforeend",`
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",tt),i=document.getElementById("amenityPickerModal"));const n=document.getElementById("amenityPickerGrid");n.innerHTML=Bt.map(a=>{const r=o.some(s=>s.includes(a.key));return`<button onclick="toggleAmenityPreset(this,'${a.key}')" data-key="${a.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${r?"#2E7D5B":"#e5e7eb"};background:${r?"#E8F5EE":"white"};color:${r?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${a.icon}" style="width:14px;height:14px;"></i> ${a.label}</button>`}).join(""),document.getElementById("amenityCustomInput").value="",i.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function Xt(t,e){const o=t.style.borderColor==="rgb(46, 125, 91)";t.style.borderColor=o?"#e5e7eb":"#2E7D5B",t.style.background=o?"white":"#E8F5EE",t.style.color=o?"#1a1a2e":"#2E7D5B"}function tt(){document.getElementById("amenityPickerModal").style.display="none",mt=null}function Zt(){const t=l.editRooms.find(n=>n.id===mt);if(!t){tt();return}const e=document.getElementById("amenityPickerGrid"),o=[];e.querySelectorAll("button").forEach(n=>{if(n.style.background==="rgb(232, 245, 238)"){const a=Bt.find(r=>r.key===n.dataset.key);a&&o.push(a.label)}});const i=document.getElementById("amenityCustomInput").value.trim();i&&o.push(i),t.amenities=o.join(" • "),tt(),gt(),typeof lucide<"u"&&lucide.createIcons()}function te(t){It(t)}function ee(t,e){const o=l.editRooms.find(n=>n.id===t);if(!o)return;const i=(o.amenities||"").split("•").map(n=>n.trim()).filter(Boolean);o.amenities=i.filter(n=>n!==e).join(" • "),gt(),typeof lucide<"u"&&lucide.createIcons()}async function oe(){const t=document.getElementById("edit-hotel-name")?.value.trim(),e=document.getElementById("edit-hotel-subtitle")?.value.trim(),o=document.getElementById("edit-hotel-address")?.value.trim(),i=document.getElementById("edit-hotel-phone")?.value.trim(),n=document.getElementById("edit-hotel-policy")?.value.trim();try{await api("POST","/api/crm/hotel-info",{name:t,subtitle:e,address:o,phone:i,cancellationPolicy:n}),toast("Hotel info saved!","success")}catch{toast("Failed to save","error")}}async function ie(){const t=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),localStorage.setItem("ratesChanged","1"),l.launchStatus=null,O(),toast("Rates saved!","success")}catch{toast("Failed to save rates","error")}}async function ne(){const t=document.getElementById("edit-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");l.token=t,l.isMasterPin=!1;try{localStorage.setItem("crmToken",l.token)}catch{}toast("PIN updated!","success")}catch(e){toast(e.message||"Failed to change PIN","error")}}function re(t){navigator.clipboard.writeText(t).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function ae(t){const e=t.nextElementSibling,o=t.querySelector(".accordion-arrow");e.style.display==="none"?(e.style.display="block",o&&(o.style.transform="rotate(90deg)")):(e.style.display="none",o&&(o.style.transform="rotate(0deg)"))}let _=!1;function At(){if(document.getElementById("goLiveOverlay"))return;const t=document.createElement("div");t.id="goLiveOverlay",t.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(255,255,255,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;",t.innerHTML='<div class="logo-sprite-bounce"></div><div style="font-size:14px;font-weight:700;color:#1a5c3f;">Opening secure checkout…</div><div style="font-size:12px;color:#6b7280;">Taking you to Stripe — one moment</div>',document.body.appendChild(t)}function st(){const t=document.getElementById("goLiveOverlay");t&&t.remove()}async function Pt(){if(!_){_=!0,At();try{const t=await api("POST","/api/crm/go-live");if(t.success&&t.url){window.location.href=t.url;return}st(),_=!1,toast(t.message||"Failed to start checkout","error")}catch{st(),_=!1,toast("Failed to start checkout. Try again.","error")}}}async function se(){try{const t=await api("GET","/api/crm/billing-portal");t.success&&t.url?window.location.href=t.url:toast(t.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function de(){const t=document.getElementById("supportMessage")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),document.getElementById("supportMessage").value="",toast("Message sent! We'll reply to your email.","success")}catch{toast("Failed to send. Email support@bookmarketel.com directly.","error")}}async function le(t){const e=l.editRooms.find(s=>s.id===t);if(!e){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+t)?.value.trim(),i=document.getElementById("edit-desc-"+t)?.value.trim(),n=parseInt(document.getElementById("edit-occ-"+t)?.value)||4,a=parseInt(document.getElementById("edit-units-"+t)?.value)||1,r={id:t,name:o||e.name,description:i||"",amenities:e.amenities||"",maxOccupancy:n,totalUnits:a};try{const s=await api("POST","/api/crm/rooms",r);if(s&&s.success===!1){toast(s.message||"Failed to save","error");return}e.name=r.name,e.description=r.description,e.maxOccupancy=n,e.totalUnits=a,toast("Room saved!","success")}catch(s){toast("Failed to save: "+(s.message||""),"error")}}async function ce(t,e){const o=Array.from(t.target.files);if(!o.length)return;const n=document.getElementById("edit-card-"+e)?.querySelector("div:first-child");n&&(n.style.position="relative",n.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+e+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+e+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let a=0,r="";for(const p of o){try{const h=await ct(e,p);if(h.image){const v=l.editRooms.find(S=>S.id===e);v&&(v.images||(v.images=[]),v.images.push(h.image),v.imageUrl||(v.imageUrl=h.image.url)),a++}}catch(h){r=h.message||"Upload failed"}const g=document.getElementById("upload-progress-"+e);g&&(g.textContent=a+" / "+o.length)}const s=document.getElementById("upload-spinner-"+e);s&&s.remove(),q(),a>0&&(l.launchStatus=null),O(),a>0?toast(a+" photo"+(a!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success"):toast(r||"Upload failed","error")}function $t(t,e=512){return new Promise((o,i)=>{const n=new Image,a=URL.createObjectURL(t);n.onload=()=>{try{const r=Math.min(n.naturalWidth,n.naturalHeight),s=(n.naturalWidth-r)/2,p=(n.naturalHeight-r)/2,g=document.createElement("canvas");g.width=e,g.height=e;const h=g.getContext("2d");h.imageSmoothingQuality="high",h.drawImage(n,s,p,r,r,0,0,e,e),URL.revokeObjectURL(a),g.toBlob(v=>v?o(v):i(new Error("crop failed")),"image/png",.92)}catch(r){URL.revokeObjectURL(a),i(r)}},n.onerror=()=>{URL.revokeObjectURL(a),i(new Error("load failed"))},n.src=a})}function Ct(){const t=document.getElementById("appsAppIconPreview");t&&(t.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function xt(t){const e=document.getElementById("appsAppIconPreview");e&&(e.style.background="#fff",e.style.border="1px solid var(--border)",e.style.padding="0",e.innerHTML='<img src="'+t+'" alt="App icon" style="width:100%;height:100%;object-fit:contain;">')}function dt(){const t=document.getElementById("appsAppIconPreview");if(!t)return;if(l.activeHotelAppIcon){xt(l.activeHotelAppIcon);return}const e=(l.activeHotelName||"H").trim().charAt(0).toUpperCase()||"🏨";t.style.background="transparent",t.style.border="none",t.style.padding="0",t.innerHTML='<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">'+e+"</span>"}async function pe(t){const e=t.files&&t.files[0];if(!e)return;Ct();const o=new FormData;try{const i=await $t(e,512);o.append("icon",i,"app-icon.png")}catch{o.append("icon",e)}try{const i=lt(),n=new URLSearchParams;l.activeHotelId&&n.set("hotelId",l.activeHotelId),i&&n.set("token",i);const r=await(await fetch(`/api/crm/hotel-app-icon?${n}`,{method:"POST",headers:{"x-crm-token":i},body:o})).json();if(r.success&&r.appIconUrl){l.activeHotelAppIcon=r.appIconUrl,xt(r.appIconUrl);const s=document.getElementById("appsView");s&&(s.dataset.appsKey=(l.activeHotelId||"")+"|"+r.appIconUrl+"|"+(l.activeHotelDomain||"")),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Logo updated! Guests will see it on their phone.","success")}else toast(r.message||"Failed to upload icon","error"),dt()}catch{toast("Failed to upload icon","error"),dt()}t.value=""}async function ue(t,e){if(confirm("Delete this photo?"))try{await api("DELETE",`/api/crm/rooms/${t}/images/${e}`);const o=l.editRooms.find(i=>i.id===t);o&&o.images&&(o.images=o.images.filter(i=>i.id!==e),o.imageUrl=o.images[0]?.url||null),q(),toast("Photo deleted","success")}catch{toast("Failed to delete","error")}}async function ge(t){if(confirm("Delete this room type?"))try{await api("DELETE",`/api/crm/rooms/${t}`),toast("Room deleted","success"),ut()}catch{toast("Failed to delete","error")}}function me(){const t=document.getElementById("editRoomsList");document.getElementById("editAddForm")||(t.insertAdjacentHTML("beforeend",`
  ...
  `),document.getElementById("editNewRoomName").focus())}function xe(){const t=document.getElementById("editNewRoomName").value.trim();t&&api("POST","/api/crm/rooms",{name:t,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),ut()}).catch(()=>toast("Failed to add","error"))}const Mt={addAmenityPrompt:te,advanceTourIfNeeded:O,changePin:ne,checklistGoTo:Ot,checklistGoToRates:Dt,cleanupPostActivationTourUi:X,cleanupSettingsTourUi:et,closeAmenityPicker:tt,confirmAmenityPicker:Zt,confirmEditAddRoom:xe,copyBookingLink:re,copyBookingLinkFromChecklist:Nt,deleteEditImage:ue,deleteEditRoom:ge,ensureTourBlurOverlay:F,finishPostActivationTour:Q,getAmenityIcon:zt,getCrmAuthToken:lt,getEditRoomImages:St,goLive:Pt,guestBookingEngineUrl:bt,handoffToGuestAppsTour:kt,hideGoLiveOverlay:st,loadEditRooms:ut,loadSettings:ht,openAmenityPicker:It,openBillingPortal:se,openEditAddRoom:me,openGuestBookingEngine:Vt,openPreviewSite:Wt,openTourAccordion:R,postRoomImageUpload:ct,queryTourSelector:$,removeAmenity:ee,renderEditRooms:gt,renderEditRoomsCards:q,replayWalkthrough:Qt,resolveLiveTourElement:J,resolveTourHighlightEl:D,restoreAppIconPreview:dt,saveEditRoom:le,saveHotelInfo:oe,saveRates:ie,scrollTourTargetIntoView:wt,sendSupportMessage:de,setAppIconPreviewImage:xt,setAppIconPreviewLoading:Ct,settingsChangePin:Ut,settingsCopyLink:Ft,settingsSaveRates:jt,settingsSendSupport:Gt,settingsUploadPhoto:qt,showActivatedModal:Jt,showEditRoomPhoto:Tt,showFinaleMockModal:N,showGoLiveOverlay:At,showOnboardingQuestions:_t,showTestDriveModal:Et,showWelcomeModal:vt,squareCropImage:$t,startPostActivationTabTour:pt,startSettingsTour:at,stepEditRoomPhoto:Kt,toggleAmenityPreset:Xt,toggleSection:ae,tourAnchorRect:K,tourElementRect:rt,updatePreviewSiteBar:Yt,uploadAppIcon:pe,uploadEditImages:ce};function fe(){Ht(Mt)}const be=Object.freeze(Object.defineProperty({__proto__:null,default:Mt,install:fe},Symbol.toStringTag,{value:"Module"}));export{ye as a,be as b,l as c,Ht as e,he as s};
