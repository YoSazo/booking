import{c as h,e as bt}from"./settings-NBuVpsVK.js";function z(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function nt(...t){return z("ensureAppsViewRendered")?.(...t)}function st(...t){return z("showFinaleMockModal")?.(...t)}function rt(...t){return z("finishTourHydration")?.(...t)}function F(...t){return z("goLive")?.(...t)}function M(...t){return z("toast")?.(...t)}function vt(...t){return z("appsCloseLightbox")?.(...t)}let P=[],f=0,G=!1,S=null,C=null;function pt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
