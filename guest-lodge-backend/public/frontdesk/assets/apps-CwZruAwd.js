import{c as r,a as Dt,b as Pt,e as Mt}from"./settings-CpDa2Wb2.js";function v(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function it(...t){return v("ensureAppsViewRendered")?.(...t)}function nt(...t){return v("showFinaleMockModal")?.(...t)}function at(...t){return v("finishTourHydration")?.(...t)}function st(...t){return v("goLive")?.(...t)}function rt(...t){return v("toast")?.(...t)}function Nt(...t){return v("appsCloseLightbox")?.(...t)}let G=[],g=0,D=!1,A=null,O=null,P=null,T=null;function Rt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function k(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function pt(){A&&(document.removeEventListener("keydown",A),A=null)}function jt(t){pt(),A=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",A)}function qt(t,e){return!t||!t.isConnected||e?.noHighlight?null:(t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),T?.destroy(),T=Pt(t,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"none",o.style.outline=e?.spotlightOutline??"none",o.style.outlineOffset=e?.spotlightOutlineOffset??"0",(t.classList.contains("apps-story-line")||e?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),T?.element||null)}function lt(t){const e=t||{};pt(),P?.destroy(),P=null,T?.destroy(),T=null,O&&(clearTimeout(O),O=null);const o=document.getElementById("appsTourLightbox");o&&!e.keepLightbox&&o.remove();const a=document.getElementById("appsTourTooltip");a&&a.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function b(t){lt(),document.body.style.overflow="";const e=D;D=!1;try{const o=typeof it=="function"?it:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),e||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive)){const a=typeof nt=="function"?nt:window.showFinaleMockModal;if(typeof a=="function"){a();return}}}function Vt(t){const e=g+t;e<0||e>=G.length||(g=e,S())}function Y(){if(localStorage.setItem("appsTourDone","1"),D||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive){r.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const e=typeof at=="function"?at:window.finishTourHydration;typeof e=="function"&&e()}}function Yt(){Y();const t=typeof st=="function"?st:window.goLive;if(b(!1),typeof t=="function"){t();return}const e=typeof rt=="function"?rt:window.toast;typeof e=="function"&&e("Open Go live to activate your booking page.","error")}function S(){Rt();const t=G[g];if(!t){b(!0);return}const e=G.length,o=g>=e-1,a=`${g+1} / ${e}`,i=Math.max(8,Math.min(100,Math.round((g+1)/e*100))),n=document.querySelector(t.target);if(!n){g++,S();return}lt({keepLightbox:!0});let s=document.getElementById("appsTourLightbox");s||(s=document.createElement("div"),s.id="appsTourLightbox",s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(s)),t.noHighlight||(n.dataset.appsTourOrigPosition=n.style.position||"",n.dataset.appsTourOrigZIndex=n.style.zIndex||"",n.dataset.appsTourOrigIsolation=n.style.isolation||"",n.dataset.appsTourOrigBoxShadow=n.style.boxShadow||"",n.dataset.appsTourOrigOutline=n.style.outline||"",n.dataset.appsTourOrigOutlineOffset=n.style.outlineOffset||"",n.dataset.appsTourOrigTransition=n.style.transition||"",n.style.position=n.style.position||"relative",n.style.zIndex="100002",n.style.isolation="isolate",n.style.transition="box-shadow 0.18s ease, outline 0.18s ease",n.style.boxShadow=t.spotlightBoxShadow??"none",n.style.outline=t.spotlightOutline??"none",n.style.outlineOffset=t.spotlightOutlineOffset??"0",(n.classList.contains("apps-story-line")||t.hideSpotlightBorder)&&(n.dataset.appsTourOrigBorderTop=n.style.borderTop||"",n.dataset.appsTourOrigPaddingTop=n.style.paddingTop||"",n.style.borderTop="none",n.style.paddingTop="0"),n.setAttribute("data-apps-tour-highlighted","1"));const d=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=t.scrollBlock||"nearest",m=d?"auto":"smooth";n.scrollIntoView({behavior:m,block:c});const f=()=>{const _=document.getElementById("appsTourTooltip");_&&_.remove();const l=Math.min(370,window.innerWidth-28),x=t.primaryLabel||(o?"Done":"Next"),E=t.secondaryLabel||(o?"Not now":"Skip tour"),u=g<=0,y=t.kicker||"Guest App",p=document.createElement("div");p.id="appsTourTooltip",p.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${l}px;max-width:${l}px;visibility:hidden;`,p.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${k(t.title)}">
        ...
        <div class="apps-tour-actions">
          ...
          <button type="button" id="appsTourSkipBtn" class="apps-tour-btn apps-tour-btn-ghost">${k(E)}</button>
          <button type="button" id="appsTourNextBtn" class="apps-tour-btn apps-tour-btn-primary">${k(x)}</button>
        </div>
      </div>`,document.body.appendChild(p),qt(n,t);const j=p.querySelector(".apps-tour-panel");P?.destroy(),P=Dt({tooltip:p,panel:j,target:n,anchor:n,spotlight:T,options:{preferredPlacement:t.tooltipPosition||"auto",maxWidth:l,gap:t.tooltipGap??10,autoScroll:!0,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),p.style.visibility="visible";const q=()=>{if(t.activateOnNext){Yt();return}if(o){Y(),b(!1),t.openGuestInstallCoachOnNext&&window.setTimeout(()=>v("appsOpenGuestInstallCoach")?.(),0);return}g++,S()},L=()=>{if(o){Y(),b(!1);return}b(!0)},w=()=>{g<=0||(g--,S())};document.getElementById("appsTourNextBtn").onclick=q,document.getElementById("appsTourSkipBtn").onclick=L;const $=document.getElementById("appsTourBackBtn");$&&($.onclick=w),jt({onNext:q,onBack:w,onSkip:L})};O=setTimeout(()=>{requestAnimationFrame(f)},d?40:320)}function Wt(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;Nt(),b(!1),D=!!o;const a=!!r.hotelSubscribed;G=!!v("isNativeFrontdeskApp")?.()?[{target:"#tour-guest-reach",kicker:"Direct guest reach",title:"Send a push notification directly to their phone.",text:"Every guest who downloads your app and turns on notifications can receive a message from you whenever you choose.",tooltipPosition:"above"},{target:"#tour-native-guest-share",kicker:"Build your audience",title:"Get your app onto their phone.",text:"Show the QR, copy the link, or open the guest page. They install it from there.",tooltipPosition:"above"},{target:"#tour-guest-icon-section",kicker:"Make it yours",title:"Choose the icon guests will save.",text:"Use your logo or a clear property photo.",scrollBlock:"start",tooltipPosition:"below"},{target:"#tour-native-install-guide",kicker:"Your cheat sheet",title:"Know exactly what to tell them.",text:"Open this anytime to practice the exact Safari taps for older iPhones and every iOS 26 layout.",primaryLabel:"Show me",secondaryLabel:"Close",openGuestInstallCoachOnNext:!0,tooltipPosition:"above"}]:[{target:"#tour-apps-intro",kicker:"The loop",title:"Your property becomes the app—and the direct connection.",text:"Guests book direct, save your property to their phone, and can receive notifications from you."},{target:"#tour-apps-first",kicker:"Your side",title:"Put Front Desk on your phone in 3 steps.",text:"There is no App Store. Save this page to your home screen so new bookings can reach you before they confirm — even when Front Desk is closed.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-then",kicker:"Their side",title:"Guests install from your booking page.",text:"One tap on Install and your icon is on their home screen.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-after",kicker:"Direct reach",title:"Send a notification to their phone whenever you want.",text:"Anyone who installs your app and turns on notifications becomes reachable directly from Front Desk.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your property.",text:"A real logo or a clear photo. Guests see this square every time.",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10},{target:"#tour-apps-loop",kicker:a?"Live loop":"Activation",title:a?"This loop is on.":"Everything is ready to turn on.",text:a?"Guests book, save your property, receive your updates, and message you. Front Desk gets the alerts.":"For $199/month, guests can book direct, save your property, receive your updates, and message you — while Front Desk receives the alerts.",primaryLabel:a?"Done":"Activate everything — $199/month",secondaryLabel:a?"Close":"Keep exploring",activateOnNext:!a,tooltipPosition:"below",tooltipGap:8}],g=0,S()}const h={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},Zt="32px";function Z(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function W(t){return`border-radius:${Zt};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function dt(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let M=[],C=0,N="ios26",z=null,ct="",F=null;function Ut(t,e){b(!1),isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),M=t,C=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?H(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?H(-1):i.key==="Escape"&&U()},document.addEventListener("keydown",o._keyHandler);let a=0;o.addEventListener("touchstart",i=>{a=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const n=i.changedTouches[0].clientX-a;Math.abs(n)>50&&H(n<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",K()}function U(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState()))}function H(t){const e=M.length;e<=1||(C=(C+t+e)%e,K())}function K(){const t=document.getElementById("appsLightbox");if(!t)return;const e=M[C],o=M.length,a=e.type!=="video",i=o>1?`${C+1} / ${o}`:"",n=a?`<img src="${dt(e.src)}" alt="${e.alt||""}"
  ...
  </svg>`}function gt(){return`<svg viewBox="45 41.5 19 6" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Kt(){return`<svg viewBox="44 39.5 21 13" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Qt(){return`<svg viewBox="0 0 28 28" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Xt(t,e){const o=[...t?[{label:"More",icon:gt()}]:[],{label:"Share",icon:Q()},...e?[{label:"View More",icon:Kt()}]:[],{label:"Add to Home Screen",icon:Qt()}];return`<div class="agic-sequence" aria-label="${o.map(a=>a.label).join(", then ")}">
  ...
  </div>`}function ut(){const t=N==="ios26",e=z==="compact",i=t&&!z?`
    <div class="agic-content agic-choice">
      ...
      <button type="button" onclick="appsGuestInstallCoachSelectLayout('compact')">
        <span class="agic-choice-glyph">${gt()}</span>
    ...
    <section class="agic-sheet" role="dialog" aria-modal="true" aria-label="How guests install your app">
      ...
      ${i}
    </section>`}function ht(){const t=document.getElementById("appsGuestInstallCoach");t&&(t.innerHTML=ut())}function Jt(){b(!1),U(),document.getElementById("appsGuestInstallCoach")?.remove(),N="ios26",z=null,ct=document.body.style.overflow,document.body.style.overflow="hidden",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),F=e=>{e.key==="Escape"&&ft()},document.addEventListener("keydown",F);const t=document.createElement("div");t.id="appsGuestInstallCoach",t.innerHTML=ut(),document.body.appendChild(t)}function ft(){F&&(document.removeEventListener("keydown",F),F=null),document.getElementById("appsGuestInstallCoach")?.remove(),document.body.style.overflow=ct,isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState())}function te(t){N=t==="classic"?"classic":"ios26",z=N==="classic"?"standard":null,ht()}function ee(t){z=["standard","compact"].includes(t)?t:null,ht()}function xt(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function B(t,e,o,a,i){const n=i?xt("Video"):"",s=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${a})">
    ...
    ${s}
  </button>`}function oe(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function ie(t){const e=document.getElementById("appsView");if(!e)return;const o=(r.activeHotelId||"")+"|"+(r.activeHotelAppIcon||"")+"|"+(r.activeHotelDomain||"");t||e.dataset.appsKey!==o||!e.querySelector(".apps-page")?(bt(),e.dataset.appsKey=o):X()}function bt(){const t=document.getElementById("appsView");if(!t)return;const e=r.activeHotelName||"Your Property",o=r.activeHotelAppIcon||"",a=e.trim().charAt(0).toUpperCase()||"🏡",i=r.activeHotelDomain||"",n=i?"https://"+i:"#",s=i?"https://"+i+"/install":"#";function d(ot){return JSON.stringify(ot).replace(/"/g,"&quot;")}const c=Z(h.guestHome,520),m=[{type:"image",src:h.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],f=[{type:"image",src:h.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:h.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:h.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],R=[{type:"video",src:h.guestInstallVideo,poster:h.guestHome,alt:"Guest adds property to phone",title:"How guests put your property on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your property shows up on their phone like an app. You don't need to do anything."}],_=[{type:"image",src:h.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your guest app.'},{type:"image",src:h.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Guest App</strong>, choose the conversation, and reply."},{type:"video",src:h.guestMessageNotifVideo,poster:h.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],l=isStandaloneApp(),x=isNativeFrontdeskApp(),E=String(r.nativeNotificationState||""),u=E==="registered",y=["authorized","registered","unavailable"].includes(E),p=x?u:l,j=x?u:p&&typeof Notification<"u"&&Notification.permission==="granted",L=!!(window.matchMedia&&window.matchMedia("(max-width: 767px)").matches)?"Put Front Desk on this phone":"Put Front Desk on my phone",w=Number(r.bookingReviewSettings?.reminderMinutes??15),$=`
    <div id="bookingReviewReminderSetting" style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border);">
    ...
    </div>`;let I;x?I=`<div id="tour-fd-installed-badge" style="display:flex;align-items:flex-start;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
    ...
    </div>`:l&&j?I=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
      <div style="width:32px;height:32px;border-radius:50%;background:#2E7D5B;color:#fff;display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0;">✓</div>
    ...
    </div>`:l?I=`<div id="tour-fd-installed-badge"><p style="font-size:13px;color:var(--text-muted);margin:0 0 12px;line-height:1.55;">Front Desk is on this device. Turn on alerts so confirmed bookings and guest messages reach your phone.</p>
      <button onclick="enableBookingAlerts()" style="width:100%;padding:14px;border-radius:12px;border:none;background:var(--green);color:#fff;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;">Turn on booking alerts</button></div>`:I=`<p style="font-size:13px;color:var(--text-muted);margin:0 0 14px;line-height:1.55;">Put Front Desk on this phone first. There is no App Store — follow 3 quick steps and it appears on your home screen like an app.</p>
      ...
      <div style="font-size:12px;color:var(--text-muted);line-height:1.45;text-align:center;">Locked until Front Desk is installed on your phone</div>`;const yt=x?`<div class="apps-story-status">
      ...
      </div>`:`<button type="button" class="apps-story-primary" onclick="handleInstallFrontdesk()">${L}</button>`,vt=s!=="#"?'<button type="button" class="apps-story-secondary" onclick="openGuestBookingEngine({focusInstall:true})">Go to direct booking page</button>':'<div class="apps-story-domain-note">Your direct booking domain is still setting up. Once it is ready, guests install from that page.</div>',J="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",wt=o?J+"background:#fff;border:1px solid var(--border);padding:0;":J,kt=o?`<img src="${o}" alt="Property logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${a}</span>`,Tt=`
    <div class="apps-icon-card">
      <div id="appsAppIconPreview" style="${wt}">
        ${kt}
      </div>
      ...
      ${s==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,Ct=s!=="#"?`
      ...
      </div>`:'<div id="guestInstallStats" style="display:none;"></div>',zt=`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-then">
        ...
        <div class="apps-story-actions">${vt}</div>
      </div>
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        ${n!=="#"?`<button onclick="window.open('${n}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,Bt=ot=>`
    ...
    </div>`,tt='<div id="messagesPanel"></div>',Ot=`
    ...
    ${_t}`,Gt=x?Ot:`${$t}
      ${zt}
      ${tt}
      ${l?Ht:`${At}${V()}`}`,et=x?"":l?"Front Desk is installed. Guests can install your property from the direct booking page.":"Install Front Desk first. Then guests can install your property from the direct booking page.";t.innerHTML=`
  <style>
