const u={token:"",isMasterPin:!1,bookings:[],guestMessages:[],currentFilter:"settings",bookingCallFilter:"all",manualAvailability:{rooms:[],overrides:{}},manualSelectedRoom:"",availabilityYear:new Date().getFullYear(),availabilityMonth:new Date().getMonth(),availabilityEditingDay:"",availabilityDaySaving:!1,editingRoomName:"",pendingDeleteRoomName:"",currentHotelPms:"",revenueEnabled:!1,hotelSubscribed:!1,revenuePeriod:"30d",revenueCache:{},revenueLoading:!1,revenueError:"",blockedDemand:{total:0,today:0,recent:[]},bookingsSubview:"bookings",launchStatus:null,growthFunnel:null,growthChecklist:{},growthPeriod:"30d",ALLOWED_REVENUE_PERIODS:new Set(["today","7d","30d","all"]),OTA_COMMISSION_RATE:.25,activeHotelId:"",activeHotelName:"",activeHotelAppIcon:"",appsViewPlatform:"ios",activeHotelDomain:"",activeHotelContext:null,settingsTourActive:!1,bootInFlight:!1,CRM_HOTEL_BY_HOST:{"guestlodgeminot.clickinns.com":"guest-lodge-minot","booking-kappa-nine.vercel.app":"guest-lodge-minot","stcroix.clickinns.com":"st-croix-wisconsin","homeplacesuites.clickinns.com":"home-place-suites","myhomeplacesuites.com":"home-place-suites","www.myhomeplacesuites.com":"home-place-suites","suitestay.clickinns.com":"suite-stay","clickinns.com":"suite-stay","www.clickinns.com":"suite-stay"},CRM_HOTEL_LABELS:{"guest-lodge-minot":"Guest Lodge Minot","st-croix-wisconsin":"St. Croix Wisconsin","home-place-suites":"Home Place Suites","suite-stay":"Suite Stay"},deferredInstallPrompt:null,frontdeskInstalled:!1,frontdeskInstallReported:!1,bookingApproval:null,bookingConflicts:[],_magicLoginPending:!1,editRooms:[],editRoomsLoadPromise:null,messageUnreadCount:0,messagesInboxOpen:!1,messagesThreadPickerOpen:!1,selectedMessageThread:"",bookingsVirtualList:[],bookingsVirtualRaf:0};let Q=null;function Je(){return typeof lucide<"u"?Promise.resolve():Q||(Q=new Promise((t,e)=>{const o=document.createElement("script");o.src="https://unpkg.com/lucide@0.469.0/dist/umd/lucide.min.js",o.async=!0,o.onload=()=>t(),o.onerror=()=>e(new Error("lucide load failed")),document.head.appendChild(o)}),Q)}async function jt(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let r=e.width,n=e.height;const a=Math.min(1,o/r,i/n);r=Math.round(r*a),n=Math.round(n*a);const s=document.createElement("canvas");s.width=r,s.height=n,s.getContext("2d").drawImage(e,0,0,r,n),e.close();const c=await new Promise((b,k)=>{s.toBlob(S=>S?b(S):k(new Error("encode failed")),"image/webp",.82)}),m=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([c],m+".webp",{type:"image/webp"})}catch{return t}}function Ze(){const t=()=>{u.currentFilter==="bookings"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}const Vt=["cancelled","canceled","released"];function Xe(t){return t?Vt.includes(String(t.status||"").trim().toLowerCase()):!0}function to(t){return String(t?.status||"").trim().toLowerCase()==="pending"}function Gt(t){Object.assign(window,t)}const Wt=14,Yt=10;function pt(t,e,o){return Math.max(e,Math.min(t,o))}function C(t,e,o,i){return{left:t,top:e,width:o,height:i,right:t+o,bottom:e+i}}function _t(){const t=window.visualViewport,e=t?t.offsetLeft:0,o=t?t.offsetTop:0,i=t?t.width:window.innerWidth,r=t?t.height:window.innerHeight;return C(e,o,i,r)}function M(t){if(!t||!t.isConnected)return null;const e=t.getBoundingClientRect();return e.width<2||e.height<2?null:C(e.left,e.top,e.width,e.height)}function Kt(t,e){if(!t||!e)return 0;const o=Math.max(0,Math.min(t.right,e.right)-Math.max(t.left,e.left)),i=Math.max(0,Math.min(t.bottom,e.bottom)-Math.max(t.top,e.top));return o*i}function Qt(t,e){return Math.max(0,e.left-t.left)+Math.max(0,t.right-e.right)+Math.max(0,e.top-t.top)+Math.max(0,t.bottom-e.bottom)}function Jt(t,e){let o=0;for(const i of e||[]){const r=document.querySelector(i);if(!r||getComputedStyle(r).display==="none")continue;const n=M(r);!n||n.bottom<t.bottom-2||n.top>=t.bottom||(o=Math.max(o,t.bottom-n.top))}return o}function Zt(t){const e=_t(),o=t.margin??Wt,i=Math.max(Number(t.bottomInset||0),Jt(e,t.avoidBottomSelectors)),r=e.left+o+Number(t.leftInset||0),n=e.top+o+Number(t.topInset||0),a=e.right-o-Number(t.rightInset||0),s=e.bottom-o-i;return C(r,n,Math.max(1,a-r),Math.max(1,s-n))}function Xt(t){return t==="above"||t==="top"?["top","bottom","right","left"]:t==="right"?["right","left","bottom","top"]:t==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function te(t,e,o,i,r){return t==="top"?C(e.left+(e.width-o)/2,e.top-i-r,o,i):t==="right"?C(e.right+r,e.top+(e.height-i)/2,o,i):t==="left"?C(e.left-o-r,e.top+(e.height-i)/2,o,i):C(e.left+(e.width-o)/2,e.bottom+r,o,i)}function ee(t,e){const o=pt(t.left,e.left,Math.max(e.left,e.right-t.width)),i=pt(t.top,e.top,Math.max(e.top,e.bottom-t.height));return C(o,i,t.width,t.height)}function oe(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function ie(t,e){if(!t||Math.abs(e)<1)return!1;const o=oe(t);return o?o.scrollTop+=e:window.scrollBy({top:e,left:0,behavior:"auto"}),!0}function lt(t,e){const o=M(t);if(!o||e.height<60)return!1;let i;return o.height<=e.height?i=pt(o.top,e.top,e.bottom-o.height):i=e.bottom-o.height,ie(t,o.top-i)}function zt(t,e){const o=getComputedStyle(t);for(const n of o)e.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=t.children,r=e.children;for(let n=0;n<i.length;n+=1)r[n]&&zt(i[n],r[n])}function ne(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function re(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((r,n)=>{const a=i[n];a&&(r.type==="checkbox"||r.type==="radio"?a.checked=r.checked:a.value=r.value)})}function ae(t,e={}){if(!t||!t.isConnected||e.disabled||!M(t))return null;const i=t.cloneNode(!0);ne(i),zt(t,i),re(t,i),i.setAttribute(e.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(e.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",e.prepareClone?.(i,t);const r=t.style.visibility;e.hideSource&&(t.style.visibility="hidden"),document.body.appendChild(i);const n=()=>{const s=M(t);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),e.hideSource&&(t.style.visibility=r)};return n(),{element:i,source:t,update:n,destroy:a}}function se({tooltip:t,panel:e,target:o,anchor:i,spotlight:r,options:n={}}){if(!t||!e||!o)return null;let a=0,s=!1,c=!1,m=!1,b="";const k=(d=!0)=>{if(s||!t.isConnected||!o.isConnected)return null;const p=Zt(n),v=`${p.left}:${p.top}:${p.width}:${p.height}`;b&&b!==v&&(c=!1,d=!0),b=v;const l=M(i)||M(o),f=M(o);if(!l||!f)return null;const x=Math.min(Number(n.maxWidth||380),p.width);t.style.position="fixed",t.style.right="auto",t.style.bottom="auto",t.style.width=`${x}px`,t.style.maxWidth=`${x}px`,t.style.margin="0",t.style.justifyContent="flex-start",e.style.maxHeight=`${Math.max(120,p.height)}px`;const y=Math.min(e.offsetHeight||t.offsetHeight||190,p.height),h=Number(n.gap??Yt);d&&!c&&n.autoScroll!==!1&&f.height+y+h<=p.height&&(c=lt(o,p),c&&requestAnimationFrame(()=>k(!1)));const w=Xt(n.preferredPlacement).map((T,O)=>{const j=te(T,l,x,y,h),Et=Qt(j,p),St=Kt(j,f);return{placement:T,index:O,raw:j,overflow:Et,overlap:St,score:Et*1e5+St*100+O}}),z=w.find(T=>T.overflow<.5&&T.overlap<1),B=z||w.slice().sort((T,O)=>T.score-O.score)[0],I=n.forceDock===!0||!z;let A="floating",F;if(I){A="docked";const T=Math.min(y,Number(n.dockMaxHeight||Math.max(180,p.height*.42)),p.height);e.style.maxHeight=`${T}px`;const O=Math.min(e.offsetHeight||T,T);if(F=C(p.left+(p.width-x)/2,p.bottom-O,x,O),d&&!c&&n.autoScroll!==!1){const j=C(p.left,p.top,p.width,Math.max(60,F.top-h-p.top));c=lt(o,j),c&&requestAnimationFrame(()=>k(!1))}}else if(F=ee(B.raw,p),d&&!c&&n.autoScroll!==!1){let T=p;if(B.placement==="bottom")T=C(p.left,p.top,p.width,Math.max(60,F.top-h-p.top));else if(B.placement==="top"){const O=F.bottom+h;T=C(p.left,O,p.width,Math.max(60,p.bottom-O))}c=lt(o,T),c&&requestAnimationFrame(()=>k(!1))}return t.dataset.tourLayoutMode=A,t.dataset.tourPlacement=I?"bottom-dock":B.placement,t.style.left=`${F.left}px`,t.style.top=`${F.top}px`,r?.update?.(),n.onLayout?.({mode:A,placement:t.dataset.tourPlacement,viewport:p,targetRect:M(o),anchorRect:M(i)||M(o),tooltipRect:F}),{mode:A,placement:t.dataset.tourPlacement,rect:F}},S=(d=!1)=>{m=m||d===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const p=m;m=!1,k(p)}))},P=()=>{c=!1,S(!0)},H=typeof ResizeObserver=="function"?new ResizeObserver(S):null;H?.observe(o),i&&i!==o&&H?.observe(i),H?.observe(e),window.addEventListener("resize",P),window.addEventListener("orientationchange",P),window.addEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",P),window.visualViewport.addEventListener("scroll",S));const dt=()=>{s=!0,a&&cancelAnimationFrame(a),H?.disconnect(),window.removeEventListener("resize",P),window.removeEventListener("orientationchange",P),window.removeEventListener("scroll",S,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",P),window.visualViewport.removeEventListener("scroll",S))},g=k(!0);return{destroy:dt,reposition:()=>k(!1),result:g}}function U(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function et(...t){return U("setFilter")?.(...t)}function de(...t){return U("toast")?.(...t)}function ot(...t){return U("updateGoLiveBanner")?.(...t)}function le(...t){return U("seedTourRevenueShell")?.(...t)}function ce(...t){return U("finishTourHydration")?.(...t)}function pe(...t){return U("goLive")?.(...t)}let Y=null,it=null,q=null;function $(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
    #tourBlurOverlay {
  ...
  `,document.head.appendChild(t)}function ft(){Y&&(document.removeEventListener("keydown",Y),Y=null)}function ue(t){ft(),Y=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",Y)}function ct(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function R(t){$();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=e.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=e.blockPointer?"auto":"none",e.lockScroll&&(document.body.style.overflow="hidden"),o}const Z="rgba(17,24,39,0.42)";function V(){const t=document.getElementById("tourTooltip"),e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!t||e)return Promise.resolve();t.style.pointerEvents="none";const o=t.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function ge(t,e){return q?.destroy(),q=ae(t,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=e?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=e?.spotlightOutlineOffset??"2px",e?.spotlightBackground&&(o.style.background=e.spotlightBackground,o.style.backgroundColor=e.spotlightBackground),e?.spotlightBorderRadius&&(o.style.borderRadius=e.spotlightBorderRadius)}}),q?.element||null}function D(t){const e=t||{};ft(),it?.destroy(),it=null,q?.destroy(),q=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!e.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.style.opacity=n.dataset.tourOrigOpacity||"";const a=n.dataset.tourOrigBackground||"",s=n.dataset.tourOrigBackgroundColor||"";s?n.style.backgroundColor=s:n.style.removeProperty("background-color"),a?n.style.background=a:n.style.removeProperty("background"),n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius,delete n.dataset.tourOrigOpacity});const r=document.getElementById("goLiveBanner");r&&r.dataset.tourHidden&&(delete r.dataset.tourHidden,typeof ot=="function"&&ot()),e.keepOverlay||(document.body.style.overflow="")}function me(){const t=document.getElementById("tourTooltip"),e=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[t,...e,...o].filter(Boolean);return!i.length&&!o.length?(D({keepOverlay:!0}),Promise.resolve()):(ft(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(D({keepOverlay:!0}),Promise.resolve()):(t&&(t.style.pointerEvents="none"),i.forEach(n=>{n.style.transition="opacity 0.07s ease, transform 0.07s ease",n.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(n=>{n.style.opacity="0",n.id==="tourTooltip"&&(n.style.transform="translateY(4px)")})}),new Promise(n=>{setTimeout(()=>{D({keepOverlay:!0}),n()},85)})))}function fe(t){const e=[t,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);e.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{e.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function N(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function L(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function G(t,e){if(e.highlightSelector){const o=L(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function X(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const r=document.querySelector(i);if(r&&r.isConnected)return r}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function nt(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Tt(t,e){const o=L(t.anchorSelector);if(o){const i=nt(o,!0);if(i)return i}return nt(e,!0)}function Bt(t,e){const o=t.tooltipAnchorSelector||t.anchorSelector,i=L(o);if(i){const r=nt(i,!0);if(r)return r}return Tt(t,e)}function rt(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const r=document.querySelector(i);r&&(r.scrollTop=0)})}function It(t,e,o){const i=o||{},r=e.scrollTarget||e.accordionCard,n=(r?L(r):null)||t;if(!n&&!e.scrollToTop)return Promise.resolve();const a=e.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=i.smooth&&!s?"smooth":u.settingsTourActive||s?"auto":"smooth";return new Promise(m=>{if(e.scrollToTop&&(rt(c),e.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&rt("auto"),m()}));return}if(!n){m();return}if(n.scrollIntoView({behavior:c,block:a,inline:"nearest"}),c==="auto"){requestAnimationFrame(()=>requestAnimationFrame(m));return}let b=!1;const k=()=>{b||(b=!0,window.removeEventListener("scrollend",S),clearTimeout(P),requestAnimationFrame(()=>requestAnimationFrame(m)))},S=()=>k();"onscrollend"in window&&window.addEventListener("scrollend",S,{once:!0});const P=setTimeout(k,520)})}function At(){D(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&et("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const r=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof r=="function"&&r({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function W(){D({keepOverlay:!0}),$(),u.settingsTourActive=!1,ot(),R({blockPointer:!0,lockScroll:!0,dim:Z});const t=document.createElement("div");if(t.id="tourTooltip",t.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),!document.getElementById("tourModalAnimStyle")){const e=document.createElement("style");e.id="tourModalAnimStyle",e.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(e)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("tourNextBtn").onclick=()=>{const o="https://"+(u.activeHotelDomain||u.activeHotelId+".mktel.co");navigator.clipboard.writeText(o).catch(()=>{}),V().then(()=>{D(),u.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.setItem("linkCopied","1"),localStorage.removeItem("settingsTourStep"),de("Booking link copied!","success"),ce(),Ct()})}}function Ct(t){$();const e=document.createElement("div");e.id="testDriveOverlay",e.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(e),document.body.style.overflow="hidden",typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{e.remove(),document.body.style.overflow=""};document.getElementById("activateNowBtn").onclick=()=>{o(),pe()},document.getElementById("activateLaterBtn").onclick=()=>{o();const i=document.querySelector('.tab[data-nav-filter="bookings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="bookings"]');i&&et("bookings",i)}}function ut(){if(localStorage.getItem("settingsTourDone"))return;if(localStorage.getItem("settingsTourStep")==="handoff"){localStorage.removeItem("settingsTourStep"),W();return}localStorage.getItem("settingsTourDone")||localStorage.removeItem("settingsTourStep"),u.settingsTourActive=!0,ot(),le();const t=document.querySelector('.tab[data-nav-filter="settings"]')||document.querySelector('.mobile-nav-item[data-nav-filter="settings"]');t&&et("settings",t);function e(){if(typeof window.isEditPageDomReady=="function"&&window.isEditPageDomReady()||typeof isEditPageDomReady=="function"&&isEditPageDomReady()||!(typeof window.needsEditPageLoad=="function"&&window.needsEditPageLoad()||typeof needsEditPageLoad=="function"&&needsEditPageLoad())&&!u.editRoomsLoadPromise)return;const p=typeof window.invokeLoadEditRooms=="function"?window.invokeLoadEditRooms:typeof invokeLoadEditRooms=="function"?invokeLoadEditRooms:null;p&&p()}e();const o=[{target:"#tour-preview-btn",highlightSelector:"#tour-preview-btn",anchorSelector:"#tour-preview-btn",scrollTarget:"#tour-preview-btn",title:"Preview your booking page",text:"Open the exact page guests will use. It is safe to review before activation, so check the basics here first.",openAccordion:!1,tab:"settings",scrollToTop:!0,scrollToTopOnly:!0,forcePageTop:!0,scrollBlock:"start"},{target:"#tour-header-preview-card",highlightSelector:"#tour-header-preview-card",anchorSelector:"#tour-header-preview-card",scrollTarget:"#tour-header-preview-card",title:"Edit your booking page",text:"This page is the source of truth for your guest site. Update the property name, address, phone, policy, rooms, photos, and prices here.",openAccordion:!1,tab:"settings",scrollBlock:"nearest",tooltipPosition:"below",tooltipGap:22},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo-placeholder, #editRoomsCards [data-tour-room-card="1"] .room-edit-photo',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-photo',scrollTarget:'#editRoomsCards [data-tour-room-card="1"]',title:"Add room photos",text:"Use real room photos. A clear first photo makes the page feel legitimate and helps guests decide faster.",openAccordion:!1,tab:"settings",scrollBlock:"center"},{target:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',highlightSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',anchorSelector:'#editRoomsCards [data-tour-room-card="1"] [data-tour-room-details-anchor="1"]',tooltipAnchorSelector:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',scrollTarget:'#editRoomsCards [data-tour-room-card="1"] .room-edit-fields',title:"Edit room details",text:"Room name, description, guest count, amenities, and units all show on the booking page. Keep this short and accurate.",openAccordion:!1,tab:"settings",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10,spotlightBackground:"#fff",spotlightBorderRadius:"12px",spotlightBoxShadow:"none",spotlightOutline:"none",spotlightOutlineOffset:"0"},{target:"#tour-booking-link-card",highlightSelector:"#tour-booking-link-card",anchorSelector:"#tour-booking-link-card",scrollTarget:"#tour-booking-link-card",title:"Share your direct link",text:"This is the link to send guests, add to your website, and place on Google Business Profile. QR tools live here too.",openAccordion:!1,tab:"settings",scrollBlock:"start"},{target:"#tour-rates-card",highlightSelector:"#tour-rates-card",anchorSelector:"#tour-rates-card",scrollTarget:"#tour-rates-card",title:"Set your rates",text:"Set nightly, weekly, and monthly prices before you share the link. Guests book from these rates on your direct page.",openAccordion:!0,accordionCard:"#tour-rates-card",tab:"settings",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#bookingsList",text:"",openAccordion:!1,tab:"bookings",customModal:!0},{target:"#availabilityCalendarWrap",text:"",openAccordion:!1,tab:"availability",customModal:"availability"},{target:".revenue-savings-pill",title:"Track revenue and payment status",text:"Revenue shows direct bookings, card status, and estimated OTA commission savings. Cards are verified, and you collect payment at check-in.",openAccordion:!1,tab:"revenue",waitForVisible:!0,scrollBlock:"start"},{target:"",text:"",openAccordion:!1,tab:"apps",customModal:"guestAppsStory"}];let i=parseInt(localStorage.getItem("settingsTourStep")||"0",10);(!Number.isFinite(i)||i<0||i>=o.length)&&(i=0,localStorage.removeItem("settingsTourStep"));function r(g){D(g)}function n(){V().then(()=>{r({keepOverlay:!0}),localStorage.removeItem("settingsTourStep"),W()})}function a(g,d){return!(!g||!d||g.customModal||d.customModal||g.tab!==d.tab||!g.target||!d.target)}function s(g,d){if(g.customModal){m(g,d);return}requestAnimationFrame(()=>m(g,d))}function c(g){const d=g||{};if(d.keepCurrentUi||r({keepOverlay:!0}),document.body.style.overflow="",i>=o.length){r({keepOverlay:!0}),localStorage.removeItem("settingsTourStep"),W();return}const p=o[i];if(p.tab==="revenue"&&!u.revenueEnabled){i++,localStorage.setItem("settingsTourStep",String(i)),c();return}if(p.tab==="apps"&&!(isStandaloneApp()||u.frontdeskInstalled)&&p.target&&!p.target.includes("tour-fd-install")){i++,localStorage.setItem("settingsTourStep",String(i)),c();return}if(p.customModal||R(),p.tab&&p.tab!==u.currentFilter){const v=document.querySelector(`.tab[data-nav-filter="${p.tab}"]`)||document.querySelector(`.mobile-nav-item[data-nav-filter="${p.tab}"]`);if(v&&et(p.tab,v),p.tab==="apps"){const l=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof l=="function"&&l(!0)}s(p,d);return}s(p,d)}function m(g,d){const p=d||{};if(g.customModal==="homescreen"){p.keepCurrentUi&&r({keepOverlay:!0}),P();return}if(g.customModal===!0||g.customModal==="bookings"){p.keepCurrentUi&&r({keepOverlay:!0}),dt();return}if(g.customModal==="availability"){p.keepCurrentUi&&r({keepOverlay:!0}),H();return}if(g.customModal==="finale"){p.keepCurrentUi&&r({keepOverlay:!0}),W();return}if(g.customModal==="guestAppsStory"){p.keepCurrentUi&&r({keepOverlay:!0}),At();return}if(g.waitForVisible){const f=g.target.split(",").map(w=>w.trim());let x=0;const y=30;R();const h=u.settingsTourActive?60:200,E=()=>{if(x++,g.tab==="apps"){const z=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof z=="function"&&z(!0)}let w=null;for(const z of f)if(w=document.querySelector(z),w)break;if(w&&(g.openAccordion&&N(w,g),g.openAccordion||w.offsetParent!==null)){b(w,g,p);return}x<y?setTimeout(E,h):(i++,localStorage.setItem("settingsTourStep",String(i)),c())};E();return}function v(f){const x=f.target.split(",").map(y=>y.trim());for(const y of x){const h=document.querySelector(y);if(h&&!(!f.openAccordion&&h.offsetParent===null&&getComputedStyle(h).position!=="fixed"))return h}if(f.accordionCard){const y=document.querySelector(f.accordionCard);if(y)return y}return null}function l(f,x){const y=v(f);if(y){x(y);return}const h=f.tab==="settings"&&!f.customModal&&f.target,E=f.tab==="apps"&&!f.customModal&&f.target;if(!h&&!E){i++,localStorage.setItem("settingsTourStep",String(i)),c();return}R();let w=0;if(h&&e(),E){const I=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof I=="function"&&I(!0)}const z=u.settingsTourActive?60:250,B=()=>{if(w++,E){const A=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof A=="function"&&A(!0)}const I=v(f);if(I){x(I);return}if(e(),E){const A=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof A=="function"&&A(!0)}w<48?setTimeout(B,z):(i++,localStorage.setItem("settingsTourStep",String(i)),c())};B()}l(g,f=>b(f,g,p))}function b(g,d,p){const v=p||{};if(N(g,d),g=G(g,d),(!g||!g.isConnected)&&(g=X(g,d),g&&(g=G(g,d))),!g){i++,localStorage.setItem("settingsTourStep",String(i)),c();return}const l=g;R(),It(l,d,{smooth:!!v.keepCurrentUi}).then(()=>{if(d.forcePageTop&&rt("auto"),!l.isConnected){i++,localStorage.setItem("settingsTourStep",String(i)),c();return}N(l,d),v.keepCurrentUi&&(r({keepOverlay:!0}),R()),d.noHighlight||(l.dataset.tourOrigPosition||(l.dataset.tourOrigPosition=l.style.position||""),l.dataset.tourOrigZIndex||(l.dataset.tourOrigZIndex=l.style.zIndex||""),l.dataset.tourOrigIsolation||(l.dataset.tourOrigIsolation=l.style.isolation||""),l.dataset.tourOrigBoxShadow||(l.dataset.tourOrigBoxShadow=l.style.boxShadow||""),l.dataset.tourOrigOutline||(l.dataset.tourOrigOutline=l.style.outline||""),l.dataset.tourOrigOutlineOffset||(l.dataset.tourOrigOutlineOffset=l.style.outlineOffset||""),l.dataset.tourOrigTransition||(l.dataset.tourOrigTransition=l.style.transition||""),l.dataset.tourOrigBackground||(l.dataset.tourOrigBackground=l.style.background||""),l.dataset.tourOrigBackgroundColor||(l.dataset.tourOrigBackgroundColor=l.style.backgroundColor||""),l.dataset.tourOrigBorderRadius||(l.dataset.tourOrigBorderRadius=l.style.borderRadius||""),l.dataset.tourOrigOpacity||(l.dataset.tourOrigOpacity=l.style.opacity||""),l.style.position=l.style.position||"relative",l.style.zIndex="99999",l.style.isolation="isolate",l.style.transition="box-shadow 0.18s ease, outline 0.18s ease",l.style.boxShadow="0 0 0 1px rgba(255,255,255,0.92), 0 18px 46px rgba(26,43,34,0.22)",l.style.outline="1px solid rgba(255,255,255,0.82)",l.style.outlineOffset="2px",d.spotlightBoxShadow!=null&&(l.style.boxShadow=d.spotlightBoxShadow),d.spotlightOutline!=null&&(l.style.outline=d.spotlightOutline),d.spotlightOutlineOffset!=null&&(l.style.outlineOffset=d.spotlightOutlineOffset),d.spotlightBackground&&(l.style.background=d.spotlightBackground,l.style.backgroundColor=d.spotlightBackground),d.spotlightBorderRadius&&(l.style.borderRadius=d.spotlightBorderRadius),v.keepCurrentUi&&(l.style.opacity="0"),l.setAttribute("data-tour-highlighted","1")),document.body.style.overflow="";const f=()=>{const h=L(d.anchorSelector)||l;if(d.freezeTooltip){const B=h&&h.isConnected?h.getBoundingClientRect():null;k(h,d,B&&B.width>=2?B:null,{fadeIn:!!v.keepCurrentUi});return}const E=X(l,d);let w=E?G(E,d):l;N(w,d);const z=d.tooltipAnchor?null:Bt(d,w);k(w||l,d,z,{fadeIn:!!v.keepCurrentUi})};if(d.freezeTooltip){requestAnimationFrame(()=>requestAnimationFrame(f));return}const x=(y=0)=>{requestAnimationFrame(()=>{if(d.forcePageTop&&rt("auto"),d.tooltipAnchor){f();return}const h=X(l,d);let E=h?G(h,d):l;N(E,d);const w=Bt(d,E);if(!w&&y<4){requestAnimationFrame(()=>x(y+1));return}k(E||l,d,w,{fadeIn:!!v.keepCurrentUi})})};x(0)})}function k(g,d,p,v){const l=v||{},f=document.getElementById("tourTooltip");f&&f.remove(),$();const x=document.createElement("div");x.id="tourTooltip";const y=Math.min(i+1,o.length),h=Math.max(8,Math.min(100,Math.round(y/o.length*100))),E=ct(d.title||"Quick setup"),w=ct(d.text||""),z=d.primaryLabel||(i<o.length-1?"Next":"Got it"),B=i<=0;x.style.cssText="position:fixed;z-index:100000;left:12px;right:12px;bottom:calc(14px + env(safe-area-inset-bottom,0px));display:flex;justify-content:center;pointer-events:none;visibility:hidden;",x.innerHTML=`
      <div class="tour-panel" role="dialog" aria-live="polite" aria-label="${E}">
        ...
        <div class="tour-actions">
          ...
          <button id="tourNextBtn" class="tour-btn tour-btn-primary" type="button">${ct(z)}</button>
        </div>
      </div>`,document.body.appendChild(x);const I=x.querySelector(".tour-panel"),A=L(d.tooltipAnchorSelector||d.anchorSelector)||g;d.noHighlight||ge(g,d),it?.destroy(),it=se({tooltip:x,panel:I,target:g,anchor:A,spotlight:q,options:{preferredPlacement:d.tooltipPosition||"auto",maxWidth:380,gap:d.tooltipGap??10,autoScroll:d.autoScroll!==!1,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),x.style.visibility="visible",l.fadeIn&&fe(x),S()}function S(){const g=document.getElementById("tourNextBtn"),d=document.getElementById("tourSkipBtn"),p=y=>{if(y<0)return;const h=a(o[i],o[y]),E=()=>{i=y,localStorage.setItem("settingsTourStep",String(i)),c({keepCurrentUi:h})};me().then(E)},v=()=>{p(i+1)},l=()=>{n()},f=()=>{i<=0||p(i-1)};g&&(g.onclick=v),d&&(d.onclick=l);const x=document.getElementById("tourBackBtn");x&&(x.onclick=f),ue({onNext:v,onBack:f,onSkip:l})}function P(){$(),typeof invokeLoadEditRooms=="function"&&invokeLoadEditRooms(),R({blockPointer:!0,lockScroll:!0,dim:Z});const g=u.activeHotelName||"Your Property",d=g.trim().charAt(0).toUpperCase(),p=g.length>10?g.slice(0,10):g,v="width:32px;display:flex;flex-direction:column;align-items:center;gap:5px;",l="width:32px;height:32px;border-radius:9px;box-sizing:border-box;",f="height:8px;max-width:46px;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;",x=`<div style="${v}"><div style="${l}background:rgba(255,255,255,0.22);"></div><div style="${f}"></div></div>`,y=u.activeHotelAppIcon||"",h=y?`<img src="${y}" alt="" style="width:100%;height:100%;object-fit:contain;">`:d,E=y?`${l}background:#fff;padding:5px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`:`${l}background:#fff;color:#2E7D5B;font-weight:800;font-size:15px;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.95);box-shadow:0 6px 14px rgba(0,0,0,0.28);`,w=`<div style="${v}"><div style="${E}">${h}</div><div style="${f}font-size:7.5px;color:#fff;font-weight:700;">${p}</div></div>`,z=[x,x,x,x,w,x,x,x].join(""),B=document.createElement("div");if(B.id="tourTooltip",B.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:20px 16px;",B.innerHTML=`
      ...
      <div style="padding:0 14px 14px;">
      ...
      </div>`],p=document.createElement("div");p.id="tourTooltip",p.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";let v=!1;function l(){const x=g>=d.length-1?"Next — Revenue →":"Next →",y=v?"none":"tourPanelIn 0.22s ease-out",h=v?"tourPageIn 0.18s ease-out":"none";p.innerHTML=`
        ...
        </div>`,v=!0,document.getElementById("tourNextBtn").onclick=()=>{g<d.length-1?(g++,l()):V().then(()=>{r({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),c()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}}if(document.body.appendChild(p),l(),!document.getElementById("tourModalAnimStyle")){const f=document.createElement("style");f.id="tourModalAnimStyle",f.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(f)}}function dt(){$(),R({blockPointer:!0,lockScroll:!0,dim:Z});let g=0,d=!1;const p=[`
        ...
        </div>`],v=document.createElement("div");v.id="tourTooltip",v.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;";const l=()=>{const f=g>=p.length-1,x=g===0?"Next — Phone alerts →":g===1?"Next — If plans change →":"Next — Availability →",y=d?"none":"tourPanelIn 0.22s ease-out",h=d?"tourPageIn 0.18s ease-out":"none";v.innerHTML=`
        <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;max-height:86vh;overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:${y};">
          <div style="animation:${h};">${p[g]}</div>
          <div style="padding:2px 18px 7px;text-align:center;">
            <div style="display:flex;justify-content:center;gap:6px;">
              ${p.map((E,w)=>`<div style="width:8px;height:8px;border-radius:50%;background:${w===g?"#2E7D5B":"#D8E4DC"};transition:background 0.2s ease;"></div>`).join("")}
            </div>
          </div>
          <div style="padding:0 18px 20px;text-align:center;">
        ...
        </div>`,d=!0,document.getElementById("tourNextBtn").onclick=()=>{if(!f){g++,l();return}V().then(()=>{r({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),c()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}};if(document.body.appendChild(v),l(),!document.getElementById("tourModalAnimStyle")){const f=document.createElement("style");f.id="tourModalAnimStyle",f.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(f)}}c()}async function Pt(){const t=document.getElementById("settingsList");if(t){t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const e=await api("GET","/api/crm/verify"),i="https://"+(e?.domain||u.activeHotelId+".mktel.co"),r="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(i),n=await api("GET","/api/crm/rooms");let a={nightly:69,weekly:299,monthly:999};n?.rates&&(a=n.rates);const s=n?.rooms||[];let c="";e?.subscribed||(c+=goLiveInlineCardHtml()),s.length?s.forEach(m=>{const b=m.images&&m.images.length>0;c+=`
    ...
    `,t.innerHTML=c}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load settings</div></div>'}}}function xe(){const t=document.getElementById("settings-booking-url");t&&navigator.clipboard.writeText(t.value).then(()=>{localStorage.setItem("linkCopied","1"),_(),toast("Link copied!","success")}).catch(()=>toast("Copy failed","error"))}function ye(){localStorage.setItem("settingsTourDone","1");const t=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",t);let e=0;const o=setInterval(()=>{e++;const i=document.getElementById("edit-rate-nightly");if(i||e>20){if(clearInterval(o),!i)return;const r=i.closest(".accordion-body");if(r&&r.style.display==="none"){r.style.display="block";const n=r.previousElementSibling?.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const n=document.getElementById("checklistPointer");n&&n.remove();const a=i.getBoundingClientRect(),s=document.createElement("div");s.id="checklistPointer",s.style.cssText=`position:fixed;z-index:100000;left:50%;transform:translateX(-50%);top:${a.bottom+12}px;max-width:240px;width:calc(100% - 40px);`,s.innerHTML=`
          ...
          `,document.body.appendChild(s),setTimeout(()=>{const c=document.getElementById("checklistPointer");c&&c.remove()},6e3)},1e3)},100)}},200)}function he(){const e="https://"+(u.activeHotelDomain||u.activeHotelId+".mktel.co");navigator.clipboard.writeText(e).then(()=>{localStorage.setItem("linkCopied","1"),_(),toast("Link copied!","success"),loadBookings()}).catch(()=>toast("Copy failed","error"))}function ve(t,e){localStorage.setItem("settingsTourDone","1");const o=document.querySelector('[data-nav-filter="settings"]');setFilter("settings",o);let i=0;const r=setInterval(()=>{i++;const n=document.querySelector(t);if(n||i>20){if(clearInterval(r),!n)return;n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{const a=document.getElementById("checklistPointer");a&&a.remove();const s=n.getBoundingClientRect(),c=document.createElement("div");c.id="checklistPointer",c.style.cssText=`
        ...
        `,document.body.appendChild(c),setTimeout(()=>{const m=document.getElementById("checklistPointer");m&&m.remove()},6e3)},1e3)}},200)}function xt(){const t=String(u.token||localStorage.getItem("crmToken")||"").trim();return t&&(u.token=t),t}async function yt(t,e){const o=xt();if(!o)throw new Error("Not logged in");const i=await jt(e),r=new FormData;r.append("image",i,i.name||"room.webp");const n=new URLSearchParams;u.activeHotelId&&n.set("hotelId",u.activeHotelId),n.set("token",o);const a=await fetch(`/api/crm/rooms/${t}/images?${n}`,{method:"POST",headers:{"x-crm-token":o},body:r}),s=await a.json().catch(()=>({}));if(!a.ok||!s.success)throw new Error(s.message||s.error||`Upload failed (${a.status})`);return s}async function be(t,e){const o=t.target.files[0];if(o)try{await yt(e,o),toast("Photo uploaded!","success"),Pt()}catch(i){toast(i.message||"Upload failed","error")}}async function we(){const t=parseFloat(document.getElementById("settings-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("settings-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("settings-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),toast("Rates saved","success")}catch{toast("Failed to save rates","error")}}async function ke(){const t=document.getElementById("settings-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");u.token=t,u.isMasterPin=!1;try{localStorage.setItem("crmToken",u.token)}catch{}toast("PIN updated!","success"),document.getElementById("settings-new-pin").value=""}catch(e){toast(e.message||"Failed to change PIN","error")}}async function Ee(){const t=document.getElementById("settings-support-msg")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),toast("Message sent!","success"),document.getElementById("settings-support-msg").value=""}catch{toast("Failed to send","error")}}function Se(){const t=u.activeHotelDomain||u.activeHotelId+".mktel.co",o=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://localhost:5173/?hotelId="+encodeURIComponent(u.activeHotelId)+"&preview=1":"https://"+t+"?preview=1";window.open(o,"_blank")}function Ot(){if((window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&u.activeHotelId)return"http://localhost:5173/?hotelId="+encodeURIComponent(u.activeHotelId);const e=u.activeHotelDomain||"";return e?"https://"+e+"/":""}function Be(){const t=Ot();if(!t){toast("Your booking domain is still setting up.","info");return}window.open(t,"_blank")}function ze(){const t=document.getElementById("previewSiteBar");t&&(t.style.display=u.currentFilter==="settings"?"block":"none")}function _(){if(localStorage.getItem("settingsTourDone"))return;const t=parseInt(localStorage.getItem("settingsTourStep")||"0"),e=u.editRooms.some(a=>a.images&&a.images.length>0),o=!!localStorage.getItem("ratesChanged"),i=!!localStorage.getItem("linkCopied");t===2&&e&&localStorage.setItem("settingsTourStep","3"),t===3&&i&&localStorage.setItem("settingsTourStep","4"),t===4&&o&&localStorage.setItem("settingsTourStep","5");const r=document.getElementById("tourTooltip");r&&r.remove();const n=document.getElementById("tourBlurOverlay");n&&n.remove(),document.querySelectorAll("[data-tour-highlighted]").forEach(a=>{a.style.position=a.dataset.tourOrigPosition||"",a.style.zIndex=a.dataset.tourOrigZIndex||"",a.style.isolation=a.dataset.tourOrigIsolation||"",a.style.boxShadow=a.dataset.tourOrigBoxShadow||"",a.style.outline=a.dataset.tourOrigOutline||"",a.style.outlineOffset=a.dataset.tourOrigOutlineOffset||"",a.style.transition=a.dataset.tourOrigTransition||"",a.style.borderRadius=a.dataset.tourOrigBorderRadius||"",a.style.opacity=a.dataset.tourOrigOpacity||"";const s=a.dataset.tourOrigBackground||"",c=a.dataset.tourOrigBackgroundColor||"";c?a.style.backgroundColor=c:a.style.removeProperty("background-color"),s?a.style.background=s:a.style.removeProperty("background"),a.removeAttribute("data-tour-highlighted"),delete a.dataset.tourOrigPosition,delete a.dataset.tourOrigZIndex,delete a.dataset.tourOrigIsolation,delete a.dataset.tourOrigBoxShadow,delete a.dataset.tourOrigOutline,delete a.dataset.tourOrigOutlineOffset,delete a.dataset.tourOrigTransition,delete a.dataset.tourOrigBackground,delete a.dataset.tourOrigBackgroundColor,delete a.dataset.tourOrigBorderRadius,delete a.dataset.tourOrigOpacity}),document.body.style.overflow=""}function Te(){let t=0;const e={},o=[{title:"Why do you want a booking page?",key:"why",type:"text",placeholder:"e.g. I want guests to book directly instead of calling me..."},{title:"How do guests currently book with you?",key:"currentBooking",type:"choice",options:[{label:"They call me or walk in",value:"phone_walkin"},{label:"Through Booking.com / Expedia",value:"ota"},{label:"I have a website but no booking system",value:"website_no_booking"},{label:"I don't take bookings online yet",value:"no_online"}]},{title:"How many bookable rooms or units do you offer?",key:"roomCount",type:"choice",options:[{label:"1–5 rooms",value:"1-5"},{label:"6–15 rooms",value:"6-15"},{label:"16–50 rooms",value:"16-50"},{label:"50+ rooms",value:"50+"}]},{title:"What's most important to you?",key:"priority",type:"choice",options:[{label:"Stop paying OTA commissions",value:"no_commission"},{label:"Get more direct bookings",value:"more_bookings"},{label:"Have a professional online presence",value:"professional"},{label:"Make it easier for guests to book",value:"easier_booking"}]}];function i(){let r=document.getElementById("onboardingOverlay");if(r&&r.remove(),t>=o.length){localStorage.setItem("onboardingDone","1");try{api("POST","/api/crm/onboarding-answers",e).catch(()=>{})}catch{}Rt();return}const n=o[t],a=document.createElement("div");a.id="onboardingOverlay",a.style.cssText="position:fixed;inset:0;z-index:100001;background:linear-gradient(135deg, #1a2b22 0%, #2E7D5B 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;",n.type==="text"?(a.innerHTML=`
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),ht()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}async function vt(){if(isEditPageDomReady())return;if(u.editRoomsLoadPromise)return u.editRoomsLoadPromise;const t=document.getElementById("editRoomsList");if(t){u.editRoomsLoadPromise=(async()=>{t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[e,o]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify")]);if(!e.rooms)throw new Error("No data");u.editRooms=e.rooms;const i=o?.hotelName||"";i&&(u.activeHotelName=i),o&&(u.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const r=o?.hotelSubtitle||"",n=o?.hotelAddress||"",a=o?.hotelPhone||"",s=o?.appIconUrl||"";u.activeHotelAppIcon=s,updateFrontdeskManifestLink();let c={nightly:69,weekly:299,monthly:999,taxRate:.1};e.rates&&(c=e.rates);const b="https://"+(o?.domain||u.activeHotelId+".mktel.co"),k="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(b);let S=`
      ...
      <div class="room-edit-fields" style="padding:18px;">
        ...
        <div style="margin-bottom:12px;">
          ...
          <div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:8px;" id="edit-amenity-pills-${e.id}">
            ${i.map(a=>`<span style="display:inline-flex;align-items:center;gap:4px;background:var(--green-pale);color:var(--green);padding:5px 10px;border-radius:8px;font-size:12px;font-weight:600;">${Dt(a)} ${a} <button onclick="removeAmenity('${e.id}','${a.replace(/'/g,"\\'")}')" style="background:none;border:none;color:var(--green);cursor:pointer;font-size:14px;margin-left:2px;">×</button></span>`).join("")}
          </div>
    ...
    </div>`}).join(""),typeof lucide<"u"&&lucide.createIcons()}}function Mt(t){const e=u.editRooms.find(o=>String(o.id)===String(t));return(e&&e.images||[]).filter(o=>o&&o.url)}function Ft(t,e){const o=Mt(t);if(!o.length)return;const i=document.getElementById("edit-card-"+t);if(!i)return;const r=o.length,n=((Number(e)||0)%r+r)%r,a=i.querySelector(".room-edit-main-img");a&&(a.src=o[n].url),i.querySelector(".room-edit-photo")?.setAttribute("data-photo-index",String(n));const s=i.querySelector(".room-edit-photo-count");s&&(s.textContent=n+1+" / "+r),i.querySelectorAll(".room-edit-image-dot").forEach((c,m)=>{c.classList.toggle("active",m===n),m===n?c.setAttribute("aria-current","true"):c.removeAttribute("aria-current")}),i.querySelectorAll(".room-edit-thumb").forEach((c,m)=>{c.classList.toggle("active",m===n),m===n?c.setAttribute("aria-current","true"):c.removeAttribute("aria-current")})}function Ce(t,e){const i=document.getElementById("edit-card-"+t)?.querySelector(".room-edit-photo"),r=parseInt(i?.getAttribute("data-photo-index")||"0",10)||0;Ft(t,r+e)}function Dt(t){const e=t.toLowerCase();return e.includes("wifi")?'<i data-lucide="wifi" style="width:14px;height:14px;"></i>':e.includes("tv")||e.includes("television")?'<i data-lucide="tv" style="width:14px;height:14px;"></i>':e.includes("fridge")||e.includes("refrigerator")?'<i data-lucide="thermometer-snowflake" style="width:14px;height:14px;"></i>':e.includes("parking")?'<i data-lucide="car" style="width:14px;height:14px;"></i>':e.includes("housekeeping")||e.includes("cleaning")?'<i data-lucide="sparkles" style="width:14px;height:14px;"></i>':e.includes("bath")||e.includes("shower")?'<i data-lucide="bath" style="width:14px;height:14px;"></i>':e.includes("work")||e.includes("desk")?'<i data-lucide="laptop" style="width:14px;height:14px;"></i>':e.includes("pet")||e.includes("dog")?'<i data-lucide="paw-print" style="width:14px;height:14px;"></i>':e.includes("pool")?'<i data-lucide="waves" style="width:14px;height:14px;"></i>':e.includes("kitchen")||e.includes("microwave")?'<i data-lucide="cooking-pot" style="width:14px;height:14px;"></i>':'<i data-lucide="check" style="width:14px;height:14px;"></i>'}const $t=[{key:"wifi",label:"Free WiFi",icon:"wifi"},{key:"tv",label:"Smart TV",icon:"tv"},{key:"fridge",label:"Fridge",icon:"thermometer-snowflake"},{key:"parking",label:"Free Parking",icon:"car"},{key:"housekeeping",label:"Weekly Housekeeping",icon:"sparkles"},{key:"bath",label:"Bath",icon:"bath"},{key:"workstation",label:"Workstation",icon:"laptop"},{key:"pet",label:"Pet Friendly",icon:"paw-print"},{key:"pool",label:"Pool",icon:"waves"},{key:"kitchen",label:"Kitchenette",icon:"cooking-pot"},{key:"ac",label:"Air Conditioning",icon:"wind"},{key:"laundry",label:"Laundry",icon:"shirt"}];let wt=null;function Lt(t){wt=t;const o=(u.editRooms.find(n=>n.id===t)?.amenities||"").split("•").map(n=>n.trim().toLowerCase()).filter(Boolean);let i=document.getElementById("amenityPickerModal");i||(document.body.insertAdjacentHTML("beforeend",`
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",st),i=document.getElementById("amenityPickerModal"));const r=document.getElementById("amenityPickerGrid");r.innerHTML=$t.map(n=>{const a=o.some(s=>s.includes(n.key));return`<button onclick="toggleAmenityPreset(this,'${n.key}')" data-key="${n.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${a?"#2E7D5B":"#e5e7eb"};background:${a?"#E8F5EE":"white"};color:${a?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${n.icon}" style="width:14px;height:14px;"></i> ${n.label}</button>`}).join(""),document.getElementById("amenityCustomInput").value="",i.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function Pe(t,e){const o=t.style.borderColor==="rgb(46, 125, 91)";t.style.borderColor=o?"#e5e7eb":"#2E7D5B",t.style.background=o?"white":"#E8F5EE",t.style.color=o?"#1a1a2e":"#2E7D5B"}function st(){document.getElementById("amenityPickerModal").style.display="none",wt=null}function Oe(){const t=u.editRooms.find(r=>r.id===wt);if(!t){st();return}const e=document.getElementById("amenityPickerGrid"),o=[];e.querySelectorAll("button").forEach(r=>{if(r.style.background==="rgb(232, 245, 238)"){const n=$t.find(a=>a.key===r.dataset.key);n&&o.push(n.label)}});const i=document.getElementById("amenityCustomInput").value.trim();i&&o.push(i),t.amenities=o.join(" • "),st(),bt(),typeof lucide<"u"&&lucide.createIcons()}function Re(t){Lt(t)}function Me(t,e){const o=u.editRooms.find(r=>r.id===t);if(!o)return;const i=(o.amenities||"").split("•").map(r=>r.trim()).filter(Boolean);o.amenities=i.filter(r=>r!==e).join(" • "),bt(),typeof lucide<"u"&&lucide.createIcons()}async function Fe(){const t=document.getElementById("edit-hotel-name")?.value.trim(),e=document.getElementById("edit-hotel-subtitle")?.value.trim(),o=document.getElementById("edit-hotel-address")?.value.trim(),i=document.getElementById("edit-hotel-phone")?.value.trim(),r=document.getElementById("edit-hotel-policy")?.value.trim();try{await api("POST","/api/crm/hotel-info",{name:t,subtitle:e,address:o,phone:i,cancellationPolicy:r}),toast("Property info saved!","success")}catch{toast("Failed to save","error")}}async function De(){const t=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),localStorage.setItem("ratesChanged","1"),u.launchStatus=null,_(),toast("Rates saved!","success")}catch{toast("Failed to save rates","error")}}async function $e(){const t=document.getElementById("edit-new-pin")?.value.trim();if(!t||t.length<4){toast("PIN must be at least 4 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");u.token=t,u.isMasterPin=!1;try{localStorage.setItem("crmToken",u.token)}catch{}toast("PIN updated!","success")}catch(e){toast(e.message||"Failed to change PIN","error")}}function Le(t){navigator.clipboard.writeText(t).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function He(t){const e=t.nextElementSibling,o=t.querySelector(".accordion-arrow");e.style.display==="none"?(e.style.display="block",o&&(o.style.transform="rotate(90deg)")):(e.style.display="none",o&&(o.style.transform="rotate(0deg)"))}let J=!1;function Ht(){if(document.getElementById("goLiveOverlay"))return;const t=document.createElement("div");t.id="goLiveOverlay",t.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(255,255,255,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;",t.innerHTML='<div class="logo-sprite-bounce"></div><div style="font-size:14px;font-weight:700;color:#1a5c3f;">Opening secure checkout…</div><div style="font-size:12px;color:#6b7280;">Taking you to Stripe — one moment</div>',document.body.appendChild(t)}function gt(){const t=document.getElementById("goLiveOverlay");t&&t.remove()}async function Ne(){if(!J){J=!0,Ht();try{const t=await api("POST","/api/crm/go-live");if(t.success&&t.url){window.location.href=t.url;return}gt(),J=!1,toast(t.message||"Failed to start checkout","error")}catch{gt(),J=!1,toast("Failed to start checkout. Try again.","error")}}}async function qe(){try{const t=await api("GET","/api/crm/billing-portal");t.success&&t.url?window.location.href=t.url:toast(t.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function Ue(){const t=document.getElementById("supportMessage")?.value.trim();if(!t){toast("Please enter a message","error");return}try{await api("POST","/api/crm/support",{message:t}),document.getElementById("supportMessage").value="",toast("Message sent! We'll reply to your email.","success")}catch{toast("Failed to send. Email support@bookmarketel.com directly.","error")}}async function je(t){const e=u.editRooms.find(s=>s.id===t);if(!e){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+t)?.value.trim(),i=document.getElementById("edit-desc-"+t)?.value.trim(),r=parseInt(document.getElementById("edit-occ-"+t)?.value)||4,n=parseInt(document.getElementById("edit-units-"+t)?.value)||1,a={id:t,name:o||e.name,description:i||"",amenities:e.amenities||"",maxOccupancy:r,totalUnits:n};try{const s=await api("POST","/api/crm/rooms",a);if(s&&s.success===!1){toast(s.message||"Failed to save","error");return}e.name=a.name,e.description=a.description,e.maxOccupancy=r,e.totalUnits=n,toast("Room saved!","success")}catch(s){toast("Failed to save: "+(s.message||""),"error")}}async function Ve(t,e){const o=Array.from(t.target.files);if(!o.length)return;const r=document.getElementById("edit-card-"+e)?.querySelector("div:first-child");r&&(r.style.position="relative",r.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+e+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+e+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let n=0,a="";for(const c of o){try{const b=await yt(e,c);if(b.image){const k=u.editRooms.find(S=>S.id===e);k&&(k.images||(k.images=[]),k.images.push(b.image),k.imageUrl||(k.imageUrl=b.image.url)),n++}}catch(b){a=b.message||"Upload failed"}const m=document.getElementById("upload-progress-"+e);m&&(m.textContent=n+" / "+o.length)}const s=document.getElementById("upload-spinner-"+e);s&&s.remove(),K(),n>0&&(u.launchStatus=null),_(),n>0?toast(n+" photo"+(n!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success"):toast(a||"Upload failed","error")}function Nt(t,e=512){return new Promise((o,i)=>{const r=new Image,n=URL.createObjectURL(t);r.onload=()=>{try{const a=Math.min(r.naturalWidth,r.naturalHeight),s=(r.naturalWidth-a)/2,c=(r.naturalHeight-a)/2,m=document.createElement("canvas");m.width=e,m.height=e;const b=m.getContext("2d");b.imageSmoothingQuality="high",b.drawImage(r,s,c,a,a,0,0,e,e),URL.revokeObjectURL(n),m.toBlob(k=>k?o(k):i(new Error("crop failed")),"image/png",.92)}catch(a){URL.revokeObjectURL(n),i(a)}},r.onerror=()=>{URL.revokeObjectURL(n),i(new Error("load failed"))},r.src=n})}function qt(){const t=document.getElementById("appsAppIconPreview");t&&(t.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function kt(t){const e=document.getElementById("appsAppIconPreview");e&&(e.style.background="#fff",e.style.border="1px solid var(--border)",e.style.padding="0",e.innerHTML='<img src="'+t+'" alt="App icon" style="width:100%;height:100%;object-fit:contain;">')}function mt(){const t=document.getElementById("appsAppIconPreview");if(!t)return;if(u.activeHotelAppIcon){kt(u.activeHotelAppIcon);return}const e=(u.activeHotelName||"P").trim().charAt(0).toUpperCase()||"🏡";t.style.background="transparent",t.style.border="none",t.style.padding="0",t.innerHTML='<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">'+e+"</span>"}async function Ge(t){const e=t.files&&t.files[0];if(!e)return;qt();const o=new FormData;try{const i=await Nt(e,512);o.append("icon",i,"app-icon.png")}catch{o.append("icon",e)}try{const i=xt(),r=new URLSearchParams;u.activeHotelId&&r.set("hotelId",u.activeHotelId),i&&r.set("token",i);const a=await(await fetch(`/api/crm/hotel-app-icon?${r}`,{method:"POST",headers:{"x-crm-token":i},body:o})).json();if(a.success&&a.appIconUrl){u.activeHotelAppIcon=a.appIconUrl,kt(a.appIconUrl);const s=document.getElementById("appsView");s&&(s.dataset.appsKey=(u.activeHotelId||"")+"|"+a.appIconUrl+"|"+(u.activeHotelDomain||"")),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Logo updated! Guests will see it on their phone.","success")}else toast(a.message||"Failed to upload icon","error"),mt()}catch{toast("Failed to upload icon","error"),mt()}t.value=""}async function We(t,e){if(confirm("Delete this photo?"))try{await api("DELETE",`/api/crm/rooms/${t}/images/${e}`);const o=u.editRooms.find(i=>i.id===t);o&&o.images&&(o.images=o.images.filter(i=>i.id!==e),o.imageUrl=o.images[0]?.url||null),K(),toast("Photo deleted","success")}catch{toast("Failed to delete","error")}}async function Ye(t){if(confirm("Delete this room type?"))try{await api("DELETE",`/api/crm/rooms/${t}`),toast("Room deleted","success"),vt()}catch{toast("Failed to delete","error")}}function _e(){const t=document.getElementById("editRoomsList");document.getElementById("editAddForm")||(t.insertAdjacentHTML("beforeend",`
  ...
  `),document.getElementById("editNewRoomName").focus())}function Ke(){const t=document.getElementById("editNewRoomName").value.trim();t&&api("POST","/api/crm/rooms",{name:t,maxOccupancy:4,totalUnits:5}).then(()=>{toast("Room added","success"),vt()}).catch(()=>toast("Failed to add","error"))}const Ut={addAmenityPrompt:Re,advanceTourIfNeeded:_,changePin:$e,checklistGoTo:ve,checklistGoToRates:ye,cleanupPostActivationTourUi:at,cleanupSettingsTourUi:D,closeAmenityPicker:st,confirmAmenityPicker:Oe,confirmEditAddRoom:Ke,copyBookingLink:Le,copyBookingLinkFromChecklist:he,deleteEditImage:We,deleteEditRoom:Ye,ensureTourBlurOverlay:R,finishPostActivationTour:tt,getAmenityIcon:Dt,getCrmAuthToken:xt,getEditRoomImages:Mt,goLive:Ne,guestBookingEngineUrl:Ot,handoffToGuestAppsTour:At,hideGoLiveOverlay:gt,loadEditRooms:vt,loadSettings:Pt,openAmenityPicker:Lt,openBillingPortal:qe,openEditAddRoom:_e,openGuestBookingEngine:Be,openPreviewSite:Se,openTourAccordion:N,postRoomImageUpload:yt,queryTourSelector:L,removeAmenity:Me,renderEditRooms:bt,renderEditRoomsCards:K,replayWalkthrough:Ie,resolveLiveTourElement:X,resolveTourHighlightEl:G,restoreAppIconPreview:mt,saveEditRoom:je,saveHotelInfo:Fe,saveRates:De,scrollTourTargetIntoView:It,sendSupportMessage:Ue,setAppIconPreviewImage:kt,setAppIconPreviewLoading:qt,settingsChangePin:ke,settingsCopyLink:xe,settingsSaveRates:we,settingsSendSupport:Ee,settingsUploadPhoto:be,showActivatedModal:Ae,showEditRoomPhoto:Ft,showFinaleMockModal:W,showGoLiveOverlay:Ht,showOnboardingQuestions:Te,showTestDriveModal:Ct,showWelcomeModal:Rt,squareCropImage:Nt,startPostActivationTabTour:ht,startSettingsTour:ut,stepEditRoomPhoto:Ce,toggleAmenityPreset:Pe,toggleSection:He,tourAnchorRect:Tt,tourElementRect:nt,updatePreviewSiteBar:ze,uploadAppIcon:Ge,uploadEditImages:Ve};function Qe(){Gt(Ut)}const eo=Object.freeze(Object.defineProperty({__proto__:null,default:Ut,install:Qe},Symbol.toStringTag,{value:"Module"}));export{se as a,ae as b,u as c,Je as d,Gt as e,to as f,eo as g,Xe as i,Ze as s};
