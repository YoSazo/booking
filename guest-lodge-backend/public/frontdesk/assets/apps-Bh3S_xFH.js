import{c as n,a as we,b as ke,e as Se}from"./settings-BjIgv-Fo.js";function v(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function ee(...e){return v("ensureAppsViewRendered")?.(...e)}function te(...e){return v("showFinaleMockModal")?.(...e)}function oe(...e){return v("finishTourHydration")?.(...e)}function ie(...e){return v("goLive")?.(...e)}function ae(...e){return v("toast")?.(...e)}function Ce(...e){return v("appsCloseLightbox")?.(...e)}let F=[],d=0,P=!1,$=null,O=null,W=null,C=null;function Te(){if(document.getElementById("frontdeskAppsTourStyle"))return;const e=document.createElement("style");e.id="frontdeskAppsTourStyle",e.textContent=`
    #appsTourLightbox {
