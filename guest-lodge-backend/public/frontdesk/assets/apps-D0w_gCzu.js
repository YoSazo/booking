import{c as r,a as mt,b as yt,e as vt}from"./settings-BB-2eeJ9.js";function x(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function J(...t){return x("ensureAppsViewRendered")?.(...t)}function tt(...t){return x("showFinaleMockModal")?.(...t)}function et(...t){return x("finishTourHydration")?.(...t)}function ot(...t){return x("goLive")?.(...t)}function it(...t){return x("toast")?.(...t)}function wt(...t){return x("appsCloseLightbox")?.(...t)}let M=[],d=0,F=!1,$=null,E=null,H=null,w=null;function kt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function v(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function at(){$&&(document.removeEventListener("keydown",$),$=null)}function Tt(t){at(),$=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",$)}function Ct(t,e){return!t||!t.isConnected||e?.noHighlight?null:(t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),w?.destroy(),w=yt(t,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"none",o.style.outline=e?.spotlightOutline??"none",o.style.outlineOffset=e?.spotlightOutlineOffset??"0",(t.classList.contains("apps-story-line")||e?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),w?.element||null)}function nt(t){const e=t||{};at(),H?.destroy(),H=null,w?.destroy(),w=null,E&&(clearTimeout(E),E=null);const o=document.getElementById("appsTourLightbox");o&&!e.keepLightbox&&o.remove();const n=document.getElementById("appsTourTooltip");n&&n.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function u(t){nt(),document.body.style.overflow="";const e=F;F=!1;try{const o=typeof J=="function"?J:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),e||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive)){const n=typeof tt=="function"?tt:window.showFinaleMockModal;if(typeof n=="function"){n();return}}}function St(t){const e=d+t;e<0||e>=M.length||(d=e,k())}function R(){if(localStorage.setItem("appsTourDone","1"),F||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive){r.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const e=typeof et=="function"?et:window.finishTourHydration;typeof e=="function"&&e()}}function zt(){R();const t=typeof ot=="function"?ot:window.goLive;if(u(!1),typeof t=="function"){t();return}const e=typeof it=="function"?it:window.toast;typeof e=="function"&&e("Open Go live to activate your booking page.","error")}function k(){kt();const t=M[d];if(!t){u(!0);return}const e=M.length,o=d>=e-1,n=`${d+1} / ${e}`,i=Math.max(8,Math.min(100,Math.round((d+1)/e*100))),a=document.querySelector(t.target);if(!a){d++,k();return}nt({keepLightbox:!0});let s=document.getElementById("appsTourLightbox");s||(s=document.createElement("div"),s.id="appsTourLightbox",s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(s)),t.noHighlight||(a.dataset.appsTourOrigPosition=a.style.position||"",a.dataset.appsTourOrigZIndex=a.style.zIndex||"",a.dataset.appsTourOrigIsolation=a.style.isolation||"",a.dataset.appsTourOrigBoxShadow=a.style.boxShadow||"",a.dataset.appsTourOrigOutline=a.style.outline||"",a.dataset.appsTourOrigOutlineOffset=a.style.outlineOffset||"",a.dataset.appsTourOrigTransition=a.style.transition||"",a.style.position=a.style.position||"relative",a.style.zIndex="100002",a.style.isolation="isolate",a.style.transition="box-shadow 0.18s ease, outline 0.18s ease",a.style.boxShadow=t.spotlightBoxShadow??"none",a.style.outline=t.spotlightOutline??"none",a.style.outlineOffset=t.spotlightOutlineOffset??"0",(a.classList.contains("apps-story-line")||t.hideSpotlightBorder)&&(a.dataset.appsTourOrigBorderTop=a.style.borderTop||"",a.dataset.appsTourOrigPaddingTop=a.style.paddingTop||"",a.style.borderTop="none",a.style.paddingTop="0"),a.setAttribute("data-apps-tour-highlighted","1"));const l=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,h=t.scrollBlock||"nearest",f=l?"auto":"smooth";a.scrollIntoView({behavior:f,block:h});const p=()=>{const m=document.getElementById("appsTourTooltip");m&&m.remove();const y=Math.min(370,window.innerWidth-28),N=t.primaryLabel||(o?"Done":"Next"),V=t.secondaryLabel||(o?"Not now":"Skip tour"),S=d<=0,B=t.kicker||"Guest App",g=document.createElement("div");g.id="appsTourTooltip",g.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${y}px;max-width:${y}px;visibility:hidden;`,g.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${v(t.title)}">
        ...
        <div class="apps-tour-kicker">${v(B)}</div>
        <div class="apps-tour-title">${v(t.title)}</div>
        <p class="apps-tour-copy">${v(t.text)}</p>
        <div class="apps-tour-actions">
          <button type="button" id="appsTourBackBtn" class="apps-tour-btn" ${S?"disabled":""}>Back</button>
          <button type="button" id="appsTourSkipBtn" class="apps-tour-btn apps-tour-btn-ghost">${v(V)}</button>
          <button type="button" id="appsTourNextBtn" class="apps-tour-btn apps-tour-btn-primary">${v(N)}</button>
        </div>
      </div>`,document.body.appendChild(g),Ct(a,t);const j=g.querySelector(".apps-tour-panel");H?.destroy(),H=mt({tooltip:g,panel:j,target:a,anchor:a,spotlight:w,options:{preferredPlacement:t.tooltipPosition||"auto",maxWidth:y,gap:t.tooltipGap??10,autoScroll:!0,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),g.style.visibility="visible";const q=()=>{if(t.activateOnNext){zt();return}if(o){R(),u(!1),t.openGuestInstallCoachOnNext&&window.setTimeout(()=>x("appsOpenGuestInstallCoach")?.(),0);return}d++,k()},_=()=>{if(o){R(),u(!1);return}u(!0)},L=()=>{d<=0||(d--,k())};document.getElementById("appsTourNextBtn").onclick=q,document.getElementById("appsTourSkipBtn").onclick=_;const O=document.getElementById("appsTourBackBtn");O&&(O.onclick=L),Tt({onNext:q,onBack:L,onSkip:_})};E=setTimeout(()=>{requestAnimationFrame(p)},l?40:320)}function It(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;wt(),u(!1),F=!!o;const n=!!r.hotelSubscribed;M=!!x("isNativeFrontdeskApp")?.()||document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1"?[{target:"#tour-guest-reach",kicker:"Direct guest reach",title:"Send a push notification directly to their phone.",text:"Every guest who downloads your app and turns on notifications can receive a message from you whenever you choose.",tooltipPosition:"above"},{target:"#tour-native-guest-share",kicker:"Build your audience",title:"Get your app onto their phone.",text:"Show the QR, copy the link, or open the guest page. They install it from there.",tooltipPosition:"above"},{target:"#tour-guest-icon-section",kicker:"Make it yours",title:"Choose the icon guests will save.",text:"Use your logo or a clear property photo.",scrollBlock:"start",tooltipPosition:"below"},{target:"#tour-native-install-guide",kicker:"Your cheat sheet",title:"Know exactly what to tell them.",text:"Open this anytime to practice the exact Safari taps for older iPhones and every iOS 26 layout.",primaryLabel:"Show me",secondaryLabel:"Close",openGuestInstallCoachOnNext:!0,tooltipPosition:"above"}]:[{target:"#tour-apps-intro",kicker:"The loop",title:"Your property becomes the app—and the direct connection.",text:"Guests book direct, save your property to their phone, and can receive notifications from you."},{target:"#tour-apps-first",kicker:"Your side",title:"Put Front Desk on your phone in 3 steps.",text:"There is no App Store. Save this page to your home screen so new bookings can reach you before they confirm — even when Front Desk is closed.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-then",kicker:"Their side",title:"Guests install from your booking page.",text:"One tap on Install and your icon is on their home screen.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-after",kicker:"Direct reach",title:"Send a notification to their phone whenever you want.",text:"Anyone who installs your app and turns on notifications becomes reachable directly from Front Desk.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your property.",text:"A real logo or a clear photo. Guests see this square every time.",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10},{target:"#tour-apps-loop",kicker:n?"Live loop":"Activation",title:n?"This loop is on.":"Everything is ready to turn on.",text:n?"Guests book, save your property, receive your updates, and message you. Front Desk gets the alerts.":"For $199/month, guests can book direct, save your property, receive your updates, and message you — while Front Desk receives the alerts.",primaryLabel:n?"Done":"Activate everything — $199/month",secondaryLabel:n?"Close":"Keep exploring",activateOnNext:!n,tooltipPosition:"below",tooltipGap:8}],d=0,k()}const c={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},$t="32px";function W(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function Y(t){return`border-radius:${$t};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function rt(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let P=[],T=0,D="ios26",C=null,st="",A=null;function At(t,e){u(!1),isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),P=t,T=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?G(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?G(-1):i.key==="Escape"&&U()},document.addEventListener("keydown",o._keyHandler);let n=0;o.addEventListener("touchstart",i=>{n=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const a=i.changedTouches[0].clientX-n;Math.abs(a)>50&&G(a<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",Z()}function U(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState()))}function G(t){const e=P.length;e<=1||(T=(T+t+e)%e,Z())}function Z(){const t=document.getElementById("appsLightbox");if(!t)return;const e=P[T],o=P.length,n=e.type!=="video",i=o>1?`${T+1} / ${o}`:"",a=n?`<img src="${rt(e.src)}" alt="${e.alt||""}"
       ...
       </video>`,s=o>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",l=o>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",h=o>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:o},(f,p)=>`<div onclick="appsOpenLightbox(_appsLbItems,${p})" style="width:7px;height:7px;border-radius:50%;background:${p===T?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${h}
    </div>`}function K(){return`<svg viewBox="169 8.5 21 25.5" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Bt(){return`<svg viewBox="44 39.5 21 13" focusable="false" aria-hidden="true">
  ...
  </svg>`}function _t(){return`<svg viewBox="0 0 28 28" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Lt(t,e){const o=[...t?[{label:"More",icon:pt()}]:[],{label:"Share",icon:K()},...e?[{label:"View More",icon:Bt()}]:[],{label:"Add to Home Screen",icon:_t()}];return`<div class="agic-sequence" aria-label="${o.map(n=>n.label).join(", then ")}">
  ...
  </div>`}function lt(){const t=D==="ios26",e=C==="compact",i=t&&!C?`
    <div class="agic-content agic-choice">
      ...
      <button type="button" onclick="appsGuestInstallCoachSelectLayout('standard')">
        <span class="agic-choice-glyph">${K()}</span>
    ...
    <section class="agic-sheet" role="dialog" aria-modal="true" aria-label="How guests install your app">
      ...
      ${i}
    </section>`}function dt(){const t=document.getElementById("appsGuestInstallCoach");t&&(t.innerHTML=lt())}function Ot(){u(!1),U(),document.getElementById("appsGuestInstallCoach")?.remove(),D="ios26",C=null,st=document.body.style.overflow,document.body.style.overflow="hidden",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),A=e=>{e.key==="Escape"&&ct()},document.addEventListener("keydown",A);const t=document.createElement("div");t.id="appsGuestInstallCoach",t.innerHTML=lt(),document.body.appendChild(t)}function ct(){A&&(document.removeEventListener("keydown",A),A=null),document.getElementById("appsGuestInstallCoach")?.remove(),document.body.style.overflow=st,isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState())}function Et(t){D=t==="classic"?"classic":"ios26",C=D==="classic"?"standard":null,dt()}function Gt(t){C=["standard","compact"].includes(t)?t:null,dt()}function gt(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function I(t,e,o,n,i){const a=i?gt("Video"):"",s=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${n})">
    ...
    ${s}
  </button>`}function Mt(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function Ft(t){const e=document.getElementById("appsView");if(!e)return;const o=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",n=(r.activeHotelId||"")+"|"+(r.activeHotelAppIcon||"")+"|"+(r.activeHotelDomain||"")+"|"+(o?"native-preview":"standard");t||e.dataset.appsKey!==n||!e.querySelector(".apps-page")?(ut(),e.dataset.appsKey=n):(isNativeFrontdeskApp()||o)&&Q()}function ut(){const t=document.getElementById("appsView");if(!t)return;const e=r.activeHotelName||"Your Property",o=r.activeHotelAppIcon||"",n=e.trim().charAt(0).toUpperCase()||"🏡",i=r.activeHotelDomain||"",a=i?"https://"+i:"#",s=i?"https://"+i+"/install":"#";function l(bt){return JSON.stringify(bt).replace(/"/g,"&quot;")}const h=W(c.guestHome,520),f=[{type:"image",src:c.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],p=[{type:"image",src:c.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:c.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:c.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],b=[{type:"video",src:c.guestInstallVideo,poster:c.guestHome,alt:"Guest adds property to phone",title:"How guests put your property on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your property shows up on their phone like an app. You don't need to do anything."}],m=[{type:"image",src:c.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your guest app.'},{type:"image",src:c.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Guest App</strong>, choose the conversation, and reply."},{type:"video",src:c.guestMessageNotifVideo,poster:c.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],y=isStandaloneApp(),N=isNativeFrontdeskApp(),V=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",S=N||V;window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,Number(r.bookingReviewSettings?.reminderMinutes??15);const B="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",g=o?B+"background:#fff;border:1px solid var(--border);padding:0;":B,j=o?`<img src="${o}" alt="Property logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,_=`
    <div class="apps-icon-card">
      <div id="appsAppIconPreview" style="${g}">
        ${j}
      </div>
      <div style="flex:1;min-width:0;">
        ...
        <button type="button" id="tour-guest-icon-btn" onclick="${y?"document.getElementById('appsAppIconInput').click()":"toast('Please install Front Desk first. Then you can change your guest app icon.', 'error')"}" style="padding:10px 16px;border-radius:10px;border:1.5px solid var(--green);background:none;color:var(--green);font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${o?"Change picture":"Upload picture"}</button>
        ${y?"":'<div style="font-size:11px;color:var(--text-muted);margin-top:8px;line-height:1.4;">Install Front Desk first to upload this picture.</div>'}
      </div>
    </div>`;s!=="#"&&`${s.replace("https://","")}`,`${h}${l(b)}${I("What guests see on their phone","",l(p),0,!1)}${I("How guests add your property","",l(b),0,!0)}${I("Guest texts you, you text back","",l(m),0,!0)}${I("Your app and theirs — side by side","",l(f),0,!1)}`,a!=="#"&&`${a}`;const L=()=>`
    ...
    <div class="apps-step-card" id="tour-native-guest-share">
      ...
      <button type="button" class="apps-install-coach-trigger" id="tour-native-install-guide" onclick="appsOpenGuestInstallCoach()">
        <span class="apps-install-coach-trigger__icon" aria-hidden="true">${K()}</span>
    ...
    ${O}
    ${L()}`,z=!!String(r.frontdeskAppStoreUrl||"").trim(),ft=S?xt:`
    <section style="min-height:52vh;display:grid;place-items:center;padding:34px 0;">
      <div style="width:min(100%,430px);padding:28px 24px;border:1.5px solid var(--border);border-radius:22px;background:#fff;text-align:center;box-shadow:0 14px 40px rgba(26,43,34,.09);">
        ...
        <button type="button" onclick="openFrontdeskAppDownload()" ${z?"":'aria-disabled="true"'} style="width:100%;min-height:50px;border:0;border-radius:13px;background:${z?"var(--green)":"#dce8e1"};color:${z?"#fff":"#527061"};font-family:inherit;font-size:15px;font-weight:800;cursor:${z?"pointer":"default"};">${z?"Download Marketel Front Desk":"Front Desk app coming soon"}</button>
      </div>
    </section>`,X=S?"":y?"Front Desk is installed. Guests can install your property from the direct booking page.":"Install Front Desk first. Then guests can install your property from the direct booking page.";t.innerHTML=`
  <style>
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),S&&(r.guestMessages.length?renderMessages():loadMessages(),Q(),ht())}async function ht(){try{const t=await api("GET","/api/crm/booking-review-settings");if(!t?.success||!t.data)return;r.bookingReviewSettings=t.data;const e=document.getElementById("bookingReviewReminderSelect");e&&(e.value=String(t.data.reminderMinutes))}catch{}}async function Ht(t){const e=String(r.bookingReviewSettings?.reminderMinutes??15),o=parseInt(t?.value,10);if([0,15,30,60].includes(o)){t&&(t.disabled=!0);try{const n=await api("POST","/api/crm/booking-review-settings",{reminderMinutes:o});if(!n?.success)throw new Error(n?.message||"Could not save reminder timing.");r.bookingReviewSettings=n.data,toast(o===0?"Booking reminders off — the first alert will still arrive.":`Booking reminders set for every ${o===60?"hour":o+" minutes"}.`,"success")}catch(n){t&&(t.value=e),toast(n?.message||"Could not save reminder timing.","error")}finally{t&&(t.disabled=!1)}}}async function Q(){const t=document.getElementById("guestInstallStats");try{const e=await api("GET","/api/crm/guest-install-stats");if(!e.success)throw new Error(e.message||"Failed");if(r.guestPushSubscriberCount=e.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const o=e.totals||{},n=e.installedBookings||0,i=o.views||0,a=o.notification_prompts||0,s=e.guestPushSubscribers||0;if(!n&&!i){t.style.display="none",t.innerHTML="";return}t.style.display="block";const l=e.installRatePercent!=null?e.installRatePercent:0,h=Object.entries(e.byTouchpoint||{}).filter(function(p){return p[1].views||p[1].installed}).sort(function(p,b){return(b[1].installed||0)-(p[1].installed||0)}).slice(0,5),f=h.length?h.map(function(p){const b=p[0].replace(/-/g," "),m=p[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+b+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(m.views||0)+" views · "+(m.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+l+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+n+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">guests reachable now</div></div></div>'+(a?'<div style="font-size:11px;color:var(--text-muted);margin:-2px 0 10px;">Notification permission: '+(o.notification_granted||0)+" granted · "+(o.notification_denied||0)+" denied · "+(o.notification_dismissed||0)+" dismissed · "+(o.notification_failed||0)+" failed</div>":"")+(f?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+f:"")}catch{r.guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}const Pt={appsCloseLightbox:U,appsCloseGuestInstallCoach:ct,appsCloudinaryFull:rt,appsCloudinaryImg:W,appsLbNav:G,appsLbRender:Z,appsOpenLightbox:At,appsOpenGuestInstallCoach:Ot,appsPhoneImgStyle:Y,appsQuestionRow:I,appsGuestInstallCoachSelectLayout:Gt,appsGuestInstallCoachSetVersion:Et,appsTourClose:u,appsTourNav:St,appsTourRender:k,appsVideoBadgeHtml:gt,detectAppPlatform:Mt,ensureAppsViewRendered:Ft,loadBookingReviewSettings:ht,loadGuestInstallStats:Q,renderAppsView:ut,saveBookingReviewReminderSetting:Ht,startAppsTour:It};function jt(){vt(Pt)}export{Pt as default,jt as install};
