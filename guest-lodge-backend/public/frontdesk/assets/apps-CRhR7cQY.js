import{c as h,e as yt}from"./settings-Dc2kdZ2N.js";function I(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function nt(...t){return I("ensureAppsViewRendered")?.(...t)}function st(...t){return I("showFinaleMockModal")?.(...t)}function at(...t){return I("finishTourHydration")?.(...t)}function C(...t){return I("goLive")?.(...t)}function M(...t){return I("toast")?.(...t)}function vt(...t){return I("appsCloseLightbox")?.(...t)}let P=[],f=0,G=!1,$=null,O=null;function pt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function k(t){return String(t??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function lt(){$&&(document.removeEventListener("keydown",$),$=null)}function wt(t){lt(),$=o=>{if(o.defaultPrevented)return;const e=o.target&&o.target.tagName?o.target.tagName.toLowerCase():"";e==="input"||e==="textarea"||e==="select"||o.target?.isContentEditable||(o.key==="Escape"?(o.preventDefault(),t.onSkip?.()):o.key==="Enter"||o.key==="ArrowRight"?(o.preventDefault(),t.onNext?.()):o.key==="ArrowLeft"&&(o.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",$)}function kt(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(o=>o.removeAttribute("id"))}function Tt(t,o){const e=t.querySelectorAll("input, textarea, select"),n=o.querySelectorAll("input, textarea, select");e.forEach((s,i)=>{const a=n[i];a&&(s.type==="checkbox"||s.type==="radio"?a.checked=s.checked:a.value=s.value)})}function dt(t,o){const e=getComputedStyle(t);for(const i of e)o.style.setProperty(i,e.getPropertyValue(i),e.getPropertyPriority(i));const n=t.children,s=o.children;for(let i=0;i<n.length;i+=1)s[i]&&dt(n[i],s[i])}function rt(t){if(!t||!t.isConnected)return null;document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(n=>n.remove());const o=t.getBoundingClientRect();if(o.width<2||o.height<2)return null;const e=t.cloneNode(!0);return kt(e),dt(t,e),Tt(t,e),t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),t.style.visibility="hidden",e.setAttribute("data-apps-tour-spotlight-clone","1"),e.setAttribute("aria-hidden","true"),e.style.position="fixed",e.style.left=`${o.left}px`,e.style.top=`${o.top}px`,e.style.width=`${o.width}px`,e.style.height=`${o.height}px`,e.style.margin="0",e.style.maxWidth="none",e.style.zIndex="100002",e.style.pointerEvents="none",e.style.transform="none",e.style.boxShadow="0 18px 46px rgba(26,43,34,0.24)",e.style.outline="1px solid rgba(255,255,255,0.82)",e.style.outlineOffset="2px",document.body.appendChild(e),e}function ct(){lt(),O&&(clearTimeout(O),O=null);const t=document.getElementById("appsTourLightbox");t&&t.remove();const o=document.getElementById("appsTourTooltip");o&&o.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(e=>e.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(e=>{e.style.position=e.dataset.appsTourOrigPosition||"",e.style.zIndex=e.dataset.appsTourOrigZIndex||"",e.style.isolation=e.dataset.appsTourOrigIsolation||"",e.style.boxShadow=e.dataset.appsTourOrigBoxShadow||"",e.style.outline=e.dataset.appsTourOrigOutline||"",e.style.outlineOffset=e.dataset.appsTourOrigOutlineOffset||"",e.style.transition=e.dataset.appsTourOrigTransition||"",e.style.visibility=e.dataset.appsTourOrigVisibility||"",e.removeAttribute("data-apps-tour-highlighted"),delete e.dataset.appsTourOrigPosition,delete e.dataset.appsTourOrigZIndex,delete e.dataset.appsTourOrigIsolation,delete e.dataset.appsTourOrigBoxShadow,delete e.dataset.appsTourOrigOutline,delete e.dataset.appsTourOrigOutlineOffset,delete e.dataset.appsTourOrigTransition,delete e.dataset.appsTourOrigVisibility})}function zt(t){let o=t&&t.parentElement;for(;o&&o!==document.body&&o!==document.documentElement;){const e=getComputedStyle(o),n=e.overflowY||e.overflow;if(/(auto|scroll)/.test(n)&&o.scrollHeight>o.clientHeight+1)return o;o=o.parentElement}return null}function It(t,o){if(!o)return;const e=zt(t);if(e){e.scrollTop+=o;return}window.scrollBy({top:o,left:0,behavior:"auto"})}function Bt(t,o){return o&&t.mobileTooltipPosition||t.tooltipPosition||""}function At(t,o,e,n,s){if(!t||!t.isConnected||!e)return t?.getBoundingClientRect()||null;const i=e.querySelector(".apps-tour-panel"),a=Math.min(i&&i.offsetHeight||e.offsetHeight||190,Math.max(130,window.innerHeight-28)),d=o.tooltipGap??8,r=(s?o.mobileFitPadTop:o.fitPadTop)??14,g=window.innerHeight-((s?o.mobileFitPadBottom:o.fitPadBottom)??14);let p=t.getBoundingClientRect();if(p.width<2||p.height<2)return p;for(let y=0;y<3;y+=1){const B=Math.max(120,g-r),c=p.height+d+a<=B;let u=0;if(n==="above"){const m=p.top-d-a-r;m<0&&(u=m),c&&p.bottom>g&&(u=p.bottom-g)}else{const m=p.bottom+d+a-g;m>0&&(u=m),c&&p.top<r&&(u=p.top-r)}if(Math.abs(u)<1)break;It(t,u),p=t.getBoundingClientRect()}return p}function b(t){ct(),document.body.style.overflow="";const o=G;G=!1;try{const e=typeof nt=="function"?nt:window.ensureAppsViewRendered;typeof e=="function"&&e(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),o||localStorage.getItem("settingsTourStep")==="handoff"||h.settingsTourActive)){const n=typeof st=="function"?st:window.showFinaleMockModal;if(typeof n=="function"){n();return}}}function $t(t){const o=f+t;o<0||o>=P.length||(f=o,T())}function Z(){if(localStorage.setItem("appsTourDone","1"),G||localStorage.getItem("settingsTourStep")==="handoff"||h.settingsTourActive){h.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const o=typeof at=="function"?at:window.finishTourHydration;typeof o=="function"&&o()}}function St(){Z();const t=typeof C=="function"?C:window.goLive;if(b(!1),typeof t=="function"){t();return}const o=typeof M=="function"?M:window.toast;typeof o=="function"&&o("Open Go live to activate your booking page.","error")}function Et(){if(h.hotelSubscribed||document.getElementById("guestAppActivationOverlay"))return;pt();const t=document.createElement("div");if(t.id="guestAppActivationOverlay",t.style.cssText="position:fixed;inset:0;z-index:100004;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;padding:24px 16px;box-sizing:border-box;",t.innerHTML=`
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:390px;width:100%;max-height:calc(100vh - 48px);overflow-y:auto;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:appsTourPanelIn 0.22s ease-out;">
    ...
    </div>`,document.body.appendChild(t),document.body.style.overflow="hidden",!document.getElementById("tourModalAnimStyle")){const e=document.createElement("style");e.id="tourModalAnimStyle",e.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(e)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0);const o=()=>{t.remove(),document.body.style.overflow=""};document.getElementById("guestAppActivateNowBtn").onclick=()=>{o();const e=typeof C=="function"?C:window.goLive;if(typeof e=="function"){e();return}const n=typeof M=="function"?M:window.toast;typeof n=="function"&&n("Open Go live to activate your booking page.","error")},document.getElementById("guestAppActivateLaterBtn").onclick=o}function T(){pt();const t=P[f];if(!t){b(!0);return}const o=P.length,e=f>=o-1,n=`${f+1} / ${o}`,s=Math.max(8,Math.min(100,Math.round((f+1)/o*100))),i=document.querySelector(t.target);if(!i){f++,T();return}ct();let a=document.createElement("div");a.id="appsTourLightbox",a.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.22);pointer-events:auto;",document.body.appendChild(a),i.dataset.appsTourOrigPosition=i.style.position||"",i.dataset.appsTourOrigZIndex=i.style.zIndex||"",i.dataset.appsTourOrigIsolation=i.style.isolation||"",i.dataset.appsTourOrigBoxShadow=i.style.boxShadow||"",i.dataset.appsTourOrigOutline=i.style.outline||"",i.dataset.appsTourOrigOutlineOffset=i.style.outlineOffset||"",i.dataset.appsTourOrigTransition=i.style.transition||"",i.style.position=i.style.position||"relative",i.style.zIndex="100002",i.style.isolation="isolate",i.style.transition="box-shadow 0.18s ease, outline 0.18s ease",i.style.boxShadow="0 0 0 1px rgba(255,255,255,0.92), 0 18px 46px rgba(26,43,34,0.22)",i.style.outline="1px solid rgba(255,255,255,0.82)",i.style.outlineOffset="2px",i.setAttribute("data-apps-tour-highlighted","1");const d=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=window.matchMedia&&window.matchMedia("(max-width: 767px)").matches,g=r&&t.mobileScrollBlock||t.scrollBlock||"center",p=d?"auto":"smooth";if(r&&t.mobileScrollToBottom){const c=Math.max(document.documentElement?document.documentElement.scrollHeight:0,document.body?document.body.scrollHeight:0);window.scrollTo({top:c,behavior:p}),setTimeout(()=>{window.scrollTo({top:c,behavior:"auto"})},p==="smooth"?520:0)}else i.scrollIntoView({behavior:p,block:g});const y=()=>{const c=document.getElementById("appsTourTooltip");c&&c.remove();const u=Math.min(r?window.innerWidth-24:370,window.innerWidth-28),m=Bt(t,r),q=t.primaryLabel||(e?"Done":"Next"),v=t.secondaryLabel||(e?"Not now":"Skip tour"),N=f<=0,R=t.kicker||"Guest App",l=document.createElement("div");if(l.id="appsTourTooltip",l.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${u}px;max-width:${u}px;visibility:hidden;`,l.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${k(t.title)}">
        ...
        <div class="apps-tour-kicker">${k(R)}</div>
        ...
        <div class="apps-tour-actions">
      ...
      </div>`,document.body.appendChild(l),r&&!m)rt(i),l.style.left="12px",l.style.right="12px",l.style.width="auto",l.style.maxWidth="none",l.style.top="auto",l.style.bottom="calc(14px + env(safe-area-inset-bottom,0px))";else{const H=m||"below",w=At(i,t,l,H,r)||i.getBoundingClientRect();rt(i);const V=l.querySelector(".apps-tour-panel"),D=Math.min(V&&V.offsetHeight||l.offsetHeight||190,Math.max(130,window.innerHeight-28)),F=t.tooltipGap??8,W=w.left+w.width/2,U=Math.max(14,Math.min(W-u/2,window.innerWidth-u-14)),K=H!=="above"?w.bottom+F:w.top-D-F,X=Math.max(14,Math.min(K,window.innerHeight-D-14));l.style.left=`${U}px`,l.style.right="auto",l.style.bottom="auto",l.style.width=`${u}px`,l.style.maxWidth=`${u}px`,l.style.top=`${X}px`}l.style.visibility="visible";const S=()=>{if(t.activateOnNext){St();return}if(e){Z(),b(!1),t.showActivationOnComplete&&Et();return}f++,T()},E=()=>{if(e){Z(),b(!1);return}b(!0)},Y=()=>{f<=0||(f--,T())};document.getElementById("appsTourNextBtn").onclick=S,document.getElementById("appsTourSkipBtn").onclick=E;const _=document.getElementById("appsTourBackBtn");_&&(_.onclick=Y),wt({onNext:S,onBack:Y,onSkip:E})},B=r&&t.mobileScrollToBottom?d?80:680:d?40:320;O=setTimeout(()=>{requestAnimationFrame(y)},B)}function _t(t){const o=t&&t.replay,e=t&&t.chainFromSettingsTour;if(!o&&!e&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;vt(),b(!1),G=!!e;const n=!!h.hotelSubscribed;P=[{target:"#tour-apps-intro",kicker:"The loop",title:"Your hotel becomes the app.",text:"Guests book from your direct page, save your hotel to their phone, then come back with one tap to book or message you."},{target:"#tour-apps-first",kicker:"Front Desk",title:"Install this on the property phone.",text:"Front Desk is this dashboard saved like an app. It is where booking alerts, guest messages, QR tools, and setup controls live.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8,mobileScrollBlock:"center",mobileTooltipPosition:"below"},{target:"#tour-apps-then",kicker:"Guest path",title:"Send guests to your direct page.",text:"The Install button sits on the booking page. Guests tap it once, and your hotel icon lands on their home screen.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8,mobileScrollBlock:"center",mobileTooltipPosition:"below"},{target:"#tour-apps-after",kicker:"Return visits",title:"Now the loop is easy to remember.",text:"Guests tap your icon to book direct or message you. New bookings and messages come back to Front Desk."},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your hotel.",text:"Use a real logo or clear property image. Guests see this square every time they save your hotel to their phone.",mobileScrollToBottom:!0,mobileScrollBlock:"end",mobileTooltipAnchor:"top",mobileTooltipPosition:"above"},{target:"#tour-apps-loop",kicker:n?"Live loop":"Activation",title:n?"This loop is on.":"Turn this on for your property.",text:n?"Guests can book direct, save your hotel, and message you. Front Desk gets the alerts.":"Activation turns on direct booking, guest installs, messages, and Front Desk alerts as one simple loop.",primaryLabel:n?"Done":"Continue to activation",secondaryLabel:n?"Close":"Not now",showActivationOnComplete:!n,mobileScrollBlock:"center",tooltipPosition:"below",tooltipGap:8,mobileTooltipPosition:"below"}],f=0,T()}const x={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},Ht="32px";function tt(t,o){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(o||400)+"/")}function J(t){return`border-radius:${Ht};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function ut(t){const o=Math.min(window.devicePixelRatio||1,2),e=Math.round(Math.min(window.screen.width*o,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${e}/`)}let j=[],z=0;function Dt(t,o){b(!1),j=t,z=o||0;let e=document.getElementById("appsLightbox");if(!e){e=document.createElement("div"),e.id="appsLightbox",e.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(e),document.body.style.overflow="hidden",e._keyHandler=s=>{s.key==="ArrowRight"||s.key==="ArrowDown"?L(1):s.key==="ArrowLeft"||s.key==="ArrowUp"?L(-1):s.key==="Escape"&&gt()},document.addEventListener("keydown",e._keyHandler);let n=0;e.addEventListener("touchstart",s=>{n=s.changedTouches[0].clientX},{passive:!0}),e.addEventListener("touchend",s=>{const i=s.changedTouches[0].clientX-n;Math.abs(i)>50&&L(i<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",et()}function gt(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="")}function L(t){const o=j.length;o<=1||(z=(z+t+o)%o,et())}function et(){const t=document.getElementById("appsLightbox");if(!t)return;const o=j[z],e=j.length,n=o.type!=="video",s=e>1?`${z+1} / ${e}`:"",i=n?`<img src="${ut(o.src)}" alt="${o.alt||""}"
          ...
          ${o.poster?`poster="${tt(o.poster,400)}"`:""}>
          <source src="${o.src}" type="video/mp4">
       </video>`,a=e>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",d=e>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",r=e>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:e},(g,p)=>`<div onclick="appsOpenLightbox(_appsLbItems,${p})" style="width:7px;height:7px;border-radius:50%;background:${p===z?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
    ...
    <div style="flex-shrink:0;padding:8px 20px max(20px,env(safe-area-inset-bottom));text-align:center;width:100%;max-width:420px;margin:0 auto;box-sizing:border-box;">
      ...
      ${r}
    </div>`}function ft(t,o){const e=t||"Video";return`<span class="${"apps-media-badge"+(o==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${e}</span></span>`}function A(t,o,e,n,s){const i=s?ft("Video"):"",a=s?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${s?" apps-q--video":""}" onclick="appsOpenLightbox(${e},${n})">
    ...
    ${a}
      ...
      <div style="font-size:12px;color:var(--text-muted);line-height:1.45;text-align:center;">Locked until Front Desk is installed on a property phone</div>`;const N=c?`<div class="apps-story-status">
      ...
      </div>`:`<button type="button" class="apps-story-primary" onclick="handleInstallFrontdesk()">${q}</button>`,R=a!=="#"?'<button type="button" class="apps-story-secondary" onclick="openGuestBookingEngine({focusInstall:true})">Go to direct booking page</button>':'<div class="apps-story-domain-note">Your direct booking domain is still setting up. Once it is ready, guests install from that page.</div>',l="width:56px;height:56px;border-radius:14px;flex-shrink:0;overflow:hidden;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(0,0,0,0.1);box-sizing:border-box;",S=e?l+"background:#fff;border:1px solid var(--border);padding:0;":l,E=e?`<img src="${e}" alt="Hotel logo" style="width:100%;height:100%;object-fit:contain;">`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">${n}</span>`,_=`
    <div class="apps-icon-card">
      <div id="appsAppIconPreview" style="${S}">
        ${E}
      </div>
      ...
      ${a==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,w=a!=="#"?`
      ...
      </div>`:'<div id="guestInstallStats" style="display:none;"></div>',D=`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${d(y)},0)" style="margin-bottom:12px;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how guests install (1 min)</span></button>
        ...
        <div class="apps-q-list">
          ...
          ${A("How guests add your hotel","",d(y),0,!0)}
          ${A("Guest texts you, you text back","",d(B),0,!0)}
          ${A("Your app and theirs — side by side","",d(g),0,!1)}
        </div>
        ${i!=="#"?`<button onclick="window.open('${i}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,U=it=>`
    ...
    ${F}
    ${D}
    ${c?xt:Q()}`,bt=c?"Front Desk is installed. Guests can install your hotel from the direct booking page.":"Install Front Desk first. Then guests can install your hotel from the direct booking page.";t.innerHTML=`
  <style>
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),ot()}async function ot(){const t=document.getElementById("guestInstallStats");try{const o=await api("GET","/api/crm/guest-install-stats");if(!o.success)throw new Error(o.message||"Failed");if(guestPushSubscriberCount=o.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const e=o.totals||{},n=o.installedBookings||0,s=e.views||0;if(!n&&!s){t.style.display="none",t.innerHTML="";return}t.style.display="block";const i=o.installRatePercent!=null?o.installRatePercent:0,a=Object.entries(o.byTouchpoint||{}).filter(function(r){return r[1].views||r[1].installed}).sort(function(r,g){return(g[1].installed||0)-(r[1].installed||0)}).slice(0,5),d=a.length?a.map(function(r){const g=r[0].replace(/-/g," "),p=r[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+g+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(p.views||0)+" views · "+(p.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+n+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div></div>'+(d?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+d:"")}catch{guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}const Lt={appsCloseLightbox:gt,appsCloudinaryFull:ut,appsCloudinaryImg:tt,appsLbNav:L,appsLbRender:et,appsOpenLightbox:Dt,appsPhoneImgStyle:J,appsQuestionRow:A,appsTourClose:b,appsTourNav:$t,appsTourRender:T,appsVideoBadgeHtml:ft,detectAppPlatform:Ft,ensureAppsViewRendered:Ot,loadGuestInstallStats:ot,renderAppsView:ht,startAppsTour:_t};function Mt(){yt(Lt)}export{Lt as default,Mt as install};
