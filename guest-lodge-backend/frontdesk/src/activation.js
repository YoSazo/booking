  ...
  function render() {
    ...
    sheet.innerHTML = `
      ...
      <div class="activation-app">
        ...
        ${android ? '<p>Front Desk runs in your browser here — booking alerts, the no-answer rule and guest messages all work. Add it to your home screen to get alerts. The iPhone app adds Lock Screen booking cards.</p>' : ''}
      </div>
