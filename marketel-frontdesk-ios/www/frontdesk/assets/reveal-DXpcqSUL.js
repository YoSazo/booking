import{c as d,e as de}from"./settings-CP4ZY9Ws.js";const B="marketelValueRevealPendingV1",T="marketelValueRevealStepV1",te="marketelBillingIntervalV1";let o=0,m="guest",g=!1,w={rooms:[],rates:null},D=null,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},S=0,R=0,A=null,c=0,O=0,C=0,h="month",s=null,K=!1,k=!1,V=!1,q="confirm";const ce="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/46/2a/e1/462ae1c9-9347-efd0-5e99-41e7f636e3f7/phone-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg",ue="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/23/4c/cb/234ccbb4-e65a-bb94-f877-3d230743e9e3/safari-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg";function ae(){const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e==="0.0.0.0"||e==="::1"||e.endsWith(".local")||/^10\./.test(e)||/^192\.168\./.test(e)||/^172\.(1[6-9]|2\d|3[01])\./.test(e)}function u(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function J(e){const t=Number(e);return Number.isFinite(t)?new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:Number.isInteger(t)?0:2}).format(t):"$99"}function b(){return d.activeHotelName||"Your Property"}function W(){return w.rooms[0]||d.editRooms[0]||{name:"Your first room",totalUnits:1,images:[]}}function me(){const e=W();return e.images?.[0]?.url||e.imageUrl||""}function ve(){return w.rates?.nightly||99}function pe(){const e=Number(w.rates?.nightly);if(!Number.isFinite(e)||e<=0)return`<div class="mvr-value-bridge is-proof-only">
  ...
  </div>`}function P(){if(ae()&&d.activeHotelId){const a=new URL(window.location.href);return a.port="5173",a.pathname="/",a.search="",a.hash="",a.searchParams.set("hotelId",d.activeHotelId),a.searchParams.set("preview","1"),a.toString()}const e=n.domain||d.activeHotelDomain||"";if(!e)return"";const t=new URL(`https://${e}/`);return d.activeHotelId&&t.searchParams.set("hotelId",d.activeHotelId),t.searchParams.set("preview","1"),t.toString()}function N(){const e=String(n.domain||d.activeHotelDomain||"").trim().replace(/^https?:\/\//i,"").replace(/\/.*$/,"").toLowerCase();return e?e.endsWith(".bookmarketel.com")?e.replace(/\.bookmarketel\.com$/,".mktel.co"):e:`${b().normalize("NFKD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,50)||"your-property"}.mktel.co`}function ge(){const e=new URL(window.location.href);return e.search="",e.hash="",d.activeHotelId&&e.searchParams.set("hotelId",d.activeHotelId),e.searchParams.set("previewEditor","1"),e.toString()}function H(e=""){const t=d.activeHotelAppIcon||me(),a=b().trim().charAt(0).toUpperCase()||"M";return t?`<img class="${e}" src="${u(t)}" alt="">`:`<span class="${e}">${u(a)}</span>`}function be(){if(!d.hotelSubscribed)try{localStorage.setItem(B,"1"),localStorage.setItem(T,String(o))}catch{}}function p(e,t=""){typeof window.api=="function"&&window.api("POST","/api/crm/value-reveal-event",{eventName:e,contentName:t,...window.MarketelJourney?.linkage?.()||{}}).catch(()=>{})}function l(e,t={},a={}){return window.MarketelJourney?.track(e,{revealStep:o,stageName:["booking-page","guest-app","front-desk-assistant","activation"][o]||"unknown",...t},a)}function fe(){try{const e=new URL(window.location.href);e.searchParams.delete("welcome"),e.searchParams.delete("reveal"),window.history.replaceState({},"",e.pathname+e.search+e.hash)}catch{}}function ie(e){typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(e)}function _(e){const t=Math.max(0,Math.floor(Number(e||0)/1e3)),a=Math.floor(t/60),i=String(t%60).padStart(2,"0");return`${a}:${i}`}function F(e){e?.layer&&(e.layer.classList.remove("is-visible","is-prompt"),e.layer.setAttribute("aria-hidden","true"),e.layer.innerHTML="")}function I(e,t){const a=e?.querySelector("#mvrLiveActions");a&&(a.hidden=!t)}function Y(e="",t=!1){const a=s;if(a){if(a.timerId&&(window.clearInterval(a.timerId),a.timerId=0),a.promptFallbackId&&(window.clearTimeout(a.promptFallbackId),a.promptFallbackId=0),a.promptDelayId&&(window.clearTimeout(a.promptDelayId),a.promptDelayId=0),t&&a.status==="running"){const i=Date.now()-a.startedAt;p("BookingChallengeAbandoned",e),l("JourneyBookingChallengeAbandoned",{reason:e,elapsedMs:i},{durationMs:i})}a.timer&&(a.timer.hidden=!0),a.status==="running"&&(a.status="abandoned"),F(a)}}function Z(e){if(!e||e.status!=="running"||!e.timer)return;const t=Date.now()-e.startedAt,a=e.timer.querySelector("[data-challenge-time]");a&&(a.textContent=`${_(t)} / 1:00`),e.timer.classList.toggle("is-over-minute",t>=6e4)}function he(e){!e||e!==s||e.status!=="prompted"||(e.status="running",e.startedAt=Date.now(),F(e),I(e.modal,!0),e.timer.hidden=!1,Z(e),e.timerId=window.setInterval(()=>Z(e),500),p("BookingChallengeStarted"),l("JourneyBookingChallengeStarted",{targetSeconds:60,bookingDomain:N()}))}function ye(e){!e||e!==s||e.hasPrompted||m!=="guest"||(e.hasPrompted=!0,e.status="prompted",e.promptFallbackId&&(window.clearTimeout(e.promptFallbackId),e.promptFallbackId=0),I(e.modal,!1),e.layer.innerHTML=`<section class="mvr-challenge-card mvr-challenge-intro" role="dialog" aria-labelledby="mvrChallengeTitle">
  ...
  </section>`,e.layer.classList.add("is-visible"),e.layer.setAttribute("aria-hidden","false"),e.layer.querySelector(".mvr-challenge-edit")?.addEventListener("click",()=>{F(e),M(e.modal,"edit",e.previewOpenedAt,"challenge-completed")}),e.layer.querySelector(".mvr-challenge-skip")?.addEventListener("click",()=>{F(e),I(e.modal,!0)}),p("BookingChallengeCheckoutReached",_(t)),l("JourneyBookingChallengeCompleted",{elapsedMs:t,completedWithin60Seconds:t<=6e4},{durationMs:t})}function re(e){const t=e?.data?.type;if(t!=="marketel:show-guest-app"&&t!=="marketel:continue-owner-tour"&&t!=="marketel:checkout-reached"&&t!=="marketel:editor-saved")return;const a=document.getElementById("marketelValueReveal");if(!(!a||!Array.from(a.querySelectorAll("iframe")).some(r=>r.contentWindow===e.source))){if(t==="marketel:editor-saved"){if(s?.iframe?.contentWindow!==e.source||m!=="edit")return;e.data?.hotelName&&(d.activeHotelName=String(e.data.hotelName)),s.modal.dataset.editorSaved="1";const r=Array.isArray(e.data?.changedFields)?e.data.changedFields.map($=>String($)):[],v=String(e.data?.kind||"booking-page");let f="header";if(v==="header"){const $=new Set(["name","subtitle","address","phone"]);f=r.length===1&&$.has(r[0])?`header-${r[0]}`:"header"}else v.includes("photo")?f="room-photo":v==="room"?f="room":v==="checkout-policy"&&(f="checkout-policy",s.modal.dataset.editorPreviewTarget="checkout");s.modal.dataset.editorHighlight=f,e.data?.roomId?s.modal.dataset.editorHighlightRoom=String(e.data.roomId):delete s.modal.dataset.editorHighlightRoom,l("JourneyBookingPreviewEdited",{kind:v,changedFields:r,highlightTarget:f}),se(),M(s.modal,"guest",s.previewOpenedAt,"saved-and-returned-to-booking-page");return}if(t==="marketel:checkout-reached"){if(s?.iframe?.contentWindow!==e.source||m!=="guest")return;we(s);return}s?.iframe?.contentWindow===e.source&&(p("GuestAppPreviewRequestedFromBookingEngine"),M(s.modal,"edit",s.previewOpenedAt,"booking-install-explainer-continued"))}}function ke(){return`<div class="mvr-progress" aria-label="Marketel overview progress">
  ...
  </div>`}function Se(){return k?'<div class="mvr-page-status is-attention"><span>!</span>The live preview is still publishing. Your setup is saved, so you can continue without waiting.</div>':n.ready?`<div class="mvr-page-status is-ready"><span>✓</span>${n.reason==="local"?"Local guest preview connected":"Your live guest page is online"}</div>`:n.reason==="deployment-disabled"?'<div class="mvr-page-status is-attention"><span>!</span>Your live page deployment needs to be re-enabled. Your saved setup is safe.</div>':`<div class="mvr-page-status"><span class="mvr-status-pulse"></span>${n.checking?"Publishing your live guest page…":"Your personalized preview is ready while the live page finishes publishing."}</div>`}function Ie(){const e=P();return`<div class="mvr-booking-preview-card">
    <div class="mvr-preview-browser-bar">
      <span class="mvr-browser-dots"><i></i><i></i><i></i></span>
      <span class="mvr-preview-address"><b></b>${u(N())}</span>
  ...
  </div>`}function $e(){return`<section class="mvr-stage mvr-stage-booking">
    <div class="mvr-copy">
  ...
  </section>`}function ee(e,t){return`<img class="mvr-ios-system-icon" src="${u(e)}" alt="${u(t)}">`}function Ae(){return`<section class="mvr-stage mvr-stage-app">
    <div class="mvr-copy">
                ...
                <div class="mvr-install-entry">
                  ...
                  <div class="mvr-ios-crop">
                    <div class="mvr-ios-dock">
                      ...
                      <div class="mvr-dock-icon">${ee(ue,"Safari")}</div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  </section>`}function Re(){const e=W().name||"King Suite",t=q==="release";return`<section class="mvr-stage mvr-stage-assistant">
    <div class="mvr-copy">
    ...
    <div class="mvr-visual mvr-assistant-visual">
      <div class="mvr-booking-alert">
        ...
        <div><span>Front Desk</span><strong>New ${u(e)} booking</strong><small>Tomorrow · ${J(ve())}</small></div>
        <b>now</b>
      </div>
      <div class="mvr-chat">
  ...
  </section>`}function Ce(){const e=d.hotelSubscribed,t=h==="year",a=t?"$1,990":"$199",i=t?"/year":"/month",r=t?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month",v=`<div class="mvr-value-list">
  ...
  </section>`}function Pe(){return o===0?$e():o===1?Ae():o===2?Re():Ce()}function Be(){if(o===0)return!K&&!k?"":`<div class="mvr-footer mvr-footer-booking">
    ...
    <div class="mvr-live-topline">
      ...
      <div class="mvr-live-address" id="mvrLiveLocation" aria-label="Your live booking address">
        ...
        <strong data-live-location-text>${u(N())}</strong>
      </div>
  ...
  </div>`,document.getElementById("marketelValueReveal")?.appendChild(a);const i=a.querySelector(".mvr-live-stage > iframe");s={modal:a,iframe:i,layer:a.querySelector(".mvr-challenge-layer"),timer:a.querySelector(".mvr-challenge-timer"),previewOpenedAt:t,status:"waiting",hasPrompted:!1,startedAt:0,timerId:0,promptFallbackId:0,promptDelayId:0},s.promptFallbackId=window.setTimeout(()=>{s?.modal!==a||s.status!=="waiting"||I(a,!0)},4e3),i?.addEventListener("load",()=>{const r=s;r?.modal!==a||m!=="guest"||(r.promptDelayId&&window.clearTimeout(r.promptDelayId),r.promptDelayId=window.setTimeout(()=>{r.promptDelayId=0,ye(r)},1500))}),a.querySelector("#mvrClosePreview")?.addEventListener("click",()=>{l("JourneyBookingPreviewModeChanged",{action:"closed",mode:m},{durationMs:Date.now()-t}),Y("preview-closed",!0),s=null,a.remove(),y()}),a.querySelector("#mvrContinueGuestApp")?.addEventListener("click",()=>{Le(a,t,"continued-without-editor")}),a.querySelector("#mvrLiveForward")?.addEventListener("click",()=>{if(m==="guest"){M(a,"edit",t,"guided-forward");return}M(a,"guest",t,"returned-to-booking-page")}),p("BookingEngineFullPreviewOpened"),l("JourneyBookingPreviewOpened",{mode:"guest",bookingPageReady:!!n.ready,bookingPageReason:n.reason||""})}function Le(e,t,a){e?.isConnected&&(l("JourneyRevealNavigation",{action:a,toStep:1,editorViewed:m==="edit"},{durationMs:Date.now()-t}),Y("continued-to-guest-app",!1),s=null,e.remove(),G(1))}function M(e,t,a,i="mode-selected"){if(!e?.isConnected)return;t==="edit"&&Y("edit-mode-selected",!0),m=t==="edit"?"edit":"guest";const r=e.querySelector("#mvrLiveLocation"),v=e.querySelector("[data-live-location-text]"),f=e.querySelector("#mvrLiveForward"),$=e.querySelector("#mvrContinueGuestApp"),j=e.querySelector("[data-live-forward-long]"),Q=f?.querySelector("b");r?.classList.toggle("is-editor",m==="edit"),v&&(v.textContent=m==="edit"?"Front Desk editor":N()),r&&r.setAttribute("aria-label",m==="edit"?"Front Desk editor":"Your live booking address"),j&&(j.textContent=m==="edit"?"Back to your booking page":"See how to edit your booking page"),Q&&(Q.textContent=m==="edit"?"↩":"→"),f&&f.setAttribute("aria-label",m==="edit"?"Back to your direct booking page":"See how you edit this booking page"),$&&($.hidden=!1),I(e,!0);const x=e.querySelector(".mvr-live-stage > iframe");if(x)if(x.title=m==="edit"?`${b()} Front Desk editor`:`${b()} booking-page preview`,m==="edit")x.src=ge();else{const L=new URL(P());if(e.dataset.editorSaved==="1"){L.searchParams.set("previewRefresh",String(Date.now()));const X=e.dataset.editorPreviewTarget==="checkout";L.searchParams.set("previewHighlight",X?"checkout-policy":e.dataset.editorHighlight||"header"),X?L.searchParams.set("previewCheckout","1"):e.dataset.editorHighlightRoom&&L.searchParams.set("previewHighlightRoom",e.dataset.editorHighlightRoom),delete e.dataset.editorSaved,delete e.dataset.editorHighlight,delete e.dataset.editorHighlightRoom,delete e.dataset.editorPreviewTarget}x.src=L.toString()}l("JourneyBookingPreviewModeChanged",{action:i,mode:m},{durationMs:Date.now()-a}),m==="edit"&&p("BookingEngineEditPreviewViewed")}function G(e){E();const t=o,a=Math.max(0,Math.min(3,e)),i=Date.now();C&&a!==t&&l("JourneyRevealStageCompleted",{revealStep:t,stageName:["booking-page","guest-app","front-desk-assistant","activation"][t]||"unknown",nextStep:a,direction:a>t?"forward":"back"},{durationMs:i-C}),o=a,C=i,be(),p(["BookingEngineRevealViewed","GuestAppRevealViewed","AssistantRevealViewed","ActivationOfferViewed"][o]),l("JourneyRevealStageViewed",{resumed:V,bookingPageReady:o===0?!!n.ready:void 0}),V=!1,y(),document.querySelector(".mvr-main")?.scrollTo({top:0,behavior:"auto"})}function De(){C&&l("JourneyRevealStageCompleted",{action:"reveal-finished",totalRevealMs:O?Date.now()-O:null},{durationMs:Date.now()-C}),S&&(window.clearTimeout(S),S=0),Y("reveal-finished",!0),s=null,E(),document.getElementById("marketelValueReveal")?.remove(),document.documentElement.classList.remove("marketel-reveal-open"),document.body.style.overflow="",window.removeEventListener("message",re),d.settingsTourActive=!1;try{localStorage.removeItem(B),localStorage.removeItem(T),localStorage.setItem("settingsTourDone","1"),localStorage.setItem("onboardingDone","1")}catch{}fe(),ie(!0),typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner(),typeof window.refreshGoLiveInlineCard=="function"&&window.refreshGoLiveInlineCard()}async function Te(e){if(d.hotelSubscribed){De();return}if(typeof window.goLive=="function"){e.disabled=!0,e.textContent="Opening secure checkout…",p("ActivationCtaClicked");try{await window.goLive({billingInterval:h})}finally{document.body.contains(e)&&(e.disabled=!1,e.textContent=h==="year"?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month")}}}function E(){R&&(window.clearTimeout(R),R=0),A?.disconnect(),A=null}function U(e){g=!!e;const t=document.querySelector(".mvr-install-visual");t?.classList.toggle("is-installed",g);const a=document.getElementById("mvrInstallDemo");a&&(a.textContent=g?"Installed ✓":"Install",a.disabled=g);const i=t?.querySelector(".mvr-install-arrow span");i&&(i.textContent=g?"Now on their Home Screen":"Tap Install")}function z(e,t=!1){E(),c=Number(e)===1?1:0;const a=document.querySelector(".mvr-install-visual");a&&(a.classList.toggle("is-slide-2",c===1),a.querySelectorAll(".mvr-app-carousel-slide").forEach((i,r)=>{i.setAttribute("aria-hidden",r===c?"false":"true")}),a.querySelectorAll(".mvr-app-carousel-dots button").forEach(i=>{const r=Number(i.dataset.mvrAppSlide)===c;i.classList.toggle("is-active",r),i.setAttribute("aria-current",r?"step":"false")}),a.querySelectorAll(".mvr-app-carousel-controls > button").forEach(i=>{i.disabled=Number(i.dataset.mvrAppSlide)===c}),c===1?U(!0):(U(!1),ne()),t&&p(c===1?"GuestAppValueSlideViewed":"GuestAppInstallSlideReplayed"),l("JourneyGuestAppDemo",{action:"slide-viewed",slide:c===1?"value":"install",manual:!!t}))}function oe(e=!1){g||c!==0||(E(),U(!0),e&&p("GuestAppInstallDemoClicked"),l("JourneyGuestAppDemo",{action:"install-demonstrated",manual:!!e}),R=window.setTimeout(()=>{o===1&&document.getElementById("marketelValueReveal")&&z(1,!1)},e?900:1200))}function ne(){if(E(),o!==1||c!==0)return;const e=document.querySelector(".mvr-install-visual");if(!e)return;const t=()=>{R||(R=window.setTimeout(()=>{o===1&&document.getElementById("marketelValueReveal")&&(g?z(1,!1):oe(!1))},g?900:1300))};"IntersectionObserver"in window?(A=new IntersectionObserver(a=>{a.some(i=>i.isIntersecting&&i.intersectionRatio>=.35)&&(A?.disconnect(),A=null,t())},{threshold:[.35]}),A.observe(e)):t()}function Fe(){document.getElementById("mvrNext")?.addEventListener("click",()=>{l("JourneyRevealNavigation",{action:"next",toStep:o+1}),G(o+1)}),document.getElementById("mvrBack")?.addEventListener("click",()=>{l("JourneyRevealNavigation",{action:"back",toStep:o-1}),G(o-1)}),document.getElementById("mvrExpandPreview")?.addEventListener("click",Ee),document.getElementById("mvrFinalCta")?.addEventListener("click",e=>Te(e.currentTarget)),document.querySelectorAll("[data-mvr-billing]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.mvrBilling==="year"?"year":"month";if(t!==h){h=t;try{localStorage.setItem(te,h)}catch{}p(t==="year"?"YearlyBillingSelected":"MonthlyBillingSelected"),l("JourneyBillingIntervalSelected",{billingInterval:h,price:h==="year"?1990:199,currency:"USD"}),y()}})}),document.getElementById("mvrInstallDemo")?.addEventListener("click",()=>{oe(!0)}),document.querySelectorAll("[data-mvr-app-slide]").forEach(e=>{e.addEventListener("click",()=>{const t=Number(e.dataset.mvrAppSlide)===1?1:0;t!==c&&z(t,!0)})}),document.querySelectorAll("[data-mvr-fallback]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.mvrFallback==="release"?"release":"confirm";t!==q&&(q=t,p(t==="release"?"AssistantReleaseFallbackSelected":"AssistantKeepFallbackSelected"),l("JourneyAssistantFallbackSelected",{noResponseAction:t}),typeof window.api=="function"&&window.api("POST","/api/crm/booking-approval",{noResponseAction:t}).catch(()=>{}),y())})}),ne()}async function se(){return D||typeof window.api!="function"||(D=Promise.all([window.api("GET","/api/crm/rooms"),window.api("GET","/api/crm/booking-approval").catch(()=>null)]).then(([e,t])=>(w={rooms:Array.isArray(e?.rooms)?e.rooms:[],rates:e?.rates||null},q=t?.data?.noResponseAction==="release"?"release":"confirm",w.rooms.length&&(d.editRooms=w.rooms),document.getElementById("marketelValueReveal")&&!document.getElementById("mvrLivePreview")&&y(),w)).catch(()=>w).finally(()=>{D=null})),D}async function le(){if(!(typeof window.api!="function"||!document.getElementById("marketelValueReveal"))){if(ae()){n={ready:!!P(),checking:!1,reason:"local",attempts:1,domain:""},P()&&(k=!1),l("JourneyBookingPageStatus",{ready:n.ready,reason:n.reason,attempts:n.attempts}),o===0&&!document.getElementById("mvrLivePreview")&&y();return}n.checking=!0,n.attempts+=1;try{const e=await window.api("GET","/api/crm/booking-page-status");n={ready:!!e?.ready,checking:!1,reason:String(e?.reason||""),attempts:n.attempts,domain:String(e?.domain||"")}}catch{n.checking=!1,n.reason="unreachable"}P()&&(k=!1),l("JourneyBookingPageStatus",{ready:n.ready,reason:n.reason,attempts:n.attempts}),o===0&&!document.getElementById("mvrLivePreview")&&y(),!(n.ready||n.reason==="deployment-disabled")&&n.attempts<10&&document.getElementById("marketelValueReveal")&&(S=window.setTimeout(le,6e3))}}function Me(e={}){if(document.getElementById("marketelValueReveal"))return;const t=Number(e.startAt);let a=0,i=!1;try{a=Number.parseInt(localStorage.getItem(T)||"0",10)}catch{}try{i=localStorage.getItem(B)==="1"}catch{}try{h=localStorage.getItem(te)==="year"?"year":"month"}catch{h="month"}if(o=Number.isFinite(t)?Math.max(0,Math.min(3,t)):Math.max(0,Math.min(3,Number.isFinite(a)?a:0)),d.hotelSubscribed&&o===3&&(o=0),m="guest",g=!1,c=0,K=!1,k=!1,O=Date.now(),C=0,V=!Number.isFinite(t)&&i,n={ready:!1,checking:!0,reason:"",attempts:0,domain:""},S&&window.clearTimeout(S),S=0,E(),!d.hotelSubscribed)try{localStorage.setItem(B,"1"),localStorage.setItem(T,String(o))}catch{}try{localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep")}catch{}d.settingsTourActive=!0,window.addEventListener("message",re),document.documentElement.classList.add("marketel-reveal-open"),document.body.style.overflow="hidden",ie(!1);const r=document.createElement("div");r.id="marketelValueReveal",r.className="mvr-root",document.body.appendChild(r),y(),p("ValueRevealStarted",d.hotelSubscribed?"subscribed-replay":"pre-activation"),l("JourneyRevealStarted",{startStep:o,replay:!!d.hotelSubscribed,pendingResume:V}),G(o),se(),le()}function Ne(){try{return localStorage.getItem(B)==="1"}catch{return!1}}function xe(){try{localStorage.removeItem(B),localStorage.removeItem(T)}catch{}}const He={clearPendingMarketelValueReveal:xe,hasPendingMarketelValueReveal:Ne,showMarketelValueReveal:Me};function qe(){de(He)}export{xe as clearPendingMarketelValueReveal,He as default,Ne as hasPendingMarketelValueReveal,qe as install,Me as showMarketelValueReveal};
