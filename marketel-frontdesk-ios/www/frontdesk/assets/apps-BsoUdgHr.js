import{c as a,a as J,b as X,e as ee}from"./settings-BP6Fp25k.js";function c(e){return typeof window<"u"&&typeof window[e]=="function"?window[e]:null}function H(...e){return c("ensureAppsViewRendered")?.(...e)}function U(...e){return c("showFinaleMockModal")?.(...e)}function N(...e){return c("finishTourHydration")?.(...e)}function q(...e){return c("goLive")?.(...e)}function V(...e){return c("toast")?.(...e)}function te(...e){return c("appsCloseLightbox")?.(...e)}let I=[],p=0,z=!1,w=null,S=null,B=null,h=null;function oe(){if(document.getElementById("frontdeskAppsTourStyle"))return;const e=document.createElement("style");e.id="frontdeskAppsTourStyle",e.textContent=`
  ...
  `,document.head.appendChild(e)}function x(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function j(){w&&(document.removeEventListener("keydown",w),w=null)}function ie(e){j(),w=t=>{if(t.defaultPrevented)return;const o=t.target&&t.target.tagName?t.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||t.target?.isContentEditable||(t.key==="Escape"?(t.preventDefault(),e.onSkip?.()):t.key==="Enter"||t.key==="ArrowRight"?(t.preventDefault(),e.onNext?.()):t.key==="ArrowLeft"&&(t.preventDefault(),e.onBack?.()))},document.addEventListener("keydown",w)}function re(e,t){return!e||!e.isConnected||t?.noHighlight?null:(e.dataset.appsTourOrigVisibility||(e.dataset.appsTourOrigVisibility=e.style.visibility||""),h?.destroy(),h=X(e,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=t?.spotlightBoxShadow??"none",o.style.outline=t?.spotlightOutline??"none",o.style.outlineOffset=t?.spotlightOutlineOffset??"0",(e.classList.contains("apps-story-line")||t?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),h?.element||null)}function K(e){const t=e||{};j(),B?.destroy(),B=null,h?.destroy(),h=null,S&&(clearTimeout(S),S=null);const o=document.getElementById("appsTourLightbox");o&&!t.keepLightbox&&o.remove();const i=document.getElementById("appsTourTooltip");i&&i.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(r=>r.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(r=>{r.style.position=r.dataset.appsTourOrigPosition||"",r.style.zIndex=r.dataset.appsTourOrigZIndex||"",r.style.isolation=r.dataset.appsTourOrigIsolation||"",r.style.boxShadow=r.dataset.appsTourOrigBoxShadow||"",r.style.outline=r.dataset.appsTourOrigOutline||"",r.style.outlineOffset=r.dataset.appsTourOrigOutlineOffset||"",r.style.transition=r.dataset.appsTourOrigTransition||"",r.style.visibility=r.dataset.appsTourOrigVisibility||"",r.dataset.appsTourOrigBorderTop!=null&&(r.style.borderTop=r.dataset.appsTourOrigBorderTop,r.style.paddingTop=r.dataset.appsTourOrigPaddingTop||"",delete r.dataset.appsTourOrigBorderTop,delete r.dataset.appsTourOrigPaddingTop),r.removeAttribute("data-apps-tour-highlighted"),delete r.dataset.appsTourOrigPosition,delete r.dataset.appsTourOrigZIndex,delete r.dataset.appsTourOrigIsolation,delete r.dataset.appsTourOrigBoxShadow,delete r.dataset.appsTourOrigOutline,delete r.dataset.appsTourOrigOutlineOffset,delete r.dataset.appsTourOrigTransition,delete r.dataset.appsTourOrigVisibility})}function f(e){K(),document.body.style.overflow="";const t=z;z=!1;try{const o=typeof H=="function"?H:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(e&&(localStorage.setItem("appsTourDone","1"),t||localStorage.getItem("settingsTourStep")==="handoff"||a.settingsTourActive)){const i=typeof U=="function"?U:window.showFinaleMockModal;if(typeof i=="function"){i();return}}}function ae(e){const t=p+e;t<0||t>=I.length||(p=t,b())}function C(){if(localStorage.setItem("appsTourDone","1"),z||localStorage.getItem("settingsTourStep")==="handoff"||a.settingsTourActive){a.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const t=typeof N=="function"?N:window.finishTourHydration;typeof t=="function"&&t()}}function ne(){C();const e=typeof q=="function"?q:window.goLive;if(f(!1),typeof e=="function"){e();return}const t=typeof V=="function"?V:window.toast;typeof t=="function"&&t("Open Go live to activate your booking page.","error")}function b(){oe();const e=I[p];if(!e){f(!0);return}const t=I.length,o=p>=t-1,i=`${p+1} / ${t}`,r=Math.max(8,Math.min(100,Math.round((p+1)/t*100))),n=document.querySelector(e.target);if(!n){p++,b();return}K({keepLightbox:!0});let s=document.getElementById("appsTourLightbox");s||(s=document.createElement("div"),s.id="appsTourLightbox",s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(s)),e.noHighlight||(n.dataset.appsTourOrigPosition=n.style.position||"",n.dataset.appsTourOrigZIndex=n.style.zIndex||"",n.dataset.appsTourOrigIsolation=n.style.isolation||"",n.dataset.appsTourOrigBoxShadow=n.style.boxShadow||"",n.dataset.appsTourOrigOutline=n.style.outline||"",n.dataset.appsTourOrigOutlineOffset=n.style.outlineOffset||"",n.dataset.appsTourOrigTransition=n.style.transition||"",n.style.position=n.style.position||"relative",n.style.zIndex="100002",n.style.isolation="isolate",n.style.transition="box-shadow 0.18s ease, outline 0.18s ease",n.style.boxShadow=e.spotlightBoxShadow??"none",n.style.outline=e.spotlightOutline??"none",n.style.outlineOffset=e.spotlightOutlineOffset??"0",(n.classList.contains("apps-story-line")||e.hideSpotlightBorder)&&(n.dataset.appsTourOrigBorderTop=n.style.borderTop||"",n.dataset.appsTourOrigPaddingTop=n.style.paddingTop||"",n.style.borderTop="none",n.style.paddingTop="0"),n.setAttribute("data-apps-tour-highlighted","1"));const l=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,k=e.scrollBlock||"nearest",v=l?"auto":"smooth";n.scrollIntoView({behavior:v,block:k});const y=()=>{const u=document.getElementById("appsTourTooltip");u&&u.remove();const g=Math.min(370,window.innerWidth-28),O=e.primaryLabel||(o?"Done":"Next"),G=e.secondaryLabel||(o?"Not now":"Skip tour"),$=p<=0,W=e.kicker||"Guestel",d=document.createElement("div");d.id="appsTourTooltip",d.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${g}px;max-width:${g}px;visibility:hidden;`,d.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${x(e.title)}">
        ...
        <div class="apps-tour-kicker">${x(W)}</div>
        <div class="apps-tour-title">${x(e.title)}</div>
        <p class="apps-tour-copy">${x(e.text)}</p>
        <div class="apps-tour-actions">
          <button type="button" id="appsTourBackBtn" class="apps-tour-btn" ${$?"disabled":""}>Back</button>
          <button type="button" id="appsTourSkipBtn" class="apps-tour-btn apps-tour-btn-ghost">${x(G)}</button>
          <button type="button" id="appsTourNextBtn" class="apps-tour-btn apps-tour-btn-primary">${x(O)}</button>
        </div>
      </div>`,document.body.appendChild(d),re(n,e);const T=d.querySelector(".apps-tour-panel");B?.destroy(),B=J({tooltip:d,panel:T,target:n,anchor:n,spotlight:h,options:{preferredPlacement:e.tooltipPosition||"auto",maxWidth:g,gap:e.tooltipGap??10,autoScroll:!0,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),d.style.visibility="visible";const D=()=>{if(e.activateOnNext){ne();return}if(o){C(),f(!1),e.openGuestInstallCoachOnNext&&window.setTimeout(()=>c("appsOpenGuestInstallCoach")?.(),0);return}p++,b()},L=()=>{if(o){C(),f(!1);return}f(!0)},M=()=>{p<=0||(p--,b())};document.getElementById("appsTourNextBtn").onclick=D,document.getElementById("appsTourSkipBtn").onclick=L;const R=document.getElementById("appsTourBackBtn");R&&(R.onclick=M),ie({onNext:D,onBack:M,onSkip:L})};S=setTimeout(()=>{requestAnimationFrame(y)},l?40:320)}function se(e){const t=e&&e.replay,o=e&&e.chainFromSettingsTour;if(!t&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;te(),f(!1),z=!!o;const i=!!a.hotelSubscribed;I=!!c("isNativeFrontdeskApp")?.()||document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1"?[{target:"#tour-guest-reach",kicker:"Guestel updates",title:"Reach guests who choose to hear from you.",text:"Guests who keep your property in Guestel and allow property updates can receive a notification from you.",tooltipPosition:"above"},{target:"#tour-native-guest-share",kicker:"Invite guests",title:"Give them one Guestel link.",text:"Show the QR or copy the Guestel link. Guests can book immediately, then keep your property and stay in Guestel.",tooltipPosition:"above"},{target:"#tour-guest-icon-section",kicker:"Make it yours",title:"Choose how your property appears.",text:"Use your logo or a clear property photo for your Guestel card.",scrollBlock:"start",tooltipPosition:"below"}]:[{target:"#tour-apps-intro",kicker:"The loop",title:"One system with a clear side for you and for guests.",text:"You use Marketel Front Desk. Guests use Guestel and your direct booking experience."},{target:"#tour-apps-first",kicker:"Your side",title:"Download Marketel Front Desk.",text:"The owner app receives new-booking alerts even when the web dashboard is closed. Guests do not download this app.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-then",kicker:"Their side",title:"Guests keep your property in Guestel.",text:"They tap Add on your booking page. Guestel keeps your property, reservations, and messages together.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-after",kicker:"Direct reach",title:"Send a notification to their phone whenever you want.",text:"Anyone who keeps your property in Guestel and opts into property updates becomes reachable from Marketel Front Desk.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the Guestel card feel like your property.",text:"Use a real logo or a clear property photo.",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10},{target:"#tour-apps-loop",kicker:i?"Live loop":"Activation",title:i?"This loop is on.":"Everything is ready to turn on.",text:i?"Guests book, keep your property in Guestel, receive opted-in updates, and message you. Front Desk gets the alerts.":a.marketelTrialEligible!==!1?"Start with 14 days of full access for $0 today. Guests can book direct, keep your property in Guestel, receive opted-in updates, and message you — while Front Desk receives the alerts.":"Reactivate Marketel so guests can book direct, keep your property in Guestel, receive opted-in updates, and message you — while Front Desk receives the alerts.",primaryLabel:i?"Done":a.marketelTrialEligible!==!1?"Start 14 days free":"Reactivate Marketel",secondaryLabel:i?"Close":"Keep exploring",activateOnNext:!i,tooltipPosition:"below",tooltipGap:8}],p=0,b()}function m(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function Y(){return String(a.guestelWalletSubtitle||a.activeHotelContext?.address||"Direct booking").trim()}function Q(){const e=document.getElementById("guestelWalletSubtitleInput"),t=String(e?.value||Y()).trim()||"Direct booking",o=document.getElementById("guestelWalletPreviewSubtitle");o&&(o.textContent=t);const i=document.getElementById("guestelWalletSubtitleCount");i&&(i.textContent=`${String(e?.value||"").length}/64`)}async function pe(){const e=document.getElementById("guestelWalletSubtitleInput"),t=document.getElementById("guestelWalletSubtitleSave"),o=String(e?.value||"").replace(/\s+/g," ").trim().slice(0,64);t&&(t.disabled=!0);try{const i=await api("POST","/api/crm/guestel-wallet-card",{subtitle:o});if(!i?.success)throw new Error(i?.message||"Could not save the Guestel card.");a.guestelWalletSubtitle=String(i.subtitle||"").trim(),e&&(e.value=a.guestelWalletSubtitle||String(i.fallbackSubtitle||"").trim()),Q(),toast("Guestel card updated.","success")}catch(i){toast(i?.message||"Could not save the Guestel card.","error")}finally{t&&(t.disabled=!1)}}function le(){const e=document.getElementById("edit-offer-enabled")?.checked,t=document.getElementById("edit-offer-kind")?.value==="amount"?"amount":"percent",o=Number(document.getElementById("edit-offer-value")?.value)||0,i=document.getElementById("offerPreview");if(i){if(!e||o<=0){i.textContent="Guests see their normal rate.",i.style.opacity="0.6";return}i.style.opacity="1",i.textContent=t==="amount"?`Returning guests see $${o} off per night.`:`Returning guests see ${o}% off the direct rate.`}}async function de(){const e=!!document.getElementById("edit-offer-enabled")?.checked,t=document.getElementById("edit-offer-kind")?.value==="amount"?"amount":"percent",o=Number(document.getElementById("edit-offer-value")?.value)||0;try{await api("POST","/api/crm/hotel-info",{returnOfferEnabled:e,returnOfferKind:t,returnOfferValue:o}),a.returnOfferEnabled=e,a.returnOfferKind=t,a.returnOfferValue=o,toast(e?"Returning-guest offer saved!":"Offer turned off","success")}catch(i){toast(i?.message||"Could not save offer","error"),A()}}function P(){const e=(a.editRooms||[]).flatMap(t=>Array.isArray(t?.images)?t.images:[]).map(t=>String(t?.url||"").trim()).find(Boolean)||"";return String(a.guestelWalletImageUrl||a.guestelWalletFallbackImageUrl||e||"").trim()}function _(e){const t=document.getElementById("guestelWalletPreviewImage");if(!t)return;const o=String(e||P()).trim();t.classList.toggle("has-image",!!o),t.innerHTML=o?`<img src="${m(o)}" alt="Guestel wallet cover">`:"<span>Add a room photo</span>";const i=document.getElementById("guestelWalletImageRemove");i&&(i.hidden=!String(a.guestelWalletImageUrl||"").trim())}async function ce(e){const t=e?.files?.[0];if(!t)return;const o=document.getElementById("guestelWalletImageButton"),i=a.guestelWalletImageUrl;o&&(o.disabled=!0,o.textContent="Uploading…");const r=new FormData;r.append("image",t);try{const n=new URLSearchParams;a.activeHotelId&&n.set("hotelId",a.activeHotelId);const s=await fetch(`/api/crm/guestel-wallet-image?${n}`,{method:"POST",headers:{"x-crm-token":a.token,...isNativeFrontdeskApp()?{"x-marketel-client":"ios"}:{}},body:r}),l=await s.json();if(!s.ok||!l?.success||!l.imageUrl)throw new Error(l?.message||"Could not update the Guestel cover.");a.guestelWalletImageUrl=l.imageUrl,_(l.imageUrl),toast("Guestel cover updated.","success")}catch(n){_(i),toast(n?.message||"Could not update the Guestel cover.","error")}finally{e.value="",o&&(o.disabled=!1,o.textContent=a.guestelWalletImageUrl?"Change cover":"Choose custom cover")}}async function ue(){const e=document.getElementById("guestelWalletImageRemove");e&&(e.disabled=!0);try{const t=await api("DELETE","/api/crm/guestel-wallet-image");if(!t?.success)throw new Error(t?.message||"Could not reset the Guestel cover.");a.guestelWalletImageUrl="",_(P());const o=document.getElementById("guestelWalletImageButton");o&&(o.textContent="Choose custom cover"),toast("Guestel will use your first room photo.","success")}catch(t){toast(t?.message||"Could not reset the Guestel cover.","error")}finally{e&&(e.disabled=!1)}}function ge(e){const t=document.getElementById("appsView");if(!t)return;const o=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",i=(a.activeHotelId||"")+"|"+(a.activeHotelAppIcon||"")+"|"+(a.activeHotelDomain||"")+"|"+(a.guestelWalletImageUrl||"")+"|"+(a.guestelWalletFallbackImageUrl||"")+"|"+(a.guestelWalletSubtitle||"")+"|"+(o?"native-preview":"standard");e||t.dataset.appsKey!==i||!t.querySelector(".apps-page")?(A(),t.dataset.appsKey=i):(isNativeFrontdeskApp()||o)&&F()}function A(){const e=document.getElementById("appsView");if(!e)return;const t=a.activeHotelName||"Your Property",o=a.activeHotelDomain||"",i=o?"https://"+o:"#",r=a.activeHotelId?`https://clip.mktel.co/clip/${encodeURIComponent(a.activeHotelId)}?intent=book&ref=frontdesk-guestel`:i,n=isStandaloneApp(),s=isNativeFrontdeskApp(),l=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",k=s||l,v=Y(),y=P(),E=!!String(a.guestelWalletImageUrl||"").trim(),u=Number(a.returnOfferValue)||0,g=a.returnOfferKind==="amount",O=a.returnOfferEnabled&&u>0?g?`Returning guests see $${u} off per night.`:`Returning guests see ${u}% off the direct rate.`:"Guests see their normal rate.",G=`
    <div class="apps-step-card" id="tour-native-guest-share">
      ...
      <div class="guestel-wallet-editor">
        <div class="guestel-wallet-card" aria-label="Preview of ${m(t)} in Guestel">
          <div class="guestel-wallet-cover${y?" has-image":""}" id="guestelWalletPreviewImage">${y?`<img src="${m(y)}" alt="Guestel wallet cover">`:"<span>Choose a cover photo</span>"}</div>
          <div class="guestel-wallet-copy">
            <strong>${m(t)}</strong>
            <span id="guestelWalletPreviewSubtitle">${m(v)}</span>
          </div>
        </div>
        ...
        <div class="guestel-wallet-actions">
          <button type="button" id="guestelWalletImageButton" onclick="document.getElementById('guestelWalletImageInput').click()">${E?"Change cover":"Choose custom cover"}</button>
          <button type="button" id="guestelWalletImageRemove" class="quiet" onclick="resetGuestelWalletImage()"${E?"":" hidden"}>Use room photo</button>
        </div>
        ...
        <div class="guestel-wallet-field">
          <input id="guestelWalletSubtitleInput" maxlength="64" value="${m(v)}" placeholder="Location or a short reason to book direct" oninput="updateGuestelWalletPreview()">
          <span id="guestelWalletSubtitleCount">${v.length}/64</span>
        </div>
      ...
      <div id="offerPreview" class="apps-offer-preview">${O}</div>
    ...
    ${guestBroadcastCardHtml({compact:!0})}`,T=k?"":n?"Front Desk is installed. Guests use Guestel; owners use Marketel Front Desk.":"You use Marketel Front Desk. Guests use Guestel.";e.innerHTML=`
  <style>
  ...
  <div class="apps-page">
    ...
    ${T?`<p class="apps-footnote">${T}</p>`:""}

  </div>`,typeof lucide<"u"&&lucide.createIcons(),k&&(a.guestMessages.length?renderMessages():loadMessages(),F(),Z())}async function Z(){try{const e=await api("GET","/api/crm/booking-review-settings");if(!e?.success||!e.data)return;a.bookingReviewSettings=e.data;const t=document.getElementById("bookingReviewReminderSelect");t&&(t.value=String(e.data.reminderMinutes))}catch{}}async function fe(e){const t=String(a.bookingReviewSettings?.reminderMinutes??15),o=parseInt(e?.value,10);if([0,15,30,60].includes(o)){e&&(e.disabled=!0);try{const i=await api("POST","/api/crm/booking-review-settings",{reminderMinutes:o});if(!i?.success)throw new Error(i?.message||"Could not save reminder timing.");a.bookingReviewSettings=i.data,toast(o===0?"Booking reminders off — the first alert will still arrive.":`Booking reminders set for every ${o===60?"hour":o+" minutes"}.`,"success")}catch(i){e&&(e.value=t),toast(i?.message||"Could not save reminder timing.","error")}finally{e&&(e.disabled=!1)}}}async function F(){const e=document.getElementById("guestInstallStats");try{const t=await api("GET","/api/crm/guest-install-stats");if(!t.success)throw new Error(t.message||"Failed");if(a.guestPushSubscriberCount=t.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!e)return;const o=t.totals||{},i=o.notification_prompts||0,r=t.guestPushSubscribers||0,n=t.guestelSavedDevices||0,s=t.guestelBroadcastSubscribers||0;if(!t.guestelSavedDevices&&!t.guestelBroadcastSubscribers){e.style.display="none",e.innerHTML="";return}e.style.display="block",e.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guestel activity</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+n+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">devices keeping your property</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">Guestel devices opted into updates</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+r+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">total reachable devices</div></div></div>'+(i?'<div style="font-size:11px;color:var(--text-muted);margin:-2px 0 10px;">Notification permission: '+(o.notification_granted||0)+" granted · "+(o.notification_denied||0)+" denied · "+(o.notification_dismissed||0)+" dismissed · "+(o.notification_failed||0)+" failed</div>":"")}catch{a.guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),e&&(e.style.display="none",e.innerHTML="")}}const xe={appsTourClose:f,appsTourNav:ae,appsTourRender:b,ensureAppsViewRendered:ge,loadBookingReviewSettings:Z,loadGuestInstallStats:F,renderAppsView:A,resetGuestelWalletImage:ue,saveBookingReviewReminderSetting:fe,saveGuestelWalletCard:pe,saveReturnOffer:de,startAppsTour:se,updateReturnOfferPreview:le,updateGuestelWalletPreview:Q,uploadGuestelWalletImage:ce};function he(){ee(xe)}export{xe as default,he as install};
