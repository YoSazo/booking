import{c as r,a as Dt,b as Mt,e as Nt}from"./settings-CsnKIiEZ.js";function m(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function at(...t){return m("ensureAppsViewRendered")?.(...t)}function st(...t){return m("showFinaleMockModal")?.(...t)}function rt(...t){return m("finishTourHydration")?.(...t)}function pt(...t){return m("goLive")?.(...t)}function lt(...t){return m("toast")?.(...t)}function Rt(...t){return m("appsCloseLightbox")?.(...t)}let M=[],g=0,N=!1,L=null,P=null,R=null,T=null;function jt(){if(document.getElementById("frontdeskAppsTourStyle"))return;const t=document.createElement("style");t.id="frontdeskAppsTourStyle",t.textContent=`
    #appsTourLightbox {
  ...
  `,document.head.appendChild(t)}function k(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function dt(){L&&(document.removeEventListener("keydown",L),L=null)}function qt(t){dt(),L=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",L)}function Vt(t,e){return!t||!t.isConnected||e?.noHighlight?null:(t.dataset.appsTourOrigVisibility||(t.dataset.appsTourOrigVisibility=t.style.visibility||""),T?.destroy(),T=Mt(t,{attribute:"data-apps-tour-spotlight-clone",zIndex:100002,hideSource:!0,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"none",o.style.outline=e?.spotlightOutline??"none",o.style.outlineOffset=e?.spotlightOutlineOffset??"0",(t.classList.contains("apps-story-line")||e?.hideSpotlightBorder)&&(o.style.border="none",o.style.borderTop="none",o.style.borderTopWidth="0",o.style.paddingTop="0")}}),T?.element||null)}function ct(t){const e=t||{};dt(),R?.destroy(),R=null,T?.destroy(),T=null,P&&(clearTimeout(P),P=null);const o=document.getElementById("appsTourLightbox");o&&!e.keepLightbox&&o.remove();const a=document.getElementById("appsTourTooltip");a&&a.remove(),document.querySelectorAll("[data-apps-tour-spotlight-clone]").forEach(i=>i.remove()),document.querySelectorAll("[data-apps-tour-highlighted]").forEach(i=>{i.style.position=i.dataset.appsTourOrigPosition||"",i.style.zIndex=i.dataset.appsTourOrigZIndex||"",i.style.isolation=i.dataset.appsTourOrigIsolation||"",i.style.boxShadow=i.dataset.appsTourOrigBoxShadow||"",i.style.outline=i.dataset.appsTourOrigOutline||"",i.style.outlineOffset=i.dataset.appsTourOrigOutlineOffset||"",i.style.transition=i.dataset.appsTourOrigTransition||"",i.style.visibility=i.dataset.appsTourOrigVisibility||"",i.dataset.appsTourOrigBorderTop!=null&&(i.style.borderTop=i.dataset.appsTourOrigBorderTop,i.style.paddingTop=i.dataset.appsTourOrigPaddingTop||"",delete i.dataset.appsTourOrigBorderTop,delete i.dataset.appsTourOrigPaddingTop),i.removeAttribute("data-apps-tour-highlighted"),delete i.dataset.appsTourOrigPosition,delete i.dataset.appsTourOrigZIndex,delete i.dataset.appsTourOrigIsolation,delete i.dataset.appsTourOrigBoxShadow,delete i.dataset.appsTourOrigOutline,delete i.dataset.appsTourOrigOutlineOffset,delete i.dataset.appsTourOrigTransition,delete i.dataset.appsTourOrigVisibility})}function f(t){ct(),document.body.style.overflow="";const e=N;N=!1;try{const o=typeof at=="function"?at:window.ensureAppsViewRendered;typeof o=="function"&&o(!0)}catch{}if(t&&(localStorage.setItem("appsTourDone","1"),e||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive)){const a=typeof st=="function"?st:window.showFinaleMockModal;if(typeof a=="function"){a();return}}}function Yt(t){const e=g+t;e<0||e>=M.length||(g=e,S())}function W(){if(localStorage.setItem("appsTourDone","1"),N||localStorage.getItem("settingsTourStep")==="handoff"||r.settingsTourActive){r.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.removeItem("settingsTourStep");const e=typeof rt=="function"?rt:window.finishTourHydration;typeof e=="function"&&e()}}function Wt(){W();const t=typeof pt=="function"?pt:window.goLive;if(f(!1),typeof t=="function"){t();return}const e=typeof lt=="function"?lt:window.toast;typeof e=="function"&&e("Open Go live to activate your booking page.","error")}function S(){jt();const t=M[g];if(!t){f(!0);return}const e=M.length,o=g>=e-1,a=`${g+1} / ${e}`,i=Math.max(8,Math.min(100,Math.round((g+1)/e*100))),n=document.querySelector(t.target);if(!n){g++,S();return}ct({keepLightbox:!0});let s=document.getElementById("appsTourLightbox");s||(s=document.createElement("div"),s.id="appsTourLightbox",s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(17,24,39,0.42);pointer-events:auto;",document.body.appendChild(s)),t.noHighlight||(n.dataset.appsTourOrigPosition=n.style.position||"",n.dataset.appsTourOrigZIndex=n.style.zIndex||"",n.dataset.appsTourOrigIsolation=n.style.isolation||"",n.dataset.appsTourOrigBoxShadow=n.style.boxShadow||"",n.dataset.appsTourOrigOutline=n.style.outline||"",n.dataset.appsTourOrigOutlineOffset=n.style.outlineOffset||"",n.dataset.appsTourOrigTransition=n.style.transition||"",n.style.position=n.style.position||"relative",n.style.zIndex="100002",n.style.isolation="isolate",n.style.transition="box-shadow 0.18s ease, outline 0.18s ease",n.style.boxShadow=t.spotlightBoxShadow??"none",n.style.outline=t.spotlightOutline??"none",n.style.outlineOffset=t.spotlightOutlineOffset??"0",(n.classList.contains("apps-story-line")||t.hideSpotlightBorder)&&(n.dataset.appsTourOrigBorderTop=n.style.borderTop||"",n.dataset.appsTourOrigPaddingTop=n.style.paddingTop||"",n.style.borderTop="none",n.style.paddingTop="0"),n.setAttribute("data-apps-tour-highlighted","1"));const c=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,x=t.scrollBlock||"nearest",y=c?"auto":"smooth";n.scrollIntoView({behavior:y,block:x});const p=()=>{const w=document.getElementById("appsTourTooltip");w&&w.remove();const l=Math.min(370,window.innerWidth-28),b=t.primaryLabel||(o?"Done":"Next"),I=t.secondaryLabel||(o?"Not now":"Skip tour"),F=g<=0,E=t.kicker||"Guest App",d=document.createElement("div");d.id="appsTourTooltip",d.style.cssText=`position:fixed;z-index:100003;left:12px;top:14px;width:${l}px;max-width:${l}px;visibility:hidden;`,d.innerHTML=`
      <div class="apps-tour-panel" role="dialog" aria-live="polite" aria-label="${k(t.title)}">
        ...
        <div class="apps-tour-kicker">${k(E)}</div>
        <div class="apps-tour-title">${k(t.title)}</div>
        <p class="apps-tour-copy">${k(t.text)}</p>
        <div class="apps-tour-actions">
          <button type="button" id="appsTourBackBtn" class="apps-tour-btn" ${F?"disabled":""}>Back</button>
          <button type="button" id="appsTourSkipBtn" class="apps-tour-btn apps-tour-btn-ghost">${k(I)}</button>
          <button type="button" id="appsTourNextBtn" class="apps-tour-btn apps-tour-btn-primary">${k(b)}</button>
        </div>
      </div>`,document.body.appendChild(d),Vt(n,t);const $=d.querySelector(".apps-tour-panel");R?.destroy(),R=Dt({tooltip:d,panel:$,target:n,anchor:n,spotlight:T,options:{preferredPlacement:t.tooltipPosition||"auto",maxWidth:l,gap:t.tooltipGap??10,autoScroll:!0,avoidBottomSelectors:[".mobile-bottom-nav","#previewSiteBar"]}}),d.style.visibility="visible";const h=()=>{if(t.activateOnNext){Wt();return}if(o){W(),f(!1),t.openGuestInstallCoachOnNext&&window.setTimeout(()=>m("appsOpenGuestInstallCoach")?.(),0);return}g++,S()},O=()=>{if(o){W(),f(!1);return}f(!0)},V=()=>{g<=0||(g--,S())};document.getElementById("appsTourNextBtn").onclick=h,document.getElementById("appsTourSkipBtn").onclick=O;const G=document.getElementById("appsTourBackBtn");G&&(G.onclick=V),qt({onNext:h,onBack:V,onSkip:O})};P=setTimeout(()=>{requestAnimationFrame(p)},c?40:320)}function Ut(t){const e=t&&t.replay,o=t&&t.chainFromSettingsTour;if(!e&&!o&&localStorage.getItem("appsTourDone")||document.getElementById("appsTourLightbox")||document.getElementById("appsTourTooltip"))return;Rt(),f(!1),N=!!o;const a=!!r.hotelSubscribed;M=!!m("isNativeFrontdeskApp")?.()||document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1"?[{target:"#tour-guest-reach",kicker:"Direct guest reach",title:"Send a push notification directly to their phone.",text:"Every guest who downloads your app and turns on notifications can receive a message from you whenever you choose.",tooltipPosition:"above"},{target:"#tour-native-guest-share",kicker:"Build your audience",title:"Get your app onto their phone.",text:"Show the QR, copy the link, or open the guest page. They install it from there.",tooltipPosition:"above"},{target:"#tour-guest-icon-section",kicker:"Make it yours",title:"Choose the icon guests will save.",text:"Use your logo or a clear property photo.",scrollBlock:"start",tooltipPosition:"below"},{target:"#tour-native-install-guide",kicker:"Your cheat sheet",title:"Know exactly what to tell them.",text:"Open this anytime to practice the exact Safari taps for older iPhones and every iOS 26 layout.",primaryLabel:"Show me",secondaryLabel:"Close",openGuestInstallCoachOnNext:!0,tooltipPosition:"above"}]:[{target:"#tour-apps-intro",kicker:"The loop",title:"Your property becomes the app—and the direct connection.",text:"Guests book direct, save your property to their phone, and can receive notifications from you."},{target:"#tour-apps-first",kicker:"Your side",title:"Put Front Desk on your phone in 3 steps.",text:"There is no App Store. Save this page to your home screen so new bookings can reach you before they confirm — even when Front Desk is closed.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-then",kicker:"Their side",title:"Guests install from your booking page.",text:"One tap on Install and your icon is on their home screen.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-apps-after",kicker:"Direct reach",title:"Send a notification to their phone whenever you want.",text:"Anyone who installs your app and turns on notifications becomes reachable directly from Front Desk.",scrollBlock:"center",tooltipPosition:"below",tooltipGap:8},{target:"#tour-guest-icon-section",kicker:"One setup item",title:"Make the icon feel like your property.",text:"A real logo or a clear photo. Guests see this square every time.",scrollBlock:"start",tooltipPosition:"auto",tooltipGap:10},{target:"#tour-apps-loop",kicker:a?"Live loop":"Activation",title:a?"This loop is on.":"Everything is ready to turn on.",text:a?"Guests book, save your property, receive your updates, and message you. Front Desk gets the alerts.":"For $199/month, guests can book direct, save your property, receive your updates, and message you — while Front Desk receives the alerts.",primaryLabel:a?"Done":"Activate everything — $199/month",secondaryLabel:a?"Close":"Keep exploring",activateOnNext:!a,tooltipPosition:"below",tooltipGap:8}],g=0,S()}const u={homeScreen:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179630/unnamed_lbsctp.jpg",guestHome:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2475_1_jxip3r.png",guestBook:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179611/IMG_2476_1_tqbmgz.png",guestMessagesImg:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179605/IMG_2477_1_zgodnn.png",frontdeskMessages:"https://res.cloudinary.com/dkmr3h5jb/image/upload/v1781179656/unnamed_2_qfhkrr.png",guestMessageNotifVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-10-2026_23-43-50_1_z22p4m.mp4",guestInstallVideo:"https://res.cloudinary.com/dkmr3h5jb/video/upload/f_mp4,q_auto/ScreenRecording_06-11-2026_00-03-19_1_lgdf59.mp4"},Zt="32px";function Z(t,e){return t.replace("/image/upload/","/image/upload/f_auto,q_auto,w_"+(e||400)+"/")}function U(t){return`border-radius:${Zt};box-shadow:0 10px 36px rgba(0,0,0,0.22);${t||""}`}function gt(t){const e=Math.min(window.devicePixelRatio||1,2),o=Math.round(Math.min(window.screen.width*e,1600));return t.replace("/image/upload/",`/image/upload/f_auto,q_auto:best,w_${o}/`)}let j=[],C=0,q="ios26",z=null,ut="",_=null;function Kt(t,e){f(!1),isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),j=t,C=e||0;let o=document.getElementById("appsLightbox");if(!o){o=document.createElement("div"),o.id="appsLightbox",o.style.cssText=["position:fixed;inset:0;z-index:102000;background:#000;","display:flex;flex-direction:column;align-items:center;justify-content:flex-start;","overscroll-behavior:contain;touch-action:pan-y;","padding-left:env(safe-area-inset-left,0px);padding-right:env(safe-area-inset-right,0px);"].join(""),document.body.appendChild(o),document.body.style.overflow="hidden",o._keyHandler=i=>{i.key==="ArrowRight"||i.key==="ArrowDown"?D(1):i.key==="ArrowLeft"||i.key==="ArrowUp"?D(-1):i.key==="Escape"&&K()},document.addEventListener("keydown",o._keyHandler);let a=0;o.addEventListener("touchstart",i=>{a=i.changedTouches[0].clientX},{passive:!0}),o.addEventListener("touchend",i=>{const n=i.changedTouches[0].clientX-a;Math.abs(n)>50&&D(n<0?1:-1)},{passive:!0})}document.body.style.overflow="hidden",Q()}function K(){const t=document.getElementById("appsLightbox");t&&(document.removeEventListener("keydown",t._keyHandler),t.remove(),document.body.style.overflow="",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState()))}function D(t){const e=j.length;e<=1||(C=(C+t+e)%e,Q())}function Q(){const t=document.getElementById("appsLightbox");if(!t)return;const e=j[C],o=j.length,a=e.type!=="video",i=o>1?`${C+1} / ${o}`:"",n=a?`<img src="${gt(e.src)}" alt="${e.alt||""}"
       ...
       </video>`,s=o>1?'<button onclick="appsLbNav(-1)" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">‹</button>':"",c=o>1?'<button onclick="appsLbNav(1)"  style="position:absolute;right:12px;top:50%;transform:translateY(-50%);width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">›</button>':"",x=o>1?`<div style="display:flex;gap:7px;justify-content:center;margin-top:12px;">
    ${Array.from({length:o},(y,p)=>`<div onclick="appsOpenLightbox(_appsLbItems,${p})" style="width:7px;height:7px;border-radius:50%;background:${p===C?"#fff":"rgba(255,255,255,0.35)"};cursor:pointer;transition:background 0.2s;"></div>`).join("")}
  </div>`:"";t.innerHTML=`
  ...
  </svg>`}function Qt(){return`<svg viewBox="44 39.5 21 13" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Xt(){return`<svg viewBox="0 0 28 28" focusable="false" aria-hidden="true">
  ...
  </svg>`}function Jt(t,e){const o=[...t?[{label:"More",icon:ht()}]:[],{label:"Share",icon:X()},...e?[{label:"View More",icon:Qt()}]:[],{label:"Add to Home Screen",icon:Xt()}];return`<div class="agic-sequence" aria-label="${o.map(a=>a.label).join(", then ")}">
  ...
  </div>`}function ft(){const t=q==="ios26",e=z==="compact",i=t&&!z?`
    ...
    <section class="agic-sheet" role="dialog" aria-modal="true" aria-label="How guests install your app">
      ...
      ${i}
    </section>`}function xt(){const t=document.getElementById("appsGuestInstallCoach");t&&(t.innerHTML=ft())}function te(){f(!1),K(),document.getElementById("appsGuestInstallCoach")?.remove(),q="ios26",z=null,ut=document.body.style.overflow,document.body.style.overflow="hidden",isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&window.setNativeShellVisible(!1),_=e=>{e.key==="Escape"&&bt()},document.addEventListener("keydown",_);const t=document.createElement("div");t.id="appsGuestInstallCoach",t.innerHTML=ft(),document.body.appendChild(t)}function bt(){_&&(document.removeEventListener("keydown",_),_=null),document.getElementById("appsGuestInstallCoach")?.remove(),document.body.style.overflow=ut,isNativeFrontdeskApp()&&typeof window.setNativeShellVisible=="function"&&(window.setNativeShellVisible(!0),typeof window.syncNativeShellState=="function"&&window.syncNativeShellState())}function ee(t){q=t==="classic"?"classic":"ios26",z=q==="classic"?"standard":null,xt()}function oe(t){z=["standard","compact"].includes(t)?t:null,xt()}function mt(t,e){const o=t||"Video";return`<span class="${"apps-media-badge"+(e==="light"?" apps-media-badge--light":"")}" title="Short video walkthrough"><span class="apps-media-badge__ring" aria-hidden="true"><span class="apps-media-badge__play" aria-hidden="true"></span></span><span class="apps-media-badge__label">${o}</span></span>`}function A(t,e,o,a,i){const n=i?mt("Video"):"",s=i?'<span class="apps-q-media" aria-hidden="true"><span class="apps-q-media__play"></span></span>':'<span class="apps-q-chevron" aria-hidden="true">›</span>';return`<button type="button" class="apps-q${i?" apps-q--video":""}" onclick="appsOpenLightbox(${o},${a})">
    ...
    ${s}
  </button>`}function ie(){const t=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(t)&&!window.MSStream?"ios":/android/i.test(t)?"android":"ios"}function ne(t){const e=document.getElementById("appsView");if(!e)return;const o=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",a=(r.activeHotelId||"")+"|"+(r.activeHotelAppIcon||"")+"|"+(r.activeHotelDomain||"")+"|"+(o?"native-preview":"standard");t||e.dataset.appsKey!==a||!e.querySelector(".apps-page")?(yt(),e.dataset.appsKey=a):J()}function yt(){const t=document.getElementById("appsView");if(!t)return;const e=r.activeHotelName||"Your Property",o=r.activeHotelAppIcon||"",a=e.trim().charAt(0).toUpperCase()||"🏡",i=r.activeHotelDomain||"",n=i?"https://"+i:"#",s=i?"https://"+i+"/install":"#";function c(nt){return JSON.stringify(nt).replace(/"/g,"&quot;")}const x=Z(u.guestHome,520),y=[{type:"image",src:u.homeScreen,alt:"Two phone apps",title:"Your app and theirs — same home screen",caption:`You get <strong>Front Desk</strong> — check bookings and reply to guests. Your guests get <strong>${e}</strong> — they tap it to book you or text you. No app store.`}],p=[{type:"image",src:u.guestHome,alt:"Guest home screen",title:"What your guests see — Home",caption:"Their stay info — check-in time, your WiFi password, and more."},{type:"image",src:u.guestBook,alt:"Guest book screen",title:"What your guests see — Book a room",caption:"They book directly with you. You keep the money — no middleman."},{type:"image",src:u.guestMessagesImg,alt:"Guest messages",title:"What your guests see — Message you",caption:`They text you from the app — like "What's the WiFi password?"`}],v=[{type:"video",src:u.guestInstallVideo,poster:u.guestHome,alt:"Guest adds property to phone",title:"How guests put your property on their phone",caption:"They open your booking website and tap <strong>Add to Home Screen</strong>. Your property shows up on their phone like an app. You don't need to do anything."}],w=[{type:"image",src:u.guestMessagesImg,alt:"Guest sends message",title:"Your guest texts you",caption:'Like "How do I connect to WiFi?" — they type it in your guest app.'},{type:"image",src:u.frontdeskMessages,alt:"You reply",title:"You text them back",caption:"Open <strong>Guest App</strong>, choose the conversation, and reply."},{type:"video",src:u.guestMessageNotifVideo,poster:u.guestMessagesImg,alt:"Guest gets reply alert",title:"Their phone buzzes with your answer",caption:"They get your reply on their phone — like a text from you."}],l=isStandaloneApp(),b=isNativeFrontdeskApp(),I=document.body.classList.contains("frontdesk-editor-preview")||new URLSearchParams(window.location.search).get("previewEditor")==="1",F=b||I,E=String(r.nativeNotificationState||""),d=I||E==="registered",$=I||["authorized","registered","unavailable"].includes(E),h=b?d:l,O=b?d:h&&typeof Notification<"u"&&Notification.permission==="granted",G=!!(window.matchMedia&&window.matchMedia("(max-width: 767px)").matches)?"Put Front Desk on this phone":"Put Front Desk on my phone",H=Number(r.bookingReviewSettings?.reminderMinutes??15),tt=`
    <div id="bookingReviewReminderSetting" style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border);">
      ...
      <div id="bookingReviewReminderHint" style="font-size:11px;color:var(--text-muted);line-height:1.45;margin-top:7px;">${b?d?"Reminders can reach this iPhone even when Front Desk is closed.":$?"Front Desk is connecting this iPhone to booking alerts.":"Allow notifications in iPhone Settings to receive booking alerts.":l?"Reminders stop as soon as you verify the room or cancel the booking.":"Download Front Desk to unlock this setting."}</div>
    </div>`;let B;b?B=`<div id="tour-fd-installed-badge" style="display:flex;align-items:flex-start;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
      ...
      <div style="flex:1;min-width:0;"><div style="font-size:13px;font-weight:700;color:#166534;">Front Desk is installed</div><div style="font-size:12px;color:#166534;margin-top:2px;line-height:1.45;">${d?"Booking alerts can reach this iPhone even when the app is closed.":$?"Connecting this iPhone to booking alerts…":"Allow notifications in iPhone Settings so booking alerts can reach you."}</div></div>
    </div>`:l&&O?B=`<div id="tour-fd-installed-badge" style="display:flex;align-items:center;gap:10px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px 16px;">
      <div style="width:32px;height:32px;border-radius:50%;background:#2E7D5B;color:#fff;display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0;">✓</div>
    ...
    </div>`:l?B=`<div id="tour-fd-installed-badge"><p style="font-size:13px;color:var(--text-muted);margin:0 0 12px;line-height:1.55;">Front Desk is on this device. Turn on alerts so confirmed bookings and guest messages reach your phone.</p>
      ...
      <div style="font-size:12px;color:var(--text-muted);line-height:1.45;text-align:center;">Locked until Front Desk is installed on your phone</div>`;const wt=b?`<div class="apps-story-status">
        <span class="apps-story-status-icon">✓</span>
        <span>Front Desk is installed here. ${d?"This iPhone can receive booking alerts.":$?"Booking-alert connection is in progress.":"Turn on notifications in iPhone Settings to receive booking alerts."}</span>
    ...
    <div class="apps-icon-card">
      ...
      ${s==="#"?'<p style="font-size:12px;color:var(--text-muted);margin:12px 0 0;">Your booking domain is still setting up.</p>':""}`,It=s!=="#"?`
      ...
      </div>`:'<div id="guestInstallStats" style="display:none;"></div>',$t=`
    ...
    <section class="apps-story">
      ...
      <div class="apps-story-line" id="tour-apps-after">
        ...
        <div style="border-radius:12px;background:#f4f7f9;border:1px solid var(--border);margin:0 0 12px;padding:16px;text-align:center;">
          <img src="${x}" alt="Guest saves property to phone" loading="eager" decoding="sync" style="max-width:140px;width:55%;height:auto;min-height:120px;display:block;margin:0 auto;border-radius:12px;box-shadow:0 4px 14px rgba(0,0,0,0.1);">
        </div>
        <button type="button" class="apps-video-teaser" onclick="appsOpenLightbox(${c(v)},0)" style="margin-bottom:12px;"><span class="apps-video-teaser__play" aria-hidden="true"></span><span>Watch how guests install (1 min)</span></button>
        ...
        <div class="apps-q-list">
          ${A("What guests see on their phone","",c(p),0,!1)}
          ${A("How guests add your property","",c(v),0,!0)}
          ${A("Guest texts you, you text back","",c(w),0,!0)}
          ${A("Your app and theirs — side by side","",c(y),0,!1)}
        </div>
        ${n!=="#"?`<button onclick="window.open('${n}','_blank')" style="width:100%;padding:13px;border-radius:12px;border:1.5px solid var(--border);background:none;color:var(--text);font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;margin-top:4px;">Preview guest website ↗</button>`:""}`,Lt=nt=>`
    ...
    ${Et}`,Pt=F?Gt:`${Bt}
      ${$t}
      ${ot}
      ${l?Ht:`${_t}${Y()}`}`,it=F?"":l?"Front Desk is installed. Guests can install your property from the direct booking page.":"Install Front Desk first. Then guests can install your property from the direct booking page.";t.innerHTML=`
  <style>
  ...
  </div>`,typeof lucide<"u"&&lucide.createIcons(),r.guestMessages.length?renderMessages():loadMessages(),J(),vt()}async function vt(){try{const t=await api("GET","/api/crm/booking-review-settings");if(!t?.success||!t.data)return;r.bookingReviewSettings=t.data;const e=document.getElementById("bookingReviewReminderSelect");e&&(e.value=String(t.data.reminderMinutes))}catch{}}async function ae(t){const e=String(r.bookingReviewSettings?.reminderMinutes??15),o=parseInt(t?.value,10);if([0,15,30,60].includes(o)){t&&(t.disabled=!0);try{const a=await api("POST","/api/crm/booking-review-settings",{reminderMinutes:o});if(!a?.success)throw new Error(a?.message||"Could not save reminder timing.");r.bookingReviewSettings=a.data,toast(o===0?"Booking reminders off — the first alert will still arrive.":`Booking reminders set for every ${o===60?"hour":o+" minutes"}.`,"success")}catch(a){t&&(t.value=e),toast(a?.message||"Could not save reminder timing.","error")}finally{t&&(t.disabled=!1)}}}async function J(){const t=document.getElementById("guestInstallStats");try{const e=await api("GET","/api/crm/guest-install-stats");if(!e.success)throw new Error(e.message||"Failed");if(r.guestPushSubscriberCount=e.guestPushSubscribers??0,applyGuestBroadcastAudienceUi(),!t)return;const o=e.totals||{},a=e.installedBookings||0,i=o.views||0,n=o.notification_prompts||0,s=e.guestPushSubscribers||0;if(!a&&!i){t.style.display="none",t.innerHTML="";return}t.style.display="block";const c=e.installRatePercent!=null?e.installRatePercent:0,x=Object.entries(e.byTouchpoint||{}).filter(function(p){return p[1].views||p[1].installed}).sort(function(p,v){return(v[1].installed||0)-(p[1].installed||0)}).slice(0,5),y=x.length?x.map(function(p){const v=p[0].replace(/-/g," "),w=p[1];return'<div style="display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:6px 0;border-bottom:1px solid var(--border);"><span style="color:var(--text);font-weight:600;text-transform:capitalize;">'+v+'</span><span style="color:var(--text-muted);white-space:nowrap;">'+(w.views||0)+" views · "+(w.installed||0)+" installed</span></div>"}).join(""):"";t.innerHTML='<div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--green);margin-bottom:8px;">Guest installs — last 30 days</div><div style="display:flex;gap:12px;margin-bottom:12px;flex-wrap:wrap;"><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+c+'%</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">of bookings installed</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+a+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">confirmed installs</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+i+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">install page views</div></div><div style="flex:1;min-width:80px;background:var(--bg);border-radius:10px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;color:var(--text);">'+s+'</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px;">guests reachable now</div></div></div>'+(n?'<div style="font-size:11px;color:var(--text-muted);margin:-2px 0 10px;">Notification permission: '+(o.notification_granted||0)+" granted · "+(o.notification_denied||0)+" denied · "+(o.notification_dismissed||0)+" dismissed · "+(o.notification_failed||0)+" failed</div>":"")+(y?'<div style="font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:4px;">By touchpoint</div>'+y:"")}catch{r.guestPushSubscriberCount=0,applyGuestBroadcastAudienceUi(),t&&(t.style.display="none",t.innerHTML="")}}const se={appsCloseLightbox:K,appsCloseGuestInstallCoach:bt,appsCloudinaryFull:gt,appsCloudinaryImg:Z,appsLbNav:D,appsLbRender:Q,appsOpenLightbox:Kt,appsOpenGuestInstallCoach:te,appsPhoneImgStyle:U,appsQuestionRow:A,appsGuestInstallCoachSelectLayout:oe,appsGuestInstallCoachSetVersion:ee,appsTourClose:f,appsTourNav:Yt,appsTourRender:S,appsVideoBadgeHtml:mt,detectAppPlatform:ie,ensureAppsViewRendered:ne,loadBookingReviewSettings:vt,loadGuestInstallStats:J,renderAppsView:yt,saveBookingReviewReminderSetting:ae,startAppsTour:Ut};function de(){Nt(se)}export{se as default,de as install};
