 ...
 */const zt=(t,e,o=[])=>{const i=document.createElementNS("http://www.w3.org/2000/svg",t);return Object.keys(e).forEach(r=>{i.setAttribute(r,String(e[r]))}),o.length&&o.forEach(r=>{const n=zt(...r);i.appendChild(n)}),i};var Kt=([t,e,o])=>zt(t,e,o);/**
 * @license lucide v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${e}]`);if(Array.from(i).forEach(r=>At(r,{nameAttr:e,icons:t,attrs:o})),e==="data-lucide"){const r=document.querySelectorAll("[icon-name]");r.length>0&&Array.from(r).forEach(n=>At(n,{nameAttr:"icon-name",icons:t,attrs:o}))}},Te={Bath:ee,Car:oe,Check:ie,ChevronLeft:ne,ChevronRight:re,CookingPot:ae,CopyCheck:se,DoorOpen:de,Ellipsis:le,Globe:ce,Inbox:pe,Laptop:ue,PawPrint:ge,QrCode:me,Rocket:fe,Share:he,Shirt:xe,Smartphone:ye,Sparkles:ve,SquarePlus:be,ThermometerSnowflake:we,Tv:ke,Waves:Ee,Wifi:Se,Wind:Be};window.lucide={createIcons(t={}){Ae({...t,icons:Te})}};function qo(){return Promise.resolve()}async function Ie(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let r=e.width,n=e.height;const a=Math.min(1,o/r,i/n);r=Math.round(r*a),n=Math.round(n*a);const s=document.createElement("canvas");s.width=r,s.height=n,s.getContext("2d").drawImage(e,0,0,r,n),e.close();const u=await new Promise((x,y)=>{s.toBlob(B=>B?x(B):y(new Error("encode failed")),"image/webp",.82)}),m=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([u],m+".webp",{type:"image/webp"})}catch{return t}}function jo(){const t=()=>{d.currentFilter==="apps"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}const ze=["cancelled","canceled","released"];function Uo(t){return t?ze.includes(String(t.status||"").trim().toLowerCase()):!0}function Ce(t){Object.assign(window,t)}const Pe=14,Re=10;function ut(t,e,o){return Math.max(e,Math.min(t,o))}function R(t,e,o,i){return{left:t,top:e,width:o,height:i,right:t+o,bottom:e+i}}function Me(){const t=window.visualViewport,e=t?t.offsetLeft:0,o=t?t.offsetTop:0,i=t?t.width:window.innerWidth,r=t?t.height:window.innerHeight;return R(e,o,i,r)}function L(t){if(!t||!t.isConnected)return null;const e=t.getBoundingClientRect();return e.width<2||e.height<2?null:R(e.left,e.top,e.width,e.height)}function Oe(t,e){if(!t||!e)return 0;const o=Math.max(0,Math.min(t.right,e.right)-Math.max(t.left,e.left)),i=Math.max(0,Math.min(t.bottom,e.bottom)-Math.max(t.top,e.top));return o*i}function De(t,e){return Math.max(0,e.left-t.left)+Math.max(0,t.right-e.right)+Math.max(0,e.top-t.top)+Math.max(0,t.bottom-e.bottom)}function Le(t,e){let o=0;for(const i of e||[]){const r=document.querySelector(i);if(!r||getComputedStyle(r).display==="none")continue;const n=L(r);!n||n.bottom<t.bottom-2||n.top>=t.bottom||(o=Math.max(o,t.bottom-n.top))}return o}function $e(t){const e=Me(),o=t.margin??Pe,i=Math.max(Number(t.bottomInset||0),Le(e,t.avoidBottomSelectors)),r=e.left+o+Number(t.leftInset||0),n=e.top+o+Number(t.topInset||0),a=e.right-o-Number(t.rightInset||0),s=e.bottom-o-i;return R(r,n,Math.max(1,a-r),Math.max(1,s-n))}function Fe(t){return t==="above"||t==="top"?["top","bottom","right","left"]:t==="right"?["right","left","bottom","top"]:t==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function He(t,e,o,i,r){return t==="top"?R(e.left+(e.width-o)/2,e.top-i-r,o,i):t==="right"?R(e.right+r,e.top+(e.height-i)/2,o,i):t==="left"?R(e.left-o-r,e.top+(e.height-i)/2,o,i):R(e.left+(e.width-o)/2,e.bottom+r,o,i)}function Ne(t,e){const o=ut(t.left,e.left,Math.max(e.left,e.right-t.width)),i=ut(t.top,e.top,Math.max(e.top,e.bottom-t.height));return R(o,i,t.width,t.height)}function qe(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function je(t,e){if(!t||Math.abs(e)<1)return!1;const o=qe(t);return o?o.scrollTop+=e:window.scrollBy({top:e,left:0,behavior:"auto"}),!0}function ct(t,e){const o=L(t);if(!o||e.height<60)return!1;let i;return o.height<=e.height?i=ut(o.top,e.top,e.bottom-o.height):i=e.bottom-o.height,je(t,o.top-i)}function Ct(t,e){const o=getComputedStyle(t);for(const n of o)e.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=t.children,r=e.children;for(let n=0;n<i.length;n+=1)r[n]&&Ct(i[n],r[n])}function Ue(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function Ve(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((r,n)=>{const a=i[n];a&&(r.type==="checkbox"||r.type==="radio"?a.checked=r.checked:a.value=r.value)})}function Ge(t,e={}){if(!t||!t.isConnected||e.disabled||!L(t))return null;const i=t.cloneNode(!0);Ue(i),Ct(t,i),Ve(t,i),i.setAttribute(e.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(e.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",e.prepareClone?.(i,t);const r=t.style.visibility;e.hideSource&&(t.style.visibility="hidden"),document.body.appendChild(i);const n=()=>{const s=L(t);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),e.hideSource&&(t.style.visibility=r)};return n(),{element:i,source:t,update:n,destroy:a}}function Ye({tooltip:t,panel:e,target:o,anchor:i,spotlight:r,options:n={}}){if(!t||!e||!o)return null;let a=0,s=!1,u=!1,m=!1,x="";const y=(l=!0)=>{if(s||!t.isConnected||!o.isConnected)return null;const p=$e(n),w=`${p.left}:${p.top}:${p.width}:${p.height}`;x&&x!==w&&(u=!1,l=!0),x=w;const c=L(i)||L(o),f=L(o);if(!c||!f)return null;const h=Math.min(Number(n.maxWidth||380),p.width);t.style.position="fixed",t.style.right="auto",t.style.bottom="auto",t.style.width=`${h}px`,t.style.maxWidth=`${h}px`,t.style.margin="0",t.style.justifyContent="flex-start",e.style.maxHeight=`${Math.max(120,p.height)}px`;const v=Math.min(e.offsetHeight||t.offsetHeight||190,p.height),b=Number(n.gap??Re);l&&!u&&n.autoScroll!==!1&&f.height+v+b<=p.height&&(u=ct(o,p),u&&requestAnimationFrame(()=>y(!1)));const k=Fe(n.preferredPlacement).map((I,O)=>{const Y=He(I,c,h,v,b),St=De(Y,p),Bt=Oe(Y,f);return{placement:I,index:O,raw:Y,overflow:St,overlap:Bt,score:St*1e5+Bt*100+O}}),T=k.find(I=>I.overflow<.5&&I.overlap<1),A=T||k.slice().sort((I,O)=>I.score-O.score)[0],C=n.forceDock===!0||!T;let P="floating",$;if(C){P="docked";const I=Math.min(v,Number(n.dockMaxHeight||Math.max(180,p.height*.42)),p.height);e.style.maxHeight=`${I}px`;const O=Math.min(e.offsetHeight||I,I);if($=R(p.left+(p.width-h)/2,p.bottom-O,h,O),l&&!u&&n.autoScroll!==!1){const Y=R(p.left,p.top,p.width,Math.max(60,$.top-b-p.top));u=ct(o,Y),u&&requestAnimationFrame(()=>y(!1))}}else if($=Ne(A.raw,p),l&&!u&&n.autoScroll!==!1){let I=p;if(A.placement==="bottom")I=R(p.left,p.top,p.width,Math.max(60,$.top-b-p.top));else if(A.placement==="top"){const O=$.bottom+b;I=R(p.left,O,p.width,Math.max(60,p.bottom-O))}u=ct(o,I),u&&requestAnimationFrame(()=>y(!1))}return t.dataset.tourLayoutMode=P,t.dataset.tourPlacement=C?"bottom-dock":A.placement,t.style.left=`${$.left}px`,t.style.top=`${$.top}px`,r?.update?.(),n.onLayout?.({mode:P,placement:t.dataset.tourPlacement,viewport:p,targetRect:L(o),anchorRect:L(i)||L(o),tooltipRect:$}),{mode:P,placement:t.dataset.tourPlacement,rect:$}},B=(l=!1)=>{m=m||l===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const p=m;m=!1,y(p)}))},z=()=>{u=!1,B(!0)},U=typeof ResizeObserver=="function"?new ResizeObserver(B):null;U?.observe(o),i&&i!==o&&U?.observe(i),U?.observe(e),window.addEventListener("resize",z),window.addEventListener("orientationchange",z),window.addEventListener("scroll",B,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",z),window.visualViewport.addEventListener("scroll",B));const lt=()=>{s=!0,a&&cancelAnimationFrame(a),U?.disconnect(),window.removeEventListener("resize",z),window.removeEventListener("orientationchange",z),window.removeEventListener("scroll",B,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",z),window.visualViewport.removeEventListener("scroll",B))},g=y(!0);return{destroy:lt,reposition:()=>y(!1),result:g}}function j(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function ot(...t){return j("setFilter")?.(...t)}function Tt(...t){return j("setBookingsSubview")?.(...t)}function _e(...t){return j("toast")?.(...t)}function it(...t){return j("updateGoLiveBanner")?.(...t)}function We(...t){return j("seedTourRevenueShell")?.(...t)}function Je(...t){return j("finishTourHydration")?.(...t)}function Ke(...t){return j("goLive")?.(...t)}let K=null,nt=null,G=null;function N(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
  ...
  </div>`}function Lt(t=null){const e=M(),o=e?"https://guest-lodge-backend.onrender.com":"",i=t?.request||null,r=i?.scheduledFor?new Date(i.scheduledFor).toLocaleDateString([],{year:"numeric",month:"short",day:"numeric"}):"",n=e?i?`<div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border);">
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),vt()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}async function ho(){if(isEditPageDomReady())return;if(d.editRoomsLoadPromise)return d.editRoomsLoadPromise;const t=document.getElementById("editRoomsList");if(t){d.editRoomsLoadPromise=(async()=>{t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[e,o,i]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify"),M()?api("GET","/api/crm/account-deletion/status").catch(()=>null):Promise.resolve(null)]);if(!e.rooms)throw new Error("No data");d.editRooms=e.rooms;const r=o?.hotelName||"";r&&(d.activeHotelName=r),o&&(d.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const n=o?.hotelSubtitle||"",a=o?.hotelAddress||"",s=o?.hotelPhone||"",u=o?.appIconUrl||"";d.activeHotelAppIcon=u,updateFrontdeskManifestLink();let m={nightly:69,weekly:299,monthly:999,taxRate:.1};e.rates&&(m=e.rates),d.editRates=m;const y="https://"+(o?.domain||d.activeHotelId+".mktel.co"),B="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(y);let z=`
      ...
      ${o?.subscribed&&!M()?`<div class="booking-card" style="margin-bottom:14px;">
