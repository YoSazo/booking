...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${e}]`);if(Array.from(i).forEach(r=>At(r,{nameAttr:e,icons:t,attrs:o})),e==="data-lucide"){const r=document.querySelectorAll("[icon-name]");r.length>0&&Array.from(r).forEach(n=>At(n,{nameAttr:"icon-name",icons:t,attrs:o}))}},Te={Bath:ee,Car:oe,Check:ie,ChevronLeft:ne,ChevronRight:re,CookingPot:ae,CopyCheck:se,DoorOpen:de,Ellipsis:le,Globe:ce,Inbox:pe,Laptop:ue,PawPrint:ge,QrCode:me,Rocket:fe,Share:he,Shirt:xe,Smartphone:ye,Sparkles:ve,SquarePlus:be,ThermometerSnowflake:we,Tv:ke,Waves:Ee,Wifi:Se,Wind:Be};window.lucide={createIcons(t={}){Ae({...t,icons:Te})}};function No(){return Promise.resolve()}async function ze(t){if(!t||!t.type.startsWith("image/")||t.type==="image/webp"&&t.size<4e5)return t;try{const e=await createImageBitmap(t),o=1600,i=1200;let r=e.width,n=e.height;const a=Math.min(1,o/r,i/n);r=Math.round(r*a),n=Math.round(n*a);const s=document.createElement("canvas");s.width=r,s.height=n,s.getContext("2d").drawImage(e,0,0,r,n),e.close();const u=await new Promise((x,y)=>{s.toBlob(B=>B?x(B):y(new Error("encode failed")),"image/webp",.82)}),m=(t.name||"room-photo").replace(/\.[^.]+$/,"")||"room-photo";return new File([u],m+".webp",{type:"image/webp"})}catch{return t}}function qo(){const t=()=>{d.currentFilter==="apps"?loadMessages():loadMessageBadges()};"requestIdleCallback"in window?requestIdleCallback(t,{timeout:2500}):setTimeout(t,600)}const Ie=["cancelled","canceled","released"];function jo(t){return t?Ie.includes(String(t.status||"").trim().toLowerCase()):!0}function Ce(t){Object.assign(window,t)}const Me=14,Re=10;function ut(t,e,o){return Math.max(e,Math.min(t,o))}function R(t,e,o,i){return{left:t,top:e,width:o,height:i,right:t+o,bottom:e+i}}function Pe(){const t=window.visualViewport,e=t?t.offsetLeft:0,o=t?t.offsetTop:0,i=t?t.width:window.innerWidth,r=t?t.height:window.innerHeight;return R(e,o,i,r)}function $(t){if(!t||!t.isConnected)return null;const e=t.getBoundingClientRect();return e.width<2||e.height<2?null:R(e.left,e.top,e.width,e.height)}function Oe(t,e){if(!t||!e)return 0;const o=Math.max(0,Math.min(t.right,e.right)-Math.max(t.left,e.left)),i=Math.max(0,Math.min(t.bottom,e.bottom)-Math.max(t.top,e.top));return o*i}function De(t,e){return Math.max(0,e.left-t.left)+Math.max(0,t.right-e.right)+Math.max(0,e.top-t.top)+Math.max(0,t.bottom-e.bottom)}function $e(t,e){let o=0;for(const i of e||[]){const r=document.querySelector(i);if(!r||getComputedStyle(r).display==="none")continue;const n=$(r);!n||n.bottom<t.bottom-2||n.top>=t.bottom||(o=Math.max(o,t.bottom-n.top))}return o}function Le(t){const e=Pe(),o=t.margin??Me,i=Math.max(Number(t.bottomInset||0),$e(e,t.avoidBottomSelectors)),r=e.left+o+Number(t.leftInset||0),n=e.top+o+Number(t.topInset||0),a=e.right-o-Number(t.rightInset||0),s=e.bottom-o-i;return R(r,n,Math.max(1,a-r),Math.max(1,s-n))}function Fe(t){return t==="above"||t==="top"?["top","bottom","right","left"]:t==="right"?["right","left","bottom","top"]:t==="left"?["left","right","bottom","top"]:["bottom","top","right","left"]}function He(t,e,o,i,r){return t==="top"?R(e.left+(e.width-o)/2,e.top-i-r,o,i):t==="right"?R(e.right+r,e.top+(e.height-i)/2,o,i):t==="left"?R(e.left-o-r,e.top+(e.height-i)/2,o,i):R(e.left+(e.width-o)/2,e.bottom+r,o,i)}function Ne(t,e){const o=ut(t.left,e.left,Math.max(e.left,e.right-t.width)),i=ut(t.top,e.top,Math.max(e.top,e.bottom-t.height));return R(o,i,t.width,t.height)}function qe(t){let e=t&&t.parentElement;for(;e&&e!==document.body&&e!==document.documentElement;){const o=getComputedStyle(e),i=o.overflowY||o.overflow;if(/(auto|scroll)/.test(i)&&e.scrollHeight>e.clientHeight+1)return e;e=e.parentElement}return null}function je(t,e){if(!t||Math.abs(e)<1)return!1;const o=qe(t);return o?o.scrollTop+=e:window.scrollBy({top:e,left:0,behavior:"auto"}),!0}function ct(t,e){const o=$(t);if(!o||e.height<60)return!1;let i;return o.height<=e.height?i=ut(o.top,e.top,e.bottom-o.height):i=e.bottom-o.height,je(t,o.top-i)}function Ct(t,e){const o=getComputedStyle(t);for(const n of o)e.style.setProperty(n,o.getPropertyValue(n),o.getPropertyPriority(n));const i=t.children,r=e.children;for(let n=0;n<i.length;n+=1)r[n]&&Ct(i[n],r[n])}function Ue(t){t.removeAttribute("id"),t.querySelectorAll("[id]").forEach(e=>e.removeAttribute("id"))}function Ve(t,e){const o=t.querySelectorAll("input, textarea, select"),i=e.querySelectorAll("input, textarea, select");o.forEach((r,n)=>{const a=i[n];a&&(r.type==="checkbox"||r.type==="radio"?a.checked=r.checked:a.value=r.value)})}function Ge(t,e={}){if(!t||!t.isConnected||e.disabled||!$(t))return null;const i=t.cloneNode(!0);Ue(i),Ct(t,i),Ve(t,i),i.setAttribute(e.attribute||"data-adaptive-tour-spotlight","1"),i.setAttribute("aria-hidden","true"),i.style.position="fixed",i.style.margin="0",i.style.maxWidth="none",i.style.zIndex=String(e.zIndex||100002),i.style.pointerEvents="none",i.style.transform="none",e.prepareClone?.(i,t);const r=t.style.visibility;e.hideSource&&(t.style.visibility="hidden"),document.body.appendChild(i);const n=()=>{const s=$(t);return s?(i.style.display="",i.style.left=`${s.left}px`,i.style.top=`${s.top}px`,i.style.width=`${s.width}px`,i.style.height=`${s.height}px`,s):(i.style.display="none",null)},a=()=>{i.remove(),e.hideSource&&(t.style.visibility=r)};return n(),{element:i,source:t,update:n,destroy:a}}function Ye({tooltip:t,panel:e,target:o,anchor:i,spotlight:r,options:n={}}){if(!t||!e||!o)return null;let a=0,s=!1,u=!1,m=!1,x="";const y=(l=!0)=>{if(s||!t.isConnected||!o.isConnected)return null;const p=Le(n),w=`${p.left}:${p.top}:${p.width}:${p.height}`;x&&x!==w&&(u=!1,l=!0),x=w;const c=$(i)||$(o),f=$(o);if(!c||!f)return null;const h=Math.min(Number(n.maxWidth||380),p.width);t.style.position="fixed",t.style.right="auto",t.style.bottom="auto",t.style.width=`${h}px`,t.style.maxWidth=`${h}px`,t.style.margin="0",t.style.justifyContent="flex-start",e.style.maxHeight=`${Math.max(120,p.height)}px`;const v=Math.min(e.offsetHeight||t.offsetHeight||190,p.height),b=Number(n.gap??Re);l&&!u&&n.autoScroll!==!1&&f.height+v+b<=p.height&&(u=ct(o,p),u&&requestAnimationFrame(()=>y(!1)));const k=Fe(n.preferredPlacement).map((z,O)=>{const Y=He(z,c,h,v,b),St=De(Y,p),Bt=Oe(Y,f);return{placement:z,index:O,raw:Y,overflow:St,overlap:Bt,score:St*1e5+Bt*100+O}}),T=k.find(z=>z.overflow<.5&&z.overlap<1),A=T||k.slice().sort((z,O)=>z.score-O.score)[0],C=n.forceDock===!0||!T;let M="floating",L;if(C){M="docked";const z=Math.min(v,Number(n.dockMaxHeight||Math.max(180,p.height*.42)),p.height);e.style.maxHeight=`${z}px`;const O=Math.min(e.offsetHeight||z,z);if(L=R(p.left+(p.width-h)/2,p.bottom-O,h,O),l&&!u&&n.autoScroll!==!1){const Y=R(p.left,p.top,p.width,Math.max(60,L.top-b-p.top));u=ct(o,Y),u&&requestAnimationFrame(()=>y(!1))}}else if(L=Ne(A.raw,p),l&&!u&&n.autoScroll!==!1){let z=p;if(A.placement==="bottom")z=R(p.left,p.top,p.width,Math.max(60,L.top-b-p.top));else if(A.placement==="top"){const O=L.bottom+b;z=R(p.left,O,p.width,Math.max(60,p.bottom-O))}u=ct(o,z),u&&requestAnimationFrame(()=>y(!1))}return t.dataset.tourLayoutMode=M,t.dataset.tourPlacement=C?"bottom-dock":A.placement,t.style.left=`${L.left}px`,t.style.top=`${L.top}px`,r?.update?.(),n.onLayout?.({mode:M,placement:t.dataset.tourPlacement,viewport:p,targetRect:$(o),anchorRect:$(i)||$(o),tooltipRect:L}),{mode:M,placement:t.dataset.tourPlacement,rect:L}},B=(l=!1)=>{m=m||l===!0,!(s||a)&&(a=requestAnimationFrame(()=>{a=0;const p=m;m=!1,y(p)}))},I=()=>{u=!1,B(!0)},U=typeof ResizeObserver=="function"?new ResizeObserver(B):null;U?.observe(o),i&&i!==o&&U?.observe(i),U?.observe(e),window.addEventListener("resize",I),window.addEventListener("orientationchange",I),window.addEventListener("scroll",B,!0),window.visualViewport&&(window.visualViewport.addEventListener("resize",I),window.visualViewport.addEventListener("scroll",B));const lt=()=>{s=!0,a&&cancelAnimationFrame(a),U?.disconnect(),window.removeEventListener("resize",I),window.removeEventListener("orientationchange",I),window.removeEventListener("scroll",B,!0),window.visualViewport&&(window.visualViewport.removeEventListener("resize",I),window.visualViewport.removeEventListener("scroll",B))},g=y(!0);return{destroy:lt,reposition:()=>y(!1),result:g}}function j(t){return typeof window<"u"&&typeof window[t]=="function"?window[t]:null}function ot(...t){return j("setFilter")?.(...t)}function Tt(...t){return j("setBookingsSubview")?.(...t)}function _e(...t){return j("toast")?.(...t)}function it(...t){return j("updateGoLiveBanner")?.(...t)}function We(...t){return j("seedTourRevenueShell")?.(...t)}function Je(...t){return j("finishTourHydration")?.(...t)}function Ke(...t){return j("goLive")?.(...t)}let K=null,nt=null,G=null;function N(){if(document.getElementById("frontdeskTourPolishStyle"))return;const t=document.createElement("style");t.id="frontdeskTourPolishStyle",t.textContent=`
    #tourBlurOverlay {
  ...
  `,document.head.appendChild(t)}function ht(){K&&(document.removeEventListener("keydown",K),K=null)}function Qe(t){ht(),K=e=>{if(e.defaultPrevented)return;const o=e.target&&e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||o==="select"||e.target?.isContentEditable||(e.key==="Escape"?(e.preventDefault(),t.onSkip?.()):e.key==="Enter"||e.key==="ArrowRight"?(e.preventDefault(),t.onNext?.()):e.key==="ArrowLeft"&&(e.preventDefault(),t.onBack?.()))},document.addEventListener("keydown",K)}function pt(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function D(t){N();const e=t||{};let o=document.getElementById("tourBlurOverlay");return o||(o=document.createElement("div"),o.id="tourBlurOverlay",o.style.cssText="position:fixed;inset:0;z-index:99998;",document.body.appendChild(o)),o.style.background=e.dim||"rgba(17,24,39,0.22)",o.style.pointerEvents=e.blockPointer?"auto":"none",e.lockScroll&&(document.body.style.overflow="hidden"),o}const X="rgba(17,24,39,0.42)";function _(){const t=document.getElementById("tourTooltip"),e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!t||e)return Promise.resolve();t.style.pointerEvents="none";const o=t.firstElementChild;return o&&(o.style.animation="tourPanelOut 0.16s ease-in forwards"),new Promise(i=>setTimeout(i,150))}function Ze(t,e){return G?.destroy(),G=Ge(t,{attribute:"data-tour-spotlight-clone",zIndex:99999,prepareClone(o){o.style.boxShadow=e?.spotlightBoxShadow??"0 18px 46px rgba(26,43,34,0.24)",o.style.outline=e?.spotlightOutline??"1px solid rgba(255,255,255,0.82)",o.style.outlineOffset=e?.spotlightOutlineOffset??"2px",e?.spotlightBackground&&(o.style.background=e.spotlightBackground,o.style.backgroundColor=e.spotlightBackground),e?.spotlightBorderRadius&&(o.style.borderRadius=e.spotlightBorderRadius)}}),G?.element||null}function F(t){const e=t||{};ht(),nt?.destroy(),nt=null,G?.destroy(),G=null;const o=document.getElementById("tourTooltip");o&&o.remove();const i=document.getElementById("tourBlurOverlay");i&&!e.keepOverlay&&i.remove(),document.querySelectorAll("[data-tour-spotlight-clone]").forEach(n=>n.remove()),document.querySelectorAll("[data-tour-highlighted]").forEach(n=>{n.style.position=n.dataset.tourOrigPosition||"",n.style.zIndex=n.dataset.tourOrigZIndex||"",n.style.isolation=n.dataset.tourOrigIsolation||"",n.style.boxShadow=n.dataset.tourOrigBoxShadow||"",n.style.outline=n.dataset.tourOrigOutline||"",n.style.outlineOffset=n.dataset.tourOrigOutlineOffset||"",n.style.transition=n.dataset.tourOrigTransition||"",n.style.borderRadius=n.dataset.tourOrigBorderRadius||"",n.style.opacity=n.dataset.tourOrigOpacity||"";const a=n.dataset.tourOrigBackground||"",s=n.dataset.tourOrigBackgroundColor||"";s?n.style.backgroundColor=s:n.style.removeProperty("background-color"),a?n.style.background=a:n.style.removeProperty("background"),n.removeAttribute("data-tour-highlighted"),delete n.dataset.tourOrigPosition,delete n.dataset.tourOrigZIndex,delete n.dataset.tourOrigIsolation,delete n.dataset.tourOrigBoxShadow,delete n.dataset.tourOrigOutline,delete n.dataset.tourOrigOutlineOffset,delete n.dataset.tourOrigTransition,delete n.dataset.tourOrigBackground,delete n.dataset.tourOrigBackgroundColor,delete n.dataset.tourOrigBorderRadius,delete n.dataset.tourOrigOpacity});const r=document.getElementById("goLiveBanner");r&&r.dataset.tourHidden&&(delete r.dataset.tourHidden,typeof it=="function"&&it()),e.keepOverlay||(document.body.style.overflow="")}function Xe(){const t=document.getElementById("tourTooltip"),e=Array.from(document.querySelectorAll("[data-tour-spotlight-clone]")),o=Array.from(document.querySelectorAll("[data-tour-highlighted]")),i=[t,...e,...o].filter(Boolean);return!i.length&&!o.length?(F({keepOverlay:!0}),Promise.resolve()):(ht(),window.matchMedia("(prefers-reduced-motion: reduce)").matches?(F({keepOverlay:!0}),Promise.resolve()):(t&&(t.style.pointerEvents="none"),i.forEach(n=>{n.style.transition="opacity 0.07s ease, transform 0.07s ease",n.style.opacity="1"}),requestAnimationFrame(()=>{i.forEach(n=>{n.style.opacity="0",n.id==="tourTooltip"&&(n.style.transform="translateY(4px)")})}),new Promise(n=>{setTimeout(()=>{F({keepOverlay:!0}),n()},85)})))}function to(t){const e=[t,...document.querySelectorAll("[data-tour-spotlight-clone]"),...document.querySelectorAll("[data-tour-highlighted]")].filter(Boolean);e.forEach(o=>{o.style.transition="opacity 0.1s ease, transform 0.1s ease",o.style.opacity="0",o.id==="tourTooltip"&&(o.style.transform="translateY(4px)")}),requestAnimationFrame(()=>{e.forEach(o=>{o.style.opacity="1",o.id==="tourTooltip"&&(o.style.transform="translateY(0)")})})}function V(t,e){if(!e.openAccordion)return;const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(!o)return;const i=o.querySelector(".accordion-body");if(!i)return;if(i.style.display==="none"||getComputedStyle(i).display==="none"){i.style.display="block";const n=o.querySelector(".accordion-arrow");n&&(n.style.transform="rotate(90deg)")}}function q(t){if(!t)return null;for(const e of String(t).split(",").map(o=>o.trim()).filter(Boolean)){const o=document.querySelector(e);if(o&&o.isConnected)return o}return null}function W(t,e){if(e.highlightSelector){const o=q(e.highlightSelector);if(o)return o}if(e.highlightCard){const o=e.accordionCard?document.querySelector(e.accordionCard):t&&t.closest?t.closest(".booking-card"):null;if(o)return o}return e.targetParent&&(t.closest(".booking-card")||t.closest(".accordion-body"))||t}function tt(t,e){if(!e)return t;const o=String(e.target||"").split(",").map(i=>i.trim()).filter(Boolean);for(const i of o){const r=document.querySelector(i);if(r&&r.isConnected)return r}if(e.accordionCard){const i=document.querySelector(e.accordionCard);if(i&&i.isConnected)return i}return t&&t.isConnected?t:null}function rt(t,e){if(!t||!t.isConnected)return null;const o=t.getBoundingClientRect();return o.width<2||o.height<2||!e&&(o.bottom<8||o.top>window.innerHeight-8)?null:o}function Mt(t,e){const o=q(t.anchorSelector);if(o){const i=rt(o,!0);if(i)return i}return rt(e,!0)}function zt(t,e){const o=t.tooltipAnchorSelector||t.anchorSelector,i=q(o);if(i){const r=rt(i,!0);if(r)return r}return Mt(t,e)}function at(t){const e=t||"auto";try{window.scrollTo({top:0,left:0,behavior:e})}catch{}const o=document.scrollingElement||document.documentElement;o&&(o.scrollTop=0),document.documentElement.scrollTop=0,document.body.scrollTop=0,["#editView","#settingsView","#app .container"].forEach(i=>{const r=document.querySelector(i);r&&(r.scrollTop=0)})}function Rt(t,e,o){const i=o||{},r=e.scrollTarget||e.accordionCard,n=(r?q(r):null)||t;if(!n&&!e.scrollToTop)return Promise.resolve();const a=e.scrollBlock||"nearest",s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,u=i.smooth&&!s?"smooth":d.settingsTourActive||s?"auto":"smooth";return new Promise(m=>{if(e.scrollToTop&&(at(u),e.scrollToTopOnly)){requestAnimationFrame(()=>requestAnimationFrame(()=>{e.forcePageTop&&at("auto"),m()}));return}if(!n){m();return}if(n.scrollIntoView({behavior:u,block:a,inline:"nearest"}),u==="auto"){requestAnimationFrame(()=>requestAnimationFrame(m));return}let x=!1;const y=()=>{x||(x=!0,window.removeEventListener("scrollend",B),clearTimeout(I),requestAnimationFrame(()=>requestAnimationFrame(m)))},B=()=>y();"onscrollend"in window&&window.addEventListener("scrollend",B,{once:!0});const I=setTimeout(y,520)})}function Pt(){F(),localStorage.setItem("settingsTourStep","handoff");const t=()=>{const o=document.querySelector('.tab[data-nav-filter="apps"]')||document.querySelector('.mobile-nav-item[data-nav-filter="apps"]');o&&ot("apps",o);const i=typeof ensureAppsViewRendered=="function"?ensureAppsViewRendered:window.ensureAppsViewRendered;typeof i=="function"&&i(!0);const r=typeof startAppsTour=="function"?startAppsTour:window.startAppsTour;typeof r=="function"&&r({chainFromSettingsTour:!0})},e=typeof loadAppsModule=="function"?loadAppsModule:window.loadAppsModule;typeof e=="function"?e().then(t).catch(t):t()}function J(){F({keepOverlay:!0}),N(),d.settingsTourActive=!1,it(),D({blockPointer:!0,lockScroll:!0,dim:X});const t=document.createElement("div");if(t.id="tourTooltip",t.style.cssText="position:fixed;z-index:100000;inset:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),!document.getElementById("tourModalAnimStyle")){const e=document.createElement("style");e.id="tourModalAnimStyle",e.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(e)}typeof lucide<"u"&&setTimeout(()=>lucide.createIcons(),0),document.getElementById("tourNextBtn").onclick=()=>{const o="https://"+(d.activeHotelDomain||d.activeHotelId+".mktel.co");navigator.clipboard.writeText(o).catch(()=>{}),_().then(()=>{F(),d.settingsTourActive=!1,localStorage.setItem("settingsTourDone","1"),localStorage.setItem("linkCopied","1"),localStorage.removeItem("settingsTourStep"),_e("Booking link copied!","success"),Je(),Ot()})}}function Ot(t){N();const e=document.createElement("div");e.id="testDriveOverlay",e.style.cssText="position:fixed;inset:0;z-index:100001;background:rgba(17,24,39,0.42);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;padding:24px 16px;",e.innerHTML=`
    <div style="background:white;border:1.5px solid #D8E4DC;border-radius:18px;max-width:380px;width:100%;box-shadow:0 24px 64px rgba(26,43,34,0.28);animation:tourPanelIn 0.22s ease-out;">
      ...
      </div>`,document.body.appendChild(A),!document.getElementById("tourModalAnimStyle")){const C=document.createElement("style");C.id="tourModalAnimStyle",C.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(C)}document.getElementById("tourNextBtn").onclick=()=>{_().then(()=>{r({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),u()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}}function U(){N(),D({blockPointer:!0,lockScroll:!0,dim:X});let g=0;const l=[`<div style="padding:20px 18px 0;">
      ...
      <div style="padding:0 14px 14px;">
        ...
        </div>`,l=!0,document.getElementById("tourNextBtn").onclick=()=>{if(!f){g++,c();return}_().then(()=>{r({keepOverlay:!0}),i++,localStorage.setItem("settingsTourStep",String(i)),u()})},document.getElementById("tourSkipBtn").onclick=()=>{n()}};if(document.body.appendChild(w),c(),!document.getElementById("tourModalAnimStyle")){const f=document.createElement("style");f.id="tourModalAnimStyle",f.textContent="@keyframes tourModalSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}",document.head.appendChild(f)}}u()}function P(){return typeof window.isNativeFrontdeskApp=="function"&&window.isNativeFrontdeskApp()}function Dt(){return`<div class="booking-card" style="margin-bottom:14px;">
  ...
  </div>`}function $t(t=null){const e=P(),o=e?"https://guest-lodge-backend.onrender.com":"",i=t?.request||null,r=i?.scheduledFor?new Date(i.scheduledFor).toLocaleDateString([],{year:"numeric",month:"short",day:"numeric"}):"",n=e?i?`<div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border);">
  ...
  `,document.body.appendChild(o),document.getElementById("activatedModalTour").onclick=()=>{o.remove(),vt()},document.getElementById("activatedModalSkip").onclick=()=>{o.remove(),localStorage.setItem("postActivationTourDone","1");try{setFilter("bookings")}catch{}}}async function ho(){if(isEditPageDomReady())return;if(d.editRoomsLoadPromise)return d.editRoomsLoadPromise;const t=document.getElementById("editRoomsList");if(t){d.editRoomsLoadPromise=(async()=>{t.innerHTML='<div class="loading"><div class="logo-sprite-bounce"></div> Loading…</div>';try{const[e,o,i]=await Promise.all([api("GET","/api/crm/rooms"),api("GET","/api/crm/verify"),P()?api("GET","/api/crm/account-deletion/status").catch(()=>null):Promise.resolve(null)]);if(!e.rooms)throw new Error("No data");d.editRooms=e.rooms;const r=o?.hotelName||"";r&&(d.activeHotelName=r),o&&(d.hotelSubscribed=!!o.subscribed,typeof updateGoLiveBanner=="function"?updateGoLiveBanner():typeof window.updateGoLiveBanner=="function"&&window.updateGoLiveBanner());const n=o?.hotelSubtitle||"",a=o?.hotelAddress||"",s=o?.hotelPhone||"",u=o?.appIconUrl||"";d.activeHotelAppIcon=u,updateFrontdeskManifestLink();let m={nightly:69,weekly:299,monthly:999,taxRate:.1};e.rates&&(m=e.rates),d.editRates=m;const y="https://"+(o?.domain||d.activeHotelId+".mktel.co"),B="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+encodeURIComponent(y);let I=`
      ...
      <div class="booking-card" id="tour-pin-card" style="margin-bottom:14px;">
        ...
        <div class="accordion-body" style="display:none;padding:0 18px 18px;">
          <div style="margin-bottom:12px;">
            <input type="text" id="edit-new-pin" value="${d.isMasterPin?"":d.token}" placeholder="${d.isMasterPin?"Enter a unique property PIN":"Enter new PIN (min 6 chars)"}" style="width:100%;font-size:16px;padding:8px 10px;border-radius:8px;border:1.5px solid var(--border);font-family:inherit;outline:none;text-align:center;letter-spacing:2px;">
          </div>
      ...
      ${o?.subscribed&&!P()?`<div class="booking-card" style="margin-bottom:14px;">
    ...
    `;t.innerHTML=I,H(),window.refreshSupportSummary?.(),typeof lucide<"u"&&lucide.createIcons()}catch{t.innerHTML='<div class="empty-state"><div class="empty-icon">⚠️</div><div class="empty-text">Failed to load your page</div><div class="empty-sub">Check your connection and refresh.</div></div>'}})();try{await d.editRoomsLoadPromise}finally{d.editRoomsLoadPromise=null}}}function bt(){H()}async function wt({render:t=!0}={}){const e=await api("GET","/api/crm/rooms");if(!Array.isArray(e?.rooms))throw new Error("Could not refresh rooms");return d.editRooms=e.rooms,e.rates&&(d.editRates=e.rates),t&&H(),d.editRooms}function H(){const t=document.getElementById("editRoomsCards");if(t){if(!d.editRooms.length){t.innerHTML='<div class="empty-state"><div class="empty-icon">🛏️</div><div class="empty-text">No rooms yet</div><div class="empty-sub">Add your first room type below.</div></div>';return}t.innerHTML=d.editRooms.map((e,o)=>{const i=(e.amenities||"").split("•").map(a=>a.trim()).filter(Boolean),r=(e.images||[]).filter(a=>a&&a.url),n=jsStr(e.id);return`
    ...
    `),document.getElementById("amenityPickerModal").addEventListener("click",dt),i=document.getElementById("amenityPickerModal"));const r=d.editRooms[0];r&&String(r.id)===String(t)?i.dataset.previewActionScope="first-room-editor":delete i.dataset.previewActionScope;const a=document.getElementById("amenityPickerGrid");a.innerHTML=Ut.map(s=>{const u=o.some(m=>m.includes(s.key));return`<button onclick="toggleAmenityPreset(this,'${s.key}')" data-key="${s.key}" style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:8px;border:1.5px solid ${u?"#2E7D5B":"#e5e7eb"};background:${u?"#E8F5EE":"white"};color:${u?"#2E7D5B":"#1a1a2e"};font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;"><i data-lucide="${s.icon}" style="width:14px;height:14px;"></i> ${s.label}</button>`}).join(""),document.getElementById("amenityCustomInput").value="",i.style.display="flex",typeof lucide<"u"&&lucide.createIcons()}function yo(t,e){const o=t.style.borderColor==="rgb(46, 125, 91)";t.style.borderColor=o?"#e5e7eb":"#2E7D5B",t.style.background=o?"white":"#E8F5EE",t.style.color=o?"#1a1a2e":"#2E7D5B"}function dt(){document.getElementById("amenityPickerModal").style.display="none",kt=null}function vo(){const t=d.editRooms.find(r=>r.id===kt);if(!t){dt();return}const e=document.getElementById("amenityPickerGrid"),o=[];e.querySelectorAll("button").forEach(r=>{if(r.style.background==="rgb(232, 245, 238)"){const n=Ut.find(a=>a.key===r.dataset.key);n&&o.push(n.label)}});const i=document.getElementById("amenityCustomInput").value.trim();i&&o.push(i),t.amenities=o.join(" • "),dt(),bt(),typeof lucide<"u"&&lucide.createIcons()}function bo(t){Vt(t)}function wo(t,e){const o=d.editRooms.find(r=>r.id===t);if(!o)return;const i=(o.amenities||"").split("•").map(r=>r.trim()).filter(Boolean);o.amenities=i.filter(r=>r!==e).join(" • "),bt(),typeof lucide<"u"&&lucide.createIcons()}async function ko(){const t=document.getElementById("edit-hotel-name")?.value.trim(),e=document.getElementById("edit-hotel-subtitle")?.value.trim(),o=document.getElementById("edit-hotel-address")?.value.trim(),i=document.getElementById("edit-hotel-phone")?.value.trim(),r=document.getElementById("edit-hotel-policy")?.value.trim();try{await api("POST","/api/crm/hotel-info",{name:t,subtitle:e,address:o,phone:i,cancellationPolicy:r}),toast("Property info saved!","success")}catch{toast("Failed to save","error")}}async function Eo(){const t=parseFloat(document.getElementById("edit-rate-nightly")?.value)||69,e=parseFloat(document.getElementById("edit-rate-weekly")?.value)||299,o=parseFloat(document.getElementById("edit-rate-monthly")?.value)||999;try{await api("POST","/api/crm/rates",{nightly:t,weekly:e,monthly:o}),localStorage.setItem("ratesChanged","1"),d.launchStatus=null,Q(),toast("Rates saved!","success")}catch{toast("Failed to save rates","error")}}async function So(){const t=document.getElementById("edit-new-pin")?.value.trim();if(!t||t.length<6){toast("PIN must be at least 6 characters","error");return}try{const e=await api("POST","/api/crm/change-pin",{newPin:t});if(!e.success)throw new Error(e.message||"Failed to change PIN");d.token=t,d.isMasterPin=!1;try{localStorage.setItem("crmToken",d.token)}catch{}toast("PIN updated!","success")}catch(e){toast(e.message||"Failed to change PIN","error")}}function Bo(t){navigator.clipboard.writeText(t).then(()=>{toast("Booking link copied!","success")}).catch(()=>{toast("Failed to copy","error")})}function Ao(t){const e=t.nextElementSibling,o=t.querySelector(".accordion-arrow");e.style.display==="none"?(e.style.display="block",o&&(o.style.transform="rotate(90deg)")):(e.style.display="none",o&&(o.style.transform="rotate(0deg)"))}let Z=!1;function Gt(){if(document.getElementById("goLiveOverlay"))return;const t=document.createElement("div");t.id="goLiveOverlay",t.style.cssText="position:fixed;inset:0;z-index:100010;background:rgba(255,255,255,0.96);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;",t.innerHTML='<div class="logo-sprite-bounce"></div><div style="font-size:14px;font-weight:700;color:#1a5c3f;">Opening secure checkout…</div><div style="font-size:12px;color:#6b7280;">Taking you to Stripe — one moment</div>',document.body.appendChild(t)}function mt(){const t=document.getElementById("goLiveOverlay");t&&t.remove()}async function To(t={}){if(P()){toast("Front Desk app access is managed with your Marketel account.","info");return}if(Z)return;const e=t?.billingInterval==="year"?"year":"month",o=e==="year"?1990:199;Z=!0,Gt();const i=window.MarketelJourney;i?.track("JourneyCheckoutRequested",{source:document.getElementById("marketelValueReveal")?"value-reveal":"frontdesk",price:o,currency:"USD",billingInterval:e},{immediate:!0});const r=i?.getContext?.()||{};try{const n=await api("POST","/api/crm/go-live",{journeyVisitorId:r.visitorId||"",journeySessionId:r.sessionId||"",journeySequence:r.sequence||null,billingInterval:e});if(n.success&&n.url){i?.track("JourneyCheckoutRedirected",{provider:"stripe",price:o,currency:"USD",billingInterval:e},{immediate:!0,keepalive:!0}),window.location.href=n.url;return}i?.track("JourneyCheckoutFailed",{stage:"create-checkout-session",reason:"server-rejected"},{immediate:!0}),mt(),Z=!1,toast(n.message||"Failed to start checkout","error")}catch{i?.track("JourneyCheckoutFailed",{stage:"create-checkout-session",reason:"network-or-server-error"},{immediate:!0}),mt(),Z=!1,toast("Failed to start checkout. Try again.","error")}}async function zo(){if(P()){toast("Email support@bookmarketel.com for billing help.","info");return}try{const t=await api("GET","/api/crm/billing-portal");t.success&&t.url?window.location.href=t.url:toast(t.message||"Contact support@bookmarketel.com to manage your subscription.","error")}catch{toast("Contact support@bookmarketel.com to manage your subscription.","error")}}async function Io(){if(!confirm("Delete this Marketel account and all property data? The subscription will be canceled when deletion completes."))return;const t=prompt("Type DELETE to schedule permanent deletion after a seven-day recovery window.");if(String(t||"").trim().toUpperCase()==="DELETE")try{const e=await api("POST","/api/crm/account-deletion/request",{confirmation:"DELETE"});if(!e?.success)throw new Error(e?.message||"Could not schedule deletion.");toast("Account deletion scheduled. You can cancel during the next seven days.","success"),setTimeout(()=>window.location.reload(),900)}catch(e){toast(e.message||"Could not schedule account deletion.","error")}}async function Co(){try{const t=await api("POST","/api/crm/account-deletion/cancel");if(!t?.success)throw new Error(t?.message||"Could not cancel deletion.");toast("Account deletion cancelled.","success"),setTimeout(()=>window.location.reload(),700)}catch(t){toast(t.message||"Could not cancel account deletion.","error")}}async function Mo(){window.openMarketelSupport?.()}async function Ro(t){const e=d.editRooms.find(s=>s.id===t);if(!e){toast("Room not found — try refreshing","error");return}const o=document.getElementById("edit-name-"+t)?.value.trim(),i=document.getElementById("edit-desc-"+t)?.value.trim(),r=parseInt(document.getElementById("edit-occ-"+t)?.value)||4,n=parseInt(document.getElementById("edit-units-"+t)?.value)||1,a={id:t,name:o||e.name,description:i||"",amenities:e.amenities||"",maxOccupancy:r,totalUnits:n};try{const s=await api("POST","/api/crm/rooms",a);if(s&&s.success===!1){toast(s.message||"Failed to save","error");return}e.name=a.name,e.description=a.description,e.maxOccupancy=r,e.totalUnits=n,toast("Room saved!","success")}catch(s){toast("Failed to save: "+(s.message||""),"error")}}async function Po(t,e){const o=Array.from(t.target.files);if(!o.length)return;const r=document.getElementById("edit-card-"+e)?.querySelector("div:first-child");r&&(r.style.position="relative",r.insertAdjacentHTML("beforeend",'<div id="upload-spinner-'+e+'" style="position:absolute;inset:0;background:rgba(255,255,255,0.8);display:flex;align-items:center;justify-content:center;z-index:5;flex-direction:column;gap:6px;"><div style="width:24px;height:24px;border:3px solid var(--border);border-top-color:var(--green);border-radius:50%;animation:spin 0.7s linear infinite;"></div><div id="upload-progress-'+e+'" style="font-size:12px;color:var(--text-muted);font-weight:600;">0 / '+o.length+"</div></div>"));let n=0,a="";for(const u of o){try{const x=await yt(e,u);if(x.image){const y=d.editRooms.find(B=>B.id===e);y&&(y.images||(y.images=[]),y.images.push(x.image),y.imageUrl||(y.imageUrl=x.image.url)),n++}}catch(x){a=x.message||"Upload failed"}const m=document.getElementById("upload-progress-"+e);m&&(m.textContent=n+" / "+o.length)}const s=document.getElementById("upload-spinner-"+e);s&&s.remove(),H(),n>0&&(d.launchStatus=null),Q(),n>0?toast(n+" photo"+(n!==1?"s":"")+" added. Check the Bookings tab to continue your launch checklist!","success"):toast(a||"Upload failed","error")}function Yt(t,e=512){return new Promise((o,i)=>{const r=new Image,n=URL.createObjectURL(t);r.onload=()=>{try{const a=Math.min(r.naturalWidth,r.naturalHeight),s=(r.naturalWidth-a)/2,u=(r.naturalHeight-a)/2,m=document.createElement("canvas");m.width=e,m.height=e;const x=m.getContext("2d");x.imageSmoothingQuality="high",x.drawImage(r,s,u,a,a,0,0,e,e),URL.revokeObjectURL(n),m.toBlob(y=>y?o(y):i(new Error("crop failed")),"image/png",.92)}catch(a){URL.revokeObjectURL(n),i(a)}},r.onerror=()=>{URL.revokeObjectURL(n),i(new Error("load failed"))},r.src=n})}function _t(){const t=document.getElementById("appsAppIconPreview");t&&(t.innerHTML='<div style="width:24px;height:24px;border:3px solid rgba(255,255,255,0.5);border-top-color:#fff;border-radius:50%;animation:spin 0.7s linear infinite;"></div>')}function Et(t){const e=document.getElementById("appsAppIconPreview");e&&(e.style.background="#fff",e.style.border="1px solid var(--border)",e.style.padding="0",e.innerHTML='<img src="'+t+'" alt="App icon" style="width:100%;height:100%;object-fit:contain;">')}function ft(){const t=document.getElementById("appsAppIconPreview");if(!t)return;if(d.activeHotelAppIcon){Et(d.activeHotelAppIcon);return}const e=(d.activeHotelName||"P").trim().charAt(0).toUpperCase()||"🏡";t.style.background="transparent",t.style.border="none",t.style.padding="0",t.innerHTML='<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--green);color:#fff;border-radius:14px;font-size:24px;font-weight:800;">'+e+"</span>"}async function Oo(t){const e=t.files&&t.files[0];if(!e)return;_t();const o=new FormData;try{const i=await Yt(e,512);o.append("icon",i,"app-icon.png")}catch{o.append("icon",e)}try{const i=xt(),r=new URLSearchParams;d.activeHotelId&&r.set("hotelId",d.activeHotelId);const a=await(await fetch(`/api/crm/hotel-app-icon?${r}`,{method:"POST",headers:{"x-crm-token":i,...P()?{"x-marketel-client":"ios"}:{}},body:o})).json();if(a.success&&a.appIconUrl){d.activeHotelAppIcon=a.appIconUrl,Et(a.appIconUrl);const s=document.getElementById("appsView");s&&(s.dataset.appsKey=(d.activeHotelId||"")+"|"+a.appIconUrl+"|"+(d.activeHotelDomain||"")),typeof updateFrontdeskManifestLink=="function"&&updateFrontdeskManifestLink(),toast("Logo updated! Guests will see it on their phone.","success")}else toast(a.message||"Failed to upload icon","error"),ft()}catch{toast("Failed to upload icon","error"),ft()}t.value=""}async function Do(t,e){if(confirm("Delete this photo?"))try{await api("DELETE",`/api/crm/rooms/${t}/images/${e}`);const o=d.editRooms.find(i=>i.id===t);o&&o.images&&(o.images=o.images.filter(i=>i.id!==e),o.imageUrl=o.images[0]?.url||null),H(),toast("Photo deleted","success")}catch{toast("Failed to delete","error")}}async function $o(t){if(!confirm("Delete this room from your booking page and Availability? Saved date changes will also be removed."))return;const e=d.editRooms.find(o=>o.id===t);try{if(await api("DELETE",`/api/crm/rooms/${t}`),d.editRooms=d.editRooms.filter(i=>i.id!==t),e){const i=d.manualAvailability||{rooms:[],overrides:{}};i.rooms=(i.rooms||[]).filter(r=>r.name!==e.name),i.overrides=Object.fromEntries(Object.entries(i.overrides||{}).filter(([r])=>!r.startsWith(`${e.name}|`))),d.manualAvailability=i,d.manualSelectedRoom===e.name&&(d.manualSelectedRoom=i.rooms[0]?.name||"")}H(),window.refreshRoomBadge?.(),window.renderAvailabilityView?.(),toast("Room deleted","success"),wt({render:!0}).catch(()=>{}),window.loadManualAvailability?.({silent:!0})?.catch(()=>{})}catch(o){toast(o.message||"Failed to delete","error")}}function Lo(){document.getElementById("editAddRoomModal")||(document.body.insertAdjacentHTML("beforeend",`
  ...
  `),window.setNativeModalOpen?.("edit-add-room",!0),requestAnimationFrame(()=>document.getElementById("editNewRoomName")?.focus()))}function Wt(){document.getElementById("editAddRoomModal")?.remove(),window.setNativeModalOpen?.("edit-add-room",!1)}async function Fo(){const t=document.getElementById("editNewRoomName"),e=document.querySelector("#editAddRoomModal .edit-add-room-actions .primary"),o=t?.value.trim()||"";if(!o)return;t&&(t.disabled=!0),e&&(e.disabled=!0,e.textContent="Adding…");const i=5;try{const r=await api("POST","/api/crm/rooms",{name:o,maxOccupancy:4,totalUnits:i});if(!r?.success||!r.room?.id)throw new Error(r?.message||"Failed to add room");const n={id:r.room.id,name:r.room.name||o,description:"",amenities:"",maxOccupancy:4,totalUnits:i,imageUrl:null,images:[]},a=d.editRooms.findIndex(m=>m.id===n.id);a>=0?d.editRooms=d.editRooms.map((m,x)=>x===a?n:m):d.editRooms=[...d.editRooms,n];const s=d.manualAvailability||{rooms:[],overrides:{}};Array.isArray(s.rooms)||(s.rooms=[]),(!s.overrides||typeof s.overrides!="object")&&(s.overrides={}),s.rooms.some(m=>m.name===n.name)||(s.rooms=[...s.rooms,{name:n.name,totalUnits:i}].sort((m,x)=>String(m.name).localeCompare(String(x.name)))),d.manualAvailability=s,d.manualSelectedRoom||(d.manualSelectedRoom=n.name),Wt(),H(),window.refreshRoomBadge?.(),toast("Room added","success"),wt({render:!0}).catch(()=>{}),window.loadManualAvailability?.({silent:!0})?.catch(()=>{})}catch(r){t&&(t.disabled=!1),e&&(e.disabled=!1,e.textContent="Add room"),toast(r.message||"Failed to add room","error")}}const Jt={addAmenityPrompt:bo,advanceTourIfNeeded:Q,changePin:So,checklistGoTo:no,checklistGoToRates:oo,cleanupPostActivationTourUi:st,cleanupSettingsTourUi:F,cancelAccountDeletion:Co,closeAmenityPicker:dt,closeEditAddRoom:Wt,confirmAmenityPicker:vo,confirmEditAddRoom:Fo,copyBookingLink:Bo,copyBookingLinkFromChecklist:io,deleteEditImage:Do,deleteEditRoom:$o,ensureTourBlurOverlay:D,finishPostActivationTour:et,getAmenityIcon:jt,getCrmAuthToken:xt,getEditRoomImages:Nt,goLive:To,guestBookingEngineUrl:Ft,handoffToGuestAppsTour:Pt,hideGoLiveOverlay:mt,loadEditRooms:ho,loadSettings:Lt,openAmenityPicker:Vt,openBillingPortal:zo,openEditAddRoom:Lo,openGuestBookingEngine:po,openPreviewSite:co,openTourAccordion:V,postRoomImageUpload:yt,queryTourSelector:q,requestAccountDeletion:Io,removeAmenity:wo,renderEditRooms:bt,renderEditRoomsCards:H,refreshEditRoomsData:wt,replayWalkthrough:mo,resolveLiveTourElement:tt,resolveTourHighlightEl:W,restoreAppIconPreview:ft,saveEditRoom:Ro,saveHotelInfo:ko,saveRates:Eo,scrollTourTargetIntoView:Rt,sendSupportMessage:Mo,setAppIconPreviewImage:Et,setAppIconPreviewLoading:_t,settingsChangePin:so,settingsCopyLink:eo,settingsSaveRates:ao,settingsSendSupport:lo,settingsUploadPhoto:ro,showActivatedModal:fo,showEditRoomPhoto:qt,showFinaleMockModal:J,showGoLiveOverlay:Gt,showOnboardingQuestions:go,showTestDriveModal:Ot,showWelcomeModal:Ht,squareCropImage:Yt,startPostActivationTabTour:vt,startSettingsTour:gt,stepEditRoomPhoto:xo,toggleAmenityPreset:yo,toggleSection:Ao,tourAnchorRect:Mt,tourElementRect:rt,updatePreviewSiteBar:uo,uploadAppIcon:Oo,uploadEditImages:Po};function Ho(){Ce(Jt)}const Uo=Object.freeze(Object.defineProperty({__proto__:null,default:Jt,install:Ho},Symbol.toStringTag,{value:"Module"}));export{Ye as a,Ge as b,d as c,No as d,Ce as e,Uo as f,jo as i,qo as s};
