import{c as s,e as oe}from"./settings-DzmlfyYA.js";const R="marketelValueRevealPendingV1",E="marketelValueRevealStepV1",X="marketelBillingIntervalV1";let r=0,u="guest",p=!1,y={rooms:[],rates:null},D=null,o={ready:!1,checking:!0,reason:"",attempts:0,domain:""},k=0,$=0,I=null,d=0,V=0,A=0,f="month",m=null,O=!1,h=!1,T=!1;const ne="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/46/2a/e1/462ae1c9-9347-efd0-5e99-41e7f636e3f7/phone-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg",se="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/23/4c/cb/234ccbb4-e65a-bb94-f877-3d230743e9e3/safari-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/512x512bb.jpg";function Z(){const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e==="0.0.0.0"||e==="::1"||e.endsWith(".local")||/^10\./.test(e)||/^192\.168\./.test(e)||/^172\.(1[6-9]|2\d|3[01])\./.test(e)}function c(e){return String(e??"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function G(e){const a=Number(e);return Number.isFinite(a)?new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:Number.isInteger(a)?0:2}).format(a):"$99"}function g(){return s.activeHotelName||"Your Property"}function Y(){return y.rooms[0]||s.editRooms[0]||{name:"Your first room",totalUnits:1,images:[]}}function le(){const e=Y();return e.images?.[0]?.url||e.imageUrl||""}function de(){return y.rates?.nightly||99}function ce(){const e=Number(y.rates?.nightly);if(!Number.isFinite(e)||e<=0)return`<div class="mvr-value-bridge is-proof-only">
  ...
  </div>`}function ye(){return h?'<div class="mvr-page-status is-attention"><span>!</span>The live preview is still publishing. Your setup is saved, so you can continue without waiting.</div>':o.ready?`<div class="mvr-page-status is-ready"><span>✓</span>${o.reason==="local"?"Local guest preview connected":"Your live guest page is online"}</div>`:o.reason==="deployment-disabled"?'<div class="mvr-page-status is-attention"><span>!</span>Your live page deployment needs to be re-enabled. Your saved setup is safe.</div>':`<div class="mvr-page-status"><span class="mvr-status-pulse"></span>${o.checking?"Publishing your live guest page…":"Your personalized preview is ready while the live page finishes publishing."}</div>`}function he(){const e=C();return`<div class="mvr-booking-preview-card">
  ...
  </section>`}function Ie(){const e=s.hotelSubscribed,a=f==="year",t=a?"$1,990":"$199",i=a?"/year":"/month",n=a?"Activate Marketel — $1,990/year":"Activate Marketel — $199/month",b=`<div class="mvr-value-list">
    ...
    <div class="mvr-finale-card">
      ...
      ${e?`${b}
        ...
        <div class="mvr-activation-decision">
          ...
          <div class="mvr-price-detail${a?" is-visible":""}">${a?"Two months free · $398 saved":"&nbsp;"}</div>
