import{f as A,c as N}from"./settings-DtcQd-dF.js";const F="marketelNativeOnboardingV2Done",b="marketelNativeOnboardingV2State",f="marketelNativeFrontDeskContactV1",E="marketelNativeBookingFallbackV1",Y="+18339830801",k="marketelNativeOnboardingStyles",l="marketelNativeOnboarding",r=[{filter:"settings",eyebrow:"Your Page",title:"Make it yours.",body:"Change rooms, photos, prices and the details guests see. Your direct booking page stays live while you manage it here.",note:"This is the control room for your booking page.",tabPosition:"12.5%"},{filter:"bookings",eyebrow:"Bookings",title:"You decide what happens.",body:"New room requests arrive here. Keep or release them in one tap, and your no-answer rule handles the moments you miss.",note:"Every pending card shows the countdown and your fallback before you act.",tabPosition:"37.5%"},{filter:"availability",eyebrow:"Availability",title:"When a walk-in takes a room, tell Front Desk.",body:"Text “A walk-in took the Queen Room tonight,” or record it here in Availability. Marketel reduces the remaining availability on your direct booking page.",note:"One rule: if it happened outside Marketel, tell Front Desk.",tabPosition:"62.5%"},{filter:"apps",eyebrow:"Guestel",title:"Guests keep your property in Guestel.",body:"Guests tap Add on your booking page or scan your QR. Guestel keeps your property, their stays, and their messages together while Marketel Front Desk remains your owner app.",note:"Tell a guest: “Scan this to book directly and keep us in Guestel.”",tabPosition:"87.5%"},{opensFrontDesk:!0,eyebrow:"Front Desk",title:"Set your rules — once.",body:"Your booking rule, the phones that get booking texts, check-in times and alerts all live in Front Desk. Set them here and it runs on its own.",note:"Opening it next so you can finish in about a minute."}],M=0,m=1,c=2,g=c,L=g+1;let w=!1,t=null;function D(){return window.location.protocol==="capacitor:"||window.location.protocol==="ionic:"||new URLSearchParams(window.location.search).get("native")==="ios"}function p(e){try{const n=window.webkit?.messageHandlers?.marketelShell;return!n||typeof n.postMessage!="function"?!1:(n.postMessage(e),!0)}catch{return!1}}function x(e){if(typeof window.setNativeShellVisible=="function"){window.setNativeShellVisible(e);return}p({type:"visibility",visible:e})}function h(e){p({type:"tourMode",active:!!e})}function T(){return p({type:"requestNotifications"})}function B(){p({type:"notificationSettings"})}function $(){try{return String(N?.nativeNotificationState||"")}catch{return""}}let S=!1;function j(){if(S)return;S=!0;const e=window.marketelNativeNotificationState;window.marketelNativeNotificationState=function(o){try{typeof e=="function"&&e(o)}finally{G(String(o||""))}}}function G(e){if(!t||t.phase!=="intro"||t.step!==m)return;const n=e==="authorized",o=t.awaitingAlerts===!0;i(),n&&o?(t.awaitingAlerts=!1,window.setTimeout(()=>{t&&t.phase==="intro"&&t.step===m&&y()},750)):n||(t.awaitingAlerts=!1)}function H(){if(!t)return;j(),t.awaitingAlerts=!0,T()||(t.awaitingAlerts=!1,y())}function s(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function z(){return String(N.activeHotelName||"your property").trim()||"your property"}function v(e){try{return localStorage.getItem(e)==="1"}catch{return!1}}function I(){try{return localStorage.getItem(E)==="release"?"release":"confirm"}catch{return"confirm"}}function u(){if(t)try{localStorage.setItem(b,JSON.stringify({phase:t.phase,step:t.step,contactSaved:t.contactSaved,noResponseAction:t.noResponseAction}))}catch{}}function K(){try{const e=JSON.parse(localStorage.getItem(b)||"null");if(!e||!["intro","tour"].includes(e.phase))return null;const n=e.phase==="intro"?g:r.length-1;return{phase:e.phase,step:Math.max(0,Math.min(Number(e.step)||0,n)),contactSaved:e.contactSaved===!0||v(f),noResponseAction:e.noResponseAction==="release"?"release":I()}}catch{return null}}function V(){if(document.getElementById(k))return;const e=document.createElement("style");e.id=k,e.textContent=`
  ...
  `,document.head.appendChild(e)}function q(e,n){return Array.from({length:n},(o,a)=>`<span class="mno-dot${a===e?" active":""}" aria-hidden="true"></span>`).join("")}function U(){const e=$(),n=e==="authorized";return`
    <div class="mno-stage">
      ...
      <div class="mno-lockscreen${n?" is-live":e==="denied"?" is-off":""}" aria-hidden="true">
        ...
        <div class="mno-la">
          <div class="mno-la-head">
            <span class="mno-la-brand"><img class="mno-la-mark" src="${A}" alt="" aria-hidden="true">Front Desk</span>
    ...
    </div>`}function Q(e){const n=s(z()),o=s(z().charAt(0).toUpperCase());if(e===M)return`
      <div class="mno-stage">
      ...
      </div>`;if(e===m)return U();if(e===c){const a=!!t?.contactSaved,d=t?.noResponseAction==="release";return`
      <div class="mno-stage">
      ...
      </div>`}return""}function J(e){const n=q(e,L);if(e===m){const a=$();return a==="authorized"?`
    ...
    <div class="mno-progress">${n}</div>`}function X(){h(!1),x(!1);const e=O();e.innerHTML=`
    <section class="mno-intro" role="dialog" aria-modal="true" aria-label="Front Desk setup">
      <div class="mno-topline">
        <div class="mno-wordmark"><img class="mno-mark" src="${A}" alt="" aria-hidden="true">Front Desk</div>
    ...
    </section>`}function C(e){typeof window.marketelNativeSelectTab=="function"&&window.marketelNativeSelectTab(e)}function W(){const e=r[t.step]||r[0];x(!0),h(!0),e.filter&&C(e.filter);const n=O(),o=!e.tabPosition;n.innerHTML=`
    ...
    </section>`}function O(){let e=document.getElementById(l);return e||(e=document.createElement("div"),e.id=l,e.addEventListener("click",Z),document.body.appendChild(e)),e}function i(){t&&(V(),document.documentElement.classList.add("marketel-native-tour-open"),u(),t.phase==="tour"?W():X())}function Z(e){const n=e.target?.closest?.("[data-mno-action]");if(!n||!t)return;const o=n.getAttribute("data-mno-action");o==="next"?y():o==="back"?te():o==="skip"?_({skipped:!0}):o==="save-contact"?ne():o==="enable-alerts"?H():o==="open-notif-settings"?B():o==="policy"&&ee(n.getAttribute("data-mno-policy"))}function ee(e){if(t){t.noResponseAction=e==="release"?"release":"confirm";try{localStorage.setItem(E,t.noResponseAction)}catch{}u(),typeof window.api=="function"&&window.api("POST","/api/crm/booking-approval",{noResponseAction:t.noResponseAction}).catch(()=>{}),i()}}function y(){if(t){if(t.phase==="intro")t.step<g?t.step+=1:(t.phase="tour",t.step=0);else if(t.step<r.length-1)t.step+=1;else{_();return}i()}}function te(){t&&(t.phase==="tour"?t.step>0?t.step-=1:(t.phase="intro",t.step=g):t.step>0&&(t.step-=1),i())}function ne(){if(!t)return;t.contactAttempted=!0,u(),p({type:"saveContact",phone:Y})||i()}function R(){document.getElementById(l)?.remove(),document.documentElement.classList.remove("marketel-native-tour-open"),h(!1),x(!0)}function oe(){if(!p({type:"openAssistant"}))try{typeof window.openFrontDeskAssistant=="function"&&window.openFrontDeskAssistant()}catch{}}function _({skipped:e=!1}={}){try{localStorage.setItem(F,"1"),localStorage.removeItem(b)}catch{}t=null,R(),C("bookings"),T(),e||(window.setTimeout(oe,300),typeof window.toast=="function"&&window.toast("Front Desk is ready","success"))}function ae(e){if(t){if(t.contactAttempted=!0,t.contactSaved=e===!0,e)try{localStorage.setItem(f,"1")}catch{}u(),t.phase==="intro"&&t.step===c&&i()}}function P({replay:e=!1}={}){return D()?(t&&R(),t=(e?null:K())||{phase:"intro",step:0,contactSaved:v(f),contactAttempted:!1,noResponseAction:I()},i(),!0):!1}function ie(){return!D()||v(F)?!1:P()}function se(){w||(w=!0,window.marketelNativeContactResult=ae,window.startNativeOnboarding=P,window.maybeStartNativeOnboarding=ie)}export{se as install,ie as maybeStartNativeOnboarding,P as startNativeOnboarding};
