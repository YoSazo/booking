...
- User content: property descriptions, room details, photos, support messages,
  and reservation information
- Identifiers: Marketel property/account identifier
...
- App functionality
- Developer communications and customer support
